...
/**
 * This is the model class for table "informasialokasidana_v".
 *
 * The followings are the available columns in table 'informasialokasidana_v':
 ...
 */
class InformasialokasidanaV extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('pasien_id, rt, rw, propinsi_id, kabupaten_id, kelurahan_id, kecamatan_id, pendaftaran_id, pekerjaan_id, shift_id, penanggungjawab_id, ruangan_id, instalasi_id, jeniskasuspenyakit_id, kelaspelayanan_id, pembayaranpelayanan_id', 'numerical', 'integerOnly'=>true),
			...
			array('nama_pasien, alamatemail, ruangan_nama, instalasi_nama, jeniskasuspenyakit_nama, nokartukeluarga', 'length', 'max'=>100),
			array('nama_bin, propinsi_nama, kabupaten_nama, kelurahan_nama, kecamatan_nama, pekerjaan_nama, transportasi, keadaanmasuk, statusperiksa, statuspasien, kunjungan, statusmasuk, no_asuransi, namapemilik_asuransi, nopokokperusahaan, pengantar, hubungankeluarga, nama_pj, kelaspelayanan_nama, nama_pegawai, namaperusahaan, nopeserta, kodefeskestk1, status_konfirmasi', 'length', 'max'=>50),
	 ...
	 * @return InformasialokasidanaV the static model class
	 */
