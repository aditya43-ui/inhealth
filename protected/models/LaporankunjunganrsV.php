...
class LaporankunjunganrsV extends CActiveRecord
{
		...
		public $tahun;
		public $bulan;
		public $rj_p, $rj_l, $tot_rj;
		public $ri_p, $ri_l, $tot_ri;
		public $jiwa_p, $jiwa_l, $tot_jiwa;
	/**
	...
	public function search()
	{
		...
		if (!empty($this->ruangan_id)) {
			# code...
			$criteria->join = 'JOIN laporankunjunganrs_v ON t.carabayar_id = laporankunjunganrs_v.carabayar_id 
			JOIN ruangan_m ON laporankunjunganrs_v_m.ruangan_id = ruangan_m.ruangan_id';
	...
	public static function getDropList(){
		...
		$cri->order = "carabayar_nama";
		$model = CarabayarM::model()->findAll($cri);
		
		$arr = array();
		foreach($model as $d){
			$arr[$d->carabayar_id] = $d->carabayar_nama;
		}
