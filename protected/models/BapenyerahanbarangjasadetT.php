...
/**
 * This is the model class for table "bapenyerahanbarangjasadet_t".
 *
 * @author  Andyka Putra <andykaputra@.com>
 * @package application.models
 * 
 * The followings are the available columns in table 'bapenyerahanbarangjasadet_t':
 * @property integer $bapenyerahanbarangjasadet_id
 ...
 */
class BapenyerahanbarangjasadetT extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return BapenyerahanbarangjasadetT the static model class
	 */
	...
	{
		return 'bapenyerahanbarangjasadet_t';
	}
	...
	public function rules()
	{
		...
		return array(
			array('bapenyerahanbarangjasa_id, nama_barang, satuan_barang, jumlah_barang', 'required'),
			array('bapenyerahanbarangjasa_id, barang_id', 'numerical', 'integerOnly'=>true),
			...
			array('bapenyerahanbarangjasadet_id, bapenyerahanbarangjasa_id, barang_id, jenis_barang, nama_barang, satuan_barang, jumlah_barang, spesifikasi_barang, harga_satuan, jumlah_harga, jumlah_pajak, pajak_persen', 'safe', 'on'=>'search'),
		);
	}
	...
	{
		return array(
			'bapenyerahanbarangjasadet_id' => 'Bapenyerahanbarangjasadet',
	...
	public function search()
	{
		...
		$criteria->compare('bapenyerahanbarangjasadet_id',$this->bapenyerahanbarangjasadet_id);
