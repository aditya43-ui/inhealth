...
/**
 * This is the model class for table "orderbataltindakanlab_v".
 *
 * The followings are the available columns in table 'orderbataltindakanlab_v':
 ...
 */
class OrderbataltindakanlabV extends CActiveRecord
{
	/**
	...
	{
		return 'orderbataltindakanlab_v';
	}
	 ...
	 * @return OrderbataltindakanlabV the static model class
	 */
