...
/**
 * This is the model class for table "ruanganmikrobiologi_v".
 *
 * The followings are the available columns in table 'ruanganmikrobiologi_v':
 ...
 */
class RuanganmikrobiologiV extends CActiveRecord
{
	/**
	 ...
	 * @return RuanganmikrobiologiV the static model class
	 */
