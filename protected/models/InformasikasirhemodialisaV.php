<?php
class InformasikasirhemodialisaV extends CActiveRecord
{
    public $tgl_awal;
    public $tgl_akhir;
    public $pegawai_id;
     ...
     * @return InformasikasirhemodialisaV the static model class
     */
    ...
    {
        return 'informasikasirhemodialisa_v';
    }
