...
/**
 * This is the model class for table "statusbedahanastesilokal_t".
 *
 * The followings are the available columns in table 'statusbedahanastesilokal_t':
 * @property integer $statusbedahanastesilokal_id
 ...
 */
class StatusbedahanastesilokalT extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return StatusbedahanastesilokalT the static model class
	 */
	...
	{
		return 'statusbedahanastesilokal_t';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('statusbedahanastesilokal_id, pasien_id, pendaftaran_id, pasienadmisi_id, pasienmasukpenunjang_id, jam_mulaianestesi, jam_selesaianestesi, statusanestesi, jam_mulaitindakanbedah, jam_selesaitindakanbedah, status_tindakanbedah, create_time, update_time, create_loginpemakai_id, update_loginpemakai_id, create_ruangan', 'safe', 'on'=>'search'),
		);
	}
	...
	{
		return array(
			'statusbedahanastesilokal_id' => 'Statusbedahanastesilokal',
			'pasien_id' => 'Pasien',
			'pendaftaran_id' => 'Pendaftaran',
			'pasienadmisi_id' => 'Pasienadmisi',
			'pasienmasukpenunjang_id' => 'Pasienmasukpenunjang',
			'jam_mulaianestesi' => 'Jam Mulaianestesi',
			'jam_selesaianestesi' => 'Jam Selesaianestesi',
			'statusanestesi' => 'Statusanestesi',
			'jam_mulaitindakanbedah' => 'Jam Mulaitindakanbedah',
			'jam_selesaitindakanbedah' => 'Jam Selesaitindakanbedah',
	...
	public function criteriaSearch()
	{
		...
		if(!empty($this->statusbedahanastesilokal_id)){
			$criteria->addCondition('statusbedahanastesilokal_id = '.$this->statusbedahanastesilokal_id);
		}
