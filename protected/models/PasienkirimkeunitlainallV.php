...
/**
 * This is the model class for table "pasienkirimkeunitlainall_v".
 *
 * The followings are the available columns in table 'pasienkirimkeunitlainall_v':
 ...
 */
class PasienkirimkeunitlainallV extends CActiveRecord
{
	/**
	...
	{
		return 'pasienkirimkeunitlainall_v';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('nama_pasien, jeniskasuspenyakit_nama, penjamin_nama, ruanganasal_nama, instalasiasal_nama, ruangan_nama, pemeriksaanrad_nama', 'length', 'max'=>100),
			array('nama_bin, carabayar_nama, kelaspelayanan_nama, nama_pegawai, noperminatanpenujang', 'length', 'max'=>50),
	 ...
	 * @return PasienkirimkeunitlainallV the static model class
	 */
