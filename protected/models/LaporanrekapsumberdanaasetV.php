...
/**
 * This is the model class for table "laporanrekapsumberdanaaset_v".
 *
 * The followings are the available columns in table 'laporanrekapsumberdanaaset_v':
 ...
 */
class LaporanrekapsumberdanaasetV extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return LaporanrekapsumberdanaasetV the static model class
	 */
	...
	{
		return 'laporanrekapsumberdanaaset_v';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('total_aset', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('lokasi_id, lokasiaset_namalokasi, ruangan_id, ruangan_nama, gedung_id, gedung_nama, sumberdana, total_aset', 'safe', 'on'=>'search'),
		);
	}
