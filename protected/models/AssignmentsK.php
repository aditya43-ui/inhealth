...
/**
 * This is the model class for table "assignments_k".
 *
 * The followings are the available columns in table 'assignments_k':
 * @property string $itemname
 * @property integer $userid
 * @property string $bizrule
 * @property string $data
 */
class AssignmentsK extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return AssignmentsK the static model class
	 */
