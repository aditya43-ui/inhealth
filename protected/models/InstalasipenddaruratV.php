...
/**
 * This is the model class for table "instalasipenddarurat_v".
 *
 * The followings are the available columns in table 'instalasipenddarurat_v':
 ...
 */
class InstalasipenddaruratV extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return InstalasipenddaruratV the static model class
	 */
