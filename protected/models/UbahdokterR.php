...
class UbahdokterR extends CActiveRecord
{
	...
	public $dokterlama_nama, $dokterbaru_nama, $spesialissubspesialis_nama, $subspesialis_baru, $spesialissubspesialis_id;
	...
	public function rules()
	{
		...
		return array(
			array('dokterlama_id, tglubahdokter, alasanperubahandokter, create_time, create_loginpemakai_id, create_ruangan, pendaftaran_id', 'required'),
			...
			array('keterangan, spesialissubspesialis_id, spesialis_id, update_time', 'safe'),
	...
	public function relations()
	{
		...
		return array(
			...
			'jadwaldokter' => array(self::BELONGS_TO, 'JadwaldokterM', 'create_ruangan'),
			'pendaftaran' => array(self::BELONGS_TO, 'PendaftaranT', 'pendaftaran_id'),
			'subspesialis' => array(self::BELONGS_TO, 'SpesialissubspesialisM', 'spesialissubspesialis_id'),
