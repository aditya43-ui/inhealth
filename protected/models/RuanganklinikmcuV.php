...
/**
 * This is the model class for table "ruanganklinikmcu_v".
 *
 * The followings are the available columns in table 'ruanganklinikmcu_v':
 ...
 */
class RuanganklinikmcuV extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return RuanganklinikmcuV the static model class
	 */
