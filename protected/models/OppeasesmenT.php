 ...
 */
class OppeasesmenT extends CActiveRecord {
    ...
    public $rekomendasi, $indikatoroppekeperawatan_nama;
    ...
    public function rules() {
        ...
        return array(
            array('ka_unitkerja_id, unitkerja_id, bulan_asesmen, pegawai_id, nama_perawat, nip_perawat, perawat_unitkerja_id, prosentase_asesmen, create_loginpemakai_id, create_time', 'required'),
            ...
            array('prosentase_asesmen', 'numerical'),
            array('nama_perawat, nip_perawat', 'length', 'max' => 255),
            array('update_time', 'safe'),
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            array('oppeasesmen_id, indikatoroppekeperawatan_id, pegawai_id, ka_unitkerja_id, unitkerja_id, bulan_asesmen, nama_perawat, nip_perawat, perawat_unitkerja_id, prosentase_asesmen, create_loginpemakai_id, create_time, update_loginpemakai_id, update_time', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function search() {
        ...
        $criteria->compare('oppeasesmen_id', $this->oppeasesmen_id);
        ...
        if(!empty($this->bulan_asesmen)){
            $criteria->addBetweenCondition("bulan_asesmen", $this->bulan_asesmen, $this->bulan_asesmen);
        }
        ...
        $criteria->compare('prosentase_asesmen', $this->prosentase_asesmen);
