...
/**
 * This is the model class for table "pegawaismscenter_v".
 *
 * The followings are the available columns in table 'pegawaismscenter_v':
 ...
 * @property string $surattandaregistrasi
 * @property string $masa_str
 * @property string $sik
 * @property string $kategoripegawai
 * @property string $kelompokjabatan
 * @property string $tgl_sik_berkala
 */
class PegawaismscenterV extends CActiveRecord
{
        public $pilih,$nomor_valid;
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return PegawaismscenterV the static model class
	 */
	...
	public function criteriaSearch()
	{
		...
		$criteria->compare('LOWER(surattandaregistrasi)',strtolower($this->surattandaregistrasi),true);
		// $criteria->compare('LOWER(tgl_str_berkala)',strtolower($this->tgl_str_berkala),true);
		// $criteria->compare('LOWER(sik)',strtolower($this->sik),true);
		...
		// $criteria->compare('LOWER(tgl_sik_berkala)',strtolower($this->tgl_sik_berkala),true);
