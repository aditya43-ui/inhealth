...
/**
 * This is the model class for table "orderbataltindakanrd_v".
 *
 * The followings are the available columns in table 'orderbataltindakanrd_v':
 ...
 */
class OrderbataltindakanrdV extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('pasien_id, rt, rw, propinsi_id, kabupaten_id, kelurahan_id, kecamatan_id, pendaftaran_id, pasienadmisi_id, pekerjaan_id, carabayar_id, penjamin_id, shift_id, penanggungjawab_id, ruangan_id, instalasi_id, jeniskasuspenyakit_id, kelaspelayanan_id, pembayaranpelayanan_id', 'numerical', 'integerOnly'=>true),
	 ...
	 * @return OrderbataltindakanrdV the static model class
	 */
