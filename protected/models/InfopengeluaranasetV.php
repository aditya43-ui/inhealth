...
/**
 * This is the model class for table "infopengeluaranaset_v".
 *
 * The followings are the available columns in table 'infopengeluaranaset_v':
 ...
 */
class InfopengeluaranasetV extends CActiveRecord
{
        public $tgl_awal;
        public $tgl_akhir;
        public $jumlah;
	 ...
	 * @return InfopengeluaranasetV the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('pengeluaranaset_id, ruangan_id, pengeluaran_id, gelarbelakangkeluar_id, jabatankeluar_id, mengetahui_id, gelarmengetahui_id, jabatanmengetahui_id, invperalatan_id, invperalatan_umurekonomis, asalaset_id, pemilikbarang_id, lokasi_id, jenisbarang_id, barang_id', 'numerical', 'integerOnly'=>true),
			array('invperalatan_harga, invperalatan_akumsusut, peralatan_dayalistrik', 'numerical'),
			array('nopengeluaranaset, kd_lokasi_kode, pengeluaran_kodelokasi, lokasipenerima_kode, jenisperuntukan, no_suratperintah, ruangan_nama, pengeluaran_nama, mengetahui_nama, invperalatan_kode, invperalatan_noregister, invperalatan_merk, invperalatan_ukuran, invperalatan_nopabrik, invperalatan_norangka, invperalatan_nomesin, invperalatan_nopolisi, invperalatan_nobpkb, invperalatan_keadaan, asalaset_nama, lokasiaset_kode, lokasiaset_namabagian, kodepos_lokasi, telp_lokasi, jenisbarang_nama, barang_type, barang_kode', 'length', 'max'=>50),
			array('penerimaaset, jabatankeluar_nama, jabatanmengetahui_nama, invperalatan_namabrg, invperalatan_bahan, peralatan_model, peralatan_noseri, peralatan_manufacturer, pemilikbarang_nama, lokasiaset_namainstalasi, lokasiaset_namalokasi, jenis_lokasi, barang_nama', 'length', 'max'=>100),
			array('pengeluaran_nip, mengetahui_nip', 'length', 'max'=>30),
			array('pengeluaran_gelardepan, mengetahui_gelardepan, invperalatan_kapasitasrata', 'length', 'max'=>10),
			array('gelarbelakangkeluar_nama, gelarmengetahui_nama', 'length', 'max'=>25),
