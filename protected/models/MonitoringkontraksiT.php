...
/**
 * This is the model class for table "monitoringkontraksi_t".
 *
 * The followings are the available columns in table 'monitoringkontraksi_t':
 * @property integer $monitoringkontraksi_id
 ...
 * @property integer $jml_kontraksi
 * @property string $durasikontraksi
 ...
 */
class MonitoringkontraksiT extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return MonitoringkontraksiT the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('partografpasien_id, pemeriksaanke, jml_kontraksi, petugaspemeriksa_id, create_loginpemakai_id, update_loginpemakai_id', 'numerical', 'integerOnly'=>true),
			array('durasikontraksi', 'length', 'max'=>20),
			array('create_time, update_time', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('monitoringkontraksi_id, partografpasien_id, pemeriksaanke, tgl_pemeriksaan, jam_pemeriksaan, jml_kontraksi, durasikontraksi, petugaspemeriksa_id, create_time, update_time, create_loginpemakai_id, update_loginpemakai_id', 'safe', 'on'=>'search'),
		);
	}
	...
	{
		return array(
			'monitoringkontraksi_id' => 'Monitoringkontraksi',
			...
			'jml_kontraksi' => 'Jumlah Kontraksi tiap 10 menit (kali)',
			'durasikontraksi' => 'Durasi satu kali kontraksi (detik)',
	...
	public function search()
	{
		...
		$criteria->compare('monitoringkontraksi_id',$this->monitoringkontraksi_id);
		...
		$criteria->compare('jml_kontraksi',$this->jml_kontraksi);
		$criteria->compare('durasikontraksi',$this->durasikontraksi,true);
