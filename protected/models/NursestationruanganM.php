 ...
 */
class NursestationruanganM extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('ruangan_id, nursestation_id', 'required'),
			array('ruangan_id, nursestation_id', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('ruangan_id, nursestation_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
                     ...
                     'nursestationrl'=>array(self::BELONGS_TO,'NursestationM','nursestation_id'),
		);
	}
