...
/**
 * This is the model class for table "laporancostcenter_v".
 *
 * The followings are the available columns in table 'laporancostcenter_v':
 ...
 */
class LaporancostcenterV extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return LaporancostcenterV the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('saldo_rj, saldo_ri, saldo_rd, saldo_vk, saldo_pi, saldo_hd, saldo_fisioterpi, saldo_mcu, saldo_lab, saldo_rad, saldo_ibs, saldo_pemulasaran, saldo_bankdrh, saldo_apotek, saldounitcost_center, saldoakun', 'numerical'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'saldo_bankdrh' => 'Saldo Bankdrh',
			'saldo_apotek' => 'Saldo Apotek',
			'saldounitcost_center' => 'Saldo Unit Cost Center',
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('saldounitcost_center',$this->saldounitcost_center);
