...
class LaporanjurnalV extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('kodenama_akun, tglbuktijurnal, noreferensi, tglreferensi, urianjurnal, create_time, update_time, create_loginpemakai_id, update_loginpemakai_id, create_ruangan, tgljurnalpost, keterangan, koreksi, catatan', 'safe'),
