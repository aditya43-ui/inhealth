...
/**
 * This is the model class for table "rekeningakuntansi6_v".
 *
 * The followings are the available columns in table 'rekeningakuntansi6_v':
 ...
 */
class Rekeningakuntansi6V extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('rekening1_id, kelompokrekening1_id, rekening2_id, kelompokrekening2_id, rekening3_id, kelompokrekening3_id, rekening4_id, kelompokrekening4_id, rekening5_id, kelompokrekening5_id, rekeninglast_id, kelompokrekeninglast_id', 'numerical', 'integerOnly'=>true),
			array('koderekening1, koderekening2, koderekening3, koderekening4, koderekening5, koderekeninglast', 'length', 'max'=>20),
			array('namarekening1, namarekening2, namarekening3, namarekening4, namarekening5, namarekeninglast', 'length', 'max'=>500),
			array('rekening1_nb, rekening2_nb, rekening3_nb, rekening4_nb, rekening5_nb, rekeninglast_nb', 'length', 'max'=>1),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('rekening1_id, koderekening1, namarekening1, rekening1_nb, kelompokrekening1_id, rekening2_id, koderekening2, namarekening2, rekening2_nb, kelompokrekening2_id, rekening3_id, koderekening3, namarekening3, rekening3_nb, kelompokrekening3_id, rekening4_id, koderekening4, namarekening4, rekening4_nb, kelompokrekening4_id, rekening5_id, koderekening5, namarekening5, rekening5_nb, kelompokrekening5_id, rekeninglast_id, koderekeninglast, namarekeninglast, rekeninglast_nb, kelompokrekeninglast_id', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Rekeningakuntansi6V the static model class
	 */
