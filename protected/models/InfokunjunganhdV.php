...
/**
 * This is the model class for table "infokunjunganhd_v".
 *
 * The followings are the available columns in table 'infokunjunganhd_v':
 ...
 */
class InfokunjunganhdV extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return InfokunjunganhdV the static model class
	 */
	...
	public function criteriaSearch()
	{
		...
		$criteria->compare('LOWER(keterangan_pendaftaran)',strtolower($this->keterangan_pendaftaran),true);
		...
		public function getMorbiditas() {
			$criteria = new CDbCriteria();
			$criteria->addCondition("pendaftaran_id = " . $this->pendaftaran_id);
			//$criteria->addCondition("diagnosa_id <> 0");
         ...
         public function getKelasPelayananRuangan()
        {
            ...
            return HDKelasPelayananM::model()->findAll($cri);
        }
}