...
{
    public $kodekecamatan_kemenkes_nama;
	/**
	...
	public function rules()
	{
		...
		return array(
            ...
            array('kodekecamatan_kemenkes', 'length', 'max'=>20),
			array('longitude, latitude', 'length', 'max'=>100),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('kecamatan_id, kabupaten_id, kecamatan_nama, kecamatan_namalainnya, kecamatan_aktif,longitude,latitude, kodekecamatan_kemenkes', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
            ...
            'kodekecamatan_kemenkes' => 'Kecamatan Kemenkes'
		);
	}
