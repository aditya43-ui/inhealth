...
/**
 * This is the model class for table "ruanganpulih_v".
 *
 * The followings are the available columns in table 'ruanganpulih_v':
 ...
 */
class RuanganpulihV extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return RuanganpulihV the static model class
	 */
