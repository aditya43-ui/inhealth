...
/**
 * This is the model class for table "ruanganinstalasigizi_v".
 *
 * The followings are the available columns in table 'ruanganinstalasigizi_v':
 ...
 */
class RuanganinstalasigiziV extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return RuanganinstalasigiziV the static model class
	 */
