...
/**
 * This is the model class for table "rekonobatadmisi_t".
 *
 * The followings are the available columns in table 'rekonobatadmisi_t':
 ...
 */
class RekonobatadmisiT extends CActiveRecord
{
	 ...
	 * @return RekonobatadmisiT the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('rekonobatadmisi_id, pendaftaran_id, pasienadmisi_id, pasien_id, tanggal_pengisian, petugas_id, rujukansebelumnya, rujukanke, create_time, update_time, create_loginpemakai, update_loginpemakai, create_ruangan', 'safe', 'on'=>'search'),
		);
	}
	...
	public function searchRiwayat()
	{
		...
		$criteria->join = "JOIN rekonobatadmisidet_t det on det.rekonobatadmisi_id = t.rekonobatadmisi_id";
