...
/**
 * This is the model class for table "ruanganrawatdarurat_v".
 *
 * The followings are the available columns in table 'ruanganrawatdarurat_v':
 ...
 */
class RuanganrawatdaruratV extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return RuanganrawatdaruratV the static model class
	 */
