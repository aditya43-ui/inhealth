 ...
 */
class LapanestesikasusdaruratV extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return LapanestesikasusdaruratV the static model class
	 */
	...
	{
		return 'lapanestesikasusdarurat_v';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('tglintraanestesi, isdarurat', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('intraanestesi_id, nointraanestesi, tglintraanestesi, pasien_id, no_rekam_medik, nama_pasien, ruangan_id, ruangan_nama, isdarurat', 'safe', 'on'=>'search'),
		);
	}
