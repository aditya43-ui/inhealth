 ...
 */
class AntibiotikmikroM extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('antibiotikmikro_kode', 'required'),
			array('antibiotikmikro_nama, antibiotikmikro_namalain', 'length', 'max'=>100),
			array('antibiotikmikro_kode, antibiotikmikro_urutan', 'length', 'max'=>20),
			array('antibiotikmikro_aktif', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('antibiotikmikro_id, antibiotikmikro_nama, antibiotikmikro_namalain, antibiotikmikro_kode, antibiotikmikro_urutan, antibiotikmikro_aktif', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'antibiotikmikro_namalain' => 'Nama Lain',
	...
	public function search()
	{
		...
		$criteria->compare('lower(antibiotikmikro_jenis)',strtolower($this->antibiotikmikro_jenis),true);
		$criteria->compare('lower(antibiotikmikro_nama)', strtolower($this->antibiotikmikro_nama),true);
		$criteria->compare('antibiotikmikro_namalain',$this->antibiotikmikro_namalain,true);
