...
/**
 * This is the model class for table "orderbataltindakanri_v".
 *
 * The followings are the available columns in table 'orderbataltindakanri_v':
 ...
 */
class OrderbataltindakanriV extends CActiveRecord
{
	/**
	 ...
	 * @return OrderbataltindakanriV the static model class
	 */
