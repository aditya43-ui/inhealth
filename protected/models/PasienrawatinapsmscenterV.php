...
/**
 * This is the model class for table "pasienrawatinapsmscenter_v".
 *
 * The followings are the available columns in table 'pasienrawatinapsmscenter_v':
 ...
 */
class PasienrawatinapsmscenterV extends CActiveRecord
{
        public $pilih,$is_tglPulang,$nomor_valid;
        
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return PasienrawatinapsmscenterV the static model class
	 */
	...
	{
		return 'pasienrawatinapsmscenter_v';
	}
	...
	public function rules()
	{
		...
		return array(
			array('rt, rw, kelompokumur_id, profilrs_id, propinsi_id, kabupaten_id, kelurahan_id, kecamatan_id, pendaftaran_id, ruangan_id, instalasi_id, penjamin_id, carabayar_id, pasienadmisi_id, pasienpulang_id, carakeluar_id, kondisikeluar_id', 'numerical', 'integerOnly'=>true),
			array('no_rekam_medik', 'length', 'max'=>10),
			array('namadepan, jeniskelamin, statusperkawinan, agama, rhesus, no_mobile_pasien, no_pendaftaran', 'length', 'max'=>20),
			array('nama_pasien, propinsi_nama, kabupaten_nama, kelurahan_nama, kecamatan_nama, ruangan_nama, instalasi_nama, penjamin_nama, carabayar_nama, ruanganakhir_nama', 'length', 'max'=>50),
...
//		$criteria->compare('LOWER(tglpasienpulang)',strtolower($this->tglpasienpulang),true);
        ...
        public function searchDialog()
        {
            ...
            $criteria=$this->criteriaSearch();
            $tgl_admisi = $this->tgladmisi;
            $Tgl1 = (explode(" - ",$tgl_admisi));
            $tgl_pulang = $this->tglpasienpulang;
