...
{
    public $totaldiskon;
    public $tglpengajuanklaimanklaim, $nopengajuanklaimanklaim, $carabayar_nama, $penjamin_nama, $pegawaipenghapusan_nama;
	...
	public function rules()
	{
		...
		return array(
			...
			array('carabayar_id, penjamin_id, bayarke, pegawaipenghapusan_id', 'numerical', 'integerOnly'=>true),
			array('totalpiutang, totalbayar, telahbayar, totalsisapiutang, biaya_administrasi, totalpenerimaan, jmlpiutangtaktertagih', 'numerical'),
			array('nopembayaranklaim', 'length', 'max'=>50),
			array('pembayaranmelalui, nobuktisetor, namabank, norekbank, terimadari', 'length', 'max'=>100),
