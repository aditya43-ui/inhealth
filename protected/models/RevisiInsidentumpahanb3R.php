...
/**
 * This is the model class for table "revisi_insidentumpahanb3_r".
 * @author Yudhit Widy Wicaksono <yudhitwicaksono@.com>
 * The followings are the available columns in table 'revisi_insidentumpahanb3_r':
 * @package application.models
 * @property integer $revisi_insidentumpahanb3_id
 ...
 * @property Insidentumpahanb3T $insidentumpahanb3
 */
class RevisiInsidentumpahanb3R extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return RevisiInsidentumpahanb3R the static model class
	 */
	...
	{
		return 'revisi_insidentumpahanb3_r';
	}
	...
	public function rules()
	{
		...
		return array(
			array('insidentumpahanb3_id, tgl_pelaporan, mengetahuipegawai_id, pelapor_id, tgl_kejadian, create_time, create_loginpemakai_id, create_ruangan', 'required'),
			array('insidentumpahanb3_id, mengetahuipegawai_id, pelapor_id, unitkerja_kejadian_id, create_loginpemakai_id, update_loginpemakai_id, create_ruangan', 'numerical', 'integerOnly'=>true),
	...
	public function relations()
	{
		...
		return array(
			'insidentumpahanb3' => array(self::BELONGS_TO, 'Insidentumpahanb3T', 'insidentumpahanb3_id'),
		);
	}
	...
	{
		return array(
			'revisi_insidentumpahanb3_id' => 'Revisi Insidentumpahanb3',
			...
			'kronologistumpahanb3' => 'Kronologistumpahanb3',
			'penyebabtumpahanb3' => 'Penyebabtumpahanb3',
			'kerugiantumpahanb3' => 'Kerugiantumpahanb3',
			'upayayangdilakukan' => 'Upayayangdilakukan',
			'usulanperbaikan' => 'Usulanperbaikan',
	...
	public function search()
	{
		...
		$criteria->compare('revisi_insidentumpahanb3_id',$this->revisi_insidentumpahanb3_id);
