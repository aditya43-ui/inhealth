...
/**
 * This is the model class for table "laporankartuhutang_v".
 *
 * The followings are the available columns in table 'laporankartuhutang_v':
 ...
 */
class LaporankartuhutangV extends CActiveRecord
{
	public $tgl_awal;
	public $tgl_akhir;
	 ...
	 * @return LaporankartuhutangV the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('notransaksi', 'length', 'max'=>50),
			array('supplier_nama', 'length', 'max'=>100),
			array('ref_id, tgltransaksi, debitkredit, tgljatuhtempo, jenistransaksi', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('ref_id, notransaksi, tgltransaksi, supplier_id, supplier_nama, nilaitransaksi, debitkredit, tgljatuhtempo, jenistransaksi', 'safe', 'on'=>'search'),
		);
	}
