...
/**
 * This is the model class for table "informasikasirfisioterapi_v".
 *
 * The followings are the available columns in table 'informasikasirfisioterapi_v':
 ...
 */
class InformasikasirfisioterapiV extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return InformasikasirfisioterapiV the static model class
	 */
	...
	{
		return 'informasikasirfisioterapi_v';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('nama_pasien, nama_bin, propinsi_nama, kabupaten_nama, kelurahan_nama, kecamatan_nama, pekerjaan_nama, transportasi, keadaanmasuk, statusperiksa, statuspasien, kunjungan, statusmasuk, no_asuransi, namapemilik_asuransi, nopokokperusahaan, carabayar_nama, penjamin_nama, pengantar, hubungankeluarga, nama_pj, ruangan_nama, instalasi_nama, kelaspelayanan_nama, nama_pegawai, namaperusahaan, nopeserta, kodefeskestk1, status_konfirmasi', 'length', 'max'=>50),
