...
/**
 * This is the model class for table "informasiformuliropnamegizi_v".
 *
 * The followings are the available columns in table 'informasiformuliropnamegizi_v':
 ...
 */
class InformasiformuliropnamegiziV extends CActiveRecord
{
    public $tgl_awal, $tgl_akhir;
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return InformasiformuliropnamegiziV the static model class
	 */
	...
	{
		return 'informasiformuliropnamegizi_v';
	}
	...
	public function rules()
	{
		...
		return array(
			array('instalasi_id, ruangan_id, formuliropnamegizi_id, stokopnamegizi_id, petugas1_id, petugas2_id, pegawaimengetahui_id', 'numerical', 'integerOnly'=>true),
			array('totalvolume', 'numerical'),
			array('instalasi_nama, ruangan_nama, noformulir, nostokopnamegizi, jenisstokopnamegizi, petugas1_nama, petugas2_nama, pegawaimengetahui_nama', 'length', 'max'=>50),
	...
	public function attributeLabels()
	{
		return array(
			...
			'tglstokopnamegizi' => 'Tglstokopnamegizi',
			'nostokopnamegizi' => 'Nostokopnamegizi',
			'isstokawal' => 'Isstokawal',
			'jenisstokopnamegizi' => 'Jenisstokopnamegizi',
    ...
    public function searchInformasi()
	{
		...
		$criteria->compare('ruangan_nama',$this->ruangan_nama,true);
		if(!empty($this->formuliropnamegizi_id)){
			$criteria->addCondition('formuliropnamegizi_id = '.$this->formuliropnamegizi_id);
		}
		$criteria->compare('tglformulir',$this->tglformulir,true);
		$criteria->compare('noformulir',$this->noformulir,true);
		if(!empty($this->stokopname_id)){
			$criteria->addCondition('stokopnamegizi_id = '.$this->stokopnamegizi_id);
		}
		$criteria->compare('tglstokopnamegizi',$this->tglstokopnamegizi,true);
		$criteria->compare('nostokopnamegizi',$this->nostokopnamegizi,true);
		$criteria->compare('isstokawal',$this->isstokawal);
