...
class BukuregisterpasienV extends CActiveRecord
{
	...
	public function search()
	{
        ...
        //         $criteria->group = " t.nama_pasien, t.no_rekam_medik";
	...
	function searchDialogBD() {
        ...
        public function searchDialogDarah() {
            ...
            if(Yii::app()->user->getState('instalasi_id') == Params::INSTALASI_ID_ICU){
...
//                }
            ...
            else if(Yii::app()->user->getState('ruangan_id') == Params::RUANGAN_ID_VK){
                    $model = new InfokunjunganpersalinanV();
			}
