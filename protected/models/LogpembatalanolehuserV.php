...
/**
 * This is the model class for table "logpembatalanolehuser_v".
 *
 * The followings are the available columns in table 'logpembatalanolehuser_v':
 ...
 */
class LogpembatalanolehuserV extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return LogpembatalanolehuserV the static model class
	 */
	...
	{
		return 'logpembatalanolehuser_v';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('jenislog, keterangan_log, tgl_log, create_loginpemakai_id, ruangan_nama', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id_log, jenislog, keterangan_log, tgl_log, create_loginpemakai_id, nama_pemakai, nama_pegawai, ruangan_nama', 'safe', 'on'=>'search'),
		);
	}
