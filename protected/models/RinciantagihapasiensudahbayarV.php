...
class RinciantagihapasiensudahbayarV extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('tarif_rsakomodasi, tarif_medis, tarif_paramedis, tarif_bhp, tarif_satuan, tarif_tindakan, qty_tindakan, tarifcyto_tindakan, discount_tindakan, pembebasan_tindakan, subsidiasuransi_tindakan, subsidipemerintah_tindakan, subsisidirumahsakit_tindakan, iurbiaya_tindakan, biayaservice, biayaadministrasi, biayakonseling, tarif_tindakanpelayanan, jmlsudahbayar', 'numerical'),
