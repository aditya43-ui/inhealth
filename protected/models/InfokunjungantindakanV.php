...
/**
 * This is the model class for table "infokunjungantindakan_v".
 *
 * The followings are the available columns in table 'infokunjungantindakan_v':
 ...
 */
class InfokunjungantindakanV extends CActiveRecord
{
	/**
	 * @return string the associated database table name
	 */
	public $tgl_awal, $tgl_akhir, $tgl_awal1, $tgl_akhir1;

	public function tableName()
	{
		return 'infokunjungantindakan_v';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('alamatemail, penjamin_nama, ruangan_nama, instalasi_nama, jeniskasuspenyakit_nama, nokartukeluarga', 'length', 'max'=>100),
	 ...
	 * @return InfokunjungantindakanV the static model class
	 */
