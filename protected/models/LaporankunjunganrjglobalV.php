...
/**
 * This is the model class for table "laporankunjunganrjglobal_v".
 *
 * The followings are the available columns in table 'laporankunjunganrjglobal_v':
 ...
 * @property string $icd_komplikasi1
 * @property string $icd_komplikasi2
 * @property string $icd_komplikasi3
 * @property string $icd_komplikasi4
 * @property string $icd_komplikasi5
 ...
 */
class LaporankunjunganrjglobalV extends CActiveRecord
{
	/**
	...
	{
		return 'laporankunjunganrjglobal_v';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('jenisidentitas, namadepan, jeniskelamin, agama, statusperkawinan, no_mobile_pasien, no_pendaftaran, no_rujukan, tekanandarah, kasusdiagnosa', 'length', 'max'=>20),
	...
	public function attributeLabels()
	{
		return array(
			...
			'umur_hari' => 'Umur Hari',
			'icd_komplikasi1' => 'Icd Komplikasi1',
			'icd_komplikasi2' => 'Icd Komplikasi2',
			'icd_komplikasi3' => 'Icd Komplikasi3',
			'icd_komplikasi4' => 'Icd Komplikasi4',
			'icd_komplikasi5' => 'Icd Komplikasi5',
			'sistem' => 'Sistem',
			'nama_pegawailoket' => 'Nama Pegawailoket',
			'dtd_nama' => 'Dtd Nama',
			'kasusdiagnosa' => 'Kasusdiagnosa',
			'nama_pegawaiverif' => 'Nama Pegawaiverif',
	...
	public function search()
	{
		...
		$criteria->compare('waktuverifikasipasien',$this->waktuverifikasipasien,true);
		...
		$criteria->compare('asalrujukan',$this->asalrujukan,true);
		$criteria->compare('alamatrujukan',$this->alamatrujukan,true);
		$criteria->compare('diagnosa',$this->diagnosa,true);
		$criteria->compare('is_anamnesa',$this->is_anamnesa);
		$criteria->compare('is_periksafisik',$this->is_periksafisik);
		$criteria->compare('is_diagnosa',$this->is_diagnosa);
		...
		$criteria->compare('icd_komplikasi1',$this->icd_komplikasi1,true);
		$criteria->compare('icd_komplikasi2',$this->icd_komplikasi2,true);
		$criteria->compare('icd_komplikasi3',$this->icd_komplikasi3,true);
		$criteria->compare('icd_komplikasi4',$this->icd_komplikasi4,true);
		$criteria->compare('icd_komplikasi5',$this->icd_komplikasi5,true);
	 ...
	 * @return LaporankunjunganrjglobalV the static model class
	 */
