...
class LaporantindakanruanganV extends CActiveRecord
{
	...
	{
		return 'laporantindakanruangan_v';
	}
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('tindakanpelayanan_id,instalasi_id,ruangan_id, daftartindakan_id, daftartindakan_kode, daftartindakan_nama, daftartindakan_katakunci, tgl_tindakan, create_time, update_time, create_loginpemakai_id, update_loginpemakai_id, create_ruangan, qty_tindakan, tarif_satuan, tindakansudahbayar_id, carabayar_id, carabayar_nama, penjamin_id, penjamin_nama', 'safe'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'daftartindakan_katakunci' => 'Kata Kunci Tindakan',
