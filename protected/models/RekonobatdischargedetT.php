...
/**
 * This is the model class for table "rekonobatdischargedet_t".
 *
 * The followings are the available columns in table 'rekonobatdischargedet_t':
 * @property integer $rekonobatdischargedet_id
 ...
 * @property RekonobatdischargeT $rekonobatdischarge
 */
class RekonobatdischargedetT extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return RekonobatdischargedetT the static model class
	 */
	...
	{
		return 'rekonobatdischargedet_t';
	}
	...
	public function rules()
	{
		...
		return array(
			array('rekonobatdischarge_id, create_time, create_loginpemakai', 'required'),
			array('rekonobatdischarge_id, create_ruangan', 'numerical', 'integerOnly'=>true),
			...
			array('rekonobatdischargedet_id, rekonobatdischarge_id, nama_obat, dosis, frekuensi, cara_pemberian, waktu_pemberian, jumlah_obat, tindaklanjut, keterangan, create_time, update_time, create_loginpemakai, update_loginpemakai, create_ruangan', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'rekonobatdischarge' => array(self::BELONGS_TO, 'RekonobatdischargeT', 'rekonobatdischarge_id'),
		);
	}
	...
	{
		return array(
			'rekonobatdischargedet_id' => 'Rekonobatdischargedet',
	...
	public function search()
	{
		...
		$criteria->compare('rekonobatdischargedet_id',$this->rekonobatdischargedet_id);
