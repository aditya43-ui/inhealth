...
/**
 * This is the model class for table "informasipembayaranrawatjalan_v".
 *
 * The followings are the available columns in table 'informasipembayaranrawatjalan_v':
 ...
 */
class InformasipembayaranrawatjalanV extends CActiveRecord
{
	/**
	...
	{
		return 'informasipembayaranrawatjalan_v';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('tglalokasi', 'length', 'max'=>255),
	 ...
	 * @return InformasipembayaranrawatjalanV the static model class
	 */
