...
/**
 * This is the model class for table "informasikasirmcu_v".
 *
 * The followings are the available columns in table 'informasikasirmcu_v':
 ...
 */
class InformasikasirmcuV extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return InformasikasirmcuV the static model class
	 */
