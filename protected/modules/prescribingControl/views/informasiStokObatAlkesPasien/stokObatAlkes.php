...
if (isset($_GET['frame'])){
    ...
    echo CHtml::link(Yii::t('mds','{icon} Close', array('{icon}'=>'<i class="entypo-cancel"></i>')), 'javascript:void(0);', array('class' => 'btn btn-default', 'onclick'=>'$("#dialogStokObat").attr("src",$(this).attr("href")); window.parent.$("#dialogStokObat").dialog("close"); return false;'));
?>
