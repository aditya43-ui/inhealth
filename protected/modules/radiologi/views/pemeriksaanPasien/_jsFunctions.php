...
<script type='text/javascript'>
    ...
    const approveFrame = (obj, frameObj) => {
        ...
        if(tab == 'smart'){
            cekRM();
            $(frameObj).removeAttr("src", "<?php echo $baseUrl; ?>?r=" + tab + "<?php echo $gets; ?>&frame=1");
    ...
    const cekSimpanTabulasi = (frameObj, tabObj, dari = 'tab') => {   
        ...
        console.log('changed: ' + form.attr("changed"));
        ...
        if (active == 0){
            ...
            if (sukses !== 1 && changed == "true") { // && tabw.includes(judul_sblm)){
