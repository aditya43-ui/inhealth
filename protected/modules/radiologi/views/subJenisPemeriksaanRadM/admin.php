<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="fas fa-layer-group"></i> Pengaturan <b>Sub-Jenis Pemeriksaan Radiologi</b>
        </div>
    </div>
    <div class="panel-body table-responsive">
        <?php
        $this->breadcrumbs = array(
            'Sub-Jenis Pemeriksaan Radiologi',
        );
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="entypo-credit-card"></i> Tabel <b>Sub-Jenis Pemeriksaan Radiologi</b>
                </div>
            </div>
            <div class="panel-body table-responsive">
                <?php
                        ...
                        array(
                            ...
                            'buttons' => array(
                                'update' => array(
                                    ...
                                    'options' => array('rel' => 'tooltip', 'title' => 'Ubah Sub-Jenis Pemeriksaan Radiologi'),
                                ),
                            ),
                        ),
                        array(
                            ...
                            'buttons' => array(
                                'remove' => array(
                                    ...
                                    'url' => 'Yii::app()->createUrl("' . Yii::app()->controller->module->id . '/' . Yii::app()->controller->id . '/nonActive",array("id"=>$data->subjenis_pemeriksaanrad_id))',
        ...
        <div class="form-actions">
            <?php
            echo CHtml::link(
                Yii::t('mds', '{icon} Tambah Sub-Jenis Pemeriksaan Radiologi', array('{icon}' => '<i class="icon-plus icon-white"></i>')),
                $this->createUrl(Yii::app()->controller->id . '/create', array('modul_id' => Yii::app()->session['modul_id'])),
                array('title' => 'Tambah Sub-Jenis Pemeriksaan Radiologi', 'class' => 'btn btn-danger',)
            );
