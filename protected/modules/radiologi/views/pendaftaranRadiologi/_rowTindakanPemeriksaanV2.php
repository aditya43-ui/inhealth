<tr <?php if(!empty($modTindakan->tindakansudahbayar_id)){?> style="background-color: #00FF00 !important;" <?php } ?>>
    ...
    <td>
        <span name="[ii][pemeriksaanrad_nama]" class="nama-daftatindakan"><?php echo (!empty($modTindakan->daftartindakan_id) ? $modTindakan->getPemeriksaanRad()->pemeriksaanrad_nama : "-") ?></span>
    ...
    <td <?php echo Params::HIDDEN_HARGA ?>>
        <?php echo CHtml::activeTextField($modTindakan,'[ii]tarif_tindakan',array('readonly'=>true,'readonly'=>true,'class'=>' col-sm-6 integer')); ?>
    </td>
