...
<div class="control-group">
    ...
    <div class="controls">
        <?php echo $form->textField($modPasien, 'anakke', array('placeholder' => '00', 'class' => 'span1 integer anakke', 'maxlength' => 2, 'onkeypress' => "return $(this).focusNextInputField(event)",'onblur' => 'cekAnakke2()')) . ' dari '; ?>
        <?php echo $form->textField($modPasien, 'jumlah_bersaudara', array('placeholder' => '00', 'class' => 'span1 integer saudara', 'maxlength' => 2, 'onkeypress' => "return $(this).focusNextInputField(event)", 'onblur' => 'cekAnakke()')) . ' bersaudara'; ?>
    </div>
</div>