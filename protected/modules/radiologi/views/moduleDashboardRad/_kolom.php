...
<div class="col-md-3 col-sm-6 col-sm-12">
    <div class="tile-stats tile-red">
        ...
        <h3>Rujukan Pasien Rawat Jalan</h3>
        <p>Rujukan pasien dari rawat jalan hari ini.</p>
    </div>
</div>
...
<div class="col-md-3 col-sm-6 col-sm-12">
    <div class="tile-stats tile-green">
        ...
        <h3>Rujukan Pasien Rawat Inap</h3>
        <p>Rujukan pasien dari rawat inap hari ini.</p>
    </div>
</div>
...
<div class="col-md-3 col-sm-6 col-sm-12">
    <div class="tile-stats tile-aqua">
        ...
        <h3>Rujukan Pasien Rawat Darurat</h3>
        <p>Rujukan pasien dari rawat darurat hari ini.</p>
    </div>
</div>
...
<div class="col-md-3 col-sm-6 col-sm-12">
    <div class="tile-stats tile-blue">
        ...
        <h3>Rujukan Pasien Luar</h3>
        <p>Rujukan pasien dari luar rumah sakit hari ini.</p>
    </div>
</div>