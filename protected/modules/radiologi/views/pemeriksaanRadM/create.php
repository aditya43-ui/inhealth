<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="far fa-plus-square"></i> Tambah <b>Pemeriksaan Radiologi</b>
        </div>
    </div>
    <div class="panel-body">
        ...
        ?>
        <?php echo $this->renderPartial('_form', array('model' => $model, 'modReferensiHasil' => $modReferensiHasil, 'modRefDet' => $modRefDet)); ?>
