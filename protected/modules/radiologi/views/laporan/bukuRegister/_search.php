        ...
        <div class="col-sm-6" id="searching">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    echo '<table>
                    <tr>
                        <td style="width: 80px;">' . CHtml::radioButton('tampilGrafik', true, array('name' => 'dataGrafik', 'id' => 'rwilayah',  'value' => 'wilayah')) . ' <label for="rwilayah">Wilayah</label></td>                                               
                        <td>' . CHtml::radioButton('tampilGrafik', false, array('name' => 'dataGrafik', 'id' => 'rcarabayar',  'value' => 'carabayar')) . ' <label for="rcarabayar">Jenis Penjamin</label></td>                                               
                    </tr>                                            
                </table>';
                    ?>
                </div>
