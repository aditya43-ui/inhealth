...
$this->breadcrumbs = array(
    'Laporan Pemeriksaan Rujukan RS'
);

$url = Yii::app()->createUrl('radiologi/laporan/FrameGrafikPemeriksaanRujukanRS&id=1');
...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="entypo-newspaper"></i> Laporan <b>Pemeriksaan Rujukan RS</b>
        </div>
    </div>
    <div class="panel-body">
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                ...
                <?php $this->renderPartial($this->pathViewLab . '_search', array(
                    'model' => $model,
                )); ?>
                <!--</fieldset>-->
                <!--search-form-->
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="entypo-credit-card"></i> Tabel <b>Pemeriksaan Rujukan RS</b>
                </div>
            </div>
            <div class="panel-body table-responsive">
                <?php $this->renderPartial($this->pathViewLab . '_table', array('model' => $model)); ?>
            </div>
        </div>
        ...
        $urlPrint =  Yii::app()->createAbsoluteUrl($module . '/' . $controller . '/printPemeriksaanRujukanRS');
