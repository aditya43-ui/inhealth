...
$url = Yii::app()->createUrl('radiologi/laporan/FrameGrafikPemeriksaanRujukanKeluar&id=1');
...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="entypo-newspaper"></i> Laporan <b>Pemeriksaan Rujukan Keluar</b>
        </div>
    </div>
    <div class="panel-body">
        ...
        $urlPrint =  Yii::app()->createAbsoluteUrl($module . '/' . $controller . '/printPemeriksaanRujukanKeluar');
