<?php
/**
* - digunakan sebagai format dasar hasil pemeriksan USG Urologi
* 
...
<table width="100%"  id="tblFormHasilPemeriksaanRad" class="table table-bordered table-striped table-condensed">
    ...
    //            echo $i;                
                if ($i == 0) {                    
                    $this->widget('ext.redactorjs.Redactor',array('model'=>$hasil,  'id'=> 'ROHasilPemeriksaanRadT_'.$i.'_rendextra_hasilexpertise','attribute'=>'['.$i.']hasilexpertise[0]','name'=>'ROHasilPemeriksaanRadT_'.$i.'_hasilexpertise','toolbar'=>'mini','height'=>'300px'));
                } else {
                   $this->widget('ext.redactorjs.Redactor',array('model'=>$hasil,'id'=> 'ROHasilPemeriksaanRadT_'.$i.'_rendextra_hasilexpertise','attribute'=>'['.$i.']hasilexpertise[0]','name'=>'ROHasilPemeriksaanRadT_'.$i.'_hasilexpertise','toolbar'=>'mini','height'=>'300px'));
                }
                 ?>
        ...
        <tr>
            ...
            <td id="kolHasil_<?php echo $i;?>" style="text-align:center;">
               <?php               
                if ($i == 0) {
                    $this->widget('ext.redactorjs.Redactor',array('id'=> 'ROHasilPemeriksaanRadT_'.$i.'_rensinistra_hasilexpertise','model'=>$hasil,'attribute'=>'['.$i.']hasilexpertise[1]','name'=>'ROHasilPemeriksaanRadT_'.$i.'_hasilexpertise','toolbar'=>'mini','height'=>'300px'));
                } else {
                   $this->widget('ext.redactorjs.Redactor',array('id'=> 'ROHasilPemeriksaanRadT_'.$i.'_rensinistra_hasilexpertise','model'=>$hasil,'attribute'=>'['.$i.']hasilexpertise[1]','name'=>'ROHasilPemeriksaanRadT_'.$i.'_hasilexpertise','toolbar'=>'mini','height'=>'300px'));
                }
                 ?>
         ...
         <tr>
            ...
            <td id="kolHasil_<?php echo $i;?>" style="text-align:center;">
               <?php               
                if ($i == 0) {
                    $this->widget('ext.redactorjs.Redactor',array('id'=> 'ROHasilPemeriksaanRadT_'.$i.'_buliprostat_hasilexpertise','model'=>$hasil,'attribute'=>'['.$i.']hasilexpertise[2]','name'=>'ROHasilPemeriksaanRadT_'.$i.'_hasilexpertise','toolbar'=>'mini','height'=>'300px'));
                } else {
                   $this->widget('ext.redactorjs.Redactor',array('id'=>'ROHasilPemeriksaanRadT_'.$i.'_buliprostat_hasilexpertise', 'model'=>$hasil,'attribute'=>'['.$i.']hasilexpertise[2]','name'=>'ROHasilPemeriksaanRadT_'.$i.'_hasilexpertise','toolbar'=>'mini','height'=>'300px'));
                }
                 ?>
        ...
        <tr>
            ...
            <td id="kolHasil_<?php echo $i;?>" style="text-align:center;">
               <?php               
                if ($i == 0) {
                    $this->widget('ext.redactorjs.Redactor',array('id'=> 'ROHasilPemeriksaanRadT_'.$i.'_prostat_hasilexpertise','model'=>$hasil,'attribute'=>'['.$i.']hasilexpertise[3]','name'=>'ROHasilPemeriksaanRadT_'.$i.'_hasilexpertise','toolbar'=>'mini','height'=>'300px'));
                } else {
                   $this->widget('ext.redactorjs.Redactor',array('id'=>'ROHasilPemeriksaanRadT_'.$i.'_prostat_hasilexpertise', 'model'=>$hasil,'attribute'=>'['.$i.']hasilexpertise[3]','name'=>'ROHasilPemeriksaanRadT_'.$i.'_hasilexpertise','toolbar'=>'mini','height'=>'300px'));
                }
                 ?>
