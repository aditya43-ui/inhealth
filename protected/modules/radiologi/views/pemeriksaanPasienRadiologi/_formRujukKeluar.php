...
<div class="col-sm-6">
    ...
    <div class="control-group">
        ...
        <?php 
            ...
            //	'empty' => '-- Pilih --'));
            echo CHtml::activeDropDownList($modRujukKeluar, '['.$i.']labklinikrujukan_id', CHtml::listData($modRujukKeluar->KlinikRujukanItems, 'rujukankeluar_id', 'rumahsakitrujukan'), array('class' => 'span2 txt_klinikrujukan', 'onkeypress' => "return $(this).focusNextInputField(event)",
                'empty' => '-- Pilih --'));
        ?>
        </div>
    </div>
