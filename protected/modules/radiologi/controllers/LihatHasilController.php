...
{
  public $path_view = 'radiologi.views.lihatHasil.';
  ...
  public function actionHasilPeriksa($pendaftaran_id, $pasien_id, $pasienmasukpenunjang_id, $caraPrint = '')
  {
    ...
    $pemeriksa = PegawaiM::model()->findByPk($modPasienMasukPenunjang->pegawai_id);
    ...
    $rumahSakit = ProfilrumahsakitM::model()->findByPk(Params::getDefaultProfilRS());
