...
//    public $tgl_rm_akhir;
    ...
    public function rules()
    {
            ...
            return array(
                    ...
                    array('pekerjaan_id, kelurahan_id, pendidikan_id, propinsi_id, kecamatan_id, suku_id, profilrs_id, kabupaten_id, rt, rw, anakke, jumlah_bersaudara, rt_domisili, rw_domisili, propinsi_domisili_id, kabupaten_domisili_id, kecamatan_domisili_id, kelurahan_domisili_id', 'numerical', 'integerOnly'=>true),
                    ...
                    array('pasien_id,nama_ibu, nama_ayah,is_ambilfoto,update_time, update_loginpemakai_id, tgl_meninggal,tgl_rm_awal,tgl_rm_akhir', 'safe'),
    ...
    public function attributeLabels()
    {
            return array(
                    ...
                    'tgl_rm_akhir' => 's/d',
                    'alamat_domisili_pasien' => 'Alamat Pasien',
                    'rt_domisili' => 'RT/RW',
                    'rw_domisili' => 'RW',
...
//            $criteria->addBetweenCondition('tgl_rekam_medik', $this->tgl_rm_awal, $this->tgl_rm_akhir);
			...
			if(!empty($this->propinsi_domisili_id)){
				$criteria->addCondition("t.propinsi_domisili_id = ".$this->propinsi_domisili_id);					
			}
			if(!empty($this->kabupaten_domisili_id)){
				$criteria->addCondition("t.kabupaten_domisili_id = ".$this->kabupaten_domisili_id);					
			}
			if(!empty($this->kecamatan_domisili_id)){
                $criteria->addCondition("t.kecamatan_domisili_id = ".$this->kecamatan_domisili_id);					
			}
			if(!empty($this->kelurahan_domisili_id)){
                $criteria->addCondition("t.kelurahan_domisili_id = ".$this->kelurahan_domisili_id);					
			}
            $criteria->compare('LOWER(alamat_domisili_pasien)',strtolower($this->alamat_domisili_pasien),true);
            $criteria->compare('rt_domisili',$this->rt_domisili);
            $criteria->compare('rw_domisili',$this->rw_domisili);
