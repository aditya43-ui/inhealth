...
class BSPegawairuanganV extends PegawairuanganV {
	...
	public function searchPegawaiMenyetujui()
	{
		...
		$criteria->group = 'jabatan_id,nomorindukpegawai,nama_pegawai,gelardepan,gelarbelakang_nama,alamat_pegawai,pegawai_id';
