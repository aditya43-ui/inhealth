<?php
class ChecklistPostOperasiController extends MyAuthController
{
    public $layout='//layouts/column1';
    public $defaultAction = 'index';
    public $path_view = 'bedahSentral.views.checklistPostOperasi.';
    ...
    public function actionIndex($pendaftaran_id, $prepostoperasi_id = null)
    {
      ...
      if(isset($_POST['PrepostoperasiT'])){
          ...
          try {
              ...
              $model->jenischecklist = "Post Operasi";
              ...
              if($model->save()){
                  ...
                  // $dataDetailSimpan = $this->simpanDataDetail($_POST['PrepostoperasidetailT'], $model);
  ...
  public function actionDetail($prepostoperasi_id, $typeruangan)
  {
      ...
      $this->render($this->path_view.'_detailRiwayat',array(
        'model'=>$model,
        'modDetail'=>$modDetail
      ));
  }
