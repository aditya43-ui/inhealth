...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="glyphicon glyphicon-file"></i> Infomasi <b>Kunjungan RS</b>
        </div>
    </div>
                ...
                <?php $this->widget('ext.bootstrap.widgets.BootGridView', array(
                    ...
                    'columns' => array(
                        ...
                        array(
                            ...
                            'type' => 'raw',
                            'value' => 'CHtml::link("<i class=\"icon-form-roperasi\"></i>",Yii::app()->createUrl("bedahSentral/PendaftaranBedahSentralRujukanRS/index",array("pendaftaran_id"=>$data->pendaftaran_id,"instalasi_id"=>$data->instalasi_id)), array("rel"=>"tooltip","title"=>"Klik untuk Rencana Operasi"))',  'htmlOptions' => array('style' => 'text-align: center; width: 60px;'),
                        ),
                    ),
