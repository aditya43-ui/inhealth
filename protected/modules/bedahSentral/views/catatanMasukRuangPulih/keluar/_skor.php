...
if (empty($det)) {
    ...
    $det->jenisaldrette = "Keluar Ruang Pulih";
}
...
<table class="table table-bordered table-condensed" id="tab_skor">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?php echo $form->textField($model, 'totalskor_aldrettekeluarrpulih', array('class'=>'span1 total_skor', 'readonly'=>true, 'style'=>'text-align: right;')); ?></td>
