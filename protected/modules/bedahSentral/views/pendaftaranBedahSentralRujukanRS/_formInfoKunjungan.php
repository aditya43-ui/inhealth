    ...
    <div class="col-sm-6">
        <div class="control-group">
            ...
            <div class="controls">
                ...
                <?php echo CHtml::textField('no_pendaftaran', $modKunjungan->no_pendaftaran, array('readonly' => true, 'class' => 'span4', 'onkeyup' => "return $(this).focusNextInputField(event);")); ?>
                <?php
                /*$this->widget('MyJuiAutoComplete', array(
                                ...
                                'htmlOptions'=>array('placeholder'=>'No. Pendaftaran','class'=>'all-caps','rel'=>'tooltip','title'=>'No. Pendaftaran','disabled' => $disabled,
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo CHtml::hiddenField('kelaspelayananasal_id', $modKunjungan->kelaspelayanan_id, array('readonly' => true, 'class' => 'span4', 'onkeyup' => "return $(this).focusNextInputField(event);")); ?>
                <?php echo CHtml::textField('kelaspelayananasal_nama', $modKunjungan->kelaspelayanan_nama, array('readonly' => true, 'class' => 'span4', 'onkeyup' => "return $(this).focusNextInputField(event);")); ?>
            </div>
        </div>
        <div class="control-group hidden">
            <?php echo CHtml::label("Jenis Kasus Penyakit Asal", 'jeniskasuspenyakit_nama', array('class' => 'control-label')); ?>
            <div class="controls">
                <?php echo CHtml::hiddenField('jeniskasuspenyakitasal_id', $modKunjungan->jeniskasuspenyakit_id, array('readonly' => true, 'class' => 'span4', 'onkeyup' => "return $(this).focusNextInputField(event);")); ?>
                <?php echo CHtml::textField('jeniskasuspenyakitasal_nama', $modKunjungan->jeniskasuspenyakit_nama, array('readonly' => true, 'class' => 'span4', 'onkeyup' => "return $(this).focusNextInputField(event);"));
                ?>
            </div>
        </div>
        <div class="control-group">
            <?php echo CHtml::label("Diagnosa Ruangan Asal", 'namadiagnosa', array('class' => 'control-label')); ?>
            <div class="controls">
                <?php echo CHtml::textArea('namadiagnosa', $modKunjungan->namadiagnosa, array('readonly' => true, 'class' => 'span4', 'onkeyup' => "return $(this).focusNextInputField(event);")); ?>
            </div>
        </div>
        <div class="control-group">
    ...
    <div class="col-sm-6">
        <div class="control-group">
            ...
            <div class="controls">
                ...
                <?php echo CHtml::textField('no_rekam_medik', $modKunjungan->no_rekam_medik, array('readonly' => true, 'class' => 'span4', 'onkeyup' => "return $(this).focusNextInputField(event);")); ?>
                <?php
                /*$this->widget('MyJuiAutoComplete', array(
                                'name'=>'no_rekam_medik',
                                ...
                                'htmlOptions'=>array('placeholder'=>'No. Rekam Medik','class'=>'all-caps','rel'=>'tooltip','title'=>'No. rekam medik untuk mencari data kunjungan','disabled' => $disabled,
                                    'onkeyup'=>"return $(this).focusNextInputField(event)",
                                    ),
                            )); */
                ?>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                ...
                <?php echo CHtml::textField('nama_pasien', $modKunjungan->nama_pasien, array('readonly' => true, 'class' => 'span4', 'onkeyup' => "return $(this).focusNextInputField(event);")); ?>
                <?php
                /*$this->widget('MyJuiAutoComplete', array(
                                'name'=>'nama_pasien',
                                ...
                                'htmlOptions'=>array('placeholder'=>'Nama Pasien','rel'=>'tooltip','title'=>'Ketik nama pasien untuk mencari data kunjungan','disabled' => $disabled,
                                    'onkeyup'=>"return $(this).focusNextInputField(event)",
                                    ),
                            )); */
                ?>
