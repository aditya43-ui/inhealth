...
<tr>
    ...
    <td>
        ...
        <?php echo CHtml::hiddenField("paketBmhp[0][hargajual]", round($PaketBmhp->obatalkes->hargajual),array('readonly'=>true,'class'=>'inputFormTable span1')); ?>
        <?php echo CHtml::hiddenField("paketBmhp[0][harganetto]", round($PaketBmhp->obatalkes->harganetto),array('readonly'=>true,'class'=>'inputFormTable span1')); ?>
        <?php echo CHtml::hiddenField("paketBmhp[0][hargasatuan]", round($PaketBmhp->obatalkes->hargajual),array('readonly'=>true,'class'=>'inputFormTable span1')); ?>
