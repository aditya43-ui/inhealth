...
$form = $this->beginWidget('ext.bootstrap.widgets.BootActiveForm',array(
	...
	<div class="row-fluid">
		<div class="control-group">
			...
			<div class="controls" style="float:left;padding-left:25px;">
				<?php 
	...
	<div class="form-actions">
                <?php echo CHtml::htmlButton(Yii::t('mds','{icon} Tambah',array('{icon}'=>'<i class="'.MyIcon::getIcons('tambah-baris').'"></i>')),
								array('class' => 'btn btn-danger', 'type'=>'button', 'onclick'=>'simpanKruPegawai();'));//,'onKeypress'=>'return formSubmit(this,event)' ?>
	</div>
