 ...
 * 
 */
//                    echo '<pre>';        var_dump($model->attributes, $modRencanaOperasi->attributes); die();
                    ...
                    <table class="table noborder paddingtext">
                        ...
                        ?>
                                <tr>
                                    ...
                                    }elseif ($signout['type'] == Params::INPUTTYPE_DATE){
                                        $arr = array(                                                
                                            'form_id'=>$signout['form_id'], 
                                            'check_id'=>$signout['check_id'],                         
                                        );
                                        echo '<td colspan="2">';
                                        CustomFunction::loadField($modDet,'[' . $signout['form_id'] . $signout['check_id'] . ']]signoutdet_isian', $signout['type'], $arr)."&nbsp;";                                                                        
                                        echo '</td>';
                                    }
                                    ?>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        if ($check['type'] == Params::INPUTTYPE_CHECK) {
                                            ...
                                            echo '<td colspan="2">';
                                            CustomFunction::loadField($modDet,'[' . $signout['form_id'] . $check['check_id'] . ']]signoutdet_isian', $check['type'], $arr)."&nbsp;";                                                                        
                                            echo '</td>';
                                        }
                                        ?>
                                    </tr>
    ...
    <div class="col-sm-6">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                ...
                echo $form->hiddenField($model, 'dokteranestesi_id', array('readonly' => true));
