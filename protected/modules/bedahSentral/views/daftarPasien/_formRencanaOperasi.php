        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <div class="control-group">
                    <?php
                    echo $form->labelEx(
                            $modRencanaOperasiAttrib, 'tglrencanaoperasi', array(
                        'class' => 'control-label'
                            )
                    );
                    ?>
                ...
                echo $form->dropDownListRow(
                        $modRencanaOperasiAttrib, 'kamarruangan_id', CHtml::listData($modPenunjang->getKamarKosongItems(Params::RUANGAN_ID_BEDAH), 'kamarruangan_id', 'KamarDanTempatTidur'), array(
                    'empty' => '-- Pilih --',
                    'onkeypress' => "return $(this).focusNextInputField(event)"
                        )
                );
                ...
                <span id="urut-<?php echo str_replace(' ', '-', strtolower(Params::KRUBEDAH_OPERATOR)); ?>">
                    <div class="control-group pelaksanaoperasi awal hide">
                        <?php echo CHtml::label('Operator <span class="required">*</span>', 'dokter', array('class' => 'control-label required')) ?>
                        <div class="controls">
                            <?php
//                            echo $form->dropDownList(
//                                    $modRencanaOperasiAttrib, 'dokterpelaksana1_id', CHtml::listData($modRencanaOperasiAttrib->getDokterItems(Params::RUANGAN_ID_BEDAH), 'pegawai_id', 'namaLengkap'), array(
//                                'empty' => '-- Pelaksana 1 --',
//                                'onkeypress' => "return $(this).focusNextInputField(event)",
...
//                            );
                ...
                <span id="urut-<?php echo str_replace(' ', '-', strtolower(Params::KRUBEDAH_ASISTEN_OPERATOR)); ?>">
                    <div class="control-group pelaksanaoperasi awal">
                        ...
                        <div class="controls">
                            <?php
                            echo $form->dropDownList(
                                    $modRencanaOperasiAttrib, 'dokterpelaksana2_id', CHtml::listData($modRencanaOperasiAttrib->getDokterParamedisItems(Params::RUANGAN_ID_BEDAH), 'pegawai_id', 'namaLengkap'), array(
                                'empty' => '-- Pelaksana 2 --',
                                'onkeypress' => "return $(this).focusNextInputField(event)",
                                'class' => 'span3 krubedah_id'
                                    )
                ...
                <span id="urut-<?php echo str_replace(' ', '-', strtolower(Params::KRUBEDAH_PETUGAS_RR)); ?>">
                    <div class="control-group pelaksanaoperasi awal">
                        ...
                        <div class="controls">
                            <?php
                            echo $form->dropDownList(
                                    $modRencanaOperasiAttrib, 'suster_id', CHtml::listData($modRencanaOperasiAttrib->getParamedisItems(Params::RUANGAN_ID_BEDAH), 'pegawai_id', 'nama_pegawai'), array(
                                'empty' => '-- Pilih --',
                                'onkeypress' => "return $(this).focusNextInputField(event)",
                                'class' => 'span3 krubedah_id'
                                    )
                ...
                <span id="urut-<?php echo str_replace(' ', '-', strtolower(Params::KRUBEDAH_PERAWAT_INSTRUMENT)); ?>">
                    <div class="control-group pelaksanaoperasi awal">
                        ...
                        <div class="controls">
                            <?php
                            echo $form->dropDownList(
                                    $modRencanaOperasiAttrib, 'bidan_id', CHtml::listData($modRencanaOperasiAttrib->getParamedisItems(Params::RUANGAN_ID_BEDAH), 'pegawai_id', 'nama_pegawai'), array(
                                'empty' => '-- Pilih --',
                                'onkeypress' => "return $(this).focusNextInputField(event)",
                                'class' => 'span3 krubedah_id'
                                    )
                ...
                <span id="urut-<?php echo str_replace(' ', '-', strtolower(Params::KRUBEDAH_PERAWAT_SIRKULER)); ?>">
                    <div class="control-group pelaksanaoperasi awal">
                        ...
                        <div class="controls">
                            <?php
                            echo $form->dropDownList(
                                    $modRencanaOperasiAttrib, 'perawatsirkuler_id', CHtml::listData($modPenunjang->getParamedisItems(Params::RUANGAN_ID_BEDAH), 'pegawai_id', 'nama_pegawai'), array(
                                'empty' => '-- Pilih --',
                                'onkeypress' => "return $(this).focusNextInputField(event)",
                                'class' => 'span3 krubedah_id'
                                    )
                ...
                echo $form->textAreaRow(
                        $modRencanaOperasiAttrib, 'keterangan_rencana', array(
                    'class' => 'span3'
                        )
                );
                ?>
...
//                );
                ...
                <span id="urut-<?php echo str_replace(' ', '-', strtolower(Params::KRUBEDAH_DOKTER_ANESTESI)); ?>">
                    <div class="control-group pelaksanaoperasi awal hide">
                        ...
                        <div class="controls">
                            <?php
//                            echo $form->dropDownList($modAnastesi, 'dokteranastesi_id', CHtml::listData($modPenunjang->getDokterItems(Params::RUANGAN_ID_BEDAH), 'pegawai_id', 'namaLengkap'), array('empty' => '-- Pilih --', 'onkeypress' => "return $(this).focusNextInputField(event)", 'value' => $modRencanaOperasiAttrib->dokteranastesi_id,
//                                'class' => 'span3 krubedah_id'));
                            ?>
                        </div>
                    </div>
                ...
                <span id="urut-<?php echo str_replace(' ', '-', strtolower(Params::KRUBEDAH_PENATA_ANESTESI)); ?>">
                    <div class="control-group pelaksanaoperasi awal">
                        ...
                        <div class="controls">										
                            <?php
                            echo $form->dropDownList($modRencanaOperasiAttrib, 'paramedis_id', CHtml::listData($modRencanaOperasiAttrib->getParamedisItems(Params::RUANGAN_ID_BEDAH), 'pegawai_id', 'nama_pegawai'), array(
                                'empty' => '-- Pilih --',
                                'onkeypress' => "return $(this).focusNextInputField(event)",
                                'class' => 'span3 krubedah_id'
                                    )
        ...
        <table id="tblFormRencanaOperasi" class="table table-striped table-condensed table-bordered">
            <thead>
                <tr>
                    ...
                    <th>Jumlah</th>
                    <th>Operator<span class="required">*</span></th>
                    <th>% Operator</th>
                    <th>Dokter Anestesi</th>
                    <th>% Dokter Anestesi</th>
                    <th>Nominal Tarif</th>
                    <th> Persentase Tarif</th>
                    <th <?php echo Params::HIDDEN_HARGA ?>>Tarif Satuan</th>
                    <th class="hide">Tipe Anastesi</th>
            ...
            foreach ($modRencanaOperasi as $i => $rencanaOperasi) {
                ...
                // $cekTarif = PerhitungantarifoperasiV::model()->findByAttributes(
                //         array(
                //             'rencanaoperasi_id' => $rencanaOperasi->rencanaoperasi_id,
                //         )
                // );
                ...
                if ($cekTindakan) {
                    ...
                    $persencyto_tind = $modTindakanTarif->persencyto_tind ?? 0;
                    ...
                    // $tarif = $cekTarif->harga_tariftindakan;
                    $tot_tarif += $tarif;
                    $persentase_dokteroperator = $rencanaOperasi->persentase_dokteroperator;
                    $persentase_dokteranestesi = $rencanaOperasi->persentase_dokteranestesi;
                ...
                <tr id="operasi_<?php echo $idOperasi; ?>">
                    <td>
                        <?php
                        echo CHtml::checkBox(
                                'BSTindakanPelayananT[' . $i . '][ceklis]', true, array(
                            'value' => $i,
                    ...
                    <td <?php echo Params::HIDDEN_HARGA ?>>
                        ...
                        echo CHtml::dropDownList(
                                'BSTindakanPelayananT[' . $i . '][golonganoperasi_id]', $rencanaOperasi->golonganoperasi_id, CHtml::listData(GolonganoperasiM::model()->getAll(), 'golonganoperasi_id', 'golonganoperasi_nama'), array(
                    ...
                    <td>
                        ...
                        echo CHtml::hiddenField(
                                "BSTindakanPelayananT[" . $i . "][daftartindakan_nama]", $daftarTindakanNama, array(
                            'class' => 'inputFormTabel',
                            'readonly' => true
                                )
                        );
                        echo CHtml::hiddenField(
                                "BSTindakanPelayananT[" . $i . "][daftartindakan_id]", $idDaftarTindakan, array(
                            'class' => 'inputFormTabel',
                            'readonly' => true
                                )
                        );
                        echo CHtml::hiddenField(
                                "BSTindakanPelayananT[" . $i . "][rencanaoperasi_id]", $rencanaOperasi->rencanaoperasi_id, array(
                            'class' => 'inputFormTabel span2',
                            'readonly' => true
                                )
                        );
                        echo CHtml::hiddenField(
                                'BSTindakanPelayananT[' . $i . '][is_operasibersama]', ($rencanaOperasi->is_operasibersama) ? 1 : 0, array(
                            'class' => 'inputFormTabel span2',
                            'readonly' => true
                                )
                        );
                        echo CHtml::hiddenField(
                                'BSTindakanPelayananT[' . $i . '][operasi_id]', $idOperasi, array(
                            'class' => 'inputFormTabel span2',
                            'readonly' => true
                                )
                        );
                        echo CHtml::hiddenField(
                                'BSTindakanPelayananT[' . $i . '][tindakanpelayanan_id]', $rencanaOperasi->tindakanpelayanan_id, array(
                            'class' => 'inputFormTabel lebar3',
                            'readonly' => true
                                )
                        );
                    ...
                    <td>
                        ...
                        echo CHtml::textField(
                                "BSTindakanPelayananT[" . $i . "][qty_tindakan]", $qty, array(
                            'class' => 'inputFormTabel span2 integer2 qty',
                    ...
                    <td>
                        <?php echo CHtml::dropDownList("BSTindakanPelayananT[" . $i . "][dokterpemeriksa1_id]",$rencanaOperasi->dokterpelaksana1_id,CHtml::listData($rencanaOperasi->getOperatorItems(Yii::app()->user->getState('ruangan_id')), 'pegawai_id', 'NamaLengkap'),array('class'=>'span3 pegawai_id_1 required')); ?>
                    </td>
                    <td>
                        <?php
                        echo CHtml::textField(
                                "BSTindakanPelayananT[" . $i . "][persentase_dokteroperator]", $persentase_dokteroperator, array(
                            'class' => 'inputFormTabel span2 integer2 persentase_dokteroperator',
                            'onblur' => 'hitungTotalRencana();',
                            'readonly' => true
                                )
                        );
                    ...
                    <td>
                        <?php echo CHtml::dropDownList("BSTindakanPelayananT[" . $i . "][dokteranastesi_id]",$rencanaOperasi->dokteranastesi_id,CHtml::listData($rencanaOperasi->getOperatorItems(Yii::app()->user->getState('ruangan_id')), 'pegawai_id', 'NamaLengkap'), array('class'=>'span3 pegawai_id_2')); ?>
                    </td>
                    <td>
                        <?php
                        echo CHtml::textField(
                                "BSTindakanPelayananT[" . $i . "][persentase_dokteranestesi]", $persentase_dokteranestesi, array(
                            'class' => 'inputFormTabel span2 integer2 persentase_dokteranestesi',
                            'onblur' => 'hitungTotalRencana();',
                            'readonly' => true
                                )
                        );
                    ...
                    <td <?php //echo Params::HIDDEN_HARGA ?>>
                        <?php
                                                    echo CHtml::textField("BSTindakanPelayananT[".$i."][tarif_tindakan]",
                                                        ...
                                                        array(
                                                            'class'=>'inputFormTabel lebar3 integer2 tariftindakan',
                                                            'readonly'=>true
                                                        )
                                                    );
                        echo CHtml::hiddenField(
                                "BSTindakanPelayananT[" . $i . "][tarif_satuan]", MyFormatter::formatNumberForPrint($tarifSatuan), array(
                     ...
                     <td <?php //echo Params::HIDDEN_HARGA ?>>
                        <?php
                        $rencanaOperasi->persentasi_tarif = number_format($rencanaOperasi->persentasi_tarif, 2,",","");
                        echo CHtml::textField(
                                "BSTindakanPelayananT[" . $i . "][persentase_tindakan]",$rencanaOperasi->persentasi_tarif , array(
                            'class' => 'inputFormTabel span2 float2 persentase',
                            'onblur' => 'hitungTotalRencana();',
                            'readonly' => true
                                )
                        ) . "%";
                    ...
                    <td class="hide">
                        ...
                        echo CHtml::dropDownList(
                                'BSTindakanPelayananT[' . $i . '][typeanastesi_id]', null, //nilai di load dengan javascript
                                //                                TypeAnastesiM::getItems(), //DISET NULL KARENA HARUS PILIH JENIS & ANASTESI DULU
                                array(), array('disabled' => false, 'class' => 'inputFormTabel span2 typeanastesi', 'style' => 'width:150px;', 'empty' => '-- Pilih --', 'onkeypress' => "return $(this).focusNextInputField(event)",)
                        );
                        ?>
                    </td>
                    <td <?php// echo Params::HIDDEN_HARGA ?>
                        <?php
                        echo CHtml::dropDownList(
                                'BSTindakanPelayananT[' . $i . '][cyto_tindakan]', $is_cyto, array(
                            1 => 'Ya',
                            0 => 'Tidak'
                                ), array(
                            'class' => 'inputFormTabel span2 is_cyto',
                            'onchange' => 'hitungTotalRencana();',
                        ...
                        <?php
                        echo CHtml::hiddenField(
                                "BSTindakanPelayananT[" . $i . "][persencyto_tind]", $persencyto_tind, array(
                            'class' => 'inputFormTabel span2',
                            'readonly' => true
                                )
                        );
                    ...
                    <td <?php echo Params::HIDDEN_HARGA ?>>
                        <?php
                        echo CHtml::textField(
                                "BSTindakanPelayananT[" . $i . "][tarif_cyto]", $tarif_cyto, array(
                    ...
                    <td <?php //echo Params::HIDDEN_HARGA ?>>
                        <?php
                        echo CHtml::textField(
                                "BSTindakanPelayananT[" . $i . "][total_tarif]", MyFormatter::formatNumberForPrint($tot_tarif), array(
                    ...
                    <td <?php //echo Params::HIDDEN_HARGA ?>>
                        <?php
                        echo CHtml::dropDownList(
                                'BSTindakanPelayananT[' . $i . '][statusoperasi]', "MULAI", LookupM::getItems('statusoperasi'), array(
                            'class' => 'inputFormTabel lebar3',
                            'empty' => '-- Pilih --',
                            'onkeypress' => "return $(this).focusNextInputField(event)",
                            'disabled' => true
                    ...
                    <td <?php echo Params::HIDDEN_HARGA ?>>
                        <?php
                        echo CHtml::dropDownList(
                                'BSTindakanPelayananT[' . $i . '][jenis_penyulit]', $rencanaOperasi->jenis_penyulit, LookupM::getItems('jenis_penyulit'), array(
                            'class' => 'inputFormTabel span2',
                            'empty' => '-- Pilih --',
                            'onkeypress' => "return $(this).focusNextInputField(event)"
                                )
...
<script>
    ...
    function hitungTotalRencana() {
        $("#tblFormRencanaOperasi tbody tr").each(function () {
            ...
            var is_cyto = $(this).find(".is_cyto").val();
            ...
            var persentase = parseFloat(unformatNumber($(this).find(".persentase").val()));
            var pcb = parseFloat(<?=!empty($konfig->persencito_bedah) ? $konfig->persencito_bedah : 0?>);
            var tarif = parseFloat(unformatNumber($(this).find(".tariftindakan").val()));;
            var total = 0;
                        
            if (persentase === 0){                                
                $(this).find(".persentase").val(persentase);
            }
//            alert(pcb);
                        
            if(is_cyto == "1") {
                total =  qty * tarif * (persentase + pcb);
            } else {
                total = qty * tarif * (persentase);
            }
