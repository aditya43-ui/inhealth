...
<!--<td>
    ...
    <td>
        <?php echo CHtml::hiddenField("pemakaianBahan[0][hargajual]", round($modObatAlkes->hargajual),array('readonly'=>true,'class'=>'inputFormTabel lebar3 integer2')); ?>
        <?php echo CHtml::hiddenField("pemakaianBahan[0][hargasatuan]", round($modObatAlkes->hargajual),array('readonly'=>true,'class'=>'inputFormTabel lebar3 integer2')); ?>
        <?php echo CHtml::hiddenField("pemakaianBahan[0][harganetto]", round($modObatAlkes->harganetto),array('readonly'=>true,'class'=>'inputFormTabel lebar3 integer2')); ?>
        ...
        <?php echo CHtml::textField("pemakaianBahan[0][qty]", '1',array('onkeyup'=>'hitungSubTotal(this)','readonly'=>false,'class'=>'inputFormTabel span1 number qty', 'style'=>'text-align: right;')); ?>
        ...
        ?>
        <?php echo CHtml::hiddenField("pemakaianBahan[0][subtotal]",$totalsub,array('readonly'=>true,'class'=>'inputFormTabel lebar3 integer2 subtotal')); ?>
    </td>
<!--<td>
