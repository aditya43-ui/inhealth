<?php Yii::import("laboratorium.models.LBObatalkesM"); 
...
//                            echo CHtml::dropDownList('tipepaket_id','',$list_tipepaket ,array('class'=>'span3','empty'=>'Pilih','options'=>$option_tipepaket)); //'onchange'=>'changeTipePaketBahanMedis()' 
                            echo CHtml::hiddenField('tipepaket_id',Params::TIPEPAKET_ID_NONPAKET,array('class'=>'span3')); //'onchange'=>'changeTipePaketBahanMedis()' 
                        ?>
                    </div>
                </div>
            </div>
	...
	'columns'=>array(
        array(
            ...
            'value'=>function($data) use (&$stok){
                ...
                $dataoa['oa']['obatalkes_nama'] = $data->obatalkes_nama;
                $dataoa['oa']['obatalkes_kode'] = $data->obatalkes_kode;
                $dataoa['oa']['jenisobatalkes_nama'] = $data->jenisobatalkes->jenisobatalkes_nama;
                $dataoa['oa']['tglkadaluarsa'] = $data->tglkadaluarsa;
                $dataoa['oa']['hargajual'] = MyFormatter::formatNumberForPrint($data->hargajual,2);
                $dataoa['oa']['mendekatiminimalstok'] = ($stok <= $data->minimalstok)?"ya":"tidak";
                
                $res = json_encode($dataoa);
