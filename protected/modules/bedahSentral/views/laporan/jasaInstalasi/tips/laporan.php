...
<table style="width:100%; padding: none; border: none;">
    ...
    <tr>
        <td>2</td>
        <td>Gunakan tombol ini <?php echo CHtml::htmlButton(Yii::t('mds', '{icon} Reset', array('{icon}' => '<i class="entypo-arrows-ccw"></i>')), array('class' => 'btn btn-default', 'type' => '')); ?> untuk mengulang kembali inputan.</td>
    </tr>
    <tr>
        <td>3</td>
    ...
    <tr>
        <td>4</td>
        <td>Gunakan tombol ini <a class="btn btn-info" href="javascript:void(0);" onclick="return false;">
