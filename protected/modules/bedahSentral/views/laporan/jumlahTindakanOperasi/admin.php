...
$this->breadcrumbs = array(
    'Laporan Jumlah Tindakan Operasi' => array(),
        ...
        <div class="panel panel-gradient">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="glyphicon glyphicon-file"></i> Laporan <b>Jumlah Tindakan Operasi</b>
                </div>
            </div>
            <div class="panel-body">
                <div class="panel panel-success">
                    ...
                    <div class="panel-body">
                        ...
                        <?php $this->renderPartial($this->path_view . 'jumlahTindakanOperasi._search', array(
                            'model' => $model,
                        )); ?>
                        <!--</fieldset>-->
                        <!--search-form-->
                ...
                <div class="panel panel-success">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <i class="entypo-credit-card"></i> Tabel <b>Jumlah Tindakan Operasi</b>
                        </div>
                    </div>
                    <div class="panel-body table-responsive">
                        <?php $this->renderPartial($this->path_view . 'jumlahTindakanOperasi._table', array('model' => $model)); ?>
                    </div>
                </div>
                ...
                $urlPrint =  Yii::app()->createAbsoluteUrl($module . '/' . $controller . '/printJumlahTindakanOperasi');
                $url = Yii::app()->createUrl($module . '/' . $controller . '/FrameGrafikJumlahTindakanOperasi&id=1');
