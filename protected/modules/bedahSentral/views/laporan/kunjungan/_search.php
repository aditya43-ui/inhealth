                        ...
                        'content' => array(
                            'content5' => array(
                                ...
                                'isi' =>  '<table>
                                        ...
                                        <tr>
                                            <td>' . CHtml::radioButton('tampilGrafik', false, array('name' => 'dataGrafik', 'value' => 'kunjungan', 'id' => 'rkunjungan')) . ' <label for="rkunjungan">Kunjungan</label></td>
										...
										<tr>                                            
											<td>' . CHtml::radioButton('tampilGrafik', false, array('name' => 'dataGrafik', 'value' => 'penjamin', 'id' => 'rpenjamin')) . ' <label for="rpenjamin">Penjamin</label></td>
