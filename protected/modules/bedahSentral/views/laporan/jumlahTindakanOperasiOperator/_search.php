    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            ...
            echo CHtml::hiddenField('filter', 'carabayar', array('disabled' => 'disabled')) .
                '
                <div class="control-group">
                    ' . CHtml::label('Dokter Operator', 'dokterpelaksana1_id', array('class' => 'control-label')) . ' 
                    <div class="controls">												 
                        ' . $form->dropDownList(
                    $model,
                    'dokterpelaksana1_id',
            ...
            //         'content4' => array(
            //             'multi' => 'multi',
            //             'header' => 'Berdasarkan Dokter Operator',
...
<script>
    $(document).ready(function() {
        dropMulti('<?php echo CHtml::activeId($model, 'dokterpelaksana1_id') ?>');
    });
</script>