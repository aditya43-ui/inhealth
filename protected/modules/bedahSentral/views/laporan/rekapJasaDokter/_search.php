...
<div class="row">
    ...
    <div class="col-sm-6">
        ...
        echo CHtml::hiddenField('filter', 'carabayar', array('disabled' => 'disabled')) .
            '<div class="control-group">
            ' . CHtml::label('Nama Dokter', 'namaDokter', array('class' => 'control-label')) . ' 
            <div class="controls">
                ' . $form->dropDownList($model, 'pegawai_id', CHtml::listData(DokterpegawaiV::model()->findAll(" pegawai_aktif = TRUE ORDER BY nama_pegawai ASC "), 'pegawai_id', 'namaLengkap'), array(
