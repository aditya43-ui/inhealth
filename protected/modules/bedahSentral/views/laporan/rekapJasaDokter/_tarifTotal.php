<?php
    ...
    $criteria->select = 'komponentarif_id,daftartindakan_tindakan,daftartindakan_konsul,daftartindakan_visite, 
                         daftartindakan_karcis,tarif_tindakankomp,pendaftaran_id,ruangan_id,tgl_pendaftaran,pegawai_id';
    ...
    foreach($modTarif as $key=>$tarif){
       if($tarif->daftartindakan_visite == true  || $tarif->daftartindakan_konsul == true || $tarif->daftartindakan_tindakan == true || $tarif->komponentarif_id == 15 || $tarif->komponentarif_id == 26 || $tarif->komponentarif_id == 21 || $tarif->komponentarif_id == 2){
           $totTarif = $totTarif + $tarif->tarif_tindakankomp;
           /*
           if($totTarif == null){
               echo "0";
           }else{
