<?php
    $this->breadcrumbs = array(
        'checklist Serah Terima Post Operasi',
    );
...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title" style="width: 100%">
          <b>Checklist Serah Terima Post Operasi</b>
        </div>
    </div>
...
?>
        ...
        <div class="panel panel-success panel-shadow">
            <div class="panel-heading">
                <div class="panel-title"><strong>Data Checklist Post Operasi</strong></div>
            </div>
            <div class="panel-body">
              <div class="row">
                <div class="col-sm-6">
              ...
              <div class="panel panel-success panel-shadow">
                  <div class="panel-heading">
                      <div class="panel-title"><strong>Serah Terima Post Operasi</strong></div>
                  </div>
                  <div class="panel-body">
                    <div class="row">
                      <?php
                          ...
                          foreach($modPrepostOperasi as $dataPrePostOperasi){
                                      ...
                                      foreach($childrenPrepost as $children){
                                        ...
                                        <div class="col-sm-6">
                                          ...
                                          <div class="control-group">
                                              ...
                                              <div class="controls">
                                                <?php echo CHtml::radioButtonList('PrepostoperasidetailT['.$indexOp.'][status_pengisian]',$status_pengisian,array('Ya'=>'Ya','Tidak'=>'Tidak') , array('class'=>'status_pengisian','onkeyup'=>"return $(this).focusNextInputField(event)",'template'=>'{input}{label}','separator'=>'','labelOptions'=>array('style'=> 'padding-left:5px; width: 30px; float: left;'),'style'=>'float:left;')); ?>
                            ...
                            ?>
                              ...
                              <div class="control-group">
                                  ...
                                  <div class="controls">
                                        <?php echo CHtml::radioButtonList('PrepostoperasidetailT['.$indexOp.'][status_pengisian]',$status_pengisian_parent,array('Ya'=>'Ya','Tidak'=>'Tidak') , array('class'=>'status_pengisian','onkeyup'=>"return $(this).focusNextInputField(event)",'template'=>'{input}{label}','separator'=>'','labelOptions'=>array('style'=> 'padding-left:5px; width: 30px; float: left;'),'style'=>'float:left;')); ?>
                                        <div style="clear: both;"></div>
                                  </div>
                              </div>
                              <div class="control-group">
