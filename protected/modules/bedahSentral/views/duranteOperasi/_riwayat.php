<div class="panel panel-success" style="margin: 17px 0;">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="glyphicon glyphicon-file"></i> Riwayat Durante Operasi
        </div>
    </div>
    <div class="panel-body">
        <?php

        $mod = new AnastesiduranteoperasiT;
        $mod->unsetAttributes();
                ...
                array(
                    ...
                    'value' => function ($data) {
                        return CHtml::link('<i class="entypo-pencil"></i>', Yii::app()->controller->createUrl('index', array(
                            ...
                            'id' => $data->anastesiduranteoperasi_id
                        )), array(
                            'rel' => 'tooltip',
                            'title' => 'Ubah Observasi',
                        ));
                    },
                    'htmlOptions' => array(
