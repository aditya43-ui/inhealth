...
<h4 style="text-align: center; font-weight: bold;">Grafik Observasi Durante Operasi</h4>
...
<div class="panel panel-success">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="entypo-credit-card"></i> Tabel <b>Durante Operasi</b>
        </div>
    </div>
    <div class="panel-body table-responsive">
        ...
        echo " ";
        echo CHtml::link('Kembali', $this->createUrl('index', array('pasienmasukpenunjang_id' => $pasienmasukpenunjang_id)), array(
...
<script>
    ...
    // var time_m = <?php // echo CJSON::encode($time_m); 
                    ?>;
    function print(id) {
        window.open("<?php
