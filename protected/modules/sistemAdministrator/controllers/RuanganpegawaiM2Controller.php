 ...
 * 
 */
class RuanganpegawaiM2Controller extends MyAuthController
{
  public $layout = '//layouts/column1';
  public $defaultAction = 'admin';
  public $path_view = 'sistemAdministrator.views.ruanganpegawaiM2.';
  ...
  {
    $model = new SARuanganpegawaiM('searchTabelRuang');
    $model->ruangan_id = Yii::app()->user->id;
    ...
    if (isset($_GET['SARuanganpegawaiM'])) {
      ...
      $model->ruangan_id = $_GET['SARuanganpegawaiM']['ruangan_id'];
      
    }
    $this->render($this->path_view . 'admin', array('model' => $model));
  }

  // public function actionSetInstalasi($ruangan_id = null)
  // {
  //   if (Yii::app()->request->isAjaxRequest) {
  //     $ruangan_id = $_POST['ruangan_id'];
  //     // var_dump($ruangan_id); die;

  //     $modinstalasi = InstalasiM::model()->findByPK($ruangan_id);
    
  //     echo CJSON::encode($modinstalasi);
  //     Yii::app()->end();
  //   }
  // }

  
  public function actionCreate($ruangan_id = null)
  {
...
//    var_dump($ruangan_id); die;
    ...
    $this->render($this->path_view . 'create', array('ruangan_id'=>$ruangan_id,'model' => $model, 'modDetails' => $modDetails));
  }
  ...
  public function actionRuanganpegawai()
  {
    if (Yii::app()->request->isAjaxRequest) {
      ...
      $cek = RuanganpegawaiM:: model()->find("pegawai_id = $pegawai_id and ruangan_id = $ruangan_id");
      ...
      $data['tr'] = $tr;
      $data['ada'] = !empty($cek) ? "ada" : "tidak ada";
