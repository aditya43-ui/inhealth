...
class PrepostoperasideskMController extends MyAuthController
{
	/**
	...
	public $path_view = 'sistemAdministrator.views.prepostoperasidesk.';
	...
	{
		$model = new PrepostoperasideskM;

		if(isset($_POST['PrepostoperasideskM']))
		{
			$model->attributes = $_POST['PrepostoperasideskM'];
			$model->status = true;
	...
	{
		$dataProvider = new CActiveDataProvider('PrepostoperasideskM');
	...
	{
		$model = new PrepostoperasideskM('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['PrepostoperasideskM'])){
			$model->attributes = $_GET['PrepostoperasideskM'];
		}
	...
	{
		$model = PrepostoperasideskM::model()->findByPk($id);
		if($model===null)
	...
	public function actionPrint()
	{
		...
		if(isset($_REQUEST['PrepostoperasideskM'])){
				$model->attributes = $_REQUEST['PrepostoperasideskM'];
		}

		$judulLaporan='Data Checklist Pra dan Post Operasi';
