...
class KomponengajiMController extends MyAuthController
{
  ...
  public function actionCreate()
  {
    ...
    if (isset($_POST['KomponengajiM'])) {
      ...
      $model->nominal_satuan = MyFormatter::formatRupiahForDB($model->nominal_satuan);
      if ($komponen == 0) {
      ...
      if ($model->save()) {
        Yii::app()->user->setFlash('success', 'Data ' . $model->komponengaji_nama . ' berhasil disimpan.');
  ...
  public function actionUpdate($id)
  {
    ...
    $model = $this->loadModel($id);
    if (empty($model->nominal_satuan))
      $model->nominal_satuan = 0;
    $model->nominal_satuan = MyFormatter::formatNumberForPrint($model->nominal_satuan);
