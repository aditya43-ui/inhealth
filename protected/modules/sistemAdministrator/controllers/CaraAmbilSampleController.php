...
class CaraAmbilSampleController extends MyAuthController
{
  /**
  ...
  public $path_view = 'sistemAdministrator.views.caraAmbilSample.';
  ...
  {
    $model = new CaraambilsampelM();
    // new SAJenisKegiatanM()
    // Uncomment the following line if AJAX validation is needed


    if (isset($_POST['CaraambilsampelM'])) {
      $model->attributes = $_POST['CaraambilsampelM'];
      if ($model->save()) {
        Yii::app()->user->setFlash('success', "Data " . $model->caraambilsampel_id . " berhasil disimpan");
        $this->redirect(array('view', 'id' => $model->caraambilsampel_id));
      } else {
  ...
  {
    $model = new CaraambilsampelM('search');
    $model->unsetAttributes();  // clear any default values
    // $model->pemeriksaanlab_aktif = true;
    if (isset($_GET['CaraambilsampelM'])) {
      $model->attributes = $_GET['CaraambilsampelM'];
  ...
  {
    // var_dump($id);die;
    $model = CaraambilsampelM::model()->findByAttributes(array('caraambilsampel_id' => $id));
    if ($model === null)
