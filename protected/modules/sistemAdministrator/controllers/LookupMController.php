...
class LookupMController extends MyAuthController
{
  ...
  /**
   * 
   * @param array $postarray munampung insert data multiple
   * @param integer $insert sebagai validasi 
   * @return array $models mengembalikan data 
   */
  ...
  /**
   * digunakan sebagai fungsi update
   * @param integer $id menampung id yang akan diedit
   */
  public function actionUpdate($id)
  {
    //if(!Yii::app()->user->checkAccess(Params::DEFAULT_UPDATE)){throw new CHttpException(401,Yii::t('mds','You are prohibited to access this page. Contact Super Administrator'));}                                                        
