...
class MasterBahanSterilisasiController extends MyAuthController
{
  ...
  public function actionCreate()
  {
    ...
    if (isset($_POST['SABahansterilisasiM'])) {
      ...
      $model->bahansterilisasi_warna = $model->bahansterilisasi_warna == "" ? null : $model->bahansterilisasi_warna;
      $model->bahansterilisasi_maksuhu = $model->bahansterilisasi_maksuhu == "" ? null : $model->bahansterilisasi_maksuhu;


      if ($model->save()) {
        Yii::app()->user->setFlash('success', 'Data ' . $model->bahansterilisasi_nama . ' berhasil disimpan.');
