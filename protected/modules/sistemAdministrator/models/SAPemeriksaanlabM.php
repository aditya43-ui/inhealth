 ...
 * @property string $formathasilperiksa
...
class SAPemeriksaanlabM extends PemeriksaanlabM
{
	...
	public $daftartindakan_nama, $jenispemeriksaanlab_kelompok;
	...
	public function search()
	{
		...
		// should not be searched.
			...
			$criteria->compare('LOWER(kode_unik)',strtolower($this->kode_unik),true);
