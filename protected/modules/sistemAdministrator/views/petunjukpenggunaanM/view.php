<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="far fa-eye"></i> Lihat <b>Petunjuk Penggunaan</b>
        </div>
    </div>
    <div class="panel-body table-responsive">
        ...
        <div class="form-actions">
            <?php echo CHtml::link(
                Yii::t('mds', '{icon} Pengaturan Petunjuk Utama', array('{icon}' => '<i class="icon-folder-open icon-white"></i>')),
