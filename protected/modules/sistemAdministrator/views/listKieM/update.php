<div class="panel panel-primary panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">Ubah <b>List KIE</b></div>
    </div>
    <div class="panel-body">
        <?php
        $this->breadcrumbs=array(
                'List KIE'=>array('admin'),
                $model->listkie_id=>array('view','id'=>$model->listkie_id),
                'Ubah',
        );

        $arrMenu = array();
        //                array_push($arrMenu,array('label'=>Yii::t('mds','Update').' Cara Pembayaran ', 'header'=>true, 'itemOptions'=>array('class'=>'heading-master'))) ;
        ...
        //                array_push($arrMenu,array('label'=>Yii::t('mds','View').' Cara Pembayaran', 'icon'=>'eye-open', 'url'=>array('view','id'=>$model->listkie_id))) ;
