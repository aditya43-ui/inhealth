<div class="panel panel-gradient">
	<div class="panel-heading">
		<div class="panel-title">
            <i class="far fa-edit"></i> Ubah <?= ($this->module->id == 'hemodialisa')?'Tempat Tidur (Bed)':'Kamar Ruangan' ?></div>
	</div>
	<div class="panel-body">
<?php
$this->breadcrumbs=array(
	'Kamar Ruangan'=>array('update','id'=>$model->kamarruangan_id),	
	'Ubah'
);
...
<?php echo $this->renderPartial($this->path_view.'_formUpdateV2',array('loadKamar'=>$loadKamar,'model'=>$model)); ?>
