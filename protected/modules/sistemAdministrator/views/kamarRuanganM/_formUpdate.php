...
<?php echo $form->dropDownListRow($model, 'ruangan_id', CHtml::listData($model->RuanganKamarItems, 'ruangan_id', 'ruangan_nama'), array('class' => 'inputRequire span3', 'onkeypress' => "return $(this).focusNextInputField(event)", 'empty' => '-- Pilih Ruangan --')); ?>
<div class="control-group">
    ...
    <div class="controls">
        <?php echo $form->dropDownList(
            $model,
            'keterangan_kamar',
            CHtml::listData($model->KeteranganKamarItems, 'lookup_value', 'lookup_name'),
            array(
...
<div class="control-group">
    <?php echo CHtml::label("", 'kamarTerpakai', array('class' => 'control-label')) ?>
    <div class="controls">
        <?php echo $form->checkBox($model, 'kamarTerpakai', array()); ?> <label>Terpakai</label>
    </div>
</div>
<div class="control-group">
    <?php echo CHtml::label("", 'kamarruangan_aktif', array('class' => 'control-label')) ?>
    <div class="controls">
        <?php echo $form->checkBox($model, 'kamarruangan_aktif', array()); ?> <label>Aktif</label>
    </div>
</div>
...
<div class="form-actions">
    ...
    <?php
    echo CHtml::link(Yii::t('mds', '{icon} Pengaturan Kamar Ruangan', array('{icon}' => '<i class="entypo-folder"></i>')), $this->createUrl(Yii::app()->controller->id . '/admin', array('modul_id' => Yii::app()->session['modul_id'])), array('class' => 'btn btn-success',));
