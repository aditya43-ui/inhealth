...
<div class="row">
    <div class="col-sm-6">
        ...
        <?php
        echo $form->dropDownListRow($model, 'carabayar_id', CHtml::listData(SAPendaftaranT::model()->getCaraBayarItems(), 'carabayar_id', 'carabayar_nama'), array(
            'empty' => '-- Pilih --', 'onkeypress' => "return $(this).focusNextInputField(event)", 'onchange' => 'setDropdownPenjamin(this);',
        ...
        ?>
        <?php echo $form->dropDownListRow($model, 'penjamin_id', CHtml::listData(SAPendaftaranT::model()->getPenjaminItems($model->carabayar_id), 'penjamin_id', 'penjamin_nama'), array('empty' => '-- Pilih --', 'onkeypress' => "return $(this).focusNextInputField(event)", 'onchange' => 'getChangePenjamin();')); ?>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        //setDropdownPenjamin($('#<?php // echo CHtml::activeId($model,'carabayar_id');   
                                    ?>'));
    });
</script>