<?php $form=$this->beginWidget('ext.bootstrap.widgets.BootActiveForm',array(
	...
	'method'=>'get',
	'id'=>'perangkateasylink-m-search',
	'type'=>'horizontal',
)); ?>

	<?php echo $form->textFieldRow($model,'perangkateasylink_id',array('class'=>'span3 numbers-only')); ?>

	<?php echo $form->textAreaRow($model,'perangkat_ip',array('rows'=>6, 'cols'=>50, 'class'=>'span8')); ?>

	<?php echo $form->textFieldRow($model,'perangkat_port',array('class'=>'span3 numbers-only')); ?>

	<?php echo $form->textAreaRow($model,'perangkat_sn',array('rows'=>6, 'cols'=>50, 'class'=>'span8')); ?>
