                                ...
                                echo $form->dropDownList($model,'carabayar_id', CHtml::listData($model->getCaraBayarItems(), 'carabayar_id', 'carabayar_nama') ,
                                        array('empty'=>'-- Pilih --','onkeypress'=>"return $(this).focusNextInputField(event)",
                                                'ajax' => array('type'=>'POST',
                                                    'url'=> Yii::app()->createUrl('ActionDynamic/GetPenjaminPasien',array('encode'=>false,'namaModel'=>'SAPenjaminpasienM')), 
                                 ...
                                 <?php echo $form->hiddenField($model,'rekeningdebit_id',array('class'=>'span3','maxlength'=>50));  ?>
                                    <?php
                                        $this->widget('MyJuiAutoComplete', array(
                                            'model' => $model,
                                            'attribute' => 'rekDebit',
                                            'sourceUrl' => Yii::app()->createUrl('sistemAdministrator/CarapembayarRek/rekeningAkuntansi'),
                                            'options' => array(
                                                'showAnim' => 'fold',
                                                'minLength' => 2,
...
$modRekDebit = new SARekeningakuntansiV('searchDialog');
$modRekDebit->unsetAttributes();
if(isset($_GET['SARekeningakuntansiV'])) {
    $modRekDebit->attributes = $_GET['SARekeningakuntansiV'];
	$modRekDebit->rekening5_nb = $_GET['rekening5_nb'];
}
$this->widget('ext.bootstrap.widgets.HeaderGroupGridView',array(
	'id'=>'rekdebit-m-grid',
        //'ajaxUrl'=>Yii::app()->createUrl('actionAjax/CariDataPasien'),
	'dataProvider'=>$modRekDebit->searchDialog(),
	'filter'=>$modRekDebit,
        'template'=>"{summary}\n{items}\n{pager}",
	...
	'columns'=>array(
			...
			'filter' => CHtml::dropDownList(
					'rekening5_nb', $modRekDebit->rekening5_nb, array('D' => 'Debit',
                ...
                array(
                    ...
                    'value'=>'CHtml::Link("<i class=\"icon-form-check\"></i>","#",array("class"=>"btn-small", 
                                    "id" => "selectRekDebit",
                                    "onClick" =>"
                                                $(\"#SAPenjaminpasienM_rekeningdebit_id\").val(\"$data->rekening5_id\");
                                                $(\"#SAPenjaminpasienM_rekDebit\").val(\"$data->nmrekening5\");                                                
...
$modRekKredit = new SARekeningakuntansiV('searchDialog');
$modRekKredit->unsetAttributes();
if(isset($_GET['SARekeningakuntansiV'])) {
    $modRekKredit->attributes = $_GET['SARekeningakuntansiV'];
	$modRekKredit->rekening5_nb = $_GET['rekening5_nb'];
}
$this->widget('ext.bootstrap.widgets.HeaderGroupGridView',array(
	'id'=>'rekdebit-m-grid',
        //'ajaxUrl'=>Yii::app()->createUrl('actionAjax/CariDataPasien'),
	'dataProvider'=>$modRekKredit->searchDialog(),
	'filter'=>$modRekKredit,
        'template'=>"{summary}\n{items}\n{pager}",
        'itemsCssClass'=>'table table-striped table-bordered table-condensed',
        'mergeHeaders'=>array(
			...
			'filter' => CHtml::dropDownList(
                ...
                array(
                    ...
                    'value'=>'CHtml::Link("<i class=\"icon-form-check\"></i>","#",array("class"=>"btn-small", 
                                    "id" => "selectRekDebit",
                                    "onClick" =>"
                                                $(\"#SAPenjaminpasienM_rekeningkredit_id\").val(\"$data->rekening5_id\");
                                                $(\"#SAPenjaminpasienM_rekKredit\").val(\"$data->nmrekening5\");
