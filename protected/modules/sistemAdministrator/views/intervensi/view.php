<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="far fa-eye"></i> Lihat <b>Intervensi</b>
        </div>
    </div>
    <div class="panel-body table-responsive">
        ...
        ?>
        <?php echo CHtml::link(Yii::t('mds', '{icon} Pengaturan Tautan SDKI-SIKI', array('{icon}' => '<i class="icon-file icon-white"></i>')), $this->createUrl(Yii::app()->controller->id . '/admin', array('modul_id' => Yii::app()->session['modul_id'], 'tab' => ($this->hasTab == TRUE) ? 'frame' : null)), array('class' => 'btn btn-success')) . "&nbsp";
