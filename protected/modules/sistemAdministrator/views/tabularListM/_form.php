...
<div class="row">
    ...
    <div class="col-sm-6">
        ...
        <?php echo $form->textFieldRow($model, 'tabularlist_block', array('placeholder' => 'Block', 'class' => 'span3', 'onkeypress' => "return $(this).focusNextInputField(event);", 'maxlength' => 50)); ?>
    ...
    <div class="col-sm-6">
        <?php echo $form->textFieldRow($model, 'tabularlist_revisi', array('placeholder' => 'Revisi', 'class' => 'span3', 'onkeypress' => "return $(this).focusNextInputField(event);", 'maxlength' => 50)); ?>
