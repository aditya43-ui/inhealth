...
$this->widget('bootstrap.widgets.BootMenu', array(
    ...
    'items'=>array(
        array('label'=>'Jenis Infeksi Nosokomial', 'url'=>$this->createUrl('/rekamMedis/jenisInfeksiNosokomialM/admin'), 'active'=>true),
        array('label'=>'Sebab Infeksi Nosokomial', 'url'=>$this->createUrl('/rekamMedis/sebabInfeksiNosokomialM/admin'),),
