<script type="text/javascript">
    ...
    function refreshTable() {
        var jenisintervensi_id = $("#<?php echo CHtml::activeId($model, 'jenisintervensi_id') ?>").val();
        var jenistindakan = $("#<?php echo CHtml::activeId($model, 'jenistindakan') ?>").val();

        if (jenisintervensi_id !== '') {
            $('#table-lookup').addClass('animation-loading');

            $.ajax({
                type: 'GET',
                url: '<?php echo $this->createUrl('getLookup'); ?>',
                data: {jenisintervensi_id: jenisintervensi_id, jenistindakan:jenistindakan},
                dataType: "json",
                success: function (data) {
