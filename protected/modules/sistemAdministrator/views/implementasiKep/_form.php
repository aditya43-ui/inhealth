...
<div class="row">
    <div class="span6">
        <div class="control-group">
            <?php echo Chtml::label('Intervensi Keperawatan', 'diagnosakep_id', array('class' => 'control-label')) ?>
            <div class="controls">
                <?php echo $form->hiddenField($model, 'jenisintervensi_id'); ?>
                <?php
                $this->widget('MyJuiAutoComplete', array(
                    'model' => $model,
                    'attribute' => 'jenisintervensi_nama',
                    ...
                    'htmlOptions' => array(
                        ...
                        'placeholder' => 'Kode / Nama Intervensi',
                        'onkeypress' => "return $(this).focusNextInputField(event)",
                    ),
                    'tombolDialog' => array('idDialog' => 'dialogJenisIntervensi'),
                ));
                ?>
            </div>
        </div>
    ...
    <div class="span6">
        <div class="control-group">
            <?php echo Chtml::label('Jenis Tindakan Intervensi', 'intervensi_nama', array('class' => 'control-label')) ?>
            <div class="controls">
                <?php echo $form->dropDownList($model, 'jenistindakan', LookupM::getItems('jenistindakanintervensi'), array('empty' => '-- Pilih --', 'class' => 'span3', 'onblur' => 'refreshTable();')); ?>
...
<div class="row-fluid block-tabel">
    <div class="panel panel-success">
        <div class="panel-heading">
            <div class="panel-title">Tabel <b>SIKI</b></div>
        </div>
...
<div class="form-actions">
    ...
    ?>
    <?php echo CHtml::link(Yii::t('mds', '{icon} Pengaturan SIKI', array('{icon}' => '<i class="icon-folder-open icon-white"></i>')), $this->createUrl($this->id . '/admin', array('modul_id' => Yii::app()->session['modul_id'])), array('class' => 'btn btn-success')); ?>
    <?php
    $tips = array(
        ...
        array(
            ...
            'value' => 'CHtml::Link("<i class=\"icon-form-check\"></i>",
                                ...
                                array(
                                    ...
                                    "id" => "selectDiagnosa",
                                    "onClick" => "
                                    $(\"#' . CHtml::activeId($model, 'jenisintervensi_id') . '\").val(\'$data->jenisintervensi_id\');
                                    $(\"#' . CHtml::activeId($model, 'jenisintervensi_nama') . '\").val(\'$data->jenisintervensi_nama\');
