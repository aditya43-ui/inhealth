...
<div class="row">
    <div class="col-sm-6">
        <?php
        //echo $form->dropDownListRow($model, 'kelompokkomponentarif_id', 
        ...
        <div class="control-group">
            <div class="controls">
                ...
                foreach ($modKomponenTarifInstalasi as $jenisKomponenTarifInstalasi) {
                    $arrKomponenTarifInstalasi[] = $jenisKomponenTarifInstalasi['instalasi_id'];
                }
            ...
            <thead>
                <tr>
                    ...
                    <th style="text-align: center"><?php
                                                    echo CHtml::link('<i class="' . MyIcon::getIcons('tambah-baris') . '"></i>', '#', array(
