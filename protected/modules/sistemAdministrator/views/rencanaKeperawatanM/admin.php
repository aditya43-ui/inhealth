        ...
        <div class="panel panel-gradient">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="fas fa-layer-group"></i> Pengaturan <b>Rencana Keperawatan</b>
                </div>
            </div>
            <div class="panel-body">
                ...
                <?php
                echo CHtml::link(
                    Yii::t('mds', '{icon} Tambah Rencana Keperawatan', array('{icon}' => '<i class="icon-plus icon-white"></i>')),
                    $this->createUrl('create', array('modul_id' => Yii::app()->session['modul_id'])),
                    array('title' => 'Tambah Rencana Keperawatan', 'class' => 'btn btn-danger',)
                );
