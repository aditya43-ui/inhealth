    ...
    <div class="panel-body">
                ...
                <?php $this->widget('ext.bootstrap.widgets.BootGridView', array(
                    ...
                    'columns' => array(
                        ...
                        array(
                            ...
                            'value' => 'empty($data->lokasipenyimpanan) ? "" : $data->lokasipenyimpanan->lokasipenyimpanan_nama',
		...
		*/
        ...
        <div class="form-actions">
            <?php
            echo CHtml::link(
                Yii::t('mds', '{icon} Tambah Rak Penyimpanan', array('{icon}' => '<i class="icon-plus icon-white"></i>')),
                $this->createUrl('create', array('modul_id' => Yii::app()->session['modul_id'])),
                array('title' => 'Tambah rak penyimpanan', 'class' => 'btn btn-danger')
            );
