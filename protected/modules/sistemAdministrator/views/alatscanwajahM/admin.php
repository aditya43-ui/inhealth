...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('alatscanwajah-m-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">Pengaturan <b>Alat Scan Wajah</b></div>
    </div>
    <div class="panel-body">
	<?php $this->widget('ext.bootstrap.widgets.BootGridView',array(
		'id'=>'alatscanwajah-m-grid',
        ...
        <br/>
<?php 
	echo CHtml::link(Yii::t('mds','{icon} Tambah Alat Scan Wajah',array('{icon}'=>'<i class="icon-plus icon-white"></i>')),$this->createUrl('create',array('modul_id'=> Yii::app()->session['modul_id'])), array('class'=>'btn btn-success'))."&nbsp&nbsp"; 
...
{
    window.open("${urlPrint}/"+$('#alatscanwajah-m-search').serialize()+"&caraPrint="+caraPrint,"",'location=_new, width=900px');
}
JSCRIPT;
