<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="far fa-edit"></i> Ubah <b>Knowledge Base</b>
        </div>
    </div>
    <div class="panel-body">
        ...
        $this->breadcrumbs = array(
            ...
            $model->knowledgebase_id => array('view', 'id' => $model->knowledgebase_id),
            'Update',
        );
        ...
        //                array_push($arrMenu,array('label'=>Yii::t('mds','View').' Asal Barang', 'icon'=>'eye-open', 'url'=>array('view','id'=>$model->knowledgebase_id))) ;
