<?php $form=$this->beginWidget('ext.bootstrap.widgets.BootActiveForm',array(
	...
	'method'=>'get',
	'id'=>'alatscanktppengguna-m-search',
	'type'=>'horizontal',
)); ?>

	<?php echo $form->textFieldRow($model,'alatscanktppengguna_id',array('class'=>'span3 numbers-only')); ?>

	<?php echo $form->textAreaRow($model,'user_ip',array('rows'=>6, 'cols'=>50, 'class'=>'span8')); ?>

	<?php echo $form->textFieldRow($model,'id_perangkat',array('class'=>'span3 numbers-only')); ?>
