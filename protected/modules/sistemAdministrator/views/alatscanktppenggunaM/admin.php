...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('alatscanktppengguna-m-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="fas fa-layer-group"></i> Pengaturan <b>Alat Scan E-KTP Pasien</b>
        </div>
    </div>
	...
	<?php $this->widget('ext.bootstrap.widgets.BootGridView',array(
		...
		'afterAjaxUpdate'=>'function(id, data){jQuery(\''.Params::TOOLTIP_SELECTOR.'\').tooltip({"placement":"'.Params::TOOLTIP_PLACEMENT.'"});}',
                ...
                <br/>
<?php 
	echo CHtml::link(Yii::t('mds','{icon} Tambah Alat Scan eKTP Pengguna',array('{icon}'=>'<i class="icon-plus icon-white"></i>')),$this->createUrl('create',array('modul_id'=> Yii::app()->session['modul_id'])), array('class'=>'btn btn-success'))."&nbsp&nbsp"; 
...
{
    window.open("${urlPrint}/"+$('#alatscanktppengguna-m-search').serialize()+"&caraPrint="+caraPrint,"",'location=_new, width=900px');
}
JSCRIPT;
