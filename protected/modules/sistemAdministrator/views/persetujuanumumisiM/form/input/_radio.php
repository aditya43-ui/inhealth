<div class="input_base_detail">
    ...
    <div class="control-group">
        <label class="control-label">
            Jumlah Radio Button <span class="required">*</span>
        </label>
        <div class="controls">
            <?php echo CHtml::activeTextField($inputan, '['.$idx.']inputan_jumlah', array('class'=>'span1 numbers-only', 'onblur'=>'setInputanDetailRadio(this);')); ?>
            <div class="radio_gen_subinput">
                <?php
                    if (!$inputan->isNewRecord) {
                        ...
                        foreach ($details as $idx2 => $detail) {
                            echo $this->renderPartial('form/input/_radio_detail', array(
