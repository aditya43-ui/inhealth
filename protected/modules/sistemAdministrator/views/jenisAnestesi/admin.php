...
<div class="panel panel-success">
    <div class="panel-heading">
        <div class="panel-title judul">Pengaturan <b>Jenis Anestesi</b></div>
    </div>
...
//			'jenisanastesi_id',
                    ...
                    array(
                        'header' => 'Aktif',
                        'type' => 'raw',
                        'value' => '($data->jenisanastesi_aktif) ? "Aktif" : "Tidak Aktif"',
                    ),
                    array(
                    ...
                    array(
                        ...
                        'buttons' => array(
                            'remove' => array(
                                ...
                                'url' => 'Yii::app()->createUrl("' . Yii::app()->controller->module->id . '/' . Yii::app()->controller->id . '/nonActive",array("id"=>$data->jenisanastesi_id))',
        ...
        <?php
        echo CHtml::link(Yii::t('mds', '{icon} Tambah Jenis Anestesi', array('{icon}' => '<i class="icon-plus icon-white"></i>')), $this->createUrl('create', array('modul_id' => Yii::app()->session['modul_id'])), array('class' => 'btn btn-danger')) . "&nbsp&nbsp";
