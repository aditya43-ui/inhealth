...
<div class="panel panel-success">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="fas fa-layer-group"></i> Pengaturan <b>Sterilisasi Barang </b>
        </div>
    </div>
    <div class="panel-body">
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="entypo-credit-card"></i> Tabel <b>Sterilisasi Barang</b>
                </div>
            </div>
            <div class="panel-body table-responsive">
                ...
                $this->widget('ext.bootstrap.widgets.BootGridView', array(
                    ...
                    'columns' => array(
                        ...
                        array(
                            'header' => 'Nama Barang',
                            'value' => '$data->getBarang($data->barang_id)',
                        ), /*
                    array(
                        'header' => 'Lihat',
        ...
        <div class="form-actions">
            <?php
            echo CHtml::link(
                Yii::t('mds', '{icon} Tambah Sterilisasi Barang ', array('{icon}' => '<i class="icon-plus icon-white"></i>')),
                $this->createUrl('create', array('modul_id' => Yii::app()->session['modul_id'])),
                array('title' => 'Tambah sterilisasi barang', 'class' => 'btn btn-danger',)
            );
