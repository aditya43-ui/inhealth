<div class="white-container">
    ...
    <?php 
    echo CHtml::link(Yii::t('mds', '{icon} Tambah Jenis Waktu', array('{icon}'=>'<i class="icon-plus icon-white"></i>')), $this->createUrl('/sistemAdministrator/JenisWaktuM/create',array('modul_id'=> Yii::app()->session['modul_id'])), array('class' => 'btn btn-danger',));
