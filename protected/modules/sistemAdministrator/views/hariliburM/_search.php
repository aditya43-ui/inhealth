...
<div class="row">
    ...
    <div class="col-sm-6">
        <?php echo $form->textFieldRow($model, 'namaharilibur', array('placeholder' => 'Nama Hari Libur', 'class' => 'span3', 'maxlength' => 25)); ?>
        <div class="control-group">
            <?php echo CHtml::label("", 'harilibur_aktif', array('class' => 'control-label')) ?>
            <div class="controls">
                <?php echo $form->checkBox($model, 'harilibur_aktif', array('checked' => 'checked')); ?> <label>Aktif</label>
            </div>
        </div>
    </div>
</div>
