<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="entypo-info-circled"></i> Informasi <b>Monitoring Error dan Bugs</b>
        </div>
    </div>
    <div class="panel-body">
        <?php
        $this->breadcrumbs = array(
            'Informasi Monitoring Error dan Bugs' => array('admin'),
        );
    ...
    ");
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="entypo-credit-card"></i> Tabel <b>Monitoring Error dan Bugs</b>
                </div>
            </div>
        ...
        <?php
        // echo CHtml::link(Yii::t('mds','{icon} Tambah Monitoring Error dan Bugs',array('{icon}'=>'<i class="icon-plus icon-white"></i>')),$this->createUrl($this->id.'/create',array('modul_id'=> Yii::app()->session['modul_id'])), array('class' => 'btn btn-danger',)); 
