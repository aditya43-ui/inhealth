...
<div class="row">
    ...
    <div class="col-sm-6">
        ...
        ?>
        <?php echo $form->textFieldRow($model, 'menu_urutan', array('placeholder' => '00', 'class' => 'span1', 'onkeypress' => "return $(this).focusNextInputField(event)")); ?>
        <div>
            <div class="control-group">
                <?php echo CHtml::label("", 'menu_shortcut', array('class' => 'control-label')) ?>
                <div class="controls">
                    <?php echo $form->checkBox($model, 'menu_shortcut', array('checked' => 'menu_aktif')); ?>
