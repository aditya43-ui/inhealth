...
<div class="panel panel-gradient">
    ...
    <div class="panel-body">
        ...
        <div class="form-actions">
            <?php
            echo CHtml::link(
                Yii::t('mds', '{icon} Tambah Indikator Perilaku', array('{icon}' => '<i class="icon-plus icon-white"></i>')),
                $this->createUrl('create', array('modul_id' => Yii::app()->session['modul_id'])),
                array('title' => 'Tambah indikator perilaku', 'class' => 'btn btn-danger',)
            );
