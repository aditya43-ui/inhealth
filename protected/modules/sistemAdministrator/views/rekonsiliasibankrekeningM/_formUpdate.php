							...
							$this->widget('MyJuiAutoComplete', array(
								...
								'options' => array(
									...
									'focus' => 'js:function( event, ui ) {
											$(this).val(ui.item.nmrekeninglast);
											return false;
										}',
    ...
    'columns' => array(
        array(
            ...
            'value' => 'CHtml::Link("<i class=\"icon-form-check\"></i>","#",array("class"=>"btn-small",
				"id" => "selectRekDebit",
				"onClick" =>"
				$(\"#AKPenjaminpasienM_rekeningdebit_id\").val(\"$data->rekeninglast_id\");
    ...
    'columns' => array(
        array(
            ...
            'value' => 'CHtml::Link("<i class=\"icon-form-check\"></i>","#",array("class"=>"btn-small",
				"id" => "selectRekDebit",
				"onClick" =>"
				$(\"#AKPenjaminpasienM_rekeningkredit_id\").val(\"$data->rekeninglast_id\");
