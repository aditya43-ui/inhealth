    ...
    <tr>
        <td>
            <div class="control-group">
                ...
                <div class="controls">
                    <?php
                    echo $form->dropDownList($modPengeluaran, 'jenisrekonsiliasibank_id', CHtml::listData($modPengeluaran->getJenisRekonItems(), 'jenisrekonsiliasibank_id', 'jenisrekonsiliasibank_nama'), array(
