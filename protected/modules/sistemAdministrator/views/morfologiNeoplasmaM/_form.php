...
<div class="form-actions">
    ...
    <?php echo CHtml::link(
        Yii::t('mds', '{icon} Pengaturan Morfologi Neoplasma', array('{icon}' => '<i class="icon-folder-open icon-white"></i>')),
        $this->createUrl('morfologiNeoplasmaM/admin', array('modul_id' => Yii::app()->session['modul_id'])),
