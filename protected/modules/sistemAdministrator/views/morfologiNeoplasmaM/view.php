...
//                (Yii::app()->user->checkAccess(Params::DEFAULT_UPDATE)) ?array_push($arrMenu,array('label'=>Yii::t('mds','Update').' SAMorfologineoplasmaM', 'icon'=>'pencil','url'=>array('update','id'=>$model->morfologineoplasma_id))) :  '' ;
//                array_push($arrMenu,array('label'=>Yii::t('mds','Delete').' SAMorfologineoplasmaM','icon'=>'trash','url'=>'#','linkOptions'=>array('submit'=>array('delete','id'=>$model->morfologineoplasma_id),'confirm'=>Yii::t('mds','Are you sure you want to delete this item?')))) ;
