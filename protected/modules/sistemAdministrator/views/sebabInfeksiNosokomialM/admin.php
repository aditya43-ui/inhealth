...
<?php 
        echo CHtml::link(Yii::t('mds', '{icon} Tambah Sebab Infeksi', array('{icon}'=>'<i class="icon-plus icon-white"></i>')), $this->createUrl('sebabInfeksiNosokomialM/create',array('modul_id'=> Yii::app()->session['modul_id'])), array('class' => 'btn btn-danger',));
