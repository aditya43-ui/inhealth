        ...
        <table id="tbl-Lookup" class="table table-responsive table-striped table-bordered table-condensed">
            ...
            <tbody>
                <tr>
                    ...
                    ?>
                    <td>
                        <?php echo CHtml::link('<i class="icon-plus-sign"></i>', '#', array('class' => 'btn btn-default', 'onclick' => 'addRow(this)', 'id' => 'row1-plus', 'onkeypress' => "return $(this).focusNextInputField(event);")); ?>
                    </td>
                </tr>
            </tbody>
        </table>
