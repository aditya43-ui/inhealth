...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="fas fa-layer-group"></i> Pengaturan <b>Submenu Jenis Kain</b>
        </div>
    </div>
    <div class="panel-body">
        <?php if (!empty($_GET['sukses'])) {
            echo Yii::app()->user->setFlash('success', '<b>Berhasil!</b> Data berhasil disimpan.');
        } ?>
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="entypo-credit-card"></i> Tabel <b>Submenu Jenis Kain</b>
                </div>
            </div>
        ...
        <div class="form-actions">
            <?php
            echo CHtml::link(
                Yii::t('mds', '{icon} Tambah Submenu Jenis Bahan', array('{icon}' => '<i class="icon-plus icon-white"></i>')),
                $this->createUrl('create', array('modul_id' => Yii::app()->session['modul_id'])),
                array('title' => 'Tambah submenu jenis bahan', 'class' => 'btn btn-danger')
            );
