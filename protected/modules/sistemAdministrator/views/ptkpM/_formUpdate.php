...
<div class="row">
    ...
    <div class="col-sm-6">
        ...
        <?php echo $form->textFieldRow($model, 'jmltanggunan', array('placeholder' => '00', 'class' => 'span3 integer2', 'onkeypress' => "return $(this).focusNextInputField(event);", 'maxlength' => 100)); ?>
        <div class="control-group">
