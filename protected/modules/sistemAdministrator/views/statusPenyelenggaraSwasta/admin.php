...
<?php $this->widget('ext.bootstrap.widgets.BootGridView',array(
	...
	'columns'=>array(
		...
		array(
			'header'=>'<p style="margin: 0; text-align: center;">Nama Status Penyelenggara Swasta</p>',
			'value'=>'$data->lookup_name',
			'htmlOptions'=>array('style'=>'text-align:left;'),
		),
		array(
			'header'=>'<p style="margin: 0; text-align: center;">Status Penyelenggara Swasta Lainnya</p>',
...
<?php 
	echo CHtml::link(Yii::t('mds','{icon} Tambah Status Penyelenggara Swasta',array('{icon}'=>'<i class="icon-plus icon-white"></i>')),$this->createUrl('create',array('modul_id'=> Yii::app()->session['modul_id'])), array('class' => 'btn btn-danger',)); 
