<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="far fa-edit"></i> Ubah <b>Konfigurasi Sistem</b>
        </div>
    </div>
    <div class="panel-body">
        <?php
        $this->breadcrumbs = array(
            'Konfigurasi Sistem' => array('update', 'id' => $model->konfigsystem_id),
            //$model->konfigsystem_id=>array('update','id'=>$model->konfigsystem_id),
            'Ubah',
        );
