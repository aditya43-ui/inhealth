    <div class="panel panel-gradient">
        <div class="panel-heading">
            <div class="panel-title">
                <i class="fas fa-layer-group"></i> Pengaturan <b>Jenis Kelas</b>
            </div>
        </div>
    ...
    ");
            ...
            <div class="panel panel-success">
                <div class="panel-heading">
                    <div class="panel-title">
                        <i class="entypo-credit-card"></i> Tabel <b>Jenis Kelas</b>
                    </div>
                </div>
            ...
            <div class="form-actions">
                <?php
                echo CHtml::link(
                    Yii::t('mds', '{icon} Tambah Jenis Kelas', array('{icon}' => '<i class="icon-plus icon-white"></i>')),
                    $this->createUrl('JenisKelasM/create', array('modul_id' => Yii::app()->session['modul_id'])),
                    array('title' => 'Tambah jenis kelas', 'class' => 'btn btn-danger',)
                );
