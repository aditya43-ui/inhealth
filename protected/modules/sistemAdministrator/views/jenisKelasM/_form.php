...
<div class="row">
    ...
    <div class="col-sm-6">
        <?php echo $form->textFieldRow($model, 'jeniskelas_namalainnya', array('placeholder' => 'Nama Lain', 'class' => 'span3', 'onkeypress' => "return nextFocus(this,event,'btn_simpan','SAJenisKelasM_jeniskelas_nama')", 'maxlength' => 25)); ?>
    </div>
</div>
