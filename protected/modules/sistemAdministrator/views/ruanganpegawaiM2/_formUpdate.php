        ...
        <table id="tabelKasuspenyakitdiagnosa" class="table table-bordered table-striped table-condensed">
            ...
            <tbody>
                ...
                foreach ($modRuanganpegawai as $value) {
                    ...
                    $tr .= '<td>' . $value->pegawai->namalengkap . '</td>';
                    $tr .= '<td style="width: 60px; text-align: center;">' . CHtml::link("<i class='icon-form-sampah'></i>", $hapus, array('onclick' => 'hapus(this);')) . '</td>';
                    $tr .= '</tr>';
                    echo $tr;
                }
                if (count((array)$modDetails) > 0) {
                    foreach ($modDetails as $i => $row) {
                        ...
                        $tr .= "<td style='width: 60px; text-align: center;'>" . CHtml::link("<i class='icon-form-silang'></i>", '#', array('onclick' => 'remove(this);')) . "</td>";
                        $tr .= "</tr>";
                        echo $tr;
                    }
                }
