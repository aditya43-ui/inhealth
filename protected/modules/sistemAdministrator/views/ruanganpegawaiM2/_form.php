...
//         $ruanganid = Yii::app()->user->ruangan_id;
        ...
        echo CHtml::hiddenField('ruanganid', $modRuangan->ruangan_id);
        echo CHtml::hiddenField('instalasi_id', $modRuangan->instalasi_id);
        
        echo $form->textFieldRow($model, 'instalasi_nama', array('value' => $modRuangan->instalasi->instalasi_nama, 'readonly' => true, 'class' => 'span3'));
        ?>
        <?php
...
function submitruanganpegawai()
{
    ...
    if(pegawai_id==''){
        ...
        if (cekList(pegawai_id) == true){
            ...
            function(data){
                if(data.ada == "ada") {
                    myAlert('Pegawai sudah terdaftar');
                } else {
                    $('#tabelKasuspenyakitdiagnosa').append(data.tr);
                }
                console.log('ada nggak? ' + data.ada);
            }, "json");
        }
    }   
}
...
<script type="text/javascript">
    ...
    var ruangan_nama =  localStorage.getItem("ruangan_nama");
    var ruangan_id =  localStorage.getItem("ruangan_id");

    console.log("ruangan_nama",ruangan_nama);
    console.log("ruangan_id",ruangan_id);
