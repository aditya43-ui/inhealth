<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="far fa-edit"></i> Ubah <b>Petunjuk Penggunaan Detail</b>
        </div>
    </div>
    <div class="panel-body">
        ...
        $this->breadcrumbs = array(
            'Petunjuk Penggunaan Detail' => array('index'),
            $model->petunjukpenggunaandetail_id => array('view', 'id' => $model->petunjukpenggunaandetail_id),
            'Update',
        );
