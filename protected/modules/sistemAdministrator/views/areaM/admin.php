...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title"> <i class="fas fa-layer-group"></i> Pengaturan <strong>Area</strong></div>
    </div>
...
<?php echo CHtml::link(Yii::t('mds', '{icon} Advanced Search', array('{icon}' => '<i class="icon-accordion icon-white"></i>')), '#', array('class' => 'search-button btn')); ?>
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title"><i class="entypo-credit-card"></i>Tabel <strong>Area</strong></div>
            </div>
        ...
        <?php
        echo CHtml::link(Yii::t('mds', '{icon} Tambah Area', array('{icon}'=>'<i class="entypo-folder"></i>')),
