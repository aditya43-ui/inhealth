    ...
    <div class="control-group table-responsive">
        <div class="controls">
            ...
            echo CHtml::dropDownList(
                ...
                array('multiple' => 'multiple', 'key' => 'kelaspelayanan_id', 'class' => 'multiselect', 'style' => 'width:450px;height:202px')
            );
            ?>
        </div>
    </div>
...
<div class="form-actions">
    ...
    <?php echo CHtml::link(
        Yii::t('mds', '{icon} Pengaturan Kelas Ruangan', array('{icon}' => '<i class="entypo-folder"></i>')),
        Yii::app()->createUrl($this->module->id . '/' . $this->id . '/admin', array('modul_id' => Yii::app()->session['modul_id'])),
