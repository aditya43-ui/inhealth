...
<?php $this->widget('ext.bootstrap.widgets.BootGridView',array(
	...
	'columns'=>array(
		...
		array(
			'header'=>'<p style="margin: 0; text-align: center;">Nama Kelas Rumah Sakit</p>',
...
<?php 
	echo CHtml::link(Yii::t('mds','{icon} Tambah Kelas Rumah Sakit',array('{icon}'=>'<i class="icon-plus icon-white"></i>')),$this->createUrl('create',array('modul_id'=> Yii::app()->session['modul_id'])), array('class' => 'btn btn-danger',)); 
