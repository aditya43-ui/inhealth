...
<?php 
        echo CHtml::link(Yii::t('mds', '{icon} Tambah Keluhan', array('{icon}'=>'<i class="icon-plus icon-white"></i>')), $this->createUrl('keluhananamnesisM/create',array('modul_id'=> Yii::app()->session['modul_id'])), array('class' => 'btn btn-danger',));
