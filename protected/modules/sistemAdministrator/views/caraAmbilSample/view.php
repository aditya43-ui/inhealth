<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="far fa-eye"></i> Lihat <b>Sample Lab</b>
        </div>
    </div>
    <div class="panel-body table-responsive">
        <?php
        $this->breadcrumbs = array(
            'Sample Lab' => array('index'),
            $model->caraambilsampel_id,
        );
        ?>
        ...
        <div class="form-actions">
            <?php echo CHtml::link(
                ...
                $this->createUrl('update&id=' . $model->caraambilsampel_id, array('modul_id' => Yii::app()->session['modul_id'])),
