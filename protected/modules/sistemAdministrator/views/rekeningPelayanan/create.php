<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="far fa-plus-square"></i> Tambah <b>Rekening Pelayanan</b>
        </div>
    </div>
    <div class="panel-body">
        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <?php echo CHtml::textField("komponentarif_nama", "", array('readonly' => true, 'span' => 'span3')); ?>
                    </div>
                </div>
                <div class="control-group">
                    <?php echo $form->labelEx($model, "Ruangan", array('class' => 'control-label')); ?>
                    <div class="controls">
                        <?php echo CHtml::textField("ruangan_nama", "", array('readonly' => true, 'span' => 'span3')); ?>
                    </div>
                </div>
            </div>
            <div class="col-sm-6">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        ?>
                        <?php
                        echo CHtml::htmlButton('<i class="' . MyIcon::getIcons('tambah-baris') . '"></i>', array(
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="entypo-credit-card"></i> Tabel <b>Daftar Akun Pelayanan</b>
                </div>
            </div>
                ...
                $this->widget('ext.bootstrap.widgets.BootGridView', array(
                    ...
                    'columns' => array(
                        ...
                        array(
                            ...
                            'name' => 'Saldo Normal',
                            'value' => function ($data) {
                                //var_dump($data->saldonormal);
                                return ($data->saldonormal == 'D' || strtolower($data->saldonormal) == 'debit') ? 'Debit' : 'Kredit';
                            },
                        ...
                        array(
                            ...
                            'type' => 'raw',
                            'value' => function ($data) {
                                return $data->ispelayanan ? '<i class="glyphicon glyphicon-ok"></i>' : "-";
                            },
                            'htmlOptions' => array(
                        ...
                        //						'type'=>'raw',
                        //						'value'=>function($data) {
                        //							return $data->ispembayaran?'<i class="glyphicon glyphicon-ok"></i>':"-";
                        //						},
                        //						'htmlOptions'=>array(
                        //							'style'=>'text-align: center'
                        //						)
                        ...
                        array(
                            ...
                            'type' => 'raw',
                            'value' => function ($data) {
                                return $data->isretur ? '<i class="glyphicon glyphicon-ok"></i>' : "-";
                            },
                            'htmlOptions' => array(
                                'style' => 'text-align: center'
                            )
                ...
                array(
                    ...
                    'value' => 'CHtml::Link("<i class=\"icon-form-check\"></i>",
                                ...
                                array(
                                    ...
                                    $(\"#komponentarif_nama\").val(\'".$data->komponentarif_nama."\');
    ...
    'columns' => array(
        array(
            ...
            'value' => 'CHtml::Link("<i class=\"icon-form-check\"></i>","#",array("class"=>"btn-small",
				"id" => "selectRekDebit",
				"onClick" =>"
                    $(\"#' . CHtml::activeId($model, 'rekening5_id_d') . '\").val(\'$data->rekeninglast_id\');
    ...
    'columns' => array(
        array(
            ...
            'value' => 'CHtml::Link("<i class=\"icon-form-check\"></i>","#",array("class"=>"btn-small",
				"id" => "selectRekDebit",
				"onClick" =>"
                    $(\"#' . CHtml::activeId($model, 'rekening5_id_k') . '\").val(\'$data->rekeninglast_id\');
