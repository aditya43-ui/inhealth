...
<div class="row">
    ...
    <div class="control-group">
            <?php echo CHtml::label("Nama Mikroorganisme", '', array('class' => 'control-label')) ?>
            <div class="controls">
                <?php echo $form->textField($model, 'nama_mikroorganisme', array('placeholder' => 'Nama', 'class' => 'span3', 'maxlength' => 100)); ?>
            </div>
        </div>
