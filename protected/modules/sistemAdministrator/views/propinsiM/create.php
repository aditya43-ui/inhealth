<div class="white-container">
    <legend class="rim2">Tambah <b>Provinsi</b></legend>
    <?php
    ...
    $arrMenu = array();
    //                array_push($arrMenu,array('label'=>Yii::t('mds','Create').' Provinsi', 'header'=>true, 'itemOptions'=>array('class'=>'heading-master'))) ;
