...
<div class="row">
    ...
    <div class="col-sm-6">
        <?php echo $form->textFieldRow($model, 'lookup_urutan', array('class' => 'span3', 'onkeypress' => "return $(this).focusNextInputField(event);", 'placeholder' => 'Urutan')); ?>
...
<div class="form-actions">
    ...
    ?>
    <?php
    //echo CHtml::link(Yii::t('mds', '{icon} Pengaturan Satuan Hasil Laboratorium', array('{icon}'=>'<i class="icon-file icon-white"></i>')), $this->createUrl('admin',array('modul_id'=> Yii::app()->session['modul_id'])), array('class' => 'btn btn-danger',));
    echo CHtml::link(
        Yii::t('mds', '{icon} Pengaturan Satuan Hasil', array('{icon}' => '<i class="icon-file icon-white"></i>')),
