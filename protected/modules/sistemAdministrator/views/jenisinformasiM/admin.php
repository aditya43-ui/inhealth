...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('jenisinformasi-m-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">Pengaturan <b>Jenis Informasi</b></div>
    </div>
    <div class="panel-body">
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">Tabel Jenis Informasi</div>
            </div>
            <div class="panel-body">
                <?php $this->widget('ext.bootstrap.widgets.BootGridView',array(
                    'id'=>'jenisinformasi-m-grid',
                    ...
                    array(
                        ...
                        'filter'=>CHtml::activeDropDownList($model, 'tipeinput_isiinformasi', Params::getTipeInputIsiInformasiList(), array('empty'=>'-- Pilih --')),
                    ),
                    array(
                        ...
                        array(
                            ...
                            'buttons'=>array(
                                'remove' => array (
                                        ...
                                        'url'=>'Yii::app()->createUrl("'.Yii::app()->controller->module->id.'/'.Yii::app()->controller->id.'/nonActive",array("id"=>$data->jenisinformasi_id))',
...
<?php 
	echo CHtml::link(Yii::t('mds','{icon} Tambah Jenis Informasi',array('{icon}'=>'<i class="icon-plus icon-white"></i>')),$this->createUrl('create',array('modul_id'=> Yii::app()->session['modul_id'])), array('class'=>'btn btn-success'))."&nbsp&nbsp"; 
...
{
    window.open("${urlPrint}/"+$('#jenisinformasi-m-search').serialize()+"&caraPrint="+caraPrint,"",'location=_new, width=900px');
}
JSCRIPT;
