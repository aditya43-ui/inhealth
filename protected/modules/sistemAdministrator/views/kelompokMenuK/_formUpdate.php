...
<div class="row">
    ...
    <div class="col-sm-6">
        ...
        <?php echo $form->textFieldRow($model, 'kelmenu_urutan', array('placeholder' => '00', 'class' => 'span1 numebrs-only', 'onkeypress' => "return nextFocus(this,event,'SAKelompokMenuK_kelmenu_aktif','SAKelompokMenuK_kelmenu_url')")); ?>
...
<div class="control-group">
    ...
    <div class="controls">
        <?php echo $form->checkBox($model, 'kelmenu_aktif', array()); ?>
