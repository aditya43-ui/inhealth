...
<div class="row">
    ...
    <div class="col-sm-6">
        <?php echo $form->textFieldRow($model, 'pendidikan_urutan', array('placeholder' => '00', 'class' => 'span1 integer', 'onkeypress' => "return $(this).focusNextInputField(event);", 'maxlength' => 6)); ?>
    </div>
</div>
