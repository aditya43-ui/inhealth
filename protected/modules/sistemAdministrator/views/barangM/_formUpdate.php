...
$form = $this->beginWidget('ext.bootstrap.widgets.BootActiveForm', array(
    ...
    'type' => 'horizontal',
    'htmlOptions' => array('enctype' => 'multipart/form-data', 'onKeyPress' => 'return disableKeyPress(event)', 'onsubmit' => 'return requiredCheck(this);'), //cekNomorReg();
...
<div class="row">
    ...
    <div class="col-sm-6">
        ...
        <?php
        echo $form->dropDownListRow($model, 'barang_satuan', LookupM::getItems('satuanbarang'), array(
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $form->textField($model, 'barang_harganetto', array('class' => 'span2 integer2', 'onkeypress' => "return $(this).focusNextInputField(event);", 'onblur' => 'perhitunganhpp();')) . ' <label>Rupiah</label>'; ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $form->textField($model, 'barang_persendiskon', array('class' => 'span1 comadesimal-only', 'onkeypress' => "return $(this).focusNextInputField(event);", 'style' => 'text-align:right;', 'onblur' => 'perhitunganhpp();')); ?>
            </div>
        </div>
        <div class="control-group">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $form->textField($model, 'barang_ppn', array('class' => 'span2 comadesimal-only', 'onkeypress' => "return $(this).focusNextInputField(event);", 'style' => 'text-align:right;', 'onblur' => 'perhitunganhpp();')); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            <?php echo CHtml::label("", 'barang_aktif', array('class' => 'control-label')) ?>
            <div class="controls">
                <?php echo $form->checkBox($model, 'barang_aktif'); ?> <label>Aktif</label>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    function perhitunganhpp() {
        var harganettp = parseInt(unformatNumber($("#<?php echo CHtml::activeId($model, "barang_harganetto"); ?>").val()));
        var persendiskon = parseFloat(unformatNumber($("#<?php echo CHtml::activeId($model, "barang_persendiskon"); ?>").val()));
        var persenppn = parseFloat(unformatNumber($("#<?php echo CHtml::activeId($model, "barang_ppn"); ?>").val()));

        var jmldiskon = ((harganettp * persendiskon) / 100);
        var jmlppn = (((harganettp - jmldiskon) * persenppn) / 100);
        var hargabruto = (harganettp - jmldiskon + jmlppn);

        $("#<?php echo CHtml::activeId($model, "barang_hpp"); ?>").val(formatNumber(hargabruto));
        $("#<?php echo CHtml::activeId($model, "barang_hargajual"); ?>").val(formatNumber(hargabruto));
    }
</script>