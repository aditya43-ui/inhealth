...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('jenisskriningpasien-m-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="fas fa-cogs"></i> Pengaturan <b>Jenis Srining Pasien</b>
        </div>
    </div>
    ...
    <div class="panel-body">
        <div class="panel panel-gradient">
            <div class="panel-heading">
                <div class="panel-title">Tabel Jenis Srining Pasien</div>
            </div>
            <div class="panel-body">
                <?php
                $this->widget('ext.bootstrap.widgets.BootGridView', array(
                    'id' => 'jenisskriningpasien-m-grid',
                        ...
                        array(
                            ...
                            'buttons' => array(
                                'remove' => array(
                                    ...
                                    'url' => 'Yii::app()->createUrl("' . Yii::app()->controller->module->id . '/' . Yii::app()->controller->id . '/nonActive",array("id"=>$data->jenisskriningpasien_id))',
    ...
    <div class="panel-body">
        <?php
        echo CHtml::link(Yii::t('mds', '{icon} Tambah Jenis Srining Pasien', array('{icon}' => '<i class="icon-plus icon-white"></i>')), $this->createUrl('create', array('modul_id' => Yii::app()->session['modul_id'])), array('class' => 'btn btn-success')) . "&nbsp&nbsp";
...
{
    window.open("${urlPrint}/"+$('#jenisskriningpasien-m-search').serialize()+"&caraPrint="+caraPrint,"",'location=_new, width=900px');
}
JSCRIPT;
