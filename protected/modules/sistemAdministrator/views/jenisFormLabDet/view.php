<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="far fa-eye"></i> Lihat <b>Jenis Form Detail</b>
        </div>
    </div>
    <div class="panel-body table-responsive">
        <?php
        $this->breadcrumbs = array(
            'Jenis Form Detail ' => array('index'),
            $model->formlab_id,
        );
        ?>
        ...
        <div class="row">
            <div class="col-sm-6">
                <?php $this->widget('ext.bootstrap.widgets.BootDetailView', array(
                    'data' => $model,
                    'attributes' => array(
                        'jp.jenispemeriksaanlab_kode',
                        'jp.jenispemeriksaanlab_nama',
            ...
            <div class="col-sm-6">
                <?php $this->widget('ext.bootstrap.widgets.BootDetailView', array(
                    ...
                    'attributes' => array(
                        ...
                        'p.jenispemeriksaanlab_kelompok',
        ...
        <div class="form-actions">
            <?php echo CHtml::link(
                ...
                $this->createUrl('update&id=' . $model->formlab_id, array('modul_id' => Yii::app()->session['modul_id'])),
