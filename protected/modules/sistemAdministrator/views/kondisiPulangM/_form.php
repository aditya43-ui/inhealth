...
<div class="row">
    <div class="col-sm-6">
        <?php echo $form->textFieldRow($model, 'lookup_name', array('placeholder' => 'Kondisi Pulang', 'class' => 'span3', 'onkeypress' => "return $(this).focusNextInputField(event);", 'maxlength' => 200)); ?>
        <?php echo $form->textFieldRow($model, 'lookup_urutan', array('placeholder' => 'Urutan', 'class' => 'span3 numbers-only', 'onkeypress' => "return $(this).focusNextInputField(event);")); ?>
    </div>
    <div class="col-sm-6">
