...
<div class="row-fluid">
    <div class="col-md-6">
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $form->textArea($model, 'post_judul', array('placeholder' => 'Nama Post', 'rows' => 5, 'cols' => 60, 'class' => 'required span6', 'onkeypress' => "return $(this).focusNextInputField(event);", 'onkeyup' => "namaLain(this)")); ?>
        ...
        <div class="control-group">
            ...
            <div class="controls">                            
                <?php echo $form->textArea($model, 'post_namalain', array('placeholder' => 'nama Lainnya', 'rows' => 5, 'cols' => 60, 'class' => 'span6', 'onkeypress' => "return $(this).focusNextInputField(event);")); ?>
            </div>
        </div>
    ...
    <div class="col-md-6">
        ...
        <div class="control-group">
            <div>
            <?php
            if ((!$model->isNewRecord) && (!empty($model->post_gambar))) {
                echo "<div class='control-group' id='gambar_hide'>
                        <div class='controls'>";
                echo "<img src='" . Params::urlBeritaGambar() . $model->post_gambar . "' class='preview_picture'  width='300px' height='300px' align='right'>";
                echo "</div></div>";
                ...
                echo "</div></div>";
            } else if ((!$model->isNewRecord) && (empty($model->post_gambar))) {
                echo "<div class='control-group'>
                        <div class='controls'>";
                echo "<img src='#' class='preview_picture' width='400' alt='Preview Gambar' />";
                echo "</div></div>";
            }else{
                echo "<div class='control-group'>
                        <div class='controls'>";
                echo "<img src='#' class='preview_picture' width='400' />";
                echo "</div></div>";
            }
            ?>
             </div>   
            <?php echo CHtml::label("Post Gambar", '', array('class' => 'control-label')); ?>
            <div class="controls">


                <?php
                if (($model->isNewRecord) && (empty($model->post_gambar))) {
                    echo CHtml::activeFileField($model, 'post_gambar', array('class' => ''));
                    echo '<b style="color:red">Catatan Image:</b>Minimal Ukuran Image Width min 400 px dan Height min 200px';
                } else {
                    echo CHtml::activeFileField($model, 'post_gambar', array('class' => ''));
                    echo '<b style="color:red">Catatan Image:</b>Minimal Ukuran Image Width min 400 px dan Height min 200px';
                }
                            ...
                            foreach ($modDetail as $rowdetail) {
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <?php echo CHtml::activeHiddenField($modelDetail, '[' . $i . ']postgambar_id', array('value' => $rowdetail->postgambar_id,'class' => 'span3')); ?>	
...
$this->renderPartial('_jsFunction', array('model' => $model, 'modDetail' => $modelDetail, 'form' => $form)); ?>
