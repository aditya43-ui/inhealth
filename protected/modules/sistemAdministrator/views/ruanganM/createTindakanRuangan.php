...
<div class="control-group">
 ...
 <div class="form-actions">
                        ...
                        array('class' => 'btn btn-default',
                              ...
                              echo CHtml::link(Yii::t('mds', '{icon} Pengaturan Ruangan', array('{icon}'=>'<i class="icon-file icon-white"></i>')), $this->createUrl(Yii::app()->controller->id.'/admin',array('modul_id'=> Yii::app()->session['modul_id'])), array('class' => 'btn btn-danger',));
                                                              ?>
            </div>
<?php $this->endWidget(); ?>