<?php $form=$this->beginWidget('ext.bootstrap.widgets.BootActiveForm',array(
	...
	<?php echo $form->errorSummary($model); ?>
        <div class="row-fluid">
            <div class="col-sm-6">
                ...
                <?php echo $form->textFieldRow($model,'anastesi_nama',array('class'=>'span3', 'onkeyup'=>"return $(this).focusNextInputField(event);", 'maxlength'=>50, 'onkeyup'=>'namalain(this)')); ?>
            </div>
            <div class="col-sm-6">
                <?php echo $form->textFieldRow($model,'anastesi_namalainnya',array('class'=>'span3', 'onkeyup'=>"return $(this).focusNextInputField(event);", 'maxlength'=>50)); ?>
                <?php if(isset($_GET['id'])){ ?>
                <?php // echo $form->checkBoxRow($model,'anastesi_aktif', array('onkeyup'=>"return $(this).focusNextInputField(event);")); ?>
	...
	<div class="form-actions">
		...
		<?php echo CHtml::link(Yii::t('mds','{icon} Pengaturan Anestesi',array('{icon}'=>'<i class="entypo-folder"></i>')),$this->createUrl('admin',array('modul_id'=> Yii::app()->session['modul_id'])), array('class'=>'btn btn-success')); ?>
		<?php 
