<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="far fa-plus-square"></i> Tambah <b>Rak Penyimpanan</b>
        </div>
    </div>
    <div class="panel-body">
        ...
        $arrMenu = array();
        array_push($arrMenu, array('label' => Yii::t('mds', 'Create') . ' Rak Penyimpanan ', 'header' => true, 'itemOptions' => array('class' => 'heading-master')));
