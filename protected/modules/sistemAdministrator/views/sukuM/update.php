...
$arrMenu = array();
                array_push($arrMenu,array('label'=>Yii::t('mds','Update').' Suku ', 'header'=>true, 'itemOptions'=>array('class'=>'heading-master'))) ;
...
//                array_push($arrMenu,array('label'=>Yii::t('mds','View').' Suku', 'icon'=>'eye-open', 'url'=>array('view','id'=>$model->suku_id))) ;
