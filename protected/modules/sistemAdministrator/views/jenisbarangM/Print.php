...
if($caraPrint=='EXCEL')
{
    ...
    <?php  $this->renderPartial($this->path_view . '_tablePrint', array('model'=>$model, 'caraPrint'=>$caraPrint)); ?>
    </div>
    ...
    <tbody>
        <tr>
            <td>
                ...
                <?php  
                  $this->renderPartial($this->path_view .'_tablePrint', array('model'=>$model, 'caraPrint'=>$caraPrint));            
                ?>
		</div>		
            </td>
        </tr>
