...
$this->widget($table, array(
    ...
    'columns' => array(
        ...
        array(
            ...
            'value' => function($data) {
                if (!empty($data->kelompoktandagejaladaftar_id)) {
                    $cekkelompok = KelompoktandagejaladaftarM::model()->findByPk($data->kelompoktandagejaladaftar_id);
                    if (!empty($cekkelompok->jenistandagejala_id)) {
                        $cekJenis = JenistandagejalaM::model()->findByPk($cekkelompok->jenistandagejala_id);
                        if (!empty($cekJenis)) {
