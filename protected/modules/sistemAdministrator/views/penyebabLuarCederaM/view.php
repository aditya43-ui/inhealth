...
//                (Yii::app()->user->checkAccess(Params::DEFAULT_UPDATE)) ?array_push($arrMenu,array('label'=>Yii::t('mds','Update').' SAPenyebabluarcederaM', 'icon'=>'pencil','url'=>array('update','id'=>$model->penyebabluarcedera_id))) :  '' ;
//                array_push($arrMenu,array('label'=>Yii::t('mds','Delete').' SAPenyebabluarcederaM','icon'=>'trash','url'=>'#','linkOptions'=>array('submit'=>array('delete','id'=>$model->penyebabluarcedera_id),'confirm'=>Yii::t('mds','Are you sure you want to delete this item?')))) ;
