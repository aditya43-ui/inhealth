...
$this->breadcrumbs = array(
    'Kirim Pesan Pasien Berkunjung',
); ?>

<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="fas fa-envelope"></i> Kirim <b>Pesan Pasien Kunjungan</b> <?php echo $this->is_blast ? "- SMS Blast" : ""; ?>
        </div>
    </div>
            ...
            <table width="100%" cellpadding="5px">
                <tr>
                    <td width="100%">
                        ...
                        $this->widget('ext.bootstrap.widgets.BootGridView', array(
                            ...
                            'columns' => array(
                                ...
                                array(
                                    ...
                                    'type' => 'raw',
                                    'htmlOptions' => array('style' => 'text-align: center;'),
                                    'value' => '$data->tglrenkontrol',
                                    'filter' =>
                                    CHtml::activeTextField($modPasien, 'tglrenkontrol', array('style' => 'width: calc(100% - 30px) !important; float: left;', 'uncheckValue' => 0, 'rel' => 'tooltip'))
                                        . ' ' .
                                        CHtml::activeCheckBox($modPasien, 'is_tglKontrol', array('style' => 'width: initial !important; margin: 8px !important;', 'uncheckValue' => 0, 'rel' => 'tooltip', 'title' => 'Filter Tanggal Kontrol'))
                                    //                            'filter' => '<div class="row">'.CHtml::activeCheckBox($modPasien, 'is_tglKontrol', array('uncheckValue'=>0,'rel'=>'tooltip','title'=>'Filter Tanggal Kontrol')).CHtml::activeTextField($modPasien, 'tglrenkontrol', array('uncheckValue'=>0,'rel'=>'tooltip')).'<div>',
                                ),
                                array(
						...
						$(\'input[name="PasienberkunjungsmscenterV[tgl_pendaftaran]"]\').daterangepicker({
							"maxDate": "' . date('m/d/Y') . '",
							"showDropdowns": true,
						}, afterPilihTanggal);
						$(\'input[name="PasienberkunjungsmscenterV[tglrenkontrol]"]\').daterangepicker({
							"showDropdowns": true,
							"opens": "left"
						}, afterPilihTanggal);
						cekStatusSelect();
...
<script type="text/javascript">
    ...
    function selectAll() {
        ...
        var tgl_pendaftaran = $("#pasien-m-grid tr.filters").find('input[name*="[tgl_pendaftaran]"]').val();
        ...
        var tglrenkontrol = $("#pasien-m-grid tr.filters").find('input[name*="[tglrenkontrol]"]').val();
        ...
        $("#pasien-m-grid tr.filters").find('input[name*="[is_tglKontrol]"]').each(
            function() {
                if ($(this).is(":checked")) {
                    is_tglKontrol = 1;
                } else {
        ...
        jQuery.ajax({
            'url': '<?php echo $this->createUrl('SelectAllKunjungan') ?>',
            'data': {
