    ...
    ?>
        ...
        <div class="col-sm-6">
            <div class="control-group">		
                ...
                <div class="controls">
                    <div class="daterange daterange-inline input-inline setIndikator" data-format="D MMMM YYYY" data-start-date="<?php echo date('F d, Y') ?>" data-end-date="<?php echo date('F d, Y') ?>">
