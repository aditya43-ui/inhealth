...
<div class="col-md-3">
    <div class="tile-stats tile-aqua">
        ...
        <div class="col-sm-6">
            <h4 style="color: white"><b>Total </b><br>Campaigns</h4>
        </div>
    </div>
</div>
...
<div class="col-md-3">
    ...
    <div class="tile-stats tile-orange">
        ...
        <div class="col-sm-6">
            ...
            <h4 style="color: white"><b>Success </b><br>Transaction</h4>
        </div>
...
<div class="col-md-3">
    ...
    <div class="tile-stats tile-green">
        ...
        <div class="col-sm-6">
            <div id="tile3" style="font-size:6vw" class="num" data-start="0" data-end="<?php echo "0"; ?>" data-postfix="" data-duration="1500" data-delay="0">0</div>
        </div>
        <div class="col-sm-6">
            <h4 style="color: white"><b>Success </b><br>SMS</h4>
...
<div class="col-md-3">
    ...
    <div class="tile-stats tile-red">
        ...
        <div class="col-sm-6">
            <h4 style="color: white"><b>Failed </b><br>SMS</h4>
