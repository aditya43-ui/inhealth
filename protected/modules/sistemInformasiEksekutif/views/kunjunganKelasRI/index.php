...
$this->breadcrumbs = array(
    'Informasi Rumah Sakit Kunjungan Rawat Inap Berdasarkan Kelas'
);
?>
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="entypo-info-circled"></i> Informasi Rumah Sakit <b>Kunjungan Rawat Inap Berdasarkan Kelas</b>
        </div>
    </div>
