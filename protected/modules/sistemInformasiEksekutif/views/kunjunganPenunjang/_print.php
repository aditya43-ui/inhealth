...
if ($caraPrint != 'EXCEL') {
    if ($caraPrint == 'PRINT') {
        ...
        <span>
        <?php
        echo $this->renderPartial('application.views.headerReport.headerLaporanTransaksiNew', array('judulLaporan' => $judulLaporan, 'periode' => '', 'colspan' => 6));
        ?>
        </span>
        <table>
            <thead>
            ...
            <tbody>
                <tr>
                    <td>
                        <div class="content"><?php $this->renderPartial('_tableprint', array('model' => $model, 'caraPrint' => $caraPrint)); ?></div>
                    </td>
                </tr>
            </tbody>
            <tfoot>
...
//        echo $this->renderPartial('application.views.headerReport.headerLaporanTransaksiNew', array('judulLaporan' => $judulLaporan, 'periode' => ' ', 'colspan' => 7));
    ...
    echo $this->renderPartial('application.views.headerReport.headerLaporanTransaksiExcelNew', array('judulLaporan' => $judulLaporan, 'periode' => ' ', 'colspan' => 6));
}
?>
...
if ($caraPrint == 'GRAFIK') {
    echo $this->renderPartial('_jsFunctions', array('model' => $model), true);
}
?>