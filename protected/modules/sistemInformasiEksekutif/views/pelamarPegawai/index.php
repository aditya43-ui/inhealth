...
$this->breadcrumbs = array(
    'Informasi Pegawai Laporan Pelamar yang Diterima sebagai Pegawai'
);
?>
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="entypo-info-circled"></i> Informasi Pegawai <b>Laporan Pelamar yang Diterima sebagai Pegawai</b>
        </div>
    </div>
