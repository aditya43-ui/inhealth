    ...
    <div class="bases">
        <div id="header" class="row">
            <div class="col-sm-3" style="padding-left: 30px;">
                <div><?php echo CHtml::image(Yii::app()->getBaseUrl('webroot')."/images/dokter/logo_rssacpt.png", 'RSSACPT', array(
            ...
            <div class="col-sm-6">
                <p style=" text-align: center;">
                    ...
                    <span id="tab-text" style="word-spacing: 30px;">
                        <i>JADWAL DOKTER</i>
                    </span>
                    <span id="tab-tgl-text">
                        <i><?php echo date('d M Y') . '</i><i>' . date('d M Y', strtotime('+6 days')) ?></i>
                    </span>
                </p>
            </div>
        ...
        <div>
            ...
            <div class="row">
                <div class="col-sm-12" style="padding-left: 50px; padding-right: 50px;">
                    ...
                    $senin = $model->jadwaldokter_hari='jumat';
                    $model->unsetAttributes();
                    $senin = $model->searchDashboardJadwal7hari();
                    $this->widget('ext.bootstrap.widgets.BootGridView', array(
                        'id' => 'ketersediaan-kamar-grid-2',
                        'dataProvider' => $senin,
                        ...
                        'columns' => array(
                            ...
                            array(
                                ...
                                'htmlOptions' => array(
                                    ...
                                    border-radius: 40px;
                                    -webkit-box-shadow: 1px 4px 10px #333;',
                                ),
                                'headerHtmlOptions' => array(
                                    'style' => 'text-align: center;
                            ...
                            array(
                                'header' => 'SENIN',
                                'name' => 'jadwaldokter_mulai',
                                'value' => function ($data) {
                                    if($data->jadwaldokter_hari='jumat'){
                                        return date("H:i", strtotime($data->jadwaldokter_mulai)).'-'.date("H:i", strtotime($data->jadwaldokter_tutup));
                                    }else{
                                        return '-';
                                    }
                                },
                            ...
                            //     'value' => 'strtoupper($data->jadwaldokter_hari)',
                            //     'htmlOptions' => array(
                            //         'style' => 'text-align: center;
                            //         font-size: 18px !important;
                            //         border-radius: 40px;
                            ...
                            array(
                                'header' => 'MINGGU',
                                'name' => 'jadwaldokter_mulai',
                                'value' => 'date("H:i", strtotime($data->jadwaldokter_mulai))." - ".date("H:i", strtotime($data->jadwaldokter_tutup))',
                                'htmlOptions' => array(
                                    'style' => 'text-align: center;
                                    font-size: 18px !important;
                                    border-radius: 40px;
...
<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/footer/dotcom.png" class="visible-md-inline visible-lg-inline" style="width: 8%; margin-left:10px; float:left;">
</html>
