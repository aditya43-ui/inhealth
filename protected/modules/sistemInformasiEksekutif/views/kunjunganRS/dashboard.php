...
<?php $this->renderPartial('_tile', ['dataTile' => $dataTile]); ?>
<?php $this->renderPartial('_lineNew', ['dataLine' => $dataLine]); ?>
<!--?php $this->renderPartial('_bar', array('model' => $model,'dataBarLineChart' => $dataBarLineChart)); ?-->
<?php $this->renderPartial('_pieNew', ['dataPie' => $dataPie]); ?>
<?php $this->renderPartial('_barNew', array('dataBar' => $dataBar, 'model' => $model)); ?>
...
<script>
    function printSemua(caraPrint) {
        ...
        doc.text("Grafik Kunjungan Ke Rumah Sakit", 150, 10, {
            align: 'center'
        });
        ...
        doc.text("Grafik Berdasarkan Pelayanan", 150, 10, {
            align: 'center'
        });
        ...
        doc.addPage();
        var canvas3 = document.querySelector('#bar');
        doc.text("Laporan Kunjungan Rumah Sakit", 150, 10, {
            align: 'center'
        });
        var canvasImg3 = canvas3.toDataURL("image/png", 1.0);
        console.log(canvasImg3);
        doc.setFontSize(20);
        doc.addImage(canvasImg3, 'PNG', 10, 10, 280, 150);
        doc.save('Grafik_KunjunganRS.pdf');
    }
</script>