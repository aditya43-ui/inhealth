...
<head>
    ...
    <style>
        ...
        #ketersediaan-kamar-grid {
            ...
            background: url("<?php echo Yii::app()->request->baseUrl; ?>/images/antrian/bed.jpg") center center no-repeat;
        ...
        <div>
            <div class="row">
                <div class="col-sm-12" style="padding-left: 20px; padding-right: 20px;">
                    <?php
                    $model = new SEInformasikamarinapV();
                    $model->unsetAttributes();
                    $this->widget('ext.bootstrap.widgets.BootGridView', array(
                        'id' => 'ketersediaan-kamar-grid',
                        'dataProvider' => $model->searchListKamar(),
                        'template' => "{items}",
                        'enableSorting' => false,
                        ...
                        'columns' => array(
                            ...
                            array(
                                ...
                                'name' => 'terpakai_bed',
                                'htmlOptions' => array(
                                    'style' => 'text-align: center; font-size: 32px !important;',
                                ),
                                'headerHtmlOptions' => array(
                                    'style' => 'width: 240px;
                                                text-align: center;
                            ...
                            array(
                                ...
                                'type' => 'raw',
                                'value' => function ($data) {
                                    return $data->total_bed - $data->terpakai_bed;
                                },
                                'htmlOptions' => array(
                                    'style' => 'text-align: center; font-size: 32px !important;',
                                ),
