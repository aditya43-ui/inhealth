...
$this->breadcrumbs = array(
    'Informasi Keuangan Pendapatan Rumah Sakit Berdasarkan Jasa'
);
?>
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="entypo-info-circled"></i> Informasi Keuangan <b>Pendapatan Rumah Sakit Berdasarkan Jasa</b>
        </div>
    </div>
