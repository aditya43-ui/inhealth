            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <?php echo $form->dropDownList($model, 'instalasi_id', CHtml::listData(SEInstalasiM::getSemuaInstalasi(), 'instalasi_id', 'instalasi_nama'), array('class' => 'span3', 'empty' => '-- Pilih --', 'onkeyup' => "return $(this).focusNextInputField(event)")); ?>
                        </div>
                    </div>
                </div>
            </div>
