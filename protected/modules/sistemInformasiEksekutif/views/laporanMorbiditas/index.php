...
?>
<?php $this->menu = array(array('label' => 'Laporan Morbiditas', 'header' => true, 'itemOptions' => array('class' => 'heading-master')),); ?>
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="entypo-newspaper"></i> Laporan <b>Morbiditas</b>
        </div>
    </div>
