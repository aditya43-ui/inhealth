...
<div class="panel panel-success" style="margin-top: 17px;">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="fas fa-chart-pie"></i> Grafik Angka Kunjungan Berdasarkan Jenis Penjamin - Periode <?php echo $awal; ?> sd <?php echo $akhir; ?>
        </div>
    ...
    <div class="panel-body">
        <div class="form-group" style="float: left;
             text-align: left;
             font-weight: normal;">
            <label for="carabayar">Jenis Penjamin:</label>
