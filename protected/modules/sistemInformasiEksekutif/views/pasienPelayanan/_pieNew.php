...
<div class="panel panel-success" style="margin-top: 17px;">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="fas fa-chart-pie"></i> Grafik 10 Besar Pelayanan Terbanyak Berdasarkan Instalasi
        </div>
    ...
    <div class="panel-body" style="text-align: center">
        <?= CHtml::dropDownList('instalasi_id', $model->instalasi_id, $model->getInstalasiPelayanan(), ['prompt' => 'Pilih Instalasi', 'style' => 'text-align:center;', 'onChange' => 'pilihInstalasi(this)']) ?>
    </div>
...
<script>
    $(document).ready(function() {
        ...
        //generateGrafik($("#pie"),'pie   ',lineChart.bar, '');
