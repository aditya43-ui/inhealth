...
class LaporanCaraBayarController extends MyAuthController
{
	...
	public function actionIndex()
	{
            ...
            $data['title'] = 'Laporan Jenis Penjamin';
        ...
        public function actionUpdateGrafik(){
            if(Yii::app()->request->isAjaxRequest) {
                ...
                $return['title'] = "Laporan Jenis Penjamin <br> Periode: ".$periodeGrafik;
                if(isset($_POST['carabayar_nama'])){
                    if(!empty($_POST['carabayar_nama']))
                        $return['title'] = 'Grafik Jenis Penjamin '.(ucfirst(strtolower($_POST['carabayar_nama'])))."<br>Periode : ".$periodeGrafik;
