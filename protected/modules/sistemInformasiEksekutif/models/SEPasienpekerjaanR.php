 ...
 */
class SEPasienpekerjaanR extends PasienpekerjaanR {

    public $tgl_awal, $tgl_akhir, $periode, $id, $jenis, $jumlah, $pekerjaan_id, $pekerjaan_nama;
    ...
    public function searchLaporan() {
        ...
        $criteria->group = "date_trunc('day', tanggal), pekerjaan_id, pekerjaan_nama";
        $criteria->select = $criteria->group . ", date_trunc('day', tanggal) as periode, SUM(jumlah) AS jumlah";
        $criteria->addBetweenCondition('tanggal', '2015-12-01', '2015-12-08');
        $criteria->order = "periode";
        return $criteria;
    }
