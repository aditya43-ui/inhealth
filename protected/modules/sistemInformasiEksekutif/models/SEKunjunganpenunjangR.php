...
class SEKunjunganpenunjangR extends CActiveRecord {
    ...
    public $data, $data_2;
    public $jumlah_radiologi, $jumlah_laboratorium, $jumlah_labpa, $jumlah_mikro, $jumlah_rehabilitasi, $jumlah_mcu, $jumlah_bedah;
    ...
    /**
     * Pencarian laporan kunjungan penunjang (print)
