...
class SELaporanpenjaminpasienV extends LaporanpemeriksaangroupV{
    ...
    public function searchCriteria(){
        ...
        // $criteria->select = 'count(penjamin_id) as jumlah, penjamin_id, penjamin_nama as data';
    ...
    public function searchGrafikGaris() {
        ...
        if($jmlhari > 30){
            $criteria->select = 'count(penjamin_id) as jumlah, EXTRACT(MONTH FROM tglmasukpenunjang::timestamp) as data, EXTRACT(YEAR FROM tglmasukpenunjang::timestamp) as data_2';
            $criteria->group = 'data_2,data';
        }else{
            $criteria->select = 'count(penjamin_id) as jumlah, date(tglmasukpenunjang) as data';
            $criteria->group = 'data';
        }
    ...
    public function searchGrafikBatangPiePenjamin() {
        $criteria = $this->searchCriteria();
        $criteria->select = 'count(penjamin_id) as jumlah, penjamin_nama as data';
    ...
    public function searchSpeedo() {
        $criteria = $this->searchCriteria();
        $criteria->select = 'count(penjamin_id) as data';
        return new CActiveDataProvider($this, array(
                    'criteria' => $criteria,
                ));
    }
