...
/**
 * This is the model class for table "beban_r".
 *
 * The followings are the available columns in table 'beban_r':
 ...
 */
class SEBebanR extends BebanR
{
    public $jns_periode;
    public $periode, $jumlah, $jenis, $jumlah_beban, $jumlah_pendapatan;
    public $tgl_awal, $tgl_akhir, $bln_awal, $bln_akhir, $thn_awal, $thn_akhir;
    public $data, $data_2;
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return BebanR the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('beban_id, tanggal, rekening_id, rekening_nama, jumlah', 'safe', 'on'=>'search'),
		);
	}
	...
	public function criteriaSearch()
	{
		...
		if(!empty($this->beban_id)){
			$criteria->addCondition('beban_id = '.$this->beban_id);
		}
