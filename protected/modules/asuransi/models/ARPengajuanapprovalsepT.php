...
{
        public $tgl_awal,$tgl_akhir,$no_pendaftaran,$carabayar_id,$penjamin_id,$no_sep,$hakkelas_kode;
	...
	public function criteriaSearch()
	{
		...
		$criteria=new CDbCriteria;
                // $criteria->addCondition('tgl_sep BETWEEN \''.$this->tgl_awal.'\' AND \''.$this->tgl_akhir.'\'');
				// $criteria->addBetweenCondition('DATE(tgl_sep)', $this->tgl_awal, $this->tgl_akhir);
		$criteria->addCondition("DATE(tgl_sep) BETWEEN '".$this->tgl_awal."' AND '".$this->tgl_akhir."' OR DATE(create_time) BETWEEN '".$this->tgl_awal."' AND '".$this->tgl_akhir."'");
		if(!empty($this->pengajuanapprovalsep_id)){
			$criteria->addCondition('pengajuanapprovalsep_id = '.$this->pengajuanapprovalsep_id);
		}
		...
		$criteria->compare('LOWER(jenispeserta_bpjs_kode)',strtolower($this->jenispeserta_bpjs_kode),true);
		$criteria->compare('LOWER(jenispeserta_bpjs_nama)',strtolower($this->jenispeserta_bpjs_nama),true);
		$criteria->compare('LOWER(tanggal_pengajuan)',strtolower($this->tanggal_pengajuan),true);
		...
		$criteria->compare('LOWER(jnspengajuan_approvalsep)',$this->jnspengajuan_approvalsep,true);
		...
		if(!empty($this->jenisrujukan)){
			$criteria->addCondition('jenisrujukan = '.$this->jenisrujukan);
		}
		$criteria->compare('LOWER(diagnosa_awal)',strtolower($this->diagnosa_awal),true);
		$criteria->compare('LOWER(diagnosa_awal_nama)',strtolower($this->diagnosa_awal_nama),true);
