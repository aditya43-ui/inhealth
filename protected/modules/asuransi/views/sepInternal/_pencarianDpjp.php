<div class="row-fluid form-horizontal">
    ...
    <div class="span12">
        <div class="control-group hideDpjpDialog">
            <?php echo CHtml::label('Kode Spesialis / Sub Spesialis', '', array('class' => 'control-label')); ?>
            <div class="controls">
                <?php echo CHtml::textField('kode_spesialis', '', array('class' => 'span3', 'placeholder' => 'Ketikan kata kunci')); ?>
                <?php echo CHtml::htmlButton(
                    '<i class="entypo-search"></i>',
                    array(
                        'onclick' => 'cariDataDokter();return false;',
...
<script type="text/javascript">
    function cariDataDokter() {
        var katakunci1 = $('#ARSepT_jnspelayanan').val();
        var katakunci2 = $('#ARSepT_tglsep').val();
        ...
        var setting = {
            url: "<?php echo $this->createUrl('dpjp/bpjsInterface'); ?>",
            type: 'GET',
            dataType: 'html',
            ...
            success: function(data) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?php echo $this->createUrl('setFormDokter'); ?>',
                    data: {
                        diagnosaList: list
                    }, //
                    dataType: "json",
