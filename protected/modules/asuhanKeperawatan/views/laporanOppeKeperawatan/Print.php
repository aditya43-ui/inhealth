    ...
    if ($caraPrint == 'PRINT') {
        ...
        <table>
            ...
            <tbody>
                <tr>
                    <td>
                        <div class="content"><?php $this->renderPartial('_tableprint', array('model' => $model, 'caraPrint' => $caraPrint, 'periode' => $periode)); ?></div>
                    </td>
                </tr>
            </tbody>
            <tfoot>
...
if ($caraPrint == 'PDF') {
    ...
    $this->renderPartial('_tableprint', array('model' => $model, 'caraPrint' => $caraPrint, 'periode' => $periode));
