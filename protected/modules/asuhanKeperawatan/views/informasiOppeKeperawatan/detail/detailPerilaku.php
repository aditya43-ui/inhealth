...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="glyphicon glyphicon-file"></i> Detail <b>Kepatuhan Perilaku</b>
        </div>
    </div>
    <div class="panel-body">
        ...
        <div class="col-sm-6">
            ...
            <div class="control-group ">
                <?php echo CHtml::label('Bulan Pencatatan', '', array('class' => 'control-label')); ?>
                <div class="controls">
                    <div class="input-append">
                        <?php echo $form->textField($model, 'bulan_pencatatan', array('disabled' => true, 'class' => 'span3', 'onkeypress' => "return $(this).focusNextInputField(event);", 'maxlength' => 20)); ?>
                    </div>
                </div>
            </div>
            <div class="control-group ">
        ...
        <div class="col-sm-6">
            ...
            <div class="control-group">
                <?php echo CHtml::label('Nilai Sejawat', '', array('class' => 'control-label')); ?>
                <div class="controls">
                    <?php echo $form->textField($model, 'nilai_sejawat', array('readonly' => true, 'class' => 'span3 float2')); ?><label> %</label>
                </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
                <?php echo CHtml::label('Nilai Dokter', '', array('class' => 'control-label')); ?>
                <div class="controls">
                    <?php echo $form->textField($model, 'nilai_dokter', array('readonly' => true, 'class' => 'span3 float2')); ?><label> %</label>
                </div>
            </div>
        </div>
    </div>
