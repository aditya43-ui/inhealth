...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="glyphicon glyphicon-file"></i> Detail <b>Caring</b>
        </div>
    </div>
    <div class="panel-body">
        ...
        <div class="col-sm-6">
            ...
            <div class="control-group ">
                <?php echo CHtml::label('Bulan Caring', '', array('class' => 'control-label')); ?>
                <div class="controls">
                    <div class="input-append">
                        <?php echo $form->textField($model, 'bulan_caring', array('disabled' => true, 'class' => 'span3', 'onkeypress' => "return $(this).focusNextInputField(event);", 'maxlength' => 20)); ?>
                    </div>
                </div>
            </div>
            <div class="control-group ">
        ...
        <div class="col-sm-6">
            <div class="control-group">
                <?php echo CHtml::label('Tgl. Kuisioner', '', array('class' => 'control-label')); ?>
                <div class="controls">
                    <?php echo $form->textField($model, 'tgl_kuisioner', array('readonly' => true, 'class' => 'span3')); ?>
                </div>
            </div>
            <div class="control-group">
                <?php echo CHtml::label('Nilai Pasien', '', array('class' => 'control-label')); ?>
                <div class="controls">
                    <?php echo $form->textField($model, 'nilai_pasien', array('readonly' => true, 'class' => 'span3 float2')); ?><label> %</label>
                </div>
            </div>
            <div class="control-group">
                <?php echo CHtml::label('Nilai Keluarga', '', array('class' => 'control-label')); ?>
                <div class="controls">
                    <?php echo $form->textField($model, 'nilai_keluarga', array('readonly' => true, 'class' => 'span3 float2')); ?><label> %</label>
                </div>
            </div>
            <div class="control-group">
                <?php echo CHtml::label('Nilai Rata-Rata', '', array('class' => 'control-label')); ?>
                <div class="controls">
                    <?php echo $form->textField($model, 'nilai_rata', array('readonly' => true, 'class' => 'span3 float2')); ?><label> %</label>
                </div>
            </div>
        </div>
    </div>
