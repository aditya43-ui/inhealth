...
<div class="panel panel-gradient">
    ...
    <div class="panel-body">
        ...
        <div class="col-sm-6">
            ...
            <div class="control-group ">
                <?php echo CHtml::label('Bulan Kehadiran', '', array('class' => 'control-label')); ?>
                <div class="controls">
                    <div class="input-append">
                        <?php echo $form->textField($model, 'bulan_kehadiran', array('disabled' => true, 'class' => 'span3', 'onkeypress' => "return $(this).focusNextInputField(event);", 'maxlength' => 20)); ?>
                    </div>
                </div>
            </div>
            <div class="control-group ">
            ...
            <div class="control-group">
                <?php echo CHtml::label('Prosentase Kehadiran', '', array('class' => 'control-label')); ?>
                <div class="controls">
                    <?php echo $form->textField($model, 'prosentase_kehadiran', array('readonly' => true, 'class' => 'span3 float2')); ?><label> %</label>
                </div>
            </div>
        </div>
    </div>
