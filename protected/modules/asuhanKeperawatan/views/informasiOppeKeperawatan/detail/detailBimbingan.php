...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="glyphicon glyphicon-file"></i> Detail <b>Jumlah Bimbingan</b>
        </div>
    </div>
    <div class="panel-body">
        ...
        <div class="col-sm-6">
            ...
            <div class="control-group ">
                <?php echo CHtml::label('Bulan Bimbingan', '', array('class' => 'control-label')); ?>
                <div class="controls">
                    <div class="input-append">
                        <?php echo $form->textField($model, 'bulan_bimbingan', array('readonly' => true, 'class' => 'span3', 'onkeypress' => "return $(this).focusNextInputField(event);", 'maxlength' => 20)); ?>
                    </div>
                </div>
            </div>
            <div class="control-group ">
        ...
        <div class="col-sm-6">
            <div class="control-group">
                <?php echo CHtml::label('Institusi', '', array('class' => 'control-label')); ?>
                <div class="controls">
                    <?php echo $form->textField($model, 'institusi', array('readonly' => true, 'class' => 'span3')); ?>
                </div>
            </div>
            <div class="control-group">
                <?php echo CHtml::label('Jumlah Bimbingan', '', array('class' => 'control-label')); ?>
                <div class="controls">
                    <?php echo $form->textField($model, 'jml_bimbingan', array('readonly' => true, 'class' => 'span3 numbers-only')); ?><label> %</label>
                </div>
            </div>
            <div class="control-group">
                <?php echo CHtml::label('Target', '', array('class' => 'control-label')); ?>
                <div class="controls">
                    <?php echo $form->textField($model, 'target', array('readonly' => true, 'class' => 'span3 numbers-only')); ?><label> %</label>
                </div>
            </div>
            <div class="control-group">
