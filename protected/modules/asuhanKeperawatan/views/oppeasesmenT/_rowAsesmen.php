<tr>
    <td style="text-align: center;">
        ...
        <?php echo CHtml::activeTextField($model, '[ii]bulan_asesmen', array('class' => 'span2 bulan_pencatatan required', 'readonly' => true)); ?>
        <?php echo CHtml::activeHiddenField($model, '[ii]oppeasesmen_id', array('class' => 'span2', 'readonly' => true)); ?>	        	
    </td>
    <td>
    ...
    <td>
        <?php echo CHtml::activeTextField($model, '[ii]prosentase_asesmen', array('class' => 'span2 float2', 'readonly' => true)); ?>	
    </td>
    <td style="text-align: center;" class="rowbutton">
        <?php echo CHtml::link('<i class="fa fa-minus"></i>', 'javascript:void(0)', array('class' => 'btn btn-danger', 'onclick' => 'hapusTemporaryAsesmen(this)')); ?>
    </td>
</tr>