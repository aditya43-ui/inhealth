...
<div class="col-sm-6">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <?php
            echo CHtml::textField('ASInforencanaaskepV[umur]', $modPasien->umur, array('readonly' => true));
            ?>
        </div>
    </div>
    <div class="control-group">
        ...
        <div class="controls">
            <?php
            echo CHtml::textField('ASInforencanaaskepV[diagnosa_nama]', $modPasien->diagnosa_nama, array('readonly' => true));
            ?>
        </div>
    </div>
    <div class="control-group">
        ...
        <div class="controls">
            <?php
            echo CHtml::textField('ASInforencanaaskepV[kelaspelayanan_nama]', $modPasien->kelaspelayanan_nama, array('readonly' => true));
            ?>
        </div>
    </div>
</div>