...
<div class="white-container">
    ...
    <table width="100%" class="spasi1">
		...
		<tr>
			...
			<td width="40%">: <?php echo (isset($modPasien->kamarruangan_nokamar) ? $modPasien->kamarruangan_nokamar : $model->getNoKamar($modPasien->pendaftaran_id)) . ' / ' . (isset($modPasien->kelaspelayanan_nama) ? $modPasien->kelaspelayanan_nama : $model->getKelasPelayanan($modPasien->pendaftaran_id)) ; ?></td>
		</tr>
		<tr>
