...
<table style="width: 100%; border: none;">
	<tr>
		...
		<td width="30%">
			: <?php echo $modAnamnesa->pasien->nama_pasien; ?>
		</td>
		<td width="20%">
	...
	<tr>
		...
		<td width="30%">
			: <?php echo $modAnamnesa->pasien->jeniskelamin; ?>
		</td>
		<td width="20%">
			<b>Dokter Pemeriksa</b>
		</td>
		<td width="30%">
			: <?php echo (!empty($modAnamnesa->pegawai->gelardepan) ? $modAnamnesa->pegawai->gelardepan : "") . " " . (!empty($modAnamnesa->pegawai->nama_pegawai) ? $modAnamnesa->pegawai->nama_pegawai : "") . " " . (!empty($modAnamnesa->pegawai->gelarbelakang->gelarbelakang_nama) ? $modAnamnesa->pegawai->gelarbelakang->gelarbelakang_nama : ""); ?>
		</td>
	</tr>
	<tr>
		<td width="20%">
		...
		<td width="30%">
			: <?php echo $modAnamnesa->pendaftaran->umur; ?>
		</td>
		<td width="20%">
			<b>Nama Paramedis</b>
		</td>
	...
	<tr>
		...
		<td width="30%">
			: <?php echo MyFormatter::formatDateTimeForUser($modAnamnesa->pendaftaran->tgl_pendaftaran); ?>
		</td>
		<td width="20%">
			<b>Kelas Pelayanan</b>
		</td>
		<td width="30%">
			: <?php echo $modAnamnesa->pendaftaran->kelaspelayanan->kelaspelayanan_nama;?>
		</td>
	</tr>
	<tr>
		<td width="20%">
		...
		<td width="30%">
			: <?php echo $modAnamnesa->pendaftaran->no_pendaftaran; ?>
		</td>
		<td width="20%">
		</td>
		<td width="30%">
