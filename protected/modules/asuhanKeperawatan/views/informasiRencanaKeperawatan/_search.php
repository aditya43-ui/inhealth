...
$form = $this->beginWidget('ext.bootstrap.widgets.BootActiveForm', array(
    ...
    'method' => 'get',
    'id' => 'rencanakeperawatan-info-search',
    'type' => 'horizontal',
...
<div class="row">
    ...
    <div class="col-sm-6">
        ...
        <div class="control-group ">
            ...
            <div class="controls">
                <?php echo $form->textField($model, 'no_rencana', array('placeholder' => 'No. Rencana', 'class' => 'span4', 'maxlength' => 20, 'onkeypress' => "return $(this).focusNextInputField(event)")); ?>
            </div>
        </div>
    </div>
</div>
