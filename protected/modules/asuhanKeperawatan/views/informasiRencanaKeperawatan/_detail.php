    ...
    <div class="row">
        <table style="width: 100%; border: none;">
            <tr>
                ...
                <td>
                    <p> : <?php echo isset($model->no_rencana) ? $model->no_rencana : "-"; ?></p>
                </td>
                <td>
                    <p>Tanggal Rencana</p>
                </td>
                <td>
                    <p> : <?php echo isset($model->rencanaaskep_tgl) ? MyFormatter::FormatDateTimeForUser($model->rencanaaskep_tgl) : "-"; ?></p>
                </td>
                <td>
                    <p>Nama Perawat</p>
                </td>
        ...
        <fieldset class="box">
            ...
            <table style="width: 100%; border: none;">
                <tr>
                    ...
                    <td>
                        <p> : <?php echo isset($modPasien->no_pengkajian) ? $modPasien->no_pengkajian : "-"; ?></p>
                    </td>
                    <td>
                        <p>Tanggal Pengkajian</p>
                    </td>
                    <td>
                        <p> : <?php echo isset($modPasien->pengkajianaskep_tgl) ? MyFormatter::FormatDateTimeForUser($modPasien->pengkajianaskep_tgl) : "-"; ?></p>
                    </td>
                    <td>
                        <p>Nama Perawat</p>
                    </td>
                    <td>
                        <p> : <?php echo isset($modPasien->nama_pegawai) ? $modPasien->nama_pegawai : "-"; ?></p>
                    </td>
                </tr>
            </table>
        </fieldset>
        ...
        <fieldset class="box">
            ...
            <table style="width: 100%; border: none;">
                ...
                <tr>
                    ...
                    <td>
                        <p> : <?php echo (isset($model->diagnosa_nama) ? $model->diagnosa_nama : $model->getDiagnosaMedis($modPasien->pasien_id, $modPasien->pendaftaran_id)); ?></p>
                    </td>
                    <td>
                        <p>No Kamar / No. Bed</p>
                    </td>
                    ...
                    ?>
                            <tr>
                                ...
                                <td><?php
									...
									left JOIN tandagejala_m AS tandagejala ON tandagejala.tandagejala_id = pilihrencanaaskep_t.tandagejala_id
                                ...
                                <td><?php
									...
									FROM pilihrencanaaskep_t
									left JOIN kriteriahasildet_m AS kriteriahasildet ON kriteriahasildet.kriteriahasildet_id = pilihrencanaaskep_t.kriteriahasildet_id
                                ...
                                <td><?php echo $modDetail->intervensi_nama; ?>
									...
									FROM pilihrencanaaskep_t
									left JOIN intervensidet_m AS intervensidet ON intervensidet.intervensidet_id = pilihrencanaaskep_t.intervensidet_id
                                ...
                                <!--								<td><?php //echo ($modDetail->iskolaborasi == 1) ? "Ya":"Tidak"; 
                                    ...
                                    //									echo "<br>";
                                    //									echo 'Ket: ';
                                    //									echo isset($modDetail->rencanaaskepdet_ketkolaborasi) ? $modDetail->rencanaaskepdet_ketkolaborasi : "-";
                                    //                                                                         echo "<br><br>";
