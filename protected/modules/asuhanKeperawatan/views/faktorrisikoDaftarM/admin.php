...
$('.search-form form').submit(function(){
    $.fn.yiiGridView.update('faktorrisikodaftar-m-grid', {
        data: $(this).serialize()
    });
    return false;
});
...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="glyphicon glyphicon-file"></i> Pengaturan <b>Daftar Faktor Risiko</b>
        </div>
    </div>
    <div class="panel-body">
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="entypo-credit-card"></i> Tabel <b>Daftar Faktor Risiko</b>
                </div>
            </div>
                        ...
                        array(
                            ...
                            'buttons' => array(
                                'remove' => array(
                                    ...
                                    'url' => 'Yii::app()->createUrl("' . Yii::app()->controller->module->id . '/' . Yii::app()->controller->id . '/nonActive",array("id"=>$data->faktorrisiko_daftar_id))',
                                    'click' => 'function(){nonActive(this);return false;}',
                                    'visible' => '(($data->faktorrisiko_daftar_aktif) ? TRUE : FALSE)',
                                ),
                                'add' => array(
                                    'label' => "<i class='glyphicon glyphicon-ok'></i> ",
                                    'options' => array('title' => Yii::t('mds', 'Add Temporary')),
                                    'url' => 'Yii::app()->createUrl("' . Yii::app()->controller->module->id . '/' . Yii::app()->controller->id . '/active",array("id"=>$data->faktorrisiko_daftar_id))',
                                    'click' => 'function(){active(this);return false;}',
                                    'visible' => '(($data->faktorrisiko_daftar_aktif) ? FALSE : TRUE)',
                                ),
                                'delete' => array(
        ...
        <div class="form-actions">
            <?php
            echo CHtml::link(
                Yii::t('mds', '{icon} Tambah Daftar Faktor Risiko', array('{icon}' => '<i class="icon-plus icon-white"></i>')),
                $this->createUrl('create', array('modul_id' => Yii::app()->session['modul_id'])),
                array('title' => 'Tambah Daftar Faktor Risiko', 'class' => 'btn btn-danger')
            );
...
{
    window.open("${urlPrint}/"+$('#faktorrisikodaftar-m-search').serialize()+"&caraPrint="+caraPrint,"",'location=_new, width=900px');
}
JSCRIPT;
...
<script type="text/javascript">
    ...
    function cekForm(obj) {
        $("#faktorrisikodaftar-m-search :input[name='" + obj.name + "']").val(obj.value);
    }
