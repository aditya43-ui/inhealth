...
<div class="row">
    <div class="col-sm-12">
        <div class="control-group">
            <?php echo CHtml::label('Tanggal', 'pengkajianaskep_tgl', array('class' => 'control-label')) ?>
            <div class="controls">
    ...
    <div class="col-sm-6">
        <div class="control-group">
            <?php echo CHtml::label('Instalasi', 'ruangan_id', array('class' => 'control-label')) ?>
            <div class="controls">
                <?php
        ...
        <div class="control-group">
            ...
            <div class="controls">
                ...
                echo $form->dropDownList(
                    $model,
                    'ruangan_id',
                    CHtml::listData($model->getRuanganItems($model->instalasi_id), 'ruangan_id', 'ruangan_nama'),
                    array(
                        'class' => 'span4',
                        'empty' => '-- Pilih --',
                        'onkeypress' => "return $(this).focusNextInputField(event)"
    ...
    <div class="col-sm-6">
        ...
        <div class="control-group ">
            <?php echo CHtml::activeLabel($model, 'no_diagnosisaskep', array('class' => 'control-label', 'label' => 'No. Diagnosis')); ?>
            <div class="controls">
                <?php echo $form->textField($model, 'no_diagnosisaskep', array('placeholder' => 'No. Diagnosis', 'class' => 'span4', 'maxlength' => 20, 'onkeypress' => "return $(this).focusNextInputField(event)")); ?>
            </div>
        </div>
    </div>
</div>
