...
<table style="width: 100%; border: none;">
    <tr>
        <td>
            ...
            ?>
            <label class="control-label no_rek">No. Pendaftaran <span class="required">*</span></label>
        </td>
        <td>
            ...
            if (!empty($modPendaftaran->no_pendaftaran)) {
                echo CHtml::textField('ASPendaftaranT[no_pendaftaran]', $modPendaftaran->no_pendaftaran, array('readonly' => true, 'class' => 'readonly span3 required'));
            } else {
                echo CHtml::hiddenField('ASPendaftaranT[pendaftaran_id]', $modPendaftaran->pendaftaran_id, array('readonly' => true, 'class' => 'readonly span3 required'));
                echo CHtml::hiddenField('ASPendaftaranT[pasien_id]', $modPendaftaran->pasien_id, array('readonly' => true, 'class' => 'readonly span3'));
        ...
        <td><?php echo CHtml::textField('ASPasienM[jeniskelamin]', $modPasien->jeniskelamin, array('class' => 'span3', 'readonly' => true, 'class' => 'readonly span3')); ?></td>

        <!--<td><?php // echo CHtml::activeLabel($modPasien, 'agama', array('class' => 'control-label'));   
                ?></td>-->
        <!--<td><?php // echo CHtml::textField('ASPasienM[agama]', $modPasien->jeniskelamin, array('readonly' => true, 'class' => 'readonly span3'));   
                ?></td>-->
    </tr>
    <tr>
        <td><?php echo CHtml::activeLabel($modPendaftaran, 'tgl_pendaftaran', array('class' => 'control-label')); ?></td>
        <td><?php echo CHtml::textField('ASPendaftaranT[tgl_pendaftaran]', $modPendaftaran->tgl_pendaftaran, array('readonly' => true, 'class' => 'readonly span3', 'class' => 'readonly span3')); ?></td>

        <!--<td><?php // echo CHtml::label('Pekerjaan', 'pekerjaan_nama', array('class' => 'control-label'));   
                ?></td>-->
        <!--<td><?php // echo CHtml::textField('ASPasienM[pekerjaan_nama]', $modPasien->pekerjaan_nama, array('readonly' => true, 'class' => 'readonly span3'));   
                ?></td>-->

        <td><?php echo CHtml::activeLabel($modPendaftaran, 'ruangan_id', array('class' => 'control-label')); ?></td>
        <td><?php echo CHtml::textField('ASPendaftaranT[ruangan_nama]', isset($modPendaftaran->ruangan->ruangan_nama) ? $modPendaftaran->ruangan->ruangan_nama : '-', array('readonly' => true, 'class' => 'readonly span3')); ?></td>
    </tr>
    <tr>
        ...
        <td><?php
            ...
            $this->widget('MyJuiAutoComplete', array(
                ...
                'htmlOptions' => array('placeholder' => 'No. Rekam Medik', 'class' => 'span3',),
            ));
            ?></td>

        <td><?php echo CHtml::activeLabel($modPasien, 'agama', array('class' => 'control-label')); ?></td>
        <td><?php echo CHtml::textField('ASPasienM[agama]', $modPasien->jeniskelamin, array('readonly' => true, 'class' => 'readonly span3')); ?></td>
        <!--<td><?php // echo CHtml::label('Pendidikan', 'pendidikan_nama', array('class' => 'control-label'));   
                ?></td>-->
        <!--<td><?php // echo CHtml::textField('ASPasienM[pendidikan_nama]', isset($modPasien->pendidikan->pendidikan_nama) ? $modPasien->pendidikan->pendidikan_nama : '-', array('readonly' => true, 'class' => 'readonly span3'));   
                ?></td>-->

        <!--<td><?php // echo CHtml::label('Kelas Pelayanan', 'kelaspelayanan_nama', array('class' => 'control-label'));   
                ?></td>-->
        <!--<td><?php // echo CHtml::textField('ASPendaftaranT[kelaspelayanan_nama]', isset($modPendaftaran->kelaspelayanan->kelaspelayanan_nama) ? $modPendaftaran->kelaspelayanan->kelaspelayanan_nama : '-', array('readonly' => true, 'class' => 'readonly span3'));   
                ?></td>-->
    ...
    <tr>
        ...
        <td><?php
            ...
            $this->widget('MyJuiAutoComplete', array(
                ...
                'htmlOptions' => array('placeholder' => 'Nama Pasien', 'class' => 'span3',),
            ));
            ?></td>

        <td><?php echo CHtml::activeLabel($modPasien, 'alamat_pasien', array('class' => 'control-label')); ?></td>
        <td><?php echo CHtml::textArea('ASPasienM[alamat_pasien]', isset($modPasien->alamat_pasien) ? $modPasien->alamat_pasien : '-', array('readonly' => true, 'class' => 'readonly span3')); ?></td>

        <!--<td><?php // echo CHtml::label('No Kamar / No. Bed', 'no_kamarbed', array('class' => 'control-label'));   
                ?></td>-->
        <!--<td><?php // echo CHtml::textField('ASPendaftaranT[no_kamarbed]', isset($modPendaftaran->kamarruangan_nokamar) ? $modPendaftaran->kamarruangan_nokamar : '' . '/' . isset($modPendaftaran->kamarruangan_nobed) ? $modPendaftaran->kamarruangan_nobed : '', array('readonly' => true, 'class' => 'readonly span3'));   
                ?></td>-->

    </tr>
    <tr>
        <td><?php echo CHtml::activeLabel($modPasien, 'umur', array('class' => 'control-label')); ?></td>
        <td><?php echo CHtml::textField('ASPendaftaranT[umur]', isset($modPasien->umur) ? $modPasien->umur : '-', array('readonly' => true, 'class' => 'readonly span3')); ?></td>

        <td><?php echo CHtml::activeLabel($modPasien, 'statusperkawinan', array('class' => 'control-label')); ?></td>
        <td><?php echo CHtml::textField('ASPendaftaranT[statusperkawinan]', isset($modPendaftaran->statusperkawinan) ? $modPendaftaran->statusperkawinan : '-', array('readonly' => true, 'class' => 'readonly span3')); ?></td>
    </tr>
    <tr>
        <td></td>
        <td></td>

        <!--<td><?php // echo CHtml::activeLabel($modPasien, 'statusperkawinan', array('class' => 'control-label'));   
                ?></td>-->
        <!--<td><?php // echo CHtml::textField('ASPendaftaranT[statusperkawinan]', isset($modPendaftaran->statusperkawinan) ? $modPendaftaran->statusperkawinan : '-', array('readonly' => true, 'class' => 'readonly span3'));   
                ?></td>-->
    </tr>
</table>
<!--</fieldset>-->
...
$this->widget('ext.bootstrap.widgets.BootGridView', array(
    ...
    'columns' => array(
        ...
        array(
            ...
            'filter' =>
            CHtml::activeTextField($modDialogKunjungan, 'tgl_pendaftaran', array('class' => 'span3', 'readonly' => true, 'class' => 'readonly span3')),
            /*$this->widget('MyDateTimePicker', array(
				...
				'htmlOptions' => array('readonly' => true, 'class' => 'readonly span3', 'class' => "span2",
