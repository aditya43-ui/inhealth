...
{
	public $tgl_awal,$tgl_akhir,$instalasi_id, $evaluasiaskep_id;
	/**
	...
	public function attributeLabels()
	{
		return array(
			...
			'iskeperawatan' => 'Iskeperawatan',
                        'rencanaaskep_tgl'=>'Tgl. Rencana Keperawatan'
		);
	}
	...
	public function search()
	{
		...
		$criteria=new CDbCriteria;
                // $criteria->select = "t.implementasiaskep_id, t.no_implementasi, t.implementasiaskep_tgl, t.no_pendaftaran, t.nama_pasien, t.jeniskelamin, t.nama_pegawai, t.ruangan_nama, t.kelaspelayanan_nama, evaluasiaskep_t.evaluasiaskep_id";
                // $criteria->join = " LEFT JOIN evaluasiaskep_t ON evaluasiaskep_t.implementasiaskep_id = t.implementasiaskep_id";
				$criteria->group = "t.implementasiaskep_id, t.no_implementasi, t.implementasiaskep_tgl, t.no_pendaftaran, t.nama_pasien, t.jeniskelamin, t.nama_pegawai, t.ruangan_nama, t.kelaspelayanan_nama";
		...
		return new CActiveDataProvider($this, array(
			'criteria'=>$criteria,
                        'sort'=>[
                            'defaultOrder'=>'implementasiaskep_tgl DESC'
                        ]
		));
	}
	...
	public function searchDialog() {
		...
		if (!empty($this->rencanaaskep_tgl)) {
                    $implementasiaskep_tgl = $this->getKonverviDateRange($this->rencanaaskep_tgl);
                    $criteria->addBetweenCondition('DATE(rencanaaskep_tgl)', $implementasiaskep_tgl[0]." 00:00:00", $implementasiaskep_tgl[1]." 23:59:59");
