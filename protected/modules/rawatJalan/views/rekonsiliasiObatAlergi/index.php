  ...
  <div class="panel-body">
    <?php
      $form = $this->beginWidget('ext.bootstrap.widgets.BootActiveForm', array(
          'id' => 'rekonsiliasiobatalergi-t-form',
    ...
    <div class="row">
      <div class="col-sm-6">
        ...
        <div class="control-group ">
            <?php echo CHtml::activeLabelEx($model, 'nama_obat', array('class' => 'control-label')); ?>
            <div class="controls">
              <div id="obat_original">
              <?php
                 echo $form->textField($model, 'nama_obat',array('class'=>'span3','maxlength'=>'100'));
              ?>
              </div>
        ...
        <div class="control-group ">
            <?php echo CHtml::activeLabelEx($model, 'reaksialergi', array('class' => 'control-label')); ?>
            <div class="controls">
              <?php echo $form->dropDownList($model,'reaksialergi', LookupM::getItems("reaksialergi"),array('empty'=>'-- Pilih --','onkeypress'=>"return $(this).focusNextInputField(event);", 'maxlength' => 100,'class'=>'span3')); ?>
            </div>
        </div>
        <div class="control-group ">
            <?php echo CHtml::activeLabelEx($model, 'bentukreaksi', array('class' => 'control-label')); ?>
            <div class="controls">
              <?php
                 echo $form->textField($model, 'bentukreaksi',array('class'=>'span3','maxlength'=>'200'));
              ?>
            </div>
        </div>
        <div class="control-group ">
    ...
    <table class="table table-striped table-bordered table-condensed" style="width: 100%" id="tblObat">
      <thead>
        <tr>
            ...
            <th style="width:200px">Reaksi Alergi</th>
            <th style="width:200px">Bentuk Reaksi</th>
