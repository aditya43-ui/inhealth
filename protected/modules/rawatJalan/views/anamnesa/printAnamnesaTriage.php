            ...
            <td>
                <div class="content">
                    ...
                    <table width="100%" border="1">
                        <tr>
                            <td style="width:20%">No. Triage Pasien</td>
                            <td style="width:30%">
                                <?php echo $modAnamnesa->notriage->no_bed_triage; ?></td>
                    ...
                    <table width="100%" class="content" style="border: none;">
                        <tr>
                            <td align="center" valign="middle" colspan="2" style="font-weight:bold">
                                <div class="judulcontent"> ANAMNESIS</div>
                            </td>
                        </tr>
                        <tr>
                            <td style="width:30%">Perawat</td>
                            <td style="width:70%">
                                <?php echo isset($modAnamnesa->paramedis_nama)?$modAnamnesa->paramedis_nama:" - "; ?>
                            </td>
                        </tr>
                        <tr>
                            <td style="width:30%">Keluhan Utama</td>
                            <td style="width:70%">
                                <?php echo isset($modAnamnesa->keluhanutama)?$modAnamnesa->keluhanutama:" - "; ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="width:70%">
                                <?php echo isset($modAnamnesa->riwayatperjalananpasien)?$modAnamnesa->riwayatperjalananpasien:" - "; ?>
                            </td>
                        </tr>
                        <tr>
                            <td style="width:30%">Lama sakit</td>
                            <td style="width:70%">
                                <?php echo isset($modAnamnesa->lamasakit)?$modAnamnesa->lamasakit:" - "; ?></td>
                        </tr>
                        <tr>
                            <td style="width:30%">Riwayat Penyakit Terdahulu</td>
                            <td style="width:70%">
                                <?php echo isset($modAnamnesa->riwayatpenyakitterdahulu)?$modAnamnesa->riwayatpenyakitterdahulu:"riwayatpenyakitterdahulu "; ?>
                            </td>
                        </tr>
                        <tr>
                            <td style="width:30%">Riwayat Penyakit Keluarga</td>
                            <td style="width:70%">
                                <?php echo isset($modAnamnesa->riwayatpenyakitkeluarga)?$modAnamnesa->riwayatpenyakitkeluarga:" - "; ?>
                            </td>
                        </tr>
                        <tr>
                            <td style="width:30%">Riwayat Alergi Obat</td>
                            <td style="width:70%">
                                <?php echo isset($modAnamnesa->riwayatalergiobat)?$modAnamnesa->riwayatalergiobat:" - "; ?>
                            </td>
                        </tr>
                        <tr>
                            <td style="width:30%">Pengobatan yang sudah dilakukan</td>
                            <td style="width:70%">
                                <?php echo isset($modAnamnesa->pengobatanygsudahdilakukan)?$modAnamnesa->pengobatanygsudahdilakukan:" - "; ?>
                            </td>
                        </tr>
                        <tr>
                            <td style="width:30%">Riwayat Alergi Makanan</td>
                            <td style="width:70%">
                                <?php echo isset($modAnamnesa->riwayatmakanan)?$modAnamnesa->riwayatmakanan:" - "; ?>
                            </td>
                        </tr>
                        <tr>
                            <td style="width:30%">Riwayat Kelahiran</td>
                            <td style="width:70%">
                                <?php echo isset($modAnamnesa->riwayatkelahiran)?$modAnamnesa->riwayatkelahiran:" - "; ?>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td style="width:70%">
                                <?php echo !empty($modAnamnesa->ispasienwanitahamil)?$modAnamnesa->ispasienwanitahamil:" - "; ?>
                            </td>
                        </tr>
                        <tr>
                            <td style="width:30%">Apakah Pasien dalam masa menyusui</td>
                            <td style="width:70%">
                                <?php echo !empty($modAnamnesa->ispasienwanitamenyusui)?$modAnamnesa->ispasienwanitamenyusui:" - "; ?>
                            </td>
                        </tr>
                        <?php } ?>
                        ...
                        <tr>
                            ...
                            <td style="width:70%">
                                <?php echo !empty($modAnamnesa->isbayianak_kelainanconginetal)?$modAnamnesa->isbayianak_kelainanconginetal:" - "; ?>
                            </td>
                        </tr>
                        <tr>
                            <td style="width:30%">Jenis Kelainan Kongenital</td>
                            <td style="width:70%">
                                <?php echo !empty($modAnamnesa->kelainanconginetal_jenis)?$modAnamnesa->kelainanconginetal_jenis:" - "; ?>
                            </td>
                        </tr>
                        <?php } ?>
                        <tr>
                            ...
                            <td style="width:70%">
                                <?php echo !empty($modAnamnesa->riwayatimunisasi)?$modAnamnesa->riwayatimunisasi:" - "; ?>
                            </td>
                        </tr>
                        <tr>
                            <td style="width:30%">Riwayat Operasi</td>
                            <td style="width:70%">
                                <?php echo !empty($modAnamnesa->riwayat_operasi)?$modAnamnesa->riwayat_operasi:" - "; ?>
                            </td>
                        </tr>
                        <tr>
                            <td style="width:30%">Status Rokok</td>
                            <td style="width:70%">
                                <?php echo !empty($modAnamnesa->statusmerokok) && $modAnamnesa->statusmerokok == 1?"Ya":" - "; ?>
                            </td>
                        </tr>
                        <tr>
                            <td style="width:30%">Jumlah Rokok (Batang)</td>
                            <td style="width:70%">
                                <?php echo !empty($modAnamnesa->jmlrokok_btg_hr)?$modAnamnesa->jmlrokok_btg_hr." per hari":" - "; ?>
                            </td>
                        </tr>
                        <tr>
                            <td style="width:30%">Konsumsi Alkohol</td>
                            <td style="width:70%">
                                <?php echo !empty($modAnamnesa->keb_konsumsialkohol) ? $modAnamnesa->keb_konsumsialkohol : " - "; ?>
                            </td>
                        </tr>
                        <tr>
                            <td style="width:30%">Jumlah Alkohol yang rutin minum</td>
                            <td style="width:70%">
                                <?php echo !empty($modAnamnesa->jmlalkohol_rutinminum) ? $modAnamnesa->jmlalkohol_rutinminum : " - "; ?>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="width:70%">
                                <?php echo isset($modAnamnesa->keb_olahraga) ? $modAnamnesa->keb_olahraga : " - "; ?>
                            </td>
                        </tr>
                        <tr>
        ...
        ?></td>
                        ...
                        <tr>
                            ...
                            <td style="width:70%;height:86px">
                                <?php echo isset($modAnamnesa->keterangananamesa)?$modAnamnesa->keterangananamesa:" - "; ?>
                            </td>
                        </tr>
                        <tr>
                            <td style="width:30%;height:86px">Nama Triase</td>
                            <td style="width:70%;height:86px">
                                <?php echo isset($modAnamnesa->triase_id)?$modAnamnesa->triase->triase_nama:" - "; ?>
                            </td>
                        </tr>
                        <tr>
                            <td style="width:30%;height:86px">Keterangan Triase</td>
                            <td style="width:70%;height:86px">
                                <?php echo isset($modAnamnesa->triase_id)?$modAnamnesa->triase->keterangan_triase:" - "; ?>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td style="width:70%;height:86px">
                                <?php echo !empty($modAnamnesa->hpht)?  MyFormatter::formatDateTimeForUser($modAnamnesa->hpht):" - "; ?>
                            </td>
                        </tr>
                        <tr>
                            <td style="width:30%;height:86px">Tgl. Tafsiran Persalinan</td>
                            <td style="width:70%;height:86px">
                                <?php echo !empty($modAnamnesa->tgl_persalinan)?  MyFormatter::formatDateTimeForUser($modAnamnesa->tgl_persalinan):" - "; ?>
                            </td>
                        </tr>
                        <?php endif; ?>
                    ...
                    <table width="100%" border="1">
                        ...
                        <tr>
                            <td width="20%"
                                style="background-color: #<?php echo !empty($modAnamnesa->triase_id)?$modAnamnesa->triase->kode_warnatriase:" - "; ?>">
                            </td>
                            <td width="20%">
                                <?php echo !empty($modAnamnesa->triase_id)?$modAnamnesa->triase->triase_nama:" - "; ?>
                            </td>
                            <td width="60%">
                                <?php echo !empty($modAnamnesa->triase_id)?$modAnamnesa->triase->keterangan_triase:" - "; ?>
                            </td>
                        </tr>
                    </table>
                    <br>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td colspan="2" style="text-align: right;">
                                    <?php echo $modAnamnesa->skrining_dewasa_skor ?></td>
                            </tr>
                            <tr>
                                <td></td>
                ...
                'modAnamnesa'=>$modAnamnesa,
                    ...
                    <table width="100%" class="tab_skrining">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>2</td>
                                <td>Apakah anak mengalami penurunan berat badan akhir-akhir ini ? (Seperti penurunan BB
                                    Tidak disengaja, baju menjadi lebih longgar, kenaikan BB tidak signifikan (jika <2
                                        tahun))</td>
                                <td class="pilih_center" width="50">
                            ...
                            <tr>
                                <td>3</td>
                                <td>Apakah anak mengalami penurunan intake makanan (termasuk ASI dan susu formula)
                                    setidaknya selama 1 minggu terakhir ?</td>
                                <td class="pilih_center" width="50">
                            ...
                            <tr>
                                <td>4</td>
                                <td>Apakah status gizi anak akan dipengaruhi oleh penyakit/kondisi kesehatan setidaknya
                                    untuk 1 minggu kedepan ?</td>
                                <td class="pilih_center" width="50">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td>TOTAL SKOR</td>
                                <td colspan="2" style="text-align: right;">
                                    <?php echo $modAnamnesa->skrining_anak_skor; ?></td>
                            </tr>
                            <tr>
                                <td></td>
                    ...
                    <table style="width: 100%; border: none;">
                        ...
                        <tr>
                            ...
                            <td colspan="3" align="center" valign="middle">
                                <?php echo Yii::app()->user->getState('kabupaten_nama').", ".date('d - M - Y'); ?><br>Dokter
                                Pemeriksa</td>
                        </tr>
                        <tr>
                            <td colspan="9">&nbsp;</td>
