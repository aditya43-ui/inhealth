...
<table class="items table table-striped table-condensed" id="tblInputAnamnesa">
    ...
    <?php if(!empty($tabelAnamnesa)){?>
        ...
        ?>
            ...
            <td><?php echo CHtml::link("<i class='icon-form-lihat'></i>", '#', array('onclick'=>'viewDetailAnamnesa2("'.$Anamnesa->anamesa_id.'","'.$_GET["pendaftaran_id"].'");return false;','rel'=>'tooltip','title'=>'Klik untuk melihat detail anamnesa')); ?>
            </td>
...
function viewDetailAnamnesa2(idAnamnesis, pendaftaran_id) {
