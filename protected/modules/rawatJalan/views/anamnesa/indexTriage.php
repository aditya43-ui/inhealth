        ...
        $this->Widget('ext.bootstrap.widgets.BootAccordion', array(
            ...
            'content' => array(
                'content-detailanamnesa' => array(
                    ...
                    'isi' => $this->renderPartial($this->path_view . '_tabelRiwayatAnamnesaTrie', array(
...
function printAnamnesa2() {
    window.open(
        '<?php echo $this->createUrl('printAnamnesa2', array('anamesa_id' => $modAnamnesa->anamesa_id)); ?>',
    ...
    <div class="panel-body">
        ...
        $this->Widget('ext.bootstrap.widgets.BootAccordion', array(
            ...
            'content' => array(
                'content-detailanamnesa' => array(
                    'header' => '<b>Tabel Riwayat Anamnesa</b>',
                    'isi' => $this->renderPartial($this->path_view . '_tabelRiwayatAnamnesaTriage', array(
                        'tabelAnamnesa' => $tabelAnamnesa,
                        'tabelAnamnesaPasien' => $tabelAnamnesaPasien,
                        'format' => new MyFormatter(),
                    ), true),
    ...
    <?php
     if ($modAnamnesa->isNewRecord) {
        ...
        echo CHtml::htmlButton(
                ...
                echo CHtml::link(Yii::t('mds', '{icon} Print Anamnesa', array('{icon}' => '<i class="entypo-print"></i>')), 'javascript:void(0);', array('class' => 'btn btn-info', 'onclick' => "printAnamnesa2();return false", 'enabled' => 'true'));
