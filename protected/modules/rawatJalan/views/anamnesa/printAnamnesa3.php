...
<table style="width: 100%; border: none;">
    ...
    <tr>
        ...
        <td colspan="3"></td>
        <td colspan="3" align="center" valign="middle"><?php echo (isset($modAnamnesa->pegawai->gelardepan ) ? $modAnamnesa->pegawai->gelardepan : "").' '.$modAnamnesa->pegawai->nama_pegawai ? $modAnamnesa->pegawai->nama_pegawai : "".' '.(isset($modAnamnesa->pegawai->gelarbelakang_nama)? $modAnamnesa->pegawai->gelarbelakang_nama:""); ?></td>
    </tr>
