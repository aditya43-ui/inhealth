...
<div class="panel panel-success">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="entypo-credit-card"></i> Tabel <b>Pelayanan Konsultasi Poliklinik</b>
        </div>
    </div>
    <div class="panel-body table-responsive">
        <?php $this->renderPartial($this->path_view . '_listKonsuPoli2', array('modRiwayatKonsul' => $modRiwayatKonsul)); ?>
    </div>
</div>
<!--</div>-->
<?php
        ...
        if (r) {
            $.post('<?php echo $this->createUrl('ajaxBatalKonsul') ?>', {
                ...
                if(data.status == 0) {
                    ...
                    window.parent.myAlert("Berhasil hapus");
                }
...
<div class="panel panel-success">
    ...
    <div class="panel-body table-responsive" id="tabelriwayat">
...
<div class="antirow">
    <div class="row">
        ...
        <div class="col-sm-6">
            ...
            <div class="control-group">
            <?php echo CHtml::label('Poliklinik Tujuan <span class="required">*</span>', 'ruangan_id', array('class' => 'control-label')) ?>
                <div class="controls">
                    <?php echo $form->dropDownList(
                            ...
                            array(
                                'empty' => '-- Pilih --', 'class' => 'form-control span3 required', 'onkeypress' => "return $(this).focusNextInputField(event);",
                                'onchange' => 'setTarif()'
                            )
                        );
                    ?>
        ...
        <div class="col-sm-6">
        <div class="control-group">
        <?php echo CHtml::label('Dokter Konsul <span class="required">*</span>', 'pegawai_id', array('class' => 'control-label')) ?>
                <div class="controls">
                <?php echo $form->dropDownList(
                    $modKonsul,
                    'pegawai_id',
                    CHtml::listData($modKonsul->getDokterItems($modPendaftaran->ruangan_id), 'pegawai_id', 'NamaLengkap'),
                    array('empty' => '-- Pilih --', 'class' => 'span3 dokter-konsul required', 'onkeypress' => "return $(this).focusNextInputField(event);")
                ); ?>
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls" style="width:80%; margin-bottom: 20px;">
                    <?php //echo $form->textArea($modKonsul, 'uraian_konsul', array('style' => 'width: 1550px; height: 200px; ')); 
                        ?>
                    <?php $this->widget('ext.redactorjs.Redactor', array('model' => $modKonsul, 'attribute' => 'uraian_konsul', 'toolbar' => 'mini', 'height' => '200px')) ?>
                    <?php echo $form->error($modKonsul, 'uraian_konsul'); ?>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <div class="panel-title">
                        <i class="glyphicon glyphicon-file"></i> Daftar Tindakan Konsultasi Poliklinik
                    </div>
                </div>
                <div id="inputanHemodialisa" class="hidden">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <div class="form-inline">
                                <?php echo $form->textField($modKonsul, 'lama_hd', array('onkeypress' => "return $(this).focusNextInputField(event)", 'class' => 'span1 integer')); ?>
                                Jam
                            </div>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <div class="form-inline">
                                <?php echo $form->textField($modKonsul, 'penarikan_cairan', array('onkeypress' => "return $(this).focusNextInputField(event)", 'class' => 'span1 integer')); ?>
                                ml
                            </div>
                        </div>
                    </div>
