<div class="panel panel-success">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="entypo-credit-card"></i> Tabel <b>Rencana Operasi <?php echo isset($modJenisTarif) ? " - ".$modJenisTarif->jenistarif->jenistarif_nama : ""; ?></b>
        </div>
    </div>
    <div class="panel-body table-responsive">
        <div class="block-tabel">
            <table id="tblFormRencanaOperasi" class="table table-bordered table-striped table-condensed">
                <thead>
                    <tr>
                        <th>Jenis Operasi</th>
                        <th>Operasi</th>
                        <th hidden>Detail Operasi</th>
                        <th>Jumlah</th>
                    </tr>
                </thead>
                <tbody>
                    <?php if (!$modKirimKeUnitLain->isNewRecord) {
                        ...
                        foreach ($det as $item) {
                            echo $this->renderPartial($this->path_view . '_formLoadPermintaanOperasiUpdate', array('item' => $item, 'id_tindakan' => $item->daftartindakan_id, 'paket' => null), true);
                        }
                    } ?>
                </tbody>
            </table>
...
function inputOperasi(obj)
{
    if($(obj).is(':checked')) {
        ...
        jQuery.ajax({'url':'<?php echo Yii::app()->createUrl('rawatJalan/bedahSentralNew/loadFormPermintaanOperasi')?>',
