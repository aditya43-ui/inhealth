        ...
        array(
            ...
            'value' => function($data) {
                $btnCheck = CHtml::link('<i class="icon-form-check"></i>', '', [
                    ...
                    $("#form-nonracikan #hargastuan_reseptur").val("' . $data['HJual'] . '");
                    setObatDariApi("'. $data['Kode'].'", "'. $data['jenis']. '", "' . $data['StFornas']. '", "' . $data['satuan']. '", "' . str_replace('"', '', $data['Nama']) . '", "' . $data['HJual'] . '", "' . $data['HPP'] . '");
                    '
                ]);
