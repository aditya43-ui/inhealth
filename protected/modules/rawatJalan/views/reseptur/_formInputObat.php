...
<div class="row-fluid" id='formjenisresep'>
    <div class="col-sm-12">
        <div id="form-nonracikan">
               ...
               <!-- data obat berasal dari get API -->
                ...
                <div class="controls">
                    ...
                    $this->widget('MyJuiAutoComplete', array(
                        ...
                        'source' => 'js: function(request, response) {
							$.ajax({
								url: "' . $this->createUrl('AutocompleteObatApi') . '",
								dataType: "json",
								data: {
									term: request.term,
									ruangantujuan_id: $("#RJResepturT_ruangan_id").val(),
            ...
            ?>
            <div class="control-group">
                <label class="control-label"><?= (Yii::app()->user->getState('modul_id') == Params::MODUL_ID_RI) ? '' : 'Waktu Pemberian / ' ?> Instruksi <?= $required ?></label>
                <div class="controls">
