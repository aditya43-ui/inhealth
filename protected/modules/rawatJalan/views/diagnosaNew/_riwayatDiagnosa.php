        ...
        ?>
            <tr>
                ...
                ?>
                        ...
                        <td <?= $hide ?>>
                            <?php 
                                echo "<center>" . CHtml::link("<i class='fa fa-copy'></i>", 'javascript:;', array('rel' => 'tooltip', 'title' => 'Klik untuk melihat salin diagnosa', 'onclick' => 'cekDiagnosa(' . $data['pendaftaran_id']. ', ' . $val['pegawai_id']. ', ' . $val['ruangan_id']. ', 1)'));
                            ?>
                        </td>
                    </tr>
...
?>
<script>
    function cekDiagnosa(pendaftaran_id, pegawai_id, ruangan_id, salin) {
