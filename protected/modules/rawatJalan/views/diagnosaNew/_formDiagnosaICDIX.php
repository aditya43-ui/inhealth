...
<tr>
    ...
    <td>
        <?php
            ...
            echo $form->dropDownList($modUraian,"[$i]kelompokdiagnosa_id", CHtml::listData(PPKelompokDiagnosaM::model()->findAll("kelompokdiagnosa_aktif = TRUE " . $condition), "kelompokdiagnosa_id", "kelompokdiagnosa_nama"),
    ...
    <td>
      <?php
            ...
            echo $form->textArea($modUraian, "[$i]keterangan", array('class' => 'span4 custom-only required', 'maxlength' => 200, 'rows' => 3));
        ?>
    </td>
    <td>
      <?php
