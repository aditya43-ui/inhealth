...
<table width="100%" style="margin-left:auto; margin-right:auto;">
    ...
    <tr>
        ...
        <td>Dokter</td><td>:</td><td><?php echo CHtml::encode($modPendaftaran->pegawai_nama); ?></td>
    </tr>
    <tr>
        <td>Ruangan</td>
        <td>:</td>
        <td><?php echo CHtml::encode($modPendaftaran->ruangan_nama); ?></td>
        <td colspan="3"></td>
    </tr>
</table>
<br/>
<table id="tblDaftarDiagnosa" class="table table-bordered table-condensed" border="2">
    <thead>
        <tr>
            <th>No.</th>
            <th width="20%">Kelompok Diagnosis</th>
            <th width="25%">Kode ICD-X</th>
            <th width="25%">Nama ICD-X</th>
            <th width="25%">Nama lain ICD-X</th>
    ...
    if (count((array)$modDiagnosa) > 0) {
        ...
        <tr>
            ...
            <td><?php echo $detail->ket_diagnosa ?></td>
        </tr>
        <?php 
        $i++;
        } 
...
<table id="tblDaftarDiagnosaIX" class="table table-bordered table-condensed" border="2">
    <thead>
        <tr>
            <th>No.</th>
            <th width="20%">Kelompok Diagnosis</th>
            <th width="25%">Kode ICD 9</th>
            <th width="25%">Nama ICD 9</th>
            <th width="25%">Nama lain ICD 9</th>
