<?php 
$kondisi = 'instalasi_id =' . Yii::app()->user->getState('instalasi_id');
if(empty($model->instalasitujuan_id)) {
  $model->instalasitujuan_id = Yii::app()->user->getState('instalasi_id');
}
if(Yii::app()->user->getState('instalasi_id') == Params::INSTALASI_ID_IGD){
  $kondisi= 'instalasi_id =' . Params::INSTALASI_ID_IGD;
  if(empty($model->instalasitujuan_id)){
    $model->instalasitujuan_id = Params::INSTALASI_ID_IGD;
  }
}
...
<div class="form-allpemindahanpasien">
          ...
          <div class="row">
            <div class="col-sm-6">
              ...
              <div class="control-group ">
                  ...
                  <div class="controls">
                    <?php 
                                        // $defaultValue = 'Antar Ruangan';
                    echo $form->dropDownList($model, 'jenispemindahan', LookupM::getItemsUrutan('jenispemindahan'), array('onkeypress' => "return $(this).focusNextInputField(event);", 'class'=>'span3')); 
                    ?>
                  </div>
              </div>
              <div class="control-group ">
                  ...
                  <div class="controls">
                    <?php
                    echo $form->dropDownList($model, 'instalasitujuan_id', CHtml::listData(RuangantransferpasienV::model()->findAll($kondisi), 'instalasi_id', 'instalasi_nama'), array('class' => 'span3', 'onkeypress' => "return $(this).focusNextInputField(event);",
              ...
              <div class="control-group ">
                <label for="" class="control-label">Ruang Tujuan <span class="required">*</span></label>
                  <div class="controls">
                    <?php echo $form->dropDownList($model, 'ruangantujuan_id', CHtml::listData(RuangantransferpasienV::model()->findAllByAttributes(array('instalasi_id'=>$model->instalasitujuan_id)), 'ruangan_id', 'ruangan_nama'), array('empty' => '-- Pilih --', 'class' => 'span3 required','onkeypress' => "return $(this).focusNextInputField(event);")); ?>
                  </div>
              </div>
              <div class="control-group ">
              ...
              <div class="control-group ">
                  ...
                  <div class="controls">
                    <?php echo $form->dropDownList($model, 'dokterperegawat_id', CHtml::listData(DokterV::model()->findAll('ruangan_id = '.Yii::app()->user->getState("ruangan_id")),'pegawai_id','namaLengkap'), array('empty'=>'-- Pilih --','onkeypress' => "return $(this).focusNextInputField(event);",'class'=>'span3 checkBoxSearch')); ?>
                  </div>
              </div>
            </div>
            <div class="col-sm-6">
  ...
  <div class="panel panel-success panel-shadow">
      <div class="panel-heading">
          <div class="panel-title">
            <?php echo CHtml::checkBox('collapse', false, array('class' => 'collapse', 'onclick' => 'collapsed(this, "background")')); ?>
            Background
          </div>
      </div>
      <div class="panel-body" id="background">
        <div class="row">
          <div class="col-sm-6">
            <div class="control-group ">
  ...
  <div class="panel panel-success panel-shadow">
      <div class="panel-heading">
          <div class="panel-title">
            <?php echo CHtml::checkBox('collapse', false, array('class' => 'collapse', 'onclick' => 'collapsed(this, "assesment")')); ?>
            Assesment
          </div>
      </div>
      <div class="panel-body" id="assesment">
        <div class="row">
          <div class="col-sm-6">
            <div class="control-group ">
  ...
  <div class="panel panel-success panel-shadow">
      <div class="panel-heading">
          <div class="panel-title">
            <?php echo CHtml::checkBox('collapse', false, array('class' => 'collapse', 'onclick' => 'collapsed(this, "kondisipasien")')); ?>
            Kondisi Pasien
          </div>
      </div>
      <div class="panel-body" id="kondisipasien">
        <div class="row">
          <div class="col-sm-6">
            <div class="control-group ">
        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            <div class="control-group ">
                ...
                <div class="controls">
                  <?php echo $form->dropDownList($model, 'pegawai_mengetahui', CHtml::listData(DokterV::model()->findAll('ruangan_id = '.Yii::app()->user->getState("ruangan_id")),'pegawai_id','namaLengkap'), array('empty'=>'-- Pilih --','onkeypress' => "return $(this).focusNextInputField(event);",'class'=>'span3 checkBoxSearch')); ?>
                </div>
            </div>
            <div class="control-group ">
            ...
            <div class="control-group ">
                ...
                <div class="controls">
                  <?php echo $form->dropDownList($model, 'perawatpengirim_id', CHtml::listData(PegawairuanganV::model()->findAll('ruangan_id = '.$model->ruanganasal_id.' and kelompokpegawai_id = '.Params::KELOMPOKPEGAWAI_ID_TENAGA_KEPERAWATAN),'pegawai_id','namaLengkap'), array('empty'=>'-- Pilih --','onkeypress' => "return $(this).focusNextInputField(event);",'class'=>'span3 checkBoxSearch perawatIncharge')); ?>
                </div>
            </div>
          </div>
        </div>
          ...
          <div class="row">
            <div class="col-sm-12">
              ...
              <div class="control-group ">
                  ...
                  <div class="controls">
                    <?php echo $form->dropDownList($model, 'perawatpenerima_id', CHtml::listData(PegawairuanganV::model()->findAll('ruangan_id = '.Yii::app()->user->getState("ruangan_id").' and kelompokpegawai_id in(2,3) '),'pegawai_id','namaLengkap'), array('empty'=>'-- Pilih --','onkeypress' => "return $(this).focusNextInputField(event);",'class'=>'span3 checkBoxSearch perawatpenerimaIncharge')); ?>
                  </div>
              </div>
            </div>
          </div>
