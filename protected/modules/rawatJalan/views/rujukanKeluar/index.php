    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?php echo $form->textArea($modRujukanKeluar, 'diagnosasementara_ruj', array('placeholder' => 'Diagnosa Sementara Rujukan', 'class' => 'span3', 'onkeypress' => "return $(this).focusNextInputField(event);", 'maxlength' => 100)); ?>
                    <?php
                    echo CHtml::htmlButton('<i class="icon-plus-sign icon-white"></i> <i class="icon-white icon-chevron-right"></i>', array(
                        'class' => 'btn btn-primary', 'onclick' => "$('#dialogAddDiagnosaSementara').dialog('open');",
...
<div class="form-actions">
    <?php if (isset($_GET['lihat'])) { ?>
        <?php echo ""; ?>
    <?php } else if (isset($_GET['pasiendirujukkeluar_id'])) { ?>
    ...
    <?php } else { ?>
        <?php echo CHtml::htmlButton(
            Yii::t('mds', '{icon} Save', array('{icon}' => '<i class="entypo-check"></i>')),
            array('title' => 'Simpan', 'class' => 'btn btn-danger', 'type' => 'submit', 'onKeypress' => 'return formSubmit(this,event)', 'id' => 'btn_simpan')
        ); ?>
    <?php } ?>
    <?php
