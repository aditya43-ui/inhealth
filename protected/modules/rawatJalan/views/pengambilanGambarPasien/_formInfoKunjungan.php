<div class="row">	
	<div class="col-sm-6">
        ...
        <?php echo CHtml::label("No. Pendaftaran <span class='required'>*</span>", 'no_pendaftaran', array('class'=>'control-label required')); ?>
            ...
            <?php 
                $this->widget('MyJuiAutoComplete', array(
					...
					'htmlOptions'=>array('maxlength'=>12,'placeholder'=>'No. Pendaftaran','class'=>'span3 all-caps alphanumeric-only','rel'=>'tooltip','title'=>'No. Pendaftaran',
        ...
        <?php echo CHtml::label("No. Rekam Medik", 'no_rekam_medik', array('class'=>'control-label')); ?>
            ...
            <?php 
                $this->widget('MyJuiAutoComplete', array(
					...
					'htmlOptions'=>array('maxlength' => 6,'placeholder'=>'No. Rekam Medik','class'=>'span3 all-caps numbers-only','rel'=>'tooltip','title'=>'No. rekam medik untuk mencari data kunjungan',
						'onkeyup'=>"return $(this).focusNextInputField(event)",
					),
				)); 
            ?>
			...
			<div class="controls">
				...
				<?php 
					$this->widget('MyJuiAutoComplete', array(
						...
						'htmlOptions'=>array('class' => 'span3 hurufs-only','maxlength' => 50,'placeholder'=>'Nama Pasien','rel'=>'tooltip','title'=>'Ketik nama pasien untuk mencari data kunjungan',
							'onkeyup'=>"return $(this).focusNextInputField(event)",
						),
					)); 
				?>
		...
		<div class="control-group">
			<?php echo CHtml::label('Tgl. Lahir / Umur', 'tanggal_lahir', array('class'=>'control-label')); ?>
			<div class="controls">
				...
				<?php echo CHtml::textField('umur',$modKunjungan->umur,array('readonly'=>true,'class'=>'span1', 'onkeyup'=>"return $(this).focusNextInputField(event);")); ?>
			</div>
		</div>
		<div class="control-group">
