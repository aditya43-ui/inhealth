        ...
        */
        ...
        <div class="col-sm-3">
            <div class="boxtindakan">
                    ...
                    if(!empty($bahan)) {
                        $cekperiksaj .=  '<label style="margin-left: 10px; font-weight: bold;">' . CHtml::checkBox('jenis_' . $gen['jenispemeriksaanlab_id'] , false, array("class"=>"cekList ceklis-jenis", "value" => '','onClick' => 'inputBahanJenis(this)' ,"onkeyup"=>"return $(this).focusNextInputField(event);")) . '<span> ' .  $gen['jenispemeriksaanlab_nama'] .  ' </span></label><br><hr>';
                    }

                    foreach($bahan as $bhn){
                        // $modKirim->samplelab_id = $bhn->samplelab_id;
                    
                            $cekperiksa .= '<label class="checkbox inline base_input_ceklis" style="display: none;" hidden="hidden">' .
                                ...
                                CHtml::checkBox("KirimspesimenlabT[".$bhn->pemeriksaanlab_id."][cekList]", false, array("class"=>"cekList cekPemeriksaan", "value" => $bhn->pemeriksaanlab_id,'onClick' => 'inputBahan(this, "' . $bhn->pemeriksaanlab_id . '", "' .  $bhn->samplelab_id . '")' ,"onkeyup"=>"return $(this).focusNextInputField(event);", "style" => "display: none;"));
                            $cekperiksa .= "<span style='display: none;'>" . $bhn->pemeriksaanlab_nama . "</span></label><br/>";
                    ...
                    $this->Widget('ext.bootstrap.widgets.BootAccordion', array(
                        ...
                        'content' => array(
                            'content-detailanamnesa-' . $i => array(
                                ...
                                'isi' => $cekperiksaj . '<div class="hide">' . $cekperiksa . "</div>",
                                'active' => false,
                            ),
                        ),
                    ));
