...
<div class="row-fluid">
    ...
    <span
        hidden><?php echo $form->dropDownListRow($modKirimKeUnitLain,'kelaspelayanan_id', CHtml::listData($modPendaftaran->getKelasPelayananItems(), 'kelaspelayanan_id', 'kelaspelayanan_nama') ,array('onkeyup'=>"return $(this).focusNextInputField(event)", 'class'=>'reqKunjungan')); ?></span>
...
<div class="row-fluid">
    <div class="col-sm-6">
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title"><b>Jenis Permintaan Mikrobiologi</b></div>
            </div>
            <div class="panel-body">
                <div class="row-fluid">
                    <?php echo CHtml::hiddenField('jenispermintaan','',array('readonly'=>TRUE));?>
                    <div class="col-sm-4"><?php echo $form->radioButton($modKirimKeUnitLain, 'is_nonprogram', array('onchange' => 'setInputan("non", this, ' . $modPendaftaran->pendaftaran_id . ');', 'class' => 'jenispermintaan', 'onkeypress' => "return $(this).focusNextInputField(event);", 'checked' => '', 'value' => 'non')) . ' <label for="RJPasienKirimKeUnitLainT_is_nonprogram">Non Program</label>'; ?></div>
                    <div class="col-sm-4"><?php echo $form->radioButton($modKirimKeUnitLain, 'is_programtbc', array('onchange' => 'setInputan("tbc", this, ' . $modPendaftaran->pendaftaran_id . ');', 'class' => 'jenispermintaan', 'onkeypress' => "return $(this).focusNextInputField(event);", 'checked' => '', 'value' => 'tbc')) . ' <label for="RJPasienKirimKeUnitLainT_is_programtbc">Program TBC</label>'; ?></div>
                    <div class="col-sm-4"><?php echo $form->radioButton($modKirimKeUnitLain, 'is_programhiv', array('onchange' => 'setInputan("hiv", this, ' . $modPendaftaran->pendaftaran_id . ');',  'class' => 'jenispermintaan', 'onkeypress' => "return $(this).focusNextInputField(event);", 'checked' => '', 'value' => 'hiv')) . ' <label for="RJPasienKirimKeUnitLainT_is_programhiv">Program HIV</label>'; ?></div>
                </div>
            </div>
        </div>

        <div class="panel panel-success panel-jenis panel-non hide">
            <?php $this->renderPartial($this->path_view.'__non',array('form' => $form, 'modKirimKeUnitLain'=>$modKirimKeUnitLain)) ?>
        </div>
        <div class="panel panel-success panel-jenis panel-tbc hide">
            <?php $this->renderPartial($this->path_view.'__tbc',array('form' => $form, 'modKirimKeUnitLain'=>$modKirimKeUnitLain, 'modPenunjang2' => $modPenunjang2)) ?>
        </div>
        <div class="panel panel-success panel-jenis panel-hiv hide">
            <?php $this->renderPartial($this->path_view.'__hiv',array('form' => $form, 'modKirimKeUnitLain'=>$modKirimKeUnitLain, 'modPenunjang2' => $modPenunjang2)) ?>
        </div>
    ...
    <div class="col-sm-12" style="margin-top: 20px;">
        <div class="tab-pane active" id="tabs-basic">
            <div class="tabbable">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        echo CHtml::dropDownList('subjenis_pemeriksaanlab_id', null, CHtml::listData(
                            SubjenisPemeriksaanlabM::model()->findAll($crsub), 'subjenis_pemeriksaanlab_id', 'subjenis_pl_nama'
                        ), array(
                            'empty'=>'-- Pilih --',
                ...
                <div style="" id="loadSpesimen" class="hide">
    ...
    <?php 
        if(!isset($_GET['idPasienKirimKeUnitLain'])){
                echo CHtml::htmlButton(Yii::t('mds','{icon} Save',array('{icon}'=>'<i class="icon-ok icon-white"></i>')),
                                    array('class'=>'btn btn-primary', 'id'=>'btn_submit','onclick'=>'cekInput()','onkeypress'=>'cekInput()', 'disabled'=>$modPendaftaran->isPasienPulangAtauTindakLanjut($_GET['konsulpoli_id'] ?? null))); 
            }else{
                echo CHtml::htmlButton(Yii::t('mds','{icon} Save',array('{icon}'=>'<i class="icon-ok icon-white"></i>')),
    ...
    <div class="col-sm-6">
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                ...
                <?php
     echo $form->dropDownListRow($modKirimKeUnitLain, 'samplelab_id', CHtml::listData(SamplelabM::model()->findAll("samplelab_aktif = TRUE AND jenispemeriksaanlab_kelompok = 'MIKROBIOLOGI KLINIK' ORDER BY samplelab_nama ASC"), 'samplelab_id', 'samplelab_nama'), array('class' => 'span3 samplelab', 'empty' => '-- Pilih --'));
 ?>
         ...
         ?>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        <?php
         // var_dump($modPenunjang->dpjp_nama);die;
             $this->widget('MyJuiAutoComplete', array(
                 'name' => 'dpjp_nama',
...
<div class="form-actions">
 ...
 if(!isset($_GET['idPasienKirimKeUnitLain'])){
         echo CHtml::htmlButton(Yii::t('mds','{icon} Save',array('{icon}'=>'<i class="icon-ok icon-white"></i>')),
                             array('class'=>'btn btn-primary', 'id'=>'btn_submit','onclick'=>'cekInput()','onkeypress'=>'cekInput()')); 
     }else{
         echo CHtml::htmlButton(Yii::t('mds','{icon} Save',array('{icon}'=>'<i class="icon-ok icon-white"></i>')),
                             array('class'=>'btn btn-primary submit', 'id'=>'btn_submit','disabled'=>true)); 
     }
...
?>
<?php $this->renderPartial($this->path_view.'_dialog',array('modKirimKeUnitLain' => $modKirimKeUnitLain)) ?>
...
$(document).ready(function() {
    ...
    $(document).ready(function() {
        ...
        var samplelab = jQuery('#<?php echo CHtml::activeId($modKirimKeUnitLain, 'samplelab_id') ?>');
    ...
    $(document).ready(function() {
        ...
        var caraambilsampel = jQuery(
            '#<?php echo CHtml::activeId($modKirimKeUnitLain, 'caraambilsampel_id') ?>');
...
function setInputan(inp, obj, pendaftaran_id) {
    ...
    $('.jenispermintaan[value="' + jns_low + '"]').prop("checked", true);
        ...
        $('#RJPasienKirimKeUnitLainT_samplelab_id').closest('.multiselect-native-select').find('input[type="radio"][value=""]').click();
    ...
    // $("#strings option[value='']").prop("selected", true);
// });
    // $('#loadSpesimen').removeClass('hide');
