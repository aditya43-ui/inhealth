    ...
    <div class="row">
      <div class="col-sm-6">
        ...
        <div class="control-group ">
            ...
            <div class="controls">
              <?php echo $form->dropDownList($model,'rujukansebelumnya', LookupM::getItems("rekonsiliasirujukanadmisi"),array('empty'=>'-- Pilih --','onkeypress'=>"return $(this).focusNextInputField(event);", 'maxlength' => 100,'class'=>'span3')); ?>
            </div>
        </div>
        <div class="control-group ">
            ...
            <div class="controls">
              <?php
               ...
               ?>
              <?php echo $form->dropDownList($model,'rujukanke', $listDataRuangan,array('empty'=>'-- Pilih --','onkeypress'=>"return $(this).focusNextInputField(event);", 'maxlength' => 100,'class'=>'span3')); ?>
            </div>
        </div>
