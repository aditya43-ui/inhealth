                    ...
                    <table class="table noborder">
                        ...
                        <tr class="border">
                            <td colspan="4">
                                ...
                                Obgyn: <?php echo $modPemeriksaanFisik->panel_obgyn;?><br><br><br>
                                </table>
                                            ...
                                            <table class="table noborder kolom-line">
                                                ...
                                                foreach ($asalRujuk as $ru) {
                                                    if ($ru->asalrujukan_id == $modPemeriksaanFisik->tl_asalrujukan_id) {
                                                        $cek = true;
                                                        $nama = isset($modPemeriksaanFisik->rujukandari->namaperujuk) ? $modPemeriksaanFisik->rujukandari->namaperujuk : "";
                                                        $namaR = isset($modPemeriksaanFisik->rujukandari->namaperujuk) ? $modPemeriksaanFisik->rujukandari->namaperujuk : "";
                        ...
                        <tr class="border">
                            <td colspan="4" style="text-align: center;">
                                <table class="noborder table">
                                    <tr>
                                        <td style="text-align:center;">Jombang, <?php echo MyFormatter::formatDateTimeId(date('Y-m-d')); ?></td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td style="text-align:center;"><?php echo $modPemeriksaanFisik->pegawai->namaLengkap; ?></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
