...
<style>
    ...
    .noborder2 tbody tr:hover td,
    .noborder2 tbody tr:hover th {
        border: 1px solid black !important;
    }

    .noborder2 tbody tr td,
    .noborder2 tbody tr th {
        border: 1px solid black !important;
        font-size: 12px !important;
    }
</style>
        ...
        <table width="100%" class="content" style="border: none;">
            <tr class="border">
                <th colspan="4" style="text-align:center;">
                    <div class="judulcontent"> PEMERIKSAAN FISIK PASIEN IGD </div>
                </th>
            </tr>
            <tr class="border">
                <td colspan="4">
                ...
                <td colspan="4">
                    <table class="table noborder kolom-line">
                        <tr class="kolom-line">
                            ...
                            <td class="kolom-line kolom-line-bottom"><u><?php echo $modPemeriksaanFisik->td_systolic."/".$modPemeriksaanFisik->td_diastolic; ?></u></td>
                        ...
                        <tr class="kolom-line">
                            ...
                            <td class="kolom-line">:</td>
                            <td class="kolom-line"><u><?php //echo $modPemeriksaanFisik->detaknadi; 
                                                        ?></u></td>
            ...
            <tr class="border">
                <td colspan="4">Bising Jantung: <?php echo $modPemeriksaanFisik->bisingjantung;?></td>
            </tr>
            <tr class="border">
                <td colspan="4">Obgyn: <?php echo $modPemeriksaanFisik->panel_obgyn;?></td>
            </tr>
        </table>
    </div>
                        ...
                        <td colspan="4">
                            <table class="table noborder kolom-line">
                                <tr class="kolom-line">
                                    ...
                                    <td class="kolom-line" style="line-height: 1.0 !important;width:412px;">
                                        <?php
                                        $css = '';
                                                ...
                                                $css .= "#imgtag" . $tbh->gambartubuh_id . "
                                    {
                                        ...
                                        ?>
                                        <div align="" id="imgtag<?php echo $tbh->gambartubuh_id ?>">
                                                    <!--<img id="myImgId" src="<?php //echo Params::urlPhotoAnatomiTubuh() . $tbh->nama_file_gbr; ?>" class="taggd"  style="width:377px;"/>-->
    ...
    <div style="page-break-before:always; page-break-after:always;">
        ...
        <tr class="border">
            <td colspan="2" class="border" width="50%" style="border-right: 1px solid black !important;">
                <table class="table noborder kolom-line">
                    <tr>
                        <td colspan="2"><b>Tanda Vital Janin</b></td>
                    </tr>
                    <tr>
                        <td width="150">Denyut Jantung Janin</td>
                        <td><?php echo !empty($modPemeriksaanFisik->denyutjantung_janin) ? $modPemeriksaanFisik->denyutjantung_janin : " - "; ?></td>
                    </tr>
                    <tr>
                        <td>Tinggi Fundus Uteri</td>
                        <td><?php echo !empty($modPemeriksaanFisik->tinggifundus_uteri) ? $modPemeriksaanFisik->tinggifundus_uteri : " - "; ?></td>
                    </tr>
                </table>
            </td>
            <td colspan="2">
            ...
            <td colspan="3">
                <table class="table noborder kolom-line">
                    ...
                    <tr class="kolom-line">
                        <td class="kolom-line  kolom-line-bottom" style="margin-left: 15px;padding-top: 4px !important;line-height: 1.0 !important;">
            ...
            <td class="border">
                <table class="table noborder kolom-line">
                    ...
                    <tr class="kolom-line">
                        <td class="kolom-line kolom-line-bottom" style="margin-left: 10px;padding-top: 4px !important;line-height: 1.0 !important;">
                            <?php echo $modPemeriksaanFisik->terapi_rawatinap; ?>
                        </td>
                    </tr>
                </table>
            </td>
                            ...
                            <table class="table noborder kolom-line">
                                ...
                                foreach ($asalRujuk as $ru) {
                                    if ($ru->asalrujukan_id == $modPemeriksaanFisik->tl_asalrujukan_id) {
                                        $cek = true;
                                        $nama = !empty($modPemeriksaanFisik->rujukandari->namaperujuk) ? $modPemeriksaanFisik->rujukandari->namaperujuk : "-";
                                        $namaR = !empty($modPemeriksaanFisik->rujukandari->namaperujuk) ? $modPemeriksaanFisik->rujukandari->namaperujuk : "-";
            ...
            <td colspan="4" style="text-align: center;">
                <table class="noborder table">
                    <tr>
                        <td style="text-align:center;"><?php echo $data->kecamatan->kecamatan_nama?>, <?php echo MyFormatter::formatDateTimeId(date('Y-m-d')); ?></td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                    </tr>
                    ...
                    <tr>
                        <td style="text-align:center;"><?php echo $modPendaftaran->pegawai->namaLengkap; ?></td>
                    </tr>
                </table>
            </td>
        </tr>
...
<script>
    function titikSesudahSimpan(titikX, titikY, urutan, img) {
        var titikX = titikX - 16;
        var titikY = titikY - 16;
        var nomor = urutan + 1;
        var color = 'red';
        var size = '5px';
        $(img).append(
