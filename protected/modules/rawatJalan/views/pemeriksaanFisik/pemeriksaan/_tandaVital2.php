...
<div class="control-group">
    ...
    <div class="controls">
        ...
        // echo '<pre>';var_dump($modPemeriksaanFisik->tekanandarah);die;
        echo $form->textField($modPemeriksaanFisik, 'tekanandarah', array('readonly' => true, 'class' => 'span2', 'style' => 'width:60px;', 'onkeypress' => "return $(this).focusNextInputField(event)", 'placeholder' => '000 / 000'));
        // $this->widget('CMaskedTextField', array(
        //     'model' => $modPemeriksaanFisik,
        //     'attribute' => 'tekanandarah',
        //     'mask' => '999 / 999',
        //     'placeholder' => '000 / 000',
        //     'htmlOptions' => array('readonly' => true, 'class' => 'span2', 'style' => 'width:60px;', 'onkeypress' => "return $(this).focusNextInputField(event)", 'value' => $modPemeriksaanFisik->tekanandarah) //,'onkeyup'=>'getTekananDarah(this);''onfocus'=>'change(this);', 'onblur'=>'change(this);',
        // ));
        ?> Mm/Hg
    </div>
</div>
...
<div class="panel panel-success panel_cgsews">
    <div class="panel-heading">
        <div class="panel-title">
            <?php 
                $checked = false;
                if($modPemeriksaanFisik->gcs_eye !== null) {
                    $checked = true;
                } 
                // echo '<pre>';var_dump($checked);die;
            ?>
            <?php echo $form->checkBox($modPemeriksaanFisik, 'gcs_eye', array('checked' => $checked,'class' => 'cek_ews', 'uncheckValue' => null)); ?>
            ...
            <?php echo $form->labelEx($modPemeriksaanFisik, 'gcs_eye', array('class' => 'control-label')) ?>
                <div class="controls">
                    ...
                    echo $form->dropDownList(
                        ...
                        array('empty' => '-- Pilih --', 'class' => 'span3 gcs_e', 'onkeypress' => "return $(this).focusNextInputField(event);", 'onchange' => 'hitungCGS()')
                    ); ?>
                </div>
            </div>
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    echo $form->dropDownList(
                        ...
                        array('empty' => '-- Pilih --', 'class' => 'span3 gcs_v', 'onkeypress' => "return $(this).focusNextInputField(event);", 'onchange' => 'hitungCGS()')
                    ); ?>
                </div>
            </div>
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    echo $form->dropDownList(
                        ...
                        array('empty' => '-- Pilih --', 'class' => 'span3 gcs_m', 'onkeypress' => "return $(this).focusNextInputField(event);", 'onchange' => 'hitungCGS()')
                    ); ?>
                </div>
            </div>
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    ?>
                    <?php echo $form->textField($modPemeriksaanFisik, 'nilai', array('class' => 'span1 integer numbersOnly', 'onkeypress' => "return $(this).focusNextInputField(event);", 'readonly' => true)) . ' '; ?>
                </div>
            </div>
