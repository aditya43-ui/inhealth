...
<?php
    $checked = false;
    if(!empty($modPemeriksaanFisik->abd_inspeksi)) {
        $checked = true;
    }
?>
<div class="panel panel-success panel_cgsews">
    <div class="panel-heading">
        <div class="panel-title"><?php echo $form->checkBox($modPemeriksaanFisik, 'abd_inspeksi', array('class' => 'cek_ews', 'uncheckValue' => null, 'checked' => $checked)); ?>
