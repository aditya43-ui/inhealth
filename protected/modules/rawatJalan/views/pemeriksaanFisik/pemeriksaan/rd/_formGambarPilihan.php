<?php
                ...
                foreach ($gbrTubuh as $tbh) {
                   if($tbh->jeniskelamin === '') {
                    ...
                    if($tbh->jeniskelamin == Params::JENIS_KELAMIN_PEREMPUAN) {
                        $hide = $hideGambarPerempuan;
                    } else {
                        $hide = $hideGambarLakiLaki;
                    }
                    $css .= " 
                ...
                ?>
                        ...
                        <div align="center" id="imgtag<?php echo $tbh->gambartubuh_id ?>" class="<?= $tbh->jeniskelamin ?>" <?= $hide ?>>
