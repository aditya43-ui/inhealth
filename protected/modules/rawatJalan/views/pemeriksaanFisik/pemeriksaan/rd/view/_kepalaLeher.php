    ...
    <table id="tblDaftarAnamnesa" width="100%" class="table table-bordered table-condensed" border="2">
        ...
        <tr>
            ...
            echo !empty($modPemeriksaanFisik->leher_anemia) ? "Normal" : ""; 
            echo !empty($modPemeriksaanFisik->leher_leterus) ? "Anemic" : ""; 
            echo !empty($modPemeriksaanFisik->leher_cyanosis) ? "Icterus" : ""; 
            echo !empty($modPemeriksaanFisik->leher_dyspneu) ? $modPemeriksaanFisik->leher_dyspneu  : ""; 
