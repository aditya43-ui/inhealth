...
<div class="control-group">
    ...
    <div class="controls">
        <?php echo $form->textField($modPemeriksaanFisik, 'suhutubuh', array('class' => 'span2 float-suhu', 'maxlength' => 5, 'onkeypress' => "return $(this).focusNextInputField(event);", 'style' => 'text-align:right;')); ?>
        &#176 Celcius
    </div>
</div>
<div class="control-group">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                echo $form->dropDownList(
                                    ...
                                    array('value'=>'empty','empty' => '-- Pilih --', 'class' => 'span3 gcs_e', 'onkeypress' => "return $(this).focusNextInputField(event);", 'onchange' => 'hitungCGS()')
                                ); ?>
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                echo $form->dropDownList(
                                    ...
                                    array('value'=>'empty','empty' => '-- Pilih --', 'class' => 'span3 gcs_v', 'onkeypress' => "return $(this).focusNextInputField(event);", 'onchange' => 'hitungCGS()')
                                ); ?>
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                echo $form->dropDownList(
                                    ...
                                    array('value'=>'empty','empty' => '-- Pilih --', 'class' => 'span3 gcs_m', 'onkeypress' => "return $(this).focusNextInputField(event);", 'onchange' => 'hitungCGS()')
                                ); ?>
                            </div>
                        </div>
                        <div class="control-group">
