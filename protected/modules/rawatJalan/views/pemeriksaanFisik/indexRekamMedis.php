...
$this->Widget('ext.bootstrap.widgets.BootAccordion', array(
    ...
    'content' => array(
        'content-detailpemeriksaanfisik' => array(
            ...
            'isi' => $this->renderPartial($this->path_view . '_tabelRiwayatFisikRekamMedis', array(
            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    ...
                    <div class="control-group">
                        ...
                        <?php echo $form->textArea($modPemeriksaanFisik, 'keadaanumum', array('placeholder' => '', 'class' => 'span5 autogrow', 'onkeypress' => "return $(this).focusNextInputField(event);")); ?>
                            <?php
