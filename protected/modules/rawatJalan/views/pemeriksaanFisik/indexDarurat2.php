        ...
        <fieldset class=''>
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    ...
                    <?php
                 $kelpeg = Yii::app()->user->getState('kelompokpegawai_id');
                ...
                ?>
                    ...
                    <?php
                        ...
                        $dokter = $modPemeriksaanFisik->getDokterItems();
                    ...
                    <div class="control-group">
                        <div class="controls">
                          <?php echo $form->dropDownListRow($modPemeriksaanFisik, 'pegawai_id', CHtml::listData($dokter, 'pegawai_id', 'NamaLengkap'), array('onkeypress' => "return $(this).focusNextInputField(event);", 'empty' => '-- Pilih --', 'class' => 'required')); ?>
                        </div>
                    </div>
...
<?php 
    $checked = false;
    if(!empty($modPemeriksaanFisik->inspeksi)) {
        $checked = true;
    }
?>
    <div class="col-sm-6" style="margin-top:17px">
        <div class="panel panel-success panel_cgsews">
            <div class="panel-heading">
                <div class="panel-title"><?php echo $form->checkBox($modPemeriksaanFisik, 'thorax', array('class' => 'cek_ews', 'uncheckValue' => null, 'checked' => $checked)); ?><?php echo $headThorax; ?></div>
           ...
           <?php
                if (!empty($hide)) {
                    echo $this->renderPartial($this->path_view . "pemeriksaan/_tandaVital2s", array('modPemeriksaanFisik' => $modPemeriksaanFisik,'modRJMetodeGSCM'=>$modRJMetodeGSCM, 'form' => $form), true);
                } else {
...
JS;
    ...
    $urlgetMetodeGCS = $this->createUrl('GetMetodeGCS2');
