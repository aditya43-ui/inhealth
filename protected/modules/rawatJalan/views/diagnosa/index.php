...
<div class="panel panel-success">
    <div class="panel-heading">
        <div class="panel-title">
            Berdasarkan
            <b><?php echo CHtml::radioButton('berdasarKasusPenyakit', true, array('onclick' => 'daftarDiagnosa(this)', 'class' => 'kp_t')); ?>Diagnosa ICD X &nbsp;&nbsp;&nbsp;&nbsp;<?php echo CHtml::radioButton('berdasarKasusPenyakit', false, array('onclick' => 'daftarDiagnosa(this)', 'class' => 'kp_f')); ?>Kasus Penyakit</b>
        </div>
    </div>
