             ...
             <div class="row-fluid">
                 <div class="col-sm-6">
                     <div class="control-group ">
                        ...
                        <div class="controls">
                            <label class="checkbox inline">
                                ...
                                <?php echo $form->checkboxRow($modAsesmenawalkeperawatanT,'statuspsikologis_islainnya',array('onChange'=>'changePsikologiLainnya(this);')); ?>   
                            </label>
                        </div>
                    </div>
                     <div class="control-group ">
                     ...
                     <div class="control-group ">
                        ...
                        <div class="controls">
                            <?php echo $form->radioButtonList($modAsesmenawalkeperawatanT,'hambatansosial_status',array('Tidak Ada'=>'Tidak Ada','Ada'=>'Ada') , array('onkeyup'=>"return $(this).focusNextInputField(event)",'onclick'=>'setHambatSosial(this);')); ?>            
                     ...
                     <div class="control-group ">
                        ...
                        <div class="controls">
                            <?php echo $form->radioButtonList($modAsesmenawalkeperawatanT,'hambatanekonomi_status',array('Tidak Ada'=>'Tidak Ada','Ada'=>'Ada') , array('onkeyup'=>"return $(this).focusNextInputField(event)",'onclick'=>'setHambatEkonomi(this);')); ?>            
                 ...
                 <div class="col-sm-6">
                    <div class="control-group ">
                        ...
                        <div class="controls">
                            <?php echo $form->radioButtonList($modAsesmenawalkeperawatanT,'hambatanspiritual_status',array('Tidak Ada'=>'Tidak Ada','Ada'=>'Ada') , array('onkeyup'=>"return $(this).focusNextInputField(event)",'onclick'=>'setHambatSpiritual(this);')); ?>            
                     ...
                     <div class="control-group ">
                        ...
                        <div class="controls">
                            <?php echo $form->radioButtonList($modAsesmenawalkeperawatanT,'nilaikepercayaan_status',array('Tidak Ada'=>'Tidak Ada','Ada'=>'Ada') , array('onkeyup'=>"return $(this).focusNextInputField(event)",'onclick'=>'setNilaiKepercayaan(this);')); ?>            
