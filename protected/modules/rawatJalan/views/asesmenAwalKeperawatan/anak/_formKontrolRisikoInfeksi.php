                               ...
                               foreach($lookupJenisRisiko as $i => $look_risiko){
                                ...
                                $htmlRisiko .= CHtml::hiddenField('RisikoInfeksi['.$i.'][jenisrisiko]',$look_risiko->lookup_value);
                                 if($look_risiko->lookup_value == 'Lainnya'){
                                   $htmlRisiko .= CHtml::checkBox('RisikoInfeksi['.$i.'][isRisiko]',false , array('datavalue'=>$look_risiko->lookup_value,'class'=>'jenisrisiko disabledinputan','onchange'=>'setJenisRisikoLainnya_anak(this)')).' <label>'.$look_risiko->lookup_name.'</label>';
