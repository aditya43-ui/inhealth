      ...
      <table width="100%" class="tablefont">
        <tr>
            ...
            <td>
              ...
              <span style="padding-left: 5px" class="<?php echo ((!empty($model->obgyn_statuskawin) && ($model->obgyn_statuskawin =='Cerai'))?'fa fa-check-square-o':'fa fa-square-o'); ?>"></span> Cerai
              <span style="padding-left: 5px" class="<?php echo ((!empty($model->obgyn_statuskawin) && ($model->obgyn_statuskawin =='Kawin'))?'fa fa-check-square-o':'fa fa-square-o'); ?>"></span> Kawin
              <span style="padding-left: 5px"></span> Jumlah : <?php echo $model->obgyn_jumlahperkawainan; ?> Kali
            </td>
        </tr>
        <tr>
            <td>Umur waktu kawin pertama</td>
            <td width="5px">:</td>
  ...
  <tr>
    <td class="padding5 borderclass">
      <table width="100%">
        ...
        <tr>
          <td class="borderclass" style="padding: 20px">
            <table class="tableBorder" width="100%">
              <thead>
                <tr>
                  <th class="textcenter" rowspan="2" width="50px">Hamil Ke-</th>
              ...
              <tbody>
                <?php
                    ...
                    if(count($riwayatKehamilan) >0){
                      ...
                      ?>
                      <tr>
                        <td class="textcenter"><?php echo $rwy->kehamilan_hamilke; ?></td>
                        <td class="textcenter"><?php echo $rwy->kehamilan_umur; ?></td>
            ...
            <table width="100%" class="tablefont">
              <tr>
                  ...
                  <td>
                    ...
                    <span style="padding-left: 5px" class="<?php echo ((!empty($model->obgyn_antenatalcare_status) && ($model->obgyn_antenatalcare_status =='Ya'))?'fa fa-check-square-o':'fa fa-square-o'); ?>"></span> Ya
                    <br/>
                    <span style="padding-left: 60px"></span>Di :
                    ...
                    <span style="padding-left: 5px" class="<?php echo ((!empty($model->obgyn_antenatalcare_tempat) && ($model->obgyn_antenatalcare_tempat =='Dokter Umum'))?'fa fa-check-square-o':'fa fa-square-o'); ?>"></span> Dokter Umum
                    <span style="padding-left: 5px" class="<?php echo ((!empty($model->obgyn_antenatalcare_tempat) && ($model->obgyn_antenatalcare_tempat =='Dokter Bidan'))?'fa fa-check-square-o':'fa fa-square-o'); ?>"></span> Dokter Bidan
                    <span style="padding-left: 5px" class="<?php echo ((!empty($model->obgyn_antenatalcare_tempat) && ($model->obgyn_antenatalcare_tempat =='Lainnya'))?'fa fa-check-square-o':'fa fa-square-o'); ?>"></span> Lainnya
                    , <?php echo $model->obgyn_antenatalcare_tempatlainnya; ?>
                    <br/>
                    <span style="padding-left: 11px"></span>Frekuensi :
              ...
              <tr>
                  ...
                  <td>
                    ...
                    <span style="padding-left: 5px" class="<?php echo ((!empty($model->obgyn_imunisasittstatus) && ($model->obgyn_imunisasittstatus =='Ya'))?'fa fa-check-square-o':'fa fa-square-o'); ?>"></span> Ya
                  ...
                  <td>
                    ...
                    if(count($keluhanhaminlArr) > 0){
                      foreach ($keluhanhaminlArr as $i => $hamil) {
                        ...
                        $stylepadding = "";
                        if($i > 0){
                            $stylepadding = "style='padding-left: 5px;'";
                        }
                        $htmlKeluhHamil .= "<span ".$stylepadding." class='".(($isCheckHamil==true)?'fa fa-check-square-o':'fa fa-square-o')."'></span> ".$hamil;
                      }
                    }
                    echo $htmlKeluhHamil;
              ...
              <tr>
                  ...
                  <td>:</td>
                  <td>
                    <?php echo $model->obgyn_penjelasankeluhan; ?>
                  </td>
              </tr>
            </table>
          </td>
      ...
      <table width="100%">
          <tr>
              ...
              <td width="50%" valign="top">
                <table width="100%" class="tablefont">
                  <tr>
                      <td width="200px">Pembiayaan Kesehatan</td>
                      <td width="5px">:</td>
      ...
      <table width="100%">
          <tr>
              <td width="50%" valign="top">
                <table width="100%" class="tablefont">
                  <tr>
                      <td width="200px">Diet Saat ini</td>
                      <td width="5px">:</td>
                      <td>
              ...
              <td width="50%" valign="top">
                <table width="100%" class="tablefont">
                    <tr>
                        <td width="250px">Penurunan/kenaikan berat badan selama 6 bulan terakhir</td>
                        <td width="5px">:</td>
                        <td>
                          ...
                          <span style="padding-left: 5px" class="<?php echo ((!empty($model->nutrisi_perubahanbb6blnterakhir) && ($model->nutrisi_perubahanbb6blnterakhir=='Ya'))?'fa fa-check-square-o':'fa fa-square-o'); ?>"></span> Ya
