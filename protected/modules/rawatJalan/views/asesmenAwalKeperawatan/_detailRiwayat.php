       ...
       <div class="panel panel-success panel-shadow">
         <div class="panel-heading">
          ...
          <div class="panel panel-success panel_nyeri" id="nyeri_dewasa" >
                  <div class="panel-heading">
                      <div class="panel-title">Asesmen Nyeri Anak > 3</div>
                  </div>
                  <div class="panel-body" >
...
<div class="pageDetail" id="pageDetail_2">
  ...
  <div class="panel panel-success panel-shadow">
     <div class="panel-heading">
      ...
      <div class="panel-body">
        <table class="items table table-bordered" width="100%">
            <thead>
                <tr>
                    <th colspan="4" style="text-align: center">Skrining Gizi pada Anak <br /> Berdasarkan Metode Strong Kids (usia < 18 th)</th>
                </tr>
                <tr>
                    <th style="width: 10px">No</th>
                    <th>Parameter</th>
            ...
            <tr>
             ...
             <tr>
                <td colspan="4" style="text-align: center;">Catatan:Skor 4-5 dilakukan pengkajian lanjut oleh ahli gizi</td>
            </tr>
        </table>
        <br/>
        <table width="100%" class="tablefont">
            <tr>
                <td width="350px">Diet Saat ini</td>
                <td width="5px">:</td>
                <td>
            ...
            <tr>
                <td valign="top">Penurunan/kenaikan berat badan selama 6 bulan terakhir</td>
                <td valign="top">:</td>
                <td>
                  ...
                  <br/>
                  <span style="padding-left: 20px"></span>Jelaskan : <?php echo $model->nutrisi_perubahanbb6blnterakhirket; ?>
                </td>
            </tr>
        </table>
