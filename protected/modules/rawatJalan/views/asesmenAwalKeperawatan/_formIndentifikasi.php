        ...
        <div class="panel-heading">
         ...
         <div class="panel-body">
             <div class="col-md-6">
                 <div class="control-group">
                    <div class="control-label">
                        <?php  echo $form->checkBox($modAsesmenawalkeperawatanT,'identifikasipenyakit_ismenular',array('onchange'=>'changeIndetifikasiPenyakitMenular(this);')); ?>
             ...
             <div class="col-md-6">
                 <div class="control-group">
                    <div class="control-label">
                        <?php  echo $form->checkBox($modAsesmenawalkeperawatanT,'identifikasipenyakit_ispenyakitjiwa',array('onchange'=>'changeIndetifikasiPenyakitJiwa(this);')); ?>
                ...
                <div class="control-group">
                     <label class="control-label"></label>
                    <div class="controls">
                        &nbsp;&nbsp;&nbsp;&nbsp;<?php echo $form->checkbox($modAsesmenawalkeperawatanT,'identifikasipenyakitjiwa_islainnya',array('class'=>'idenpenyakitjiwa','disabled'=>true,'onchange'=>'setIdenPenyakitJiwaLainnya(this);')); ?>     <label>Lainnya</label> 
