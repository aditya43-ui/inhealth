...
<div style="padding: 5px;">
  <div class="textright textbold headertext">FRM/73E/RSBM</div>
  <?php echo $this->renderPartial($this->path_view."_headerPrint", array(
       'modProfilRs'=>$modProfilRs,'modPasien'=>$modPasien,'modPendaftaran'=>$modPendaftaran, 'header_print'=>'ASESMEN AWAL KEPERAWATAN <br/>','header_print_title'=>'PASIEN RAWAT JALAN DEWASA'
   ), true); ?>
  <?php echo $this->renderPartial($this->path_view."dewasa/_printpage3", array(
       'model'=>$model,'modPendaftaran'=>$modPendaftaran
   ), true); ?>

  <div style="page-break-before:always; page-break-after:always;">
    <?php echo $this->renderPartial($this->path_view."dewasa/_printpage2", array(
