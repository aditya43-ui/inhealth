         ...
         <div class="panel-body">
             <div class="col-md-6">
                 ...
                 <div class="control-group ">
                    ...
                    <div class="controls">
                        <?php echo $form->radioButtonList($modAsesmenawalkeperawatanT,'keb_eliminasi_bab_keluhanstatus',array(0=>'Tidak Ada',1=>'Ada') , array('class'=>'keb_eliminasi_bab_keluhanstatus','onkeyup'=>"return $(this).focusNextInputField(event)",'onclick'=>'setKebEliminasiBab_dws(this);')); ?>
                    </div>
                </div>
                 <div class="control-group ">
                 ...
                 <div class="control-group ">
                     <label class="control-label"></label>
                     <div class="controls">
                            &nbsp;&nbsp;&nbsp;&nbsp;<?php echo $form->checkbox($modAsesmenawalkeperawatanT,'keb_eliminasi_bab_iskeluhanlainnya',array('class'=>'kebEliminasiBab','disabled'=>true,'onchange'=>'setKebEliminasiKeluhanLainBab_dws(this);')); ?>   <label>Lainnya</label>
             ...
             <div class="col-md-6">
                 ...
                 <div class="control-group ">
                    ...
                    <div class="controls">
                        <?php echo $form->radioButtonList($modAsesmenawalkeperawatanT,'keb_eliminasi_bak_keluhanstatus',array(0=>'Tidak Ada',1=>'Ada') , array('class'=>'keb_eliminasi_bak_keluhanstatus','onkeyup'=>"return $(this).focusNextInputField(event)",'onclick'=>'setKebEliminasiBak_dws(this);')); ?>
                    </div>
                </div>
                 <div class="control-group">
                     <label class="control-label"></label>
                 ...
                 <div class="control-group">
                     <label class="control-label"></label>
                    <div class="controls">
                        &nbsp;&nbsp;&nbsp;&nbsp;<?php echo $form->checkbox($modAsesmenawalkeperawatanT,'keb_eliminasi_bak_iskeluhanlainnya',array('class'=>'kebEliminasiBak','disabled'=>true,'onchange'=>'setKebEliminasiKeluhanLainBak_dws(this);')); ?>     <label>Lainnya</label>
