...
<script type="text/javascript">
    function print(pendaftaran_id) {
        window.open('<?php echo $this->createUrl('printTindakan'); ?>&id=' + pendaftaran_id, 'printwin', 'left=100,top=100,width=1080,height=640');
    }

    function printSemua(pendaftaran_id) {
        window.open('<?php echo $this->createUrl('printTindakan'); ?>&id=' + pendaftaran_id + '&is_all=true', 'printwin', 'left=100,top=100,width=1080,height=640');
    }

    function printNota(pendaftaran_id) {
        var nopel = $('#nopel').val();
        window.open('<?php echo $this->createUrl('printTindakan'); ?>&id=' + pendaftaran_id + '&nopelayanan=' + nopel, 'printwin', 'left=100,top=100,width=1080,height=640');
    }

    function printNotaPenunjang() {
        var nopel = $('#nopel').val();
        var pasienmasukpenunjang_id = $('#pasienmasukpenunjang_id').val();
        window.open('<?php echo $this->createUrl('printTindakanPenunjang'); ?>&pasienmasukpenunjang_id=' + pasienmasukpenunjang_id + '&nopelayanan=' + nopel, 'printwin', 'left=100,top=100,width=1080,height=640');
    }

    function printUlang(pendaftaran_id) {
        $('#dialogCetakUlang')
        window.open('<?php echo $this->createUrl('printUlangTindakan'); ?>&pendaftaran_id=' + pendaftaran_id, 'printwin', 'left=100,top=100,width=1080,height=640');
    }
    // the subviews rendered with placeholders
    var trTindakan = new String(<?php echo CJSON::encode($this->renderPartial($this->path_view . '_rowTindakanPasien', array('modTindakan' => $modTindakan, 'removeButton' => true, 'checked' => false), true)); ?>);
    ...
    function addRowTindakan(obj) {
        console.log('ini tambah baris tindakan');
        ...
        renameInput('RJTindakanPelayananT', 'tarif_tindakan');
        renameInput('RJTindakanPelayananT', 'tgl_tindakan');
        renameInput('RJTindakanPelayananT', 'keltindakanid');
        renameInput('RJTindakanPelayananT', 'checklist');
    ...
    function renameInput(modelName, attributeName) {
        ...
        $('#tblInputTindakan tr').each(function() {
            ...
            //untuk dokter 6-10
            $(this).find('div[id^="dokter6_"]').attr('id', 'dokter6_' + i + '');
            $(this).find('div[id^="dokter7_"]').attr('id', 'dokter7_' + i + '');
            $(this).find('div[id^="dokter8_"]').attr('id', 'dokter8_' + i + '');
            $(this).find('div[id^="dokter9_"]').attr('id', 'dokter9_' + i + '');
            $(this).find('div[id^="dokter10_"]').attr('id', 'dokter10_' + i + '');
    ...
    function addDokterLengkap(obj = null) {
        ...
        if (obj != null) {
            ...
            if (tot_checked == 0) {
                myAlert("Data Tindakan belum ada yang terchecklist");
                return false;
            }
            $('#dialogPemeriksaLengkap #dokterpemeriksa1_id').val("");
            $('#dialogPemeriksaLengkap #dokterpemeriksa2_id').val("");
            $('#dialogPemeriksaLengkap #dokterdelegasi_id').val("");
            $('#dialogPemeriksaLengkap #dokterpendamping_id').val("");
            $('#dialogPemeriksaLengkap #dokteranastesi_id').val("");
            $('#dialogPemeriksaLengkap #perawat_id').val("");
            $('#dialogPemeriksaLengkap #perawat2_id').val("");
            $('#dialogPemeriksaLengkap #bidan_id').val("");
            $('#dialogPemeriksaLengkap #supir_id').val("");
            $('#dialogPemeriksaLengkap #bidan2_id').val("");
            $('#dialogPemeriksaLengkap #bidan3_id').val("");
            $('#dialogPemeriksaLengkap #dokter6').val("");
            $('#dialogPemeriksaLengkap #dokter7').val("");
            $('#dialogPemeriksaLengkap #dokter8').val("");
            $('#dialogPemeriksaLengkap #dokter9').val("");
            $('#dialogPemeriksaLengkap #dokter10').val("");
    ...
    function setDokterPemeriksa1(item, i = null) {
        ...
        $('#tampilanDokterPemeriksa_' + row).parents("tr").show();
    }

    function updateDokterPemeriksa1(value) {
        if (value == '') {
            var row = $('#dialogPemeriksaLengkap #rowTindakan').val();
            $('#RJTindakanPelayananT_' + row + '_dokterpemeriksa1_id').val('');
            $('#tampilanDokterPemeriksa_' + row).html('');
            $('#tampilanDokterPemeriksa_' + row).parents("tr").show();
        }
    }

    function setDokterPemeriksa2(item, i = null) {
        var row = $('#dialogPemeriksaLengkap #rowTindakan').val();
        if (i != null) {
            var row = i;
        }
        console.log(row, 'ini row');
        $('#RJTindakanPelayananT_' + row + '_dokterpemeriksa2_id').val(item.pegawai_id);
        $('#tampilanDokterPemeriksa2_' + row).html("Dokter Pemeriksa 2 : " + item.nama_pegawai);
        $('#tampilanDokterPemeriksa2_' + row).parents("tr").show();
    }

    function updateDokterPemeriksa2(value) {
        if (value == '') {
            var row = $('#dialogPemeriksaLengkap #rowTindakan').val();
            $('#RJTindakanPelayananT_' + row + '_dokterpemeriksa2_id').val('');
            $('#tampilanDokterPemeriksa2_' + row).html('');
            $('#tampilanDokterPemeriksa2_' + row).parents("tr").show();
        }
    }

    function setDokterDelegasi(item, i = null) {
        var row = $('#dialogPemeriksaLengkap #rowTindakan').val();
        if (i != null) {
            var row = i;
        }
        ...
        $('#tampilanDokterDelegasi_' + row).parents("tr").show();
    }

    function updateDokterDelegasi(value) {
        if (value == '') {
            var row = $('#dialogPemeriksaLengkap #rowTindakan').val();
            $('#RJTindakanPelayananT_' + row + '_dokterdelegasi_id').val('');
            $('#tampilanDokterDelegasi_' + row).html('');
            $('#tampilanDokterDelegasi_' + row).parents("tr").show();
        }
    }

    function setDokterPendamping(item, i = null) {
        var row = $('#dialogPemeriksaLengkap #rowTindakan').val();
        if (i != null) {
            var row = i;
        }
        $('#RJTindakanPelayananT_' + row + '_dokterpendamping_id').val(item.pegawai_id);
        $('#tampilanDokterPendamping_' + row).html("Dokter Pendamping : " + item.nama_pegawai);
        $('#tampilanDokterPendamping_' + row).parents("tr").show();
    }

    function updateDokterPendamping(value) {
        if (value == '') {
            var row = $('#dialogPemeriksaLengkap #rowTindakan').val();
            $('#RJTindakanPelayananT_' + row + '_dokterpendamping_id').val('');
            $('#tampilanDokterPendamping_' + row).html('');
            $('#tampilanDokterPendamping_' + row).parents("tr").show();
        }
    }

    function setDokterAnastesi(item, i = null) {
        var row = $('#dialogPemeriksaLengkap #rowTindakan').val();
        if (i != null) {
            var row = i;
        }
        $('#RJTindakanPelayananT_' + row + '_dokteranastesi_id').val(item.pegawai_id);
        $('#tampilanDokterAnastesi_' + row).html("Dokter Anastesi : " + item.nama_pegawai);
        $('#tampilanDokterAnastesi_' + row).parents("tr").show();
    }

    function setDokter6sampai10(item, identitas, nomor, i = null) {
        var row = $('#dialogPemeriksaLengkap #rowTindakan').val();
        if (i != null) {
            var row = i;
        }
        console.log(item, identitas, nomor, i, 'test');
        $('#RJTindakanPelayananT_' + row + '_' + identitas + '_id').val(item.pegawai_id);
        $('#' + identitas + '_' + row).html("Dokter " + nomor + " : " + item.nama_pegawai);
        $('#' + identitas + '_' + row).parents("tr").show();
    }

    function updateDokterAnastesi(value) {
        if (value == '') {
            var row = $('#dialogPemeriksaLengkap #rowTindakan').val();
            $('#RJTindakanPelayananT_' + row + '_dokteranastesi_id').val('');
            $('#tampilanDokterAnastesi_' + row).html('');
            $('#tampilanDokterAnastesi_' + row).parents("tr").show();
        }
    }

    function setBidan(item, i = null) {
        var row = $('#dialogPemeriksaLengkap #rowTindakan').val();
        if (i != null) {
            var row = i;
        }
        ...
        $('#tampilanBidan_' + row).parents("tr").show();
    }

    function setBidan2(item, i = null) {
        var row = $('#dialogPemeriksaLengkap #rowTindakan').val();
        if (i != null) {
            var row = i;
        }
        $('#RJTindakanPelayananT_' + row + '_bidan2_id').val(item.pegawai_id);
        $('#tampilanBidan2_' + row).html("Bidan 2 : " + item.nama_pegawai);
        $('#tampilanBidan2_' + row).parents("tr").show();
    }

    function setBidan3(item, i = null) {
        var row = $('#dialogPemeriksaLengkap #rowTindakan').val();
        if (i != null) {
            var row = i;
        }
        $('#RJTindakanPelayananT_' + row + '_bidan3_id').val(item.pegawai_id);
        $('#tampilanBidan3_' + row).html("Bidan 3 : " + item.nama_pegawai);
        $('#tampilanBidan3_' + row).parents("tr").show();
    }

    function updateBidan(value) {
        if (value == '') {
            var row = $('#dialogPemeriksaLengkap #rowTindakan').val();
            $('#RJTindakanPelayananT_' + row + '_bidan_id').val('');
    ...
    function setSuster(item, i) {
        ...
        $('#tampilanSuster_' + row).parents("tr").show();
    }

    function updateSuster(value) {
        if (value == '') {
            var row = $('#dialogPemeriksaLengkap #rowTindakan').val();
            $('#RJTindakanPelayananT_' + row + '_suster_id').val('');
            $('#tampilanSuster_' + row).html('');
            $('#tampilanSuster_' + row).parents("tr").show();
        }
    }

    function setPerawat(item, i = null) {
        var row = $('#dialogPemeriksaLengkap #rowTindakan').val();
        if (i != null) {
            var row = i;
        }
        if (item != null) {
            ...
            $('#tampilanPerawat_' + row).parents("tr").show();
        }
    }

    function setPerawat2(item, i = null) {
        var row = $('#dialogPemeriksaLengkap #rowTindakan').val();
        if (i != null) {
            var row = i;
        }
        if (item != null) {
            $('#RJTindakanPelayananT_' + row + '_perawat2_id').val(item.pegawai_id);
            $('#tampilanPerawat2_' + row).html("Perawat 2 : " + item.nama_pegawai);
            $('#tampilanPerawat2_' + row).parents("tr").show();
        }
    }
    ...
    function updatePerawat(value) {
        if (value == '') {
            var row = $('#dialogPemeriksaLengkap #rowTindakan').val();
            $('#RJTindakanPelayananT_' + row + '_perawat_id').val('');
    ...
    function updatePerawat(value) {
        if (value == '') {
            var row = $('#dialogPemeriksaLengkap #rowTindakan').val();
            $('#RJTindakanPelayananT_' + row + '_perawat2_id').val('');
            $('#tampilanPerawat2_' + row).html('');
            $('#tampilanPerawat2_' + row).parents("tr").show();
        }
    }

    function setSupir(item, i) {
        var row = $('#dialogPemeriksaLengkap #rowTindakan').val();
        if (i != null) {
            var row = i;
        }
        if (item != null) {
            $('#RJTindakanPelayananT_' + row + '_supir_id').val(item.pegawai_id);
            $('#tampilanSupir_' + row).html("Supir : " + item.nama_pegawai);
            $('#tampilanSupir_' + row).parents("tr").show();
        }
    }
    ...
    function updateSupir(value) {
        if (value == '') {
            var row = $('#dialogPemeriksaLengkap #rowTindakan').val();
            $('#RJTindakanPelayananT_' + row + '_supir_id').val('');
    ...
    function setTindakan(obj, item) {
        ...
        $(obj).parents('tr').find('input[name$="[keltindakanid]"]').val(item.kelompoktindakan_id);
        $(obj).parents('tr').find('input[name$="[kode_tindakan]"]').val(item.daftartindakan_kode);
    ...
    function setDialog(obj) {
        ...
        $.fn.yiiGridView.update('giladiagnosa-m-grid2', {
            data: {
                // "TariftindakanperdaruanganV[kelaspelayanan_id]":kelaspelayanan_id,
                "TariftindakanperdaruanganV[tipepaket_id]": tipepaket_id,
                "TariftindakanperdaruanganV[jenistarif_id]": jenistarif_id,
                "TariftindakanperdaruanganV[penjamin_id]": penjamin_id,
            }
        });
    ...
    function dialogReturTindakan(obj, tindakanpelayanan_id, tindakansudahbayar_id) {
        if ($(obj).prop('checked') == true) {
            ...
            $.ajax({
                ...
                data: {
                    tindakanpelayanan_id: tindakanpelayanan_id,
                    tindakansudahbayar_id: tindakansudahbayar_id
                },
                dataType: "json",
                success: function(data) {
                    if (data.pesan != '') {
    ...
    $(document).ready(function() {
        ...
        $("#is_pilihsemua").attr('checked', false);
        pilihSemua($('#is_pilihsemua'));
    ...
    function pilihSemua(obj) {
        ...
        if ($(obj).is(":checked")) {
            for (let i = 0; i < count; i++) {
                const checkbox = `RJTindakanPelayananT_${i}_checklist`;
    ...
    function setNol(obj) {
        ...
        console.log(tot_checked, count, 'test');
        if (tot_checked < count) {
            $("#is_pilihsemua").prop('checked', false);
        } else if (tot_checked == count) {
            $("#is_pilihsemua").prop('checked', true);
        }
    }
</script>