...
<table style="width: 100%; border: none;">
    ...
    <tr>
        ...
        <td style="width:30%"><?php echo isset($modAnamnesa->jeniskasuspenyakit->jeniskasuspenyakit_nama) ?$modAnamnesa->jeniskasuspenyakit->jeniskasuspenyakit_nama : "";  ?></td>
        <td style="width:20%">NO. Rekam Medik</td>
        <td style="width:30%"><?php echo isset($modAnamnesa->pendaftaran->no_rekam_medik) ? $modAnamnesa->pendaftaran->no_rekam_medik : ""; ?></td>
    </tr>
    <tr>
        <td style="width:20%">Nama</td>
        <td style="width:30%"><?php echo isset($modAnamnesa->pasien->nama_pasien) ? $modAnamnesa->pasien->nama_pasien : ""; ?></td>
        <td style="width:20%">Tgl. Lahir / UMUR</td>
        <td style="width:30%"><?php echo isset($modAnamnesa->pasien->tanggal_lahir) ? MyFormatter::formatDateTimeId($modAnamnesa->pasien->tanggal_lahir) : ""; ?> / <?php 
        $result = isset($modAnamnesa->pasien->tanggal_lahir) ? MyFormatter::formatDateTimeId($modAnamnesa->pasien->tanggal_lahir) :""; 
        echo CustomFunction::hitungUmur($result); ?></td>
    </tr>
    <tr>
        <td style="width:20%">Jenis Kelamin</td>
        <td style="width:30%"><?php echo isset($modAnamnesa->pasien->jeniskelamin) ? $modAnamnesa->pasien->jeniskelamin : ""; ?></td>
        <td style="width:20%">No. Pendaftaran</td>
        <td style="width:30%"><?php echo isset($modAnamnesa->pendaftaran->no_pendaftaran) ? $modAnamnesa->pendaftaran->no_pendaftaran : "" ; ?></td>
    </tr>
</table>
...
<table style="width: 100%; border: none;">
    ...
    <tr>
        ...
        <td colspan="3"></td>
        <td colspan="3" align="center" valign="middle"><?php echo (isset($modAnamnesa->pegawai->gelardepan)?$modAnamnesa->pegawai->gelardepan:'').' '.$modAnamnesa->pegawai->nama_pegawai.' '.(isset($modAnamnesa->pegawai->gelarbelakang_nama)?$modAnamnesa->pegawai->gelarbelakang_nama:''); ?></td>
    </tr>
