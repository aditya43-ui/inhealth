    ...
    <div class="panel-body">
        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <?php if(isset($_GET['pendaftaran_id']) && !isset($_GET['is_triage']) && !$readonly):?>

                <?= $form->hiddenField($modAnamnesa, 'pegawai_id') ?>
                <?php echo $form->dropDownListRow($modAnamnesa, 'nama_pegawai', CHtml::listData($modAnamnesa->getDokterItems(), 'nama_pegawai', 'NamaLengkap'), array('onkeypress' => "return $(this).focusNextInputField(event);", 'disabled' => true)); ?>
        ...
        if(!empty($kelPegawai->kelompokpegawai_id)){

        if (($kelPegawai->kelompokpegawai_id !== Params::KELOMPOKPEGAWAI_ID_DOKTER_TETAP)) {


        }else{

            // var_dump($kelPegawai->kelompokpegawai_id == Params::KELOMPOKPEGAWAI_ID_DOKTER_TETAP); die;
?>
            ...
            <div class="control-group <?= $hide ?> <?= (Yii::app()->user->getState('kelompokpegawai_id') == Params::KELOMPOKPEGAWAI_ID_DOKTER_TETAP) ? 'hide' : '' ?>">
            ...
            <?php }else{?>
            <?php
                    if (($kelPegawaippds->kelompokpegawai_id !== Params::KELOMPOKPEGAWAI_ID_DOKTER_TETAP)) {
...
if ($modPasien->jeniskelamin == 'PEREMPUAN' && (!empty($kelPegawai->loginpemakai_id == Yii::app()->user->getState('loginpemakai_id')) && $kelPegawai->kelompokpegawai_id == Params::KELOMPOKPEGAWAI_ID_DOKTER_TETAP)){
...
if ($kelPegawai !== null) {
    if ((!empty($kelPegawai->loginpemakai_id == Yii::app()->user->getState('loginpemakai_id')) && $kelPegawai->kelompokpegawai_id == Params::KELOMPOKPEGAWAI_ID_DOKTER_TETAP)){
    ...
    if ((!empty($kelPegawaippds->loginpemakai_id == Yii::app()->user->getState('loginpemakai_id')) && $kelPegawaippds->kelompokpegawai_id == Params::KELOMPOKPEGAWAI_ID_DOKTER_TETAP)){
