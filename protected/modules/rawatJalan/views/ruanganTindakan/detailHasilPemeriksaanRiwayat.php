        ...
        <td>
            <table>
                ...
                <tr>
                    <td>Ruangan</td>
                    <td> : </td>
                    <td><?= $modPendaftaran->ruangan->ruangan_nama ?></td>
                </tr>
                <tr>
                    <td>No. Hasil Pemeriksaan</td>
                    <td> : </td>
                    <td><?= $modPasienMasukPenunjang->no_masukpenunjang ?? '' ?></td>
                </tr>
                <tr>
...
<br>
<br>
<div class="hide-sementara"><?php echo CHtml::link("<i class='" . MyIcon::getIcons('cetak') . "'></i> Print", 'javascript:;', array('onclick' => 'printdulu(this);', 'class' => 'btn btn-success')); ?></div>
