    ...
    <div class="col-sm-12">
        <div class="control-group" >
            ...
            <div class="controls">
               ...
               <?php echo $form->radioButton($model, 'jumlahjanin_ket', array('onclick' => 'pilihJumlahJaninTrs3(this)', 'value' => 'Tunggal', 'class'=>'pilih_trs', 'uncheckValue'=>null)); ?> <label>Tunggal</label>
            </div>
        </div> 
        <div class="control-group" >
            <label class="control-label"></label>
            <div class="controls">
               <?php echo $form->radioButton($model, 'jumlahjanin_ket', array('onclick' => 'pilihJumlahJaninTrs3(this)', 'value' => 'Gemeli', 'class'=>'pilih_trs', 'uncheckValue'=>null)); ?> <label>Gemeli</label>
            </div>
        </div> 
        <div class="control-group" >
            <label class="control-label"></label>
            <div class="controls">
               <?php echo $form->radioButton($model, 'jumlahjanin_ket', array('onclick' => 'pilihJumlahJaninTrs3(this)', 'value' => 'Triple', 'class'=>'pilih_trs', 'uncheckValue'=>null)); ?> <label>Triple</label>
            </div>
        </div> 
        <div class="control-group" >
            <label class="control-label"></label>
            <div class="controls">
               <?php echo $form->radioButton($model, 'jumlahjanin_ket', array('onclick' => 'pilihJumlahJaninTrs3(this)', 'value' => 'Lainnya', 'class'=>'pilih_trs', 'uncheckValue'=>null)); ?> <label>Lainnya</label>
            </div>
            <div class="controls">
               <?php echo $form->textField($model, 'jumlahjaninlain', array('class' => 'span1 integer','readonly'=>true,'onkeyup'=>'addJumlahjaninTrs3()')); ?> 
            </div>
...
<div class="panel panel-success">
    ...
    <div class="panel-body">
        <div style="overflow-x: auto;">
            <table class="items table table-bordered" id="tbltrimester_3" style="width:2500px !important">
                <thead>
                    <tr>
