<div class="search-form">
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            ...
            ?>
            <?php 
                echo CHtml::hiddenField('filter', 'carabayar_id', array('disabled' => 'disabled')) . '<div class="control-group">
                            ' . CHtml::label('Uraian Tindakan', 'daftartindakan_id', array('class' => 'control-label')) . ' 
                            <div class="controls">												 
                                ' . $form->dropDownList(
                        $model,
                        'daftartindakan_id',CHtml::listData(DaftartindakanM::model()->findAll('daftartindakan_aktif=TRUE ORDER BY daftartindakan_nama ASC'), 'daftartindakan_id', 'daftartindakan_nama'),
                        array(
                            'class' => 'form-control', 
                            'multiple' => 'multiple',
                        )
