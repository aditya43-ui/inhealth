...
<div>
    ...
    <table width="100%" >
        <tr>
            ...
            <td class="titik">:</td>
            <td style="float:left"><?php echo !empty($modPasien->no_rekam_medik) ? $modPasien->no_rekam_medik: "" ?></td>
        </tr>        
        <tr>
    ...
    <br><br>
    <p style="text-align :left">
        Surat keterangan ini digunakan untuk (1) kali kunjungan dengan diagnosa di atas pada Tanggal : <?php echo date('d ', strtotime($modPendaftaran->tglrenkontrol)).MyFormatter::getMonthId(date('m', strtotime($modPendaftaran->tglrenkontrol))).date(' Y', strtotime($modPendaftaran->tglrenkontrol));  ?>
    </p>
</div><br>
<div >
    <div>
            ...
            <table class="tabel-surat" width="100%" >
                <tr>
                    ...
                    <td width="50%" style="text-align: center;font-size:15px">                        
                        ...
                        <?php 
                        echo $modPegawai->gelardepan.' '.$modPegawai->nama_pegawai.' '.$modPegawai->gelarbelakang_nama; 
