...
foreach ($modRiwayatKirimKeUnitLain as $i => $riwayat) {
    ...
    <tr>
        <td>
            <?php echo $riwayat->tgl_kirimpasien; ?>
            <?php echo CHtml::hiddenField('pasienkirim_id_' . $i, $riwayat->pasienkirimkeunitlain_id, array('class' => 'pasienkirimkeunitlain_id')); ?>
        ...
        <td>
            <?php echo CHtml::link("<i class='icon-form-silang'></i>", '#', array('onclick'=>'batalKirim('.$riwayat->pasienkirimkeunitlain_id.','.$riwayat->pendaftaran_id.', this);return false;','rel'=>'tooltip','title'=>'Klik untuk membatalkan kirim pasien')); ?>
        </td>
    </tr>
    <?php
}
