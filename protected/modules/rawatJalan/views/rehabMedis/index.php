...
<div class="formInputTab">
    ...
    <?php foreach ($modJenisTindakanRm as $i => $jenisPeriksa) {
        $ceklist = false;
    ?>
        <div class="boxtindakan" style="margin-top: 17px;" <?=$hidden?>>
            <div class="panel panel-success">
                <div class="panel-heading">
                    <div class="panel-title">
    ...
    <div class="antirow" <?=$hidden?>>
        <div class="row" style="margin-top: 17px;">
            ...
            <div class="col-sm-6">
                ...
                <?php 
                    echo $form->dropDownListRow($modKirimKeUnitLain, 'ruangan_id',  CHtml::listData(RuanganM::model()->findAll('ruangan_id in (1252, 1253, 1255, 1254, 272)'), 'ruangan_id', 'ruangan_nama'), ['class' => 'span3 ruangan_id', 'empty' => '--- Pilih ---', 'disabled' => true]);
                    echo CHtml::hiddenField('RJPasienKirimKeUnitLainT[ruangan_idhidden]', '', ['class' => 'ruangan_id'])
                ?>
                    <?php
        ...
        myConfirm("Apakah Anda akan membatalkan kirim pasien ke Rehab Medis?", "Perhatian!", function(r) {
            if (r) {
                ...
                $.post('<?php echo $this->createUrl('ajaxBatalKirim') ?>', {
                    ...
                    window.location.replace('<?php echo $this->createUrl('index') ?>&pendaftaran_id=<?php echo $_GET['pendaftaran_id'] ?>');
