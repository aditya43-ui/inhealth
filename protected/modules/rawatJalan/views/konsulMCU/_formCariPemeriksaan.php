<div id="form-caripemeriksaan" class="form-horizontal">
    ...
    <div class="row">
        ...
        <?php echo CHtml::htmlButton(Yii::t('mds', '{icon}', array('{icon}' => '<i class="entypo-search"></i>')), array('class' => 'btn btn-danger', 'type' => 'button', "onclick" => "updateChecklistTindakanMcu();", 'rel' => 'tooltip', 'title' => 'Klik untuk mencari pemeriksaan')); ?>
