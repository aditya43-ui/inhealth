...
//	'Asesment Resiko Jatuh'=>array('/rawatJalan/asesmentResikoJatuh'),
//	'Print',
//);?>
...
<p>
	...
	the file <span class="monospace-text"><?php // echo __FILE__; ?></span>.
</p>-->
<head>
...
<table width="100%" border="1">
    <tr>
        <td rowspan="3" style="width:70%"><?php echo $this->renderPartial('application.views.headerReport.headerDefaultNew'); ?></td>
...
<div style="padding-top: 10px; padding-bottom: 10px; text-align:center; font-weight:bold">
    <h4 style='padding-left:35px'>ASESMEN PASIEN JATUH KHUSUS DEWASA</h4><br>
    <h5 style='margin-top:-15px'><i>RISK FALL FOR ADULT</i></h5>
</div>
    ...
    <tr>
        <td colspan='12'>
            ...
            <b>Skor  :  0 -24  Tidak Ada Risiko (TR)<br>
                        25 -44 Resiko Rendah (RR)<br>
                        ≥ 45  Resiko Tinggi (RT)</b>
        </td>
    </tr>
    <tr>
        <td rowspan='13'>
