...
{    
    ...
    public $pegawai_nama,$nama_pj,$antrian_nama,$alamat_pj,$hubungankeluarga,$no_mobile_pasien;
    public $no_rekam_medik,$propinsi_nama,$kabupaten_nama,$kecamatan_nama;
    public $nama_pasien,$kabupaten_id,$kecamatan_id,$kelurahan_id,$kelurahan_nama;
    public $jeniskelamin;
    public $instalasi_nama, $ruangan_nama, $kelaspelayanan_nama, $alamat_pasien;
    /**
