...
class RJGambartubuhM extends GambartubuhM
{
	...
	public function getFileNameGambar(){
		$model = RJGambartubuhM::model()->find('gambartubuh_aktif = true AND ispemeriksaanfisik IS TRUE ORDER BY gambartubuh_urutan ASC');
    ...
    public function getAllDataGambarAnatomi() {
        $model = RJGambartubuhM::model()->findAll('gambartubuh_aktif = true AND ispemeriksaanfisik IS TRUE ORDER BY gambartubuh_urutan ASC');
		return $model;
    }
    
    public function getAllDataGambarRonggaMulut() {
        $model = RJGambartubuhM::model()->findAll('gambartubuh_aktif = true AND isronggamulut IS TRUE ORDER BY gambartubuh_urutan ASC');
		return $model;
    }
}