...
{
	public $jmlstok,$therapiobat_id, $is_obatkronis, $obatalkes_kode, $satuan, $penjualanresep_id, $permintaan_temp, $obatalkes_nama, $jumlahpermintaan_obatnonracikan, $jumlahpermintaan_obatracikan, $sumberdana_nama;
	/**
