...
//                $instalasi_id=array(PARAMS::INSTALASI_ID_RJ,PARAMS::INSTALASI_ID_RI,PARAMS::INSTALASI_ID_RD);
    ...
    public function searchDialogPasienRekonsiliasiOA() {
          // Warning: Please modify the following code to remove attributes that
          // should not be searched.
          ...
          $criteria->compare('LOWER(statusperiksa)', strtolower($this->statusperiksa), true);
          // $criteria->addInCondition("statusperiksa",array(Params::STATUSPERIKSA_SEDANG_PERIKSA,Params::STATUSPERIKSA_SUDAH_PULANG, Params::STATUSPERIKSA_ANTRIAN, Params::STATUSPERIKSA_SEDANG_DIRAWATINAP, Params::STATUSPERIKSA_SUDAH_DIPERIKSA, Params::STATUSPERIKSA_NUNGGU_DAFTAR_SO));
          $criteria->compare('LOWER(no_pendaftaran)', strtolower($this->no_pendaftaran), true);
          $criteria->compare('LOWER(no_rekam_medik)', strtolower($this->no_rekam_medik), true);
          $criteria->compare('LOWER(nama_pasien)', strtolower($this->nama_pasien), true);
          $criteria->compare('LOWER(jeniskelamin)', strtolower($this->jeniskelamin), true);
