...
class PemeriksaanFisikController extends MyAuthController {
     ...
     */
    public function actionIndex($pendaftaran_id = null, $id = null, $jnstransaksi = null, $is_triage = null, $notriage_pasien_id = null) {
        ...
        if(!empty($pendaftaran_id)) {
            ...
            $modPemeriksaanFisik = RJPemeriksaanFisikT::model()->findByAttributes(array('pendaftaran_id' => $pendaftaran_id), array('order' => 'tglperiksafisik DESC'));
            if(!empty($modPemeriksaanFisik) && $modPemeriksaanFisik != null){
                // $modPemeriksaanFisik = RJPemeriksaanFisikT::model()->findByAttributes(array('pendaftaran_id' => $pendaftaran_id), array('order' => 'tglperiksafisik DESC'));
                $modPemeriksaanFisik->keadaanumum = strip_tags($modPemeriksaanFisik->keadaanumum);
                // var_dump('as');die;
            ...
            $modPemeriksaanFisik->pemeriksaanfisik_id = null;
            ...
            if(Yii::app()->user->getState('kelompokpegawai_id') === Params::KELOMPOKPEGAWAI_ID_DOKTER_TETAP) {
                $modPemeriksaanFisik->pegawai_id = Yii::app()->user->getState('pegawai_id');
            } else {
                $modPemeriksaanFisik->pegawai_id = $modPendaftaran->pegawai_id;
                if(isset($_GET['pasienadmisi_id'])) {
                    $modPemeriksaanFisik->pegawai_id = $modPendaftaran->admisi->pegawai_id;
                }
            }
        ...
        if(empty($modPemeriksaanFisik->paramedis_nama) && Params::KELOMPOKPEGAWAI_ID_DOKTER_TETAP != Yii::app()->user->getState('kelompokpegawai_id')) {
        ...
        if (!empty($id)) {
            ...
            if(empty($modPemeriksaanFisik->ppds_id)) {
                $modPemeriksaanFisik->ppds_id =$modPendaftaran->ppds_id ?? "";
            }
            //ttv
            $modPemeriksaanFisik->denyutjantung = 'REGULER';
            // echo '<pre>';var_dump($modPemeriksaanFisik);die;
            //gcs
            // if ((empty($modPemeriksaanFisik->pemeriksaanfisik_id))) {
            //     $modPemeriksaanFisik->gcs_eye ='';
            //     $modPemeriksaanFisik->gcs_verbal ='';
            //     $modPemeriksaanFisik->gcs_motorik ='';
            // }           
            ...
            // echo '<pre>';var_dump($modPemeriksaanFisik);die;
            //pemeriksaan pasien rd
            if($modul_id == 6 && !isset($_GET['is_triage']) && empty($modPemeriksaanFisik->pendaftaran_id)) {

                // thorax
                $modPemeriksaanFisik->au_parurhkanan_1 = null;
                $modPemeriksaanFisik->au_parurhkiri_1 = null;
                
                $modPemeriksaanFisik->au_paruwhkanan_1 =null;
                $modPemeriksaanFisik->au_paruwhkiri_1 = null;
                
                $modPemeriksaanFisik->au_cardios1 = null;


                // kepala leher;
                $modPemeriksaanFisik->leher_mata = null;
                $modPemeriksaanFisik->leher_nasal = null;
                $modPemeriksaanFisik->leher_telinga = null;
                $modPemeriksaanFisik->leher_orofans = null;

                $modPemeriksaanFisik->leher_kelgetahbening_teraba = null;
                $modPemeriksaanFisik->leher_kelenjartiroid_teraba = null;
                $modPemeriksaanFisik->leher_lainlain = null;
                $modPemeriksaanFisik->leher_reflekpupil = null;
                $modPemeriksaanFisik->leher_jvp = null;
                $modPemeriksaanFisik->is_pilih = null;

                $modPemeriksaanFisik->au_parurhkanan_1 = $modPemeriksaanFisik->au_parurhkanan_2 = $modPemeriksaanFisik->au_parurhkanan_3 = null;
                $modPemeriksaanFisik->au_parurhkiri_1 = $modPemeriksaanFisik->au_parurhkiri_2 = $modPemeriksaanFisik->au_parurhkiri_3 = null;
            
                $modPemeriksaanFisik->au_paruwhkanan_1 = $modPemeriksaanFisik->au_paruwhkanan_2 = $modPemeriksaanFisik->au_paruwhkanan_3 = null;
                $modPemeriksaanFisik->au_paruwhkiri_1 = $modPemeriksaanFisik->au_paruwhkiri_2 = $modPemeriksaanFisik->au_paruwhkiri_3 = null;

                $modPemeriksaanFisik->au_cardios1 = $modPemeriksaanFisik->au_cardios2 = null;

            } else {
                $modPemeriksaanFisik->leher_mata = 'Normal';
                $modPemeriksaanFisik->leher_nasal = 'Normal';
                $modPemeriksaanFisik->leher_telinga = 'Normal';
                $modPemeriksaanFisik->leher_orofans = 'Normal';

                $modPemeriksaanFisik->leher_kelgetahbening_teraba = 0;
                $modPemeriksaanFisik->leher_lainlain = 'Normal';
            }
        ...
        if (isset($_POST['RJPemeriksaanFisikT'])) {
            ...
            try {
                // echo '<pre>';var_dump($transaction);die;
                $counjuctiva = '';
                $modPemeriksaanFisik = new RJPemeriksaanFisikT();
                $modPemeriksaanFisik->attributes = $_POST['RJPemeriksaanFisikT'];
                if(isset($_POST['RJPemeriksaanFisikT']['is_pilih'])) {
                    if(count($_POST['RJPemeriksaanFisikT']['is_pilih']) > 0) {
                        $counjuctiva = isset($_POST['RJPemeriksaanFisikT']['is_pilih']['val']) ? $_POST['RJPemeriksaanFisikT']['is_pilih']['val'] : '';
                    } 
                }
                if(!empty($pendaftaran_id)) {
                    $modPemeriksaanFisik->pendaftaran_id = $pendaftaran_id;
                }
                $modPemeriksaanFisik->conjuctiva = $counjuctiva;
                ...
                $cekTriage = NotriagePasienT::model()->findByAttributes(['pendaftaran_id' => $pendaftaran_id]);

                if(!empty($cekTriage)) {
                    $modPemeriksaanFisik->notriage_pasien_id = null;
                }
                ...
                if ($this->simpanpemeriksaanfisik && $this->simpanpemeriksaangambar && $ok) {
                    ...
                    if(isset($pendaftaran_id)) {
                        $this->redirect(array('index', 'pendaftaran_id' => $pendaftaran_id, 'id' => $modPemeriksaanFisik->pemeriksaanfisik_id, 'sukses' => 1));
                    } else {
        ...
        if (Yii::app()->user->getState('modul_id') == Params::MODUL_ID_REKAMMEDIS || isset($_GET['lihat'])) {
        ...
        else if (empty(Params::getModulRDRI(Yii::app()->user->getState('modul_id')))) {
            ...
            $this->render($this->path_view . 'indexDarurat2', array(
                'modPasien' => $modPasien,
                'modPemeriksaanFisik' => $modPemeriksaanFisik,
                'modPendaftaran' => $modPendaftaran,
                'modRJMetodeGSCM' => $modRJMetodeGSCM,
    ...
    public function actionIndexDarurat($pendaftaran_id = null, $id = null, $jnstransaksi = null, $is_triage = null, $notriage_pasien_id = null) {
        $format = new MyFormatter();
        $modBagianTubuh = new RJBagiantubuhM();
        $modGambarTubuh = new RJGambartubuhM();
        $modRJMetodeGSCM = RJMetodeGCSM::model()->findAll('metodegcs_aktif=TRUE ORDER BY metodegcs_id');
        ...
        if(isset($is_triage)){
            ...
            $tabelAnamnesaRD = RJPemeriksaanFisikT::model()->findAllByAttributes(array('notriage_pasien_id' => $notriage_pasien_id), array('order' => 'create_time DESC'));
            $tabelAnamnesaPasienRD = RJPemeriksaanFisikT::model()->findAllByAttributes(array('notriage_pasien_id' => $notriage_pasien_id), array('order' => 'create_time DESC'));
        ...
        if(!empty($pendaftaran_id)) {
            ...
            $modPemeriksaanttv = RJPemeriksaanFisikT::model()->findByAttributes(array('pendaftaran_id' =>$pendaftaran_id),array('order' =>'pendaftaran_id desc'));
        ...
        if (isset($_POST['RJPemeriksaanFisikT'])) {
            ...
            try {
                ...
                if ($this->simpanpemeriksaanfisik && $this->simpanpemeriksaangambar && $ok) {
                    ...
                    if(isset($pendaftaran_id)) {
                        $this->redirect(array('indexDarurat', 'pendaftaran_id' => $pendaftaran_id, 'id' => $modPemeriksaanFisik->pemeriksaanfisik_id));
                    } else {
                        $this->redirect(array('indexDarurat', 'is_triage' => $is_triage, 'notriage_pasien_id' => $notriage_pasien_id, 'id' => $modPemeriksaanFisik->pemeriksaanfisik_id, 'tipe' => 'sukses', 'sukses' => 1));
                    }
                } else {
                    //die;
                    $transaction->rollback();
    ...
    public function actionIndex2($jnstransaksi = null) {
        ...
        if(!empty($pemeriksaanfisik_id)) {
            ...
            $modPendaftaran = RJPendaftaranT::model()->with('jeniskasuspenyakit')->findByPk($pemeriksaanfisik_id);
            $modPasien = RJPasienM::model()->findByPk($pemeriksaanfisik_id ?? "");
            $modPpds = PpdsM::model()->findByPk($modPendaftaran->ppds_id ?? "");
            $cekPemeriksaanFisik = RJPemeriksaanFisikT::model()->findByPk(array('pemeriksaanfisik_id' => $pemeriksaanfisik_id ));
            $tabelPemeriksaan = RJPemeriksaanFisikT::model()->findAllByAttributes(array('pemeriksaanfisik_id' => $pemeriksaanfisik_id), array('order' => 'create_time DESC'));
            if(!empty($cekPemeriksaanFisik)) {
                $tabelPemeriksaanPasien = RJPemeriksaanFisikT::model()->findAllByAttributes(array('pemeriksaanfisik_id' => $pemeriksaanfisik_id), array('order' => 'create_time DESC'));
            } else {
                $tabelPemeriksaanPasien = null;
            }
            ...
            $konsul =  KonsulpoliT::model()->findByAttributes(array(
                'pendaftaran_id' => $pemeriksaanfisik_id ?? "",
                'ruangan_id' => Yii::app()->user->getState('ruangan_id'),
                    ), array(
                'order' => 'tglkonsulpoli desc',
            ));
            ...
            try {
                ...
                if ($this->simpanpemeriksaanfisik && $this->simpanpemeriksaangambar && $ok) {
                    ...
                    if(isset($pendaftaran_id)) {
                        ...
                        $this->redirect(array('index2', 'is_triage' => $is_triage, 'notriage_pasien_id' => $notriage_pasien_id, 'id' => $modPemeriksaanFisik->pemeriksaanfisik_id, 'tipe' => 'sukses'));
                    }
                } else {
                    //die;
                    $transaction->rollback();
    ...
    public function simpanPemeriksaanGambar($postperiksagbr, $modPemeriksaanFisik, $modGambarTubuh) {
        ...
        if (empty($postperiksagbr['pemeriksaangambar_id'])) {
            ...
            // echo '<pre>';var_dump($modPemeriksaanGambar);die;
    ...
    public function simpanPemeriksaanGambar2($postperiksagbr, $modPemeriksaanFisik, $modGambarTubuh) {
        $format = new MyFormatter;
        ...
        if (empty($postperiksagbr['pemeriksaangambar_id'])) {
         ...
         //   $modPemeriksaanGambar->pemeriksaangambar_id = $modGambarTubuh->DataGambarAnatomi->pemeriksaangambar_id; 
            
            $modPemeriksaanGambar->pendaftaran_id = isset($modPemeriksaanFisik->pendaftaran_id) ? $modPemeriksaanFisik->pendaftaran_id : "";
            $modPemeriksaanGambar->pasien_id = isset($modPemeriksaanFisik->pasien_id) ? $modPemeriksaanFisik->pasien_id : "";
            $modPemeriksaanGambar->tglpemeriksaan = date('Y-m-d H:i:s');
            $modPemeriksaanGambar->create_time = date('Y-m-d H:i:s');
            $modPemeriksaanGambar->create_loginpemakai_id = Yii::app()->user->id;
            $modPemeriksaanGambar->create_ruangan = Yii::app()->user->getState('ruangan_id');
            //  var_dump($modPemeriksaanGambar); die;
            if ($modPemeriksaanGambar->validate()) {
                return $modPemeriksaanGambar->save();
            } else {
                return false;
            ...
            if ($modPemeriksaanFisik->jnstransaksi == 'salin') {
                $modPemeriksaanGambar = RJPemeriksaangambarT::model()->findByPk($postperiksagbr['pemeriksaangambar_id']);
                $modPemeriksaanGambar->pemeriksaanfisik_id = isset($modPemeriksaanFisik->pemeriksaanfisik_id) ? $modPemeriksaanFisik->pemeriksaanfisik_id : "";
                unset($modPemeriksaanGambar->pemeriksaangambar_id);
                $modPemeriksaanGambar->IsNewRecord = true;
                return $modPemeriksaanGambar->save();
            } else {
    ...
    public function actionPrintPemeriksaanFisik2($notriage_pasien_id, $pemeriksaanfisik_id = null) {
        $this->layout = '//layouts/printWindows';
        $format = new MyFormatter;
        $modPemeriksaanFisik = RJPemeriksaanFisikT::model()->findByPk($notriage_pasien_id);
       // $modPendaftaran = RJPendaftaranT::model()->findByAttributes(array('pemeriksaanfisik_id'=>isset($notriage_pasien_id)));
        $modPasien = RJPasienM::model()->findByPk(isset($modPemeriksaanFisik->pasien_id));
        if (!empty($pemeriksaanfisik_id)) {
            $modPemeriksaanFisik = RJPemeriksaanFisikT::model()->findByAttributes(array('pemeriksaanfisik_id' => $pemeriksaanfisik_id));
            $modPemeriksaanGambar = RJPemeriksaangambarT::model()->findAllByAttributes(array('pemeriksaanfisik_id' => $pemeriksaanfisik_id));
        } else {
            $modPemeriksaanFisik = RJPemeriksaanFisikT::model()->findByAttributes(array('notriage_pasien_id' => $notriage_pasien_id));
            $modPemeriksaanGambar = RJPemeriksaangambarT::model()->findAllByAttributes(array('pendaftaran_id' => $notriage_pasien_id));
        }
        $modGambarTubuh = new RJGambartubuhM();
        $modBagianTubuh = new RJBagiantubuhM();
        if ((!empty($modPemeriksaanFisik->gcs_eye)) && (!empty($modPemeriksaanFisik->gcs_verbal)) && (!empty($modPemeriksaanFisik->gcs_motorik))) {
    ...
    public function actionGetMetodeGCS2() {
        if (Yii::app()->request->isAjaxRequest) {
            $gcs_eye = $_POST['gcs_eye'];
            $gcs_motorik = $_POST['gcs_motorik'];
            $gcs_verbal = $_POST['gcs_verbal'];
    ...
    public function actionGetBagianTubuhId() {
        ...
        //    $cr->compare('pemeriksaangambar_id', $pemeriksaangambar_id);
    ...
    public function actionAjaxDetailFisik() {
        if (Yii::app()->request->isAjaxRequest) {
            ...
            $modPasien = RJPasienM::model()->findByPk($modPemeriksaanFisik->pasien_id);
            $jumlah = 0;
            $hasil = null;
    ...
    public function actionAjaxDetailFisik2() {
        if (Yii::app()->request->isAjaxRequest) {
            $idFisik = $_POST['idFisik'];
            $notriage_pasien_id = $_POST['notriage_pasien_id'];
            $modPendaftaran = NotriagePasienT::model()->findByPk($notriage_pasien_id);
            $modPemeriksaanFisik = RJPemeriksaanFisikT::model()->findByPk($idFisik);

            // echo '<pre>'; var_dump($idFisik); die;
           // $modPasien = RJPasienM::model()->findByPk($modPemeriksaanFisik->pasien_id);
            $jumlah = 0;
            $hasil = null;
            $gcs_eye = isset($modPemeriksaanFisik->gcs_eye)?$modPemeriksaanFisik->gcs_eye :"" ;
            $gcs_motorik = isset($modPemeriksaanFisik->gcs_motorik)?$modPemeriksaanFisik->gcs_motorik :"";
            $gcs_verbal = isset($modPemeriksaanFisik->gcs_verbal)?$modPemeriksaanFisik->gcs_verbal :"";
            $modPemeriksaanGambar = RJPemeriksaangambarT::model()->findAllByAttributes(array('pemeriksaanfisik_id' => $idFisik));
            $modGambarTubuh = !empty($modPemeriksaanGambar) ? RJGambartubuhM::model()->findByPk($modPemeriksaanGambar[0]->gambartubuh_id) : new RJGambartubuhM;
            $modBagianTubuh = new RJBagiantubuhM();
            $jumlah = (int)$gcs_eye + (int)$gcs_motorik + (int)$gcs_verbal;
            $namaGCS = GcsM::model()->find('' . $jumlah . '>=gcs_nilaimin AND ' . $jumlah . '<=gcs_nilaimax AND gcs_aktif=TRUE');
            if (!empty($namaGCS)) { //Jika Nilai GCSnya ada
                $hasil = $namaGCS->gcs_nama;
            } else {
            ...
            $data['result'] = $this->renderPartial($this->path_view . '_viewDetailFisik2', array(
                'modPemeriksaanFisik' => $modPemeriksaanFisik,
                'modPendaftaran' => $modPendaftaran,
                'hasil' => $hasil,
                'idFisik'=>$idFisik,
    ...
    function actionSetGambarTubuh() {
        $jeniskelamin = $_POST['jeniskelamin'];
        $modGambarTubuh = new RJGambartubuhM();
        $data['html'] = $this->renderPartial($this->path_view . 'pemeriksaan/rd/_formGambarPilihan', ['modGambarTubuh' => $modGambarTubuh, 'jeniskelamin' => $jeniskelamin], true);
