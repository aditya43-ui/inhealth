...
class RehabMedisController extends MyAuthController
{
  ...
  public function actionIndex($pendaftaran_id, $idPasienKirimKeUnitLain = null)
  {
    ...
    $modRiwayatKirimKeUnitLain = RJPasienKirimKeUnitLainT::model()->findAllByAttributes(
      ...
      'pasienmasukpenunjang_id IS NULL and ruangan_id in (1252, 1253, 1255, 1254, 272)'
    );
  ...
  protected function savePasienKirimKeUnitLain($modPendaftaran)
  {
    ...
    $modKirimKeUnitLain->ruangan_id = isset($_POST['RJPasienKirimKeUnitLainT']['ruangan_idhidden']) ? $_POST['RJPasienKirimKeUnitLainT']['ruangan_idhidden'] : Params::RUANGAN_ID_REHABMEDIS;
  ...
  protected function savePermintaanPenunjang($permintaan, $modKirimKeUnitLain)
  {
    ...
    foreach ($permintaan['inputtindakanrm'] as $i => $value) {
      ...
      $modPermintaan->tarif_pelayananan = $permintaan['inputtariftindakanrm'][$i];
  ...
  public function actionLoadFormPermintaanRehabMedis()
  {
    if (Yii::app()->request->isAjaxRequest) {
      ...
      $modTindakanRm = Tindakanrm::model()->findByPk($tindakanrm_id);
      ...
      if (!empty($modTarif)) {
        echo CJSON::encode(array(
          'status' => 'create_form',
          'tindakanruanganrm' => $modTindakanRm->ruangan->ruangan_nama,
          'ruangan_id' => $modTindakanRm->ruangan_id,
