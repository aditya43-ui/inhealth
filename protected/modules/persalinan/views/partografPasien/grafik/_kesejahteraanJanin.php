...
<?php Yii::app()->clientScript->registerScriptFile(Yii::app()->baseUrl . '/js/chart.min.js', CClientScript::POS_HEAD); ?>
    ...
    <div>
        <div style="width: 1000px; height: 200px; padding-left: 22px; padding-right: 2px;">
            <canvas id="grafik_janin"></canvas>

        </div>
        <br/>
        <div style="width: 1000px;">
            <div style="padding-right: 8px; padding-left: 170px;">
...
<script>
    ...
    $(document).ready(function () {
        var ctx = document.getElementById('grafik_janin').getContext('2d');
        ctx.height = 200;
