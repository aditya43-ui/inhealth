...
<script>
  ...
  function generateGrafik(){
        ...
        $("#partograf-kontrol > tbody > tr").each(function(){
            //djj
            if ($(this).find(".kontrol-waktu").val() != '' && $(this).find(".kontrol-djj").val() != ''){
                arr[i] ={ 
                    x: '<?php echo date("Y-m-d", strtotime($model->tglperiksa)); ?> '+$(this).find(".kontrol-waktu").val(),
                    y: $(this).find(".kontrol-djj").val()
            ...
            //pembukaan serviks
            if ($(this).find(".kontrol-waktu").val() != '' && $(this).find(".kontrol-serviks").val() != ''){
                arrServiks[j] ={ 
                    x: '<?php echo date("Y-m-d", strtotime($model->tglperiksa)); ?> '+$(this).find(".kontrol-waktu").val(),
                    y: $(this).find(".kontrol-serviks").val()
            ...
            //turunya kepala
            if ($(this).find(".kontrol-waktu").val() != '' && $(this).find(".kontrol-kepala").val() != ''){            
                arrTurun[k] ={ 
                    x: '<?php echo date("Y-m-d", strtotime($model->tglperiksa)); ?> '+$(this).find(".kontrol-waktu").val(),
                    y: $(this).find(".kontrol-kepala").val()
            ...
            //kontraksi jumlah
            if ($(this).find(".kontrol-waktu").val() != '' && $(this).find(".kontrol-kontraksijml").val() != ''){            
                arrKontraksi[l] ={ 
                    x: '<?php echo date("Y-m-d", strtotime($model->tglperiksa)); ?> '+$(this).find(".kontrol-waktu").val(),
                    y: $(this).find(".kontrol-kontraksijml").val()
            ...
            //kontraksi lama
            if ($(this).find(".kontrol-waktu").val() != '' && $(this).find(".kontrol-kontraksilama").val() != ''){            
                if ($(this).find(".kontrol-kontraksilama").val() == '<?php echo Params::PARTOGRAF_KONTRAK_KURANG ?>'){
                    var color = 'blue';
                }else if ($(this).find(".kontrol-kontraksilama").val() == '<?php echo Params::PARTOGRAF_KONTRAK_SD ?>'){
                    var color = 'red';
                }else if ($(this).find(".kontrol-kontraksilama").val() == '<?php echo Params::PARTOGRAF_KONTRAK_LEBIH ?>'){
                    var color = '#b7b7b7';
                }
            ...
            //suhu
            if ($(this).find(".kontrol-waktu").val() != '' && $(this).find(".kontrol-suhu").val() != ''){            
                arrSuhu[n] ={ 
                    x: '<?php echo date("Y-m-d", strtotime($model->tglperiksa)); ?> '+$(this).find(".kontrol-waktu").val(),
                    y: $(this).find(".kontrol-suhu").val()
            ...
            //garis tekanan darah
            if ($(this).find(".kontrol-waktu").val() != '' && $(this).find(".kontrol-diastolic").val() != '' && $(this).find(".kontrol-systolic").val() != ''){            
                arrAnno[r] ={ 
                    type: 'box',
                    drawTime: 'beforeDatasetsDraw',                            
                    xScaleID: 'x-axis-0',
                    yScaleID: 'A',
                    xMin: '<?php echo date("Y-m-d", strtotime($model->tglperiksa)); ?> '+$(this).find(".kontrol-waktu").val(),
                    xMax: '<?php echo date("Y-m-d", strtotime($model->tglperiksa)); ?> '+$(this).find(".kontrol-waktu").val(),
                    yMax: parseInt($(this).find(".kontrol-diastolic").val()),
                    yMin:  parseInt($(this).find(".kontrol-systolic").val()),
                    borderColor: '#ED3237',
                    borderWidth: 4,
