...
$this->beginWidget('zii.widgets.jui.CJuiDialog', array( // the dialog
    ...
    $instalasi_id_pilih = $modDialogKunjungan->instalasi_id;
    if ($instalasi_id_pilih == Params::INSTALASI_ID_RI) {
        $instalasi_id_pilih = Params::grupInstalasiRIID();
    }


    $prov = $modDialogKunjungan->searchDialogKunjungan2();
        ...
        array(
            ...
            'value'=>function($data) use ($controller_id) {
                ...
                return CHtml::Link('<i class="icon-form-check"></i>',"javascript:void(0);",array(
                    ...
                    "onclick" => "
                        setKunjungan($data->pendaftaran_id, '', '', '', $data->instalasi_id, $data->penjamin_id, '".$data->tglalokasi."');
