...
<?php echo $this->renderPartial('application.views.headerReport.headerLaporanTransaksi',array('judulLaporan'=>$judulLaporan, 'judulFont'=>3)); ?>
<?php
    $a = 0;
    $subsidiasuransi =0;
    $subsidirs = 0;
...
<table width="100%" cellpadding="0" cellspacing="0" border="0" class="grid">
    ...
    ?>
        ...
        <tr>
            ...
            <td colspan="4" align="right"  class="border"><b>Tanggungan Asuransi :</b></td>
            <td align="right" class=""><b><?php if (isset($subsidiasuransi)) { echo MyFormatter::formatNumberForPrint($subsidiasuransi);} ?></b></td>
        </tr>
        <tr>
            <td colspan="6"></td>
            <td colspan="4" align="right"  class="border"><b>Tanggungan Rumah Sakit :</b></td>
            <td align="right" class="border"><b><?php if (isset($subsidirs)) { echo MyFormatter::formatNumberForPrint($subsidirs);} ?></b></td>
        </tr>
        <tr>
            <td colspan="6"></td>
            <td colspan="4" align="right" class="border"><b>Tanggungan Pemerintah :</b></td>
            <td align="right" class="border"><b><?php if (isset($subsidipemerintah)) { echo MyFormatter::formatNumberForPrint($subsidipemerintah);} ?></b></td>
        </tr>
        <tr>
            <td colspan="6"><?php echo $data['nama_pegawai']; ?></td>
            <td colspan="4" align="right" class="border" style="border-bottom: 1px solid #333;"><b>Tangungan Pasien :</b></td>
            <td align="right" class="border" style="border-bottom: 1px solid #333;"><b><?php if (isset($subsidirs)) { echo MyFormatter::formatNumberForPrint($total_tagihan - ($subsidiasuransi + $subsidirs + $subsidipemerintah)); } else { echo MyFormatter::formatNumberForPrint($total_tagihan); } ?></b></td>
        </tr>
    <?php
        }else{
    ?>
        ...
        <tr>
            <td colspan="10" align="right" class="border"><b>Tanggungan Asuransi :</b></td>
            <td align="right" class="border"><b><?php echo MyFormatter::formatNumberForPrint($subsidiasuransi); ?></b></td>
        </tr>
        <tr>
            <td colspan="10" align="right" class="border"><b>Tanggungan Rumah Sakit :</b></td>
            <td align="right" class="border"><b><?php echo MyFormatter::formatNumberForPrint($subsidirs); ?></b></td>
        </tr>
        <tr>
            <td colspan="10" align="right" class="border"><b>Tanggungan Pemerintah :</b></td>
            <td align="right" class="border"><b><?php echo MyFormatter::formatNumberForPrint($subsidipemerintah); ?></b></td>
        </tr>
        <tr>
            <td colspan="10" align="right"  style="border-bottom: 1px solid #333;"><b>Tangungan Pasien :</b></td>
