...
<table style="width: 100%; border: none;">
    ...
    <tr>
        <td>Tgl. Resep</td>
        <td>: <?php echo MyFormatter::formatDateTimeForUser($model->penjualanresep->tglresep);?></td>
        <td>Umur</td>
...
//        <td style='text-align: center;'>".$data->obatpasien->qty_oa."</td>
    ...
    <tr style='border:1px solid;'>
        ...
        <td style='text-align: center;'><?php echo MyFormatter::formatNumberForPrint($totalSubTotal); ?></td>
    </tr>
    </tbody>
</table>
<br>
<table>
    ...
    <tr><td>Petugas Farmasi</td><td></td></tr>
    <tr><td>&nbsp;</td></tr>
    <tr><td>&nbsp;</td></tr>
