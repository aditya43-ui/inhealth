<div class="row-fluid">
	<div class="col-sm-6">
		<div class="control-group">		
			...
			<div class="controls">
				<div id="tgl_admisi" class="daterange daterange-inline input-inline" data-format="MMMM D, YYYY" data-start-date="<?php echo date('F d, Y', strtotime($model->tgl_awal_admisi)) ?>" data-end-date="<?php echo date('F d, Y', strtotime($model->tgl_akhir_admisi)) ?>" hidden>
					<i class="entypo-calendar"></i>
					<span ><?php echo date('F d, Y', strtotime($model->tgl_awal_admisi)) ?> - <?php echo date('F d, Y', strtotime($model->tgl_akhir_admisi)) ?></span>
	...
	<div class="col-sm-6">
            ...
            /*
            echo $form->dropDownListRow($model,'ruanganakhir_id', CHtml::listData($model->getRuanganItems(Params::INSTALASI_ID_RI), 'ruangan_id', 'ruangan_nama'),array(
                'class'=>'span3',
                'empty'=>'-- Pilih --', 
        ...
        <div class="control-group">
			<?php echo $form->label($model, 'Rencana Pulang', array('class'=>'control-label')); ?>
			<div class="controls">
				<?php echo $form->dropDownList($model,'rencana', array(1 => 'BELUM', 2 => 'SUDAH'),array('options' => array('2'=>array('selected'=>true))), array('empty'=>'-- Pilih --', 'class'=>'span3')); ?>
			</div>
		</div>
	</div>
</div>
