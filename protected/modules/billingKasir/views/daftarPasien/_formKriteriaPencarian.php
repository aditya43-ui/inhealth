	...
	<div class="col-sm-6">
		<div class="control-group">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?php echo $form->dropDownList($model,'ruangan_id', CHtml::listData($model->getRuanganItems(Params::INSTALASI_ID_RJ), 'ruangan_id', 'ruangan_nama'),array('class'=>'span3','empty'=>'-- Pilih --', 'onkeyup'=>"return $(this).focusNextInputField(event)")); ?>
                </div>
            </div>
            ...
            // echo $form->dropDownListRow($model,'statusperiksa', $sp,array('options' => array('SUDAH DI PERIKSA'=>array('selected'=>true))), array('empty'=>'-- Pilih --', 'class'=>'span3'));
