...
<div class="control-group">
    <?php echo $form->labelEx($model, 'notelp_penanggungjawab', array('class'=>'control-label', 'label'=>'No. Telp <span class="required">*</span>'))?>
    <div class="controls">
        <?php echo $form->textField($model, 'notelp_penanggungjawab', array(
            'class'=>'span3 numbers-only required',
            'onkeyup'=>"return $(this).focusNextInputField(event);",
            'readonly'=>false,
        )); ?>
    </div>
...
<div class="control-group">
    <?php echo $form->labelEx($model, 'nomobile_penanggungjawab', array('class'=>'control-label', 'label'=>'No. HP'))?>
    <div class="controls">
        <?php echo $form->textField($model, 'nomobile_penanggungjawab', array(
...
<div class="control-group">
    <?php echo $form->labelEx($model, 'catatan', array('class'=>'control-label', 'label'=>'Alasan'))?>
    <div class="controls">
