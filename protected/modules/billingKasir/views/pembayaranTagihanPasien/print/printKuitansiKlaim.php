...
<?php 
      ...
      WHERE piutangasuransi_id = ".$_GET['id'];
        $query= Yii::app()->db->createCommand($sql)->queryRow();
        $total = $query['jmlpiutangasuransi'];
?>
                                ...
                                <table cellspacing=0 width="100%">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="terbilang">
                                                <?php
                                                echo strtoupper($format->formatNumberTerbilang($total)) . ' RUPIAH';
                                                ?>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div align="center" style="border:1px solid #000000;width:200px;padding:5px;" class="uang">
                                                    Rp. <?php echo MyFormatter::formatNumberForPrint($total, 2); ?>,-
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
