...
if (!empty($admisi)) {
    ...
    $admisiTgl = date('Y-m-d H:i:s', strtotime($admisi->tgladmisi));
    $masukkamarTgl = (!empty($masukKamarPasien) ? date('Y-m-d H:i:s', strtotime($masukKamarPasien->tglmasukkamar)) : $admisiTgl);


    $admisiTgl = date('Y-m-d', strtotime($admisiTgl));    
    $masukkamarTgl = date('Y-m-d', strtotime($masukkamarTgl));


    $pulang = $admisi->rencanapulang ?? $modPembayaran->tglpembayaran; //empty($admisi->tglpulang) ? $admisi->rencanapulang : $admisi->tglpulang;
    ...
    $tgl_daftar = $modPendaftaran->tgl_pendaftaran;
    $tgl_pulang = $vpulang;
    ...
    <td width="50%">
      <table width="100%">
        ...
        <tr>
          ...
          <td>:</td>
          <td><?php echo empty($modPendaftaran->pasienadmisi_id)?$modPendaftaran->ruangan->ruangan_nama:$admisi->ruangan->ruangan_nama; ?></td>
        </tr>
        <tr>
          <td>KELAS</td>
          <td>:</td>
          <td><?php echo (isset($admisi)? (isset($admisi->kelaspelayanan) ? $admisi->kelaspelayanan->kelaspelayanan_nama: ""): (isset($modPendaftaran->kelaspelayanan)? $modPendaftaran->kelaspelayanan->kelaspelayanan_nama: "")); ?></td>
        </tr>
        <tr>
          <td>JENIS PEMBAYARAN</td>
          <td>:</td>
          <td><?php echo (isset($admisi)? (isset($admisi->carabayar) ? $admisi->carabayar->carabayar_nama: ""): (isset($modPendaftaran->carabayar)? $modPendaftaran->carabayar->carabayar_nama: "")); ?></td>
        </tr>
      </table>
    </td>
    <td width="50%">
