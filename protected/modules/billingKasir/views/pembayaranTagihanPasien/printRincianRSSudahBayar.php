                        ...
                        <tfoot>
                            ...
                            <?php if ($modPembayaran->totalpembebasan > 0): ?>
                                <tr>
                                    ...
                                    <td></td>
                                    <td></td>
                                    <td align='right' style="font-weight:bold;"><?php echo $format->formatNumberForPrint($modPembayaran->totalpembebasan,0); ?></td>
                                </tr>
                            <?php endif; ?>
                            <?php if ($modPembayaran->total_inacbg != 0 || $modPembayaran->totalsubsidiasuransi != 0): ?>
                                <tr>
                                    ...
                                    <td></td>
                                    <td></td>
                                    <td align='right' style="font-weight:bold;"><?php echo $format->formatNumberForPrint((!empty($modPembayaran->total_inacbg)? $modPembayaran->total_inacbg : $modPembayaran->totalsubsidiasuransi),0); ?></td>
                                </tr>
                            <?php endif; ?>
                            <?php if ($modPembayaran->totalsubsidirs > 0): ?>
                                <tr>
                                    ...
                                    <td></td>
                                    <td></td>
                                    <td align='right' style="font-weight:bold;"><?php echo $format->formatNumberForPrint($modPembayaran->totalsubsidirs,0); ?></td>
                                </tr>
                            <?php endif; ?>
                            <?php if ($jml_uangmuka > 0): ?>
                                <tr>
                                    ...
                                    <td></td>
                                    <td></td>
                                    <td align='right' style="font-weight:bold;"><?php echo $format->formatNumberForPrint($jml_uangmuka,0); ?></td>
                                </tr>
                            <?php endif; ?>
                            <?php
                            if ($modAlokasi->carabayar_id == Params::CARABAYAR_ID_BPJS && !empty($modAlokasi->total_inacbg) && $modAlokasi->total_inacbg > 0) { ?>
                                <tr>
                                    <!-- <td colspan='2' align='right' style="font-weight:bold;">Dibayar Oleh Pasien</td> -->
                                    <td colspan='2' style="font-weight:bold;">Inacbg Kelas Pelayanan</td>
                                    <!--<td></td>-->
                                    <td></td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
                                    <td align='right' style="font-weight:bold;"><?php echo $format->formatNumberForPrint($modAlokasi->totalinacbg_naikkelasperawatan,0); ?></td>
                                </tr>
                                <tr>
                                    <!-- <td colspan='2' align='right' style="font-weight:bold;">Dibayar Oleh Pasien</td> -->
                                    <td colspan='2' style="font-weight:bold;">Inacbg Kelas Tanggungan</td>
                                    <!--<td></td>-->
                                    <td></td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
                                    <td align='right' style="font-weight:bold;"><?php echo $format->formatNumberForPrint($modAlokasi->total_inacbg,0); ?></td>
                                </tr>
                            <?php }
                            ?>
                            <?php 
                            ...
                            if ($modPembayaran->totaliurbiaya > 0): ?>
                                <tr>
                                    <!-- <td colspan='2' align='right' style="font-weight:bold;">Dibayar Oleh Pasien</td> -->
