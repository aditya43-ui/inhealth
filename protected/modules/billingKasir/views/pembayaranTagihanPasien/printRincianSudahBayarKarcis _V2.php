...
<table width="100%" class="tab_detail">
    ...
    <tbody>
        ...
        <tr style="height: 50px;"></tr>
                            ...
                            <tr>
                                <td>Terbilang</td>
                                <td >: # <?php echo MyFormatter::kataTerbilang($subtotalkotor);?> #</td>
                            ...
                            <tr>
                                ...
                                <td style="text-align: left;">:</td>
                                <td style="text-align: center;" ><?php echo MyFormatter::formatNumberForPrint($tandabukti->biayaadministrasi,2); ?></td>
                            </tr>
                            <tr>
                                <td></td>
                                <td ></td>
        ...
        <tr class="closing footee">
            <td colspan="9"hidden>INA <?php echo $kelas->kelaspelayanan_nama; ?></td><td style="text-align: right;"><?php echo MyFormatter::formatNumberForPrint($modSubsidi->subsidiasuransi,2); ?></td>
        </tr>
        <?php //}
        ...
        ?>
            ...
            <tr class="grand_total footee"hidden>
                <td colspan="9">Total Embalase</td><td style="text-align: right;"><?php echo MyFormatter::formatNumberForPrint($modPembayaran->total_embalase,2); ?></td>
            </tr>
            <?php endif; ?>
...
<table width = "50%">
    <tr>
        <td></td>
        <td>Jaminan : <?php echo MyFormatter::formatNumberForPrint($modPembayaran->totalsubsidiasuransi);
        // var_dump($modPembayaran)?></td>
    </tr>
    <tr style="height: 100px; border:1px solid;">
        ...
        <td>
            <p><?php echo "Tunai" .":".MyFormatter::formatNumberForPrint($tandabukti->uangditerima);?></p>
            <?php $modJenis = JenispembayaranT::model()->findAllByAttributes(array('tandabuktibayar_id'=>$tandabukti->tandabuktibayar_id));
