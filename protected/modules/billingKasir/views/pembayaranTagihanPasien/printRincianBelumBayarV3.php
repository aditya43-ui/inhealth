...
?>
<div class="judulcontent" style="text-align: center; font-weight: bold;">Rincian Tagihan <?php echo $is_rsb == 1 ? "" : "Sementara"; ?></div>
...
foreach ($modRincians2 as $item) {
    ...
    */
    ...
    if (empty($grp[$item->ruangan_id]['content'][$idx_line])) {
        ...
        $grp[$item->ruangan_id]['content'][$idx_line]['total_lunas'] += $total_lunas;
...
if($modInstalasi->instalasi_id == Params::INSTALASI_ID_RI || $modInstalasi->instalasi_id == Params::INSTALASI_ID_PERSALINAN || $modInstalasi->instalasi_id == Params::INSTALASI_ID_PI ){
    $grand_totals = $subtotalKotor // + $admin1 
    + $jasafarmasi + $totalembalase;
}else{
...
<table width="100%" class="rincian" >
    <thead >
        ...
        <th style='border-right: 1px solid;text-align: center;' <?= $is_rsb == 1 ? 'hidden' : '' ?>>Nota</th>
        ...
        <th style='border-right: 1px solid;text-align: center;' hidden>Keringanan</th>
        ...
        <th style='border-right: 1px solid; text-align: center;'>Jumlah</th>
        <th style='text-align: center;' <?= $is_rsb == 1 ? 'hidden' : '' ?>>Keterangan</th>
    </thead>
    <tbody>
        ...
        <tr>
            ...
            <tr >
                ...
                <td <?= $is_rsb == 1 ? 'hidden' : '' ?>><?php echo $item2['no_nota']; ?></td>
                <td hidden><?php
                ...
                <td style="text-align: right;"><?php echo $item2['is_akomodasi'] ? "" : MyFormatter::formatNumberForPrint($item2['harga'],2); ?></td>
                <td style="text-align: right;" hidden><?php echo MyFormatter::formatNumberForPrint($item2['jmldiskon'],2); ?></td>
                ...
                <td style="text-align: center;" <?= $is_rsb == 1 ? 'hidden' : '' ?>><?php 
                if (trim($item2['subtotalKotor']) - trim($item2['total_lunas']) == 0) {
                    ...
                    $total_lunas += $item2['subtotalKotor'];
                } else {
                    echo "-";
                    $total_belum_lunas += $item2['subtotalKotor'];
                }
                ?></td>
            </tr>
            ...
            <?php endforeach; ?>
            <tr>
            <td colspan="<?= $is_rsb == 1 ? 4 : 5 ?>" style="text-align: right;"><b>Subtotal <?php //echo $item['nama']; ?></b></td>
        ...
        ?>
                        <tr style="height: 50px;"></tr>
                            ...
                            <tr>
                                ...
                                <td colspan="<?= $is_rsb == 1 ? 1 : 2 ?>"style="text-align: right;"> Total(Rp)</td>
                                <td style="text-align: left;">:</td>
                                <td style="text-align: center;"><?php echo MyFormatter::formatNumberForPrint($subtotalKotor) ; ?></td>
                            </tr>
                            <?php if ($total_lunas > 0 && $is_rsb != 1): ?>
                            <tr>
                                <td></td>
                                <td ></td>
                                <td colspan="2"style="text-align: right;"> Total Lunas(Rp)</td>
                                <td style="text-align: left;">:</td>
                                <td style="text-align: center;" ><?php echo MyFormatter::formatNumberForPrint($total_lunas, 0); ?></td>
                            </tr>
                            <?php endif; ?>
                            <?php if ($total_belum_lunas > 0 && $is_rsb != 1): ?>
                            <tr>
                                <td></td>
                                <td ></td>
                                <td colspan="2"style="text-align: right;"> Total Belum Lunas(Rp)</td>
                                <td style="text-align: left;">:</td>
                                <td style="text-align: center;" ><?php echo MyFormatter::formatNumberForPrint($total_belum_lunas, 0); ?></td>
                            </tr>
                            <?php endif; ?>
                            <tr style="height: 50px;"></tr>
                            <?php /*
                            <tr>
                                ...
                                <td style="text-align: left;">:</td>
                                <td style="text-align: center;" ><?php echo MyFormatter::formatNumberForPrint($subr, 0); ?></td>
                            </tr>
...
?>
<table width = "40%" <?= $is_rsb == 1 ? 'hidden' : '' ?>>
    <tr style="height: 20px; border-top:1px solid;border-right:1px solid; border-left:1px solid;">
        ...
        <td style="text-align: right;" ><?php echo MyFormatter::formatNumberForPrint($total_belum_lunas); ?></td>
    </tr>
    ...
    <tr style="height: 20px; border-bottom:1px solid;border-right:1px solid; border-left:1px solid;">
        ...
        <td style="text-align: right;" ><?php echo MyFormatter::formatNumberForPrint($total_belum_lunas - $total); ?></td>
    </tr>
</table>
<br/><br/><br/>
<table width = "40%" <?= $is_rsb == 1 ? 'hidden' : '' ?>>
...
<table width='100%' <?= $is_rsb == 1 ? 'hidden' : '' ?>>
                        <tr hidden>
                            <td></td>
...
<table width = "50%" class="belumLunas" hidden>
    <tr>
        <td>
...
?>
     ...
     */
    function print(){
        window.open("<?php echo Yii::app()->createUrl("billingKasir/PembayaranTagihanPasien/PrintRincianBelumBayar", array("instalasi_id"=>$_GET['instalasi_id'], "pendaftaran_id"=>$_GET['pendaftaran_id'], "pasienadmisi_id"=>(isset($_GET['pasienadmisi_id']) ? $_GET['pasienadmisi_id'] : null), 'is_rsb'=>$is_rsb)) ?>","",'location=_new, width=1024px');
    }
    </script>
