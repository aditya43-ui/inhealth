...
?>
	...
	function printExcel(){
		...
		?>
				window.open("<?php echo Yii::app()->createUrl("billingKasir/pembayaranTagihanPasien/PrintRincianSudahBayarFarmasi&caraPrint=EXCEL", array("pembayaranpelayanan_id"=>$_GET['pembayaranpelayanan_id'])) ?>","",'location=_new, width=1024px');
		<?php
			}else{
		?>
