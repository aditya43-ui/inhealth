...
<table width="100%" class="tab_detail">
    ...
    <tbody>
        <?php foreach ($grp as $item) : ?>
            ...
            ?>
                <tr>
                    ...
                    <td style="text-align: center;"><?php echo MyFormatter::formatNumberForPrint($item2['jml'], 2); ?></td>
        ...
        <!-- <tr hidden>
            ...
            <td style="text-align: left;">:</td>
            <td style="text-align: center;" ><?php //echo MyFormatter::formatNumberForPrint($modPembayaran->totalpembebasan,2); 
                                                ?></td>
        </tr>
        <tr hidden>
            <td></td>
            ...
            <td style="text-align: left;">:</td>
            <td style="text-align: center;" ><?php //echo MyFormatter::formatNumberForPrint($tandabukti->jmlpembulatan,2); 
                                                ?></td>
        </tr> -->
        <?php //endif; 
        ?>
        ...
        <!-- <tr style="border-top:1px solid #333;" class="footee" hidden>
            ...
            <td style="text-align: right;"><?php //echo MyFormatter::formatNumberForPrint($diskon,2); 
                                            ?></td>
            <td style="text-align: right;" class=""><?php //echo MyFormatter::formatNumberForPrint($suba,0); 
                                                    ?></td>
            <td style="text-align: right;" class="hddn"><?php //echo MyFormatter::formatNumberForPrint($subp,2); 
                                                        ?></td>
            <td style="text-align: right;" class=""><?php //echo MyFormatter::formatNumberForPrint($subr,2); 
                                                    ?></td>
            <td style="text-align: right;" class="hddn"><?php //echo MyFormatter::formatNumberForPrint($subtotal,2); 
                                                        ?></td>
            <td style="text-align: right;"><?php //echo MyFormatter::formatNumberForPrint($subtotalkotor,0); 
                                            ?></td>
        </tr> -->
        ...
        ?>
            ...
            <!-- <?php //if ($grand_totals != 0) : 
                    ?>
            <tr class="closing footee" hidden>
                <td colspan="9">Total Tagihan</td><td style="text-align: right;"><?php //echo MyFormatter::formatNumberForPrint($grand_totals,2); 
                                                                                    ?></td>
            </tr> -->
            <?php //endif; 
            ?>
            ...
            <?php if ($modPembayaran->total_inacbg != 0 || $modPembayaran->totalsubsidiasuransi != 0) : ?>
                <!-- <tr class="closing footee" hidden>
                    <td colspan="9">Total Tanggungan Asuransi</td><td style="text-align: right;"><?php //echo MyFormatter::formatNumberForPrint((!empty($modPembayaran->total_inacbg)? $modPembayaran->total_inacbg : $modPembayaran->totalsubsidiasuransi),0); 
                                                                                                    ?></td>
                </tr> -->
            <?php endif; ?>
            ...
            <!-- <tr class="closing footee" hidden>
                <td colspan="9">Dibayar Oleh Pasien</td><td style="text-align: right;"><?php //echo MyFormatter::formatNumberForPrint($modPembayaran->totaliurbiaya, 0); 
                                                                                        ?></td>
            </tr> -->
...
<table width="50%">
    <tr>
        ...
        <?php if ($modPembayaran->total_inacbg != 0) : ?>
            <td>Jaminan :
                <?php echo MyFormatter::formatNumberForPrint($modPembayaran->total_inacbg + $tandabukti->biayaadministrasi); ?>
            </td>
        <?php endif; ?>
        <?php if ($modPembayaran->total_inacbg == 0 && $modPembayaran->totalsubsidiasuransi != 0) { ?>
