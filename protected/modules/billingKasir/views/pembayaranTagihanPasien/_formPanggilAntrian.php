<?php $form_antrian=$this->beginWidget('ext.bootstrap.widgets.BootActiveForm',array(
	...
	<div class = "span12">
            ...
            <?php echo $form_antrian->hiddenField($modAntrian,'modelantrian_id',array('class'=>'span3', 'onkeyup'=>"return $(this).focusNextInputField(event);")); ?>
            ...
            <div style="width: 100%; text-align: center; font-size: 30px; font-weight: bold;">
                <?php echo (empty($modAntrian->ruangan_id) ? "X" : $modAntrian->modelantrian->modelantrian_singkatan)."-".(empty($modAntrian->noantrian) ? "0000" : $modAntrian->noantrian); ?>
            </div>
