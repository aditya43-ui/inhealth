<div class="panel panel-success">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="glyphicon glyphicon-file"></i> Form <b>Pembayaran</b>
        </div>
    </div>
    <div class="panel-body">
        ...
        <div class="col-sm-6">
            <div class="control-group">
                ...
                <div class="controls">
                    <?php   
                            if (empty($modTandabukti->tglbuktibayar)) {
                                $modTandabukti->tglbuktibayar = date('Y-m-d H:i:s');
                            }
                            
                            $modTandabukti->tglbuktibayar = MyFormatter::formatDateTimeForUser($modTandabukti->tglbuktibayar);
            ...
            <?php /*
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        echo CHtml::textField('totTagihan',$modPengeluaran->totalharga,array('readonly'=>true,'class'=>'inputFormTabel integer2 span3', 'onkeypress'=>"return $(this).focusNextInputField(event);")) ?>
                    </div><!--total taginan-->
                </div>
                 * 
                 */ ?>
