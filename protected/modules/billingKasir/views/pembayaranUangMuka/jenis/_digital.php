<div class="panel_jenispembayaran panel_jenispembayaran_digital">
    ...
    <div class="control-group">
        <?php echo CHtml::activeLabel($modJenis, 'nostruk', array('class'=>'control-label', 'label'=>'No. Transaksi <span class="required">*</span>')); ?>
        <div class="controls">
            <?php echo CHtml::activeTextField($modJenis, '[detail]['.$i.']nostruk', array('class'=>'span3 nostruk required')); ?>
        </div>
    </div>
    <div class="control-group">
        <?php echo CHtml::activeLabel($modJenis, 'noreferensi', array('class'=>'control-label', 'label'=>'No. Referensi <span class="required">*</span>')); ?>
        <div class="controls">
