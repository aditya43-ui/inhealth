<div class = "span6">
    <div class="control-group">
        <?php echo CHtml::label("Subsystem", 'instalasi_id', array('class'=>'control-label')); ?>
        <div class="controls">
            <?php
            if(!empty($modKunjungan->pendaftaran_id)){
                ...
                echo CHtml::dropDownList('instalasi_id',$modKunjungan->instalasi_id,CHtml::listData(BKInstalasiM::model()->getInstalasiPelayananRawat(),'instalasi_id','instalasi_nama'),array('onchange'=>'setKunjunganReset();refreshDialogKunjungan();','class'=>'span3','onkeyup'=>"return $(this).focusNextInputField(event)",)); 
            }
            ?>
        </div>
    </div>
