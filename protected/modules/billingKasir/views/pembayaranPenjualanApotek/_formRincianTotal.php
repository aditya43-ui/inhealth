...
<table class="table table-bordered table-striped table-condensed">
    <thead>
        ...
        <th>Total INACBG / Subsidi Asuransi <br>(Rp.)</th>
    ...
    <tfoot>
        ...
        <td>
			...
			<?php echo CHtml::textField('tot_subsidiasuransi_semua',0,array('onblur'=>'proporsiSubsidiAsuransiSemua();','readonly'=>true,'style'=>'width:100px;','class'=>'inputFormTabel lebar3 span2 integer-decimal', 'title'=>'Total Subsidi Asuransi', 'onkeyup'=>"return $(this).focusNextInputField(event);")) ?></td>
        ...
        <td><?php echo CHtml::textField('tot_iurbiaya_semua',0,array('onblur'=>'proporsiTanggunganRsSemua();','readonly'=>true,'style'=>'width:100px;','class'=>'inputFormTabel lebar3 span2 integer-decimal','onkeyup'=>"return $(this).focusNextInputField(event);")) ?></td>
				<td hidden><?php echo CHtml::textField('tot_jmlselisihbpjs_semua',0,array('readonly'=>true,'style'=>'width:100px;','class'=>'inputFormTabel lebar3 span2 integer-decimal','onkeyup'=>"return $(this).focusNextInputField(event);")) ?></td>
