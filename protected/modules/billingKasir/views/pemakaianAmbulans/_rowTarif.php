            ...
            <div class="col-sm-6">
                ...
                <div class="dokter-lengkap" style="display:none;">
                    <?php $this->widget('MyJuiAutoComplete',array(
                                ...
                                'htmlOptions'=>array('placeholder'=>'bidan','onkeyup'=>"return $(this).focusNextInputField(event)", 'class'=>'span3 autocomplete-dokter','style'=>'float:left;',
                    ...
                    <?php $this->widget('MyJuiAutoComplete',array(
                                ...
                                'htmlOptions'=>array('placeholder'=>'suster','onkeyup'=>"return $(this).focusNextInputField(event)", 'class'=>'span3 autocomplete-dokter','style'=>'float:left;',
                    ...
                    <?php $this->widget('MyJuiAutoComplete',array(
                                ...
                                'htmlOptions'=>array('placeholder'=>'perawat','onkeyup'=>"return $(this).focusNextInputField(event)", 'class'=>'span3 autocomplete-dokter','style'=>'float:left;',
