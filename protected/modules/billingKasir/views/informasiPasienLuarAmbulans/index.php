...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="entypo-info-circled"></i> Informasi <b>Rincian Tagihan Pasien Luar Ambulans</b>
        </div>
    </div>
    <div class="panel-body">
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                ...
                $this->beginWidget('zii.widgets.jui.CJuiDialog', array( // the dialog
                    'id' => 'dialogPembayaran',
                    'options' => array(
                        'title' => 'Pembayaran Tagihan Pasien Ambulans',
                        'autoOpen' => false,
                        'modal' => true,
                        'width' => 1200,
                        'height' => 500,
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="entypo-credit-card"></i> Tabel <b>Rincian Tagihan Pasien Luar Ambulans</b>
                </div>
            </div>
            <div class="panel-body table-responsive">
                ...
                <?php $this->widget('ext.bootstrap.widgets.BootGroupGridView', array(
                    ...
                    'dataProvider' => $model->searchRincianTagihanAmbulans(),
                    //	'filter'=>$model,
                    'template' => "{summary}\n{items}\n{pager}",
                    ...
                    'columns' => array(
                        ...
                        array(
                            ...
                            'value' => '(empty($data->totaltagihan)) ? "0" : MyFormatter::formatNumberForPrint($data->totaltagihan)',
...
$this->beginWidget('zii.widgets.jui.CJuiDialog', array( // the dialog
    ...
    'options' => array(
        'title' => 'Rincian Tagihan Pasien Ambulans',
        'autoOpen' => false,
        'modal' => true,
        'width' => 800,
        'height' => 500,
