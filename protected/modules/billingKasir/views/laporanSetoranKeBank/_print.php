...
if ($caraPrint != 'GRAFIK')
$this->renderPartial('_tableBaru', array('model'=>$model, 'modDetail'=>$modDetail,'caraPrint'=>$caraPrint, 'data'=>$data,'rincianUang'=>$rincianUang)); 

if ($caraPrint == 'GRAFIK')
echo $this->renderPartial('_grafik', array('model'=>$model, 'data'=>$data, 'caraPrint'=>$caraPrint), true);  /*
?>
<p style="text-align: center;"><b>Terbilang : <?php //echo MyFormatter::formatNumberTerbilang($model->getTotal()); ?></b></p>
<br>
<br>
