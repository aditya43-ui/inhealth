<div class="col-sm-6">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <?php echo CHtml::checkBox('berdasarkanMasterOa', false, array('onclick' => 'setValue(this);', 'rel' => 'tootip', 'title' => 'Ceklis Jika Ingin Menampilkan Semua Data Obat dan Alkes dari Master', 'onkeypress' => "return $(this).focusNextInputField(event)")) ?>
...
<div class="col-sm-6">
    <div class="control-group">
        ...
        <div class="controls">
            <?php echo CHtml::textField('qty_input', '1', array('readonly' => false, 'onblur' => '$("#qty").val(this.value);', 'onkeyup' => "return $(this).focusNextInputField(event)", 'class' => 'span1 numbers-only', 'style' => 'text-align:right;width:50px;')) ?>
        </div>
        <div class="controls">
...
$this->beginWidget('zii.widgets.jui.CJuiDialog', array( // the dialog
    ...
    'options' => array(
        'title' => 'Master Obat dan Alkes Supplier "<span id="suppliernama"></span>"',
        'autoOpen' => false,
        'modal' => true,
        'width' => 980,
        'height' => 600,
...
$this->widget('ext.bootstrap.widgets.BootGridView', array(
    ...
    'columns' => array(
        ...
        array(
            ...
            'value' => '$data->satuankecil->satuankecil_nama',
            'filter' => CHtml::activeDropDownList($modObatAlkes, 'satuankecil_id', CHtml::listData(
                SatuankecilM::model()->findAll(array('condition' => 'satuankecil_aktif = true', 'order' => 'satuankecil_nama asc')),
                'satuankecil_id',
                'satuankecil_nama'
            ), array('empty' => '-- Pilih --')),
        ),
