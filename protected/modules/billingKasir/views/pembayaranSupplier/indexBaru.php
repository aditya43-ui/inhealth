...
<script type="text/javascript">
    ...
    function hitungTotal() {
        ...
        $('#tblBayarOA tbody tr').each(function() {
            ...
            totppnterima += (rpppn * jmlterima);
            totpphterima += (rppph * jmlterima);
            ...
            $(this).find('input[name$="[persenppnfaktur]"]').val((ppn));
            $(this).find('input[name$="[persenpphfaktur]"]').val((pph));
            $(this).find('input[name$="[hargasatuan]"]').val(Math.floor((subhpp)));
            $(this).find('input[name$="[jmlppn]"]').val(Math.floor(rpppn));
        });
        //alert(total);
        $("#BKBayarkeSupplierT_totaltagihan").val(Math.floor(totbruto) - sudahbayar);
        $("#BKBayarkeSupplierT_jmldibayarkan").val(Math.floor(totbruto) - sudahbayar);
        //alert(totdisterima);
        $("#<?php echo CHtml::activeId($modFakturBeli, 'jmldiskonasli') ?>").val(Math.floor(totdisterima));
        $('#<?php echo CHtml::activeId($modFakturBeli, 'totharganetto'); ?>').val(Math.floor(totnettqty));
        $('#<?php echo CHtml::activeId($modFakturBeli, 'totalpajakppn'); ?>').val(Math.floor(totppnterima));
        $('#<?php echo CHtml::activeId($modFakturBeli, 'totalpajakpph'); ?>').val(Math.floor(totpphterima));
        $('#<?php echo CHtml::activeId($modFakturBeli, 'jmldiscount'); ?>').val(Math.floor(totdisterima));
        $('#<?php echo CHtml::activeId($modFakturBeli, 'totalhargabruto'); ?>').val(Math.floor(totbruto));
    ...
    function setHPP(obj) {
        ...
        if (hpp == 0) {
            ...
            if (parseInt(diskonpersen) == 100) {
                ...
                //alert(harganetto);
                $(obj).parents("tr").find('input[name$="[harganettofaktur]"]').val(Math.round(harganetto));
