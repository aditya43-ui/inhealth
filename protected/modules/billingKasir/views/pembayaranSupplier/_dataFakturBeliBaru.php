...
<div class="row">
    <div class="col-sm-6">
		...
		<div class="control-group">			
            ...
            <div class="controls">
                <?php 
                echo CHtml::activeTextField($modFakturBeli, 'nofaktur', array('readonly'=>true,'onblur'=>'ubahNoFaktur(this);'));
//				if (!isset($_GET['frame'])){
...
//				}
        ...
        <div class="control-group">
            ...
            <div class="controls">		
                    <?php echo CHtml::textField('FAPendaftaranT[umur_hutang]', !empty($modFakturBeli->syaratbayar)? $modFakturBeli->syaratbayar->syaratbayar_nama : '', array('readonly'=>true)); ?>
            </div>
        </div>
        <div class="control-group">
            <?php echo CHtml::label("Keterangan Faktur", '',array('class'=>'control-label')); ?>
            <div class="controls">		
                    <?php echo CHtml::textField('FAPendaftaranT[umur_hutang]', $modFakturBeli->keteranganfaktur, array('readonly'=>true)); ?>
            </div>
        </div>
        <div class="control-group">
...
<!--		<div id="sudahadapembayaran" hidden>
	...
	<div class="col-sm-6">
            <?php echo $form->textFieldRow($modFakturBeli,'totharganetto', array('class'=>'span3 integer-decimal','readonly'=>TRUE, 'onkeyup'=>"return $(this).focusNextInputField(event)")) ?>
            <div class="control-group">
                <label class='control-label'>
                        Total Keringanan
              </label>
                <div class="controls">
                    <?php echo $form->textField($modFakturBeli,'jmldiscount', array('class'=>'span3 integer-decimal','readonly'=>true, 'onblur'=>'setPersenDisFaktur(this);hitungTotalFaktur()')); ?>
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?php echo $form->textField($modFakturBeli,'totalpajakppn', array('class'=>'span3 integer-decimal','readonly'=>true, 'onkeyup'=>"return $(this).focusNextInputField(event)", 'onblur' => 'hitungTotalFaktur()')) ?>
                </div>
            </div>
            <div class="control-group">
                <label class='control-label'>
                ...
                <div class="controls">
                        <?php echo $form->textField($modFakturBeli,'totalpajakpph', array('class'=>'span3 integer-decimal','readonly'=>true, 'onkeyup'=>"return $(this).focusNextInputField(event)", 'onblur' => 'hitungTotalFaktur()')) ?>
                </div>
            </div>
<div class="control-group">
                <label class='control-label'>
                ...
                <div class="controls">
                     <?php echo $form->textField($modFakturBeli,'totalhargabruto', array('class'=>'span3 integer-decimal','readonly'=>TRUE,'onkeyup'=>"return $(this).focusNextInputField(event)")) ?>
                </div>
            </div>
...
<!--			<div class="control-group">
			...
			<div class="control-group">
				<?php // echo CHtml::label("Total Diskon",'',array('class' => 'control-label')) ?>
				<div class="controls">
