    ...
    <div class="col-md-12">
        <div class="panel panel-gradient">
            <div class="panel-heading">
                <div class="panel-title">Transaksi <strong>Order Batal Pembayaran</strong></div>
            </div>
            <div class="panel-body">
                ...
                <div class="panel panel-success">
                    <div class="panel-heading">
                        <div class="panel-title">Tabel <strong>Order Batal Pembayaran Pelayanan</strong></div>
                    </div>
                    <div class="panel-body" style="overflow-x: auto;">
                        <?php echo $this->renderPartial($this->path_view."_tabDetail", array(
