...
$this->widget('ext.bootstrap.widgets.BootGridView', array(
    ...
    'dataProvider' => $modDialogPasien->searchDialogKunjunganBatalVerifikasi(),
        ...
        array(
            ...
            'value' => function ($data) {
                ...
                return CHtml::Link('<i class="icon-form-check"></i>', 'javascript:void(0);', array(
                    ...
                    'onClick' => 'isiDataPasien(' . $res . '); loadPembayaran(' . $data->pendaftaran_id . '); $("#dialogPasien").dialog("close"); return false;'
                ));
            },
        ),
        array(
        ...
        array(
            ...
            'filter' => CHtml::activeDropDownList($modDialogPasien, 'ruangan_id', CHtml::listData(
                RuanganM::model()->findAllByAttributes(array(
                    'instalasi_id' => $modDialogPasien->instalasi_id,
                    'ruangan_aktif' => true,
...
<script type="text/javascript">
    ...
    function loadPembayaran(pendaftaran_id, penjualanresep) {
        ...
        <?php $tindakanParam = ',tindakan : 1, is_batal: 1'; ?>
        $.post('<?php echo Yii::app()->createUrl('billingKasir/ActionAjax/loadPembayaranBatalVerifikasi'); ?>', {
            ...
            console.log('load pembayaran tindakan');
            setTimeout(function() {
                if (is_load) {
            ...
            // $('#tblBayarTind tbody').find('td').eacn(function (idx, val) {
            //     $(this).find('#no_urut').val(idx + 1);
            // });
