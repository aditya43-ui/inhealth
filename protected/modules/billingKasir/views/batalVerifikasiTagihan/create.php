...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="glyphicon glyphicon-briefcase"></i> Transaksi <b>Order Batal Verifikasi Tagihan</b>
    ...
    <div class="panel-body">
        ...
        $this->breadcrumbs = array(
            'Transaksi Order Batal Verifikasi Tagihan',
        );
        ...
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                <div class="search-form">
                    ...
                    <?php
                    $this->renderPartial(
                        'billingKasir.views.batalVerifikasiTagihan._ringkasDataPasien',
                        array(
        ...
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                        ...
                        <table id="tblBayarTind" class="table table-bordered table-striped table-condensed">
                            <thead>
                                <tr>
                                    ...
                                    <th width="80">Order Batal<br/>Verifikasi</th>
                                    <th width="80">Tanggal</th>
                                    <th hidden>Uraian Tindakan</th>
                                    <th>No Nota</th>
                                    <th width="100" hidden>Nominal Tarif</th>
                                    <!--<th width="100">Ruangan</th>-->
                                    <th width="100" hidden>Jumlah</th>
                                    ...
                                    <th width="100" hidden>Sub Total</th>
                                    <th width="100">Uraian Tindakan</th>
                                </tr>
                            </thead>
                            <tbody></tbody>
                        </table>
                ...
                <?php echo CHtml::htmlButton(
                    ...
                    array('title' => 'Simpan', 'class' => 'btn btn-primary', 'type' => 'button', 'onclick' => "simpanSemuaCeklisVerifikasi('tblBayarTind')")
                ); ?>
            </div>
        </div>
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                ...
                <?php echo CHtml::htmlButton(
                    Yii::t('mds', 'Simpan', array('{icon}' => '<i class="entypo-search"></i>')),
                    array('title' => 'Simpan', 'class' => 'btn btn-primary', 'type' => 'button', 'onclick' => "simpanSemuaCeklisVerifikasi('tblBayarOA')")
                ); ?>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function cekTotalSemuaTind(obj) {

        var nopelayanan = $(obj).closest('tr').find('.nopel').val();

        if($(obj).is(':checked')) {
            $('.nopel[value="' + nopelayanan + '"]').each(function () {
                $(this).closest('tr').find('.pilih-tin').prop('checked', true);
            });
        } else {
            $('.nopel[value="' + nopelayanan + '"]').each(function () {
                $(this).closest('tr').find('.pilih-tin').prop('checked', false);
            });
        }
...
//                myAlert("Uang diterima tidak boleh kurang dari jumlah pembayaran");
    ...
    */
    ...
    function simpanSemuaCeklisVerifikasi(table_id) {

        var cek = 0;
       
       $('#' + table_id + ' .pilih-cek').each(function(key, val) {
            if($(this).is(":checked")) {
       ...
       if(cek > 0 && ok) {
           myAlert('Data Telah Berhasil Di Order Verifikasi!');
       }

       // console.log(cek);
       // loadPembayaran($('#FAPendaftaranT_pendaftaran_id').val());
