...
<table class="tab_detail">
    ...
    <tbody>
        ...
        foreach ($tindakan as $item) :
            ...
            $subtotal = $item->tarif_tindakan - ($item->discount_tindakan + $item->subsidiasuransi_tindakan + $item->subsisidirumahsakit_tindakan);
            $tot_diskon += $item->discount_tindakan;
            $tot_asuransi += $item->subsidiasuransi_tindakan;
            $tot_rs += $item->subsisidirumahsakit_tindakan;
            $tot_iur += $subtotal;
            $tot_subtotal += $item->tarif_tindakan;
            $total += $item->qty_tindakan;
        ?>
            <tr>
                <td><?php echo $tgl; ?></td>
                <td>
                    <?= $tindakan->noNota; //$tindakan->pendaftaran->no_pendaftaran . $tindakan->nopelayanan ?>
                </td>
                <td>
                ...
                <td hidden>
                    <table>
                        ...
                        <tbody>
                            ...
                            // echo '<pre>';
                            foreach ($item->komponenTindakan as $komponen) :
                ...
                <td style="text-align: right;" hidden><?php echo MyFormatter::formatNumberForPrint($item->discount_tindakan); ?></td>
                <td style="text-align: right;" hidden><?php echo MyFormatter::formatNumberForPrint($item->subsidiasuransi_tindakan); ?></td>
                <td style="text-align: right;" hidden><?php echo MyFormatter::formatNumberForPrint($item->subsisidirumahsakit_tindakan); ?></td>
