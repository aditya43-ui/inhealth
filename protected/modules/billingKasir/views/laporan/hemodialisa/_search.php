<div class="search-form">
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <?php
            echo CHtml::hiddenField('filter', 'asal', array('disabled' => 'disabled')) .
                '<div class="control-group">
    ' . CHtml::label('Asal', 'asal', array('class' => 'control-label')) . ' 
    <div class="controls">
        ' . $form->dropDownList($model, 'asal', array('rs' => ProfilrumahsakitM::model()->findByPk(Params::getDefaultProfilRS())->nama_rumahsakit, 'rujukan' => 'Rujukan'), array(
    ...
    <div class="controls">
        ' . $form->dropDownList($model, 'curabayar_id', CHtml::listData(CarabayarM::model()->findAll('carabayar_aktif = true'), 'carabayar_id', 'carabayar_nama'), array(
                    'class' => 'form-control', 'multiple' => 'multiple'
                )) . '
    </div>
</div>
