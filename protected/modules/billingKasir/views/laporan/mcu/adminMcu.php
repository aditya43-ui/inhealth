<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="entypo-newspaper"></i> Laporan <b>MCU</b>
        </div>
    </div>
    <div class="panel-body">
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                ...
                <fieldset class="box search-form">
                    <?php
                    $this->renderPartial(
                        'billingKasir.views.laporan.mcu/_search',
                        array(
        ...
        <div class="panel panel-success">
            ...
            <div class="panel-body table-responsive">
                ...
                $this->widget('bootstrap.widgets.BootMenu', array(
                    ...
                    'items' => array(
                        array('label' => 'Transaksi MCU', 'url' => 'javascript:tab(0);', 'itemOptions' => array("index" => 0), 'active' => true,),
                        array('label' => 'Rekap / Pasien', 'url' => 'javascript:tab(1);', 'itemOptions' => array("index" => 1)),
                        array('label' => 'MCU Per-Registrasi', 'url' => 'javascript:tab(2);', 'itemOptions' => array("index" => 2)),
                    ),
                ))
                ?>
                <div class="biru" id="div_reportTranasksi">
                    ...
                    <div class="white">
                        <?php
                        $this->renderPartial(
                            'billingKasir.views.laporan.mcu/_tableTransaksi',
                            array(
                                'model' => $model
                            )
                        );
                ...
                <div class="biru" id="div_rekap">
                    ...
                    <div class="white">
                        <?php
                        $this->renderPartial(
                            'billingKasir.views.laporan.mcu/_tableRekap',
                            array(
                                'model' => $model
                            )
                        );
                ...
                <div class="biru" id="div_per_registrasi">
                    ...
                    <div class="white">
                        <?php
                        $this->renderPartial(
                            'billingKasir.views.laporan.mcu/_tablePerRegistrasi',
                            array(
                                'model' => $model
                            )
                        );
        ...
        <div class="form-actions">
            ...
            $urlPrint =  Yii::app()->createAbsoluteUrl($module . '/' . $controller . '/printLaporanMcu');
