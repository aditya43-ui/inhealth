...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="entypo-newspaper"></i> Laporan <b>Keseluruhan</b>
        </div>
    </div>
    <div class="panel-body">
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                <?php
                $this->renderPartial('billingKasir.views.laporan.keseluruhan/_searchKeseluruhan', array('model' => $model,));
                ?>
            </div>
        </div>
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="entypo-credit-card"></i> Tabel <b>Keseluruhan</b>
                </div>
            </div>
            <div class="panel-body table-responsive search-form">
                <?php
                $this->renderPartial(
                    'billingKasir.views.laporan.keseluruhan/_tableKeseluruhan',
                    array(
                        'model' => $model
                    )
                );
