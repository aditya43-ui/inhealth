<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="entypo-newspaper"></i> Laporan <b>Radiologi</b>
        </div>
    </div>
    <div class="panel-body">
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="entypo-credit-card"></i> Tabel <b>Radiologi</b>
                </div>
            </div>
            <div class="panel-body table-responsive">
                ...
                $this->widget('bootstrap.widgets.BootMenu', array(
                    ...
                    'items' => array(
                        array('label' => 'Transaksi Radiologi', 'url' => 'javascript:tab(0);', 'itemOptions' => array("index" => 0), 'active' => true,),
                        array('label' => 'Rekap / Pasien', 'url' => 'javascript:tab(1);', 'itemOptions' => array("index" => 1)),
                        array('label' => 'Radiologi Per-Registrasi', 'url' => 'javascript:tab(2);', 'itemOptions' => array("index" => 2)),
                    ),
                ))
                ?>
                <div class="biru" id="div_reportTranasksi">
                    ...
                    <div class="white">
                        <?php
                        $this->renderPartial(
                            'billingKasir.views.laporan.radiologi/_tableTransaksi',
                            array(
                                'model' => $model
                            )
                        );
                ...
                <div class="biru" id="div_rekap">
                    ...
                    <div class="white">
                        <?php
                        $this->renderPartial(
                            'billingKasir.views.laporan.radiologi/_tableRekap',
                            array(
                                'model' => $model
                            )
                        );
                ...
                <div class="biru" id="div_per_registrasi">
                    ...
                    <div class="white">
                        <?php
                        $this->renderPartial(
                            'billingKasir.views.laporan.radiologi/_tablePerRegistrasi',
                            array(
                                'model' => $model
                            )
                        );
        ...
        <div class="form-actions">
            ...
            $urlPrint =  Yii::app()->createAbsoluteUrl($module . '/' . $controller . '/printLaporanRad');
