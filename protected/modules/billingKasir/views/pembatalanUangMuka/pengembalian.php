	...
	<div class="col-md-12">
		<div class="panel panel-gradient">
			<div class="panel-heading">
				<div class="panel-title">Transaksi Pengembalian <strong>Uang Muka</strong></div>
			</div>
			<div class="panel-body">
				...
				<div class="panel panel-success">
					<div class="panel-heading">
						<div class="panel-title">Data Pengembalian</div>
					</div>
					<div class="panel-body">
						<div class="row-fluid">
							<div class="col-sm-6">
                  ...
                  <?php echo $form->labelEx($modBatal,'tglpembatalan',array('class'=>'control-label','label'=>'Tanggal Pengembalian'));?>
									<div class="controls">
										<?php
                ...
                <div class="control-group">
                    <?php echo CHtml::label('Total Uang Muka', '', array('class' => 'control-label')) ?>
                    <div class="controls">
						<?php echo $form->textField($modBatal,'total_uangmuka',array('class'=>'span3 integer-decimal req','onkeypress'=>"return $(this).focusNextInputField(event);",'readonly'=>true)); ?>
                    </div>
                </div>
				<div class="control-group">
                    <?php echo CHtml::label('Pemakaian Uang Muka', '', array('class' => 'control-label')) ?>
                    <div class="controls">
						<?php echo $form->textField($pemakaianUangMuka,'pemakaianuangmuka',array('class'=>'span3 integer-decimal','onkeypress'=>"return $(this).focusNextInputField(event);",'readonly'=>true)); ?>
                    </div>
                </div>
				<div class="control-group">
                    <?php echo CHtml::label('Sisa Uang Muka', '', array('class' => 'control-label')) ?>
                    <div class="controls">
						<?php echo $form->textField($pemakaianUangMuka,'sisauangmuka',array('class'=>'span3 integer-decimal','onkeypress'=>"return $(this).focusNextInputField(event);",'readonly'=>true)); ?>
                    </div>
                </div>
