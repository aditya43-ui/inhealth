...
<div class="panel panel-primary panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="entypo-info-circled"></i> Informasi Pembatalan Uang Muka
        </div>
    </div>
    <div class="panel-body">
        ...
        <div class="panel panel-success panel-shadow">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="entypo-credit-card"></i> Tabel <strong>Order Batal Pembayaran Uang Muka</strong>
                </div>
            </div>
            <div class="panel-body">
...
<script>
    function confirmBatal(id) {
        ...
        myConfirm("Anda yakin untuk order batal pembayaran uang muka?", "Peringatan", function(r) {
            if (r) {
