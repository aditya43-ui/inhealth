    ...
    <div class="col-md-12">
        <div class="panel panel-gradient">
            <div class="panel-heading">
                <div class="panel-title">Pembayaran <strong>Tagihan Pasien Penjaminan</strong></div>
            </div>
...
<script>
    ...
    $('input, select, textarea').not('#BKTandabuktibayarT_uangditerima, #BKTandabuktibayarT_darinama_bkm, #BKInformasikasirrawatjalanV_items, #no_pendaftaran').attr('readonly', true);
