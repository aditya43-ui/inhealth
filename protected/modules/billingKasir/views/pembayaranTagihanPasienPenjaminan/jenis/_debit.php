...
<div class="panel_jenispembayaran panel_jenispembayaran_debit">
    <!-- <div class="control-group">
        <?php //echo CHtml::activeLabel($modJenis, 'bank', array('class' => 'control-label', 'label' => 'Bank Pengirim', 'required' => true)); ?>
        <div class="controls">
    ...
    <div class="control-group">
        <?php echo CHtml::activeLabel($modJenis, 'nokartu', array('class' => 'control-label', 'label' => 'No Kartu / Rekening Pengirim', 'required' => true)); ?>
        <div class="controls">
            <?php echo CHtml::activeTextField($modJenis, '[detail][' . $i . ']nokartu', array('class' => 'span3 nokartu')); ?>
        </div>
    </div>
    <div class="control-group" hidden>
        <?php echo CHtml::activeLabel($modJenis, 'nostruk', array('class' => 'control-label', 'label'=>'No. Bukti Transfer / Transaksi')); ?>
        <div class="controls">
    ...
    <div class="control-group">
        <?php echo CHtml::activeLabel($modJenis, 'bankpenerima_id', array('class' => 'control-label', 'label'=>'Bank Penerima', 'required' => true)); ?>
        <div class="controls">
            <?php
