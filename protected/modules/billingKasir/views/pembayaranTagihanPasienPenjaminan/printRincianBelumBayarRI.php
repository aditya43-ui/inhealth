...
?>
<div class="judulcontent" style="text-align: center; font-weight: bold;">RINCIAN TAGIHAN</div>
...
<table width="100%" class="rincian">
    <thead>
        ...
        <th style='text-align: center;'>Jumlah Yang Harus Dibayar</th>
    </thead>
    <tbody>
        ...
        <tr>
            ...
            <tr>
                ...
                <td style="text-align: right;"><?php echo MyFormatter::formatNumberForPrint($item2['suba'],2); ?></td>
