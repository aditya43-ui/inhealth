...
function setAsuransiKelas() {
    ...
    function setAlokasiDana() {
        ...
        $.post('<?php echo $this->createUrl('loadAlokasiDana'); ?>', {
            ...
            $("#BKPembayaranpelayananT_totalbiayatindakan").val(formatThousandDecimal(data.totalbiayatindakan));
            $("#BKPembayaranpelayananT_totalbiayaoa").val(formatThousandDecimal(data.totalbiayaoa));
            $("#BKPembayaranpelayananT_totalbiayapelayanan").val(formatThousandDecimal(data.totalbiayapelayanan));
            $("#BKTandabuktibayarT_jmlpembayaran").val(formatThousandDecimal(data.totalbiayapelayanan));
            $("#BKPembayaranpelayananT_total_inacbg").val(formatThousandDecimal(data.total_inacbg));
            $("#BKPembayaranpelayananT_totalsubsidiasuransi").val(formatThousandDecimal(data.totalsubsidiasuransi));
            $("#BKPembayaranpelayananT_totaliurbiaya").val(formatThousandDecimal(data.totaliurbiaya));
