                            ...
                            <td align="center" valig="middle" colspan="3">
                                <table align="center" cellspacing=0 width="100%">
                                    <tbody>
                                        ...
                                        if(!empty($tindakanSudahBayar)) {
                                            if(count($tindakanSudahBayar) > 1) {
                                                $bayar_td = $tindakanSudahBayar[0]->daftartindakan->daftartindakan_nama . ', DLL';
                                            } else {
                                                $bayar_td = $tindakanSudahBayar[0]->daftartindakan->daftartindakan_nama;
                                            }
                                        }
                                        ?>
                                        <!--tr>
