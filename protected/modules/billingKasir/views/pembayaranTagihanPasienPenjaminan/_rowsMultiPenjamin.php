<tr>
	...
	<td>
		<?php echo CHtml::activeTextField($modPiutangAsuransi,'[ii]jmlpiutangasuransi',array('readonly'=>true,'class'=>'span2 integer-decimal', 'onkeypress'=>"return $(this).focusNextInputField(event);")); ?>
