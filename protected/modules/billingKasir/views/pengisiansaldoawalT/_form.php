...
<div class='row'>
    <div class="col-sm-6">
        <div class="control-group">
            ...
            <div class="controls">
                ...
                $this->widget('MyDateTimePicker', array(
                    ...
                    'htmlOptions' => array(
                        'onchange' => 'resetTgl(this);', 'readonly' => true, 'class' => 'span3 dtPicker3 realtime',
        ...
        <div class="control-group">
            <?php echo CHtml::label('Shift<span class="required">*</span>', '', array('class' => 'required control-label')); ?>
            <div class="controls">
    ...
    <div class="col-sm-6">
        ...
        <div class="control-group">
            <?php echo CHtml::label('Nilai Saldo Awal <span class="required">*</span>   Rp', '', array('class' => 'control-label')); ?>
            <div class="controls">
                <?php echo $form->textField($model, 'nilaisaldoawal', array('placeholder' => 'Nilai Saldo Awal', 'class' => 'span3 inputFormTabel integer-decimal reqForm', 'onkeypress' => "return nextFocus(this,event,'btn_simpan','SACaraBayarM_carabayar_namalainnya')", 'maxlength' => 50)); ?>
            </div>
        </div>
        <div class="control-group">
            <?php echo CHtml::label('Keterangan', '', array('class' => 'control-label')); ?>
            <div class="controls">
                <?php echo $form->textArea($model, 'keterangan', array('placeholder' => 'Keterangan', 'class' => 'span3', 'rows' => 4, 'onkeypress' => "return nextFocus(this,event,'btn_simpan','SACaraBayarM_carabayar_namalainnya')", 'maxlength' => 50)); ?>
            </div>
        </div>
    </div>
</div>
...
<div class="form-actions">
    <?php echo CHtml::htmlButton(
        $model->isNewRecord ? Yii::t('mds', '{icon} Create', array('{icon}' => '<i class="fa fa-check"></i>')) :
    ...
    ?>
    <?php
    // echo CHtml::link(Yii::t('mds', '{icon} Pengaturan Pengisian Saldo', array('{icon}'=>'<i class="icon-folder-open icon-white"></i>')),$this->createUrl('/billingKasir/pengisiansaldoawalT/Admin',array('modul_id'=> Yii::app()->session['modul_id'])), array('class'=>'btn btn-success'));
    ?>
</div>
<?php $this->endWidget(); ?>
<?php
