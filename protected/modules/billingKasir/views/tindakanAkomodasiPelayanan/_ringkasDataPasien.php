            ...
            <div class="controls">
                ...
                if (!empty($modPendaftaran->instalasi_id)) {
                    ...
                    echo CHtml::dropDownList(
                        ...
                        array(Params::INSTALASI_ID_RI => "INSTALASI RAWAT INAP"), 
...
$modDialogPasien->instalasi_id = Params::INSTALASI_ID_RI;
...
$this->widget('ext.bootstrap.widgets.BootGridView', array(
    ...
    'dataProvider' => $modDialogPasien->searchDialogKunjunganAkomodasi(),
        ...
        array(
            ...
            'value' => function ($data) {
                ...
                return CHtml::Link('<i class="icon-form-check"></i>', 'javascript:void(0);', array(
                    ...
                    'onClick' => 'cekValidasiPJA(' . $res . '); $("#dialogPasien").dialog("close"); return false;'
                ));
            },
        ),
        array(
...
<script type="text/javascript">
    ...
    function cekValidasiPJA(data) {
        // cek validasi pja sudah dilakukan apa belum
        $.post('<?= $this->createUrl('cekValidasiPJA') ?>', {
    ...
    function isiDataPasien(data) {
        ...
        setFrameTindakanAkomodasi(data.pendaftaran_id, data.pasienadmisi_id);

    }

    function setFrameTindakanAkomodasi(pendaftaran_id, pasienadmisi_id) {

        // console.log("SET", pendaftaran_id, pasienadmisi_id);

        $(".biru").prop('src', '<?php echo $this->createUrl("/rawatInap/tindakanAkomodasi/index")?>&pendaftaran_id=' + pendaftaran_id + '&pasienadmisi_id=' + pasienadmisi_id);
    }
