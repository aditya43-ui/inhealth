...
<tr data-idx="<?php echo $i; ?>" class="row_main <?php echo $is_confirm ? "ada_data" : ""; ?>">
    <td>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo CHtml::activeTextField($modJenis, '[detail]['.$i.']jumlahpembayaran', array('class'=>'span2 integer2 main_nominal',
                    'readonly'=>$is_confirm, 'onblur'=>'cekBayarBank(); hitungKembalian();')); ?>
            </div>
        </div>
        <div class="control-group">
