...
class BKRinciantagihapasienlaboratoriumV extends RinciantagihapasienlaboratoriumV{
    ...
    public function searchRincianTagihan()
	{
		...
		$criteria=new CDbCriteria;
                ...
                $criteria->select = array(
                                ...
                                'pembayaranpelayanan_id', 'ruangan_nama', 'ruangan_id', 'ruanganpenunjang_id',
                            );
                ...
                $criteria->group = 'nama_pegawai, pendaftaran_id,tgl_pendaftaran, no_pendaftaran, no_rekam_medik, nama_pasien, nama_bin, jeniskelamin, 
                            carabayar_nama, penjamin_nama, jeniskasuspenyakit_id, jeniskasuspenyakit_nama, pembayaranpelayanan_id, ruangan_nama, ruangan_id, ruanganpenunjang_id';
		...
		$criteria->addInCondition('ruanganpendaftaran_id', array(Params::RUANGAN_ID_LAB_KLINIK, Params::RUANGAN_ID_LAB_ANATOMI, Params::RUANGAN_ID_RAD));
		$criteria->addInCondition('ruanganpenunjang_id', array(Params::RUANGAN_ID_LAB_KLINIK, Params::RUANGAN_ID_LAB_ANATOMI));
