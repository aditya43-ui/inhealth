...
class BKTindakandanoasudahbayarV extends TindakandanoasudahbayarV
{
        /**
        ...
        public function searchTable()
	{
		...
		$criteria=new CDbCriteria;
                ...
                $criteria->select='t.tglpembayaran, pendaftaran_t.tgl_pendaftaran,pendaftaran_t.no_pendaftaran,ruangan_nama,
                                   pasien_m.no_rekam_medik,pasien_m.nama_pasien,pasien_m.pasien_id,
                                   sum(t.totalbayartindakan) as totalbayartindakan,sum(t.totalbiayapelayanan) as totalbiayapelayanan';
                $criteria->group='t.tglpembayaran, pendaftaran_t.tgl_pendaftaran,pendaftaran_t.no_pendaftaran,ruangan_nama,
                                  pasien_m.no_rekam_medik, pasien_m.nama_pasien, pasien_m.pasien_id';
        ...
        public function searchPrint()
	{
		...
		$criteria= new CDbCriteria;
                ...
                $criteria->select='t.tglpembayaran, pendaftaran_t.tgl_pendaftaran,pendaftaran_t.no_pendaftaran,ruangan_nama, 
                                   pasien_m.no_rekam_medik,pasien_m.nama_pasien,pasien_m.pasien_id,
                                   sum(t.totalbayartindakan) as totalbayartindakan,sum(t.totalbiayapelayanan) as totalbiayapelayanan';
                $criteria->group='t.tglpembayaran, pendaftaran_t.tgl_pendaftaran,pendaftaran_t.no_pendaftaran,ruangan_nama,pasien_m.no_rekam_medik,
                                  pasien_m.nama_pasien, pasien_m.pasien_id';
                $criteria->join='LEFT JOIN pasien_m ON pasien_m.pasien_id = t.pasien_id
                                 LEFT JOIN pendaftaran_t ON pendaftaran_t.pendaftaran_id = t.pendaftaran_id';
                $criteria->addBetweenCondition('pendaftaran_t.tgl_pendaftaran',$this->tgl_awal,$this->tgl_akhir,true);
                $criteria->limit = -1;
...
//                $criteria->addCondition('pendaftaran_t.ruangan_id = '.Yii::app()->user->getState('ruangan_id'));
		return new CActiveDataProvider($this, array(
			'criteria'=>$criteria,
		));
	}
