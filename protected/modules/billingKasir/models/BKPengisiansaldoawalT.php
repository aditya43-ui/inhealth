...
class BKPengisiansaldoawalT extends PengisiansaldoawalT {
	
	public $tgl, $tgl_awal, $tgl_akhir, $format,$nama_rumahsakit,$ruangan_nama, $pegawai_nama, $namaLengkap, $profilrs_id, $ruanganAsal, $instalasi_id,$instalasi_nama;
...
//		$criteria->compare('LOWER(sd_tglrevisianggaran)',strtolower($this->sd_tglrevisianggaran),true);
	...
	public static function getItems(){
		$criteria = new CDbCriteria();
		$criteria->addCondition("is_kirim = 1");
		$criteria->order = "is_kirim ASC";
		
		return self::model()->findAll($criteria);
	}
	public function getCabangItems()
	{
		return ProfilrumahsakitM::model()->findAll('isholding=false ORDER BY nama_rumahsakit');
	}
}
