...
class BKPendaftaranT extends PendaftaranT
{
	...
	public static function model($className=__CLASS__)
	{
        ...
        public function getCaraBayarItems($cara_pembayaran = null)
        {
            $cr = new CDbCriteria();
            $cr->compare('lower(metode_pembayaran)', strtolower($cara_pembayaran), true);
            $cr->addCondition('carabayar_aktif = true');
            $cr->order = 'carabayar_nourut';
            
            return CarabayarM::model()->findAll($cr);
        }
