 ...
 */
class PembayaranTagihanPasienPenjaminanController extends MyAuthController
{
    /**
    ...
    public $path_view = 'billingKasir.views.pembayaranTagihanPasienPenjaminan.';
                ...
                if (!empty($_POST['BKPiutangasuransiT'])) {
                    foreach ($_POST['BKPiutangasuransiT'] as $piutang) {
                        ...
                        if ($model->statusperiksa == Params::STATUSPERIKSA_SUDAH_PULANG) {
                            ...
                            $this->bayarsemuatindakanoa = false;
                        }
        ...
        if (Yii::app()->request->isAjaxRequest) {
            ...
            if (!empty($pembayaranpelayanan_id)) {
                ...
                if (!empty($pendaftaran_id) && $cekdata == false) {
                    ...
                    $criteria->addCondition("alokasidanadetailtindakan_id IS NOT NULL");
    ...
    public function actionSetRincianObatalkes()
    {
        if (Yii::app()->request->isAjaxRequest) {
            ...
            if (!empty($pendaftaran_id)) {
                ...
                $criteria->addCondition("alokasidanadetailoa_id IS NOT NULL");
    ...
    public function actionBayarPiutang($id) {
        ...
        $model->jumlah_total = MyFormatter::formatNumberForPrint($model->totalsubsidiasuransi);
