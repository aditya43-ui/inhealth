...
class PemakaianObatPJController extends PemakaianObatController
{
  ...
  public function actionIndex($pemakaianobat_id = null, $a = null)
  {
      ...
      if ($this->pemakaianobatsimpan) {
        if (count((array)$_POST['FAPemakaianobatdetailT']) > 0) {
          ...
          foreach ($_POST['FAPemakaianobatdetailT'] as $i => $postDetail) {
            ...
            //                                                        $detailGroups[$obatalkes_id]['ket_obatpakai'] = $model->ket_pemakaianobat;
            //						}
          }
          //END GROUP
        }
    ...
    $linkHalaman = CustomFunction::getUrlByMenuID(2468);
  ...
  public function actionInformasi($a = null) {
      $linkHalaman = CustomFunction::getUrlByMenuID(2506);
