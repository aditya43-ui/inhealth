...
class InfoPemakaianBarangPJController extends InfoPemakaianBarangController
{
  /**
  ...
  public function actionIndex($linkHalaman = null)
  {
    ...
    $linkHalaman = CustomFunction::getUrlByMenuID(2509);

    $this->render($this->path_view . 'index', array(
      'model' => $model, 'format' => $format, 'disabled' => $disabled, 'linkHalaman' => $linkHalaman
    ));
  }
