...
if(!empty($modTindakans)) {
    $this->renderPartial($this->path_view.'_cekvalidTindakanPasien2',array('modTindakans'=>$modTindakans,'removeButton'=>true));
} else {
?>
<tr>
    <td rowspan="2">
    ...
    <td><?php echo CHtml::activeTextField($modTindakan, '[0]qty_tindakan', array('readonly'=>true,'onblur'=>'hitungSubtotal(this)','onkeypress'=>"return $(this).focusNextInputField(event)",'class'=>'inputFormTabel span1 integer numbersOnly')) ?></td>
    <td><?php echo CHtml::activeDropDownList($modTindakan, '[0]satuantindakan', LookupM::getItems('satuantindakan'),array( 'readonly'=>true,'onkeypress'=>"return $(this).focusNextInputField(event)",'class'=>'inputFormTabel span2')) ?></td>
    <td>
        <?php echo CHtml::activeHiddenField($modTindakan, '[0]persenCyto', array('readonly'=>true,'class'=>'inputFormTabel ineteger-decimal')) ?>
        <?php echo CHtml::activeDropDownList($modTindakan, '[0]cyto_tindakan', array('0'=>'Tidak','1'=>'Ya'), array( 'readonly'=>true, 'onchange'=>'hitungCyto(this)','onkeypress'=>"return $(this).focusNextInputField(event)",'class'=>'inputFormTabel span2')) ?>
    </td>
    <td>
...
<tr>
    ...
    echo CHtml::activeTextField($modTindakan, '[0]tgl_tindakan', array('readonly'=>true,'class'=>'tanggal dtPicker2 realtime', 'style'=>'float:left;','value'=>  MyFormatter::formatDateTimeForUser(date('Y-m-d H:i:s')))); ?><span class="add-on"><i class="entypo-calendar"></i><i class="icon-time"></i></span></div></td>
        ...
        <table style="margin:0;" class="list_pegawai_tindakan">
          <tr>
            <td width="20px" style="background-color:transparent;border: 0;">
                ...
                <?php echo CHtml::link("<i class='icon-edit' title='Klik untuk merubah dokter / perawat / bidan'></i>", '#', array('id'=>'btnAddDokter_0','readonly'=>true,'onclick'=>'addDokterLengkap(this);return false;')); ?>
            </td>
            ...
            <td style="background-color:transparent;border: 0;"><?php echo CHtml::activeTextField($modTindakan, '[0]keterangantindakan', array('readonly'=>true,'class'=>'inputFormTabel span3','placeholder'=>'Keterangan Tindakan')) ?></td> 
          </tr>
          <tr>
                <td></td>
