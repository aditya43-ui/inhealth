    ...
    <tr>
        <td style="width: 70%;">
            <b>No. Nota :
                ...
                <?php /*
                    if(!empty($modPendaftaran->pasienadmisi_id)) {
                        ...
                        if (
                            ...
                            || in_array($modTindakans[0]->instalasi_id, array(Params::INSTALASI_ID_RI, Params::INSTALASI_ID_ICU, 79, 38, 14, 85, 100))
                ...
                ?>
                <?php echo $modTindakans[0]->noNota ?? "-"; //echo $nopendaftaran . $modTindakans[0]->nopelayanan; ?></b>
        </td>
