...
$modObatAlkes = new PJObatAlkesM('searchDialog');
$modObatAlkes->unsetAttributes();
if (isset($_GET['PJObatAlkesM'])) {
    $modObatAlkes->attributes = $_GET['PJObatAlkesM'];
    $modObatAlkes->jenisobatalkes_nama = $_GET['PJObatAlkesM']['jenisobatalkes_nama'];
    $modObatAlkes->satuankecil_nama = $_GET['PJObatAlkesM']['satuankecil_nama'];
}
