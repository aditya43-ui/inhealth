<?php 
$modAmbulans = new PJMobilambulansM('searchDialog');
$modAmbulans->unsetAttributes();
if(isset($_GET['PJMobilambulansM'])){
    $modAmbulans->attributes = $_GET['PJMobilambulansM'];
}

$this->widget('ext.bootstrap.widgets.BootGridView',array(
    'id'=>'ambulans-t-grid',
    'dataProvider'=>$modAmbulans->searchDialog(),
    'filter'=>$modAmbulans,
        'template'=>"{summary}\n{items}\n{pager}",
