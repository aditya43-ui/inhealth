...
<div class="panel panel-default" id="charts_env">
    <div class="panel-heading">
        <div class="panel-title with-tabs">
            <i class="entypo-users"></i> Pelayanan dan Tindakan Bulan Ini
        </div>
    ...
    $(document).ready(function($) {
        ...
        Morris.Area({
            ...
            data: [
                ...
                ?> {
                            "x": "<?php echo date("d", strtotime($chart['tgl_tindakan'])); ?>",
        ...
        Morris.Line({
            ...
            data: [
                ...
                ?> {
                            ...
                            label: "<?php echo isset($chart['daftartindakan_nama']) ? $chart['daftartindakan_nama'] : ""; ?>"
                        },
                <?php
                    }
                }
            ...
            labels: [
                ...
                if (count((array)$dataLineChart) > 0) {
                    foreach ($dataLineChart as $i => $chart) {
                ?> "<?php echo isset($chart['daftartindakan_nama']) ? $chart['daftartindakan_nama'] : ""; ?>",
                <?php
                    }
                }
                ?>
