...
<div class="row">
    <div class="col-sm-6">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                ...
                $this->widget('MyJuiAutoComplete', array(
                    ...
                    'htmlOptions' => array('placeholder' => 'No. Identitas Pasien', 'rel' => 'tooltip', 'title' => 'No. Identitas untuk masukan data / mencari pasien', 'onkeyup' => "return $(this).focusNextInputField(event)", 'class' => 'span4'),
                ));
                ?>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                ...
                $this->widget('MyJuiAutoComplete', array(
                    ...
                    'htmlOptions' => array('placeholder' => 'Nama Lengkap Pasien', 'rel' => 'tooltip', 'title' => 'Ketik Nama untuk masukan data / mencari pasien', 'onkeyup' => "return $(this).focusNextInputField(event)", 'class' => 'span4 ' . $nama_kapital),
                ));
                ?>
        ...
        <?php echo $form->textFieldRow($modPasien, 'nama_bin', array('placeholder' => 'Alias / Nama Panggilan Pasien', 'class' => 'span4 ' . $nama_kapital, 'onkeyup' => "return $(this).focusNextInputField(event);")); ?>
        <?php echo $form->textFieldRow($modPasien, 'tempat_lahir', array('placeholder' => 'Kota/Kabupaten Kelahiran', 'class' => 'span4 all-caps', 'onkeyup' => "return $(this).focusNextInputField(event);", 'maxlength' => 25)); ?>
        <div class="control-group">
        ...
        <?php echo $form->textFieldRow($model, 'umur', array('placeholder' => '00 Thn 00 Bln 00 Hr', 'class' => 'span4 umur', 'onblur' => 'setTglLahir(this);', 'onkeyup' => "return $(this).focusNextInputField(event);", 'maxlength' => 20)); ?>
        ...
        <?php echo $form->textFieldRow($modPasien, 'nama_ibu', array('placeholder' => 'Nama Ibu Kandung Pasien', 'class' => 'span4 ' . $nama_kapital, 'onkeyup' => "return $(this).focusNextInputField(event);", 'maxlength' => 50)); ?>
    ...
    <div class="col-sm-6">
        ...
        <div style="text-align: center;">
            ...
            <?php echo CHtml::htmlButton(
                ...
                array(
                    ...
                    'class' => 'btn btn-dark', 'onclick' => "$('#dialog-addphoto').dialog('open');",
        ...
        <?php echo $form->textFieldRow($modPasien, 'no_mobile_pasien', array('placeholder' => 'No. Handphone', 'class' => 'span4 numbers-only', 'onkeyup' => "return $(this).focusNextInputField(event);", 'maxlength' => 20)); ?>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $form->dropDownList($modPasien, 'pekerjaan_id', CHtml::listData($modPasien->getPekerjaanItems(), 'pekerjaan_id', 'pekerjaan_nama'), array('empty' => '-- Pilih --', 'class' => 'span4', 'onkeyup' => "return $(this).focusNextInputField(event)")); ?>
            </div>
        </div>
        <?php echo $form->textFieldRow($modPasien, 'nama_perusahaan_bekerja', array('placeholder' => 'Tempat Bekerja', 'class' => 'span4 all-caps', 'onkeyup' => "return $(this).focusNextInputField(event);")); ?>
    </div>
</div>
...
$modDataPasien = new PJPasienM('searchDialog');
$modDataPasien->unsetAttributes();
if (isset($_GET['PJPasienM'])) {
    $modDataPasien->attributes = $_GET['PJPasienM'];
    $modDataPasien->kelurahan_nama = $_GET['PJPasienM']['kelurahan_nama'];
    $modDataPasien->kecamatan_nama = $_GET['PJPasienM']['kecamatan_nama'];
}
