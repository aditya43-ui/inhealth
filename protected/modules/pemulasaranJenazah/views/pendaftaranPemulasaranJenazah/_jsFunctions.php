        ...
        success:function(data){
            if(data.statusrekammedis.trim() == "<?php echo Params::STATUSREKAMMEDIS_AKTIF?>"){
				...
				setAsuransiPasienLama(data.pasien_id);
                 cekDisabled($('#pendaftaran_t_form'));
...
function pilihTindakanIni(kelompoktindakan_id,daftartindakan_id,kelompoktindakan_nama,daftartindakan_kode,daftartindakan_nama,harga_tariftindakan,jenistarif_id){
    ...
    var rowtindakan = '<?php echo CJSON::encode($this->renderPartial($this->path_view_jenazah.'_rowTindakanPelayanan',array('modTindakan'=>$modTindakan),true));?>';
    //check tindakan 
...
$( document ).ready(function(){
    ...
    ?>
    cekDisabled($('#pendaftaran_t_form')); 
    $("#cari_no_rekam_medik").blur(cekDisabled($('#pendaftaran_t_form')));
});
