<div class="search-form">
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            ...
            <tr>
                <td style="width: 140px;">' . CHtml::radioButton('tampilGrafik', true, array('name' => 'dataGrafik', 'value' => 'kunjungan', 'id' => 'rkunjungan',)) . ' <label for="rkunjungan">Kunjungan</label></td>                                               
