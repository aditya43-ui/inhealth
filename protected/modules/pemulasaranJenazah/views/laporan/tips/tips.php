    ...
    <tr>
        ...
        <td>
            <table style="width: 100%; border: none;">
                ...
                <tr>
                    <td>
                        <div class="accordion-heading1" style=" width:200px;"><a class="accordion-toggle btn-info" data-toggle="collapse" data-parent="#big"> Berdasarkan Wilayah
                                <i class="icon-white icon-chevron-down pull-right"></a></div>
                    </td>
                </tr>
            </table>
        </td>
