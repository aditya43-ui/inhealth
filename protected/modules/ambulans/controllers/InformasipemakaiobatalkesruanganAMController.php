...
class InformasipemakaiobatalkesruanganAMController extends InformasipemakaiobatalkesruanganVController
{
  ...
  {
    return $this->createUrl('PemakaianObatAM/rincianDetail');
  }
  ...
  {
    return $this->createUrl('PemakaianObatAM/Index');
  }
}
