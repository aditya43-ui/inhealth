...
class AMPemakaianambulansT extends PemakaianambulansT
{
    ...
    public $pendampingdokter_nama;
        
    public $pelayanan_ambulan, $jasa_sarana, $harga_bbm, $bhp, $jasa_pengemudi, $jasa_pendamping;
    public $jasa_dokter, $total_tarif, $isPendamping, $isDokter;
