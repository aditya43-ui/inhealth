...
<div class="antirow">
    <div class="row">
        <div class="col-sm-6">
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    ?>
                    <?php echo CHtml::TextField('Tujuan', $profil->nama_rumahsakit, array('class' => 'span3', 'readonly' => true)); ?>
                    <?php echo CHtml::hiddenField('FromsearchTextField', $profil->alamatlokasi_rumahsakit, array('class' => 'span3', 'readonly' => true)); ?>
                </div>
            </div>
            <div class="control-group">
        ...
        <div class="col-sm-6">
            <div class="control-group">
                <label class="control-label">Pelayanan Ambulans</label>
                <div class="controls">
                    <?php
                    $data_list = CHtml::listData(KonfigtarifambulasK::model()->findAll('konfigurasitarifambulans_aktif = true order by komponenunit_id'), 'komponenunit_id', 'komponenunit_id');
                    $data_list = array_merge($data_list, array());

                    echo $form->dropDownList(
                        $modPemakaian,
                        'pelayanan_ambulan',
                        CHtml::listData(KomponenunitM::model()->findAllByAttributes(array(
                            'komponenunit_id' => $data_list,
            ...
            <div id="input_tarif">
                ...
                <div class="control-group">
                    <label class="control-label">Tarif BBM</label>
                    <div class="controls">
                        <div class="txt_01">
                            <?php echo $form->textField($modPemakaian, 'harga_bbm_hargasatuan', array('class' => 'span2 integer2 tarif_harga')); ?>
                            <label> /Km</label>
                        </div>
                        <label>Qty</label>
                        <?php echo $form->textField($modPemakaian, 'jumlahkm', array('class' => 'span1 numbers-only tarif_qty', 'readonly' => false)); ?>
                        <label>Hari</label>
                        <?php echo $form->textField($modPemakaian, 'tarif_hari', array('class' => 'span1 numbers-only tarif_hari', 'readonly' => false)); ?>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label">Jasa Paramedis</label>
                    <div class="controls">
                        <div class="txt_01">
                            <?php echo $form->textField($modPemakaian, 'jasapendamping_hargasatuan', array('class' => 'span2 integer2 tarif_harga')); ?>
                            <label> /Orang</label>
                        </div>
                        <label>Qty</label>
                        <?php echo $form->textField($modPemakaian, 'jasapendamping_qty', array('class' => 'span1 numbers-only tarif_qty', 'readonly' => false)); ?>
                        <label>Hari</label>
                        <?php echo $form->textField($modPemakaian, 'jasapendamping_hari', array('class' => 'span1 numbers-only tarif_hari', 'readonly' => false)); ?>
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label">Akomodasi Paramedis</label>
                    <div class="controls">
                        <div class="txt_01">
                            <?php echo $form->textField($modPemakaian, 'akomodasipendamping_hargasatuan', array('class' => 'span2 integer2 tarif_harga')); ?>
                            <label> /Orang</label>
                        </div>
                        <label>Qty</label>
                        <?php echo $form->textField($modPemakaian, 'akomodasipendamping_qty', array('class' => 'span1 numbers-only tarif_qty', 'readonly' => false)); ?>
                        <label>Hari</label>
                        <?php echo $form->textField($modPemakaian, 'akomodasipendamping_hari', array('class' => 'span1 numbers-only tarif_hari', 'readonly' => false)); ?>
                    </div>
                </div>

                <div class="panel_akomodasi">

                    <div class="control-group">
                        <label class="control-label"></label>
                        <div class="controls">
                            <div class="checkbox-inline">
                                <?php echo CHtml::checkBox('is_akomodasi', false, array('id' => 'is_akomodasi', 'class' => 'cb_akomodasi')); ?>
                                <label>Akomodasi Lain-Lain</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <div class="txt_01">
                                <?php echo $form->textField($modPemakaian, 'biayatol_hargasatuan', array('class' => 'span2 integer2 tarif_harga')); ?>
                                <label> pp</label>
                            </div>
                            <label>Qty</label>
                            <?php echo $form->textField($modPemakaian, 'biayatol_qty', array('class' => 'span1 numbers-only tarif_qty', 'readonly' => false)); ?>
                            <label>Hari</label>
                            <?php echo $form->textField($modPemakaian, 'biayatol_hari', array('class' => 'span1 numbers-only tarif_hari', 'readonly' => false)); ?>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <div class="txt_01">
                                <?php echo $form->textField($modPemakaian, 'biayahotel_hargasatuan', array('class' => 'span2 integer2 tarif_harga')); ?>
                                <label> /Hari</label>
                            </div>
                            <label>Qty</label>
                            <?php echo $form->textField($modPemakaian, 'biayahotel_qty', array('class' => 'span1 numbers-only tarif_qty', 'readonly' => false)); ?>
                            <label>Hari</label>
                            <?php echo $form->textField($modPemakaian, 'biayahotel_hari', array('class' => 'span1 numbers-only tarif_hari', 'readonly' => false)); ?>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <div class="txt_01">
                                <?php echo $form->textField($modPemakaian, 'biayatiket_hargasatuan', array('class' => 'span2 integer2 tarif_harga')); ?>
                                <label> /pp</label>
                            </div>
                            <label>Qty</label>
                            <?php echo $form->textField($modPemakaian, 'biayatiket_qty', array('class' => 'span1 numbers-only tarif_qty', 'readonly' => false)); ?>
                            <label>Hari</label>
                            <?php echo $form->textField($modPemakaian, 'biayatiket_hari', array('class' => 'span1 numbers-only tarif_hari', 'readonly' => false)); ?>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel_akomodasi">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <div class="checkbox-inline">
                                <?php echo CHtml::checkBox('is_akomodasi_dokter', false, array('id' => 'is_akomodasi_dokter', 'class' => 'cb_akomodasi')); ?>
                                <label>Akomodasi Dokter</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <div class="txt_01">
                                <?php echo $form->textField($modPemakaian, 'jasadokter_hargasatuan', array('class' => 'span2 integer2 tarif_harga')); ?>
                                <label> /Hari</label>
                            </div>
                            <label>Qty</label>
                            <?php echo $form->textField($modPemakaian, 'jasadokter_qty', array('class' => 'span1 numbers-only tarif_qty', 'readonly' => false)); ?>
                            <label>Hari</label>
                            <?php echo $form->textField($modPemakaian, 'jasadokter_hari', array('class' => 'span1 numbers-only tarif_hari', 'readonly' => false)); ?>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <div class="txt_01">
                                <?php echo $form->textField($modPemakaian, 'uangmakandokter_hargasatuan', array('class' => 'span2 integer2 tarif_harga')); ?>
                                <label> /Hari</label>
                            </div>
                            <label>Qty</label>
                            <?php echo $form->textField($modPemakaian, 'uangmakandokter_qty', array('class' => 'span1 numbers-only tarif_qty', 'readonly' => false)); ?>
                            <label>Hari</label>
                            <?php echo $form->textField($modPemakaian, 'uangmakandokter_hari', array('class' => 'span1 numbers-only tarif_hari', 'readonly' => false)); ?>
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">Hotel</label>
                        <div class="controls">
                            <div class="txt_01">
                                <?php echo $form->textField($modPemakaian, 'biayahoteldokter_hargasatuan', array('class' => 'span2 integer2 tarif_harga')); ?>
                                <label> /Hari</label>
                            </div>
                            <label>Qty</label>
                            <?php echo $form->textField($modPemakaian, 'biayahoteldokter_qty', array('class' => 'span1 numbers-only tarif_qty', 'readonly' => false)); ?>
                            <label>Hari</label>
                            <?php echo $form->textField($modPemakaian, 'biayahoteldokter_hari', array('class' => 'span1 numbers-only tarif_hari', 'readonly' => false)); ?>
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">Tiket</label>
                        <div class="controls">
                            <div class="txt_01">
                                <?php echo $form->textField($modPemakaian, 'biayatiketdokter_hargasatuan', array('class' => 'span2 integer2 tarif_harga')); ?>
                                <label> pp</label>
                            </div>
                            <label>Qty</label>
                            <?php echo $form->textField($modPemakaian, 'biayatiketdokter_qty', array('class' => 'span1 numbers-only tarif_qty', 'readonly' => false)); ?>
                            <label>Hari</label>
                            <?php echo $form->textField($modPemakaian, 'biayatiketdokter_hari', array('class' => 'span1 numbers-only tarif_hari', 'readonly' => false)); ?>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?php echo $form->textField($modPemakaian, 'totaltarifambulans', array('class' => 'span2 integer2 total_tarif', 'readonly' => true)); ?>
                </div>
            </div>
        ...
        <!--<div class="col-sm-12">-->
        <div class="col-sm-12">
            <div id="googlemaps" style="margin-top: 17px; height: 400px; width: 100%; color: #000;"></div>
        </div>
    </div>
</div>
            ...
            distanceService.getDistanceMatrix({
                ...
                function(response, status) {
                    if (status !== google.maps.DistanceMatrixStatus.OK) {
                        ...
                        $("#AMPemakaianambulansT_jumlahkm").val(Math.round(response.rows[0].elements[0].distance.value / 1000));
                        $("#AMPemakaianambulansT_tarif_hari").val(1);

                        if ($("#AMPemakaianambulansT_pelayanan_ambulan").val() != "") {
                            setTarifAmbulans();
                        }
