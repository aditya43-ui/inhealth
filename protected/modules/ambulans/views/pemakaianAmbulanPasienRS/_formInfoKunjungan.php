        ...
        <div class="control-group">
            ...
            <div class="controls">
                ...
                $this->widget('MyJuiAutoComplete', array(
                    ...
                    'htmlOptions' => array(
                        'placeholder' => 'No. Pendaftaran', 'class' => 'all-caps span4', 'rel' => 'tooltip', 'title' => 'No. pendaftaran / klik icon untuk mencari data kunjungan',
...
$this->widget('ext.bootstrap.widgets.BootGridView', array(
    ...
    'columns' => array(
        ...
        array(
            ...
            'filter' =>
            CHtml::activeTextField($modDialogKunjungan, 'tgl_pendaftaran', array('class' => 'span4', 'readonly' => true)),
