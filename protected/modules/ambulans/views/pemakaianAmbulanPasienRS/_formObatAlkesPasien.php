...
if (isset($_GET['AMObatAlkesM'])) {
    ...
    $modObatAlkes->jenisobatalkes_nama = isset($_GET['AMObatAlkesM']['jenisobatalkes_nama']) ? $_GET['AMObatAlkesM']['jenisobatalkes_nama'] : null;
    $modObatAlkes->satuankecil_nama = isset($_GET['AMObatAlkesM']['satuankecil_nama']) ? $_GET['AMObatAlkesM']['satuankecil_nama'] : null;
}
