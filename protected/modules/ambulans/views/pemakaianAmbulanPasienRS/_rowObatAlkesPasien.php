<tr>
    <td>
        ...
        <?php echo CHtml::hiddenField("pemakaianBahan[0][pasienmasukpenunjang_id]", (isset($modPasienMasukPenunjang->pasienmasukpenunjang_id) ? $modPasienMasukPenunjang->pasienmasukpenunjang_id : "") ,array('readonly'=>true,'class'=>'inputFormTabel lebar1')); ?>
    ...
    <td>
	 ...
	 <td>
        <?php echo CHtml::hiddenField("pemakaianBahan[0][obatalkes_id]", $modObatAlkesPasien->obatalkes_id,array('readonly'=>true,'class'=>'inputFormTabel span1')); ?>
        <?php echo $modObatAlkesPasien->satuankecil_nama; ?>
    </td>
	<td>
        <?php echo CHtml::hiddenField("pemakaianBahan[0][qty_stok]",$modObatAlkesPasien->qty_stok,array('readonly'=>true,'class'=>'span1 float', 'onkeyup'=>"return $(this).focusNextInputField(event)",)); ?>
        <?php echo CHtml::textField("pemakaianBahan[0][qty_oa]",$modObatAlkesPasien->qty_oa,array('class'=>'span1 float', 'onblur'=>'hitungSubTotal(this)', 'onkeyup'=>"return $(this).focusNextInputField(event)",)); ?>
    </td>
    <td>
        <?php echo CHtml::textField("pemakaianBahan[0][harganetto_oa]", $modObatAlkesPasien->harganetto_oa,array('readonly'=>true,'class'=>'inputFormTabel lebar3 float')); ?>
        <?php echo CHtml::hiddenField("pemakaianBahan[0][hargajual_oa]", $modObatAlkesPasien->hargajual_oa,array('readonly'=>true,'class'=>'inputFormTabel lebar3 float')); ?>
