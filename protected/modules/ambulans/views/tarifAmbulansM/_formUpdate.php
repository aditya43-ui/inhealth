...
<div class="row">
    ...
    <div class='col-sm-6'>
        <?php echo $form->textFieldRow(
            $model,
            'tarifambulans_kode',
            array('placeholder' => 'Kode Tarif', 'size' => 20, 'maxlength' => 20, 'class' => 'span4')
        ); ?>
    ...
    <div class="col-sm-6">
        <?php echo $form->textFieldRow($model, 'jmlkilometer', array('placeholder' => 'Jumlah Kilometer', 'class' => 'span3 numbers-only', 'onblur' => 'tarif();')); ?>
        <?php echo $form->textFieldRow($model, 'tarifperkm', array('placeholder' => 'Tarif / KM', 'class' => 'span3 integer', 'onblur' => 'tarif();')); ?>
        <?php echo $form->textFieldRow($model, 'tarifambulans', array('placeholder' => 'Tarif Ambulans', 'class' => 'span3 integer')); ?>
        <div class="control-group">
...
$this->widget('ext.bootstrap.widgets.BootGridView', array(
    ...
    'dataProvider' => $daftarTindakan->searchDialogTarif(),
