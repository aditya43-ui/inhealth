    ...
    <div class="panel-body">
        <div class="search-form">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <?php echo $form->textFieldRow($model, 'nopolisi', array('placeholder' => 'No. Polisi', 'class' => 'span4', 'maxlength' => 20)); ?>
                ...
                <div class="col-sm-6">
                    ...
                    <?php echo $form->textFieldRow($model, 'pemakai_nama', array('placeholder' => 'Nama Pemakai', 'class' => 'span4', 'maxlength' => 100)); ?>
