<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="far fa-eye"></i> Lihat <b>Mobil Ambulans</b>
        </div>
    </div>
    <div class="panel-body table-responsive">
        ...
        <div class="form-actions">
            <?php echo CHtml::link(
                ...
                $this->createUrl($this->id . '/update&id=' . $model->mobilambulans_id, array('modul_id' => Yii::app()->session['modul_id'])),
