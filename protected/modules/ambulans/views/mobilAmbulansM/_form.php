...
<div class="row">
    <div class="col-sm-6">
        ...
        <?php echo $form->textFieldRow($model, 'nopolisi', array('placeholder' => 'No. polisi', 'size' => 20, 'maxlength' => 20, 'class' => 'span4')); ?>
        ...
        <?php echo $form->textFieldRow($model, 'isibbmliter', array('placeholder' => '00', 'class' => 'span4 numbers-only')); ?>
        <?php echo $form->textFieldRow($model, 'kmterakhirkend', array('placeholder' => '00', 'class' => 'span4 numbers-only')); ?>
    </div>

    <div class="col-sm-6">
        <?php echo $form->FileFieldRow($model, 'photokendaraan', array('class' => 'span4', 'rows' => 6, 'cols' => 50)); ?>
        <?php echo $form->textFieldRow($model, 'hargabbmliter', array('placeholder' => '00', 'class' => 'span4 integer')); ?>
...
$modBarang = new AMBarangM('searchDialogAmbulan');
...
$this->widget('ext.bootstrap.widgets.BootGridView', array(
    ...
    'dataProvider' => $modBarang->searchDialogAmbulan(),
    'filter' => $modBarang,
    'template' => "{summary}\n{items}\n{pager}",
