        ...
        <thead>
            <tr>
                <th width="50%" class="col-padding-1">
                    <div class="pull-left">
                        <div class="h4 no-margin">Jumlah Pengajuan</div>
                        <small><?php echo $dataKolom[5]; ?></small>
                    </div>
                </th>
                <th width="50%" class="col-padding-1">
                    <div class="pull-left">
                        <div class="h4 no-margin">Jumlah Pemesanan</div>
                        <small><?php echo $dataKolom[6]; ?></small>
                    </div>
                </th>
                <th width="50%" class="col-padding-1">
                    <div class="pull-left">
                        <div class="h4 no-margin">Jumlah Penyimpanan</div>
                        <small><?php echo $dataKolom[7]; ?></small>
                    </div>
                </th>
                <th width="50%" class="col-padding-1">
                    <div class="pull-left">
                        <div class="h4 no-margin">Jumlah Penerimaan</div>
                        <small><?php echo $dataKolom[8]; ?></small>
                    </div>
                </th>
            </tr>
        </thead>
...
<script type="text/javascript">
    $(document).ready(function($) {
            ...
            data: [
                ...
                if (count((array)$dataAreaChart) > 0) {
                    foreach ($dataAreaChart as $i => $chart) { ?> {
                            "x": "<?php echo date("d", strtotime($chart['tglrekammedis'])); ?>",
        ...
        Morris.Line({
            ...
            data: [
                ...
                if (count((array)$dataLineChart) > 0) {
                    foreach ($dataLineChart as $i => $chart) { ?> {
                            x: "<?php echo date("d", strtotime($chart['tglpeminjamanrm'])); ?>",
            ...
            xkey: 'x',
            ykeys: ['y_1', 'y_2'],
            labels: ['Jumlah Penerimaan', 'Jumlah Penerimaan'],
            parseTime: false,
            ...
            data: [
                ...
                if (count((array)$dataDonutChart) > 0) {
                    foreach ($dataDonutChart as $i => $chart) { ?> {
                            label: "<?php echo $chart['ruangan_nama']; ?>",
