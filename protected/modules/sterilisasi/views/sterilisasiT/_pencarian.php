    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?php echo $form->textField($modPenerimaansterilisasiV, 'penerimaansterilisasi_no', array('placeholder' => 'No Penerimaan', 'class' => 'span4', 'onkeyup' => "return $(this).focusNextInputField(event);", 'maxlength' => 20, 'readonly' => false)); ?>
                </div>
            </div>
        </div>
        <div class="col-sm-6">
...
//								$(this).val( ui.item.label);
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?php echo $form->dropDownList($modPenerimaansterilisasiV, 'ruangan_id', $ruanganTujuans, array('class' => 'span3', 'onkeyup' => "return $(this).focusNextInputField(event);")); ?>
                </div>
            </div>
        </div>
    </div>
