...
<div class="row" id="formLinen">
    <div class="col-sm-6">
        <div class="control-group">
            ...
            <div class="controls">
                ...
                ?>
                <?php echo Chtml::dropDownList('jenisperalatan', '', LookupM::getItemsUrutan('jenisperalatan'), array('onchange' => 'refreshDialog();', 'empty' => '-- Pilih --', 'class' => 'span3',  'onkeypress' => "return $(this).focusNextInputField(event)",)); //'onchange'=>'peralatanBarang()', 
                ?>
            </div>
        </div>
    ...
    <div class="col-sm-6">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo Chtml::dropDownList('keadaanperalatan', '', LookupM::getItemsUrutan('keadaanperalatan'), array('class' => 'span2', 'onchange' => 'peralatanBarang()', 'onkeypress' => "return $(this).focusNextInputField(event)",)); ?>
            </div>
        </div>
    </div>
    <div class="col-sm-6">
