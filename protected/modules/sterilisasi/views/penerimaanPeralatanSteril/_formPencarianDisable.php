...
<div class="row">
    <div class="col-sm-6">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $form->textField($modCari, 'pengajuansterlilisasi_no', array('placeholder' => 'No. Pengajuan', 'style' => 'width:199px;', 'maxlength' => 20, 'readonly' => true)); ?>
            </div>
        </div>
    </div>
    <div class="col-sm-6">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $form->dropDownList($modCari, 'ruangan_id', CHtml::listData(RuanganM::model()->findAll(), 'ruangan_id', 'ruangan_nama'), array('readonly' => true, 'class' => 'span3', 'empty' => '-- Pilih --', 'onkeyup' => "return $(this).focusNextInputField(event);")); ?>
            </div>
        </div>
    </div>
</div>
<div class="form-actions">
    ...
    //    echo CHtml::htmlButton(Yii::t('mds', '{icon} Search', array('{icon}' => '<i class="entypo-search"></i>')), array('class' => 'btn btn-danger', 'type' => 'button','onclick'=>'searchPenerimaan()','onkeypress'=>'searchPenerimaan()'));
    ?>
...
<script type="text/javascript">
    $('#STPengajuansterlilisasiT_instalasi_id').css('pointer-events', 'none');
    $('#STPengajuansterlilisasiT_ruangan_id').css('pointer-events', 'none');
</script>