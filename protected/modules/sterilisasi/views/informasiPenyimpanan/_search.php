...
<div class="row">
    <div class="col-sm-6">
        <div class="control-group">
            <?php echo CHtml::label('Tgl. Penyimpanan', 'penyimpanansteril_tgl', array('class' => 'control-label')) ?>
            <div class="controls">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $form->textField($model, 'penyimpanansteril_no', array('placeholder' => 'No. Penyimpanan', 'class' => 'span4', 'maxlength' => 20, 'onkeypress' => "return $(this).focusNextInputField(event)")); ?>
            </div>
        </div>
    </div>
    <div class="col-sm-6">
