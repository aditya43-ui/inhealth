...
<body class="kertas">
    ...
    <table width="100%" class="table border" style='margin-left:auto; margin-right:auto;'>
        ...
        ?>
            <tr>
                <td><?php echo !empty($modLinen->barang_id)?$modLinen->barang->barang_nama:"" ?></td>
        ...
        <td width="100%" align="left" align="top">
            <table style="width: 100%; border: none;">
                <tr>
                    ...
                    <td width="35%" align="center">
                        <div>Mengetahui</div>
                        <div style="margin-top:60px;"><?php echo !empty($modPenerimaan->pegmengetahui_id)?$modPenerimaan->pegawaiMengetahui->nama_pegawai:""; ?></div>
                        <div></div>
                    </td>
                </tr>
            </table>
