<div class="row">
    <div class="col-sm-6">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $form->dropDownList(
                    $model,
                    'instalasi_id',
                    CHtml::listData(InstalasiM::model()->findAllByAttributes(array('instalasi_aktif' => true), array('order' => 'instalasi_nama')), 'instalasi_id', 'instalasi_nama'),
                    array(
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $form->dropDownList($model, 'ruangan_id', CHtml::listData(RuanganM::model()->findAllByAttributes(array('ruangan_aktif' => true)), 'ruangan_id', 'ruangan_nama'), array('class' => 'span3 required', 'empty' => '-- Pilih --', 'onkeyup' => "return $(this).focusNextInputField(event);")); ?>
            </div>
        </div>
    </div>
    <div class="col-sm-6">
        <div class="control-group">
            ...
            <div class="controls">
                ...
                $this->widget('MyJuiAutoComplete', array(
                    ...
                    'htmlOptions' => array(
                        'placeholder' => 'Pegawai Pengirim',
                        'class' => 'span3 pegawaipengirim_nama',
        ...
        <div class="control-group">
            ...
            ?>
            <?php echo CHtml::label('Pegawai Penerima', 'Pegawai Penerima', array('class' => 'control-label')) ?>
            <div class="controls">
        ...
        <?php echo $form->textAreaRow($model, 'kirimperlinensteril_ket', array('placeholder' => 'keterangan', 'rows' => 3, 'cols' => 100, 'class' => 'span3', 'onkeypress' => "return $(this).focusNextInputField(event);")); ?>
    </div>
</div>
<?php
