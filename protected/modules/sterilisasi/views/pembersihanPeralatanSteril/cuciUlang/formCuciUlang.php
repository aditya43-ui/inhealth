<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="glyphicon glyphicon-briefcase"></i> Transaksi <b>Pembersihan Sterilisasi</b>
        </div>
    </div>
    <div class="panel-body">
        ...
        ?>
            <?php echo Yii::app()->user->setFlash('success', "Data Pembersihan Sterilisasi berhasil disimpan!");
            $this->widget('bootstrap.widgets.BootAlert'); ?>
        <?php } ?>
        ...
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                <?php $this->renderPartial($this->path_view . 'cuciUlang/_tablePenerimaan', array(
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="glyphicon glyphicon-briefcase"></i> Pembersihan
                </div>
            </div>
            <div class="panel-body">
                <?php $this->renderPartial($this->path_view . 'cuciUlang/_formPembersihan', array(
