...
<div class="panel panel-success">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="entypo-credit-card"></i> Data <b>Dekontaminasi</b>
        </div>
    </div>
...
<div class="row">
    <div class="col-sm-6">
        <div class="control-group">
            <?php echo  CHtml::label('No Pembersihan', 'siklus_mesin', array('class' => 'control-label')) ?>
            <div class="controls">
                <?php
                echo $form->textField($modPembersihan, 'no_pembersihan', array('class' => 'span3', 'onkeyup' => "return $(this).focusNextInputField(event);", 'readonly' => true));
                ?>
            </div>
        </div>
        <div class="control-group">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $form->dropDownList($modPembersihan, 'namamesin_id', CHtml::listData(
                    BarangM::model()->findAllByAttributes(array('barang_aktif' => true, 'jenisbarang_id' => 44)),
                    'barang_id',
                    'barang_nama'
                ), array('class' => 'span3', 'empty' => '-- Pilih --', 'class' => 'required')); ?>
            </div>
        </div>
