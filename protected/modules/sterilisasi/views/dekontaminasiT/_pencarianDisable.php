    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?php echo $form->textField($modPenerimaanSterilisasiDetail, 'penerimaansterilisasi_no', array('placeholder' => 'No. Penerimaan', 'class' => 'span4', 'onkeyup' => "return $(this).focusNextInputField(event);", 'maxlength' => 20, 'readonly' => true)); ?>
                </div>
            </div>
        </div>
        <div class="col-sm-6">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?php echo $form->dropDownList($modPenerimaanSterilisasiDetail, 'ruangan_id', $ruanganTujuans, array('readonly' => true, 'class' => 'span3', 'onkeyup' => "return $(this).focusNextInputField(event);")); ?>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    $('#STPenerimaansterilisasidetT_instalasi_id').css('pointer-events', 'none');
    $('#STPenerimaansterilisasidetT_ruangan_id').css('pointer-events', 'none');
</script>