<?php
class PenerimaanPeralatanSterilLangsungController extends MyAuthController
{
  public $layout = '//layouts/column1';
  public $path_view = 'sterilisasi.views.penerimaanPeralatanSterilLangsung.';
  ...
  {
    $this->pageTitle = Yii::app()->name . " - Penerimaan Sterilisasi Langsung";
    if (isset($_GET['frame'])) {
