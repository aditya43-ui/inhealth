<?php
/**
 * model ini digunakan untuk mengakses view pasienmasukpenunjang_v dan hanya bisa diakses oleh modul laboratorium saja
 * 
 ...
 */
class MKPasienMasukPenunjangV extends PasienmasukpenunjangV
{
    ...
    public $pegawaipenunjang_id, $hasilpemeriksaanlab_id, $namapenerimahasil, $tglpengambilanhasil;
	public $perawat_id = null; //untuk tindakanpelayanan_t (analis lab)
    public $penilaian_kelayakan_spesimen_id, $no_lab;
    /**
...
//                $criteria->addBetweenCondition('t.tgl_pendaftaran', $this->tgl_awal, $this->tgl_akhir);
    ...
    /**
     * pencarian data daftar pasien laboratorium dalam bentuk dialog box
     * @return \CActiveDataProvider
     */
...
//                $criteria->addCondition('tgl_pendaftaran BETWEEN \''.$this->tgl_awal.'\' AND \''.$this->tgl_akhir.'\'');
    ...
    /**
     * mengenerate nama lengkap pegawai
     * @param type $pegawai_id
     * @return type
     */
     ...
     * @return string
     */
    public function getStatusLab($status,$id,$pasienmasukpenunjang_id){
