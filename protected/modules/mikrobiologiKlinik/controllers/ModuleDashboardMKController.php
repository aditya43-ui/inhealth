...
/**
 * digunakan untuk meload dashboard mikrobiologi klinik
 * RSST-5079
 ...
 */
class ModuleDashboardMKController extends ModuleDashboardNeonController
{
    public $path_view = 'pendaftaranPenjadwalan.views.moduleDashboardNeon.';
    
    /**
     * action utama untuk masuk ke dashboard
     */
...
//				ORDER BY carabayar_nama ASC";
		...
		// $dataTable = MKPendaftaranMp::model()->findAll($criteria_updatepasien);
		
		
		$dataTable = new MKPasienMasukPenunjangV("searchPemeriksaan");
