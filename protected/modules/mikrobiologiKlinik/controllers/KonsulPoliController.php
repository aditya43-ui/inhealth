...
class KonsulPoliController extends MyAuthController
{
  ...
  protected $path_view = 'mikrobiologiKlinik.views.konsulPoli.';
  public function actionIndex($pendaftaran_id, $idPasienKirimKeUnitLain = null, $idKonsulPoli = null)
  {
    ...
    if (isset($_POST['RJKonsulPoliT'])) {
      ...
      if (isset($_POST['RJKonsulPoliT']['ruangan_id']) && count($_POST['RJKonsulPoliT']['ruangan_id']) > 0) {
        foreach($_POST['RJKonsulPoliT']['ruangan_id'] as $ruangantujuan_id) {
