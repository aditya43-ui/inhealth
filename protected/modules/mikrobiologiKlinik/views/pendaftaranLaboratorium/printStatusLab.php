...
?>
<table style="width: 75%; border: none; margin: 0px auto">
    <thead>
        <tr>
             <td>
                <div class="header">
    ...
    <tbody>
        <tr>
			...
			<div class="judulcontent" style="font-weight: 100;margin-top: 5px;margin-bottom: 20px;">Data Pasien  </div>
                        <table class="status">
       
         <!-- <tr>
            <td align="left" valig="middle" colspan="3" style="padding: 20px;">
                Data Pasien
            </td>
        </tr> -->
        <tr>
        ...
        <?php 
            if(count((array)$modPasienMasukPenunjangs) > 0){
                ...
                ?>
                    ...
                    <tr>
                        <?php //echo '<pre>'; var_dump($daftartindakan[0][0]->attributes); die; ?>
                        <td>No. Nota</td>
                        <td>:</td>
                        <td><?php echo isset($daftartindakan[0][0]) ? $modPendaftaran->no_pendaftaran . $daftartindakan[0][0]->nopelayanan : "-"; ?></td>
                    </tr>
<!--<tr>
