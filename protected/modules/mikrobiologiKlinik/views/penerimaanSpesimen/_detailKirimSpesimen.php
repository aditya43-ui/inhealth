    ...
    foreach ($modKirimSpesimendetail as $data) {
        ...
        if (isset($modSpesimen)) {
            $row_arr[$modSpesimen->spesimen_id] = array(
                ...
                'jenisspesimen_nama' => $data->samplelab_nama,
                'daftartindakan_nama' => $data->daftartindakan_nama,
                'no_kirimspesimen' => $data->no_kirimspesimen,
                'tglkirimspesimen' => $data->tglkirimspesimen,
    ...
    foreach ($row_arr as $no_sampel => $item) :
        ...
        <tr>  
            <td style="text-align: center;">
                ...
                <?php echo CHtml::activeCheckBox($modTerimaSpesimenDet, 'detail[' . $no_sampel . '][checklist]', array('checked' => true, 'class' => 'checklist', 'onclick' => 'setNol(this);', 'style' => 'display:none;')); ?>
            </td>
            ...
            <td><?php echo $item['nama_pegawai']; ?>
                ...
                echo CHtml::activeHiddenField($modTerimaSpesimenDet, 'detail[' . $no_sampel . '][detail][' . $item['spesimen_id'] . '][spesimen_id]', array('value' => $item['spesimen_id'], 'readonly' => true, 'class' => 'spesimen_id'));
                ?>
            </td>
