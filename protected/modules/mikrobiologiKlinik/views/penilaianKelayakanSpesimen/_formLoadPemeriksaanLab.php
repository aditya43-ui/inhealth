...
<tr id="periksalab_<?php echo $modTarif->pemeriksaanlab_id; ?>">
    ...
    <td>
        ...
        <?php echo CHtml::textField("permintaanPenunjang[permintaankepenunjang_id][]", $permintaankepenunjang_id,array('class'=>'inputFormTabel permintaankepenunjang_id','readonly'=>true)); ?>
        <?php echo CHtml::textField("permintaanPenunjang[idDaftarTindakan][]", $modTarif->daftartindakan_id,array('class'=>'inputFormTabel idDaftarTindakan','readonly'=>true)); ?>
        <?php echo CHtml::textField("permintaanPenunjang[tindakanpelayanan_id][]", $id_tindakan); ?>
        <?php echo CHtml::textField("permintaanPenunjang[ruanganID][]", $modTarif->ruangan_id, array('class' => 'idruangan')); ?>
    </td>
    <td>
        <?php 
    ...
    <td style="text-align: center;">
        ...
        if(!isset($_GET['sukses'])){
           echo CHtml::link(!empty($permintaankepenunjang_id)? '<i class="entypo-trash"></i>' : '<i class="entypo-cancel-circled"></i>', '#', array(
