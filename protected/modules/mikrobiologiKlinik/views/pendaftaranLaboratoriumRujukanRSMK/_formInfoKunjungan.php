    ...
    <div class="control-group">
        ...
        <div class="controls">
            ...
            $this->widget('MyJuiAutoComplete', array(
                ...
                'htmlOptions' => array(
                    'placeholder' => 'No. Pendaftaran', 'class' => 'all-caps span4', 'rel' => 'tooltip', 'title' => 'No. Pendaftaran',
...
<div class="col-sm-6">
    <div class="control-group">
        ...
        <div class="controls">
            ...
            <?php echo CHtml::hiddenField('pasienadmisi_id', $modKunjungan->pasienadmisi_id, array('readonly' => true, 'class' => 'span4', 'onkeyup' => "return $(this).focusNextInputField(event);")); ?>
            <?php
            $this->widget('MyJuiAutoComplete', array(
                'name' => 'no_rekam_medik',
                ...
                'htmlOptions' => array(
                    'placeholder' => 'No. Rekam Medik', 'class' => 'all-caps span4', 'rel' => 'tooltip', 'title' => 'No. rekam medik untuk mencari data kunjungan',
                    'onkeyup' => "return $(this).focusNextInputField(event)",
                ),
            ));
            ?>
