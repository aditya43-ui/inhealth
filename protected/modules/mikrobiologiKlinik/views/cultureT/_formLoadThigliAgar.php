    ...
    <div class="panel panel-success">
        <div class="panel-heading">
            ...
            <span style="float:right; padding: 10px">
                <?php // echo CHtml::activeCheckBox($modThigli, '[detail]['.$i.']pilih', array('class' => 'pilihcheck')) ?>
            </span>
        </div>
        <div class="panel-body">
            <div class="control-group">
                ...
                <div class="controls">
                    <?php
                    $modThigli->tanggal_thiglikolatbroth = date('d M Y H:i:s');
            ...
            <div class="control-group">
                ...
                <div class="controls" style="text-align: right;float:right;">
                    <?php echo CHtml::link('<i class="glyphicon glyphicon-minus"></i>', "javascript:;", array('class' => 'btn btn-red', 'style' => 'margin-right: 50px;', 'onclick' => 'hapusThigli(this);')); ?>
                </div>
            </div>
        </div>
    </div>
