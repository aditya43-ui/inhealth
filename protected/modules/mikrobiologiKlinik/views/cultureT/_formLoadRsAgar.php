    ...
    <div class="panel panel-success">
        ...
        <div class="panel-body">
            <div class="control-group">
                ...
                <div class="controls">
                    <?php
                    $modBrucella->tanggal = date('d M Y H:i:s');
            ...
            <div class="control-group">
                ...
                <div class="controls" style="text-align: right;float:right;">
                    <?php echo CHtml::link('<i class="glyphicon glyphicon-minus"></i>', "javascript:;", array('class'=>'btn btn-red', 'style' => 'margin-right: 50px;','onclick'=>'hapusRs(this);')); ?>
                </div>
            </div>
            <div class="control-group">
