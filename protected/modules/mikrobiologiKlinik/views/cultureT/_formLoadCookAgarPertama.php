    ...
    <div class="panel panel-success">
        <div class="panel-heading">
            ...
            <span style="float:right; padding: 10px">
                <?php // echo CHtml::activeCheckBox($modCook, '[detail]['.$i.']pilih', array('class' => 'pilihcheck')) ?>
            </span>
        </div>
        <div class="panel-body">
            <div class="control-group">
                ...
                <div class="controls">
                    <?php
                    $modCook->tanggal_cookedmeatbroth = date('d M Y H:i:s');
            ...
            <div class="control-group">
                <?php echo CHtml::label("Cooked Meat Broth ", 'cookedmeatbroth', array('class' => 'control-label')) ?>
                <div class = "controls">
                    <?php echo CHtml::activeDropDownList($modCook, '[detail][' . $i . ']cookedmeatbroth', LookupM::getItems('culture'), array('empty' => '-- Pilih Cooked Meat Broth --', 'class' => 'span3')); ?>
                </div>
                <div class="controls" style="text-align: right;float:right;">
                    <?php // echo CHtml::link('<i class="glyphicon glyphicon-minus"></i>', "javascript:;", array('class' => 'btn btn-red', 'style' => 'margin-right: 50px;', 'onclick' => 'hapusCook(this);')); ?>
                </div>
            </div>
        </div>
    </div>
