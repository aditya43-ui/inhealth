    ...
    <div class="panel panel-success">
        <div class="panel-heading">
            ...
            <span style="float:right; padding: 10px">
                <?php echo CHtml::activeCheckBox($modBlood, '[detail][' . $i . ']pilih', array('class' => 'pilihcheck')) ?>
            </span>
        </div>
        <div class="panel-body">
            <div class="control-group">
                ...
                <div class="controls">
                    <?php
                    $modBlood->tanggal = date('d M Y H:i:s');
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    $this->widget('MyJuiAutoComplete', array(
                                        ...
                                        'tombolDialog' => array('idDialog' => 'dialogPpdsBl', 'jsFunction' => "setDialogBl(this);"),
                                    ));
