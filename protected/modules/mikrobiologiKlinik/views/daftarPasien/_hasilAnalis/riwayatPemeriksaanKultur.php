...
<table class="table table-striped table-bordered table-condensed" style="width: 100%;">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="link_col"><?php echo CHtml::link('<i class="icon-form-print"></i>', '#', array('onclick'=>'printKultur1(' . $riwayat->pemeriksaankultur_id . ');return false;')); ?></td>
...
<script>
    ...
    function hapusRiwayatKultur(id, obj) {
        myConfirm('Anda yakin untuk menghapus hasil pemeriksaan ini ?', 'Peringatan', function(r) {
            if (r) {
                $.post('<?php echo $this->createUrl('hapusKultur'); ?>', {id: id}, function(data) {
                    if (data.ok == 1) {
