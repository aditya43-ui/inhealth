...
function setRiwayatAnamnesa(){
    ...
    $.ajax({
        type:'POST',
        url:'<?php echo $this->createUrl('/mikrobiologiKlinik/daftarPasien/setRiwayatAnamnesa'); ?>',
...
function setRiwayatPemeriksaanFisik(){
    ...
    $.ajax({
        type:'POST',
        url:'<?php echo $this->createUrl('/mikrobiologiKlinik/daftarPasien/setRiwayatPemeriksaanFisik'); ?>',
        data: {pasienmasukpenunjang_id:$("#pasienmasukpenunjang_id").val()},
        dataType: "json",
        success:function(data){
...
function setRiwayatDiagnosa(){
    ...
    $.ajax({
        type:'POST',
        url:'<?php echo $this->createUrl('/mikrobiologiKlinik/daftarPasien/setRiwayatDiagnosa'); ?>',
        data: {pasienmasukpenunjang_id:$("#pasienmasukpenunjang_id").val()},
        dataType: "json",
        success:function(data){
