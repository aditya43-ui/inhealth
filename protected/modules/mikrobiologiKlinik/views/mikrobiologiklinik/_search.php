...
<div class="row">
    ...
    <div class="control-group">
        ...
        <div class="col-sm-6">
     <div class="control-group">
            <?php echo CHtml::label("Antibiotik Nama Lain", '', array('class' => 'control-label')) ?>
            <div class="controls">
                <?php echo $form->textField($model, 'antibiotikmikro_namalain', array('placeholder' => 'Nama Lain', 'class' => 'span3', 'maxlength' => 100)); ?>
            </div>
        </div>
