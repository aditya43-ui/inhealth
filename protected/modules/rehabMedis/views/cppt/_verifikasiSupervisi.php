...
if(isset($_GET['sukses'])){
    $hiddenData = "hidden";
    Yii::app()->user->setFlash('success',"Berhasil di Verifikasi Supervisi!");
}

$this->widget('bootstrap.widgets.BootAlert'); 
?>
<?php $form=$this->beginWidget('ext.bootstrap.widgets.BootActiveForm',array(
    'id'=>'verifikasisupervisi-t-form',
...
<div class="row-fluid">
    <div class="col-sm-12">
        <div class="control-group">		
            <?php echo CHtml::label("Supervisi",'', array('class' => 'control-label')) ?>
            <div class="controls">
        ...
        <div class="control-group">		
            ...
            <div class="controls">
                <?php   
                    ...
                    'model'=>$model,
                    'attribute'=>'verifikasisupervisi_tanggal',
                    'mode'=>'datetime',
                    'options'=> array(
        ...
        <div class="control-group">		
            ...
            <div class="controls">
                <?php echo $model->verifikasidpjp_hasilreview ?>
            </div>
        </div>
        <div class="control-group">		
        ...
        <div class="control-group">	
            <div style="width: 100%">
                <?php $this->widget('ext.redactorjs.Redactor',array('model'=>$model, 'attribute'=>'verifikasisupervisi_keterangan', 'toolbar'=>'mini','height'=>'100px')) ?>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    function simpanVerifikasi(){
        $('#verifikasisupervisi-t-form').submit();
    }
</script>