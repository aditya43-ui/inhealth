...
<table style="width: 100%; border: none;">
   ...
   <table class="status" width="100%">
        ...
        <tr>
            ...
            <td>:</td>
            <td><?php 
            if ($modPendaftaran->ruangan->is_tindakan == 'TRUE'){
                $nomor = explode("AN",$modPendaftaran->pasienmasukpenunjang->no_masukpenunjang);
                // var_dump($nomor);die;
                $nomor2= isset($nomor[1])? $modPendaftaran->ruangan->ruangan_singkatan."".$nomor[1] : '-';
                echo $nomor2;

            }else{
                echo $modPendaftaran->pasienmasukpenunjang->no_masukpenunjang;
            }
           ?></td>
        </tr>
        <tr>
