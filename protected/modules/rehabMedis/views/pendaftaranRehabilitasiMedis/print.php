...
<table style="width: 100%; border: none;">
    <thead>
        ...
        <tr>
            <td style="width: 95%;"><?php echo $rs->alamatlokasi_rumahsakit ?></td>
    ...
    <tbody>
        ...
        <tr>
            <td style="width: 70%;">
                <b>No. Nota :
                    <?php echo $modPendaftaran->no_pendaftaran  ?><?php echo isset($modTindakans[0]->nopelayanan) ? $modTindakans[0]->nopelayanan : '-'; ?></b>
            </td>
