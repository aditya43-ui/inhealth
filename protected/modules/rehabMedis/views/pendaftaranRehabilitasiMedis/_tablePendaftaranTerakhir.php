<div class="panel panel-success">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="entypo-user"></i> <b>10 Pasien Rehabilitasi Medis Terakhir</b>
    ...
    <div class="panel-body" style="max-height: 200px; overflow: auto;">
        ...
        $modListPendaftaran->unsetAttributes();
        $modListPendaftaran->ruanganasal_id = Params::RUANGAN_ID_REHABMEDIS;
