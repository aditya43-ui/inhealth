    ...
    <?php if (!in_array(strtolower($this->id), array("pendaftaranrawatdarurat", "pendaftaranbayibarulahir", "pendaftaranrawatinapdarirjrd"))) { ?>
        <div class="control-group ">
            ...
            <div class="controls form-inline">
                ...
                echo $form->radioButtonList($modSep, 'jenisfaskes', array("1" => "PCare&nbsp;&nbsp;", "2" => "Rumah Sakit"), array('onkeyup' => "return $(this).focusNextInputField(event)", "class" => "jenisfaskes"));
                ?>
            </div>
        </div>
    <?php } ?>
    ...
    <div class="panel panel-success rujukan" id="skdp" style="margin-bottom: 10px !important; padding: 5px">
        ...
        ?>
            <div class="control-group">
                ...
                <div class="controls">
                    <?php echo $form->textField($modSep, 'no_surat', array('placeholder' => $labelplaceholder_no_surat, 'class' => 'span3 ' . $requiredInput, 'onkeyup' => "return $(this).focusNextInputField(event);", 'maxlength' => 30, 'rel' => 'tooltip', 'title' => 'Isi jika pasien dengan surat kontrol')); ?>
