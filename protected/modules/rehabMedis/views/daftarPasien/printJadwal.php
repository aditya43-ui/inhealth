...
<fieldset>
    <legend>Detail Jadwal Kunjungan</legend>
        ...
        <div class="control-group" style="display: <?php echo (!empty($listJadwalKunjungan)) ? 'none' : 'block' ?>">
            ...
            <div class="controls">
                <?php echo CHtml::textfield('lamaterapi', '',array('style'=>'width:100px')) ?> <b>Kali Kunjungan</b>
                <?php echo CHtml::htmlButton(Yii::t('mds','{icon} ',array('{icon}'=>'<i class="entypo-check"></i>')),
                                                        array('class' => 'btn btn-danger','onClick'=>'generateJadwal()','rel'=>'tooltip','data-title'=>'Klik untuk membuat jadwal kunjungan')); ?>
            </div>
        </div>
    ...
    <fieldset>
        <table class="table table-bordered table-condensed" id="tblDetailjadwal">
            ...
            <tr>
                ...
                <td><?php echo $jadwalKunjungan->jadwalrehabmedis_hari /*$jadwalKunjungan->harijadwalrm*/.' - '. $jadwalKunjungan->jadwalrehabmedis_tgl_ke /*$jadwalKunjungan->tgljadwalrm*/ ?></td>
...
//                $tindakans = HasilpemeriksaanrmT::model()->findAllByAttributes(array('jadwalrehabmedis_id'=>$jadwalKunjungan->jadwalrehabmedis_id)); ?>
                ...
                <td>
                    ...
                    $nobed = "-";
                    if (isset($slotM)) {
                        $noslot = $slotBedM->slotbed_noslot;
                    }
