        ...
        <?php $this->widget('MyJuiAutoComplete',array(
                    ...
                    'options'=>array(
                       ...
                       'focus'=> 'js:function( event, ui ) {
                            ...
                            $("#tindakanSementara").val( ui.item.label);
                            return false;
                        }',
                       'select'=>'js:function( event, ui ) {
                            setTindakan($(this), ui.item);
                            setTindakanSementara($(this), ui.item);
                            return false;
                        }',
                    ...
                    'htmlOptions'=>array(
                            'onblur' => 'if(this.value === ""){ $("#tindakanSementara").val(""); updateDokterPemeriksa1(this.value);}',
...
<tr>
    ...
    <td colspan="6">
        <table style="margin:0;">
          ...
          <tr>
              <td></td>
			  <td style="background-color:transparent;border: 0;"><div id="tampilanOkupasi_0"></div></td>
          </tr>
          <tr>
              <td></td>
			  <td style="background-color:transparent;border: 0;"><div id="tampilanTerapiwicara_0"></div></td>
          </tr>
          <tr>
              <td></td>
			  <td style="background-color:transparent;border: 0;"><div id="tampilanFisioterapi_0"></div></td>
          </tr>
        </table>
