    ...
    <?php $form = $this->beginWidget('ext.bootstrap.widgets.BootActiveForm', array(
        ...
        'type' => 'horizontal',
        'focus' => '#RMTindakanPelayananT_0_daftartindakanNama',
        'htmlOptions' => array(
    ...
    <div class="formInputTab">
        ...
        ?>
        <!-- tabel foc sementara -->
        <!-- <table class="table table-bordered table-condensed" id="tblInputTindakan">
            <thead>
                <th>Tindakan</th>
            ...
            <?php
            // $trTindakan = $this->renderPartial($this->path_view . '_rowTindakanPasienFOC', array('modTindakan' => $modTindakan, 'modTindakans' => $modTindakans, 'kelaspelayanan_id' => $modPendaftaran->kelaspelayanan_id), true);
            // echo $trTindakan;
            ?>
        </table> -->
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="entypo-credit-card"></i> Daftar <b>Tindakan</b>
                </div>
            </div>
            <div class="panel-body table-responsive">
                <div class="panel-body">
                    <?php $this->renderPartial('_tindakan', array('modViewTindakans' => $modViewTindakans)); ?>
                </div>
            </div>
        </div>
        <div class="panel panel-success">
        ...
        <!-- <div class="panel panel-success hidden" style="margin-top: 17px;">
            <div class="panel-heading">
                <div class="panel-title">
    ...
    //echo $modPendaftaran->kelaspelayanan_id;
    $this->renderPartial($this->path_view . '_daftarTindakanPaket', array(
        'modPendaftaran'=>$modPendaftaran, 'modJenisTarif'=>$modJenisTarif,
    ));
...
JS;
    ...
    <div style='display:none;'>
        ...
        $this->widget('MyDateTimePicker', array(
            ...
            'htmlOptions' => array(
                'readonly' => true,
                'onkeypress' => "return $(this).focusNextInputField(event)", 'id' => 'RMTindakanPelayananT_0_tgl_tindakan'
            ),
        ));
        ?>
    </div>
