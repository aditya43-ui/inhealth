	...
	<div class="col-sm-3" style="padding:0">
		...
		<div class="scrollable" data-height="400" data-scroll-position="right" data-rail-color="#fff" data-rail-opacity=".9" data-rail-width="8" data-rail-radius="10" data-autohide="0">
			  <?php foreach ($dataMap as $i => $map) { ?>
				<div class="tile-entry list-map" style="cursor:pointer;background:rgba(0, 0, 0, 0.15); padding:10px 20px 10px 10px; margin:1px 0" onclick="panTo(<?php echo !empty($map['latitude'])?$map['latitude']:"'tidakada'"; ?>, <?php echo !empty($map['longitude'])?$map['longitude']:"'tidakada'" ?>, '<?php echo $map['kecamatan_nama'] ?>')"> 
