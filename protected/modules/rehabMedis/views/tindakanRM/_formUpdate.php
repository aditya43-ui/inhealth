...
<div class="row">
    <div class="col-sm-6">
        ...
        <?php echo $form->textFieldRow($model, 'daftartindakan_id', array('placeholder' => 'Daftar Tindakan', 'value' => $model->daftartindakan->daftartindakan_nama, 'class' => 'span3', 'readonly' => true, 'onkeypress' => "return $(this).focusNextInputField(event);")); ?>
    </div>
    <div class="col-sm-6">
