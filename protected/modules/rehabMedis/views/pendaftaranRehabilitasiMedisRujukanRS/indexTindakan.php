...
$this->breadcrumbs = array(
    ...
    'Pendaftaran Rujukan Rumah Sakit',
);
...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="glyphicon glyphicon-briefcase"></i> Transaksi <b>Pendaftaran Rujukan Rumah Sakit</b>
        </div>
    </div>
    <div class="panel-body">
                ...
                <div class="panel panel-success">
                    ...
                    <div class="panel-body table-responsive" id="form-permintaankepenunjang">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <?php echo CHtml::textField('ruangan_tujuan',!empty($modKirim) ? $modKirim->ruangan->ruangan_nama : null,array('readonly'=>true,'class'=>'span3', 'onkeyup'=>"return $(this).focusNextInputField(event);")); ?>
                            </div>
                        </div>
                        <div class="control-group">
                            <?php echo CHtml::label('Ruangan Asal', 'ruangan_asal', array('class'=>'control-label')); ?>
                            <div class="controls">
                                <?php echo CHtml::textField('ruangan_asal',!empty($modKirim) ? $modKirim->createruangan->ruangan_nama : null,array('readonly'=>true,'class'=>'span3', 'onkeyup'=>"return $(this).focusNextInputField(event);")); ?>
                            </div>
                        </div>
                        <div class="control-group">
            ...
            <div class="col-sm-6">
                <fieldset class="">
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">
                            <?php echo $this->renderPartial('_formMasukPenunjangTindakan', array('form' => $form, 'modPasienMasukPenunjang' => $modPasienMasukPenunjang, 'modTindakan' => $modTindakan)); ?>
                        </div>
                    </div>
                </fieldset>
        ...
        <div class="form-actions">
            ...
            // } else {
            //     echo CHtml::link(Yii::t('mds', '{icon} Print Status', array('{icon}' => '<i class="entypo-print"></i>')), 'javascript:void(0);', array('class' => 'btn btn-info', 'onclick' => "printStatusTindakan();return false"));
            // }
...
<?php
    ...
    $this->renderPartial($this->path_view . '_daftarTindakanPaketTindakan');
...
function printStatusTindakan()
{
    ...
    if(pendaftaran_id != ""){
        window.open('<?php echo $this->createUrl('/rawatJalan/tindakan/printTindakan'); ?>&id='+pendaftaran_id,'printwin','left=100,top=100,width=480,height=640');
    }else{
