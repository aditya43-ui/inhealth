...
class LBPendaftaranMp extends PendaftaranT {
    ...
    */
    ...
    {
        $modRuangan = RuanganM::model()->findAll('(instalasi_id = '.Params::INSTALASI_ID_LAB_PA.' OR instalasi_id = '.Params::INSTALASI_ID_RAD.' OR instalasi_id = '.Params::INSTALASI_ID_REHAB.') AND ruangan_aktif=true ORDER BY ruangan_nama');
        return $modRuangan;
    }
