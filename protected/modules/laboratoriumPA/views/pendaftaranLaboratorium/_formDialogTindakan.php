	...
	$this->widget('ext.bootstrap.widgets.BootGridView',array(
			...
			'columns'=>array(
					...
					array(
						...
						'footer' => CHtml::htmlButton('+ Tambah', array('class'=>'btn btn-green', 'onclick'=>'add_pemeriksaan_pilihan(); $("#dialogTindakan").dialog("close");'))
					),
					array(
						'header' => 'Jenis Pemeriksaan',
						'value' => '$data->jenispemeriksaanlab_nama',
						'filter' =>CHtml::activeHiddenField($tindakanLab, 'kelaspelayanan_id',array('class'=>'dialog_kelaspelayanan_id')). CHtml::activeHiddenField($tindakanLab, 'penjamin_id',array('class'=>'dialog_penjamin_id')).CHtml::activeHiddenField($tindakanLab, 'ruangan_id',array('class'=>'dialog_ruangan_id')).CHtml::activeDropDownList($tindakanLab, 'jenispemeriksaanlab_id',  CHtml::listData(JenispemeriksaanlabM::model()->findAll("jenispemeriksaanlab_kelompok = 'PATOLOGI ANATOMI' and jenispemeriksaanlab_aktif = true ORDER BY jenispemeriksaanlab_nama"), 'jenispemeriksaanlab_id', 'jenispemeriksaanlab_nama'),array('empty' => '-- Pilih --'))
					),
					array(
						'header' => 'Pemeriksaan',
						'name' => 'pemeriksaanlab_nama',
