...
<div class="control-group ">
    ...
    <div class="controls">
        <?php echo $form->dropDownList($modPenanggungJawab,'jenisidentitas', LookupM::getItems('jenisidentitas'), array('empty'=>'-- Pilih --','class'=>'span2','style'=>'width:80px;','onkeyup'=>"return $(this).focusNextInputField(event)", 'onchange' => 'cekLengthPJ(this);',)); ?>
        <?php echo $form->textField($modPenanggungJawab,'no_identitas', array(
            'placeholder'=>'No. Identitas',
            'class'=>'span2 all-caps',
