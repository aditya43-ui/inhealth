...
<div id="div_luar">
	...
	<div class="panel panel-success panel-shadow">
		<div class="panel-heading">
			<div class="panel-title">Tabel Pendapatan Ruangan<strong> Laboratorium - Dari Luar RS</strong></div>
		</div>
	...
	<?php 
	$url = Yii::app()->createUrl('laboratoriumPA/laporan/frameGrafikLaporanPendapatan&id=1');
