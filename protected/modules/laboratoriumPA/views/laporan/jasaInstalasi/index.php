...
$url = Yii::app()->createUrl('laboratoriumPA/laporan/frameGrafikLaporanJasaInstalasi&id=1');
    ...
    <div class="col-md-12">
        <div class="panel panel-primary panel-gradient">
            <div class="panel-heading">
                <div class="panel-title">Laporan <strong>Jasa Instalasi</strong></div>
            </div>
            <div class="panel-body">
                ...
                <div class="panel panel-success panel-shadow">
                    <div class="panel-heading">
                        <div class="panel-title">Tabel <strong>Jasa Instalasi</strong></div>
                    </div>
