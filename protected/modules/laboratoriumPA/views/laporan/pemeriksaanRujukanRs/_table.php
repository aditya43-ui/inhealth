...
<?php $this->widget($table,array(
	...
	'mergeHeaders'=>array(
			array(
				'name'=>'<center>Jenis Pemeriksaan</center>',
				'start'=>'4',
				'end'=>'6',
			),
			array(
				'name'=>'<center>Rujukan Internal</center>',
				'start'=>'7',
				'end'=>'8',
			),
		),	
	'columns'=>array(
			...
			array(
				'header'=>'Hematologi',
				'value'=>function($data){
					if ($data->jenispemeriksaan == Params::JENISPEMERIKSAANLAB_HEMATOLOGI){
						return 'v';
					}else{
						return '';
					}		
			...
			array(
				'header'=>'Kimia Klinik',
				'value'=>function($data){
					if ($data->jenispemeriksaan == Params::JENISPEMERIKSAANLAB_ELEKTROLIT){
						return 'v';
					}else{
						return '';
					}		
			...
			array(
				'header'=>'Lain-Lain',
				'value'=>function($data){
					if ($data->jenispemeriksaan != Params::JENISPEMERIKSAANLAB_ELEKTROLIT && $data->jenispemeriksaan != Params::JENISPEMERIKSAANLAB_HEMATOLOGI){
						return 'v';
					}else{
						return '';
					}		
			...
			array(
				...
				'value' => '"Rp".number_format($data->tarif_tindakankomp,0,"",".")',
				'footer' => '<b>Total</b>',
