...
$url = Yii::app()->createUrl('laboratoriumPA/laporan/frameGrafikKunjungan&id=1');
    ...
    <div class="col-md-12">
        <div class="panel panel-primary panel-gradient">
            <div class="panel-heading">
                <div class="panel-title">Laporan <strong>Kunjungan</strong></div>
            </div>
            <div class="panel-body">
                ...
                <div class="panel panel-success panel-shadow">
                    <div class="panel-heading">
                        <div class="panel-title">Tabel <strong>Kunjungan</strong></div>
                    </div>
