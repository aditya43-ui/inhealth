<div class="white-container">
    ...
    //        ))
        ?>
        <?php $this->renderPartial('laboratoriumPA.views.laporan.pemeriksaanRujukan/_tabMenu',array()); ?>
        <?php $this->renderPartial('laboratoriumPA.views.laporan.pemeriksaanRujukan/_jsFunctions',array()); ?>
        <div>
