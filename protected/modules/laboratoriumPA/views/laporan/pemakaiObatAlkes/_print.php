...
echo $this->renderPartial('application.views.headerReport.headerLaporanTransaksi',array('judulLaporan'=>'Laporan Kunjungan Pasien', 'periode'=>'Periode : '.$periode, 'colspan'=>7)); 
