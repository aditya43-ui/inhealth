...
//                                    'htmlOptions'=>array('class'=>'aw',)
    ...
    <div class="form-actions">
        <?php echo CHtml::htmlButton(Yii::t('mds', '{icon} Search', array('{icon}' => '<i class="entupo-search"></i>')), array('class' => 'btn btn-primary', 'type' => 'submit', 'id' => 'btn_simpan'));?>
        <?php
...
//                ),
        array(
            ...
            'filter' => Chtml::activeDropDownList($modPemeriksaan, 'jenispemeriksaanlab_id', Chtml::listData(LBJenisPemeriksaanLabM::model()->findAll("jenispemeriksaanlab_kelompok ='PATOLOGI ANATOMI' and jenispemeriksaanlab_aktif = TRUE ORDER BY jenispemeriksaanlab_nama ASC "), 'jenispemeriksaanlab_id', 'jenispemeriksaanlab_nama'), array('empty'=>'-- Pilih --'))
        ),
        array(
