...
$url = Yii::app()->createUrl('laboratoriumPA/laporan/frameGrafikLaporanBiayaPelayanan&id=1');
    ...
    <div class="col-md-12">
        <div class="panel panel-primary panel-gradient">
            <div class="panel-heading">
                <div class="panel-title">Laporan Biaya <strong>Pelayanan Laboratorium</strong></div>
            </div>
            <div class="panel-body">
                ...
                <div class="panel panel-success panel-shadow">
                    <div class="panel-heading">
                        <div class="panel-title">Tabel <strong>Biaya Pelayanan Laboratorium</strong></div>
                    </div>
