<div class="search-form" style="">
    ...
    <div class="row-fluid">
        ...
        <div class="col-sm-6">
            <?php
                echo $form->textFieldRow($model,'no_rekam_medik', array('class'=>'form-control numbers-only','maxlength'=>6,));
                echo $form->textFieldRow($model,'nama_pasien', array('class'=>'form-control hurufs-only'));
            ?>
        </div>
    </div>
	<div class="row-fluid">
