    ...
    <div class="col-md-12">
        <div class="panel panel-primary panel-gradient">
            <div class="panel-heading">
                <div class="panel-title">Laporan <strong>Pemeriksaan Pembayaran</strong></div>
            </div>
            <div class="panel-body">
                <div class="panel panel-success panel-shadow">
                    ...
                    <div class="panel-body">
						<div class="search-form">
							<?php $this->renderPartial('laboratoriumPA.views.laporan.pembayaranPemeriksaan/_searchPembayaranPemeriksaan',
							array('model'=>$model)); ?>
						</div>
                    </div>
                </div>								
                <div class="panel panel-success panel-shadow">
                    <div class="panel-heading">
                        <div class="panel-title">Tabel <strong>Pembayaran Pemeriksaan</strong></div>
                    </div>
