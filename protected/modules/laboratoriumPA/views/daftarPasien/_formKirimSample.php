<div class="panel panel-success" id="kirimSample">
    <div class="panel-heading">
        <div class="panel-title">
            <?php echo $form->checkBox($modKirimSample, '[' . $i . ']isKirimSample', array('onclick' => 'enableInputSample(this)')); ?> Kirim Sample
        </div>
    </div>
    <div class="panel-body">
        <div class="col-sm-6">
            <?php
            echo $form->dropDownListRow($modKirimSample, '[' . $i . ']labklinikrujukan_id', CHtml::listData($modKirimSample->LabKlinikRujukanItems, 'labklinikrujukan_id', 'labklinikrujukan_nama'), array('class' => 'span2', 'onkeypress' => "return $(this).focusNextInputField(event)",
                'empty' => '-- Pilih --'));
            ?>
            <?php echo $form->textFieldRow($modKirimSample, '[' . $i . ']nokirimsample', array('class' => 'span2', 'onkeyup' => "return $(this).focusNextInputField(event);", 'maxlength' => 20)); ?>
            <div class="control-group ">
                ...
                <div class="controls">
                    ...
                    $this->widget('MyDateTimePicker', array(
                        ...
                        'htmlOptions' => array('readonly' => true, 'class' => 'dtPicker1', 'onkeypress' => "return $(this).focusNextInputField(event)"
                        ,'width'=>'140px;'),
                    ));
                    ?>
