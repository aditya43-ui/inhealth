<div class = "col-sm-6">
        ...
        <div class="controls">
            ...
            <?php 
                $this->widget('MyJuiAutoComplete', array(
                                ...
                                'htmlOptions'=>array('placeholder'=>'Ketik No. Pendaftaran','class'=>'span3 all-caps','rel'=>'tooltip','title'=>'Ketik no. pendaftaran',
        ...
        <div class="controls">
            ...
            <?php  
                $this->widget('MyJuiAutoComplete', array(
                                ...
                                'htmlOptions'=>array('placeholder'=>'Ketik No. Masuk Penunjang','class'=>'span3 all-caps','rel'=>'tooltip','title'=>'Ketik no. masuk penunjang / klik icon untuk mencari data kunjungan',
                                    'onkeyup'=>"return $(this).focusNextInputField(event)",                                    
                                    ),
                            )); 
            ?>
	...
	<div class="control-group">
		<?php echo CHtml::label("Dokter Perujuk",'',array('class'=>'control-label')); ?>
		<div class="controls">
			<?php 		
				
				echo CHtml::textField('dokterperujuk',$modKunjungan->dokterperujuk,array('readonly'=>true,'class'=>'span3', 'onkeyup'=>"return $(this).focusNextInputField(event);"));
			?>
		</div>
	</div>
</div>
<div class = "col-sm-6">
        ...
        <div class="controls">
            ...
            <?php 
                $this->widget('MyJuiAutoComplete', array(
                                ...
                                'htmlOptions'=>array('placeholder'=>'Ketik No. Rekam Medik','class'=>'span3 all-caps','rel'=>'tooltip','title'=>'Ketik no. rekam medik untuk mencari data kunjungan',
                                    'onkeyup'=>"return $(this).focusNextInputField(event)",
                                    ),
                            )); 
            ?>
        ...
        <div class="controls">
            ...
            <?php 
                $this->widget('MyJuiAutoComplete', array(
                                ...
                                'htmlOptions'=>array('class' => 'span3', 'placeholder'=>'Ketik Nama Pasien','rel'=>'tooltip','title'=>'Ketik nama pasien untuk mencari data kunjungan',
                                    'onkeyup'=>"return $(this).focusNextInputField(event)",
                                    ),
                            )); 
            ?>
	...
	<div class="control-group">
        ...
        <div class="controls">
            <?php echo CHtml::textArea('alamat_pasien',$modKunjungan->alamat_pasien,array('readonly'=>true,'class'=>'span3', 'placeholder'=>'Ketik Alamat', 'onkeyup'=>"return $(this).focusNextInputField(event);")); ?>
        </div>
    </div>    
