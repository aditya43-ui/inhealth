<?php echo $form->dropDownListRow($modPasienMasukPenunjang,'jeniskasuspenyakit_id', CHtml::listData(LBPendaftaranT::model()->getJenisKasusPenyakitItems($modPasienMasukPenunjang->ruangan_id), 'jeniskasuspenyakit_id', 'jeniskasuspenyakit_nama') ,array('empty'=>'-- Pilih --', 'class'=>'span3', 'onkeyup'=>"return $(this).focusNextInputField(event)")); ?>
<div class="control-group">
    ...
    <div class="controls">
		...
		echo $form->hiddenField($modPasienMasukPenunjang,'pegawai_id', array('readonly' => true, 'class' => 'required'));
			...
			'htmlOptions' => array('class'=>'span3 required', 'placeholder'=>'Ketik Nama Dokter')	
			)); 
...
<div class="control-group">
    ...
    <div class="controls">
		...
		echo $form->hiddenField($modPasienMasukPenunjang,'perawat_id', array('readonly' => true));
			...
			'htmlOptions' => array('class'=>'span3', 'placeholder'=>'Ketik Nama Analis')	
			)); 
