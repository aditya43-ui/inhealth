...
<div class="row-fluid">
	<div class="col-sm-6">
		...
		<?php echo $form->textFieldRow($model,'no_rekam_medik',array('placeholder'=>'Ketik No. Rekam Medik','class'=>'span3 numbers-only', 'maxlength'=>8)); ?>            
	</div>
	<div class="col-sm-6">
...
//      'onclick'=>'if(!confirm("Apakah anda ingin mengulang ini ?")) return false;'));
	...
	?>   
    <?php 
        $content = $this->renderPartial('laboratoriumPA.views.tips.informasi_rincian',array(),true);
