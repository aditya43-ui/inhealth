...
?>   
    <tr>
        ...
        <td><?php echo CHtml::activeTextArea($modDetail,'['.$i.']hasilpemeriksaan',array('placeholder'=>'Ketik Hasil Pemeriksaan','class'=>'autogrow','onkeyup'=>"return $(this).focusNextInputField(event)")) ?></td>
