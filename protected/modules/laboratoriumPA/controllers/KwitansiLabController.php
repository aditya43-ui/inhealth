...
//            $data['judulLaporan']='Data Rincian Tagihan Pasien';
            ...
            if($caraPrint=='PRINT') {
                ...
                $this->render('laboratoriumPA.views.kwitansiLab.viewKwitansi', array('model'=>$model,'pembayarans'=>$pembayarans, 'modPendaftaran'=>$modPendaftaran, 'judulKwitansi'=>$judulKwitansi, 'caraPrint'=>$caraPrint, 'rincianpembayaran'=>$rincianpembayaran,
                                       'modTandaBukti'=>$modTandaBukti,
                                       'modBayar'=>$modBayar));
                ...
                $mpdf->WriteHTML($this->renderPartial('laboratoriumPA.views.kwitansiLab.viewKwitansiPdf',array('model'=>$model,'pembayarans'=>$pembayarans, 'modPendaftaran'=>$modPendaftaran, 'judulKwitansi'=>$judulKwitansi, 'caraPrint'=>$caraPrint, 'rincianpembayaran'=>$rincianpembayaran,
                                       'modTandaBukti'=>$modTandaBukti,
