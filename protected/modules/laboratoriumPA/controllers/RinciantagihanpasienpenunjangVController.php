...
class RinciantagihanpasienpenunjangVController extends MyAuthController
{
	...
	public $path_view = 'laboratoriumPA.views.rinciantagihanpasienpenunjangV.';
...
//                
		...
		$this->render('laboratoriumPA.views.rinciantagihanpasienpenunjangV.index',array(
...
//            $model = new LBRinciantagihanpasienpenunjangV('search');
            ...
            $this->render('laboratoriumPA.views.rinciantagihanpasienpenunjangV.rincian', array(
        ...
        public function actionRemoveTemporary($id)
	{
        ...
        public function actionPrint()
        {
            ...
            if($caraPrint=='PRINT') {
                ...
                $this->render('laboratoriumPA.views.rinciantagihanpasienpenunjangV.rincian', array('modPenunjang'=>$modPenunjang,'modPendaftaran'=>$modPendaftaran, 'modRincian'=>$modRincian, 'data'=>$data, 'caraPrint'=>$caraPrint));
