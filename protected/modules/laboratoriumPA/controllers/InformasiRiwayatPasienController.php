...
//                
		...
		$this->render('laboratoriumPA.views.informasiRiwayatPasien.index',array(
			'model'=>$model,
		));
	}
...
//				}
        ...
        $this->render('laboratoriumPA.views.informasiRiwayatPasien.rincian', array('modHasilPemeriksaan'=>$modHasilPemeriksaan, 'modPasien'=>$modPasien, 'data'=>$data));
    }
        ...
        public function actionPrint()
        {
            ...
            if($caraPrint=='PRINT') {
                ...
                $this->render('laboratoriumPA.views.informasiRiwayatPasien.rincian', array('modHasilPemeriksaan'=>$modHasilPemeriksaan, 'modPasien'=>$modPasien, 'data'=>$data, 'caraPrint'=>$caraPrint));
                ...
                $mpdf->WriteHTML($this->renderPartial('laboratoriumPA.views.informasiRiwayatPasien.rincian',array('modHasilPemeriksaan'=>$modHasilPemeriksaan, 'modPasien'=>$modPasien, 'data'=>$data, 'caraPrint'=>$caraPrint),true));
                $mpdf->Output();
            }                       
        }
