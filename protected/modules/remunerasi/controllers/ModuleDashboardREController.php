...
class ModuleDashboardREController extends ModuleDashboardNeonController
{
  ...
  {
    $this->pageTitle = Yii::app()->name . " - Dashboard Remunerasi";
    $this->render('index');
  }
  ...
  public function actionSetIFrameDashboard()
  {
    ...
    //=== start map ===
    $sql = "SELECT kecamatan_m.kecamatan_nama,kabupaten_m.kabupaten_nama as kabupaten_nama,kabupaten_m.longitude as logitude_kab, kabupaten_m.latitude as latitude_kab,  kecamatan_m.longitude, kecamatan_m.latitude, count(pegawai_m.pegawai_id) as jumlah
    FROM pegawai_m
    ...
    JOIN kabupaten_m ON kabupaten_m.kabupaten_id = pegawai_m.kabupaten_id
				...
				GROUP BY kecamatan_m.kecamatan_nama,kabupaten_m.kabupaten_nama,logitude_kab,  latitude_kab,  kecamatan_m.longitude, kecamatan_m.latitude
  ...
  public function actionSetKabupaten() {
    if (Yii::app()->request->isAjaxRequest) {
        ...
        $criteria->select = "kecamatan_m.kecamatan_nama,kabupaten_m.kabupaten_nama as kabupaten_nama,kabupaten_m.longitude as logitude_kab, kabupaten_m.latitude as latitude_kab,  kecamatan_m.longitude, kecamatan_m.latitude, count(pegawai_m.pegawai_id) as jumlah";
        $criteria->join = 'JOIN kecamatan_m ON kecamatan_m.kecamatan_id = pegawai_m.kecamatan_id
        JOIN kabupaten_m ON kabupaten_m.kabupaten_id = pegawai_m.kabupaten_id';
        ...
        $model = PegawaiM::model()->findAll($criteria);
