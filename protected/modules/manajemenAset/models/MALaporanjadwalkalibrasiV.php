...
class MALaporanjadwalkalibrasiV extends LaporanjadwalkalibrasiV
{
    public $no;
    public $tipe;
    public $total_semua;
    ...
    public function criteriaSearch(){
        ...
        $criteria->select = [
            'sum(sudahkalibrasi_medik) as sudahkalibrasi_medik',
            'sum(jatuhtempo_medik) as jatuhtempo_medik',
            'sum(lewatjatuhtempo_medik) as lewatjatuhtempo_medik',
            'sum(sudahkalibrasi_nonmedik) as sudahkalibrasi_nonmedik',
            'sum(jatuhtempo_nonmedik) as jatuhtempo_nonmedik',
            'sum(lewatjatuhtempo_nonmedik) as lewatjatuhtempo_nonmedik',
            'sum(lewatjatuhtempo_nonmedik+jatuhtempo_nonmedik+sudahkalibrasi_nonmedik+lewatjatuhtempo_medik+jatuhtempo_medik+sudahkalibrasi_medik) as total_semua',
            '(ROW_NUMBER () OVER (
    ...
    */
    ...
    {            
        ...
        foreach($load as $key => $val){            
            ...
            $r[$init]['sudahkalibrasi_medik'] = (isset($r[$val->ruangan_nama]['sudahkalibrasi_medik'])?$r[$val->ruangan_nama]['sudahkalibrasi_medik']:0)+$val->sudahkalibrasi_medik;
            ...
            $r[$init]['sudahkalibrasi_nonmedik'] = (isset($r[$val->ruangan_nama]['sudahkalibrasi_nonmedik'])?$r[$val->ruangan_nama]['sudahkalibrasi_nonmedik']:0)+$val->sudahkalibrasi_nonmedik;
            ...
            $data[$init]['lok'][$init2]['total_sudahkalibrasi_medik'] = $val->sudahkalibrasi_medik;
            ...
            $data[$init]['lok'][$init2]['total_sudahkalibrasi_nonmedik'] = $val->sudahkalibrasi_nonmedik;
        ...
        foreach($r as $key => $val){
            ...
            $res[$temp_no]['total_sudahkalibrasi_medik'] = 0;
            $res[$temp_no]['total_jatuhtempo_medik'] = 0;
            $res[$temp_no]['total_lewatjatuhtempo_medik'] = 0;
            $res[$temp_no]['total_sudahkalibrasi_nonmedik'] = 0;
            ...
            foreach($data[$key]['lok'] as $det){
                ...
                $res[$i]['no'] = $a;
                $res[$i]['total_sudahkalibrasi_medik'] = $det['total_sudahkalibrasi_medik'];
                $res[$i]['total_jatuhtempo_medik'] = $det['total_jatuhtempo_medik'];
                $res[$i]['total_lewatjatuhtempo_medik'] = $det['total_lewatjatuhtempo_medik'];
                $res[$i]['total_sudahkalibrasi_nonmedik'] = $det['total_sudahkalibrasi_nonmedik'];
                ...
                $res[$temp_no]['total_sudahkalibrasi_medik'] += $det['total_sudahkalibrasi_medik'];
                ...
                $res[$temp_no]['total_sudahkalibrasi_nonmedik'] += $det['total_sudahkalibrasi_nonmedik'];
            ...
            $res[$temp_no]['total_sudahkalibrasi_medik'] = '<b>'.$res[$temp_no]['total_sudahkalibrasi_medik'].'</b>';
            ...
            $res[$temp_no]['total_sudahkalibrasi_nonmedik'] = '<b>'.$res[$temp_no]['total_sudahkalibrasi_nonmedik'].'</b>';
        ...
        if (!empty($load)){
            if ($tipe != 'pie'){
                ...
                $grafik['datasets'][0]['data'] = [
                    'NaN',$load->sudahkalibrasi_medik,'Nan'
                ];                
                $grafik['datasets'][0]['backgroundColor'] = '#13b7b4'; 
                $grafik['datasets'][0]['label'] = 'Sudah Kalibrasi - Alat Medik';   
                ...
                $grafik['datasets'][3]['data'] = [
                    'NaN',$load->sudahkalibrasi_nonmedik,'Nan'
                ];                
                $grafik['datasets'][3]['backgroundColor'] = '#ff4558'; 
                $grafik['datasets'][3]['label'] = 'Sudah Kalibrasi - Alat Non Medik';
