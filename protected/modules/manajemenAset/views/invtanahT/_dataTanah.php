...
>>>>>>> 152b37e85d299dbd8eb1b7ff84973d587254cd55
             ...
             */ ?>
            <div class="control-group ">
                <?php echo CHtml::activeLabel($modBarang, 'jmlterima',array('class'=>'control-label', 'label'=>'Jumlah Terima Belum Inventarisasi')); ?>
        ...
        <div class="col-sm-6">
            <div class="control-group ">
                <label class="control-label" for="barang_type">
                    <?php echo CHtml::label("Sub-Sub Kelompok Barang",'subsubkelompok_nama', array('class'=>'control-label', 'label'=>'Sub-Sub Kelompok Barang'));?>
                </label>
                <div class="controls">
...
$this->beginWidget('zii.widgets.jui.CJuiDialog', array( // the dialog
    'id'=>'dialogBarang',
    'options'=>array(
        'title'=>'Data Inventarisasi Tanah',
        'autoOpen'=>false,
        'modal'=>true,
        'width'=>800,
        'height'=>600,
