...
<div class="panel panel-primary" id="charts_env">
	<div class="panel-heading">
		 <div class="panel-title with-tabs">Inventarisasi Aset Bulan Ini</div>
		...
		<thead>
			<tr>
				<th width="50%" class="col-padding-1">
					<div class="pull-left">
						<div class="h4 no-margin">Total Inventarisasi Aset s/d Bulan ini</div>
                                                <small><?php echo MyFormatter::formatNumberForPrint((float)$dataKolom[5],2); ?></small>
					</div>
...
$(document).ready(function($) 
{
	...
	Morris.Area({
				...
				foreach ($dataAreaChart as $i => $chart) { ?>
					{ x: "<?php echo date("d",strtotime($chart['create_time'])); ?>", 
						...
						y_4: <?php echo isset($chart['jumlah_4']) ? $chart['jumlah_4'] : 0; ?>,
                                                y_5: <?php echo isset($chart['jumlah_5']) ? $chart['jumlah_5'] : 0; ?> 
                                        },
				<?php }
			}
			?>
		...
		labels: ['Inventarisasi Tanah','Inventarisasi Peralatan dan Mesin','Inventarisasi Gedung dan Bangunan','Inventarisasi Jalan Irigasi dan Jaringan Hari Ini','Aset Tetap Lainnya'],
		parseTime: false,
	...
	Morris.Line({
		...
		xkey: 'x',
		ykeys: ['y_1','y_2','y_3','y_4','y_5'],
		labels: ['Inventarisasi Tanah','Inventarisasi Peralatan dan Mesin','Inventarisasi Gedung dan Bangunan','Inventarisasi Jalan Irigasi dan Jaringan','Aset Tetap Lainnya'],
		parseTime: false,
		lineColors: [getRandomColor(),getRandomColor(),getRandomColor(),getRandomColor(),getRandomColor()],
	});
    // Donut Chart
