            ...
            <div class="row-fluid">
                <div class="col-sm-6">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                           <?php echo Chtml::textField('nama_sertifikat','', array('class' => 'span3','placeholder'=>'Ketik No Sertifikat', 'onkeypress' => "return $(this).focusNextInputField(event);")); ?>
                        </div>
                    </div>
                    <div class="control-group">
                        <?php echo Chtml::label("Keterangan",'',array('class' => 'control-label')); ?>
                        <div class="controls">
                           <?php echo Chtml::textArea('sertifikat_ket','', array('class' => 'span3','placeholder'=>'Ketik No Sertifikat', 'onkeypress' => "return $(this).focusNextInputField(event);")); ?>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6">
                    ...
                    <tbody>
                        ...
                        if(count($modSertifikat) > 0){
                            foreach($modSertifikat AS $i=> $modDetail){
                                ...
                                echo $this->renderPartial($this->path_view.'_rowDetail',array('modSertifikat'=> $modDetail));
                            }
                        }
                        ?>
                    </tbody>
