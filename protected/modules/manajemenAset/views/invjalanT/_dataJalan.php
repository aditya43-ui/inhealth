    ...
    <div class="panel-body">
        <div class="col-sm-6">
            ...
            <div class="control-group">
                <?php echo CHtml::activeLabel($model, 'nopenerimaan', array(
                    'class'=>'control-label',
                )); ?>
                <div class="controls">
                    <?php echo CHtml::activeHiddenField($model, 'terimapersediaan_id', array(
                        'id'=>'terimapersediaan_id'
                    )); ?>
                    <?php 
                        $this->widget('MyJuiAutoComplete', array(
                            ...
                            'source'=>'js: function(request, response) {
                                           $.ajax({
                                               url: "'.Yii::app()->createUrl('ActionAutoComplete/getTerimaPersediaan').'",
                                               dataType: "json",
                                               data: {
                                                   term: request.term,
                             ...
                             'options'=>array(
                                   ...
                                   'select'=>'js:function( event, ui ) { 
                                        setTerimaPersediaan(ui.item);
                                        return false;
                                    }',
                            ),
                            'htmlOptions'=>array(
                                    'placeholder'=>'Ketik Nomor Perolehan Barang','onkeypress'=>"return $(this).focusNextInputField(event)",'class'=>'required'
                            ),
...
>>>>>>> 152b37e85d299dbd8eb1b7ff84973d587254cd55
            ...
            <div class="control-group ">
                ...
                <div class="controls">
                   <?php echo CHtml::activeTextField($modBarang, 'jmlterima', array('readonly'=>true, 'class'=>'span1')); ?>
                </div>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="control-group ">
                <label class="control-label" for="barang_type">
                    <?php echo CHtml::label("Sub-sub Kelompok Barang",'subsubkelompok_nama', array('class'=>'control-label', 'label'=>'Kode Sub Sub Kelompok'));?>
                </label>
                <div class="controls">
            ...
            <div class="control-group ">
                <label class="control-label" for="barang_kode">
                    <?php echo CHtml::label("Kode Sub-sub Kelompok Barang",'subsubkelompok_kode', array('class'=>'control-label', 'label'=>'Kode Sub Sub Kelompok'));?>
                </label>
                <div class="controls">
...
$this->beginWidget('zii.widgets.jui.CJuiDialog', array( // the dialog
    'id'=>'dialogBarang',
    'options'=>array(
        'title'=>'Data Inventarisasi Jalan Irigasi dan Jaringan',
        'autoOpen'=>false,
        'modal'=>true,
        'width'=>800,
        'height'=>600,
...
$barang->golongan_kode = ParamsConst::GOLONGAN_KODE_JALAN_IRIGASI_JARINGAN;
