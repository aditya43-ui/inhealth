...
<div>
    ...
    <?php $this->renderPartial('_dataJalan', array('form'=>$form,'modBarang' => $modBarang, 'model' => $model, 'jenisAset'=>'04')); ?>
    <div class="panel panel-primary panel-success">
        <div class="panel-heading">
            <div class="panel-title">											
                <i class="glyphicon glyphicon-file"></i> Data Inventarisasi Jalan Irigasi dan Jaringan																	
            </div>
        </div>
        <div class="panel-body">
            <div class="row-fluid">
                <div class="col-sm-6">
                    ...
                    <?php echo $form->textFieldRow($model, 'invjalan_kode', array('readonly'=>true,'class' => 'span2', 'onkeypress' => "return $(this).focusNextInputField(event);", 'maxlength' => 50)); ?>
                    <div class="control-group">
                        <?php echo $form->labelEx($model, 'invjalan_noregister', array(
                            'class'=>'control-label',
                            'label'=>'Kode Lokasi',
                        )); ?>
                        <div class="controls">
                            <?php echo $form->textField($model,'invjalan_noregister',array('readonly'=>true,'class'=>'span3', 'onkeypress'=>"return $(this).focusNextInputField(event);", 'maxlength'=>50)); ?>        
                        </div>
                    </div>
                    ...
                    <?php echo $form->textFieldRow($model, 'invjalan_kontruksi', array('class' => 'span3', 'onkeypress' => "return $(this).focusNextInputField(event);", 'maxlength' => 20)); ?>
                    <?php /*
                    <div class="control-group">
                    ...
                    <?php echo $form->textFieldRow($model, 'nomerkodetanah', array('class' => 'span2 ', 'onkeypress' => "return $(this).focusNextInputField(event);", 'maxlength' => 30)); ?>
                ...
                <div class="col-sm-6">
                    <div class="control-group">
                        <?php echo $form->labelEx($model, 'invjalan_panjang', array(
                            'class'=>'control-label',
                        )); ?>
                        <div class="controls">
                            <?php echo $form->textField($model, 'invjalan_panjang', array('class' => 'span2 float2', 'style'=>'text-align: right;', 'onkeypress' => "return $(this).focusNextInputField(event);", 'maxlength' => 30)); ?>
                            <label>m</label>
                        </div>
                    </div>
                    <div class="control-group">
                        <?php echo $form->labelEx($model, 'invjalan_lebar', array(
                            'class'=>'control-label',
                        )); ?>
                        <div class="controls">
                            <?php echo $form->textField($model, 'invjalan_lebar', array('class' => 'span2 float2', 'style'=>'text-align: right;', 'onkeypress' => "return $(this).focusNextInputField(event);", 'maxlength' => 30)); ?>
                            <label>m</label>
                            
                        </div>
                    </div>
                    <div class="control-group">
                        <?php echo $form->labelEx($model, 'invjalan_luas', array(
                            'class'=>'control-label',
                        )); ?>
                        <div class="controls">
                            <?php echo $form->textField($model, 'invjalan_luas', array('class' => 'span2 float2', 'style'=>'text-align: right;', 'onkeypress' => "return $(this).focusNextInputField(event);", 'maxlength' => 30)); ?>
...
<?php echo $form->labelEx($model, 'invjalan_tglguna', array('class' => 'control-label')) ?>
                    ...
                    <?php echo $form->textFieldRow($model, 'invjalan_harga', array('id'=>'harga_tanah', 'class' => 'span2 integer2', 'onkeypress' => "return $(this).focusNextInputField(event);")); ?>
                    <div class="control-group">
                        <?php echo $form->labelEx($model, 'invjalan_akumsusut', array(
                            'class'=>'control-label',
                        )); ?>
                        <div class="controls">
                            <?php echo $form->textField($model, 'invjalan_akumsusut', array('class' => 'span1 float2', 'style'=>'text-align: right;', 'onkeypress' => "return $(this).focusNextInputField(event);", 'maxlength' => 30)); ?>
                            <label>%</label>
...
<script>
    function setKodeRegister(barang_id) {
        $.ajax({
            ...
            dataType: "json",
            success: function (data) {
                $('#MAInvjalanT_invjalan_noregister').val(data.value);
                $('#MAInvjalanT_invjalan_kode').val(data.kode);
            },
