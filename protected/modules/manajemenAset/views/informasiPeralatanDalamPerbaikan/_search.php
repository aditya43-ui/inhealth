...
<div class="col-sm-6">
    ...
    <div class="control-group">
        <label class="control-label">Jenis Perbaikan</label>
        <div class="controls">
            <?= CHtml::activeDropDownList($model, 'jenis_perbaikan', LookupM::getItemsUrutan('jenisperbaikanalat'),['empty'=>'-- Pilih --']) ?>
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <?= CHtml::activeDropDownList($model, 'status', LookupM::getItemsUrutan('statusperbaikanalat'),['empty'=>'-- Pilih --']) ?>
        </div>
    </div>
</div>
</div>
