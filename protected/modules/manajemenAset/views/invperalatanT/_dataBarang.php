                        ...
                        $this->widget('MyJuiAutoComplete', array(
                            ...
                            'options' => array(
                                ...
                                'select'=>'js:function( event, ui ) {
                                    ...
                                    $("#MAInvperalatanT_terimapersdetail_id").val(ui.item.terimapersdetail_id);   
...
$barang->golongan_kode = ParamsConst::KODE_GOLONGAN_MESIN_ALAT;
...
$this->widget('ext.bootstrap.widgets.BootGridView',array(
    'id'=>'barang-v-grid',
    'dataProvider'=>$barang->searchDialogAsetAlat(),
    'filter'=>$barang,
        'template'=>"{summary}\n{items}\n{pager}",
        ...
        array(
            ...
            'value'=>'CHtml::Link("<i class=\"icon-form-check\"></i>",
                        ...
                        array(
                            ...
                            $(\"#MAInvperalatanT_terimapersdetail_id\").val($data->terimapersdetail_id);   
