...
$this->renderPartial($this->path_view.'kalibrasiPeralatanMesin.grid._table', array('model'=>$model, 'caraPrint'=>$caraPrint)); 

if ($caraPrint == 'GRAFIK-NOT-AUTO'){
    echo $this->renderPartial($this->path_view.'kalibrasiPeralatanMesin._grafik', array('model'=>$model, 'caraPrint'=>$caraPrint), true); 
    echo $this->renderPartial($this->path_view.'kalibrasiPeralatanMesin._jsFunction', array('model'=>$model), true); 
}
?>
