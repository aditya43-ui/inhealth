...
$period = 'Periode : '.$periode.$ged_text.$ru_text.$lok_text;
...
$this->renderPartial($this->path_view.'rekapitulasiPemerliharaanAset._table', array('model'=>$model, 'caraPrint'=>$caraPrint)); 

if ($caraPrint == 'GRAFIK-NOT-AUTO'){
    echo $this->renderPartial($this->path_view.'rekapitulasiPemerliharaanAset._grafik', array('model'=>$model, 'caraPrint'=>$caraPrint), true); 
    echo $this->renderPartial($this->path_view.'rekapitulasiPemerliharaanAset._jsFunction', array('model'=>$model), true); 
}
