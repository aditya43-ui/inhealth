<div class="search-form" style="">
    ...
    $sumberdana = CHtml::listData(SumberdanaM::model()->findAll(" sumberdana_aktif = TRUE ORDER BY sumberdana_nama ASC "), 'sumberdana_nama', 'sumberdana_nama')
    ?>
        ...
        <div class="col-sm-6">                
            <?= CHtml::hiddenField('type','bar'); ?>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <?= $form->dropDownList($model,'tahun_perolehan', CustomFunction::getTahun(5,5),['class'=>'span3 tahun_perolehan']) ?>
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <?= $form->dropDownList($model,'sumberdana', $sumberdana,['empty'=>'-- Pilih --','class'=>'span3 sumberdana']) ?>
                    </div>
                </div>
