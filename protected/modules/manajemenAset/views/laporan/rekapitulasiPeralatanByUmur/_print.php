...
$this->renderPartial($this->path_view.'rekapitulasiPeralatanByUmur._table', array('model'=>$model, 'caraPrint'=>$caraPrint)); 

if ($caraPrint == 'GRAFIK-NOT-AUTO'){
    echo $this->renderPartial($this->path_view.'rekapitulasiPeralatanByUmur._grafik', array('model'=>$model, 'caraPrint'=>$caraPrint), true); 
    echo $this->renderPartial($this->path_view.'rekapitulasiPeralatanByUmur._jsFunction', array('model'=>$model), true); 
}
