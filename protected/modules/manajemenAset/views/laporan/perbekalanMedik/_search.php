<div class="search-form" style="">
    ...
    <div class="row-fluid">
        <div class="col-sm-6">                            
            ...
            <div class="control-group">
                <label class="control-label">Jenis Perbekalan</label>
                <div class="controls">
                    <?= $form->dropDownList($model,'invpersparepart_jenis', LookupM::getItemsUrutan('perbekalan_jenis'),['empty'=>'-- Pilih --','onkeypress' => "return $(this).focusNextInputField(event);"]) ?>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-6">
                            ...
                            'attribute'=>'nama_aset',                                
                                    ...
                                    'options'=>array(
                                        ...
                                        'select'=>'js:function( event, ui ) { 
                                            ...
                                            $(".nama_aset").val(ui.item.barang_nama);                                        
                                            return false;
                                        }',
                                    ),
                                    'htmlOptions'=>array(
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?= $form->textField($model,'invperalatan_kode',['placeholder'=>'Ketik nomor aset','onkeypress' => "return $(this).focusNextInputField(event);"]) ?>
                </div>
            </div>
            
            <div class="control-group">
                <label class="control-label">Nama Perbekalan</label>
                <div class="controls">
                    <?= $form->textField($model,'nama_perbekalan',['placeholder'=>'Ketik nama perbekalan','onkeypress' => "return $(this).focusNextInputField(event);"]) ?>
                </div>
            </div>
        </div>
    </div>
