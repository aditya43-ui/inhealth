...
$this->renderPartial($this->path_view.'rekapitulasiKondisiAset.grid._table', array('model'=>$model, 'caraPrint'=>$caraPrint)); 

if ($caraPrint == 'GRAFIK-NOT-AUTO'){
    echo $this->renderPartial($this->path_view.'rekapitulasiKondisiAset._grafik', array('model'=>$model, 'caraPrint'=>$caraPrint), true); 
    echo $this->renderPartial($this->path_view.'rekapitulasiKondisiAset._jsFunction', array('model'=>$model), true); 
}
