...
echo $this->renderPartial('application.views.headerReport.headerLaporanTransaksiNew',array('judulLaporan'=>$judulLaporan, 'periode'=>$period, 'colspan'=>5));  


if ($caraPrint != 'GRAFIK-NOT-AUTO')
$this->renderPartial($this->path_view.'rekapitulasiPeralatanBySumberDana._table', array('model'=>$model, 'caraPrint'=>$caraPrint)); 

if ($caraPrint == 'GRAFIK-NOT-AUTO'){
    echo $this->renderPartial($this->path_view.'rekapitulasiPeralatanBySumberDana._grafik', array('model'=>$model, 'caraPrint'=>$caraPrint), true); 
    echo $this->renderPartial($this->path_view.'rekapitulasiPeralatanBySumberDana._jsFunction', array('model'=>$model), true); 
}
