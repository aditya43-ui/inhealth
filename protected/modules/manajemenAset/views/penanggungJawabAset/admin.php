...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title"> <i class="fas fa-layer-group"></i> Pengaturan <strong>Penanggung Jawab Aset Ruangan</strong></div>
    </div>
...
<?php echo CHtml::link(Yii::t('mds', '{icon} Advanced Search', array('{icon}' => '<i class="icon-accordion icon-white"></i>')), '#', array('class' => 'search-button btn')); ?>
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title"><i class="entypo-credit-card"></i> Tabel <strong>Penanggung Jawab Aset Ruangan</strong></div>
            </div>
        ...
        <?php
        echo CHtml::link(Yii::t('mds', '{icon} Tambah Penanggung Jawab Aset Ruangan', array('{icon}'=>'<i class="entypo-folder"></i>')),
...
<script type="text/javascript">
    ...
    function deleteRecord(id) {
        ...
        myConfirm("Apakah Anda yakin ingin menghapus ini ?", "Perhatian!", function (r) {
            if (r) {
                $.post(url, {id: id},
                        function (data) {
                            if (data.status == 'proses_form') {
