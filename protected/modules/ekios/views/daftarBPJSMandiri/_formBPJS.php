...
<div class="form_panel form_bpjs" style="display: none;">
    <div style="font-size: 15pt; font-family: Roboto !important; color:black">DATA PASIEN</div>
    <hr>
    <div class="panel-body">
        <div class="row-fluid">
            <div class="col-sm-6">
                <div class="control-group ">
                    <label class="control-label" style="font-family: Roboto !important; padding-right: 80px !important; font-size: 13pt !important; width: 260px !important;"> No. RM </label>
                    <div class="controls">
                        <?php 
                            echo $form->textField($modPasien, 'no_rekam_medik', array(
                            'class'=>'span3', 'readonly'=>true, 'style'=>'font-family: Roboto !important; height: 40px !important; font-size: 13pt !important; width: 300px !important;'
                            )); 
                        ?>
                    </div>
                </div>
                <div class="control-group ">
                    <label class="control-label" style="font-family: Roboto !important; padding-right: 80px !important; font-size: 13pt !important; width: 260px !important;"> No. Kartu Asuransi </label>
                    <div class="controls">
                        <?php 
                            echo $form->textField($modSep, 'nokartuasuransi', array(
                            'class'=>'span3', 'readonly'=>true, 'style'=>'font-family: Roboto !important; height: 40px !important; font-size: 13pt !important; width: 300px !important;'
                            )); 
                        ?>
                    </div>
                ...
                <div class="control-group ">
                    <label class="control-label" style="font-family: Roboto !important; padding-right: 80px !important; font-size: 13pt !important; width: 260px !important;"> No. Identitas Pasien </label>
                    <div class="controls">
                        <?php 
                ...
                <div class="control-group ">
                    <label class="control-label" style="font-family: Roboto !important; padding-right: 80px !important; font-size: 13pt !important; width: 260px !important;"> Nama Pasien </label>
                    <div class="controls">
                        <?php 
                ...
                <div class="control-group ">
                    <label class="control-label" style="font-family: Roboto !important; padding-right: 80px !important; font-size: 13pt !important; width: 260px !important;"> Tanggal Lahir </label>
                    <div class="controls">
                        <?php 
                            echo $form->textField($modPasien, 'tanggal_lahir', array(
                            'class'=>'span3', 'readonly'=>true, 'style'=>'font-family: Roboto !important; height: 40px !important; font-size: 13pt !important; width: 300px !important;'
                            )); 
                        ?>
                    </div>
            ...
            <div class="col-sm-6">
                <div class="control-group ">
                    <label class="control-label" style="font-family: Roboto !important; padding-right: 80px !important; font-size: 13pt !important; width: 260px !important;"> Poliklinik Tujuan </label>
                    <div class="controls">
                        <?php 
                            echo $form->textField($model, 'ruangan_id', array(
                            'class'=>'span3', 'readonly'=>true, 'style'=>'font-family: Roboto !important; height: 40px !important; font-size: 13pt !important; width: 300px !important;'
                            )); 
                        ?>
                    </div>
                ...
                <div class="control-group ">
                    <label class="control-label" style="font-family: Roboto !important; padding-right: 80px !important; font-size: 13pt !important; width: 260px !important;"> Dokter </label>
                    <div class="controls">
                        <?php 
                            echo $form->textField($model, 'pegawai_id', array(
                            'class'=>'span3', 'readonly'=>true, 'style'=>'font-family: Roboto !important; height: 40px !important; font-size: 13pt !important; width: 300px !important;'
                            )); 
                        ?>
                    </div>
                ...
                <div class="control-group ">
                    <label class="control-label" style="font-family: Roboto !important; padding-right: 80px !important; font-size: 13pt !important; width: 260px !important;"> Tgl. Pendaftaran </label>
                    <div class="controls">
                        <?php 
                            echo $form->textField($model, 'tgl_pendaftaran', array(
                            'class'=>'span3', 'readonly'=>true, 'style'=>'font-family: Roboto !important; height: 40px !important; font-size: 13pt !important; width: 300px !important;'
                            )); 
                        ?>
                    </div>
                ...
                <div class="control-group ">
                    <label class="control-label" style="font-family: Roboto !important; padding-right: 80px !important; font-size: 13pt !important; width: 260px !important;"> No. Booking </label>
                    <div class="controls">
                        <?php 
                            echo $form->textField($model, 'no_buatjanji', array(
                            'class'=>'span3', 'readonly'=>true, 'style'=>'font-family: Roboto !important; height: 40px !important; font-size: 13pt !important; width: 300px !important;'
                            )); 
                        ?>
                    </div>
                ...
                <div class="control-group ">
                    <label class="control-label" style="font-family: Roboto !important; padding-right: 80px !important; font-size: 13pt !important; width: 260px !important;"> No. Antrian </label>
                    <div class="controls">
                        <?php 
                            echo $form->textField($model, 'no_urutantri', array(
                            'class'=>'span3', 'readonly'=>true, 'style'=>'font-family: Roboto !important; height: 40px !important; font-size: 13pt !important; width: 300px !important;'
                            )); 
                        ?>
                    </div>
    ...
    <div class="form_bpjs_sep">
        <div style="font-size: 15pt; color:black">DATA SEP</div>
        <hr>
        <div class="panel-body">
    ...
    <div class="form-action">
        <?php 
            echo CHtml::htmlButton("<i class=\"entypo-home\"></i> HOME", array(
                "onclick"=>"kembali()",
                'style'=> 'height: 50px; width: 130px; font-size: 15px !important; border-radius: 50px; text-align: center; color: white; background-color: #00008B;'
            ));
        ?> 
        <?php
            echo CHtml::htmlButton(
                ...
                array(
                    ...
                    'title' => 'Simpan', 
                    'id' => 'btnSubmit',
                    'style'=> 'height: 50px; width: 130px; border-radius: 50px; font-size: 15px !important; text-align: center; color: white; background-color: #006400;'
                )
            );
        ?>
        <?php echo CHtml::htmlButton("Ulangi", array(
            'style'=> 'height: 50px; width: 130px; font-size: 15px !important; border-radius: 50px; text-align: center; color: white; background-color: #8B0000;',
...
<script>
    ...
    function cekTandaTangan(){
        if ($("#tampung_gambar tr").length == 0){
            ...
            $("#pesan").html("<p>Mohon Menunggu. Data Anda sedang Diproses :)</p>")
        ...
        var setting = {
            ...
            success: function(data) {
                ...
                if (obj.response.rujukan != null) {
                    ...
                    $("#<?php echo CHtml::activeId($modSep, 'politujuan') ?>").val($("#PPPendaftaranT_kode_ruangan_bpjs").val());
