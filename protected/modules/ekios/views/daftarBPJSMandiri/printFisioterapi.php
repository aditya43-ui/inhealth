        ...
        <td colspan="4">
            <table border="0" style="text-align:left;">
                <tr>
                    ...
                    <td width="1%">:</td>
                    <td width="20%"><?php echo $dataSep->peserta->jnsPeserta;//isset($modAsuransiPasienBpjs->jenispeserta_bpjs) ? $modAsuransiPasienBpjs->jenispeserta_bpjs : '-'; ?></td>
                ...
                <tr>
                    <td>No SRK</td>
                    <td>:</td>
                    <td><b><?php echo !empty($dataSep->kontrol->noSurat) ? $dataSep->kontrol->noSurat : '-'; ?></b></td>
                    <td>COB</td>
                    <td>:</td>
                    <td><?php echo ($dataSep->cob == 0) ? "-" : $modSep->no_asuransi_cob . "-" . $modSep->namaasuransi_cob; ?></td>
                </tr>
                <tr>
                    <td>Tgl. SEP</td>
                    <td>:</td>
                ...
                <tr>
                    <td>Nama Peserta</td>
                    <td>:</td>
                    <td><?php echo  $dataSep->peserta->nama;//$modPasien->nama_pasien; ?></td>
                    <td>Jns. Kunjungan</td>
                    <td>:</td>
                    <td colspan="2"><?php
...
<br><br>
<h4 style="text-decoration-line: underline; text-align: center;">
    BUKTI PELAYANAN PESERTA JKN DI INSTALASI RAWAT JALAN DAN IGD RS WILLIAM BOOTH SURABAYA
</h4>
<center>
    (Mohon Diisi Dengan Lengkap Sebagai Lampiran Tagihan)
</center>
<br>
<br>

<table height="800px" style="position: fixed;">
    <tr>
        <td>Anamnesa </td>
...
<?php 
    ...
    $cropKota = $data->kabupaten->kabupaten_nama;
    $hasil = explode(" ",$cropKota);
    $surabaya = strtolower($hasil[1]);

?>
<table width="100%" style="position: fixed;bottom: 18px;">
    <tr>
        <td style="margin-top: 0;">
            <br/><br/><br/>
                <font style="text-transform: capitalize;"><?php echo $surabaya.", ".MyFormatter::formatDateTimeId(date("d M Y")); ?></font>
            <br>
                Dokter yang merawat,
        ...
        <td align="center" style="font-size: 11pt !important; line-height:20px;"><br><br><br>Pasien / Keluarga<br><br><br>
        <?php if (empty($modSep->ttd_link)) { ?>
                    <?php } else {
                        $url = Params::urlSignSepDirectory() . $modSep->ttd_link;
                    ?>
