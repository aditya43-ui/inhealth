...
<div class="form_panel form_utama">
    <div class="form_main">
        ...
        <div style="display: none;" id="proses-cetak">
            <p style="font-weight: bold; font-size: 20pt; margin-top: 100px;">
                Sistem Sedang Melakukan Proses Cetak
            </p>
        </div>
    </div>
</div>
...
<script>
    ...
    function printSep() {
        ...
        $("#proses-cetak").attr("style", "display: block");
    }
