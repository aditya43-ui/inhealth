...
<table width="100%" border = "0" style = "text-align:left;">
   ...
   <th style="padding-top: 40px; margin-right:5px;" width = "93px">
        <center>
    ...
    <td colspan = "4">
        <table border = "0"  style = "text-align:left;">
            ...
            <tr>
                ...
                echo !empty($modSep->penjamin_lakalantas)?$modSep->penjamin_lakalantas:$modPenjamin->penjamin_nama; 
                ?></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                ?>
                <td style="text-align:justify;font-size: 13pt !important;" colspan="5"><?php echo $diagnosa; ?></td>
            </tr>
            <tr>
