        ...
        <div class="control-group">
            ...
            <div class="controls">
                ...
                <?php echo CHtml::htmlButton('<i class="entypo-search"></i>',
                        array('onclick'=>'cariDataNoRujukan();return false;',
...
//        var katakunci2 = '<?php echo date('Y-m-d')?>';
        var katakunci3 = $('#norujukan').val();
        var tujuan = $("#input_klinik_tujuan :selected").data("kode");
        if (<?php echo ($konfig->isbridging == TRUE) ? 1 : 0; ?>) {
        } else {
        ...
        var setting = {
            ...
            type: 'GET',
            dataType: 'html',
            data : 'param=13&query=' + katakunci3,
            beforeSend: function () {
            ...
            success: function (data) {
                ...
                if(list.length > 0){
                    ...
                    for(var i=0; i<list.length; i++){
                        ...
                        // if (tujuan != null && objRjl.poliRujukan.kode != tujuan) {
                        //     continue;
                        // }

                        if (objRjl.asalFaskes != null && objRjl.asalFaskes != "") {
                            console.log("set data asal faskes");
                            asalFaskes = objRjl.asalFaskes;
                        }


                        var on_click = "getRujukanNoRujukan('"+objRjl.noKunjungan+"', '"+asalFaskes+"'); $('#dialogNoRujukan').dialog('close');";
                    ...
                    // $("#data_rujukan").val(JSON.stringify(list));

                    if (cnt == 0) {
                        myAlert("Rujukan tidak ditemukan");
                    }
                }
