...
if (!isset($_GET['frame'])) {
    ...
    <table width="100%">
            ...
            <tr>
                <td>
                    ...
                    <?php if(isset($caraPrint)) {?>
                        <?php
                            echo $this->renderPartial('application.views.headerReport.headerDefaultNew', array('table_width' => '80%'));
                            ?>
                        ...
                        <table class="identitas" width="100%">
                            <tr>
                                ...
                                <tr>
                                    ...
                                    ?>
                                    <?php echo $modpenjamin->penjamin_nama ?></td></td>
        ...
        <td></td>
        <?php if ($modPembayaran->selisihuntungrugibpjs > 0): ?>
                <td colspan="9">Jaminan :<?php echo MyFormatter::formatNumberForPrint($modPembayaran->selisihuntungrugibpjs, 2); ?></td>
            <?php endif; ?>
