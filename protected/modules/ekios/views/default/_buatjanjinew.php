                ...
                <div class="wizard">
                    ...
                    <div class="tab-content">
                            ...
                            <div class="row" id="menudokumen">
                                <div class="col-xs-6 ">
                                    <a href="#" onclick="setPasien('pasienlama')">
                                        <div class="tile-stats tile-purple" style="background-color:#c31884;height:100px;">
                                            <div class="icon"><i class="entypo-doc-text"></i></div>
                                            <div class="num" style="color:#c31884; font-size:14pt"><b>Pasien Lama</b></div>
                                ...
                                <div class="col-xs-6">
                                    <a href="#" onclick="setPasien('pasienbaru')">
                                        <div class="tile-stats tile-purple" style="background-color:#c31884;height:100px;">
                                            <div class="icon"><i class="entypo-doc-text"></i></div>
                                            <div class="num" style="color:#c31884;font-size:14pt"><b>Pasien Baru</b></div>
                        ...
                        <div class="tab-pane" role="tabpanel" id="step6">
                            <?php echo $this->renderPartial('kelompokbuatjanji/formtindakan', array('form' => $form, 'modPPBuatJanjiPoli' => $modPPBuatJanjiPoli)); ?>
        ...
        function inputkontrol(obj) {
            ...
            if ($(obj).is(':checked')) {
                ...
                $.ajax({
                    ...
                    // data: {kelompoktindakan_nama: $(this).val()}, //
                    dataType: "json",
                    success: function(data) {
                        $('#tampil').append(data.form);
                        $('#tampil').removeClass("animation-loading");
