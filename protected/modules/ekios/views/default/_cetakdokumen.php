...
<body>
    ...
    <div class="tab form-user1" align="center">
        <div>
            <h1><b>Cetak Dokumen</b></h1>
        </div><br>
        <p><?php echo $form->textField($modPasien, 'no_rekam_medik', array('placeholder' => 'Nomer Rekam Medik', 'onkeypress' => "return $(this).focusNextInputField(event)", 'class' => 'span12',)); ?></p>
        <div style="position:relative;height:50px">
            <div style="position:absolute;top: 50%;left: 50%;transform: translate(-50%, -50%);">
                ...
                $this->widget('MyDateTimePicker', array(
                    ...
                    'htmlOptions' => array(
                        'placeholder' => 'tanggal lahir', 'readonly' => true, 'id' => 'picker', 'style' => 'margin:auto', 'class' => 'span12 dtPicker3 ', 'onkeypress' => "return $(this).focusNextInputField(event)"
                    ),
                ));
                ?>
    ...
    <div style="overflow:auto;">
        <div style="float:right;">
            ...
            <button type="button" style="background-color:#57a595" id="nextBtn" onclick="nextPrev(1)">Lanjutkan</button>
            <button type="button" id="prevlist" onclick="showlist();">Kembali</button>
