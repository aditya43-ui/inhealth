...
<head>
    ...
    if (isset($_GET['sukses'])) {
        ...
        if (isset($_GET['sep_id']) || isset($_GET['pendaftaran_id'])) {
            echo "<script>
                    function autoPrint() {
                        setTimeout(function() {
    ...
    <div class="bases">
        <div class="row">
            ...
            <div class="col-sm-9" style="text-align: right;margin-top:5px;margin-right:10px;" hidden>
                <?php echo CHtml::image(Yii::app()->getBaseUrl('webroot') . "/images/dokter/link_4.png", 'RSSA', array(
                    'style' => 'width: 100px;',
                )); ?>
                <?php echo CHtml::image(Yii::app()->getBaseUrl('webroot') . "/images/dokter/link_3.png", 'RSSA', array(
                    'style' => 'width: 100px; ',
                )); ?>
                <?php echo CHtml::image(Yii::app()->getBaseUrl('webroot') . "/images/dokter/link_2.png", 'RSSA', array(
                    'style' => 'width: 100px; ',
                )); ?>
                <?php echo CHtml::image(Yii::app()->getBaseUrl('webroot') . "/images/dokter/link_1.png", 'RSSA', array(
                    'style' => 'width: 100px;',
                )); ?>
            </div>
        </div>
        <div id="header" class="row">
            <div class="col-sm-3" style="padding-right: 50px;">
                <div>
                    ...
                    <?php
                    echo CHtml::image(Params::urlProfilRSDirectory() . $modProfilRs->logo_rumahsakit, 'rssa', array(
                        'style' => 'width: 210px; margin-top: 90px',
                    ));
                    ?>
                    <?php //echo Params::urlProfilRSDirectory() . $modProfilRs->logo_rumahsakit; 
                    ?>
                </div>
        ...
        <div class="row" style="margin: 200px auto 200px auto;width:fit-content;">
            <div class="grid-container">
                <div>
                    <a href='<?php echo Yii::app()->createUrl('ekios/default/Create/') ?>'>
                        <table style="font-size: 20px; background-color:none; text-align:center;" style="width:100%">
                            <tr>
                                <td rowspan="2" style="background-color:#AEB7AE;"><span style='color:green;font-size:80px;'><i class='entypo-calendar'></i></span></i></span></td>
                                <td style="border-bottom:1px solid black;font-weight:bold;">1. BOOKING</td>
                            </tr>
                            <tr>
                                <td style="text-align:center;background-color:#AEB7AE;font-weight:bold;">BOOKING</td>
                            </tr>
                        </table>
                        <table style="text-align:center;">
                            <tr>
                                <td colspan="2" style="background-color:#AEB7AE;">
                                    <p style="background-color: none;">Booking jadwal dengan dokter spesialis atau umum di poliklinik</p>
                                </td>
                            </tr>
                        </table>
                    </a>
                ...
                <div>
                    <a href="<?php echo Yii::app()->createUrl('ekios/DaftarBPJSMandiri/index') ?>">
                        <table style="font-size: 20px;text-align:center;">
                            <tr>
                                <td rowspan="2" style="background-color:#AEB7AE;"><span style='color:green;font-size:70px;'><i class='entypo-doc-text'></i></span></i></span></td>
                                <td style="border-bottom:1px solid black;font-weight:bold;">2. SEP MANDIRI</td>
                            </tr>

                            <tr>
                                <td style="text-align:center;background-color:#AEB7AE;font-weight:bold;"></td>
                            </tr>
                        </table>
                        <table style="text-align:center;">
                            <tr>
                                <td colspan="2" style="background-color:#AEB7AE;">
                                    <p>Pembuatan SEP Mandiri oleh pasien.</p>
                                </td>
                            </tr>
                        </table>
                    </a>
                ...
                <div>
                    <a href='<?php echo Yii::app()->createUrl('ekios/checkin/index/') ?>'>
                        <table style="font-size: 20px;text-align:center;">
                            <tr>
                                <td rowspan="2" style="background-color:#AEB7AE;"><span style='font-size:70px;color:green;'><i class='entypo-doc-text'></i></span></i></span></td>
                                <td style="border-bottom:1px solid black;font-weight:bold;">3. KEDATANGAN</td>
                            </tr>
                            <tr>
                                <td style="text-align:center;background-color:#AEB7AE;font-weight:bold;">CHECKIN</td>
                            </tr>
                        </table>
                        <table style="text-align:center;">
                            <tr>
                                <td colspan="2">
                                    <p>Checkin hari H sebelum pasien diperiksa oleh dokter poliklinik</p>
                                </td>
                            </tr>
                        </table>
                    </a>
...
<script type="text/javascript">
    ...
    function printLabel() {
        window.open('<?php echo $this->createUrl('/ekios/checkin/printLabel', array('pendaftaran_id' => (isset($_GET['pendaftaran_id'])) ? $_GET['pendaftaran_id'] : "")); ?>', 'printwin', 'left=100,top=100,width=480,height=640');
        // id = <?php //echo isset($_GET['pendaftaran_id']) ? $_GET['pendaftaran_id'] : "0" ?>;
        // $.post('<?php //echo $this->createUrl('GetDataLabel'); ?>', {
        //     id: id
        // }, function(data) {
        //     console.log('data', data);
        //     $.post('http://localhost/printer_bridging/ekiosp80.php', {
