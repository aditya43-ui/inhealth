...
class CheckinController extends Controller
{
            ...
            try {
                if($janji_poli->carabayar_id != Params::CARABAYAR_ID_BPJS){
                    ...
                    if($res['res'] == True){
                        ...
                        $this->redirect(array('/ekios/default/index', 'pendaftaran_id' => $modPendaftaran->pendaftaran_id, 'sukses' => 1, 'buatjanjipoli_id'=> $janji_poli->buatjanjipoli_id));
                    }else{
                        $trans->rollback();
                ...
                if (
                    ...
                    $this->redirect(array('/ekios/default/index', 'sep_id' => $modSep2->sep_id, 'pendaftaran_id' => $janji_poli->pendaftaran_id, 'sukses' => 1, 'buatjanjipoli_id' => $janji_poli->buatjanjipoli_id));
                } else {
                    $bpjs = new BpjsVklaim;
                ...
                if (isset($reqSep['metaData']['code']) && !empty($reqSep['metaData']['code'])) {
                    if ($reqSep['metaData']['code'] == 200) {
                        ...
                        if ($modSep->save()) {
                            ...
                            Yii::app()->user->setFlash('success', 'SEP Berhasil dibuat');
                            $this->redirect(array('/ekios/default/index', 'sep_id' => $modSep->sep_id, 'pendaftaran_id' => $modPendaftaran->pendaftaran_id, 'sukses' => 1, 'buatjanjipoli_id' => $janji_poli->buatjanjipoli_id));
                        } else {
    ...
    public function actionGetPasienDariNomorPesertaNIK()
    {
        ...
        if ($dataPasien['metaData']['code'] == 200) {
