...
class EKPendaftaranRMT extends PendaftaranT
{
	...
	public function rules()
	{
		...
		return array(
			array('kelompokumur_id, no_pendaftaran, tgl_pendaftaran, no_urutantri, statuspasien, kunjungan, statusmasuk, umur, create_time, create_loginpemakai_id, pegawai_id, ruangan_id, kelaspelayanan_id, carabayar_id, penjamin_id', 'required'),
			...
			array('isumumkebpjs, alihstatus, byphone, kunjunganrumah, tglselesaiperiksa, keterangan_reg, update_time, update_loginpemakai_id, create_ruangan, nopendaftaran_aktif, tgl_konfirmasi, jeniskasuspenyakit_id, tglrenkontrol, statusfarmasi', 'safe'),
