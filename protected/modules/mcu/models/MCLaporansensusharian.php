 ...
 * @subpackage      models
 */
class MCLaporansensusharian extends LaporansensuharianmcV {
    ...
    /**
     * sebagai filter pencarian laporan sensus harian
    ...
    public static function criteriaGrafik($model, $type = 'data', $addCols = array()) {
        $criteria = new CDbCriteria;
        $criteria->select = 'count(distinct pendaftaran_id) as jumlah';
    ...
    /**
     * digunakan sebagai kriteria pencarian 
     * @return \CDbCriteria the data provider that can return the models based on the search/filter conditions.
     */
    protected function functionCriteria() {
        $criteria = new CDbCriteria();

        $criteria->select = 'pasien_id,namadepan, nama_pasien, nama_bin, no_rekam_medik,tanggal_lahir,umur, jeniskelamin, alamat_pasien, kunjungan, statuspasien, diagnosa_nama, carabayar_nama, carabayar_id, penjamin_nama, penjamin_id, pendaftaran_id, ruangan_id, diagnosa_id, diagnosa_nama';
        $criteria->group = 'pasien_id,namadepan, nama_pasien, nama_bin, no_rekam_medik,tanggal_lahir,umur, jeniskelamin, alamat_pasien, kunjungan, statuspasien, diagnosa_nama, carabayar_nama, carabayar_id, penjamin_nama, penjamin_id, pendaftaran_id, ruangan_id, diagnosa_id, diagnosa_nama';
    ...
    /**
     * sebagai kriteria status pasien
     * @return string nilai
     */
    ...
    /**
     * sebagai kriteria status kunjungan
     * @return string nilai
     */
