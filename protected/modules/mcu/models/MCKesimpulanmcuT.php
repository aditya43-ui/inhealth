...
class MCKesimpulanmcuT extends KesimpulanmcuT
{
	...
	public $pemeriksaan_umum;
	public $kandungan;
	public $jantung;
	public $fisioterapi;
	public $treadmill;
	public $hearing_test;
	public $konsultasi_poliklinik;
	public $diagnosis;
	public $jantung_koroner;
	public $tes_spirometri;
	public $suratketerangan_sehat;
	public $reseptur;

	public $kesimpulan_checkbox,$saran_checkbox, $statusperiksa;
	public $keterangan_td,$keterangan_nadi;
