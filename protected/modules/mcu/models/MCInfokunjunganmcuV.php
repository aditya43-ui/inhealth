<?php
class MCInfokunjunganmcuV extends InfokunjunganmcuV
{
	public $pilihanx;
	public $jumlah;
	public $data;
    ...
    public $tgl_awal, $tgl_akhir, $tgl_awal_pendaftar, $tgl_akhir_pendaftar;
    public $ceklis = false;
    public $statusBayar;
    ...
    public function searchDaftarPasienMcu() {
        ...
        if (!empty($this->tgl_awal) && !empty($this->tgl_akhir)) {
            $criteria->addBetweenCondition('DATE(t.tglrenkontrol)', $this->tgl_awal, $this->tgl_akhir);
        }
        //
        if($this->ceklis)
		{
            // if (!empty($this->tgl_awal_pendaftar) && !empty($this->tgl_akhir_pendaftar)) {
            //     $criteria->addBetweenCondition('DATE(t.tgl_pendaftaran)', $this->tgl_awal_pendaftar, $this->tgl_akhir_pendaftar);
            // }
			$criteria->addBetweenCondition('DATE(t.tgl_pendaftaran)', $this->tgl_awal_pendaftar, $this->tgl_akhir_pendaftar);
		}
...
//        $criteria->addCondition('t.ruangan_id = '.Yii::app()->user->getState('ruangan_id'));
   ...
   /**
    ...
    public function ambilHasil($pendaftaran_id) {
        ...
        public function konsulPoli($pendaftaran_id) {
        $konsulpoli_id = '';
        $konsulpoli = KonsulpoliT::model()->findByAttributes(array('pendaftaran_id'=>$pendaftaran_id, 'ruangan_id'=>Yii::app()->user->getState('ruangan_id')));
        if(!empty($konsulpoli->konsulpoli_id)){
            $konsulpoli_id = $konsulpoli->konsulpoli_id;
        }
        return $konsulpoli_id;
    }   
