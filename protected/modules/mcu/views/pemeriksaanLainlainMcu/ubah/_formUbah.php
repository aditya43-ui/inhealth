...
if (isset($_GET['sukses'])) {
    Yii::app()->user->setFlash('success', "Data Pemeriksaan Lain-lain berhasil diubah");
}
...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="far fa-edit"></i> Ubah <b>Pemeriksaan Lain-lain</b>
        </div>
        ...
        <div class="panel-body">
            <div class="col-sm-6">
                <div class="control-group">
                    ...
                    <div class="controls">
                        <?php
                        echo $form->hiddenField($modMcuPemeriksaanlainlain, 'checkup_lainlain_id', array('readonly' => true));
            ...
            <div class="col-sm-6">
                <div class="control-group">
                    ...
                    <div class="controls">
                        <?php echo $form->dropDownList($modMcuPemeriksaanlainlain, 'dokterpemeriksa_id',  CHtml::listData(DokterV::model()->findAll("pegawai_aktif = TRUE AND ruangan_id = '" . Yii::app()->user->getState('ruangan_id') . "'  "), 'pegawai_id', 'namaLengkap'), array(
                            'class' => 'span3'
                        )); ?>
                    </div>
                </div>
...
<div class="form-actions">
    ...
    <?php if (!isset($_GET['frame'])) {
        echo CHtml::link(
            ...
            $this->createUrl($this->id . '/index&pendaftaran_id=' . $modMcuPemeriksaanlainlain->pendaftaran_id),
            array(
