...
if (isset($_GET['sukses'])) {
    Yii::app()->user->setFlash('success', "Data Pemeriksaan Hearing Test berhasil ubah");
}
...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="far fa-edit"></i> Ubah <b>Hearing Test</b>
        </div>
        ...
        <div class="form-actions">
            ...
            <?php if (!isset($_GET['frame'])) {
                echo CHtml::link(
                    ...
                    $this->createUrl($this->id . '/update&id=' . $modHearingTest->hearingtest_id),
                    array(
