...
<?php if (!empty($detailHasil[0]->diagnosa->diagnosa_kode)):?>
<table class="table table-bordered table-condensed">
    ...
    <tbody>
        ...
        <tr>
            <td><?php echo ($i+1); ?></td>
            <td><?php echo isset($hasil->tglmorbiditas) ? MyFormatter::formatDateTimeForUser($hasil->tglmorbiditas) : ""; ?><br>
                Keterangan Diagnosa:
                <br>
                <?php echo $hasil->ket_diagnosa;?>
            </td>
...
<table class="table table-bordered table-condensed">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?php echo $hasil->ket_diagnosa; ?></td>
        </tr>
        <?php } ?>
    </tbody>
</table>
