<?php
$judulLaporan = "Riwayat Pemeriksaan Umum";
...
<?php 
if (count((array)$riwayat1)>0){
foreach ($riwayat1 as $i => $model){
?>
    <table width="100%" border="1px" style="margin-bottom: 10px;"> <!-- class="table-condensed"  -->
        <tr>
