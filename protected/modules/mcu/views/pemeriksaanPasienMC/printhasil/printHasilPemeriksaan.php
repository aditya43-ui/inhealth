<!--div class="white-container"-->
    ...
    $judulLaporan = "Hasil Laboratorium";
    echo $this->renderPartial('application.views.headerReport.headerDefault1LogoRSKiri',array('judulLaporan'=>$judulLaporan, 'colspan'=>3)); 
    $no_urut = 1;
    $class='';
    if(isset($_GET['frame']) ){
...
<table width="100%" class="paddingtext2">
        <tr>
            <td><?php echo $modKunjungan2->getAttributeLabel('no_pendaftaran') ?></td><td>:</td><td> <?php echo $modKunjungan2->no_pendaftaran ?></td>
            <td><?php echo $modKunjungan2->getAttributeLabel('no_rekam_medik') ?></td><td>:</td><td> <?php echo $modKunjungan2->no_rekam_medik ?></td>
        </tr>
        <tr>
            <td><?php echo $modKunjungan2->getAttributeLabel('tgl_pendaftaran') ?></td><td>:</td><td><?php echo $modKunjungan2->tgl_pendaftaran ?></td>
            <td><?php echo $modKunjungan2->getAttributeLabel('nama_pasien') ?></td><td>:</td><td> <?php echo $modKunjungan2->namadepan." ".$modKunjungan2->nama_pasien ?></td>
        </tr>
        <tr>
            <td><?php echo $modKunjungan2->getAttributeLabel('no_masukpenunjang') ?></td><td>:</td><td> <?php echo $modKunjungan2->no_masukpenunjang ?></td>
            <td><?php echo $modKunjungan2->getAttributeLabel('tanggal_lahir').'/'.$modKunjungan2->getAttributeLabel('umur') ?></td><td>:</td><td> <?php echo $modKunjungan2->tanggal_lahir.'/ '.CustomFunction::getUmur(MyFormatter::formatDateTimeForDb($modKunjungan2->tanggal_lahir)); ?></td>
        </tr>
        <tr>
            <td><?php echo $modKunjungan2->getAttributeLabel('tglmasukpenunjang') ?></td><td>:</td><td> <?php echo $modKunjungan2->tglmasukpenunjang ?></td>
            <td><?php echo $modKunjungan2->getAttributeLabel('jeniskelamin') ?></td><td>:</td><td> <?php echo $modKunjungan2->jeniskelamin ?></td>
        </tr>
        <tr>
            <td><?php echo $modKunjungan2->getAttributeLabel('ruangan_nama') ?></td><td>:</td><td> <?php echo $modKunjungan2->ruangan_nama ?></td>
            <td><?php echo $modKunjungan2->getAttributeLabel('alamat_pasien') ?></td><td>:</td><td> <?php echo $modKunjungan2->alamat_pasien ?></td>
        </tr>
        <tr>
