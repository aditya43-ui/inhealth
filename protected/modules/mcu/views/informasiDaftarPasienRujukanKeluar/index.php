<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="entypo-info-circled"></i> Informasi <b>Pasien Rujukan Ke Luar</b>
        </div>
    </div>
...
?>
<iframe name='frameSuratRujukan' style="width: 100%; height: 98%;"></iframe>
<?php $this->endWidget(); ?>
<?php
$this->beginWidget('zii.widgets.jui.CJuiDialog', array(
...
?>
<iframe src="" name="iframeUbahDokterPeriksa" width="100%" height="400"></iframe>
<?php
$this->endWidget();
?>