<div class="white-container">
	...
	<table style="width: 100%; border: none;">
        <tr>
            <td><?php echo $modPenunjang->getAttributeLabel('no_pendaftaran') ?></td><td>: <?php echo $modPenunjang->no_pendaftaran ?></td>
            <td><?php echo $modPenunjang->getAttributeLabel('no_rekam_medik') ?></td><td>: <?php echo $modPenunjang->no_rekam_medik ?></td>
        </tr>
        <tr>
            <td><?php echo $modPenunjang->getAttributeLabel('tgl_pendaftaran') ?></td><td>: <?php echo $modPenunjang->tgl_pendaftaran ?></td>
            <td><?php echo $modPenunjang->getAttributeLabel('nama_pasien') ?></td><td>: <?php echo $modPenunjang->namadepan . " " . $modPenunjang->nama_pasien ?></td>
        </tr>
        <tr>
            <td><?php echo $modPenunjang->getAttributeLabel('no_masukpenunjang') ?></td><td>: <?php echo $modPenunjang->no_masukpenunjang ?></td>
            <td><?php echo $modPenunjang->getAttributeLabel('tanggal_lahir') ?></td><td>: <?php echo $modPenunjang->tanggal_lahir ?></td>
        </tr>
        <tr>
            <td><?php echo $modPenunjang->getAttributeLabel('tglmasukpenunjang') ?></td><td>: <?php echo $modPenunjang->tglmasukpenunjang ?></td>
            <td><?php echo $modPenunjang->getAttributeLabel('jeniskelamin') ?></td><td>: <?php echo $modPenunjang->jeniskelamin ?></td>
        </tr>
        <tr>
            <td><?php echo $modPenunjang->getAttributeLabel('ruangan_nama') ?></td><td>: <?php echo $modPenunjang->ruangan_nama ?></td>
            <td><?php echo $modPenunjang->getAttributeLabel('alamat_pasien') ?></td><td>: <?php echo $modPenunjang->alamat_pasien ?></td>
        </tr>
        <tr>
