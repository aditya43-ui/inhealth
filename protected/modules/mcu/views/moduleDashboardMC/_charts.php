...
<div class="panel panel-default" id="charts_env">
    <div class="panel-heading">
        <div class="panel-title with-tabs">
            <i class="entypo-users"></i> Pasien Kunjungan Bulan <?php echo MyFormatter::getMonthId(date("m")); ?>
        </div>
    ...
    <div class="panel-body">
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane active" id="line-chart">
                <div class="panel-title">
                    <i class="entypo-users"></i> Pasien MCU Berdasarkan Kunjungan Bulan <?php echo MyFormatter::getMonthId(date("m")); ?>
                </div>
            ...
            <div class="tab-pane" id="pie-chart">
                <div class="panel-title">
                    Kunjungan Poliklinik Bulan
                    <?php echo MyFormatter::getMonthId(date("m")); ?>
                </div>
