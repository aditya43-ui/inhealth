...
<div class="control-group">
    <label for="MCRujukanbpjsT_kddiagnosa_rujukan" class="control-label">Kode Diagnosa Rujukan <span class="required">*</span><i class="icon-search" onclick="$('#dialogDiagnosa').dialog('open')" , style="cursor:pointer;" rel='tooltip' title='klik untuk mencari diagnosa rujukan'></i></label>
    <div class="controls">
        <?php
...
<div class="control-group">
    <label for="MCRujukanbpjsT_diagnosa_rujukan" class="control-label">Diagnosa Rujukan <span class="required">*</span></label>
    <div class="controls">
        <?php
        $this->widget('application.extensions.FCBKcomplete.FCBKcomplete', array(
            'model' => $modRujukanBpjs,
...
<div class="control-group">
    <div class="controls">
        <?php //echo $form->checkBox($modAsuransiPasien,'status_konfirmasi', array('onkeyup'=>"return $(this).focusNextInputField(event)",'checked'=>false)); 
        ?>
        <!--<label> Telah Dikonfirmasi</label>-->
