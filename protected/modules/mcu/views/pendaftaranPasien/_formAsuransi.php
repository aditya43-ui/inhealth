    ...
    <div class="controls">
        ...
        $this->widget('MyJuiAutoComplete', array(
            ...
            'htmlOptions' => array(
                ...
                'class' => 'span3 angkahuruf-only all-caps span3'
            ),
        ));
        ?>
    ...
    <div class="controls">
        ...
        $this->widget('MyJuiAutoComplete', array(
            ...
            'htmlOptions' => array(
                ...
                //                                    'onblur'=>"if($(this).val()=='') setAsuransiBaru(); else setAsuransiLama('',this.value)",
                'class' => 'angkahuruf-only all-caps span3'
            ),
        ));
        ?>
...
<div class="control-group">
    ...
    <div class="controls">
        ...
        $this->widget('MyDateTimePicker', array(
            ...
            'htmlOptions' => array('placeholder' => 'Tgl. Konfirmasi', 'class' => 'span3 dtPicker3 datetimemask', 'onkeyup' => "return $(this).focusNextInputField(event)",),
        )); ?>
