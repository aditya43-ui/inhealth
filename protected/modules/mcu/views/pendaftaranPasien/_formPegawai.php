<div class="control-group">
        <?php echo CHtml::label("Cari No. Badge <span class='required'>*</span>", 'nopeserta', array('class'=>'control-label required'))?>
        <div class="controls">
            ...
            <?php
                $this->widget('MyJuiAutoComplete', array(
                                ...
                                'htmlOptions'=>array('placeholder'=>'No. Induk Pegawai',
                                    'rel'=>'tooltip','title'=>'Ketik NIP',
        ...
        <div class="controls">
            <?php 
                $this->widget('MyJuiAutoComplete', array(
                                ...
                                'htmlOptions'=>array('placeholder'=>'Nama Pegawai',
                                    'rel'=>'tooltip','title'=>'Ketik Nama Pegawai',
                                    'onkeyup'=>"return $(this).focusNextInputField(event)",
									'onblur'=>"if($(this).val()=='') setPegawaiReset()",
                                    ),
                            )); 
...
<?php echo $form->textFieldRow($modPegawai,'unit_perusahaan',array('class'=>'span3', 'onkeyup'=>"return $(this).focusNextInputField(event);",'placeholder' => 'Unit / Perusahaan','readonly'=>true)); ?>
<div class="control-group">
    ...
    <div class="controls">
        <?php   
			...
			echo $form->textField($modPegawai,'jabatan_nama',array('class'=>'span3', 'onkeyup'=>"return $(this).focusNextInputField(event);",'placeholder' => 'Jabatan','readonly'=>true));
		?>
