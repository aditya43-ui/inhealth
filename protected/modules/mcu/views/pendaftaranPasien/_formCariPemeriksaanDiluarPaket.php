...
<div id="form-caripemeriksaan-diluar-paket" class="form-horizontal">
    ...
    <div class="control-group" style="float:left;">
        ...
        <div class="controls">
            ...
            <?php echo CHtml::htmlButton(Yii::t('mds', '{icon}', array('{icon}' => '<i class="entypo-search"></i>')), array('class' => 'btn btn-primary', 'type' => 'button', "onclick" => "updateChecklistTindakanMcuDiluarPaket();", 'rel' => 'tooltip', 'title' => 'Klik untuk mencari pemeriksaan')); ?>
