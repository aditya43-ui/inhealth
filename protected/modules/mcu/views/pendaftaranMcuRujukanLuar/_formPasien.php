...
if (isset($_GET['MCPasienM'])) {
    ...
    $modDataPasien->nomorindukpegawai = isset($_GET['MCPasienM']['nomorindukpegawai']) ? $_GET['MCPasienM']['nomorindukpegawai'] : null;
    $modDataPasien->jeniskelamin = isset($_GET['MCPasienM']['jeniskelamin']) ? $_GET['MCPasienM']['jeniskelamin'] : null;
}
