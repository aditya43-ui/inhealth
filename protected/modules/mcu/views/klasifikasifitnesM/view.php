<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="far fa-eye"></i> Lihat <b>Klasifikasi Fitnes</b>
        </div>
    </div>
    <div class="panel-body table-responsive">
        <?php
        $this->breadcrumbs = array(
            'Klasifikasi Fitnes' => array('admin'),
        ...
        <div class="form-actions">
            <?php echo CHtml::link(
                ...
                $this->createUrl('update', array('id' => $model->klasifikasifitnes_id, 'modul_id' => Yii::app()->session['modul_id'])),
