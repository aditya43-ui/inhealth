    ...
    #headerlaporan {
        ...
        <table>
            ...
            <tbody>
                <tr>
                    <td>
                        <div class="content"><?php $this->renderPartial($this->path_view_mcu.'sensus/_table', array('model'=>$model, 'caraPrint'=>$caraPrint)); ?></div>
                    </td></tr></tbody>
            <tfoot>
                <tr>
                    <td>
...
if ($caraPrint == 'PDF') {
    ...
    $this->renderPartial($this->path_view_mcu.'sensus/_table', array('model'=>$model, 'caraPrint'=>$caraPrint));  
 ...
 if ($caraPrint == 'GRAFIK') {
        ...
        <table style="width: 100%; border: none;">
            ...
            <tbody>
                <tr>
                    <td>
                        <div class="content"><?php echo $this->renderPartial($this->path_view_mcu.'_grafik', array('model'=>$model, 'data'=>$data, 'caraPrint'=>$caraPrint), true);?> </div>
                    </td></tr></tbody>
            <tfoot>
                <tr>
                    <td>
