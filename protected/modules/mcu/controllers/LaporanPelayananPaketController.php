<?php
class LaporanPelayananPaketController extends MyAuthController
{

  public $layout = '//layouts/iframe';
  public $path_view = 'mcu.views.laporanPelayananPaket.';

  public function actionIndex()
  {
    $this->pageTitle = Yii::app()->name . " - Laporan Pelayanan Paket";
  ...
  public function actionPrint()
  {
    ...
    $model->thn_awal = date('Y');
    $model->thn_akhir = date('Y');
    $judulLaporan = 'Laporan Pelayanan Paket';

    //Data Grafik
    $data['title'] = 'Grafik Laporan Pelayanan Paket';
