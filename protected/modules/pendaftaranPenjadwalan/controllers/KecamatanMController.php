...
class KecamatanMController extends MyAuthController
{
  ...
  public function actionUpdate($id)
  {
    ...
    $model = $this->loadModel($id);
    $model->kodekecamatan_kemenkes_nama = $model->kodekecamatan_kemenkes;
  ...
  public function actionSetDropdownKabupaten($encode = false, $model_nama = '', $attr = '')
  {
    ...
    public function actionSetDropdownKecamatanKemenkes() {
       if (Yii::app()->request->isAjaxRequest) {
            ...
            $kemenkesnamakecamatan = (isset($_POST['kemenkesnamakecamatan'])?$_POST['kemenkesnamakecamatan']:"");
            
            $kabupatenMod = KabupatenM::model()->findByPk($kabupaten_id);
            
            if(isset($kabupatenMod)){
                
                if(!empty($kabupatenMod->kodekabupaten_kemenkes)){
                    $query = "kabkota/".$kabupatenMod->kodekabupaten_kemenkes;
                    ...
                    if(count($decodeJson->kecamatan) > 0){
                        foreach ($decodeJson->kecamatan as $data){
                            ...
                            $nama = $data->nama;
                            $selected = "";
                            if(!empty($kemenkesnamakecamatan)){
                                if($kemenkesnamakecamatan == $kode){
