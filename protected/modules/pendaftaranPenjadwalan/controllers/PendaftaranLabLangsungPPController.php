<?php
Yii::import('laboratorium.controllers.PendaftaranLabLangsungController');
Yii::import('laboratorium.models.*');
Yii::import('laboratorium.views.pendaftaranLabLangsung');
/**
 ...
 */
class PendaftaranLabLangsungPPController extends PendaftaranLabLangsungController
{
  public $path_view_pendaftaran = 'pendaftaranPenjadwalan.views.pendaftaranLabLangsungPP.';
  ...
  public function simpanPasien($modPasien, $post)
  {
    ...
    if($modPasien->is_bukanmanusia = true){
      ...
      if($modPasien->is_bukanmanusia = true){
        $modPasien->no_rekam_medik = MyGenerator::noRekamMedikBM();
    ...
    $modPasien->statusrekammedis = Params::STATUSREKAMMEDIS_AKTIF;
    // var_dump('<pre>aaaa',$modPasien,'</pre>');die;
  ...
  public function simpanPendaftaran($model, $modPasien, $modRujukan, $modPenanggungJawab, $post, $postPasien, $postPenunjang, $modAsuransiPasien)
  {
    ...
    // var_dump($modPasien->pasien_id);die;
