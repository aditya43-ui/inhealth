...
class PPLaporankunjunganrs extends LaporankunjunganrsV {
    ...
    public $tgl_awal, $tgl_akhir, $jumlah, $data, $tick, $carabayar_id;
    ...
    protected function functionCriteria() {
        ...
        if (!empty($this->jeniskasuspenyakit_id)) {
            if (is_array($this->jeniskasuspenyakit_id)) {
                $criteria->addInCondition("jeniskasuspenyakit_id", $this->jeniskasuspenyakit_id);
            } else {
