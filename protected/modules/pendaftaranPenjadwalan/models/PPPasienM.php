...
//        public $kelurahanNama;
    ...
    // public $npk;
    public $statuspasien_id;
    public $is_rmmanual;
    public $cari_pasien_via_api;
    ...
    public function rules() {
        ...
        return array(
            array('kelompokumur_id, kecamatan_id, kabupaten_id, propinsi_id, no_rekam_medik, tgl_rekam_medik, nama_pasien, pekerjaan_id, kelurahan_id, jeniskelamin, tanggal_lahir, alamat_pasien, agama, warga_negara, statusrekammedis,statusperkawinan,no_mobile_pasien, create_time, create_loginpemakai_id', 'required'),
    ...
    public function searchPasien() {
        ...
        if ($this->ceklis) {
            $this->tanggal_lahir = MyFormatter::formatDateTimeForDb(($this->tanggal_lahir));
            // var_dump($this->tanggal_lahir);die;
            $criteria->addCondition("t.tanggal_lahir::date = '".$this->tanggal_lahir."'");
		}
