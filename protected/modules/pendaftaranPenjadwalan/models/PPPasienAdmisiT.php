...
class PPPasienAdmisiT extends PasienadmisiT
{
    ...
    public function rules()
	{
		...
		return array(
			...
			array('dokterpenerima_id, dpjp2_id, dpjp3_id, tglpulang, statuskeluar, rawatgabung', 'safe'),
