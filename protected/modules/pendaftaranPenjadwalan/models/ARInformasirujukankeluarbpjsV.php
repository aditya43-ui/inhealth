 ...
 */
class ARInformasirujukankeluarbpjsV extends InformasirujukankeluarbpjsV
{
...
//		$criteria->compare('LOWER(tgldirujuk)',strtolower($this->tgldirujuk),true);
                $criteria->addBetweenCondition('date(tglrencanakunjungan_bpjs)', $this->tgl_awal, $this->tgl_akhir);
