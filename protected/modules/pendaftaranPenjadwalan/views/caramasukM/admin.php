...
");
        ...
        ?>
        <?php echo CHtml::link(Yii::t('mds', '{icon} Advanced Search', array('{icon}' => '<i class="icon-accordion icon-white"></i>')), '#', array('class' => 'search-button btn btn-dark')); ?>
        ...
        <div class="form-actions">
            ...
            echo CHtml::link(
                ...
                $this->createUrl('/pendaftaranPenjadwalan/CaramasukM/create', array('modul_id' => Yii::app()->session['modul_id'])),
                array('class' => 'btn btn-danger', 'title' => 'Tambah Cara Masuk')
            );
