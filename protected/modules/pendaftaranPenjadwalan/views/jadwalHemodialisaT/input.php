<?php $this->widget('MyJuiAutoComplete',array(
		'name'=>'jadwalHemo[jadwal]['.$idTabel.'][shift]['.$idShift.'][ruangan_id]['.$idRuangan.'][namapasien]['.$jmlBaris.']',
		'source'=>'js: function(request, response) {
					   $.ajax({
						   url: "'.Yii::app()->createUrl('pendaftaranPenjadwalan/jadwalhemodialisaT/AutoCompletePasien').'",
						   dataType: "json",
						   data: {
							   term: request.term,
