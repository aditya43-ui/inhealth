...
<div class="control-group">
    ...
    <div class="controls">
        <?php echo CHtml::textField('jp', 'jp', array('class' => 'span3', 'readonly' => true)); ?>
    </div>
</div>
<?php
...
echo $form->dropDownListRow(
    ...
    CHtml::listData(
        $model->getJenisKasusPenyakitItems($model->ruangan_id),
        'jeniskasuspenyakit_id',
...
<script type="text/javascript">
    ...
    function loadDataPendaftaran() {
        ...
        $.post("<?php echo ($menu == 'HD' ? $this->createUrl('getDataPendaftaranHD') : $this->createUrl('getDataPendaftaranRJ')); ?>", {
    ...
    function loadJenisPenyakit(id_ruangan) {
        $.post("<?php echo $this->createUrl('getKasusPenyakit') ?>", {
