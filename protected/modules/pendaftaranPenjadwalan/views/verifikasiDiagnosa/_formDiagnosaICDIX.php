...
<tr>
    ...
    <td id="input_field">
        <?php
            ...
            echo $form->hiddenField($modUraian,"[$i]diagnosaicdix_id", ["class"=>"row_diagnosa_ix_id"]);
        ?>
    </td>
    <td>
        <?php
    ...
    <td>
      <?php
            ...
            echo $form->textArea($modUraian, "[$i]keterangan", array('class' => 'span4 custom-only', 'maxlength' => 200, 'rows' => 3));
        ?>
    </td>
    <td>
      <?php
