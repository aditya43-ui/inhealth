...
$this->widget(
    ...
    array(
        ...
        'columns' => array(
            array(
                ...
                'value' => function($data) {
                    ...
                    "id" => "selectPasien2",
                    "onClick" => "
                        addRowDiagnosaKematian('" . $data->diagnosa_id . "', '" . $data->diagnosa_kode . "', '" . $data->diagnosa_nama . "', '" . $data->diagnosa_namalainnya . "');updateSorotX2();
                                    "
                            )
                    )
        ...
        'afterAjaxUpdate' => 'function(id, data){jQuery(\'' . Params::TOOLTIP_SELECTOR . '\').tooltip({"placement":"' . Params::TOOLTIP_PLACEMENT . '"}); updateSorotX2();}',
    )
);