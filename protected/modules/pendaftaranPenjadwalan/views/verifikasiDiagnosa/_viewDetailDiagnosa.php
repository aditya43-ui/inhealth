...
<table width="100%" style="margin-left:auto; margin-right:auto;">
    ...
    <tr>
        <td>Ruangan</td>
        <td>:</td>
        <td><?php echo CHtml::encode($modPendaftaran->ruangan->ruangan_nama); ?></td>
        <td colspan="3"></td>
    </tr>
</table>
<br/>
...
<table id="tblDaftarDiagnosaIX" class="table table-bordered table-condensed" border="2">
    <thead>
        <tr>
            <th>No.</th>
            <th width="20%">Kelompok Diagnosis</th>
            <th width="25%">Kode ICD-9 CM</th>
            <th width="25%">Nama ICD-9 CM</th>
            <th width="25%">Nama lain ICD-9 CM</th>
        </tr>
    </thead>
