...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="entypo-credit-card"></i> Tabel <b>Diagnosa (ICD 10)
        </div>
    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                $this->widget(
                                    'MyJuiAutoComplete',
                                    array(
                                        'name' => "DiagnosaM[$i][diagnosa_kode]",
                                        'sourceUrl' => $this->createUrl('getDiagnosaixM&param=kode'),
                                        'value' => empty($model[$i]->diagnosa->diagnosa_kode) ? NULL : $model[$i]->diagnosa->diagnosa_kode,
                                        'options' => array(
                                            'showAnim' => 'fold',
                                            'minLength' => 3,
                            ...
                            <td>
                                ...
                                $this->widget(
                                    'MyJuiAutoComplete',
                                    array(
                                        'name' => "DiagnosaM[$i][diagnosa_nama]",
                                        'sourceUrl' => $this->createUrl('getDiagnosaM&param=nama'),
                                        'value' => empty($model[$i]->diagnosa->diagnosa_nama) ? NULL : $model[$i]->diagnosa->diagnosa_nama,
                                        'options' => array(
                                            'showAnim' => 'fold',
                                            'minLength' => 3,
                                            'focus' => 'js:function( event, ui ){
                            ...
                            <td>
                                ...
                                $this->widget(
                                    'MyJuiAutoComplete',
                                    array(
                                        'name' => "DiagnosaM[$i][diagnosa_namalainnya]",
                                        'sourceUrl' => $this->createUrl('getDiagnosaM&param=lainnya'),
                                        'value' => empty($model[$i]->diagnosa->diagnosa_namalainnya) ? NULL : $model[$i]->diagnosa->diagnosa_namalainnya,
                                        'options' => array(
                                            'showAnim' => 'fold',
                                            'minLength' => 3,
                                            'focus' => 'js:function( event, ui ){
                            ...
                            <td style="text-align: center">
                                <?php
                                echo CHtml::link("<i class=icon-remove-sign></i><br>Hapus", "", array("onclick" => "hapusDiagnosa(this);return false;",  "title" => "Klik untuk Menghapus Diagnosa"));
                                ?>
                            </td>
                        </tr>
                    <?php
...
<script type="text/javascript">
    ...
    function hapusDiagnosa(mine) {
        ...
        if (pasienmorbiditas_id != '') {
            jQuery.ajax({
                'url': '<?php echo Yii::app()->createUrl('pendaftaranPenjadwalan/verifikasiDiagnosa/hapusDiagnosax') ?>',
                'data': {
    ...
    function inputDiagnosa(mine, params, kode) {
        ...
        console.log('sebelum kode undefined');
    ...
    array(
        ...
        'columns' => array(
            ...
            array(
                ...
                'value' => 'CHtml::dropDownList("kelompokdiagnosa", "", CHtml::listData(KelompokdiagnosaM::model()->findAll("kelompokdiagnosa_aktif = TRUE"), "kelompokdiagnosa_id","kelompokdiagnosa_nama"), array("class"=>"span2 kelompokdiagnosa", "onchange"=>"diagnosaKelompok(this);", "empty"=>"-- Pilih --"))',
                'filter' => false,
                'type' => 'raw',
            ),
            array(
