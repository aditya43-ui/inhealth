<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="glyphicon glyphicon-file"></i> Pendaftaran <b>Rawat Inap (Langsung)</b>
        </div>
    </div>
            ...
            <div class="panel-heading">
                <div class="panel-title">
                    ...
                    echo CHtml::radioButton('rb_rm', false, array(
                        ...
                        'class' => 'rb_rm rmbaru',
                        'id' => 'pasienbaru'
                    )) . "<label for='pasienbaru' style='color:white;font-weight:bold;font-size:14px'>Pasien Baru</label> ";
                    echo CHtml::radioButton('rb_rm', false, array(
                        'value' => 0,
                        'name' => 'otomatis',
                        'uncheckValue' => null,
                        ...
                        'class' => 'rb_rm rmlama',
                        'id' => 'pasienlama'
                    )) . "<label for='pasienlama' style='color:white;font-weight:bold;font-size:14px'>Pasien Lama</label> ";
                    ?>
                        ...
                        $this->Widget('ext.bootstrap.widgets.BootAccordion', array(
                            ...
                            'content' => array(
                                'content-asudepartemen' => array(
                                    'header' => CHtml::htmlButton("<i class='entypo-minus'></i>", array('class' => 'btn btn-primary btn-mini', 'onclick' => '', 'onkeyup' => "return $(this).focusNextInputField(event)", 'rel' => 'tooltip', 'title' => 'Klik untuk Tampilkan Form')) . '<b><span class="judulasuransi">Asuransi Departemen </span> </b> &nbsp &nbsp <span class="refreshasuransi">'
                        ...
                        $this->Widget('ext.bootstrap.widgets.BootAccordion', array(
                            ...
                            'content' => array(
                                'content-asupekerja' => array(
                                    'header' => CHtml::htmlButton("<i class='entypo-minus'></i>", array('class' => 'btn btn-primary btn-mini', 'onclick' => '', 'onkeyup' => "return $(this).focusNextInputField(event)", 'rel' => 'tooltip', 'title' => 'Klik untuk Tampilkan Form')) . '<b><span class="judulasuransi">Asuransi Pekerja PT. Badak LNG </span> </b> &nbsp &nbsp <span class="refreshasuransi">'
                                        . CHtml::htmlButton('<i class="entypo-arrows-ccw"></i>', array('class' => 'btn btn-danger btn-mini pull-center', 'onclick' => 'setAsuransiBadakReset();', 'onkeyup' => "return $(this).focusNextInputField(event)", 'rel' => 'tooltip', 'title' => 'Klik untuk membersihkan field')) . '</span>',
                                    'isi' =>
                        ...
                        <?php $this->Widget('ext.bootstrap.widgets.BootAccordion', array(
                            ...
                            'content' => array(
                                'content-riwayatpasien' => array(
                                    'header' => CHtml::htmlButton("<i class='entypo-minus'></i>", array('class' => 'btn btn-primary btn-mini', 'onclick' => '', 'onkeyup' => "return $(this).focusNextInputField(event)", 'rel' => 'tooltip', 'title' => 'Klik untuk tampilkan riwayat kunjungan pasien')) . '<b>Riwayat Kunjungan Pasien</b>',
                        ...
                        $this->Widget('ext.bootstrap.widgets.BootAccordion', array(
                            ...
                            'content' => array(
                                'content-paketbmhp' => array(
                                    ...
                                    'isi' => $this->renderPartial('pendaftaranPenjadwalan.views.pendaftaranRawatJalan.paket/_formPaketBMHP', array(
                                        'form' => $form,
                                        'modPasien' => $modPasien,
                                    ), true),
                                    'active' => false,
    ...
    <div class="form-actions">
        ...
        if ($model->isNewRecord) {
            ...
            echo CHtml::link(
                Yii::t('mds', '{icon} Print Label Gelang', array('{icon}' => '<i class="entypo-print"></i>')),
                Yii::app()->controller->createUrl("labelGelang", array("pendaftaran_id" => $model->pendaftaran_id)),
                array(
                    "id" => $model->no_pendaftaran,
                    'class' => 'btn btn-info',
                    "rel" => "tooltip",
            ...
            if (Yii::app()->user->getState('bridging_inhealth') == TRUE) {
                if (!empty($model->penjamin_id) && $model->penjamin_id == Params::PENJAMIN_ID_INHEALTH) {
                    echo CHtml::link(Yii::t('mds', '{icon} Proses SJP', array('{icon}' => '<i class="icon-ok icon-white"></i>')), $this->createUrl("pendaftaranRawatJalan/prosesSJP", array("pendaftaran_id" => $model->pendaftaran_id, "pasien_id" => $modPasien->pasien_id, "frame" => true, 'pelayanan' => "RI")), array(
