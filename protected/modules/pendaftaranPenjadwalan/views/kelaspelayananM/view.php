    ...
    <div class="panel-body table-responsive">
        ...
        <div class="form-actions">
            <?php echo CHtml::link(
                ...
                $this->createUrl($this->id . '/update&id=' . $model->kelaspelayanan_id, array('modul_id' => Yii::app()->session['modul_id'])),
                array('title' => 'Ubah', 'class' => 'btn btn-danger')
            ); ?>
            <?php echo CHtml::link(
                Yii::t('mds', '{icon} Pengaturan Kelas Pelayanan', array('{icon}' => '<i class="entypo-folder"></i>')),
