        ...
        <div class="controls">
            ...
            if ($readonly) {
                ...
                $this->widget('MyJuiAutoComplete', array(
                    ...
                    'htmlOptions' => array(
                        'placeholder' => 'Ketik Nama Pasien', 'rel' => 'tooltip', 'title' => 'Ketik nama pasien untuk mencari data kunjungan',
...
<div class="span6">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            ...
            <?php
            if ($readonly) {
                echo $form->textField('no_rekam_medik', $modInfoKunjungan->no_rekam_medik, array('class' => 'span3', 'onkeyup' => "return $(this).focusNextInputField(event);", 'readonly' => $readonly));
            } else {
                $this->widget('MyJuiAutoComplete', array(
                    'name' => 'no_rekam_medik',
...
if (isset($_GET['ARPasienM'])) {
    ...
    // $modDialogKunjungan->tgl_pendaftaran = (isset($_GET['ARPasienM']['tgl_pendaftaran']) ? $modDialogKunjungan->getKonverviDateRangeUser($_GET['ARPasienM']['tgl_pendaftaran']) : "");
...
// var_dump($modDialogKunjungan->searchDialogKunjungan()->data);die;
$this->widget('ext.bootstrap.widgets.BootGridView', array(
    ...
    'columns' => array(
        ...
        array(
            ...
            'type' => 'raw',
            'filter' =>  CHtml::dropDownList('instalasi_id', $modDialogKunjungan->instalasi_id, CHtml::listData(ARInstalasiM::model()->getInstalasiPelayanans(), 'instalasi_id', 'instalasi_nama'), array('onchange' => 'setInfoPasienReset();refreshDialogInfoPasien();', 'class' => 'span3', 'onkeyup' => "return $(this).focusNextInputField(event)",)), //CHtml::activeHiddenField($modDialogKunjungan, 'instalasi_id') . CHtml::activeTextField($modDialogKunjungan, 'instalasi_nama'),
        ),
        array(
            'name' => 'ruangan_nama',
            'type' => 'raw',
        ...
        $(".btn_pendaftaran_apply").on("click", function() {
            setTimeout(function() {
                $.fn.yiiGridView.update("datakunjungan-grid", {
                    data: $("#datakunjungan-grid :input").serialize()
                });
            }, 100);
        });
    }
