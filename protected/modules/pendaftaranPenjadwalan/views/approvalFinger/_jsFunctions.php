<script type="text/javascript">
    function collapsedPanel(obj, id_panel) {
        console.log('fhdhfd')
        if($(obj).is(':checked')) {
            $('#' + id_panel).slideDown();
        } else {
    ...
    function getAsuransiNoKartu(isi) {
        ...
        var tanggal = $("#ARPengajuanapprovalsepT_tgl_sep").val();
            ...
            success: function(data) {
                ...
                if (obj.metaData.code == '201') {
                    ...
                    if (obj.response != null) {
                        ...
                        // $("#<?php //echo CHtml::activeId($model, 'jenis_pelayanan') 
    ...
    function cekInput(obj, param) {
        ...
        var panelKunjungan = $('.collapsedPanel').is(':checked');
        ...
        if(panelKunjungan) {
            ...
            if (no_pendaftaran == "") {
                myAlert("Data Pendaftaran Kosong")
                return false;
            }
        } else {
            if (!requiredCheck("#panel-data-pengajuan-approval")) {
                requiredCheck("#panel-data-pengajuan-approval");
            } else {
                status = 1;
            }
        }
        ...
        */
        ...
        var jnsPengajuan = $("#<?php echo CHtml::activeId($model, 'jnspengajuan_approvalsep') ?>").val();
        ...
        if (status == 1) {
            var setting = {
                ...
                type: 'GET',
                dataType: 'html',
                data: 'param=' + param + '&noKartu=' + noKartu + '&tglSep=' + tglSep + '&jnsPelayanan=' + jnsPelayanan + '&jnsPengajuan=' + jnsPengajuan + '&catatan=' + catatan + '&user=' + user + '&pendaftaran_id=' + pendaftaran_id,
                ...
                */
                ...
                success: function(data) {
                    ...
                    if (obj.metaData.code != '200') {
                        ...
                        if (obj.response != null) {
                            $("#responbridging_pengajuan").val(data);
                            $("#assep-t-form").submit();
                        }
                    }
                    $("#content-bpjs").removeClass("animation-loading");
