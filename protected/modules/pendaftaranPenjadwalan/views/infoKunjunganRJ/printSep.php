...
<table width="100%" border = "0" style = "text-align:left;">
    <thead>
        ...
        <th align='center' style="font-weight:bold;padding-right:200px;"><span style="font-size:17px;"><?php echo $judul_print; ?><br><?php echo 'RSUD-C ABEPURA'//$data->nama_rumahsakit; ?></span></th>        
        ...
        <td colspan = "4">
            <table border = "0" width=100%' style = "text-align:left;">
                <tr>
                    ...
                    <td>:</td>
                    <td style = "padding-left:20px;"><span style="font-size:17px;font-weight:bold;font-family: arial;"><?php echo $modSep->nosep; ?></span></td>
                    <td>&nbsp;</td>
                    <td><span>No. DMK</span></td>
                    <td>:</td>
                ...
                <tr>
                    ...
                    <td>&nbsp;</td>
                    <td style = "padding-left:20px"><div style = "padding: 0;margin: 0;height:10px;width:120px;border-top: solid 2px #000;"></div></td>
                    <td></td>
                    <td style = "padding-left:20px"><div style = "padding: 0;margin: 0;height:10px;width:120px;border-top: solid 2px #000;"></div></td>                    
                </tr>
            </table>
