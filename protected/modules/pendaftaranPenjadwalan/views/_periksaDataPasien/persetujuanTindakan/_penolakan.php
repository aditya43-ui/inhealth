...
<TABLE>
        ...
        <TABLE ALIGN="CENTER">
             <tr>
                <td ALIGN=CENTER VALIGN=MIDDLE>
                    <B><span FACE="Liberation Serif" SIZE=4><U><?php echo "SURAT PENOLAKAN TINDAKAN MEDIS"; ?></U></span></B>
                </td>
            </tr>
             <tr>
                <td ALIGN=CENTER VALIGN=MIDDLE>
    ...
    <p align="justify">
		...
		<h3><p style="margin: 0; text-align: center;">PENOLAKAN/PEMBATALAN</p></h3>
		<p align="justify">
...
//                                                                echo (!empty($tindakan->anastesi_id) ? $tindakan->anastesi->anastesi_nama : ""); 
        ...
        <p align="justify" style="margin-left: 50px; text-indent: 0;">
			Bedah/Operasi : <br>
