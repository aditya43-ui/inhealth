...
<table class="table noborder">
    <tr class="border">
        <td colspan="4" class="border" style="border: 1px solid black;">
            <?php 
            
            $login = LoginpemakaiK::model()->findByPk($modPemeriksaanFisik->create_loginpemakai_id);
            $peg_nama = "";
            if (!empty($login)) {
                $peg_nama = !empty($login->pegawai) ? $login->pegawai->namaLengkap : "-";
            }
            echo 'Dibuat Oleh : '.$peg_nama.'';
	...
	<tr class="border">
		<th colspan="4" style="text-align:center;">
                    <h3>PEMERIKSAAN FISIK PASIEN IGD</h3>
		</th>					
	</tr>
	<tr class="border">
		<td colspan="4">
...
<!--					<td class="kolom-line">GDS</td>
	...
	<tr class="border">
		<td colspan="4">
			<table class="table noborder kolom-line">
				<tr class="kolom-line">
					<td class="kolom-line">Mata</td>
					<td class="kolom-line">verbal</td>
    ...
    <tr class="border">
		<td colspan="2" style="border-right: 1px solid black !important;" width="50%">
            <b>Thorax</b><br><br><br>
    ...
    <tr class="border">
        ...
        <td colspan="2" class="border">
            <table class="table noborder kolom-line">
                ...
                <tr>
                    <td>Palpasi</td>
                    <td>: <?php echo !empty($modPemeriksaanFisik->abd_palpasi) ? $modPemeriksaanFisik->abd_palpasi : "-"; ?>
                        <ul>
			...
			<table class="table noborder kolom-line">
				<tr class="kolom-line">
					...
					<td class="kolom-line" style="line-height: 1.0 !important;width:412px;">						
						<?php 
							$css = '';
							if (!empty($modGambarTubuh->AllDataGambarAnatomi) && count((array)$modGambarTubuh->AllDataGambarAnatomi) > 0)
							{
	...
	<tr class="border">
		<td colspan="3">
			<table class="table noborder kolom-line">
				...
				<tr class="kolom-line">
					<td class="kolom-line kolom-line-bottom">A. Diagnosis Kerja</td>					
				</tr>
				<tr class="kolom-line">
					<td class="kolom-line kolom-line-bottom">
						<ol>
	...
	<tr class="border">
		<td colspan="3" style="width:45%;border:1px solid #333 !important;">
			<table class="table noborder kolom-line">
				<tr class="kolom-line">
					<td class="kolom-line kolom-line-bottom">P : Terapi IGD :</td>					
				</tr>						
				<tr class="kolom-line">					
					<td class="kolom-line kolom-line-bottom"  style="margin-left: 10px;padding-top: 4px !important;line-height: 1.0 !important;">
	...
	<tr class="border">
		...
		<td colspan="3"  class="border">
			<table class="table noborder kolom-line">
				<tr class="kolom-line kolom-line-bottom">
					<td class="kolom-line kolom-line-bottom" colspan="2">Edukasi awal, disampaikan tentang diagnosa, serta rencana dan tujuan terapi kepada :</td>					
				</tr>
				<tr class="kolom-line kolom-line-bottom">
