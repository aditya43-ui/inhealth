<div id="search-form">
    <div class="col-sm-6 form-horizontal">   
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo CHtml::activeTextField($model, 'barcode', array('placeholder' => 'Ketik Nomor Barcode', 'class' => 'span4',  'onkeypress' => "return $(this).focusNextInputField(event)")); ?>
            </div>
        </div>           
        <div class="control-group">
            <?php echo CHtml::label('No Antrian', '', array('class' => 'control-label')) ?> 
            <div class="controls">
                <?php echo CHtml::activeTextField($model, 'noantrian', array('placeholder' => 'Ketik Nomor Antrian', 'class' => 'span4',  'onkeypress' => "return $(this).focusNextInputField(event)")); ?>
            </div>
        </div>  
    </div>
    <div class="col-sm-6">
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo CHtml::activeDropDownList($model, 'ruangan_id', RuanganM::arrRuanganId(Params::INSTALASI_ID_RJ), array('empty' => '-- Pilih --', 'class' => 'span4', 'onkeypress' => "return $(this).focusNextInputField(event)")); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo CHtml::activeDropDownList($model, 'jenis_kunjungan', LookupM::getItemsUrutan('jeniskunjunganantrian'), array('empty' => '-- Pilih --', 'class' => 'span4', 'onkeypress' => "return $(this).focusNextInputField(event)")); ?>
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo CHtml::activeDropDownList($model, 'status_barcode', [
