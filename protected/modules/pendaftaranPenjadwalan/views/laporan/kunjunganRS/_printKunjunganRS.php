...
if ($caraPrint == 'EXCEL') {
    ...
    echo $this->renderPartial('application.views.headerReport.headerDefaultNewExcel', array('judulLaporan' => $judulLaporan, 'periode' => $periode, 'colspan' => 10));
}
            ...
            <tr>
                <td>
                    <div class="content">
                        ...
                        <?php  echo $this->renderPartial('pendaftaranPenjadwalan.views.laporan._grafik', array('model'=>$model, 'data'=>$data, 'caraPrint'=>$caraPrint), true); ?>
