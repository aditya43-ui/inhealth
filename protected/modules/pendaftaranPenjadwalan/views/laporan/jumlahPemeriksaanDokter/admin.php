...
$this->breadcrumbs = array(
    'Laporan Jumlah Pemeriksaan Dokter',
);
?>
<?php
//$this->breadcrumbs=array(
...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="entypo-newspaper"></i> Laporan <b>Jumlah Pemeriksaan Dokter</b>
        </div>
    </div>
    <div class="panel-body">
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="entypo-credit-card"></i> Tabel <b>Jumlah Pemeriksaan Dokter</b>
                </div>
            </div>
        ...
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                ...
                <iframe src="" id="Grafik" width="100%" height='0' class="biru" onload="javascript:resizeIframe(this);"></iframe>
            </div>
        </div>
