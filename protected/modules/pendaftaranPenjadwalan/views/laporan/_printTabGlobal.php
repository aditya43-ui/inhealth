...
if ($caraPrint == 'EXCEL') {
    ...
    echo $this->renderPartial('application.views.headerReport.headerDefaultNewExcel', array('judulLaporan' => $judulLaporan, 'periode' => $periode, 'colspan' => 21));
}
            ...
            <tr>
                <td>
                    <div class="content">
                        ...
                        <?php
                       $this->renderPartial('pendaftaranPenjadwalan.views.laporan._tableGlobalRJ', array('model'=>$model, 'caraPrint'=>$caraPrint)); 
                        ?>
...
if ($caraPrint == 'PDF') {
    ...
    <div class="content">
        ...
        <?php
      $this->renderPartial('pendaftaranPenjadwalan.views.laporan._tableRJ', array('model'=>$model, 'caraPrint'=>$caraPrint));  
        ?>
    </div>
