            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <div class="daterange daterange-inline add-ranges input-inline span4"
                                data-format="DD MMM YYYY"
                                data-start-date="<?php echo date('d M Y', strtotime($modPPInfoKunjunganV->tgl_awal)) ?>"
                                data-end-date="<?php echo date('d M Y', strtotime($modPPInfoKunjunganV->tgl_akhir)) ?>">
                                <i class="entypo-calendar"></i>
                                <span><?php echo date('d M Y', strtotime($modPPInfoKunjunganV->tgl_awal)) ?> -
                                    <?php echo date('d M Y', strtotime($modPPInfoKunjunganV->tgl_akhir)) ?></span>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <?php echo $form->dropDownList($modPPInfoKunjunganV,'carakeluar_id',  CHtml::listData(CarakeluarM::model()->findAll('carakeluar_aktif = true ORDER BY carakeluar_urutan ASC'), 'carakeluar_id', 'carakeluar_nama'),array('empty'=>'-- Pilih --','onkeypress'=>"return $(this).focusNextInputField(event)",'onchange'=>'carakeluar(this.value)')); ?>
                        </div>
                    </div>
                    <div class="control-group">
                        <?php echo CHtml::label('Sistem', 'Sistem', array('class' => 'control-label')) ?>
                        <div class="controls">
                            <?php echo $form->dropDownList($modPPInfoKunjunganV,'sistem', ['Rawat Jalan' => 'Rawat Jalan', 'Rawat Darurat' => 'Rawat Darurat'],array('onkeypress'=>"return $(this).focusNextInputField(event)",'onchange'=>'', 'empty'=>'-- Pilih --')); ?>
                        </div>
                    </div>
                </div>
