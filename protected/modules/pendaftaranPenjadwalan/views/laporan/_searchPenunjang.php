            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    $modPPInfoKunjunganV,
                        ...
                        $insDrop->addInCondition(" instalasi_id ", Params::getArrayInstalasiPenunjang());
                        $insDrop->order = " instalasi_nama ASC ";
                        echo '<div class="control-group">
                            ' . CHtml::label('Instalasi', 'instalasi_id', array('class' => 'control-label')) . ' 
                            <div class="controls">
                                ' . $form->dropDownList($modPPInfoKunjunganV, 'instalasi_id', CHtml::listData(InstalasiM::model()->findAll($insDrop), 'instalasi_id', 'instalasi_nama'), array(
                        'class' => 'form-control', 'multiple' => 'multiple'
                    )) . '
                            </div>
                        </div>
