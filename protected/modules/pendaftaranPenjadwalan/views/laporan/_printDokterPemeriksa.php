            ...
            <tr>
                <td>
                    <div class="content">
                        ...
                        <?php   echo $this->renderPartial('pendaftaranPenjadwalan.views.laporan._grafikDokterPemeriksa', array('model'=>$model, 'data'=>$data, 'caraPrint'=>$caraPrint, 'colspan'=>9), true); 
