    ...
    ");
        ...
        $this->widget('bootstrap.widgets.BootMenu', array(
            ...
            'items' => array(
                ...
                array('label' => 'Pemeriksaan', 'url' => $this->createAbsoluteUrl($controller . '/laporanPemeriksaanKunjunganRI'), 'active' => true), //RSPMC-970
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="entypo-credit-card"></i> Tabel <b>Kunjungan Rawat Inap - Pemeriksaan</b>
                </div>
            </div>
