<div class="panel panel-gradient">
    ...
    ");
        ...
        <?php $this->renderPartial('pendaftaranPenjadwalan.views.laporan._searchRIGobal', array(
        ...
        $this->widget('bootstrap.widgets.BootMenu', array(
            ...
            'items' => array(
                array('label' => 'Global', 'url' => $this->createAbsoluteUrl($controller . '/LaporanKunjunganRIGlobal'), 'active' => true),
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="entypo-credit-card"></i> Tabel <b>Kunjungan Rawat Inap</b>
                </div>
            </div>
            <div class="panel-body table-responsive">
                <?php $this->renderPartial('pendaftaranPenjadwalan.views.laporan.rawatInap._tableGlobalRI', array('model' => $model)); ?>
            </div>
        </div>
        ...
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                ...
                <iframe class="biru" src="" id="Grafik" width="88%" height='0' onload="javascript:resizeIframe(this);"></iframe>
            </div>
        </div>
        ...
        $controller = Yii::app()->controller->id; //mengambil Controller yang sedang dipakai
        $module = Yii::app()->controller->module->id; //mengambil Module yang sedang dipakai
        $urlPrint =  Yii::app()->createAbsoluteUrl($module . '/' . $controller . '/PrintKunjunganRIGlobal');
