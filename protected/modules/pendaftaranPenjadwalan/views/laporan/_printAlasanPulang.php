            ...
            <tr>
                <td>
                    <div class="content">
                        ...
                        <?php
                  if ($model->instalasi_id == Params::INSTALASI_ID_RI){
            ...
            <tr>
                <td>
                    <div class="content">
                        ...
                        <?php  echo $this->renderPartial('pendaftaranPenjadwalan.views.laporan._grafikAlasanPulang', array('model'=>$model, 'data'=>$data, 'caraPrint'=>$caraPrint, 'colspan'=>9), true); ?>
