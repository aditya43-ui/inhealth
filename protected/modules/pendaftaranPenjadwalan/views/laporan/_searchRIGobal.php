            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <?= $form->radioButtonList($modPPInfoKunjunganV, 'pilihanPeriode', ['1' => 'Tgl. Masuk', '2' => 'Tgl. Keluar']) ?>
                        </div>
                    ...
                    <div class="control-group">
                        <label for="" class="control-label">Cara Keluar</label>
                        <div class="controls">
                            <?php echo $form->dropDownList($modPPInfoKunjunganV,'carakeluar_id',CHtml::listData(CarakeluarM::model()->findAll('carakeluar_aktif = true and carakeluar_id != 5 ORDER BY carakeluar_nama ASC'), 'carakeluar_id', 'carakeluar_nama'),array(
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <?php echo $form->dropDownList($modPPInfoKunjunganV,'instalasi_id',CHtml::listData(InstalasiM::model()->findAll('instalasi_aktif = true and instalasi_id in ( ' . implode(',', Params::INSTALASI_ID_RI_ARR) . ' ) ORDER BY instalasi_nama ASC'), 'instalasi_id', 'instalasi_nama'),array(
                            'class'=>'form-control', 'empty' => '-- Pilih --' //'multiple'=>'multiple'
                        ));
                        ?>											
                    </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">												 
                        <?php echo $form->dropDownList($modPPInfoKunjunganV,'penjamin_id',array(),
