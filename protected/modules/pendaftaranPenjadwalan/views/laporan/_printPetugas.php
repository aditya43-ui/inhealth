            ...
            <tr>
                <td>
                    <div class="content">
                        ...
                        <?php
 $this->renderPartial('pendaftaranPenjadwalan.views.laporan._tablePetugas', array('model'=>$model, 'caraPrint'=>$caraPrint)); ?>
            ...
            <tr>
                <td>
                    <div class="content">
                        ...
                        <?php  echo $this->renderPartial('pendaftaranPenjadwalan.views.laporan._grafikUnitPelayanan', array('model'=>$model, 'data'=>$data, 'caraPrint'=>$caraPrint, 'colspan'=>9), true); 
  ?>
