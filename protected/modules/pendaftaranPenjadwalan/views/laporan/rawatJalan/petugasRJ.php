    ...
    ");
        ...
        $this->widget('bootstrap.widgets.BootMenu', array(
            ...
            'items' => array(
                ...
                array('label' => 'Per Petugas', 'url' => $this->createAbsoluteUrl($controller . '/laporanPerPetugasRJ'),'active' => true) : 
                null,
            ),
        ));
        ?>
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="entypo-credit-card"></i> Tabel <b>Kunjungan Rawat Jalan - Per Petugas</b>
                </div>
            </div>
            <div class="panel-body table-responsive">
                <!--<h6>Table Kunjungan <b>Rawat Jalan - Unit Pelayanan</b></h6>-->
                <?php $this->renderPartial('pendaftaranPenjadwalan.views.laporan._tablePetugas', array('model' => $model)); ?>
                <!--</div>-->
            </div>
        </div>
        ...
        $controller = Yii::app()->controller->id; //mengambil Controller yang sedang dipakai
        $module = Yii::app()->controller->module->id; //mengambil Module yang sedang dipakai
        $urlPrint =  Yii::app()->createAbsoluteUrl($module . '/' . $controller . '/PrintPetugasRJ');
