...
<div class="row">
    ...
    <div class="col-sm-6">
        ...
        <div class="input-append"><span class="add-on"><?php echo $form->textField($model, 'dokter_nama', array('id' => 'dokternama', 'data-offset-top' => 200, 'data-spy' => 'affix', 'style' => 'margin-top:-5px; margin-left:-5px', 'inline' => false, 'onkeypress' => "return $(this).focusNextInputField(event)", 'sourceUrl' => $this->createUrl('getDokter'), 'placeholder' => 'Nama Dokter')); ?>
