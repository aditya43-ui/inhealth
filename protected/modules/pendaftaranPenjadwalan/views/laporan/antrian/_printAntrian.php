...
// if ($caraPrint != 'PDF'){
    echo '<div id="headers" style="margin-top: 50px;">';
...
if ($caraPrint != 'GRAFIK')
$this->renderPartial('pendaftaranPenjadwalan.views.laporan.antrian/_tableAntrian', array('model'=>$model, 'caraPrint'=>$caraPrint)); 
