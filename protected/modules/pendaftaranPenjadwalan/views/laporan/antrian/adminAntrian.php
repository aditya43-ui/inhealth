...
$url = Yii::app()->createUrl('pendaftaranPenjadwalan/laporan/frameGrafikAntrian&id=1');
if (Yii::app()->user->getState('ruangan_id') == Params::RUANGAN_ID_REKAM_MEDIS) {
    $url = Yii::app()->createUrl('rekamMedis/laporan/frameGrafikAntrian&id=1');
}
...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="entypo-newspaper"></i> Laporan <b>Antrian</b>
        </div>
    </div>
    <div class="panel-body">
        <div class="panel panel-success">
            ...
            <div class="panel-body search-form">
                <?php $this->renderPartial('pendaftaranPenjadwalan.views.laporan.antrian/_searchAntrian', array(
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="entypo-credit-card"></i> Tabel <b>Antrian</b>
                </div>
            </div>
            <div class="panel-body table-responsive">
                <?php $this->renderPartial('pendaftaranPenjadwalan.views.laporan.antrian/_tableAntrian', array('model' => $model)); ?>
            </div>
        </div>
        ...
        $urlPrint =  Yii::app()->createAbsoluteUrl($module . '/' . $controller . '/printLaporanAntrian');
