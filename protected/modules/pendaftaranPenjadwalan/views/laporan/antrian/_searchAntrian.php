...
<div class="row">
    ...
    <div class="col-sm-6">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <div class="daterange daterange-inline add-ranges input-inline span4" data-format="DD MMM YYYY"
        ...
        <div class="control-group">
            <?php echo CHtml::label('Poliklinik', 'ruangan_id', array('class' => 'control-label')) ?>
            <div class="controls">
                <?php echo $form->dropDownList(
                    $model,
                    'ruangan_id',
                    LoketpendaftaranpoliM::listRuanganLoket(),
    ...
    <div class="col-sm-6">
        <div class="control-group">
            <?php echo CHtml::label('Jenis Kunjungan', 'jenis_kunjungan', array('class' => 'control-label')) ?>
            <div class="controls">
                <?php echo $form->dropDownList(
                    $model,
                    'jenis_kunjungan',
                    AntrianT::listJenisKunjungan(),
                    array('empty' => '-- Pilih --','class' => 'form-control span3')
                ); ?>
            </div>
        </div>
        <div class="control-group">
