...
<?php echo $form->textFieldRow($modPegawai, 'unit_perusahaan', array('class' => 'span3 form-control', 'onkeyup' => "return $(this).focusNextInputField(event);", 'placeholder' => 'Unit / Perusahaan', 'readonly' => true)); ?>
<div class="control-group">
    ...
    <div class="controls">
        ...
        echo $form->textField($modPegawai, 'jabatan_nama', array('class' => 'span3 form-control', 'onkeyup' => "return $(this).focusNextInputField(event);", 'placeholder' => 'Jabatan', 'readonly' => true));
        ?>
