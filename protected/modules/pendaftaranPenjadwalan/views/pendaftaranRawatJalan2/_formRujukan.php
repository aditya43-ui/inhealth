...
<div class="control-group">
    ...
    <div class="controls">
        ...
        <?php echo '&nbsp;' . CHtml::htmlButton(Yii::t('mds', '{icon}', array('{icon}' => '<i class="entypo-search"></i>')), array('class' => 'btn btn-primary pull-right', 'style' => 'margin: -36px 2px 0 0;', 'rel' => 'tooltip', 'title' => 'klik untuk mencari diagnosa rujukan', 'onclick' => '$(\'#dialogDiagnosa\').dialog(\'open\')')); ?>
    </div>
</div>
