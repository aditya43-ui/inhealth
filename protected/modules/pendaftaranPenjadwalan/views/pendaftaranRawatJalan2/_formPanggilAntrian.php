...
<?php echo $form_antrian->hiddenField($modAntrian, 'jml_panggil', array('readonly' => true, 'class' => 'span3', 'onkeyup' => "return $(this).focusNextInputField(event);", 'maxlength' => 50)); ?>
<div style="width: 100%; text-align: center; font-size: 30px; font-weight: bold;">
    <?php echo (empty($modAntrian->modelantrian_id) ? "X" : $modAntrian->modelAntrian->modelantrian_singkatan) . "-" . (empty($modAntrian->noantrian) ? "0000" : $modAntrian->noantrian); ?>
</div>
