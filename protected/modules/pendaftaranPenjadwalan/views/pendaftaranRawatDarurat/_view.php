        ...
        <div class="block-tabel">
            ...
            <?php $this->widget('ext.bootstrap.widgets.BootDetailView',array(
                ...
                'attributes'=>array(
                    ...
                    array(
                        'name'=>'isumumkebpjs',
                        'value'=>($model->isumumkebpjs)?"Ya":"Tidak",
                    ),
				...
				<table width="100%"  class="table table-striped table-condensed detail-view">
					...
					<tbody>
						<?php $total = 0; foreach ($modTindakan as $i => $tindakan){ 
                                                    $tindakan->tarif_satuan = str_replace(",", "", $tindakan->tarif_satuan);
						...
						<tr>
							...
							<td style="text-align: right"><label><?php echo MyFormatter::formatNumberForPrint($tindakan->tarif_satuan * $tindakan->qty_tindakan); 
						...
						<tr style="background-color: #87c8bc">
							...
							<td colspan="3" style="text-align: right"><?php echo MyFormatter::formatNumberForPrint($total); ?></td>
						</tr>
					</tbody>
