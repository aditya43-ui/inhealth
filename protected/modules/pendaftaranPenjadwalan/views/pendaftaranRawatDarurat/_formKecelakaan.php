...
<?php echo $form->textFieldRow($modKecelakaan, 'tempatkecelakaan', array(
    'class' => 'span3',
    'onkeyup' => "return $(this).focusNextInputField(event)",
    'placeholder' => 'Tempat Kecelakaan'
)); ?>
<?php echo $form->textFieldRow($modKecelakaan, 'keterangankecelakaan', array(
    'class' => 'span3',
    'onkeyup' => "return $(this).focusNextInputField(event)",
