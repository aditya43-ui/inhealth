<?php echo CHtml::activeHiddenField($model, 'is_lakalantas', array('value' => '0')); ?>
...
<div class="control-group form-inline frminput_suplesi">
    <?php echo CHtml::label("Suplesi Jasa Raharja", 'suplesi', array('class' => 'control-label')) ?>
    <div class="controls">
        <?php
        echo $form->radioButtonList($model, 'suplesi_jasaraharja', array("1" => "YA&nbsp;&nbsp;", "0" => "TIDAK"), array('class' => 'suplesi_jasaraharja', 'onkeyup' => "return $(this).focusNextInputField(event)", 'onchange' => 'cekSuplesi(this);'));
        ?>
    </div>
</div>

<div class="control-group frminput_suplesi">
    ...
    <div class="controls">
        ...
        <?php echo CHtml::link("<i class='icon-search'></i>", 'javascript:void(0)', array("rel" => "tooltip", "title" => "klik untuk cari no suplesi", "onclick" => "$('#dialogSuplesi').dialog('open');return true;", 'class' => 'cari_suplesi')); ?>
    </div>
</div>

<div class="control-group frminput_lppolisi">
    <?php echo CHtml::label("No. Laporan Polisi", '', array('class' => 'control-label')) ?>
    <div class="controls">
        <?php echo $form->textField($model, 'kll_nolaporan_polisi', array('placeholder' => 'No. Laporan Polisi', 'class' => 'span3', 'onkeyup' => "return $(this).focusNextInputField(event);", 'maxlength' => 50, 'disabled' => 'disabled')); ?>
    </div>
</div>
...
<div class="control-group ">
    ...
    <div class="controls">
        ...
        $this->widget('MyDateTimePicker', array(
            ...
            'htmlOptions' => array('class' => 'dtPicker2 span3 required', 'onkeyup' => "return $(this).focusNextInputField(event)",),
        )); ?>
...
<div class="control-group ">
    ...
    <div class="controls">
        ...
        <?php echo $form->dropDownList($model, 'propinsi_lakalantas_id', array(), array('empty' => '-- Pilih Propinsi --', 'class' => 'span3 required', 'onkeyup' => "return $(this).focusNextInputField(event)", 'onchange' => 'setKabupaten(this)')); ?><br>
        ...
        <?php echo $form->hiddenField($model, 'propinsi_lakalantas_id', array('class' => 'span3 propinsi', 'onkeyup' => "return $(this).focusNextInputField(event);")); ?>
        <?php echo $form->hiddenField($model, 'kabupaten_lakalantas_id', array('class' => 'span3 kabupaten', 'onkeyup' => "return $(this).focusNextInputField(event);")); ?>
        <?php echo $form->hiddenField($model, 'kecamatan_lakalantas_id', array('class' => 'span3 kecamatan', 'onkeyup' => "return $(this).focusNextInputField(event);")); ?>
    </div>
</div>
<div class="control-group">
