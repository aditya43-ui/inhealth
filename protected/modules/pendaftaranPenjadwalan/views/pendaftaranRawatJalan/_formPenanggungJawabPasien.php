...
<?php echo $form->textFieldRow($modPenanggungJawab, 'nama_pj', array('placeholder' => 'Nama Lengkap Penanggung Jawab', 'class' => 'span4 form-control ' . $nama_kapital, 'onkeyup' => "return $(this).focusNextInputField(event);")); ?>
...
<div class="control-group">
    ...
    <div class="controls">
        <?php
        $modPenanggungJawab->tgllahir_pj = date('d/m/Y', strtotime($modPenanggungJawab->tgllahir_pj));
