...
<script type="text/javascript">
    function cariDataNoRujukan() {
        var katakunci1 = $('.jenisfaskes:checked').val();
        ...
        var setting = {
            ...
            type: 'GET',
            dataType: 'html',
            data: 'param=13&query=' + katakunci3 + '&query2=' + katakunci1,
            beforeSend: function() {
            ...
            success: function(data) {
                ...
                console.log('datafaskes', obj.response.asalFaskes);
                var datatata = $('#ytPPSepT_jenisfaskes').val(obj.response.asalFaskes);
                ...
                if (list != null) {
                    var list2 = list.rujukan.length
                    var html = "";

                    for (var i = 0; i < list2; i++) {

                        var objRjl = list.rujukan[i];
                        ...
                        html += "<tr class = 'hoverable' onclick=\"" + on_click + "\">" +
                            "<td>" +
