...
<div class="col-sm-6">
    <div class="panel panel-success">
        ...
        <div class="panel-body">
            ...
            <div class="control-group rm_manual">
                <label class="control-label">No. RM Manual</label>
                <div class="controls">
                    <?php echo CHtml::activeRadioButtonList($modPasien, 'is_rm_manual', array(1 => 'Ya', 0 => 'Tidak'), array(
                        'template' => '<div style="display: inline-block;">{input}{label}</div>',
                        'class' => 'is_rm_manual', 'onclick' => 'pilihIsManual();'
                    )); ?>
                </div>
            </div>
            <div class="control-group rm_manual">
                ...
                <div class="controls">
                    <?php echo $form->textField($modPasien, 'no_rekam_medik', array(
                        'template' => '<div style="display: inline-block;">{input}{label}</div>',
                        'class' => 'numbers-only span3 no_rekam_medik_manual',
                        'maxlength' => MyGenerator::DigitRM(),
                    )); ?>
                </div>
            </div>
