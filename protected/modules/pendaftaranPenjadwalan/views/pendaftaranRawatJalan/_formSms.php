<div class="control-group">
    ...
    <div class="controls">
        ...
        foreach ($modSmsgateway as $idx => $item) {
            echo CHtml::checkBox('tujuansms[' . $idx . "]", $item->tujuansms == Params::TUJUANSMS_PASIEN, array('value' => $item->tujuansms, 'id' => $item->tujuansms, 'uncheckValue' => null)) . " <label for='" . $item->tujuansms . "'>" . $item->tujuansms . "</label><br>";
        }
