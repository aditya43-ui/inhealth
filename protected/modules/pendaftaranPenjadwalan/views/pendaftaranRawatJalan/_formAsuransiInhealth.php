<div class="control-group">
    ...
    <div class="controls">
        ...
        ?>
        <?php echo CHtml::link("<i class='icon-search'></i>", 'javascript:void(0)', array("rel" => "tooltip", "title" => "klik untuk mengecek peserta", "onclick" => "EligibilitasPeserta($('#" . CHtml::activeId($modAsuransiPasienInhealth, "nopeserta") . "').val());return true;")); ?>
...
<div class="control-group">
    ...
    <div class="controls">
        ...
        $this->widget('MyJuiAutoComplete', array(
            ...
            'htmlOptions' => array('placeholder' => 'Ketik No. Kartu Asuransi Inhealth', 'rel' => 'tooltip', 'title' => 'Ketik No. Peserta',
...
<div class="control-group ">
    ...
    <div class="controls">
    <?php echo $form->dropDownList($modRujukanInhealth,'asalrujukan_id', CHtml::listData($modRujukanInhealth->getAsalRujukanItems(), 'asalrujukan_id', 'asalrujukan_nama'), 
...
<div class="control-group ">
    ...
    <div class="controls">
        <?php echo $form->dropDownList($modRujukanInhealth,'rujukandari_id',CHtml::listData($modRujukanInhealth->getRujukanDariItems($modRujukanInhealth->asalrujukan_id), 'rujukandari_id', 'namaperujuk'),
...
<div class="control-group ">
    <label class="control-label">Diagnosa Utama <font color="red">*</font></label> 
    <div class="controls">
        <?php
        $this->widget('MyJuiAutoComplete', array(
           ...
           'htmlOptions' => array('placeholder' => 'Ketik Kode/Nama Diagnosa', 'rel' => 'tooltip', 'title' => 'Ketik diagnosa untuk mencari data diagnosa', 'class' => 'span3 required',
               'onkeyup' => "return $(this).focusNextInputField(event)",
           ),
        ));
        ?>
...
<div class="control-group ">
    ...
    <div class="controls">
        ...
        $this->widget('MyJuiAutoComplete', array(
           ...
           'htmlOptions' => array('placeholder' => 'Ketik Kode/Nama Diagnosa', 'rel' => 'tooltip', 'title' => 'Ketik diagnosa untuk mencari data diagnosa', 'class' => 'span3',
               'onkeyup' => "return $(this).focusNextInputField(event)",
           ),
        ));
        ?>
...
<div class="control-group ">
    ...
    <div class="controls">
        <?php echo $form->dropDownList($modSepInhealthT,'lakalantas',array('0'=>"Tidak/Biasa",'1'=>"Kecelakaan Kerja",'2'=>"Kecelakaan Lalu Lintas"),
...
<br>
<br>
<?php echo $this->renderPartial($this->path_view.'_jsFunctionInhealth', 
    array('model' => $model,
