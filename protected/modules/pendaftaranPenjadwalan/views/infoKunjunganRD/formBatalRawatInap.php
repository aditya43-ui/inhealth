...
<br>
    ...
    <div class="form-actions" align="center">
           <?php echo CHtml::htmlButton(Yii::t('mds','{icon} Yes',array('{icon}'=>'<i class="icon-lock icon-white"></i>')),
                                array('class' => 'btn btn-danger', 'type'=>'button', 'onclick'=>"parent.$('#dialogBatalRawatInap').dialog('close');")); ?>  </div> 
<?php } else {
?>
...
<fieldset>
    ...
    <div class="form-actions">
		...
		<?php $disablePrint = ($disableSave) ? false : true; ?>
         ...
         <?php echo CHtml::link(Yii::t('mds','{icon} Reset',array('{icon}'=>'<i class="entypo-arrows-ccw"></i>')), 'javascript:void(0);' ,
