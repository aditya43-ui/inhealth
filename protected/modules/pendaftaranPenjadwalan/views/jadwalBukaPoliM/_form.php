...
<div class="row">
    <div class="col-sm-6">
        ...
        <?php echo $form->dropDownListRow($model, 'hari', CustomFunction::getNamaHari(), array('class' => 'span3  form-control', 'onkeyup' => "return $(this).focusNextInputField(event)", 'empty' => '-- Pilih --')); ?>
        ...
        <?php echo $form->textFieldRow($model, 'maxantiranpoli', array('class' => 'span1 numbers-only', 'onkeyup' => "return $(this).focusNextInputField(event);", 'style' => 'text-align:right;')); ?>
    </div>
    <div class="col-sm-6">
        <div class="control-group">
            ...
            <div class="controls">
                ...
                $this->widget('MyDateTimePicker', array(
                    ...
                    'htmlOptions' => array(
                        'readonly' => true, 'class' => 'dtPicker3 span3', 'onkeyup' => "return $(this).focusNextInputField(event)"
                    ),
                )); ?>
