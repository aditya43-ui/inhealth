                ...
                <div class="content">
                    ...
                    <!--<tr>
                        ...
                        <tr>
                            <td>Nama Dokter</td>
                            <td>:</td>
                            <td><?php echo $modPendaftaran->dokter->gelardepan . $modPendaftaran->dokter->nama_pegawai . (isset($modPendaftaran->dokter->gelarbelakang->gelarbelakang_nama) ? "(" . $modPendaftaran->dokter->gelarbelakang->gelarbelakang_nama . ")" : ""); ?></td>
                        </tr>
