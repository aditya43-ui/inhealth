...
<?php echo $form->textFieldRow($modKecelakaan, 'tempatkecelakaan', array('placeholder' => 'Tempat kecelakaan', 'class' => 'span3', 'onkeyup' => "return $(this).focusNextInputField(event)")); ?>
<?php echo $form->textFieldRow($modKecelakaan, 'keterangankecelakaan', array('placeholder' => 'Keterangan', 'class' => 'span3', 'onkeyup' => "return $(this).focusNextInputField(event)",)); ?>
<div class="control-group">
    ...
    <div class="controls">
        ...
        $this->widget('MyDateTimePicker', array(
            ...
            'htmlOptions' => array(
                ...
                'class' => 'span3 dtPicker3 datetimemask',
