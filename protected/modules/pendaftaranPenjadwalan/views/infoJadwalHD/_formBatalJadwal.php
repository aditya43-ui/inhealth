    ...
    <div class="panel-body">
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="control-group">
                    <?php echo $form->labelEx($modBatal, 'bataljadwalhd_tgl', array('class' => 'control-label')) ?>
                    <div class="controls">
                        <?php
                        $this->widget('MyDateTimePicker', array(
                            'model' => $modBatal,
                            'attribute' => 'bataljadwalhd_tgl',
                            'mode' => 'date',
                            'options' => array(
                ...
                <?php echo $form->textAreaRow($modBatal, 'bataljadwalhd_alasan', array('class' => 'span3')); ?>
            </div>
            <div class="col-sm-6">

                <?php echo $form->textAreaRow($modBatal, 'bataljadwalhd_desc', array('class' => 'span3')); ?>
            </div>
        </div>
        <div class="form-actions">
            ...
            <?php echo CHtml::htmlButton(
                ...
                array('class' => 'btn btn-danger', 'onclick' => 'myConfirm("Apakah Anda ingin membatalkan ini?","Perhatian!",function(r){if(r) parent.location.reload();});')
            );
            ?>
        </div>
    </div>
