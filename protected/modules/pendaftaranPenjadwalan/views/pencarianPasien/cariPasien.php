            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <?php echo CHtml::label(CHtml::activeCheckBox($model, 'tgl_rekam_medik',array('checked'=>'checked')) . " <label for='PPPasienM_tgl_rekam_medik'>Tgl. Rekam Medik</label>", 'tgl_rekam_medik', array('class' => 'control-label')) ?>
                     ...
                     */ ?>
                     <div class="control-group">
                            ...
                            <div class="controls">
                                <?php echo $form->textField($model, 'no_rekam_medik', array('class' => 'span4 numbers-only', 'onkeypress' => "return $(this).focusNextInputField(event)", 'placeholder' => 'No. Rekam Medik')); ?>
                            </div>
                        </div>
                        <div class="control-group">
                            <?php echo CHtml::label('Nama Pasien', 'nama_pasien', array('class' => 'control-label')); ?>
                            <div class="controls">
                                <?php echo $form->textField($model, 'nama_pasien', array('class' => 'span4 hurufs-only', 'onkeypress' => "return $(this).focusNextInputField(event)", 'placeholder' => 'Nama Pasien')); ?>
                            </div>
                        </div>
                        <div class="control-group">
                            <?php echo CHtml::label('Alamat Pasien', 'alamat_pasien', array('class' => 'control-label')); ?>
                            <div class="controls">
                                <?php echo $form->textField($model, 'alamat_pasien', array('class' => 'span4 custom-only', 'onkeypress' => "return $(this).focusNextInputField(event)", 'placeholder' => 'Alamat Pasien')); ?>
                            </div>
                        </div>
                        <div class="control-group">
                            <?php echo CHtml::label('Status Rekam Medis', 'statusrekammedis', array('class' => 'control-label')); ?>
                            <div class="controls">
                                <?php
                                    echo $form->dropDownList($model, 'statusrekammedis', array(Params::STATUSREKAMMEDIS_AKTIF => 'Aktif', Params::STATUSREKAMMEDIS_NON_AKTIF => "Non Aktif"), array(
                        ...
                        <div class="control-group">
                            <?php $model->tanggal_lahir = Yii::app()->dateFormatter->formatDateTime(CDateTimeParser::parse($model->tanggal_lahir, 'yyyy-MM-dd'), 'medium', null); ?>
                     ...
                     */
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                            <?php
                                echo $form->dropDownList($model, 'propinsi_id', CHtml::listData($modProp, 'propinsi_id', 'propinsi_nama'), array(
                                    'empty' => '-- Pilih --',
                                    'onkeypress' => "return $(this).focusNextInputField(event)",
                                    'class' => 'span4',
                                    'ajax' => array(
                        ...
                        <div class="control-group">
                            <?php echo CHtml::label('Kota/Kabupaten', 'kabupaten_id', array('class' => 'control-label')); ?>
                            <div class="controls">
                                <?php
                        ...
                        <div class="control-group">
                            <?php echo CHtml::label('Kecamatan', 'kecamatan_id', array('class' => 'control-label')); ?>
                            <div class="controls">
                                <?php
                        ...
                        <div class="control-group">
                            <?php echo CHtml::label('Kelurahan/Desa', 'kelurahan_id', array('class' => 'control-label')); ?>
                            <div class="controls">
                                <?php
                                    echo $form->dropDownList($model, 'kelurahan_id', array(), array(
                                        'empty' => '-- Pilih --',
                                        'onkeypress' => "return $(this).focusNextInputField(event)",
                                        'class' => 'span4',
                                    ));
                ...
                $this->widget('ext.bootstrap.widgets.HeaderGroupGridView', array(
                    ...
                    'columns' => array(
                        ...
                        array(
                            ...
                            'htmlOptions' => array('style' => 'text-align: center; width: 60px;'),
                            'value' => function ($data) {
                                return CHtml::link("<i class='icon-form-riwayatpasien'></i>", Yii::app()->createUrl('rawatJalan/daftarPasien/getRiwayatPasien&id=' . $data->pasien_id), array("rel" => "tooltip", "title" => "Klik untuk Riwayat Pemeriksaan Pasien"));
                            },
                        ),
                        array(
                            'header' => 'Non Aktif',
...
$this->beginWidget('zii.widgets.jui.CJuiDialog', array( // the dialog
    'id' => 'dialogDokFilerm',
    'options' => array(
        'title' => 'Riwayat Dokumen File Rekam Medik',
        'autoOpen' => false,
        'modal' => true,
        'width' => 950,
        'height' => 550,
