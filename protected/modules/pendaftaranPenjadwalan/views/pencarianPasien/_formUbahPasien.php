        ...
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                <div class="control-group">
                    ...
                    <div class="controls">
                        <?php echo $form->hiddenField($modPegawai, 'pegawai_id', array('readonly' => true, 'class' => 'span4', 'onkeyup' => "return $(this).focusNextInputField(event);", 'maxlength' => 10)); ?>
                        <?php
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <?php echo $form->textField($model, 'no_rekam_medik', array('class' => 'span4', 'onkeypress' => "return $(this).focusNextInputField(event)", 'maxlength' => 6, 'readonly' => TRUE)); ?>
                    </div>
                </div>
                <div class="control-group">
                    <?php echo $form->labelEx($model, 'tgl_rekam_medik', array('class' => 'control-label')) ?>
                    <div class="controls">
                        <?php echo $form->textField($model, 'tgl_rekam_medik', array('class' => 'span4', 'onkeypress' => "return $(this).focusNextInputField(event)", 'maxlength' => 6, 'readonly' => TRUE)); ?>
                    </div>
                </div>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <?php
                        echo $form->dropDownList($model, 'jenisidentitas', LookupM::getItems('jenisidentitas'), array(
                ...
                <?php // echo $form->textFieldRow($model,'no_identitas_pasien',array('class'=>'span4', 'onkeypress'=>"return $(this).focusNextInputField(event)"));  
                ?>
                <div class="control-group">
                    ...
                    <div class="controls inline">
                        ...
                        <?php
                        echo $form->dropDownList($model, 'namadepan', LookupM::getItems('namadepan'), array(
                            'empty' => '-- Pilih --', 'onkeypress' => "return $(this).focusNextInputField(event)", 'class' => 'span1', "disabled" => false,
                        ));
                        ?>
                        <?php echo $form->textField($model, 'nama_pasien', array('onkeypress' => "return $(this).focusNextInputField(event)", 'class' => 'span3 hurufs-only '.$nama_kapital)); ?>

                        <?php //echo $form->error($model, 'namadepan');  
                        ?><?php echo $form->error($model, 'nama_pasien'); ?>
                    </div>
                </div>
                <?php echo $form->textFieldRow($model, 'nama_bin', array('placeholder' => 'Nama Panggilan', 'class' => 'span4 '.$nama_kapital, 'onkeypress' => "return $(this).focusNextInputField(event)")); ?>
                <?php echo $form->textFieldRow($model, 'tempat_lahir', array('placeholder' => 'Tempat Lahir', 'class' => 'span4 '.$alamat_kapital, 'onkeypress' => "return $(this).focusNextInputField(event)")); ?>
                <div class="control-group">
                ...
                <?php echo $form->textFieldRow($modPendaftaran, 'umur', array('placeholder' => '00 Thn 00 Bln 00 Hr', 'class' => 'span4 umur', 'onblur' => 'setTglLahir(this);', 'onkeyup' => "return $(this).focusNextInputField(event);", 'maxlength' => 20)); ?>
                ...
                <?php echo $form->dropDownListRow($model, 'statusperkawinan', LookupM::getItems('statusperkawinan'), array('empty' => '-- Pilih --', 'onkeypress' => "return $(this).focusNextInputField(event)", 'onchange' => 'setNamaGelar()', 'class' => 'span4')); ?>
                <div class="control-group">
                ...
                <?php echo $form->textFieldRow($model, 'nama_ibu', array('class' => 'hurufs-only '.$nama_kapital, 'onkeypress' => "return $(this).focusNextInputField(event)", 'placeholder' => 'Nama Ibu')); ?>
                <?php echo $form->textFieldRow($model, 'nama_ayah', array('class' => 'hurufs-only '.$nama_kapital, 'onkeypress' => "return $(this).focusNextInputField(event)", 'placeholder' => 'Nama Ayah')); ?>
            </div>
        </div>
    </div>
    <div class="col-sm-6">
        ...
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                <?php echo $form->textFieldRow($model, 'alamat_pasien', array('placeholder' => 'Alamat Pasien', 'class' => 'span4 '.$alamat_kapital, 'onkeypress' => "return $(this).focusNextInputField(event)")); ?>
                <div class="control-group">
                    <?php echo $form->labelEx($model, 'rt', array('class' => 'control-label inline')) ?>

                    <div class="controls">
                        <?php echo $form->textField($model, 'rt', array('placeholder' => '00', 'onkeypress' => "return $(this).focusNextInputField(event)", 'class' => 'span1', 'maxlength' => 3)); ?> /
                        <?php echo $form->textField($model, 'rw', array('placeholder' => '00', 'onkeypress' => "return $(this).focusNextInputField(event)", 'class' => 'span1', 'maxlength' => 3)); ?>
                        <?php echo $form->error($model, 'rt'); ?>
                        <?php echo $form->error($model, 'rw'); ?>
                    </div>
                </div>
                <?php
                echo $form->dropDownListRow($model, 'propinsi_id', CHtml::listData(PropinsiM::model()->getPropinsiItems(), 'propinsi_id', 'propinsi_nama'), array(
                ...
                ?>
                <?php
                echo $form->dropDownListRow($model, 'kabupaten_id', CHtml::listData(KabupatenM::model()->getKabupatenItemsProp($model->propinsi_id), 'kabupaten_id', 'kabupaten_nama'), array(
                    'class' => 'span4', 'empty' => '-- Pilih --', 'onkeypress' => "return $(this).focusNextInputField(event)",
                    'ajax' => array(
                        'type' => 'POST',
                ...
                ?>
                <?php
                echo $form->dropDownListRow($model, 'kecamatan_id', CHtml::listData(KecamatanM::model()->getKecamatanItemsKab($model->kabupaten_id), 'kecamatan_id', 'kecamatan_nama'), array(
                    'class' => 'span4', 'empty' => '-- Pilih --', 'onkeypress' => "return $(this).focusNextInputField(event)",
                    'ajax' => array(
                        'type' => 'POST',
                ...
                ?>
                <?php echo $form->dropDownListRow($model, 'kelurahan_id', CHtml::listData(KelurahanM::model()->getKelurahanItemsKec($model->kecamatan_id), 'kelurahan_id', 'kelurahan_nama'), array('class' => 'span4', 'empty' => '-- Pilih --', 'onkeypress' => "return $(this).focusNextInputField(event)")); ?>

                <?php
                echo $form->dropDownListRow($model, 'pekerjaan_id', CHtml::listData(PekerjaanM::model()->getPekerjaanItems(), 'pekerjaan_id', 'pekerjaan_nama'), array(
                    'class' => 'span4', 'empty' => '-- Pilih --', 'onkeypress' => "return $(this).focusNextInputField(event)", 'onchange' => 'cekStatusPekerjaan(this)',
                ...
                <?php echo $form->textFieldRow($model, 'no_telepon_pasien', array('placeholder' => 'No. Telepon Pasien', 'class' => 'span4', 'onkeypress' => "return $(this).focusNextInputField(event)")); ?>
                <?php echo $form->textFieldRow($model, 'no_mobile_pasien', array('placeholder' => 'No. Handphone Pasien', 'class' => 'span4', 'onkeypress' => "return $(this).focusNextInputField(event)")); ?>
                <div class="control-group">
                    <?php echo $form->labelEx($model, 'agama', array('class' => 'control-label')) ?>
                    <div class="controls">
                        <?php echo $form->dropDownList($model, 'agama', LookupM::getItems('agama'), array('style' => 'width:170px;', 'class' => 'form-control span3', 'empty' => '-- Pilih --', 'onkeyup' => "return $(this).focusNextInputField(event)")); ?>
                    </div>
                </div>
                <?php echo $form->dropDownListRow($model, 'warga_negara', LookupM::getItems('warganegara'), array('style' => 'width:170px;', 'class' => 'form-control span3', 'empty' => '-- Pilih --', 'onkeyup' => "return $(this).focusNextInputField(event)")); ?>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    function setNamaDepan() {
        ...
        var statusperkawinan = $('#PPPasienM_statusperkawinan').val();
        var namadepan = $('#PPPasienM_namadepan');
        var umur = $("#<?php echo CHtml::activeId($modPendaftaran, 'umur'); ?>").val().substr(0, 2);
        umur = parseInt(umur);
