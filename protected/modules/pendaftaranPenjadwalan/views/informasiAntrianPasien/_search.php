...
<div class="col-sm-6">   
    <div class="control-group">
        <?php echo CHtml::label('Tanggal Antrian', '', array('class' => 'control-label')) ?> 
        <div class="controls">
            <?php  
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <?php echo $form->textField($model, 'no_pendaftaran', array('placeholder' => 'Ketik Nomor Pendaftaran', 'class' => 'span4',  'onkeypress' => "return $(this).focusNextInputField(event)")); ?>
        </div>
    </div>  
</div>
<div class="col-sm-6">
<div class="control-group">
        ...
        <div class="controls">
            <?php echo $form->textField($model, 'no_rekam_medik', array('placeholder' => 'Ketik Nomor Rekam Medik', 'class' => 'span4',  'onkeypress' => "return $(this).focusNextInputField(event)")); ?>
        </div>
    </div>  
    <div class="control-group">
        <?php echo CHtml::label('No Antrian Poliklinik', '', array('class' => 'control-label')) ?> 
        <div class="controls">
            <?php echo $form->textField($model, 'noantrian', array('placeholder' => 'Ketik Nomor Antrian Poliklinik', 'class' => 'span4',  'onkeypress' => "return $(this).focusNextInputField(event)")); ?>
        </div>
    </div>  
    <div class="control-group">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <?php echo $form->dropDownList($model, 'carabayar_id', CarabayarM::arrBayarId(), array('empty' => '-- Pilih --', 'class' => 'span4', 'onkeypress' => "return $(this).focusNextInputField(event)")); ?>
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <?php echo $form->dropDownList($model, 'statuspasien', [
                'ANJUNGAN' => 'ANJUNGAN',
                'PROSES BARCODE' => 'PROSES BARCODE',
                'TUNGGU DAFTAR' => 'TUNGGU DAFTAR',
                'TUNGGU POLIKLINIK'=> 'TUNGGU POLIKLINIK',
