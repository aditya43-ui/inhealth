...
");
        ...
        <div class="form-actions">
            <?php
            echo CHtml::link(Yii::t('mds', '{icon} Tambah Kelurahan', array('{icon}' => '<i class="icon-plus icon-white"></i>')), $this->createUrl('/pendaftaranPenjadwalan/kelurahanM/create', array('modul_id' => Yii::app()->session['modul_id'])), array('class' => 'btn btn-danger'));
