...
<?php $form=$this->beginWidget('ext.bootstrap.widgets.BootActiveForm',array(
    ...
    if(isset($_GET['sukses'])){
        Yii::app()->user->setFlash('success',"Data Janj Poli Pasien ".$modPPBuatJanjiPoli->pasien->namadepan." ".$modPPBuatJanjiPoli->pasien->nama_pasien." berhasil disimpan ");
    }
    ?>
    ...
    <div class="form-actions">
         <?php
             if ($modPPBuatJanjiPoli->isNewRecord) {
                    echo CHtml::htmlButton($modPPBuatJanjiPoli->isNewRecord ? Yii::t('mds','{icon} Create',array(
                            '{icon}'=>'<i class="entypo-check"></i>')) : Yii::t('mds','{icon} Save',array(
                                    '{icon}'=>'<i class="entypo-check"></i>')),array('class'=>'btn btn-primary', 'type'=>'submit',
        ...
        <?php   
			if(!empty($_GET['id'])){
				echo CHtml::link(Yii::t('mds', '{icon} Print', array('{icon}'=>'<i class="entypo-print"></i>')), '#', 
