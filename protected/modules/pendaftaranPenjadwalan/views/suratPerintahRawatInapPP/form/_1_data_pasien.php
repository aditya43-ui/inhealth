        ...
        <div class="control-group">
            ...
            <div class="controls">
                ...
                if (!empty($model->pendaftaran_id)) {
                    ...
                    echo CHtml::dropDownList('instalasi_id', $model->instalasi_id, CHtml::listData(InstalasiM::model()->getInstalasiPelayananRDRI(), 'instalasi_id', 'instalasi_nama'), array('onchange' => 'setInfoPasienReset();refreshDialogInfoPasien();', 'class' => 'span3', 'onkeyup' => "return $(this).focusNextInputField(event)",));
                }
                ?>
            </div>
        </div>
