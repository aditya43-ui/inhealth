...
<p>
    ...
    Saya menyetujui untuk dirawat di <?php echo ProfilrumahsakitM::model()->find()->nama_rumahsakit; ?>  sesuai kebutuhan medis. Saya mengetahui
...
dan menyadari bahwa <?php echo ProfilrumahsakitM::model()->find()->nama_rumahsakit; ?>  termasuk Dokter dan Paramedisnya tidak bertanggung jawab
...
digunakan untuk perawatan medis dijamin kerahasiannya oleh pihak <?php echo ProfilrumahsakitM::model()->find()->nama_rumahsakit; ?>, dan saya
memberikan wewenang kepada pihak <?php echo ProfilrumahsakitM::model()->find()->nama_rumahsakit; ?> untuk memberikan informasi tentang diagnosa
...
<?php echo ProfilrumahsakitM::model()->find()->nama_rumahsakit; ?>  untuk memberikan informasi tentang diagnosa, hasil tes diagnosa, hasil laboratorium
...
Saya telah mendapatkan informasi tentang Hak dan Tangung jawab pasien di <?php echo ProfilrumahsakitM::model()->find()->nama_rumahsakit; ?> melalui
leaflet dan banner yang disediakan oleh petugas. Saya memahami bahwa <?php echo ProfilrumahsakitM::model()->find()->nama_rumahsakit; ?>  tidak ber-
tanggun jawab atas kehilangan barang pribadi dan berharga yang dibawa pasien. Saya ikut bertangung jawab
atas ketertiban, kebersihan, ketenangan dan kenyamanan di <?php echo ProfilrumahsakitM::model()->find()->nama_rumahsakit; ?>
...
yang telah dijelaskan oleh petugas <?php echo ProfilrumahsakitM::model()->find()->nama_rumahsakit; ?>
