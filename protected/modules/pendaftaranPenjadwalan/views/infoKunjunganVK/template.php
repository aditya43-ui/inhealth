...
<table width = "32%" class="belumLunas">
    <tr>
        <td>
            <div style="padding:2px; margin-left: 30px; border:1px solid; border-color: black;transform: rotate(0deg); text-align: left;">
                <p style="font-size:20px; font-weight:bold; color:red;"></p>
                ...
                <?= ($print)?$model->catatanpenting:$form->textArea($model,'catatanpenting',['rows'=>9]) ?>
            </div>
        </td>
    </tr>
