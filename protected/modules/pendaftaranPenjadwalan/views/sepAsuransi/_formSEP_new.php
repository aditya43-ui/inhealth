<div class="row-fluid">
    <div class="span8">
        ...
        <div class="control-group clsrujukan">
            ...
            <div class="controls">
                ...
                <?php echo CHtml::link("<i class='icon-search'></i>", 'javascript:void(0)', array('class' => 'rujukanTombol', "rel" => "tooltip", "title" => "klik untuk mengecek rujukan", "onclick" => "$('#dialogNoRujukan').dialog('open');cariDataNoRujukan();")); ?>
                <?php
                echo CHtml::htmlButton('<i class="icon-search icon-white"></i> Cari No SEP Rawat Inap ', array(
                    'class' => 'btn btn-primary',
                    'onclick' => 'srkCariRiwayatSEPRI_1();',
                    'rel' => 'tooltip',
        ...
        <div class="control-group ">
            ...
            <div class="controls isRawatInap hidden">
                <?php echo $form->checkBox($model, 'isNaikKelas', array('onchange' => 'isNaikKelas(this)', 'class' => 'permanent')); ?> Naik Kelas
            </div>
        </div>
        <div class="is-naikkelas">
            <div class="control-group ">
                <?php echo CHtml::label("Kelas Rawat <span class='required'>*</span>", 'kelastanggungan', array('class' => 'control-label')) ?>
                <div class="controls">
                    <?php echo $form->dropDownList($model, 'klsRawatNaik', CHtml::listData(KelaspelayananM::model()->findAll('kelaspelayanan_aktif = true and kelasnaikbpjs_id is not null order by kelasnaikbpjs_id DESC'), 'kelaspelayanan_id', 'kelaspelayanan_nama'), array(
                        'empty' => '-Pilih-', 'class' => 'span3 required', 'onkeyup' => "return $(this).focusNextInputField(event)",
                    )); ?>
                </div>
            </div>
            <div class="control-group">
                <?php echo $form->labelEx($model, 'penanggungjwb_naikkls_id', array('class' => 'control-label')) ?>
                <div class="controls">
                    <?php
                    echo $form->dropDownList($model, 'penanggungjwb_naikkls_id', CHtml::listData(LookupM::model()->findAllByAttributes(array(
                        'lookup_type' => 'bpjs_penanggungjawab_naikkelas',
                    ), array(
                        'order' => 'lookup_urutan'
                    )), 'lookup_value', 'lookup_name'), array('disabled' => true, 'empty' => '-- Pilih --', 'class' => 'span3', 'onkeyup' => "return $(this).focusNextInputField(event)", 'onchange' => 'inputNamaPenjamin()'));

                    ?>
                </div>
            </div>
            <div class="control-group">
                <?php echo $form->labelEx($model, 'penanggungjwb_naikkls_nama', array('class' => 'control-label')) ?>
                <div class="controls">
                    <?php
                    echo $form->textArea($model, 'penanggungjwb_naikkls_nama', array('placeholder' => 'penanggungjawab', 'class' => 'span3 ', 'onkeyup' => "return $(this).focusNextInputField(event);", 'maxlength' => 100, 'rel' => 'tooltip', 'title' => 'Isi jika pasien naik Kelas', 'disabled' => false));
                    ?>
                </div>
            </div>
        </div>
    ...
    <div class="span6">
        ...
        <div class="control-group politujuan_n">
        ...
        <div class="rujukan" id="skdp">
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    <?php echo CHtml::link("<i class='icon-search'></i>", 'javascript:void(0)', array("rel" => "tooltip", "title" => "klik untuk car Surat Kontrol Pasien", "id" => "tombolcarispri", "onclick" => "cariSuratKontrol(); return true;")); ?>
                </div>
            </div>
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    <?php echo CHtml::link("<i class='icon-search'></i>", 'javascript:void(0)', array("rel" => "tooltip", "title" => "klik untuk cari DPJP", "id" => "tombolcari", "onclick" => "$('#dialogDpjp').dialog('open');return true;")); ?>
        ...
        <div class="control-group dpjp-melayani">
            <?php
            ...
            <div class="controls">
                ...
                <?php echo CHtml::link("<i class='icon-search'></i>", 'javascript:void(0)', array("rel" => "tooltip", "title" => "klik untuk cari DPJP", "onclick" => "clickJenis();")); ?>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $form->dropDownList($model, 'statuskecelakaan_kode', LookupM::getItemsUrutan('bpjs_statuskecelakaan'), array('class' => 'span3', 'onchange' => 'setChangeStatusKecelakaan()')); ?>
            </div>
        </div>
        <?php
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $form->textField($model, 'no_telpon_peserta', array('placeholder' => 'Telepon peserta', 'class' => 'span3  numbers-only required', 'onkeyup' => "return $(this).focusNextInputField(event);", 'maxlength' => 50, 'onblur' => 'cekNoPonselSEP()')); ?>
            </div>
        </div>
        <div class="control-group">
...
<script>
    function clickJenis() {
        ...
        $('#dialogDpjpMelayani').dialog('open');

        var kode_spesialis_melayani = $('#ARSepT_politujuan').val();
        $('#kode_spesialis_melayani').val(kode_spesialis_melayani);
    }
    ...
    function pilihJenisKunjunganBPJS() {
        ...
        if (jenis == "2") {
            $("#ARSepT_asesmen_pelayanan").val(5);
        }
