...
<div class="col-sm-6">
    <div class="box2">
        ...
        <?php echo $form->dropDownListRow($model, 'jeniskasuspenyakit_id', CHtml::listData($model->getJenisKasusPenyakitItems(Params::INSTALASI_ID_PERSALINAN), 'jeniskasuspenyakit_id', 'jeniskasuspenyakit_nama'), array('onkeyup' => "return $(this).focusNextInputField(event)", 'class' => 'span3', 'empty' => '-- Pilih --')); ?>
        <div class='control-group'>
            ...
            <div class='controls'>
                <?php echo $form->dropDownList(
                    $model,
                    'ruangan_id',
                    CHtml::listData($model->getRuanganItemsVK2(Params::INSTALASI_ID_PERSALINAN), 'ruangan_id', 'ruangan_nama'),
                    array(
                        'empty' => '-- Pilih --',
            ...
            <div class="controls">
                <?php echo $form->dropDownList($model, 'carabayar_id', CHtml::listData($model->getCaraBayarItems(), 'carabayar_id', 'carabayar_nama'), array(
                    ...
                    'ajax' => array(
                        ...
                        'success' => 'function(data){$("#' . CHtml::activeId($model, "penjamin_id") . '").html(data);setKarcis();setKelasTanggunganDrop();}',
                    ),
                    'onchange' => 'setFormAsuransi(this.value); cekCaraBayarBadak(this.value);showUmumBpjs(this.value);bpjsManual();',
                    'class' => 'span3',
                )); ?>
            </div>
        ...
        <?php echo $form->dropDownListRow($model, 'keadaanmasuk', LookupM::getItems('keadaanmasuk'), array(
            'empty' => '-- Pilih --',
            'onkeyup' => "return $(this).focusNextInputField(event)", 'class' => 'span3'
        )); ?>
        ...
        array(
            ...
            'filter' => $this->widget(
                ...
                array(
                    ...
                    'htmlOptions' => array('readonly' => false, 'class' => 'span3', 'id' => 'jadwaldokter_buka', 'placeholder' => '00:00:00'),
                ),
                true
            ),
...
<script>
    ...
    //     jQuery("input#jadwaldokter_buka").datepicker(jQuery.extend({
    ...
    //     $("#PPJadwaldokterM_jadwaldokter_buka").datepicker();
    // }
</script>