<?php $linkHalaman = CustomFunction::getUrlByMenuID(3448); ?>
<style>
...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="glyphicon glyphicon-user"></i> Pendaftaran <b>Persalinan</b>
    ...
    <div class="panel-body">
                        ...
                        <?php /* $this->Widget('ext.bootstrap.widgets.BootAccordion',array(
								...
								'content'=>array(
									'content-kecelakaan'=>array(
										...
										'isi'=>$this->renderPartial($this->path_viewRD.'_formKecelakaan',array(
												'form'=>$form,
												'model'=>$model,
        ...
        <div class="form-actions">
            ...
            if ($model->isNewRecord) {
                ...
                echo CHtml::htmlButton(Yii::t('mds', '{icon} Hak & Kewajiban Pasien', array('{icon}' => '<i class="entypo-user"></i>')), array('id' => 'btn_hak_pasien', 'rel' => 'tooltip', 'class' => 'btn btn-info','disabled' => true));
            } else {
        ...
        <?php $this->renderPartial($this->path_viewRD . '_jsFunctions', array('model' => $model, 'modPasien' => $modPasien, 'modPenanggungJawab' => $modPenanggungJawab, 'modRujukan' => $modRujukan, 'modSep'=> $modSep)); ?>
    </div>
</div>
<?php
$this->beginWidget('zii.widgets.jui.CJuiDialog', array(
