        ...
        <div class="panel-body">
            <!-- <div class="control-group">
                ...
                <div class="controls">
                    ...
                    //     'class' => 'rb_rm rmbaru',
                    //     'id' => 'rmbaru',
                    // )) . "<label for='rmbaru'> Pasien Baru</label> ";
                    // echo CHtml::radioButton('rb_rm', false, array(
                    //     'value' => 0,
                    //     'name' => 'otomatis',
                    //     'uncheckValue' => null,
                    ...
                    //     'class' => 'rb_rm rmlama',
                    //     'id' => 'rmlama',
                    // )) . "<label for='rmlama'> Pasien Lama</label> ";
                    ?>
                </div>
            </div> -->
            <!--</div>-->
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?php echo $form->dropDownList($modPasien, 'jenisidentitas', LookupM::getItems('jenisidentitas'), array('empty' => '-- Pilih --', 'onkeyup' => "return $(this).focusNextInputField(event)", 'class' => 'span3', 'style' => 'float:left; width:150px'));
                    ?>
                    <br>
                    <br>
                    <?php
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?php echo $form->dropDownList($modPasien, 'namadepan', LookupM::getItems('namadepan'), array('empty' => '-- Pilih --', 'onkeyup' => "return $(this).focusNextInputField(event)", 'class' => 'span3',));
                    ?>
                    <br>
                    <?php
                    $this->widget('MyJuiAutoComplete', array(
        ...
        <div class="panel-body">
            ...
            <?php else : ?>
                <div style="text-align: center;">
                    <?php
                    // echo CHtml::htmlButton(Yii::t('mds', '{icon} Ambil Foto', array('{icon}' => '<i class="entypo-camera"></i>')), array('class' => 'btn btn-primary', 'onclick' => "$('#dialog-addphoto').dialog('open'); putarWebcam();",
                    //     'id' => 'btn-addphoto', 'onkeyup' => "return $(this).focusNextInputField(event)",
                    ...
                    ?>
                    <img id="photo-preview" src="<?php echo $url_photopasien ?>" width="160px;" />
                </div>
    ...
    $this->Widget('ext.bootstrap.widgets.BootAccordion', array(
        ...
        'content' => array(
            'content-detailpasien' => array(
                // 'header' => CHtml::htmlButton("<i class='icon-plus icon-white'></i>", array('class' => 'btn btn-primary btn-mini', 'onclick' => '', 'onkeyup' => "return $(this).focusNextInputField(event)", 'rel' => 'tooltip', 'title' => 'Klik untuk tampilkan detail pasien')) . '<b>Detail Pasien</b>',
...
<script type="text/javascript">
    ...
    function simpanGambar() {
        ...
        $("#ROPasienM_photopasien").val(temp_img);
        $("#ROPasienM_is_ambilfoto").val(1);
