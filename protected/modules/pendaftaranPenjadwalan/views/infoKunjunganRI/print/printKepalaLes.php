...
<table width="100%" style="margin-top:18.5mm;position: absolute;" >
    <tr>
...
<table width='100%' style="margin-left: 15mm; margin-top:30mm">
    ...
    <tr class="kosong2">
        ...
        <td valign="top" colspan="2" style="text-align: right; padding-right: 70px;"><?= $modPasien->pendidikan->pendidikan_nama ?? '' ?></td>
    </tr>
    <tr class="kosong2">
        <td></td>
        <td></td>
    ...
    <tr class="penanggung">
        ...
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td colspan="2" style="text-align: right; padding-right: 70px;"><?= $modPasien->pekerjaan->pekerjaan_nama ?></td>
    </tr>
    <tr>
        <td colspan="4">
