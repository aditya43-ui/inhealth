...
<div class="dashboard" style="overflow: hidden;">
    <div class="row">
        <div class="col-md-3 col-sm-6 col-sm-12">
            <div class="tile-stats tile-red">
                ...
                <div data-delay="0" data-duration="1500" data-postfix="" data-end="<?php echo $modKunjunganToday; ?>" data-start="0" class="num">0</div>
        ...
        <div class="col-md-3 col-sm-6 col-sm-12">
            <div class="tile-stats tile-green">
                ...
                <div data-delay="0" data-duration="1500" data-postfix="" data-end="<?php echo $modPasienBaru; ?>" data-start="0" class="num">0</div>
                <h3>Pasien Baru</h3>
        ...
        <div class="col-md-3 col-sm-6 col-sm-12">
            <div class="tile-stats tile-aqua">
                ...
                <div data-delay="0" data-duration="1500" data-postfix="" data-end="<?php echo $modPasienLama; ?>" data-start="0" class="num">0</div>
                <h3>Pasien Lama</h3>
        ...
        <div class="col-md-3 col-sm-6 col-sm-12">
            <div class="tile-stats tile-blue">
                ...
                <div data-delay="0" data-duration="1500" data-postfix="" data-end="<?php echo $modJanjipoli; ?>" data-start="0" class="num">0</div>
                <h3>Pasien Online </h3>
                <p>Pasien online hari ini.</p>
            </div>
        </div>
    </div>
    ...
    <div class="row">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <div class="panel-options">
                        <!--<a href="#sample-modal" data-toggle="modal" data-target="#sample-modal-dialog-1" class="bg hidden"><i class="entypo-cog"></i></a>-->
        ...
        <div class="col-sm-6">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="panel-title">
                        <i class="entypo-user"></i> Pendaftaran Pasien Terbaru
                    </div>
    ...
    if ($konsys->mapdashboard) { ?>
        ...
        <div class="row">
            <?php $this->renderPartial('_map', array('modMap' => $modMap, 'profil' => $profil, 'konsys' => $konsys, 'longitude' => $longitude, 'latitude' => $latitude)); ?>
        </div>
