...
<script type="text/javascript">
    ...
    function printKepalaLes(pendaftaran_id) {
        window.open('<?php echo $this->createUrl('/pendaftaranPenjadwalan/InfoKunjunganRI/printKepalaLes'); ?>&pendaftaran_id=' + pendaftaran_id, 'printwin', 'left=100,top=100,width=860,height=480');
    }
    ...
    function setPasienRJRD(pendaftaran_id, no_pendaftaran, pasien_id, no_rekam_medik, instalasi_id) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                // if (data.is_approve_rd == 0) {
                //     myAlert("Pasien belum divalidasi PJA");
                //     $("#form-pasien > div").removeClass("animation-loading");
                //     return false;
                // }

                //            if(data.statusperiksa != "<?php // echo Params::STATUSPERIKSA_SEDANG_DIRAWATINAP 
                                                        ?>"){ << RND-1531
                //                myAlert("Status periksa pasien '"+data.statusperiksa+"'. Silakan hubungi Poliklinik/Ruangan : "+data.ruangan_nama+" untuk di tindak lanjut ke Rawat Inap!");
                //                $("#form-pasien > div").removeClass("animation-loading");
                //                return false;
                //            }
                if (data.statusrekammedis == "<?php echo Params::STATUSREKAMMEDIS_AKTIF ?>") {
                    ...
                    $('#no_rekam_medik_hidden').val(data.no_rekam_medik);
                    ...
                    if (data.carabayar_id == <?= Params::CARABAYAR_ID_BPJS ?>) {
                        $('#PPSepT_no_surat').val(data.nomorspri_bpjs);
                    }
                    ...
                    console.log('Mau masuk set asuransi nih?');
                    console.log(data);
                    ...
                    $("#PPPasienM_jenisidentitas").change();
                } else {
    ...
    function setDokterDPJP(data) {
        $("#dokterpenerima_id").val(data.dpjp1_id);
        $("#dokterpenerima").val(data.dpjp1);
        ...
        $("#<?php echo CHtml::activeId($model, 'penerimapasien') ?>").val(data.penerimapasien);
    ...
    function setAsuransiPasienLama(pasien_id) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                console.log('data ada nggak ini:');
                console.log(data);
                if (data != null) {
                            ...
                            if (data.carabayar_id == <?php echo Params::CARABAYAR_ID_BPJS; ?>) {
                                ...
                                <?php if (Yii::app()->user->getState('isbridging') == true) { ?>
                                    ...
                                    $.post("<?php echo $this->createUrl("cekCaraBayarBPJS"); ?>", {
                                        ...
                                        // console.log(data2.dat.jenispeserta_bpjs, $("#<?php echo CHtml::activeId($modRujukanBpjs, 'jenispeserta_bpjs') ?>")     );
                                        $("#<?php echo CHtml::activeId($modSep, 'ppkrujukan') ?>").val(data2.ppk);
                                        $("#<?php echo CHtml::activeId($modSep, 'no_telpon_peserta') ?>").val(data2.sep.no_telpon_peserta);
                                        $("#<?php echo CHtml::activeId($modSep, 'statuskecelakaan_kode') ?>").val(data2.sep.statuskecelakaan_kode);
                                        $("#<?php echo CHtml::activeId($modSep, 'jenis_kunjungan') ?>").val(data2.sep.jenis_kunjungan).change();
                                        $("#<?php echo CHtml::activeId($modSep, 'catatansep') ?>").val(data2.sep.catatansep).change();
                                        $("#<?php echo CHtml::activeId($modSep, 'no_surat') ?>").val(data2.spri);
                                        $("#<?php echo CHtml::activeId($modSep, 'jenisfaskes') ?>_1").click();
                                        $("#<?php echo CHtml::activeId($modSep, 'penanggungjwb_naikkls_id') ?>").prop("disabled", true).val("");
                                        $("#<?php echo CHtml::activeId($modSep, 'klsRawatNaik') ?>").val("");

                                        if (data2.sep.cob != null) {
                                            $("#<?php echo CHtml::activeId($modSep, 'cob') ?>").prop("checked", true);
                                        } else {
                                            $("#<?php echo CHtml::activeId($modSep, 'cob') ?>").prop("checked", false);
                                        }

                                        if (data2.sep.katarak == 0) {
                                            $("#<?php echo CHtml::activeId($modSep, 'katarak') ?>_1").click();
                                        }
                                        if (data2.sep.katarak == 1) {
                                            $("#<?php echo CHtml::activeId($modSep, 'katarak') ?>_0").click();
                                        }


                                        if (data2.sep.poli_eksekutif == 0) {
                                            $("#<?php echo CHtml::activeId($modSep, 'poli_eksekutif') ?>_1").click();
                                        }
                                        if (data2.sep.poli_eksekutif == 1) {
                                            $("#<?php echo CHtml::activeId($modSep, 'poli_eksekutif') ?>_0").click();
                                        }


                                        $("#<?php echo CHtml::activeId($modAsuransiPasienBpjs, 'jenispersertakode_bpjs') ?>").val(data2.dat.jenispersertakode_bpjs);
                                        $("#<?php echo CHtml::activeId($modAsuransiPasienBpjs, 'jenispeserta_bpjs') ?>").val(data2.dat.jenispeserta_bpjs);
						...
						$.ajax({
							...
							success:function(data){
								if(data.status === true){
									...
									$("#<?php //echo CHtml::activeId($modPasienAdmisi,"carabayar_id");
                                        ?>").val(datacarabayar_id);
									$("#<?php //echo CHtml::activeId($modPasienAdmisi,"penjamin_id");
                                        ?>").html(datalistPenjamin);
									$("#<?php //echo CHtml::activeId($modPasienAdmisi,"penjamin_id");
                                        ?>").val(datapenjamin_id);
									if(datacarabayar_id == <?php //echo Params::CARABAYAR_ID_BPJS 
                                                            ?>){
										getAsuransiNoKartu(datanopeserta);
									}else if((datacarabayar_id == <?php //echo Params::CARABAYAR_ID_BADAK; 
                                                                    ?>) || (datacarabayar_id == <?php echo Params::CARABAYAR_ID_DEP_BADAK; ?>) || (datacarabayar_id == <?php echo Params::CARABAYAR_ID_PEKERJA; ?>)){
    ...
    // {
    //     window.open('<?php //echo $this->createUrl('printKarcis',array('pendaftaran_id'=>$model->pendaftaran_id)); 
                        ?>','printwin','left=100,top=100,width=480,height=640');
    // }

    function printLabelGelangRawatInap(tipe) {
    ...
    $(document).ready(function() {
        <?php if (isset($_GET['pendaftarantindaklanjut_id'])) {

            $pendaftaran = PendaftaranT::model()->findByPk($_GET['pendaftarantindaklanjut_id']);

            if (empty($pendaftaran->pasienadmisi_id)) {
        ?>

                setPasienRJRD(<?php echo $pendaftaran->pendaftaran_id; ?>, '', <?php echo $pendaftaran->pasien_id; ?>, '', <?php echo $pendaftaran->instalasi_id; ?>);
    ...
    function setPegawai(pegawai_id, nip) {
        $.post('<?php echo $this->createUrl('getDataPegawaiUntukPasienBaru'); ?>', {
            ...
            if (data.ok == 0) {
                ...
                $("#<?php echo CHtml::activeId($modPasien, "suku_id"); ?>").val(data.res.suku_id).change().multiselect('rebuild');
    ...
    function setPasienBaru() {
        ...
        $("#<?php echo CHtml::activeId($modPasien, "suku_id"); ?>").val('<?php echo $modPasien->suku_id; ?>').change().multiselect('rebuild');;
        $("#<?php echo CHtml::activeId($modPasien, "alamatemail"); ?>").val("");
        $("#<?php echo CHtml::activeId($modPasien, "anakke"); ?>").val("");
        $("#<?php echo CHtml::activeId($modPasien, "jumlah_bersaudara"); ?>").val("");
        $("#<?php echo CHtml::activeId($modPasien, "pendidikan_id"); ?>").val("");
            ...
            success: function(data) {
                ...
                if (data != null) {
                    ...
                    if (confirm("Apakah pasien ini akan menggunakan penjamin " + data.penjamin_nama + "?")) {
                        ...
                        $("#<?php echo CHtml::activeId($modPasienAdmisi, "carabayar_id"); ?>").val(datacarabayar_id).multiselect('rebuild');
                        $("#<?php echo CHtml::activeId($modPasienAdmisi, "penjamin_id"); ?>").html(datalistPenjamin).multiselect('rebuild');
                        $("#<?php echo CHtml::activeId($modPasienAdmisi, "penjamin_id"); ?>").val(datapenjamin_id).multiselect('rebuild');
    ...
    function setDropdownJeniskasuspenyakit(ruangan_id) {
        $.ajax({
            ...
            dataType: "json",
            success: function(data) {
                $("#<?php echo CHtml::activeId($model, "jeniskasuspenyakit_id"); ?>").html(data.listKasuspenyakit).multiselect('rebuild');
                ...
                $(".is_nonkelas").val(data.is_nonkelas);
            },
            error: function(jqXHR, textStatus, errorThrown) {
                console.log(errorThrown);
            }
     ...
     */
    // function setKarcis() {
    //     var kelaspelayanan_id = $("#<?php //echo CHtml::activeId($model, "kelaspelayanan_id"); 
                                        ?>").val();
    //     var ruangan_id = $("#<?php //echo CHtml::activeId($model, "ruangan_id"); 
                                ?>").val();
    //     var penjamin_id = $("#<?php //echo CHtml::activeId($model, "penjamin_id"); 
                                    ?>").val();
    ...
    * pada KTP, dan kemudian periksa pengulangan angka di awal.
    ...
    function printGeneralConsent() {
        window.open('<?php echo $this->createUrl('suratPersetujuanUmum/PrintGeneralConsent', array('pendaftaran_id' => $model->pendaftaran_id)); ?>', 'printwin', 'left=100,top=100,width=860,height=480');
    }
    ...
    function cariSpri() {
        ...
        var isi = $("#PPSepT_no_surat").val();
        var no_kartu = $('#PPAsuransipasienbpjsM_nopeserta').val();
        var aksi = 19;
        ...
        var setting = {
            ...
            success: function(data) {
                ...
                if (res.response != null) {
                    data_kontrol = res.response;
                    if (res.response.diagnosa_kode != 0) {
                        setDiagnosa(res.response.diagnosa_kode, res.response.diagnosa_nama)
                        setDiagnosaBpjs(res.response.diagnosa_kode, res.response.diagnosa_nama)
                    }
                    showDialogSpri();
                } else {
                    myAlert(res.metaData.message);
    ...
    function setSuratKontrol() {
        ...
        if (data_kontrol.status_kontrol != 0) { // data spri nya sudah lewat dari tgl rencana
            $("#PPSepT_no_surat").val("");
        } else {
            ...
            */
            $("#PPSepT_politujuan").val(data_kontrol.namaPoliTujuan);
        }
    }
...
//              $("#<?php echo CHtml::activeId($modAsuransiPasienBpjs, 'kelastanggunganasuransi_id') ?>").val(peserta.kelasTanggungan.kdKelas); // <<tidak sama dengan kelaspelayanan_id
    ...
    function setDropDownRuangan(jeniskasuspenyakit_id) {
        var instalasi_id = "<?php echo Params::INSTALASI_ID_RI; ?>";
        $.ajax({
            type: 'POST',
            url: '<?php echo $this->createUrl('pendaftaranRawatJalan/setDropDownRuangan'); ?>',
            data: {
            ...
            success: function(data) {
                ...
                $("#PPPasienAdmisiT_ruangan_id").html(data.listRuangan).multiselect('rebuild');
            },
            error: function(jqXHR, textStatus, errorThrown) {
                console.log(errorThrown);
            }
    ...
    $kelas_urut_new = CHtml::listData($kelas_data, 'kelasbpjs_id', 'kelasnaikbpjs_id');
    ...
    var data_kelas_naik_bpjs_new = <?php echo CJSON::encode($kelas_urut_new); ?>;
    ...
    function cekPerbedaanKelas(obj) {
        ...
        var is_nonkelas = $(".is_nonkelas").val();
        
        var is_pasientitipan = $("#<?php echo CHtml::activeId($modPasienAdmisi, "is_titipan"); ?>").val();
        console.log(is_nonkelas, is_pasientitipan, 'kelas')
        $('.isnaikkelasRI').find(".required").addClass("not-required").removeClass("required");
        $('.isnaikkelasRI').hide();
        $("#PPSepT_klsRawatNaik").val("");
        if (is_nonkelas != 0) {
            return false;
        }
        if (is_pasientitipan != 0) {
            return false;
        }
        ...
        if (typeof kelastanggungan.val() === 'undefined') {
            ...
            if (kelaspelayanan.val() != '' && (kelastanggungan.val() != '')) {
                if (kelastanggungan.text() != kelaspelayanan.text()) {
                    ...
                    if (carabayar == <?php echo Params::CARABAYAR_ID_BPJS ?>) {
                        cekBedaKelasBPJS(kelaspelayanan.val(), kelastanggungan.val());
                    }
                }
            }
        }
    ...
    function cekBedaKelasBPJS(kelaspelayanan_id, kelastanggungan_id) {
        console.log(data_kelas_naik_bpjs[kelaspelayanan_id], data_kelas_naik_bpjs_new[kelastanggungan_id])
        if (data_kelas_naik_bpjs[kelaspelayanan_id] != null && data_kelas_naik_bpjs[kelaspelayanan_id] < data_kelas_naik_bpjs_new[kelastanggungan_id]) {
            $('.isnaikkelasRI').find(".not-required").addClass("required").removeClass("not-required");
            $('.isnaikkelasRI').show();
            // $("#PPSepT_penanggungjwb_naikkls_id").prop("disabled", false).val("").parents(".control-group").show();
            // $("#PPSepT_penanggungjwb_naikkls_nama").prop("disabled", false).val("").parents(".control-group").show();
            ...
            // $("#PPSepT_penanggungjwb_naikkls_nama").prop("disabled", true).val("").parents(".control-group").hide();
            // $("#PPSepT_klsRawatNaik").val("");
            // $("#PPSepT_penanggungjwb_naikkls_id").prop("disabled", false).val("").parents(".control-group").show();
            // $("#PPSepT_penanggungjwb_naikkls_nama").prop("disabled", false).val("").parents(".control-group").show();
            $('.isnaikkelasRI').find(".not-required").addClass("required").removeClass("not-required");
    ...
    $(document).ready(function() {
        var cara = jQuery('#<?php echo CHtml::activeId($modPasienAdmisi, 'carabayar_id') ?>');
        var penj = jQuery('#<?php echo CHtml::activeId($modPasienAdmisi, 'penjamin_id') ?>');
        $("#<?php echo CHtml::activeId($modPasienAdmisi, "is_titipan"); ?>").val(0); // default tidak pasien titipan
        /**
        ...
        jQuery(cara).multiselect({
            ...
            onChange: function(element, checked) {
                var cara = jQuery('#<?php echo CHtml::activeId($modPasienAdmisi, 'carabayar_id') ?>');
                var cara_all = jQuery('#<?php echo CHtml::activeId($modPasienAdmisi, 'carabayar_id') ?>   option:selected');
                var penj = jQuery('#<?php echo CHtml::activeId($modPasienAdmisi, 'penjamin_id') ?>');
                var v = $(element).val();
    ...
    function pasienTitipan() {
        var is_nonkelas = $(".is_nonkelas").val();
        if ($('.istitipan').is(':checked')) {
            var is_titipan = $("#<?php echo CHtml::activeId($modPasienAdmisi, "is_titipan"); ?>");
            is_titipan.val(1);
            $('.isnaikkelasRI').hide()
            $('.isnaikkelasRI').find(".required").addClass("not-required").removeClass("required");
        } else {
