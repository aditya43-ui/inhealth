...
<div class="panel panel-success">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="glyphicon glyphicon-file"></i> Data <b>Jadwal Rehab Medis Baru</b>
        </div>
    </div>
    <div class="panel-body">
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <div class="control-group">
                    <?php echo $form->labelEx($modJadwal, 'jadwalrehabmedis_tgl_ke', array('class' => 'control-label')) ?>
                    <div class="controls">
                        <?php
                        echo $form->textField($modJadwal, 'jadwalrehabmedis_tgl_ke', array(
            ...
            <div class="col-sm-6">
                <div class="control-group">
                    <?php echo $form->labelEx($modUbah, 'gantijadwalrh_tgl', array('class' => 'control-label')) ?>
                    <div class="controls">
                        <?php
                        $this->widget('MyDateTimePicker', array(
                            'model' => $modUbah,
                            'attribute' => 'gantijadwalrh_tgl',
                            'mode' => 'date',
                            'options' => array(
                ...
                <?php echo $form->textAreaRow($modUbah, 'gantijadwalrh_alasan', array('placeholder' => 'Alasan Ubah', 'class' => 'span3',)); ?>
                <?php echo $form->textAreaRow($modUbah, 'gantijadwalrh_desc', array('placeholder' => 'Deskripsi', 'class' => 'span3',)); ?>
            </div>
        </div>
        ...
        <div class="form-actions">
            ...
            echo CHtml::htmlButton(
                ...
                array('title' => 'Ulang', 'class' => 'btn btn-default', 'onclick' => 'myConfirm("Apakah Anda ingin membatalkan ini?","Perhatian!",function(r){if(r) parent.location.reload();});')
            );
            ?>
        </div>
    </div>
