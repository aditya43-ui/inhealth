<div class="row-fluid">
    <div class="span6">
        <div class="control-group ">
            ...
            <div class="controls">
                <?php echo CHtml::textField('nomorrujukan_fktl', '', array('placeholder' => 'Nomor Rujukan', 'disabled' => true, 'class' => 'span3')); ?>
                <?php echo CHtml::htmlButton(
                    '<i class="entypo-search"></i>',
                    array(
                        'onclick' => 'cariDataRujukanBpjsFktl(1);return false;',
                        'class' => 'btn btn-primary btn-nomorrujukan_fktl',
                        'onkeypress' => "cariDataRujukanBpjsFktl(1);return false;",
                        'rel' => "tooltip",
        ...
        <div class="control-group ">
            ...
            <div class="controls">
                <?php echo CHtml::textField('nomorkartupeserta_fktl', '', array('placeholder' => 'Nomor Kartu Peserta', 'disabled' => true, 'class' => 'span3')); ?>
                <?php echo CHtml::htmlButton(
                    '<i class="entypo-search"></i>',
                    array(
                        'onclick' => 'cariDataRujukanBpjsFktl(2);return false;',
                        'class' => 'btn btn-primary btn-nomorkartu_fktl',
                        'onkeypress' => "cariDataRujukanBpjsFktl(2);return false;",
                        'rel' => "tooltip",
