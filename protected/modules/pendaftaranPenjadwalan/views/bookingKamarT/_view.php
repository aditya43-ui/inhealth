<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('bookingkamar_id')); ?>:</b>
	<?php echo CHtml::link(CHtml::encode($data->bookingkamar_id),array('view','id'=>$data->bookingkamar_id)); ?>
	<br>
	...
	<?php echo CHtml::encode($data->kamarruangan_id); ?>
	<br>
	...
	<?php /*
	<b><?php echo CHtml::encode($data->getAttributeLabel('bookingkamar_no')); ?>:</b>
	<?php echo CHtml::encode($data->bookingkamar_no); ?>
	<br>

	<b><?php echo CHtml::encode($data->getAttributeLabel('tglbookingkamar')); ?>:</b>
	<?php echo CHtml::encode($data->tglbookingkamar); ?>
	<br>

	<b><?php echo CHtml::encode($data->getAttributeLabel('statusbooking')); ?>:</b>
	<?php echo CHtml::encode($data->statusbooking); ?>
	<br>

	<b><?php echo CHtml::encode($data->getAttributeLabel('keteranganbooking')); ?>:</b>
	<?php echo CHtml::encode($data->keteranganbooking); ?>
	<br>
