...
<!-- <div class="col-sm-6"> -->
    <div class="box2">
        ...
        echo $form->dropDownListRow($model, 'jeniskasuspenyakit_id', CHtml::listData($model->getJenisKasusPenyakitItems($model->instalasi_id), 'jeniskasuspenyakit_id', 'jeniskasuspenyakit_nama'), array('onkeyup' => "return $(this).focusNextInputField(event)", 'class' => 'span3 form-control2', 'empty' => '-- Pilih --'));
        ?>
        <div class='control-group'>
            ...
            <div class='controls'>
                <?php
                $modRuangan = $model->getRuanganItems(Params::INSTALASI_ID_REHAB);
