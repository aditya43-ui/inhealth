<div class="panel panel-success">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="far fa-plus-square"></i> Tambah <b>Jadwal Dokter</b>
        </div>
    </div>
  ...
  <style>
	...
	<div class="col-sm-6">
		...
		<div class="control-group">
			...
			<div class="controls">
				<?php
                    ...
                    echo CHtml::dropDownList('jadwalDokter[instalasi]', '', CHtml::listData(InstalasiM::model()->findAll($cr), 'instalasi_id', 'instalasi_nama'),
                                            array('empty'=>'-- Pilih --',
                                                  'id'=>'instalasi',
        ...
        <div class="control-group">
			...
			<div class="controls">
				<?php echo CHtml::dropDownList('jadwalDokter[poliklinik]', null, array(), array(
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo CHtml::dropDownList('jadwalDokter[pegawai]', null, array(), array(
                ...
                <div class="col_tanggal_gen_content">
                    ...
                    <div class="col_content">
                        <div class="input-append">
                            <input style="float:left" type="text" name="gen[<?php echo $idx ?>][jadwaldokter_mulai]" class="span2 genTimePicker jadwaldokter_mulai" value="00:00:00" onchange="hitungJumlahPasienDariEstimasi()"><span class="add-on" style="margin-top:0px !important; height: 31px !important;"><i class="icon-time"></i></span>
                        </div> s/d
                        <div class="input-append">
                            <input style="float:left" type="text" name="gen[<?php echo $idx ?>][jadwaldokter_tutup]" class="span2 genTimePicker jadwaldokter_tutup" value="00:00:00" onchange="hitungJumlahPasienDariEstimasi()"><span class="add-on" style="margin-top:0px !important; height: 31px !important;"><i class="icon-time"></i></span>
                        </div>
                        <hr/>
...
function hitungJumlahPasienDariEstimasi() {
    ...
    $(".col_tanggal_gen").each(function() {
        if ($(this).find(".col_ceklis_gen").is(":checked")) {
            var jam_awal = timeStringToFloat($(this).find(".jadwaldokter_mulai").val());
            var jam_akhir = timeStringToFloat($(this).find(".jadwaldokter_tutup").val());
...
function insertInputDokter(idTabel, idRuangan, obj)
{
	...
	input += '<td><select style="display:inline-block;" name="jadwalDokter[jadwal]['+idTabel+'][dokter]['+idRuangan+'][dokter]['+jmlBaris+'][pegawai_id]" id="jadwalDokter_'+idTabel+'_'+idRuangan+'_'+jmlBaris+'" type="text" class="inputDokter span3" ></select>';
	input += '</td></tr>';
	input += '<tr>';
    input += '<td><div style="display:inline-block;margin-bottom:-7px;" class="input-append"><input style="float:left; width:70px;" type="text" name="jadwalDokter[jadwal]['+idTabel+'][dokter]['+idRuangan+'][dokter]['+jmlBaris+'][jadwaldokter_mulai]" class="timePickerTest"><span class="add-on"><i class="icon-time"></i></span></div>';
    input += ' s/d ';
    input += '<div style="display:inline-block;margin-bottom:-7px;" class="input-append"><input style="float:left; width:70px;" type="text" name="jadwalDokter[jadwal]['+idTabel+'][dokter]['+idRuangan+'][dokter]['+jmlBaris+'][jadwaldokter_tutup]" class="timePickerTest"><span class="add-on"><i class="icon-time"></i></span></div></td>';
    input += '<td>max umum</td>';
    input += '<td><input style="display:inline-block;" type="text" name="jadwalDokter[jadwal]['+idTabel+'][dokter]['+idRuangan+'][dokter]['+jmlBaris+'][maximumantrian]" class="span1 numbersOnly"></td>';
    input += '<td>max bpjs</td>';
    input += '<td><input style="display:inline-block;" type="text" name="jadwalDokter[jadwal]['+idTabel+'][dokter]['+idRuangan+'][dokter]['+jmlBaris+'][maximumbpjsantrian]" class="span1 numbersOnly"></td>';
    input += '<td>max janji</td>';
    input += '<td><input style="display:inline-block;" type="text" name="jadwalDokter[jadwal]['+idTabel+'][dokter]['+idRuangan+'][dokter]['+jmlBaris+'][maksbuatjanji]" class="span1 numbersOnly"></td>';
