        ...
        <div class="panel-body">
            ...
            <div class="control-group form_bm">
                ...
                <div class="controls">
                    ...
                    $this->widget('MyJuiAutoComplete', array(
                        'model' => $modPasien,
                        'attribute' => 'nama_pasien_spesimen',
                        'source' => 'js: function(request, response) {
                                               $.ajax({
                                                   url: "' . $this->createUrl('AutocompletePasienLama') . '",
                                                   dataType: "json",
                        ...
                        'htmlOptions' => array('placeholder' => 'Nama Spesimen', 'rel' => 'tooltip', 'title' => 'Ketik Nama untuk masukan data / mencari pasien', 'onkeyup' => "return $(this).focusNextInputField(event)", 'class' => 'span3' . $nama_kapital),
                    ));
                    ?>
            ...
            <div class="control-group nama_bin">
                <?php echo CHtml::label('Nama Panggilan', '', array('class' => 'control-label')) ?>
                <div class="controls">
                    <?php echo $form->textField($modPasien, 'nama_bin', array('placeholder' => 'Alias / Nama Panggilan Pasien', 'class' => 'span3 ' . $nama_kapital, 'onkeyup' => "return $(this).focusNextInputField(event);")); ?>
                </div>
            </div>
            <div class="control-group tempat_lahir">
                <?php echo CHtml::label('Tempat Lahir', '', array('class' => 'control-label')) ?>
                <div class="controls">
                    <?php echo $form->textField($modPasien, 'tempat_lahir', array('placeholder' => 'Kota/Kabupaten Kelahiran', 'class' => 'span3 all-caps', 'onkeyup' => "return $(this).focusNextInputField(event);", 'maxlength' => 25)); ?>
                </div>
            </div>
            ...
            <div class="control-group tanggal_lahir">
            ...
            <div class="control-group umur">
                <?php echo CHtml::label('Umur <span class="required">*</span>', '', array('class' => 'control-label required')) ?>
                <div class="controls">
                    <?php echo $form->textField($model, 'umur', array('placeholder' => '00 Thn 00 Bln 00 Hr', 'class' => 'span3 umur', 'onblur' => 'setTglLahir(this);', 'onkeyup' => "return $(this).focusNextInputField(event);", 'maxlength' => 20, 'disable'=>true)); ?>
                </div>
            </div>
            <div class="control-group jeniskelamin">
                <?php echo CHtml::label('Jenis Kelamin <span class="required">*</span>', '', array('class' => 'control-label required required_m')) ?>
                <div class="controls">
                    <?php echo $form->radioButtonList($modPasien, 'jeniskelamin', LookupM::getItems('jeniskelamin'), array('onkeyup' => "return $(this).focusNextInputField(event)", 'onchange' => "setNamaDepan()", 'class' => 'required required_m')); ?>
                </div>
            </div>
            ...
            <div class="control-group goldar">
            ...
            <div class="control-group kawin">
                <?php echo CHtml::label('Status Perkawinan', '', array('class' => 'control-label')) ?>
                <div class="controls">
                    <?php echo $form->dropDownList($modPasien, 'statusperkawinan', LookupM::getItems('statusperkawinan'), array('empty' => '-- Pilih --', 'onkeyup' => "return $(this).focusNextInputField(event)", 'onchange' => 'setNamaDepan()', 'class' => 'span3')); ?>
                </div>
            </div>
            <div class="control-group ibu">
                <?php echo CHtml::label('Nama Ibu', '', array('class' => 'control-label')) ?>
                <div class="controls">
                    <?php echo $form->textField($modPasien, 'nama_ibu', array('placeholder' => 'Nama Ibu Kandung Pasien', 'class' => 'span3 ' . $nama_kapital, 'onkeyup' => "return $(this).focusNextInputField(event);", 'maxlength' => 50)); ?>
                </div>
            </div>
...
<div class="col-sm-6">
    <div class="panel panel-success form_m">
        <div class="panel-heading">
            <div class="panel-title">
        ...
        <div class="panel-body">
            ...
            <?php if (Yii::app()->user->getState('is_mips')) :  ?>
                <?php echo CHtml::htmlButton(
                    ...
                    array(
                        'class' => 'btn btn-danger', 'onclick' => "ambilFoto();",
                ...
                <?php echo CHtml::htmlButton(
                    ...
                    array(
                        'class' => 'btn btn-primary', 'onclick' => "hapusFoto();",
    ...
    <div class="panel panel-success form_m">
        ...
        <div class="panel-body">
            ...
            <div class="control-group no_mobile_pasien">
            ...
            <div class="control-group warganegara">
                <?php echo CHtml::label("Warga Negara <span class='required'>*</span>", '', array('class' => 'control-label required_m')) ?>
                <div class="controls">
                    <?php echo $form->dropDownList($modPasien, 'warga_negara', LookupM::getItems('warganegara'), array('class' => 'span3 required_m', 'empty' => '-- Pilih --', 'onkeyup' => "return $(this).focusNextInputField(event)")); ?>
                </div>
            </div>
            <div class="control-group agama">
                <?php echo CHtml::label("Agama <span class='required'>*</span>", '', array('class' => 'control-label refreshable required_m')) ?>
                <?php //echo $form->labelEx($modPasien, 'agama', array('class' => 'control-label refreshable')) ?>
                <div class="controls">
                    <?php echo $form->dropDownList($modPasien, 'agama', LookupM::getItems('agama'), array('class' => 'span3 required_m', 'empty' => '-- Pilih --', 'onkeyup' => "return $(this).focusNextInputField(event)")); ?>
                </div>
            </div>
        </div>
    </div>
