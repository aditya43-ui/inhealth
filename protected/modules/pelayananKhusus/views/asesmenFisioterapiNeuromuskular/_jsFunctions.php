...
function setStatik(){
  ...
  $('.statik').each(function(){
    if($(this).val()=='Lainnya' &&  $(this).prop('checked')==true){
      $('#<?php echo CHtml::activeId($model, 'inspeksi_statik_di'); ?>').attr('readonly',false);
      indexLainnya = 1;
    }else{
      index++;
    }
  ...
  if(index <= 4 && indexLainnya == 0){
    $('#<?php echo CHtml::activeId($model, 'inspeksi_statik_di'); ?>').val('');
    $('#<?php echo CHtml::activeId($model, 'inspeksi_statik_di'); ?>').attr('readonly',true);
  }
}
...
function setDinamis(){
  ...
  $('.dinamis').each(function(){
    if($(this).val()=='Lainnya' &&  $(this).prop('checked')==true){
      $('#<?php echo CHtml::activeId($model, 'inspeksi_dinamis_polalain'); ?>').attr('readonly',false);
      indexLainnya = 1;
    }else{
      index++;
    }
  ...
  if(index <= 4 && indexLainnya == 0){
    $('#<?php echo CHtml::activeId($model, 'inspeksi_dinamis_polalain'); ?>').val('');
...
function setPalpasi(){
  ...
  $('.palpasi').each(function(){
    if($(this).val()=='Lainnya' &&  $(this).prop('checked')==true){
      $('#<?php echo CHtml::activeId($model, 'palpasi_di'); ?>').attr('readonly',false);
      indexLainnya = 1;
    }else{
      index++;
    }
  ...
  if(index <= 5 && indexLainnya == 0){
    $('#<?php echo CHtml::activeId($model, 'palpasi_di'); ?>').val('');
    $('#<?php echo CHtml::activeId($model, 'palpasi_di'); ?>').attr('readonly',true);
  }
}
...
function SetNilai(obj)
{
    ...
    i=0;
    if(idTombol=='E'){
        $('#<?php echo CHtml::activeId($model, 'gcs_eye'); ?>').val(valueGCS);
    }else if(idTombol=='M'){
        $('#<?php echo CHtml::activeId($model, 'gcs_motorik'); ?>').val(valueGCS);
    }else if(idTombol=='V'){
        $('#<?php echo CHtml::activeId($model, 'gcs_verbal'); ?>').val(valueGCS);
    }
...
function hitungCGS()
{
    gcs_eye =  $('#<?php echo CHtml::activeId($model, 'gcs_eye'); ?>').val();
    gcs_motorik =  $('#<?php echo CHtml::activeId($model, 'gcs_motorik'); ?>').val();
    gcs_verbal =  $('#<?php echo CHtml::activeId($model, 'gcs_verbal'); ?>').val();
    if((gcs_eye!='') && (gcs_motorik!='') &&(gcs_verbal!='')){
      var jumlah = (parseInt(gcs_eye) + parseInt(gcs_motorik) + parseInt(gcs_verbal));
      $('#<?php echo CHtml::activeId($model, 'namaGCS'); ?>').val(jumlah);
    }
}
