<tr>
  ...
  <td width="25%">
    ...
    <div class="control-group">
      ...
      <div class="controls">
          <?php echo CHtml::textField('aktif_rom',(isset($oriSinistra)?$oriSinistra->aktif_rom:""),array('class'=>'aktif_rom_sinistra span2')); ?><label> &deg;Derajat</label>
      </div>
    </div>
    </div>
  ...
  <td width="25%">
    ...
    <div class="control-group">
      <label class="control-label" style='width: 50px !important'>ROM</label>
      <div class="controls">
          <?php echo CHtml::textField('pasif_rom',(isset($oriSinistra)?$oriSinistra->pasif_rom:""),array('class'=>'pasif_rom_sinistra span2')); ?><label> &deg;Derajat</label>
      </div>
    </div>
    </div>
  ...
  <td width="25%">
    ...
    <div class="control-group">
      <label class="control-label" style='width: 50px !important'>ROM</label>
      <div class="controls">
          <?php echo CHtml::textField('isometrik_rom',(isset($oriSinistra)?$oriSinistra->isometrik_rom:""),array('class'=>'isometrik_rom_sinistra span2')); ?><label> &deg;Derajat</label>
      </div>
    </div>
    </div>
