...
<div class="col-sm-7">
    ...
    <div class="control-group">        
        <div class="controls">
            <label>b. Measurement Edema</label>
        </div>
    </div>
    
     <div class="control-group">        
        <div class="controls">
            <?php echo $form->textArea($model,'measurement_edema',array('class' => 'span5 autorow')) ?>    
        </div>
    </div>    
</div>
<div class="col-sm-5"> 
    ...
    <div class="control-group">        
        <div class="controls">
            <label>c. Test Khusus Sesuai Kelainan/Penyakit/Gangguan</label>
        </div>
    </div>
