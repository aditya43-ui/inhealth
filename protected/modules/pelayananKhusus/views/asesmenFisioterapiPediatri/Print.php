   ...
   <tr>
     <td colspan="2" class="bordertopclass padding5">
       <table width="100%" class="tablepadding">
         ...
         <tr>
           <td style="padding-left: 20px" width="100px">a. Penunjang Diagnosis</td>
           <td width="5px">:</td>
           <td  colspan="3">
             ...
             <span style="padding-left: 5px" class="<?php echo ((!empty($model->diagnosis_penunjang) && ($model->diagnosis_penunjang =='Lab'))?'fa fa-dot-circle-o':'fa fa-circle-o'); ?>"></span> Lab
             <span style="padding-left: 5px" class="<?php echo ((!empty($model->diagnosis_penunjang) && ($model->diagnosis_penunjang =='CT Scan'))?'fa fa-dot-circle-o':'fa fa-circle-o'); ?>"></span> CT Scan
             <br/>
             ...
             <span style="padding-left: 5px" class="<?php echo ((!empty($model->diagnosis_penunjang) && ($model->diagnosis_penunjang =='ENMG'))?'fa fa-dot-circle-o':'fa fa-circle-o'); ?>"></span> ENMG
             <span style="padding-left: 5px" class="<?php echo ((!empty($model->diagnosis_penunjang) && ($model->diagnosis_penunjang =='EEG'))?'fa fa-dot-circle-o':'fa fa-circle-o'); ?>"></span> EEG
           </td>
         </tr>
         <tr>
         ...
         <tr>
           <td style="padding-left: 20px" colspan="5">
             Statik <br />
             <span class="<?php echo ((!empty($model->inspeksi) && (strpos($model->inspeksi,"Kelemahan Sebelah Tubuh") != 0))?'fa fa-dot-circle-o':'fa fa-circle-o'); ?>"></span> Kelemahan Sebelah Tubuh
             <span style="padding-left: 5px" class="<?php echo ((!empty($model->inspeksi) && (strpos($model->inspeksi,"Kontraktur") != 0))?'fa fa-dot-circle-o':'fa fa-circle-o'); ?>"></span> Kontraktur
             <span style="padding-left: 5px" class="<?php echo ((!empty($model->inspeksi) && (strpos($model->inspeksi,"Wajah Asimetris") != 0))?'fa fa-dot-circle-o':'fa fa-circle-o'); ?>"></span> Wajah Asimetris
             <span style="padding-left: 5px" class="<?php echo ((!empty($model->inspeksi) && ( strpos($model->inspeksi,"Lainnya") != 0))?'fa fa-dot-circle-o':'fa fa-circle-o'); ?>"></span> Lainnya
             <span style="padding-left: 5px"></span><div style="width: 150px; display: inline-block;" class="borderbottomclass"><?php echo $model->inspeksi_lainnya; ?></div>
           </td>
         </tr>
         <tr>
           <td style="padding-left: 20px" colspan="5">
         ...
         <tr>
           <td style="padding-left: 20px" colspan="5">b. MMT</td>
         </tr>
         <tr>
           <td style="padding-left: 20px" colspan="5">
         ...
         <tr>
           <td style="padding-left: 20px" colspan="5">c. Antropometri</td>
         </tr>
         <tr>
           <td style="padding-left: 20px" colspan="5">
             <table width="100%">
         ...
         <tr>
           <td style="padding-left: 20px" colspan="5">d. Sensibilitas</td>
         </tr>
         <tr>
           <td style="padding-left: 40px" colspan="5">
             <div class="borderbottomclass">
               <?php echo $model->sensibilitas; ?>
             </div>
           </td>
         </tr>
         <tr>
           <td style="padding-left: 20px" colspan="5">e. Reflek Patologis</td>
         </tr>
         <tr>
           <td style="padding-left: 40px" colspan="5">
             <div class="borderbottomclass">
               <?php echo $model->refleks_patologis; ?>
             </div>
           </td>
         </tr>
         <tr>
           <td style="padding-left: 20px" colspan="5">f. Test Khusus Sesuai Kelainan/Penyakit/Gangguan</td>
         </tr>
         <tr>
           <td style="padding-left: 40px" colspan="5">
             <div class="borderbottomclass">
