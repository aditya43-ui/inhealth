   ...
   <tr>
     <td colspan="2" class="bordertopclass padding5">
       <table width="100%" class="tablepadding">
         ...
         <tr>
           <td style="padding-left: 20px" colspan="5">c. Penilaian ADL dengan Indeks Barthel</td>
         </tr>
         <tr>
           <td style="padding-left: 20px" colspan="5">
             <table class="table-bordercustom" width="100%">
                 ...
                 <?php
                     ...
                     if(count($loadMaster) > 0){
                       foreach($loadMaster as $det){
                           ...
                           <tr>
                             <td><?php echo $i; ?></td>
                             <td><?php echo $det['fungsi']; ?></td>
                             <td><?php echo $modDet->skor; ?></td>
                             <td><?php echo $modDet->keterangan; ?></td>
                           </tr>
                           <?php
                           $i++;
                       }
         ...
         <tr>
           <td style="padding-left: 20px" colspan="5">d. Test Khusus Sesuai Kelainan/Penyakit/Gangguan</td>
         </tr>
         <tr>
