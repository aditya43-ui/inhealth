...
?>
    ...
    function print(){
        window.open("<?php echo Yii::app()->createUrl("bedahSentral/daftarPasien/RincianTagihanPenunjang", array("pendaftaran_id"=>$_GET['pendaftaran_id'], "instalasi_id"=>$_GET['instalasi_id'], "pasienmasukpenunjang_id"=>$_GET['pasienmasukpenunjang_id'] , "pasienadmisi_id"=>(isset($_GET['pasienadmisi_id']) ? $_GET['pasienadmisi_id'] : null))) ?>","",'location=_new, width=1024px');
    }
    </script>
<?php
}
