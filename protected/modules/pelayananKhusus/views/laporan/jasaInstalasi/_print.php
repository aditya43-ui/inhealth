    ...
    if ($caraPrint == 'PRINT') {
        ...
        <style>
            ...
            @page {
                ...
                width: <?php echo Params::height_A4 ?>mm;
                height:<?php echo Params::width_A4 ?>mm
        ...
        <table>
            ...
            <tbody>
                <tr>
                    <td>
                        <div class="content"><?php $this->renderPartial('jasaInstalasi/_table', array('model' => $model, 'caraPrint' => $caraPrint)); ?></div>
                    </td></tr></tbody>
            <tfoot>
                <tr>
                    <td>
