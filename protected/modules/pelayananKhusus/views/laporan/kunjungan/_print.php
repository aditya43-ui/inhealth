...
if ($caraPrint != 'EXCEL') {
    if ($caraPrint == 'PRINT') {
        ...
        <table>
            ...
            <tbody>
                <tr>
                    <td>
                        <div class="content"><?php $this->renderPartial('kunjungan/_table', array('model'=>$model, 'caraPrint'=>$caraPrint));    ?></div>
                    </td></tr></tbody>
            <tfoot>
                <tr>
                    <td>
    ...
    echo $this->renderPartial('application.views.headerReport.headerLaporanTransaksiExcel', array('judulLaporan' => $judulLaporan, 'periode' => 'Periode : ' . $periode, 'colspan' => 9));
}
?>
