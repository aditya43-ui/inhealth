...
<?php echo $form->textFieldRow($modAsuransiPasien,'nokepesertaan',array('placeholder'=>'No Kepesertaan','class'=>'span3 all-caps', 'onkeyup'=>"return $(this).focusNextInputField(event);", 'maxlength'=>50)); ?>
...
<?php 
	if (isset($statusMenu)){
		echo $form->dropDownListRow($modAsuransiPasien,'kelastanggunganasuransi_id', CHtml::listData(RMPendaftaranT::model()->getKelasPelayanan(), 'kelaspelayanan_id', 'kelaspelayanan_nama') ,array('disabled'=>true,'empty'=>'-- Pilih --','class'=>'span3','onkeyup'=>"return $(this).focusNextInputField(event)", 'onchange'=>'cekPerbedaanKelas(this);')); 
	}else{
		echo $form->dropDownListRow($modAsuransiPasien,'kelastanggunganasuransi_id', CHtml::listData(RMPendaftaranT::model()->getKelasPelayanan(), 'kelaspelayanan_id', 'kelaspelayanan_nama') ,array('disabled'=>true,'empty'=>'-- Pilih --','class'=>'span3','onkeyup'=>"return $(this).focusNextInputField(event)")); 
	}
...
<?php echo $form->textFieldRow($modAsuransiPasien,'produk_asuransi',array('placeholder'=>'Produk','class'=>'span3 all-caps', 'onkeyup'=>"return $(this).focusNextInputField(event);", 'maxlength'=>50)); ?>
<?php echo $form->textFieldRow($modAsuransiPasien,'type_asuransi',array('placeholder'=>'Tipe','class'=>'span3 all-caps', 'onkeyup'=>"return $(this).focusNextInputField(event);", 'maxlength'=>50)); ?>
<?php echo $form->textFieldRow($modAsuransiPasien,'klien',array('placeholder'=>'Klien','class'=>'span3 all-caps', 'onkeyup'=>"return $(this).focusNextInputField(event);", 'maxlength'=>50)); ?>
<?php echo $form->textFieldRow($modAsuransiPasien,'mata_uang',array('placeholder'=>'Mata Uang','class'=>'span3 all-caps', 'onkeyup'=>"return $(this).focusNextInputField(event);", 'maxlength'=>50)); ?>
<?php echo $form->textFieldRow($modAsuransiPasien,'pembayar_pertama',array('placeholder'=>'Pembayar Pertama','class'=>'span3 all-caps', 'onkeyup'=>"return $(this).focusNextInputField(event);", 'maxlength'=>50)); ?>
<div class="control-group ">
    <?php echo $form->labelEx($modAsuransiPasien,'masaberlakukartu', array('class'=>'control-label', 'label'=>'Masa Berlaku')) ?>
    <div class="controls">
        <?php   
            $modAsuransiPasien->tgl_konfirmasi = (!empty($modAsuransiPasien->masaberlakukartu) ? date("d/m/Y H:i:s",strtotime($modAsuransiPasien->masaberlakukartu)) : null);
            $this->widget('MyDateTimePicker',array(
                            'model'=>$modAsuransiPasien,
                            'attribute'=>'masaberlakukartu',
                            'mode'=>'date',
                            'options'=> array(
