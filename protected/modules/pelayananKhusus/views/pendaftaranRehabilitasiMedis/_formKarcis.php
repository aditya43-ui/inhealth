...
if(count($modKarcis) > 0){ 
        ...
        echo "<table class='table table-bordered table-condesed table-stripped'>";
        echo "<thead>";
        echo "<th>Karcis</th>";
        echo "<th>Harga</th>";
        echo "<th class='hidden'>Pilih</th>";
        echo "</thead>";
        foreach($modKarcis AS $ii =>$karcis){
            ...
            echo '<tr class="checked">
                    ...
                    <td style="display:none;"><a data-karcis="'.$karcis->karcis_id.' class="btn-small" href="javascript:void(0);" onclick="pilihKarcis(this);return false;">
