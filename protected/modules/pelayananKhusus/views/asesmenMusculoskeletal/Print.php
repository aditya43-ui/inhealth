...
<?php echo $this->renderPartial($this->path_view."_headerPrint", array(
 ...
 <table width="100%">
   <tr>
     <td width="50%" class="padding5">Tanggal : <?php echo MyFormatter::formatDateTimeForUser($model->tgl_pengisian); ?> </td>
     ...
     <td colspan="2" class="bordertopclass padding5">
       <table width="100%" class="tablepadding">
         ...
         <tr>
           ...
           <td width="5px">:</td>
           <td class="borderbottomclass"  colspan="3"><?php echo $model->riwayat_penyakit; ?></td>
         </tr>
         <tr>
         ...
         <tr>
           ...
           <td width="5px">:</td>
           <td class="borderbottomclass"><?php echo $model->detaknadi; ?></td>
           <td>x/menit</td>
         </tr>
         <tr>
         ...
         <tr>
           <td style="padding-left: 20px" colspan="5">
             ...
             <span style="padding-left: 5px"></span><div style="width: 150px; display: inline-block;" class="borderbottomclass"><?php echo $model->statiklainnya; ?></div>
           </td>
         </tr>
         <tr>
           <td style="padding-left: 20px" colspan="5">
             ...
             <span style="padding-left: 5px"></span><div style="width: 150px; display: inline-block;" class="borderbottomclass"><?php echo $model->dinamislainnya; ?></div>
           </td>
         </tr>
         <tr>
         ...
         <tr>
           <td style="padding-left: 30px" colspan="5">
             ...
             <span style="padding-left: 5px"></span><div style="width: 200px; display: inline-block; height: 30px; vertical-align: text-bottom; padding: 2px !important;" class="borderclass"><?php echo $model->palpasilainnya; ?></div>
           </td>
         </tr>
         <tr>
               ...
               <tr>
                 <td width="35%">
                   <table>
                     ...
                     <tr>
                       ...
                       <td class="padding5 borderbottomclass" width="100px"><?php echo $model->bonelength_sinestra." - ".$model->bonelength_sinestra2; ?></td>
                       <td class="padding5" width="20px">cm</td>
                     </tr>
                   </table>
                 </td>
                 <td width="30%">
                   <table>
                     ...
                     <tr>
                       <td class="padding5" width="70px">Sinistra</td>
                       <td class="padding5 borderbottomclass" width="100px"><?php echo $model->truelength_sinestra." - ".$model->truelength_sinestra2; ?></td>
                       <td class="padding5" width="20px">cm</td>
                     </tr>
                   </table>
                 </td>
                 <td width="35%">
                   <table>
                     ...
                     <tr>
                       <td class="padding5" width="70px">Dextra</td>
                       <td class="padding5 borderbottomclass" width="100px"><?php echo $model->apparentlength_dextra." - ".$model->apparentlength_dextra2; ?></td>
                       <td class="padding5" width="20px">cm</td>
                     </tr>
                     <tr>
                       <td class="padding5" width="70px">Sinistra</td>
                       <td class="padding5 borderbottomclass" width="100px"><?php echo $model->apparentlength_sinestra." - ".$model->apparentlength_sinestra2; ?></td>
                       <td class="padding5" width="20px">cm</td>
                     </tr>
                   </table>
                 </td>
         ...
         <tr>
           <td style="padding-left: 20px" colspan="5">d. Measurement Edema</td>
         </tr>
         <tr>
           <td style="padding-left: 40px" colspan="5">
             <div class="borderbottomclass">
               <?php echo $model->measurement; ?>
             </div>
           </td>
         </tr>
         <tr>
           <td style="padding-left: 20px" colspan="5">e. Test Khusus Sesuai Kelainan/Penyakit/Gangguan</td>
         </tr>
         <tr>
           <td style="padding-left: 40px" colspan="5">
             <div class="borderbottomclass">
 ...
 <table width="100%">
     ...
     <tr>
         ...
         <td colspan="2" >
             <center>Fisioterapi
                 <br><br><br><br><br><br>
                 (<?php echo (isset($model->petugaspengisi)? $model->petugaspengisi->NamaLengkap: ""); ?>)
             </center>
         </td>
     </tr>
 </table>
