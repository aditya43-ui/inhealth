...
<div class="panel panel-gradient">
  <div class="panel-heading">
      <div class="panel-title">
          <strong>Transaksi Asesmen Musculoskeletal</strong>
      </div>
  </div>
    ...
    <div class="row">
      <div class="col-sm-6">
        <div class="control-group ">
            <?php echo $form->labelEx($model,'tgl_pengisian', array('class'=>'control-label')) ?>
            <div class="controls">
                <?php
                    $this->widget('MyDateTimePicker',array(
                    'model'=>$model,
                    'attribute'=>'tgl_pengisian',
                    'mode'=>'datetime',
                    'options'=> array(
      ...
      <div class="col-sm-6">
          <?php echo $form->dropDownListRow($model, 'petugaspengisi_id', CHtml::listData(PegawairuanganV::model()->findAll('ruangan_id = '.Yii::app()->user->getState("ruangan_id").' ORDER BY nama_pegawai ASC'), 'pegawai_id', 'NamaLengkap'), array('empty'=>'-- Pilih --','onkeypress' => "return $(this).focusNextInputField(event);",)); ?>
      </div>
      <div class="clear"></div>
      <div class="col-sm-12">
            ...
            <div class="panel-body" style="padding-top:5px !important;">
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <div class="control-group ">
                      <?php echo CHtml::label('Keluhan Utama', '', array('class' => 'control-label','style'=>'width: 100px')) ?>
                  </div>
                  <div class="control-group ">
                  ...
                  <div class="control-group ">
                      <?php echo CHtml::label('Riwayat Terdahulu', '', array('class' => 'control-label','style'=>'width: 120px')) ?>
                  </div>
                  <div class="control-group ">
                      <div class="controls" style="padding-left: 10px">
                        <?php echo $form->textArea($model,'riwayat_penyakit',array('cols'=>20,'rows'=>4,'readonly'=>false)) ?>
                      </div>
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="control-group ">
                      <?php echo CHtml::label('&nbsp;', '', array('class' => 'control-label','style'=>'width: 60px')) ?>
                  </div>
                  <div class="control-group ">
                      <?php echo CHtml::label('Keluhan Tambahan', '', array('class' => 'control-label','style'=>'width: 110px')) ?>
                  </div>
                  <div class="control-group ">
                      <div class="controls">
                        <?php echo $form->textArea($model,'keluhantambahan',array('cols'=>20,'rows'=>4,'readonly'=>false)) ?>
                      </div>
                  </div>
                  <div class="control-group ">
                      <?php echo CHtml::label('&nbsp;', '', array('class' => 'control-label','style'=>'width: 60px')) ?>
                  ...
                  <div class="control-group ">
                      <?php echo CHtml::label('Riwayat Keluarga', '', array('class' => 'control-label','style'=>'width: 100px')) ?>
                  </div>
                  <div class="control-group ">
                      <div class="controls">
                        <?php echo $form->textArea($model,'riwayat_keluarga',array('cols'=>20,'rows'=>4,'readonly'=>false)) ?>
                      </div>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <div class="control-group ">
                      ...
                      <div class="controls">
                        <?php echo $form->textField($model,'detaknadi',array('class'=>'span2  integer numbersOnly', 'maxlength'=>3, 'onkeypress'=>"return $(this).focusNextInputField(event)"));?> /Menit
                      </div>
                  </div>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-sm-12">
                  ...
                  <div class="control-group ">
                     ...
                     <div class="controls">
                        ...
                        <?php //echo $form->textField($model,'statiklainnya',array('class'=>'span3', 'onkeypress'=>"return $(this).focusNextInputField(event);"));?>
                      </div>
                       <div class="radio inline">
                         <div class="form-inline">
                            <?php //echo $form->radioButtonList($model,'statik[0]',array('Kelemahan Sebelah Tubuh'=>'Kelemahan Sebelah Tubuh') , array('onkeyup'=>"return $(this).focusNextInputField(event)",'class'=>'statik','onchange'=>'setStatik();','labelOptions'=>array('style'=> 'padding-left:5px;padding-right:10px;'))); ?>
                      ...
                      <div class="radio inline">
                        <div class="form-inline">
                          ...
                          <?php
                                ...
                                if(count($look_spasme) > 0){
                                  foreach ($look_spasme as $i => $lookp) {
                                    ...
                                    if ($lookp == 'Lainnya'){
                                        ...
                                        $htmlSpasme .= $form->textField($model,'dinamislainnya',array('class'=>'span3', 'onkeypress'=>"return $(this).focusNextInputField(event);"));
                                    }else{
                                ...
                                echo $htmlSpasme;
                              ?>
                          <?php //echo $form->textField($model,'dinamislainnya',array('class'=>'span3', 'onkeypress'=>"return $(this).focusNextInputField(event);"));?>
                        </div>
                      </div>
                ...
                <div class="control-group ">
                   ...
                   <div class="controls">
                                ...
                                if(count($look_spasme) > 0){
                                  foreach ($look_spasme as $i => $lookp) {
                                    ...
                                    if ($lookp == 'Lainnya'){
                                        ...
                                        $htmlSpasme .= $form->textField($model,'palpasilainnya',array('class'=>'span3', 'onkeypress'=>"return $(this).focusNextInputField(event);"));
                                    }else{
                     ...
                     <br/>
                    <!-- <span style='padding-left: 20px'></span><?php //echo $form->radioButton($model,'palpasi[4]',array('class'=>'palpasi','value'=>'Lainnya','uncheckValue'=>null,'onkeypress'=>"return $(this).focusNextInputField(event);",'onchange'=>'setPalpasi();')); ?> <label>Lainnya</label> -->
                    <?php //echo $form->textField($model,'palpasilainnya',array('class'=>'span3', 'onkeypress'=>"return $(this).focusNextInputField(event);"));?>
                   </div>
               </div>
               <div class="control-group">
              ...
              <div class="row">
                ...
                <div class="col-sm-4">
                  ...
                  <div class="control-group">
                      ...
                      <div class="controls">
                            <?php echo $form->textField($model,'bonelength_dextra',array('class'=>'span1  float', 'maxlength'=>6, 'onkeypress'=>"return $(this).focusNextInputField(event)"));?>
                            <label>-</label>
                            <?php echo $form->textField($model,'bonelength_dextra2',array('class'=>'span1  float', 'maxlength'=>6, 'onkeypress'=>"return $(this).focusNextInputField(event)"));?>
                            <label>cm</label>
                      </div>
                  </div>
                  <div class="control-group ">
                      ...
                      <div class="controls">
                            <?php echo $form->textField($model,'bonelength_sinestra',array('class'=>'span1  float', 'maxlength'=>6, 'onkeypress'=>"return $(this).focusNextInputField(event)"));?>
                            <label>-</label>
                            <?php echo $form->textField($model,'bonelength_sinestra2',array('class'=>'span1  float', 'maxlength'=>6, 'onkeypress'=>"return $(this).focusNextInputField(event)"));?>
                            <label>cm</label>
                      </div>
                  </div>
                </div>
                <div class="col-sm-4">
                  ...
                  <div class="control-group ">
                      ...
                      <div class="controls">
                            <?php echo $form->textField($model,'truelength_dextra',array('class'=>'span1  float', 'maxlength'=>6, 'onkeypress'=>"return $(this).focusNextInputField(event)"));?>
                            <label>-</label>
                            <?php echo $form->textField($model,'truelength_dextra2',array('class'=>'span1  float', 'maxlength'=>6, 'onkeypress'=>"return $(this).focusNextInputField(event)"));?>
                            <label>cm</label>
                      </div>
                  </div>
                  <div class="control-group ">
                      ...
                      <div class="controls">
                            <?php echo $form->textField($model,'truelength_sinestra',array('class'=>'span1  float', 'maxlength'=>6, 'onkeypress'=>"return $(this).focusNextInputField(event)"));?>
                            <label>-</label>
                            <?php echo $form->textField($model,'truelength_sinestra2',array('class'=>'span1  float', 'maxlength'=>6, 'onkeypress'=>"return $(this).focusNextInputField(event)"));?>
                            <label>cm</label>
                      </div>
                  </div>
                </div>
                <div class="col-sm-4">
                  ...
                  <div class="control-group ">
                      ...
                      <div class="controls">
                            <?php echo $form->textField($model,'apparentlength_dextra',array('class'=>'span1  float', 'maxlength'=>6, 'onkeypress'=>"return $(this).focusNextInputField(event)"));?>
                            <label>-</label>
                            <?php echo $form->textField($model,'apparentlength_dextra2',array('class'=>'span1  float', 'maxlength'=>6, 'onkeypress'=>"return $(this).focusNextInputField(event)"));?>
                            <label>cm</label>
                      </div>
                  </div>
                  <div class="control-group ">
                      ...
                      <div class="controls">
                            <?php echo $form->textField($model,'apparentlength_sinestra',array('class'=>'span1  float', 'maxlength'=>6, 'onkeypress'=>"return $(this).focusNextInputField(event)"));?>
                            <label>-</label>
                            <?php echo $form->textField($model,'apparentlength_sinestra2',array('class'=>'span1  float', 'maxlength'=>6, 'onkeypress'=>"return $(this).focusNextInputField(event)"));?>
                            <label>cm</label>
                      </div>
                  </div>
                </div>
                ...
                <div class="col-sm-6">
                  <div class="control-group ">
                      <?php echo CHtml::label('4. Measurement Edame', '', array('class' => 'control-label')) ?>
                  </div>
                  <div class="control-group ">
                      <?php echo CHtml::label('', '', array('class' => 'control-label','style'=>'width: 5px')) ?>
                      <div class="controls">
                        <?php echo $form->textArea($model,'measurement',array('cols'=>20,'rows'=>4)) ?>
                      </div>
                  </div>
                </div>
                <div class="col-sm-6">
      ...
      <div class="col-sm-6">
        <div style="margin-top: 20px !important;" class="panel panel-darkk">
          ...
          <div class="panel-body" style="padding-top:5px !important;">
              <?php $this->widget('ext.redactorjs.Redactor',array('model'=>$model,'attribute'=>'kemampuan_fungsional','name'=>'AsesmenmusculoskeletalT[kemampuan_fungsional]','toolbar'=>'mini','height'=>'200px'));?>
      ...
      <div class="col-sm-6">
        <div style="margin-top: 20px !important;" class="panel panel-darkk">
          ...
          <div class="panel-body" style="padding-top:5px !important;">
              <?php $this->widget('ext.redactorjs.Redactor',array('model'=>$model,'attribute'=>'diagnosis_fisioterapi','name'=>'AsesmenmusculoskeletalT[diagnosis_fisioterapi]','toolbar'=>'mini','height'=>'200px'));?>
      ...
      <div class="col-sm-6">
        <div style="margin-top: 20px !important;" class="panel panel-darkk">
          ...
          <div class="panel-body" style="padding-top:5px !important;">
              <?php $this->widget('ext.redactorjs.Redactor',array('model'=>$model,'attribute'=>'program_fisioterapi','name'=>'AsesmenmusculoskeletalT[program_fisioterapi]','toolbar'=>'mini','height'=>'200px'));?>
      ...
      <div class="col-sm-6">
        <div style="margin-top: 20px !important;" class="panel panel-darkk">
          ...
          <div class="panel-body" style="padding-top:5px !important;">
              <?php $this->widget('ext.redactorjs.Redactor',array('model'=>$model,'attribute'=>'evaluasidantindaklanjut','name'=>'AsesmenmusculoskeletalT[evaluasidantindaklanjut]','toolbar'=>'mini','height'=>'200px'));?>
    ...
    <div class="row-fluid">
        <div class="form-actions">
            <?php
                ...
                if(isset($_GET['sukses'])){
                  echo "&nbsp&nbsp". CHtml::htmlButton(Yii::t('mds','{icon} Print',array('{icon}'=>'<i class="entypo-print"></i>')),array('class'=>'btn btn-primary', 'type'=>'button','onclick'=>'print("'.$_GET['pendaftaran_id'].'")'));
                }else{
