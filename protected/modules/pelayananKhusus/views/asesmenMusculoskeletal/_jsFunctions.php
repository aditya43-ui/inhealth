...
function setStatik(){
  ...
  $('.statik').each(function(){
    if($(this).val()=='Lainnya' &&  $(this).prop('checked')==true){
      $('#<?php echo CHtml::activeId($model, 'statiklainnya'); ?>').attr('readonly',false);
      indexLainnya = 1;
    }else{
      index++;
    }
  ...
  if(index <= 4 && indexLainnya == 0){
    $('#<?php echo CHtml::activeId($model, 'statiklainnya'); ?>').val('');
    $('#<?php echo CHtml::activeId($model, 'statiklainnya'); ?>').attr('readonly',true);
  }
}
...
function setDinamis(){
  ...
  $('.dinamis').each(function(){
    if($(this).val()=='Lainnya' &&  $(this).prop('checked')==true){
      $('#<?php echo CHtml::activeId($model, 'dinamislainnya'); ?>').attr('readonly',false);
      indexLainnya = 1;
    }else{
      index++;
    }
  ...
  if(index <= 4 && indexLainnya == 0){
    $('#<?php echo CHtml::activeId($model, 'dinamislainnya'); ?>').val('');
    $('#<?php echo CHtml::activeId($model, 'dinamislainnya'); ?>').attr('readonly',true);
  }
}
...
function setPalpasi(){
  ...
  $('.palpasi').each(function(){
    if($(this).val()=='Lainnya' &&  $(this).prop('checked')==true){
      $('#<?php echo CHtml::activeId($model, 'palpasilainnya'); ?>').attr('readonly',false);
      indexLainnya = 1;
    }else{
      index++;
    }
  ...
  if(index <= 5 && indexLainnya == 0){
    $('#<?php echo CHtml::activeId($model, 'palpasilainnya'); ?>').val('');
    $('#<?php echo CHtml::activeId($model, 'palpasilainnya'); ?>').attr('readonly',true);
  }
}
...
{
    window.open('<?php echo $this->createUrl('print'); ?>&pendaftaran_id='+pendaftaran_id,'printwin','left=100,top=100,width=793,height=1122,scrollbars=yes');
}
