<ol class="row-fluid">
    <div class="span6">
        ...
        <li>
            Tombol  <div class="btn btn-danger" name="yt0" type="button"><i class="entypo-arrows-ccw"></i></div>
    ...
    <div class="span6">
        ...
        <li>
            Tombol  <div class="btn btn-info" name="yt0" type="button"><i class="entypo-print"></i></div> dapat digunakan (sedang aktif)
