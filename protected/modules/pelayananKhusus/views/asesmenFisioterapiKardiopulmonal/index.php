...
<div class="panel panel-gradient">
  <div class="panel-heading">
      <div class="panel-title">
          <strong>Transaksi Asesmen Kardiopulmonal</strong>
      </div>
  </div>
  <div class="panel-body">
                ...
                <div class="col-sm-12">
                 ...
                 <div class="control-group ">
                    <div class="controls">
                      <div class="radio inline">
                        <div class="form-inline">
                          <?php //echo $form->radioButtonList($model,'inspeksi_dinamis',LookupM::getItems(Params::LOOKUPTYPE_KARDIOPULMONAL_INSPEKSI_DINAMIS) , array('onkeyup'=>"return $(this).focusNextInputField(event)",'class'=>'dinamis','labelOptions'=>array('style'=> 'padding-left:5px;padding-right:10px;'))); ?>
                          <?php
                                $htmlSpasme = "";
                                $look_spasme = LookupM::getItems(Params::LOOKUPTYPE_KARDIOPULMONAL_INSPEKSI_DINAMIS);
                                ...
                                if(count($look_spasme) > 0){
                                  foreach ($look_spasme as $i => $lookp) {
                                    ...
                                    if ($lookp == 'Lainnya'){
                                        $htmlSpasme .= CHtml::activecheckBox($model,'inspeksi_dinamis['.$i.']',array('class'=>'dinamis','onClick'=>'setStatik();','value'=>$lookp,'checked'=>$ischeck)) .' '."<label>".$lookp."</label>&nbsp;";
                                        $htmlSpasme .= $form->textField($model,'statiklainnya',array('class'=>'span3', 'onkeypress'=>"return $(this).focusNextInputField(event);"));
                                    }else{
								...
								<div class="control-group ">
									 <div class="controls">
										 ...
										 <?php
												...
												if(count($look_spasme) > 0){
													foreach ($look_spasme as $lookp) {
														$htmlSpasme .= "<div class='col-sm-6'>";
														$htmlSpasme .= CHtml::activeRadioButton($model,'palpasi_spasme_otot',array('class'=>'palpasi_spasme_otot','value'=>$lookp->lookup_value,'uncheckValue'=>null,'onkeypress'=>"return $(this).focusNextInputField(event);")) .' '."<label>".$lookp->lookup_name."</label>";
														$htmlSpasme .= "</div>";
													}
												}
												echo $htmlSpasme;
            ...
            <div class="panel-body" style="padding-top:5px !important;">
              <div class="row">
                ...
                <div class="col-sm-6">
									...
									<div class="control-group ">
											<?php echo CHtml::label('Lokasi Sputum', '', array('class' => 'control-label','style'=>'width: 90px')) ?>
									</div>
                  <div class="control-group ">
                      <div class="controls">
                           ...
                           <?php echo $form->textField($model,'khusus_pengukuran_eksthoraks_processus',array('class'=>'span3 float', 'onkeypress'=>"return $(this).focusNextInputField(event)"));?> cm
							...
							<div class="col-sm-6">
								...
								<div class="control-group ">
										...
										<div class="controls">
											<?php echo $form->textArea($model,'pemeriksaan_sesaknafas',array('cols'=>20,'rows'=>4)) ?>
										</div>
								</div>
								<div class="control-group ">
								...
								<div class="control-group ">
										<?php echo CHtml::label('', '', array('class' => 'control-label','style'=>'width: 5px')) ?>
										<div class="controls">
											<?php echo $form->textArea($model,'pemeriksaan_spirometri',array('cols'=>20,'rows'=>4)) ?>
										</div>
								</div>
							</div>
							<div class="col-sm-6">
								...
								<div class="control-group ">
										<?php echo CHtml::label('', '', array('class' => 'control-label','style'=>'width: 5px')) ?>
										<div class="controls">
											<?php echo $form->textArea($model,'pemeriksaan_nyeri',array('cols'=>20,'rows'=>4)) ?>
										</div>
								</div>
								<div class="control-group ">
										<?php echo CHtml::label('7. Pemeriksaan Panjang Otot', '', array('class' => 'control-label','style'=>'width: 160px')) ?>
								</div>
								<div class="control-group ">
										<?php echo CHtml::label('', '', array('class' => 'control-label','style'=>'width: 5px')) ?>
										<div class="controls">
											<?php echo $form->textArea($model,'pemeriksaan_panjangotot',array('cols'=>20,'rows'=>4)) ?>
										</div>
								</div>
							</div>
							<div class="clear"></div>
							<div class="col-sm-12">
								<div class="control-group ">
										<?php echo CHtml::label('8. Pemendekan otot bantu nafas', '', array('class' => 'control-label','style'=>'width: 180px')) ?>
								</div>
								<div class="control-group " style="padding-left: 20px">
                  <div class="row" style="width: 50% !important; ">
                  <?php
                     $htmlSpasme = "";
                     $look_spasme = LookupM::model()->findAllByAttributes(array('lookup_type'=>'kardiopulmonal_pemendekanotot'));
                     ...
                     if(count($look_spasme) > 0){
                       foreach ($look_spasme as $i=> $lookp) {
                         ...
                         if(!empty($model->pemendekan_otot)){
                           ...
                           if(count($arrOriPemendekan) > 0){
                             foreach ($arrOriPemendekan as $dataPemedekan) {
                               if($lookp->lookup_value == $dataPemedekan){
                                 $ischeck = true;
                               }
                             }
                           }
                         ...
                         $htmlSpasme .= "<div class='col-sm-6'>";
                         $htmlSpasme .= CHtml::hiddenField('PemendekanOtot['.$i.'][nama]',$lookp->lookup_value);
                         $htmlSpasme .= CHtml::checkBox('PemendekanOtot['.$i.'][ischeckotot]',$ischeck,array('class'=>'palpasi_spasme_otot')) .' '."<label>".$lookp->lookup_name."</label>";
                         $htmlSpasme .= "</div>";
                       }
                     }
                     echo $htmlSpasme;
      ...
      <div class="col-sm-12">
        <div style="margin-top: 20px !important;" class="panel panel-darkk">
          ...
          <div class="panel-body" style="padding-top:5px !important;">
						<div class="control-group ">
								<?php echo $form->radioButtonList($model,'khusus_perkusi', CHtml::listData(LookupM::model()->findAll("lookup_type ='".Params::LOOKUPTYPE_KARDIOPULMONAL_FUNGSIONAL."' order by lookup_urutan ASC"),'lookup_value','lookupValueAndName') , array('onkeyup'=>"return $(this).focusNextInputField(event)",'class'=>'statik','labelOptions'=>array('style'=> 'padding-left:5px;padding-right:10px;'))); ?>
						</div>
          </div>
        </div>
      </div>
        ...
        <div style="margin-top: 20px !important;" class="panel panel-darkk">
          ...
          <div class="panel-body" style="padding-top:5px !important;">
              <?php $this->widget('ext.redactorjs.Redactor',array('model'=>$model,'attribute'=>'diagnosis_fisioterapi','name'=>'AsesmenFisioterapiKardiopulmonalT[diagnosis_fisioterapi]','toolbar'=>'mini','height'=>'200px'));?>
        ...
        <div style="margin-top: 20px !important;" class="panel panel-darkk">
          ...
          <div class="panel-body" style="padding-top:5px !important;">
              <?php $this->widget('ext.redactorjs.Redactor',array('model'=>$model,'attribute'=>'program_fisioterapi','name'=>'AsesmenFisioterapiKardiopulmonalT[program_fisioterapi]','toolbar'=>'mini','height'=>'200px'));?>
        ...
        <div style="margin-top: 20px !important;" class="panel panel-darkk">
          ...
          <div class="panel-body" style="padding-top:5px !important;">
              <?php $this->widget('ext.redactorjs.Redactor',array('model'=>$model,'attribute'=>'evaluasi_tindaklanjut','name'=>'AsesmenFisioterapiKardiopulmonalT[evaluasi_tindaklanjut]','toolbar'=>'mini','height'=>'200px'));?>
