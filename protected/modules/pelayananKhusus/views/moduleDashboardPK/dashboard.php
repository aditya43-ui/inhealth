...
<div class="well">
    ...
    <h3>Selamat Datang di Modul <?php echo (!empty($modul_nama) ? $modul_nama->modul_nama : $this->module->id); ?>, <b><?php echo $nama_peg; ?></b></h3>
</div>
    ...
    if ($konsys->mapdashboard == true) { ?>
        <div class="panel panel-default">
            ...
            <div class="panel-body fluid">
                <?php $this->renderPartial('_map', array('dataMap' => $dataMap, 'profil' => $profil, 'konsys' => $konsys, 'longitude' => $longitude, 'latitude' => $latitude)); ?>
            </div>
        </div>
    <?php } ?>
</div>