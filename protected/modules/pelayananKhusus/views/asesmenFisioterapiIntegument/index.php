...
<div class="panel panel-gradient">
  <div class="panel-heading">
      <div class="panel-title">
          <strong>Transaksi Asesmen Integument</strong>
      </div>
  </div>
    ...
    <div class="row">
              ...
              <div class="row">
                ...
                <div class="col-sm-4">
                  ...
                  <div class="control-group ">
                      ...
                      <div class="controls">
                        <?php echo $form->textField($model,'bonelength_dextra',array('class'=>'span1  integer', 'maxlength'=>6, 'onkeypress'=>"return $(this).focusNextInputField(event)"));?>
                        <label>-</label>
                        <?php echo $form->textField($model,'bonelength_dextra2',array('class'=>'span1  integer', 'maxlength'=>6, 'onkeypress'=>"return $(this).focusNextInputField(event)"));?>
                        <label>cm</label>
                      </div>
                  </div>
                  <div class="control-group ">
                      ...
                      <div class="controls">
                        <?php echo $form->textField($model,'bonelength_sinistra',array('class'=>'span1  integer', 'maxlength'=>6, 'onkeypress'=>"return $(this).focusNextInputField(event)"));?>
                        <label>-</label>
                        <?php echo $form->textField($model,'bonelength_sinistra2',array('class'=>'span1  integer', 'maxlength'=>6, 'onkeypress'=>"return $(this).focusNextInputField(event)"));?>
                        <label>cm</label>
                      </div>
                  </div>
                </div>
                <div class="col-sm-4">
                  ...
                  <div class="control-group ">
                      ...
                      <div class="controls">
                        <?php echo $form->textField($model,'truelength_dextra',array('class'=>'span1  integer', 'maxlength'=>6, 'onkeypress'=>"return $(this).focusNextInputField(event)"));?>
                        <label>-</label>
                        <?php echo $form->textField($model,'truelength_dextra2',array('class'=>'span1  integer', 'maxlength'=>6, 'onkeypress'=>"return $(this).focusNextInputField(event)"));?>
                        <label>cm</label>
                      </div>
                  </div>
                  <div class="control-group ">
                      ...
                      <div class="controls">
                        <?php echo $form->textField($model,'truelength_sinistra',array('class'=>'span1  integer', 'maxlength'=>6, 'onkeypress'=>"return $(this).focusNextInputField(event)"));?>
                        <label>-</label>
                        <?php echo $form->textField($model,'truelength_sinistra2',array('class'=>'span1  integer', 'maxlength'=>6, 'onkeypress'=>"return $(this).focusNextInputField(event)"));?>
                        <label>cm</label>
                      </div>
                  </div>
                </div>
                <div class="col-sm-4">
                  ...
                  <div class="control-group ">
                      ...
                      <div class="controls">
                        <?php echo $form->textField($model,'apparent_dextra',array('class'=>'span1  integer', 'maxlength'=>6, 'onkeypress'=>"return $(this).focusNextInputField(event)"));?>
                        <label>-</label>
                        <?php echo $form->textField($model,'apparent_dextra2',array('class'=>'span1  integer', 'maxlength'=>6, 'onkeypress'=>"return $(this).focusNextInputField(event)"));?>
                        <label>cm</label>
                      </div>
                  </div>
                  <div class="control-group ">
                      ...
                      <div class="controls">
                        <?php echo $form->textField($model,'apparent_sinistra',array('class'=>'span1  integer', 'maxlength'=>6, 'onkeypress'=>"return $(this).focusNextInputField(event)"));?>
                        <label>-</label>
                        <?php echo $form->textField($model,'apparent_sinistra2',array('class'=>'span1  integer', 'maxlength'=>6, 'onkeypress'=>"return $(this).focusNextInputField(event)"));?>
                        <label>cm</label>
                      </div>
                  </div>
                </div>
                ...
                <div class="col-sm-6">
                  <div class="control-group ">
                      <?php echo CHtml::label('4. Penilaian Derajat Luka Bakar', '', array('class' => 'control-label','style'=>'width: 170px')) ?>
                  </div>
                  <div class="control-group ">
                      <?php echo CHtml::label('', '', array('class' => 'control-label','style'=>'width: 10px')) ?>
                      <div class="controls">
                        <?php echo $form->textArea($model,'penilaian_lukabakar',array('cols'=>20,'rows'=>4)) ?>
                      </div>
                  </div>
                  <div class="control-group ">
                      <?php echo CHtml::label('6. Test Khusus Sesuai Kelainan/Penyakit/Gangguan', '', array('class' => 'control-label','style'=>'width: 280px')) ?>
                  </div>
                  <div class="control-group ">
                      <?php echo CHtml::label('', '', array('class' => 'control-label','style'=>'width: 10px')) ?>
                      <div class="controls">
                ...
                <div class="col-sm-6">
                  <div class="control-group ">
                      <?php echo CHtml::label('5. Measurement Edame', '', array('class' => 'control-label','style'=>'width: 135px')) ?>
                  </div>
                  <div class="control-group ">
                      <?php echo CHtml::label('', '', array('class' => 'control-label','style'=>'width: 5px')) ?>
                      <div class="controls">
                ...
                <div class="clear"></div>
                <div class="col-sm-12">
                  <?php echo $this->renderPartial($this->path_view.'form/_formGambarPemeriksaan',array('model'=>$model, 'form'=>$form, 'modGambarTubuh'=>$modGambarTubuh, 'modPemeriksaanGambar'=>$modPemeriksaanGambar)) ?>
                </div>
      ...
      <div class="col-sm-6">
        <div style="margin-top: 20px !important;" class="panel panel-darkk">
          ...
          <div class="panel-body" style="padding-top:5px !important;">
              <?php $this->widget('ext.redactorjs.Redactor',array('model'=>$model,'attribute'=>'kemampuan_fungsional','name'=>'AsesmenFisioterapiIntegumentT[kemampuan_fungsional]','toolbar'=>'mini','height'=>'200px'));?>
      ...
      <div class="col-sm-6">
        <div style="margin-top: 20px !important;" class="panel panel-darkk">
          ...
          <div class="panel-body" style="padding-top:5px !important;">
              <?php $this->widget('ext.redactorjs.Redactor',array('model'=>$model,'attribute'=>'diagnosis_fisioterapi','name'=>'AsesmenFisioterapiIntegumentT[diagnosis_fisioterapi]','toolbar'=>'mini','height'=>'200px'));?>
      ...
      <div class="col-sm-6">
        <div style="margin-top: 20px !important;" class="panel panel-darkk">
          ...
          <div class="panel-body" style="padding-top:5px !important;">
              <?php $this->widget('ext.redactorjs.Redactor',array('model'=>$model,'attribute'=>'program_fisioterapi','name'=>'AsesmenFisioterapiIntegumentT[program_fisioterapi]','toolbar'=>'mini','height'=>'200px'));?>
      ...
      <div class="col-sm-6">
        <div style="margin-top: 20px !important;" class="panel panel-darkk">
          ...
          <div class="panel-body" style="padding-top:5px !important;">
              <?php $this->widget('ext.redactorjs.Redactor',array('model'=>$model,'attribute'=>'evaluasi_tindaklanjut','name'=>'AsesmenFisioterapiIntegumentT[evaluasi_tindaklanjut]','toolbar'=>'mini','height'=>'200px'));?>
              <?php //echo $form->textArea($model,'evaluasi_tindaklanjut', array('style'=>'height: 200px; width: 100%')) ?>
          </div>
        </div>
      </div>
...
<?php $this->renderPartial($this->path_view.'_jsFunctions',array('model'=>$model,'modBagianTubuh' => $modBagianTubuh, 'modGambarTubuh' => $modGambarTubuh)); ?>
