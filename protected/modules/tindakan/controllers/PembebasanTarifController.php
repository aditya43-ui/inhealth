...
class PembebasanTarifController extends MyAuthController
{
          ...
          foreach ($_POST['pembebasan'] as $tindkomponen_id => $dataPembebasan) {
            ...
            if ($tindkomponen_id_post != null) {
              if ($tindkomponen_id == $tindkomponen_id_post) {
                $model = $this->savePembebasan($model, $dataPembebasan, $modPendaftaran);
  ...
  protected function savePembebasan($model, $dataPembebasan, $modPendaftaran)
  {
    ...
    $modPembebasan->pendaftaran_id = $modPendaftaran['pendaftaran_id'];
    $modPembebasan->pasien_id = $modPendaftaran['pasien_id'];
  ...
  public function actionLoadDataPasien()
  {
    if (Yii::app()->request->isAjaxRequest) {
      ...
      $data = RJInfokunjunganrjV::model()->findByAttributes(array('pendaftaran_id' => $_POST['pendaftaran_id']));
      $post = null;
