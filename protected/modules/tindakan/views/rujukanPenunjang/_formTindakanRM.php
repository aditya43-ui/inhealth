                ...
                <div class="boxtindakan">
                    ...
                    <?php foreach ($modTindakan as $j => $tindakanRM) {
                        if ($jenisTindakan->jenistindakanrm_id == $tindakanRM->jenistindakanrm_id) {
                            echo CHtml::checkBox("tindakanrm_id[]", $ceklist, array(
                ...
                <thead>
                    <tr>
                        <th>
                            ...
                            <?php echo CHtml::checkBox('kingCheck', true, array(
    ...
    function inputTindakan(obj) {
        if ($(obj).is(':checked')) {
            ...
            if (kelasPelayan_id == '') {
                ...
                jQuery.ajax({
                    'url': '<?php echo $this->createUrl('loadFormPemeriksaanRMPendRM') ?>',
                    'data': {
                        idPemeriksaanRM: idPemeriksaanRM,
                        kelasPelayan_id: kelasPelayan_id
                    },
                    'type': 'post',
                    'dataType': 'json',
