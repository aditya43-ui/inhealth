...
{
    window.open('<?php echo $this->createUrl('/rawatJalan/tindakan/printTindakan'); ?>&id='+pendaftaran_id,'printwin','left=100,top=100,width=640,height=640');
}
...
function setTindakanAuto(kelaspelayanan_id,daftartindakan_id){
    ...
    */
    ...
    $.get('<?php echo Yii::app()->createUrl('tindakan/tindakan/daftarTindakan'); ?>',{
        tipepaket_id: tipepaket_id, 
        kelaspelayanan_id:kelaspelayanan_id, 
        daftartindakan_id:daftartindakan_id,
