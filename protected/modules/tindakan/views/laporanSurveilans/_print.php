...
if($caraPrint=='EXCEL')
{
    ...
    header('Cache-Control: max-age=0');     
      echo $this->renderPartial('application.views.headerReport.headerDefaultNewExcel', array('judulLaporan'=>$judulLaporan,'periode'=>$periode,'colspan'=>20));
}
...
?>
 ...
 <table style="width: 100%; border: none;">
  ...
  <?php 
    ...
    $this->renderPartial($this->path_view.'_tableRekap', array('model'=>$model, 'caraPrint'=>$caraPrint)); 
    $this->renderPartial($this->path_view.'_tableHitungan', array('model'=>$model, 'caraPrint'=>$caraPrint)); 
 ?>
