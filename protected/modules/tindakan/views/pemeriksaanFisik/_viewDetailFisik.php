...
<table style="width: 100%; border: none;">
    ...
    <tr>
        <td>  <label class='control-label'><?php echo CHtml::encode($modPemeriksaanFisik->getAttributeLabel('Nama PPDS')); ?>:</label>
            <?php echo CHtml::encode($modPemeriksaanFisik->ppds->ppds_nama); ?>
</td>
        <td>
