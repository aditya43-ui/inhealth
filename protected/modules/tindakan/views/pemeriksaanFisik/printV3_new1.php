<?php 
$data =ProfilrumahsakitM::model()->findByPk(5);
?>
<style>
    #imgtag {
        position: relative;
...
if (in_array($ruangan->instalasi_id, array(Params::INSTALASI_ID_RD, Params::INSTALASI_ID_PERSALINAN))) : ?>
    ...
    <tr>
        <td width="412">
            <div align="center" id="imgtag_detail">
                ...
                <img id="myImgId" src="<?php echo Yii::app()->request->baseUrl; ?>/images/anatomi.jpg" class="taggd" style="width:377px;" />
                <div id="tagbox"></div>
            </div>
        </td>
...
<?php if (in_array($ruangan->instalasi_id, array(Params::INSTALASI_ID_RD, Params::INSTALASI_ID_PERSALINAN))) : ?>
...
<?php else : ?>
    ...
    <table id="tblDaftarAnamnesa" class="table table-bordered table-condensed" border="2">
        ...
        <?php
        $modPemeriksaanFisik->sensibilitas_panasdingin = explode(":", $modPemeriksaanFisik->sensibilitas_panasdingin);
        $modPemeriksaanFisik->sensibilitas_tajamtumpul = explode(":", $modPemeriksaanFisik->sensibilitas_tajamtumpul);
        $modPemeriksaanFisik->sensibilitas_kasarhalus = explode(":", $modPemeriksaanFisik->sensibilitas_kasarhalus);
        $modPemeriksaanFisik->sensibilitas_titik = explode(":", $modPemeriksaanFisik->sensibilitas_titik);
        ?>
        <tr>
            ...
            <td width="50%" colspan="2" style="text-align: center;"><i class="<?php echo in_array("Panas", $modPemeriksaanFisik->sensibilitas_panasdingin) ? "entypo-check" : "entypo-cancel" ?>"></i> Panas / Dingin<i class="<?php echo in_array("Dingin", $modPemeriksaanFisik->sensibilitas_panasdingin) ? "entypo-check" : "entypo-cancel" ?>"></i></td>
        ...
        <tr>
            ...
            <td width="50%" colspan="2" style="text-align: center;"><i class="<?php echo in_array("Tajam", $modPemeriksaanFisik->sensibilitas_tajamtumpul) ? "entypo-check" : "entypo-cancel" ?>"></i> Tajam / Tumpul<i class="<?php echo in_array("Tumpul", $modPemeriksaanFisik->sensibilitas_tajamtumpul) ? "entypo-check" : "entypo-cancel" ?>"></i></td>
        ...
        <tr>
            ...
            <td width="50%" colspan="2" style="text-align: center;"><i class="<?php echo in_array("Kasar", $modPemeriksaanFisik->sensibilitas_kasarhalus) ? "entypo-check" : "entypo-cancel" ?>"></i> Kasar / Halus<i class="<?php echo in_array("Halus", $modPemeriksaanFisik->sensibilitas_kasarhalus) ? "entypo-check" : "entypo-cancel" ?>"></i></td>
        ...
        <tr>
            ...
            <td width="50%" colspan="2" style="text-align: center;"><i class="<?php echo in_array("1 Titik", $modPemeriksaanFisik->sensibilitas_titik) ? "entypo-check" : "entypo-cancel" ?>"></i>1 Titik / 2 Titik<i class="<?php echo in_array("2 Titik", $modPemeriksaanFisik->sensibilitas_titik) ? "entypo-check" : "entypo-cancel" ?>"></i></td>
    ...
    <?php if (in_array($ruangan->instalasi_id, array(Params::INSTALASI_ID_REHAB))) : ?>
        <table id="tblDaftarAnamnesa" class="table table-bordered table-condensed" border="2">
            <tr>
...
<?php endif; ?>
<table style="width: 140%; border: none;">
    <tr>
        <td colspan="10">&nbsp;</td>
    </tr>
    <tr>
        ...
        <td colspan="4"></td>
        <td colspan="4" align="center" valign="middle"><?php echo Yii::app()->user->getState('kabupaten_nama') . ", " . MyFormatter::formatDateTimeId(date('Y-m-d', strtotime($modPemeriksaanFisik->tglperiksafisik))); ?><br>Dokter Pemeriksa</td>
    </tr>
    <tr>
        <td colspan="9">&nbsp;</td>
    </tr>
    ...
    <tr>
        ...
        <td colspan="4" align="center" valign="middle"></td>
        <td colspan="4"></td>
        <td colspan="4" align="center" valign="middle"><?php echo (isset($modPendaftaran->pegawai->gelardepan) ? $modPendaftaran->pegawai->gelardepan : '') . ' ' . $modPendaftaran->pegawai->nama_pegawai . ' ' . (isset($modPendaftaran->pegawai->gelarbelakang_nama) ? $modPendaftaran->pegawai->gelarbelakang_nama : ''); ?></td>
    </tr>
</table>
