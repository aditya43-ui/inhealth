            ...
            <div class="panel-body" style="width:412px !important;">
                ...
                ?>
                        ...
                        <div align="center" id="imgtag<?php echo $tbh->gambartubuh_id ?>">
                            <!--<img img-no="<?php echo $tbh->gambartubuh_id ?>" alt="<?php echo $tbh->gambartubuh_id ?>" id="myImgId<?php echo $tbh->gambartubuh_id ?>" src="<?php echo Params::urlPhotoAnatomiTubuh() . $tbh->nama_file_gbr; ?>" class="taggd<?php echo $tbh->gambartubuh_id ?>" style="width:480px;" data-id="<?php echo $tbh->gambartubuh_id ?>" />-->
