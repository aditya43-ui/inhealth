...
<div class="antirow">
            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <?php echo $form->dropDownList($modPemeriksaanFisik, 'pegawai_id', CHtml::listData($modPemeriksaanFisik->getDokterItems($ruangan_dokter), 'pegawai_id', 'NamaLengkap'), array('empty' => '-- Pilih --', 'onkeypress' => "return $(this).focusNextInputField(event);", 'class' => 'required')); ?>
                        </div>
                    </div>
                    <div class="control-group">
                        <?php
    ...
    <div class="row">
        ...
        <div class="col-sm-12" style="margin-top: 17px;">
            ...
            <div class="panel panel-success panel_cgsews">
                <div class="panel-heading">
                    <div class="panel-title">
                        <?php echo $form->checkBox($modPemeriksaanFisik, 'thorax', array('class' => 'cek_ews', 'uncheckValue' => null)); ?>
                        <i class="glyphicon glyphicon-file"></i> <?php echo $headThorax; ?>
                    </div>
    ...
    <div class="row" style="margin-top: 17px;" hidden>
        <div class="col-sm-12">
    ...
    <div class="row" <?php echo $hide ?> style="margin-top: 17px;">
        <div class="col-sm-12">
            ...
            <div class="panel panel-success panel_cgsews" hidden>
                <div class="panel-heading">
                    <div class="panel-title">
                        <?php echo $form->checkBox($modPemeriksaanFisik, 'denyutjantung_janin', array('class' => 'cek_ews', 'uncheckValue' => null)); ?>
                        <i class="glyphicon glyphicon-file"></i> Tanda Vital Janin
                    </div>
                </div>
                <div class="panel-body">
                    <div id="divJanin" style="display: block">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <?php echo $form->textField($modPemeriksaanFisik, 'denyutjantung_janin', array('class' => 'span2 numbersOnly', 'style' => 'text-align: right;')); ?>
                                /menit
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <?php echo $form->textField($modPemeriksaanFisik, 'tinggifundus_uteri', array('class' => 'span2 numbersOnly', 'style' => 'text-align: right;')); ?>
                                cm
                            </div>
                        </div>
                    </div>
    ...
    <div class="row" <?php echo $hide ?>>
        <div class="col-sm-12">
            ...
            <?php
            echo $this->renderPartial($this->path_view . 'pemeriksaan/polik-mata/index', array('model' => $modPemeriksaanFisik, 'form' => $form));
            ?>
