    ...
    <div class="panel panel-success">
        ...
        <div class="panel-body">
            ...
            <div class="col-sm-6">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        -
                        <?php echo CHtml::activeTextField($modPasienPenunjang, 'no_masukpenunjang', array('readonly' => true, 'class' => 'span1')); ?>
                    </div>
                </div>
                <div class="control-group">
            ...
            <div class="col-sm-6">
                ...
                <div class="control-group">
                    <?php echo CHtml::label('', 'photo_pasien', array('class' => 'control-label')); ?>
                    <div class="controls">
                        <?php
