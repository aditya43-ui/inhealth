...
<div class="panel panel-success">
    <div class="panel-heading">
        <div class="panel-title">
            Hasil Pemeriksaan Jawaban Tindakan
        </div>
    </div>
    <?php 
    ...
    <div class="panel-body">
        <div class="col-sm-12">
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    $this->widget('MyDateTimePicker', array(
                        'model' => $model,
                        'attribute' => 'tgljawabordertindakan',
                        'mode' => 'datetime',
                        'options' => array(
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?php echo CHtml::activeTextArea($model, 'jawaban_tindakan', array('class' => 'span8')); ?>
                </div>
            </div>
            <div class="control-group">
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td>
                                    <?php
                                        echo $form->dropDownList($modMorbiditas[$i], "[$i]ppds_id", CHtml::listData(PpdsM::model()->findAllByAttributes(array(
                                            'ruangan_id' => Yii::app()->user->getState('ruangan_id'),
                                        )), "ppds_id", "ppds_nama"), array(
                                            'empty' => '-- Pilih --', 'onkeypress' => "return $(this).focusNextInputField(event)", 'class' => 'span2', 'disabled' => $disabled,
                                        ));
                                        echo $form->error($modMorbiditas[$i], "[$i]ppds_id");
                                        ?>
                            </td>
                                    <td>
                    ...
                    $this->widget('MyJuiAutoComplete', array(
                        ...
                        'options' => array(
                            ...
                            'select' => 'js:function( event, ui ) {
                                ...
                                $("#RJRuangTindakan_pegawaiordertindakan_id").val(ui.item.pegawai_id);
                                return false;
                            }',
                        ),
                        ...
                        'htmlOptions' => array(
                            'onblur' => '
                                if($(this).val() == ""){
                                    $("#RJRuangTindakan_pegawaiordertindakan_id").val("");
                                }
                            '
                        ),
                    ));
                    ?>
                    <?php echo CHtml::activeHiddenField($model, 'pegawaiordertindakan_id', array('readonly' => true)); ?>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-6">
            <div class="control-group">
                ...
                <div class="controls" style="width:50%;">
                    <?php $this->widget('ext.redactorjs.Redactor',array('model'=>$model, 'attribute'=>'subjektif_jawaban', 'toolbar'=>'mini','height'=>'100px')) ?>
                </div>
            </div>
            <div class="control-group">
                <label class="control-label">Objective</label>
                <div class="controls" style="width:50%;">
                    <?php $this->widget('ext.redactorjs.Redactor',array('model'=>$model, 'attribute'=>'objektif_jawaban', 'toolbar'=>'mini','height'=>'100px')) ?>
                </div>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="control-group">
                ...
                <div class="controls" style="width:50%;">
                    <?php $this->widget('ext.redactorjs.Redactor',array('model'=>$model, 'attribute'=>'assesment_jawbaan', 'toolbar'=>'mini','height'=>'100px')) ?>
                </div>
            </div>
            <div class="control-group">
                <label class="control-label">Planning</label>
                <div class="controls" style="width:50%;">
                    <?php $this->widget('ext.redactorjs.Redactor',array('model'=>$model, 'attribute'=>'planning_jawaban', 'toolbar'=>'mini','height'=>'100px')) ?>
                </div>
            </div>
            <div class="control-group">
                <label class="control-label">File Periksa</label>
        <div class="controls" style="width:50%;">
                <?php echo $form->FileFieldRow($model, 'hasiltindakan_file', array('class' => 'span4', 'rows' => 6, 'cols' => 50)); ?>
           </div>
            </div>
            ...
            array(
                ...
                'value' => function ($data) {
                    ...
                    return CHtml::link('<i class="icon-form-check"></i>', '#', array(
                        ...
                        $('#RJRuangTindakan_diagnosa_id').val(" . $data->diagnosa_id . ");
                        $('#RJRuangTindakan_diagnosa_nama').val('" . $data->diagnosa_nama . "');
                        $('#RJRuangTindakan_diagnosa_nama').val('');
        ...
        array(
            ...
            'value' => function ($data) {
                return CHtml::Link('<i class="icon-form-check"></i>', "#", array(
                    "class" => "btn-small",
                    "onclick" => "
                        $('#RJRuangTindakan_pegawaiordertindakan_id').val(" . $data->pegawai_id . ");
                        $('#RJRuangTindakan_nama_pegawai').val('" . $data->nama_pegawai . "');
...
<script>
    var trUraian = new String(<?php echo CJSON::encode($this->renderPartial('tindakanInternal/_formDiagnosaICDX', array('form' => $form, 'modUraian' => $modUraian), true)); ?>);
        ...
        myConfirm("Anda yakin untuk menghapus Diagnosis (ICD X) ini?", "Peringatan", function(r) {
            if (r) {
                if (pasienmorbiditas_id.length > 0) {
                    jQuery.ajax({
                        'url': '<?php echo Yii::app()->createUrl('rawatJalan/diagnosaTRJNew/hapusDiagnosax') ?>',
                        'data': {
    ...
    function inputDiagnosa(diagnosa_id, params) {
        ...
        if (id_diagnosax[diagnosa_id] == undefined) {
            ...
            setTimeout(function() {
                ...
                renameInput('RJPasienMorbiditasT', 'ppds_id');
