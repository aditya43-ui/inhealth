...
<table width="100%" class=''>
    ...
    <td style="width: 25%; text-align: center" valign="bottom" >
    <center>
        <table>
            <tr>
                <td style="font-weight: bold; font-size: 14pt; text-align: center">
                  HASIL PEMERIKSAAN <br/>USG
                </td>
            </tr>
        </table>
    </center>
    ...
    <td style="width: 35%;" valign="top">
        <table class="borderclass infopasienheader" style=" float:right; width: 100%">
            <tr>
            ...
            <tr>
                ...
                <td style="padding: 2px">
                    <?php
                    $pegawalDpjp = (isset($modPendaftaran->pegawai)?$modPendaftaran->pegawai->namaLengkap:"");

                    if(isset($modPendaftaran->pasienadmisi)){
                      $pegawalDpjp = $modPendaftaran->pasienadmisi->dokpenerima->namaLengkap;
                    }
                echo $pegawalDpjp; ?>
                </td>
            </tr>
