<tr>
    ...
    <td>
        <?php echo CHtml::textField('biometri_ac', '',array('class'=>'biometri_ac span1 integer-decimal','onkeyup'=>"return $(this).focusNextInputField(event);")) ?> cm
    </td>
    <td>
    ...
    <td>
        <?php echo CHtml::textField('taksiranberatjanin', '',array('class'=>'taksiranberatjanin span1 integer-decimal')) ?> cm
    </td>
    <td>
    ...
    <td>
        <?php echo CHtml::textField('denyutjantungjanin', '',array('class'=>'deyutjantungjanin span1 integer2')) ?>
    </td>
    <td>
