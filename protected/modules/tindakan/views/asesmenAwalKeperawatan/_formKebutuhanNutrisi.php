         ...
         <div class="panel-body">
             <div class="col-md-6">
                 <div class="control-group ">
                    ...
                    <div class="controls">
                        <?php echo $form->radioButtonList($modAsesmenawalkeperawatanT,'keb_nutricairankeluhan_status',array(0=>'Tidak Ada',1=>'Ada') , array('class'=>'keb_nutricairankeluhan_status','onkeyup'=>"return $(this).focusNextInputField(event)",'onclick'=>'setKebNutrisiStatus(this);')); ?>            
                    </div>
                </div>
                 <div class="control-group ">
                    <div class="controls">
             ...
             <div class="col-md-6">
                 ...
                 <div class="control-group ">
                    ...
                    <div class="controls">
                        <?php echo $form->radioButtonList($modAsesmenawalkeperawatanT,'keb_nutricairan_edemastatus',array(0=>'Tidak',1=>'Ya') , array('class'=>'keb_nutricairan_edemastatus','onkeyup'=>"return $(this).focusNextInputField(event)",'onclick'=>'setKebNutrisiEdema(this);')); ?>            
                    </div>
                </div>
                 <div class="control-group">
