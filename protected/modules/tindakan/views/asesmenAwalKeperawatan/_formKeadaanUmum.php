             ...
             <div class="row-fluid">
                 <div class="col-sm-6">
                     <div class="control-group ">
                        ...
                        <div class="controls">
                            <?php echo $form->radioButtonList($modAsesmenawalkeperawatanT,'kesadaranpasien',array('Compos Mentis'=>'Compos Mentis','Delirium'=>'Delirium','Somnolen'=>'Somnolen','Sopor'=>'Sopor','Koma'=>'Koma') , array('onkeyup'=>"return $(this).focusNextInputField(event)",'class'=>'statusAlergi','onclick'=>'setStatusAlergi(this);')); ?>
                    ...
                    <?php if(Yii::app()->user->getState("instalasi_id") != Params::INSTALASI_ID_RJ){ ?>
                     <div class="control-group ">
                            <?php echo $form->labelEx($modAsesmenawalkeperawatanT, 'kondisiumum', array('class' => 'control-label')) ?>
                            <div class="controls">
                                    <?php
                                            $this->widget('application.extensions.FCBKcomplete.FCBKcomplete',array(
                                                    'model'=>$modAsesmenawalkeperawatanT,
                                                    'attribute'=>'kondisiumum',
                                                    'data'=> explode(',', $modAsesmenawalkeperawatanT->kondisiumum),
                                                    'debugMode'=>true,
                                                    'options'=>array(
                                                            //'bricket'=>false,
                                    ...
                                    ?>
                                    <?php echo $form->error($modAsesmenawalkeperawatanT, 'kondisiumum'); ?>
                            </div>
                    </div>
                     <div class="control-group ">
                        <?php echo $form->labelEx($modAsesmenawalkeperawatanT,'kebutuhankhusus_status', array('class'=>'control-label')) ?>
                        <div class="controls">
                            <?php echo $form->radioButtonList($modAsesmenawalkeperawatanT,'kebutuhankhusus_status',array('Tidak Ada'=>'Tidak Ada','Ada'=>'Ada') , array('onkeyup'=>"return $(this).focusNextInputField(event)",'class'=>'kebutuhankhusus_status','onclick'=>'setStatusKebutuhanKhusus(this);')); ?>
                            <?php echo $form->error($modAsesmenawalkeperawatanT, 'kebutuhankhusus_status'); ?>
                        </div>
                    </div>
                     <div class="control-group ">
                        <div class="controls">
                            <label class="checkbox inline">
                                <?php echo $form->checkboxRow($modAsesmenawalkeperawatanT,'kebutuhankhusus_isgigipalsu',array('disabled'=>true)); ?>
                                <?php echo $form->checkboxRow($modAsesmenawalkeperawatanT,'kebutuhankhusus_isalatbantudengar',array('disabled'=>true)); ?>
                                <?php echo $form->checkboxRow($modAsesmenawalkeperawatanT,'kebutuhankhusus_ispakaikacamata',array('disabled'=>true)); ?>
                                <?php echo $form->checkboxRow($modAsesmenawalkeperawatanT,'kebutuhankhusus_istongkat',array('disabled'=>true)); ?>
                                <?php echo $form->checkboxRow($modAsesmenawalkeperawatanT,'kebutuhankhusus_islainnya',array('disabled'=>true,'onChange'=>'changeIsLainnya(this);')); ?>
                            </label>
                        </div>
                    </div>
                     <div class="control-group ">
                         ...
                         <div class="controls">
                             <?php echo $form->textArea($modAsesmenawalkeperawatanT,'kebutuhankhusus_jenislainnya',array('readonly'=>true, 'class'=>'span3','maxlength'=>100)); ?>
                         </div>
                    </div>
                  <?php } ?>
                 </div>
                     ...
                     <div class="panel panel-success panel-shadow">
                        ...
                        <div class="panel-body">
                            <div class="control-group ">
                                ...
                                <div class="controls">
                                 <?php  echo $form->textField($modAsesmenawalkeperawatanT,'td_systolic',array('class'=>'span1 numbersOnly systolic', 'onkeypress'=>"return $(this).focusNextInputField(event);", 'maxlength'=>3, 'onkeyup'=>'returnValue(this); getText();', 'style'=>'text-align: right;'));?>Mm
                                 <?php echo $form->textField($modAsesmenawalkeperawatanT,'td_diastolic',array('onblur'=>'','readonly'=>false,'class'=>'span1 numbersOnly diastolic', 'onkeypress'=>"return $(this).focusNextInputField(event);", 'maxlength'=>3, 'onkeyup'=>'returnValue(this); getText();', 'style'=>'text-align: right;')); ?>Hg
                                </div>
                            </div>
                            <div class="control-group ">
