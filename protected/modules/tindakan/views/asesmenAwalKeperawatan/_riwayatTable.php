	...
	'columns'=>array(
                    ...
                    array(
                        ...
                        'value'=>function ($data){
                          ...
                          if($data->jenisasesmen == 'asesmen_anak'){
                            $jenisasesmen = "Asesmen Awal Keperawatan Pasien Rawat Jalan Anak";
                          }else if($data->jenisasesmen == 'asesmen_dewasa'){
                                $jenisasesmen = "Asesmen Awal Keperawatan Pasien Rawat Jalan Dewasa";
                          }else if($data->jenisasesmen == 'asesmen_neonatus'){
                            $jenisasesmen = "Asesmen Awal Keperawatan Neonatus";
                          }else if($data->jenisasesmen == 'asesmen_obgyn'){
                ...
                array(
                        ...
                        'value'=>function($data) {
                          ...
                          if($data->jenisasesmen == 'asesmen_anak'){
                            ...
                            $jenisasesmen = "Asesmen Awal Keperawatan Rawat Inap Neonatus Neonatus (< 30 Hari)";
                          }else if($data->jenisasesmen == 'asesmen_obgyn'){
                            $jenisasesmen = "Asesmen Awal Keperawatan Klinik Obstetri Gynekologi";
                          }

                          return CHtml::link(
                              '<icon class="icon-form-detail"></icon>', Yii::app()->createUrl("/rawatJalan/AsesmenAwalKeperawatan/detail", array("asesmenawalkeperawatan_id"=>$data->asesmenawalkeperawatan_id,"frame"=>true)),
                              array(
                                  "target"=>"iframeDetail",
                    ...
                    array(
                        ...
                        'type'=>'raw',
                        'value'=>function($data) {
                            return CHtml::link('<i class="entypo-pencil" style="font-size: 14pt"></i>', Yii::app()->controller->createUrl('edit', array(
                ...
                array(
                        ...
                        'type'=>'raw',
                        'value'=>function($data) {
                            return CHtml::link('<i class="icon-trash" style="font-size: 14pt"></i>', 'javascript:void(0)', array(
