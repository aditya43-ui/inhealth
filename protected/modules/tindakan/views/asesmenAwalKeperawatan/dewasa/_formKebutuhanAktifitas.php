                     ...
                     <td width="50%">
                         <table width="100%">
                             ...
                             <tr>
                                 ...
                                 <td>
                                     <div class="controls">
                                        <?php echo $form->radioButtonList($modAsesmenawalkeperawatanT,'deformitas_status',array(0=>'Tidak Ada',1=>'Ada ,Regio') , array('onkeyup'=>"return $(this).focusNextInputField(event)",'onclick'=>'setDeformitas_dws(this);')); ?>
                                    </div>
                                 </td>
                                 <td valign="bottom">
                     ...
                     <td width="50%">
                         <table width="100%">
                             <tr>
                                 ...
                                 <td>
                                      <div class="controls">
                                        <?php echo $form->radioButtonList($modAsesmenawalkeperawatanT,'gangguantidur_status',array(0=>'Tidak',1=>'Ya') , array('onkeyup'=>"return $(this).focusNextInputField(event)",'onclick'=>'setGangguanTidur_dws(this);')); ?>
                                    </div>
                                 </td>
                             </tr>
                             <tr>
