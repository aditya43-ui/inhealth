<?php if(Yii::app()->user->getState("instalasi_id") == Params::INSTALASI_ID_RJ){
  $modAsesmenawalkeperawatanT->isskrinninggizidewasa = 0;
} ?>
<div class="row-fluid">
  <?php if(Yii::app()->user->getState("instalasi_id") != Params::INSTALASI_ID_RJ){ ?>
     <div class="panel panel-primary panel-success">
        <div class="panel-heading">
            <div class="panel-title"><?php echo $form->radioButton($modAsesmenawalkeperawatanT, 'isskrinninggizidewasa', array('onclick' => 'choiseSkrinningGizi(this)', 'value' => 1, 'class'=>'pilih_SkrinningGizi', 'uncheckValue'=>null)); ?> <strong>Skrinning Gizi Dewasa (Metode Malnutrition Skrinning Tools/ MST)</strong></div>
        </div>
                         ...
                         <tbody>
                            <tr>
                                ...
                                <th>
                                    ...
                                    <select id="<?php echo get_class($modAsesmenawalkeperawatanT); ?>skrinninggizi_jwb_penurunanbb_dewasa_text" name="<?php echo get_class($modAsesmenawalkeperawatanT); ?>[skrinninggizi_jwb_penurunanbb_dewasa_text]" class="span3" onkeypress="return $(this).focusNextInputField(event);" onchange="skrinninggizidewasa_penurunbb(this);">
                            ...
                            <tr>
                                ...
                                <th>
                                    ...
                                    <?php echo $form->dropDownList($modAsesmenawalkeperawatanT,'skrinninggizi_jwb_asupanmakanan_dewasa_text',array('0'=>'Ya','1'=>'Tidak'), array('empty' => '-- Pilih --', 'class' => 'jeniskelaminAnak span3', 'onkeypress' => "return $(this).focusNextInputField(event);",'onchange'=>'skrinninggizidewasa_asupan(this)'));?>
                                </th>
   ...
   <?php } ?>
    <div class="panel panel-primary panel-success">
        <div class="panel-heading">
            <div class="panel-title"><?php echo $form->radioButton($modAsesmenawalkeperawatanT, 'isskrinninggizidewasa', array('onclick' => 'choiseSkrinningGizi(this)', 'value' => 0, 'class'=>'pilih_SkrinningGizi', 'uncheckValue'=>null)); ?> <strong>Skrinning Gizi Anak (Metode Strong Kids)</strong></div>
        </div>
         <div class="panel-body">
                         ...
                         <tbody>
                            <tr>
                                ...
                                <th>
                                    ...
                                    <?php echo $form->dropDownList($modAsesmenawalkeperawatanT, 'skrinninggizi_jwb_tampakkurus_text', array('Ya'=>'Ya','Tidak'=>'Tidak'), array('empty' => '-- Pilih --', 'class' => 'span3', 'onkeypress' => "return $(this).focusNextInputField(event);",'onchange' => 'skrininggizianak_tampakkurus(this)')); ?>
                                </th>
                            ...
                            <tr>
                                ...
                                <th>
                                    ...
                                    <?php echo $form->dropDownList($modAsesmenawalkeperawatanT,'skrinninggizi_jwb_penurunanbb_text',array('Ya'=>'Ya','Tidak'=>'Tidak'), array('empty' => '-- Pilih --', 'class' => 'jeniskelaminAnak span3', 'onkeypress' => "return $(this).focusNextInputField(event);",'onchange'=>'skrininggizianak_bb(this)'));?>
                                </th>
                            ...
                            <tr>
                                ...
                                <th>
                                    ...
                                    <?php echo $form->dropDownList($modAsesmenawalkeperawatanT, 'skrinninggizi_jwb_kondisi_text', array('Ya'=>'Ya','Tidak'=>'Tidak'), array('empty' => '-- Pilih --', 'class' => 'span3', 'onkeypress' => "return $(this).focusNextInputField(event);",'onchange' => 'skrininggizianak_kondisi(this)')); ?>
                                </th>
                            ...
                            <tr>
                                ...
                                <th>
                                    ...
                                    <?php echo $form->dropDownList($modAsesmenawalkeperawatanT, 'skrinninggizi_jwb_penyakit_text', array('Ya'=>'Ya','Tidak'=>'Tidak'), array('empty' => '-- Pilih --', 'class' => 'span3', 'onkeypress' => "return $(this).focusNextInputField(event);",'onchange' => 'skrininggizianak_penyakit(this)')); ?>
                                </th>
           ...
           <div class="row">
             ...
             <div class="col-sm-6">
               <div class="control-group">
                   ...
                   <div class="controls">
                       <?php echo $form->radioButtonList($modAsesmenawalkeperawatanT,'nutrisi_perubahanbb6blnterakhir', array('Tidak'=>'Tidak','Ya'=>'Ya'), array('class'=>'nutrisi_perubahanbb6blnterakhir','onkeyup'=>"return $(this).focusNextInputField(event)", 'onchange'=>'setNutrisiPerubahanBB_anak();')); ?>
                   </div>
               </div>
               <div class="control-group">
