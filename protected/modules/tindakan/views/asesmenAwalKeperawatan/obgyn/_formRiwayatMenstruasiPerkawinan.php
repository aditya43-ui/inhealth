             ...
             <div class="row">
               <div class="col-sm-6">
                ...
                <div class="control-group ">
                   ...
                   <div class="controls">
                     <?php  echo $form->textField($modAsesmenawalkeperawatanT,'obgyn_menarcheumur',array('class'=>'span1 integer2', 'onkeypress'=>"return $(this).focusNextInputField(event);", 'maxlength'=>3, 'style'=>'text-align: right;')); ?> Tahun
                   </div>
               </div>
               <div class="control-group ">
                  ...
                  <div class="controls">
                    <?php
                      $this->widget('MyDateTimePicker', array(
                              ...
                              'htmlOptions' => array('readonly' => true, 'class'=>'span3', 'onchange'=>'hitungSiklusHaid()',
