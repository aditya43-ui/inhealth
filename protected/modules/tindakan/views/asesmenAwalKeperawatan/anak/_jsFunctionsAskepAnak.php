...
function skorskrinningfungsional(){
   ...
   if(totalSkor == 100){
    ...
    $('.formAnak').find('#<?php echo CHtml::activeId($model,'skrinningfungsional_jumlah_skor') ?>').val(totalSkor);
    $('.formAnak').find('#<?php echo CHtml::activeId($model,'skrinningfungsional_keterangan') ?>').val(keterangan);
    $('.formAnak').find('#<?php echo CHtml::activeId($model,'skrinningfungsional_kategori') ?>').val(kategori);
}
...
<?php if(Yii::app()->user->getState("instalasi_id") == Params::INSTALASI_ID_RJ){ ?>
 ...
 <?php }else{ ?>
    ...
    $('.formAnak').find('.pilih_resikoJatuh').each(function(){
      ...
      }else if($('.formAnak').find(this).val() == 1 && $('.formAnak').find(this).prop('checked')==true){
         <?php if($modPasien->kelompokumur_id == Params::KELOMPOKUMUR_BARU_LAHIR){ ?>
             $('.formAnak').find('#<?php echo CHtml::activeId($model,'resikojatuh_tingkat') ?>').val("Resiko Tinggi");
         <?php }else{ ?>
             $('.formAnak').find('#<?php echo CHtml::activeId($model,'resikojatuh_tingkat') ?>').val(ketResikoAnak);
...
function setChangeDetEdukasiLain(obj){
    ...
    if($('.formAnak').find(obj).prop('checked')==true){
        $('.formAnak').find('#RJAsesmenkebutuhanEdukasidetT_'+index+'_edukasipasien_lainnya').attr('readonly',false);
    }else{
        $('.formAnak').find('#RJAsesmenkebutuhanEdukasidetT_'+index+'_edukasipasien_lainnya').attr('readonly',true);
        $('.formAnak').find('#RJAsesmenkebutuhanEdukasidetT_'+index+'_edukasipasien_lainnya').val('');
    }
}
