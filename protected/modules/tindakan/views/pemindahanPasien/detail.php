          ...
          <td width="50%" valign="top">
            <table width="100%" style="border: none;">
              ...
              <tr>
                ...
                <td>
                          <?php
                                echo CHtml::textField('tekanandarah','',array('disabled'=>true,'readonly'=>true, 'class'=>'span2', 'style'=>'width:60px;','onkeypress'=>"return $(this).focusNextInputField(event)"));
                          ?> Mm/Hg
                        </td>
                      </tr>
                      <tr>
          ...
          <td width="50%" valign="top">
            <table width="100%" style="border: none;">
              <tr>
                ...
                <td>
                  <?php echo CHtml::activeDropDownList($model, 'pegawai_mengetahui', CHtml::listData(PegawairuanganV::model()->findAll('ruangan_id = '.Yii::app()->user->getState("ruangan_id")),'pegawai_id','namaLengkap'), array('disabled'=>true,'empty'=>'-- Pilih --','onkeypress' => "return $(this).focusNextInputField(event);",'class'=>'span3')); ?>
                </td>
              </tr>
              <tr>
                <td>
                ...
                <td>
                    <?php echo CHtml::activeDropDownList($model, 'perawatpengirim_id', CHtml::listData(PegawairuanganV::model()->findAll('ruangan_id = '.Yii::app()->user->getState("ruangan_id").' and kelompokpegawai_id = '.Params::KELOMPOKPEGAWAI_ID_TENAGA_KEPERAWATAN),'pegawai_id','namaLengkap'), array('disabled'=>true,'empty'=>'-- Pilih --','onkeypress' => "return $(this).focusNextInputField(event);",'class'=>'span3')); ?>
                  </td>
                </tr>
            </table>
          </td>
