...
foreach($modMasukPenunjang as $row){
        ...
        } else if(!empty($modHasilRad)){ //jika radiologi
            $subresult .= "".CHtml::link("<i class='icon-list-alt'></i> ".$modHasilRad->pemeriksaanrad->pemeriksaanrad_nama.' - '.$modHasilRad->tglpemeriksaanrad.' - '.$row->ruangan_nama.'<br>'.$hasilRad->pemeriksaanrad_nama,Yii::app()->createUrl(
