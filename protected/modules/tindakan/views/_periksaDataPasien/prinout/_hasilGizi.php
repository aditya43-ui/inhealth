...
<table class='prinout w100 grid'>
    <tr>
        <td rowspan="3" width="100" style="text-align: center; vertical-align: middle;"><b>PENGKAJIAN DAN ASUHAN GIZI</b></td>
        <td rowspan="2">
    ...
    <tr>
        <td colspan="3">
            <table class="w100 no-grid prinout">
                <tbody>
                    <tr>
                        <td width="50%">
                            Antropometri<br>
