...
<script type='text/javascript'>
    ...
    const cekSimpanTabulasi = (frameObj, tabObj, dari = 'tab') => {   
        ...
        const tabw = ['Anamnesis Keperawatan (S)', 'Anamnesis Medis', 'Periksa Fisik Awal (O)', 'Laboratorium (P)', 'Radiologi (P)', 'Reseptur (P)'];
        
        if(kunjungan = 'KUNJUNGAN LAMA') {
            const tabw = ['Periksa Fisik Awal (O)', 'Laboratorium (P)', 'Radiologi (P)', 'Reseptur (P)'];
        }
