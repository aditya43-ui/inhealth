    ...
    <div class="panel panel-primary panel-success">
        ...
        <div class="panel-body">
            <table width="100%" class="table-condensed">
                ...
                <tr>
                  <td><?php echo CHtml::Label('Dokter Pemeriksa', 'dokter_pemeriksa', array('class'=>'control-label')); ?></td>
                  <td><?php
                   ...
                   echo CHtml::textField('dokterpemeriksaLengkap', $namaDokterPemeriksa, array('readonly'=>true)); ?></td>
