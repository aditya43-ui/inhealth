...
<table width="100%" <?php echo $style; ?> >
    <tr>
        <td width="30%"><?php echo CHtml::encode($modPendaftaran->getAttributeLabel('tgl_pendaftaran')); ?></td>
        <td width="60%"><?php echo CHtml::encode(MyFormatter::formatDateTimeForUser($modPendaftaran->tgl_pendaftaran)); ?></td>
    </tr>
    <tr>
        <td width="30%"><?php echo CHtml::encode($modPendaftaran->getAttributeLabel('no_pendaftaran')); ?></td>
...
<table id="tblListPemeriksaanLab" class="tab-detail" border="1" >
    <thead>
        <tr>
            ...
            <th>No. Permintaan</th>
            <!--<th>No. Antrian</th>-->
            <th hidden>Jenis Pemeriksaan</th>
...
<table width="100%">
    <tr>
        <td colspan="2" width="40%" align="left">Catatan Dokter : <?php echo (isset($riwayat->catatandokterpengirim) ? CHtml::encode($riwayat->catatandokterpengirim) : " - "); ?></td>
    ...
    <tr>
        ...
        ?>
        <td width="30%" align="center"><?php echo Yii::app()->user->getState('nama_pegawai'); ?></td>
        <td width="40%" align="center"></td>
