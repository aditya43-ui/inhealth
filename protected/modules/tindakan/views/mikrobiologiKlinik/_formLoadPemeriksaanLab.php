...
<tr id="periksalab_<?php echo $modTarif->pemeriksaanlab_id; ?>">
    <?php if($modTarif->jenispemeriksaanlab_kelompok == Params::PATOLOGI_MIKROBIOLOGI_KLINIK){ ?>
      <td>
    ...
    <td><?php echo CHtml::textField("permintaanPenunjang[inputqty][]", '1',array('readonly'=>!empty($id_tindakan),'class'=>'inputFormTabel lebar1 integer gty span1', 'onkeyup'=>'hitungTotal();',)); ?>
        <?php echo CHtml::hiddenField("permintaanPenunjang[inputtarifpemeriksaanlab][]", $tarif,array('class'=>'inputFormTabel lebar3 integer tarif_satuan','readonly'=>true)); ?>
    </td>
