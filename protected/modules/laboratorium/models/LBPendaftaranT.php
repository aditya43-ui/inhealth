<?php
/**
 * model ini digunakan untuk meload tabel pendaftaran_t, hanya untuk di modul laboratorium
 * 
...
class LBPendaftaranT extends PendaftaranT
{
        ...
        /**
         * luntuk load fungsi yii dari CActiveRecord
        ...
        /**
         * mengatur rules, untuk tiap field
         * @return type
         */
        public function rules()
        {
                ...
                return array(
                        array('kelompokumur_id, no_pendaftaran, tgl_pendaftaran, no_urutantri, statuspasien, kunjungan, statusmasuk, umur, create_time, create_loginpemakai_id, ruangan_id, jeniskasuspenyakit_id, kelaspelayanan_id, carabayar_id, penjamin_id', 'required'),
        ...
        */
        ...
        public function searchRiwayatPasien(){
            ...
            //    $criteria->addInCondition("ruangan_id", array(Params::RUANGAN_ID_LAB_KLINIK,Params::RUANGAN_ID_LAB_ANATOMI));
            //}
        ...
        public function getRuanganTanggalStatus() {
            return $this->ruangan->ruangan_nama . ' - ' . MyFormatter::formatDateTimeForUser(date('Y-m-d', strtotime($this->tgl_pendaftaran))) . ' - ' . $this->statusperiksa;
        }
