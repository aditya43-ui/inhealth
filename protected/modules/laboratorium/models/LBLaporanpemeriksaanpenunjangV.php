...
class LBLaporanpemeriksaanpenunjangV extends LaporanpemeriksaanpenunjangV
{
	...
	public static function model($className=__CLASS__)
	{
        ...
        protected function functionCriteria() {
            ...
            $criteria->select = 't.carabayar_nama, mp.nama_pasien,rum.ruangan_nama, t.penjamin_nama,t.no_rekam_medik, t.tgl_tindakan, t.daftartindakan_kode, t.daftartindakan_nama,t.tarif_satuan, 
            ...
            JOIN pasien_m mp ON mp.pasien_id = t.pasien_id
            JOIN ruangan_m rum ON rum.ruangan_id = t.ruangan_id ";
          
            
            $criteria->group = 't.carabayar_nama,t.tgl_tindakan,t.no_rekam_medik,t.penjamin_nama,mp.nama_pasien,rum.ruangan_nama, t.daftartindakan_kode, t.daftartindakan_nama, t.tarif_satuan';
            ...
            $criteria->compare('LOWER(mp.nama_pasien)',strtolower($this->nama_pasien),true);
            $criteria->compare('LOWER(rum.ruangan_nama)',strtolower($this->ruangan_nama),true);
