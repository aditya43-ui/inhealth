...
class PemakaianBahanController extends PemakaianBmhpController
{
  ...
  {
    if($linkHalaman == null) $linkHalaman = CustomFunction::getUrlByMenuID(849);
    return PemakaianBmhpController::actionIndex($pasienmasukpenunjang_id, $linkHalaman);
  }
  ...
  public function actionInformasi($linkHalaman = null)
  {
    ...
    if($linkHalaman == null) $linkHalaman = CustomFunction::getUrlByMenuID(1015);

    $this->render('laboratorium.views.pemakaianBahan.informasi', array(
      'model' => $model,
