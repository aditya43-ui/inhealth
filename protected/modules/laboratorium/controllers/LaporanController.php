...
class LaporanController extends MyAuthController
{
  ...
  {
    $this->pageTitle = Yii::app()->name . " - Pemeriksaan Penunjang";
  ...
  public function actionPrintLaporanPemeriksaanCaraBayar()
  {
    ...
    if (isset($_REQUEST['LBLaporanpemeriksaangroupV'])) {
      ...
      switch ($model->jns_periode) {
        case 'bulan':
          $modelPerusahaan->tgl_awal = $modelPerusahaan->bln_awal . "-01";
          $modelPerusahaan->tgl_akhir = $bln_akhir;
          break;
        case 'tahun':
          $modelPerusahaan->tgl_awal = $modelPerusahaan->thn_awal . "-01-01";
          $modelPerusahaan->tgl_akhir = $thn_akhir;
          break;
        default:
          null;
      }
  ...
  {
    $this->pageTitle = Yii::app()->name . " - Pembayaran Pemeriksaan Laboratorium";
    ...
    if (isset($_GET['LBLaporanpembayaranpenunjangV'])) {
      ...
      $model->tgl_awal = $model->tgl_awal . " 00:00:00";
      $model->tgl_akhir = $model->tgl_akhir . " 23:59:59";
      if (isset($_GET['LBLaporanpembayaranpenunjangV']['no_pendaftaran'])) {
  ...
  public function actionPemeriksaanRujukanRS()
  {
    ...
    $model->thn_awal = date('Y');
    $model->thn_akhir = date('Y');
    $this->path_view = 'laboratorium.views.laporan.pemeriksaanRujukanRs.';
