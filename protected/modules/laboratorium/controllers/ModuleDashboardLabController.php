...
class ModuleDashboardLabController extends ModuleDashboardNeonController
{
  ...
  {
    $this->pageTitle = Yii::app()->name . " - Dashboard Laboratorium";
    $this->render('index');
  }
  ...
  public function actionSetIFrameDashboard()
  {
    ...
    //=== start map ===
    $sql = "SELECT kecamatan_m.kecamatan_id,kabupaten_m.kabupaten_id,kabupaten_m.kabupaten_nama,kabupaten_m.longitude as longitude_kab,kabupaten_m.latitude as latitude_kab, kecamatan_m.kecamatan_nama, kecamatan_m.longitude, kecamatan_m.latitude, count(pendaftaran_id) as jumlah
				FROM pasienmasukpenunjang_v
