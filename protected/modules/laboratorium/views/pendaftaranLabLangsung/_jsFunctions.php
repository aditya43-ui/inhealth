...
<script type="text/javascript">
    ...
    function checkOto() {
        ...
        if (otoval == 1) { //baru
            ...
            $(".nama_pas_bm").hide().find(":input").prop("disabled", true);

            $("#btn_hak_pasien").prop("disabled", false);

            // manusia enable
            $(".nama_pas").show().find(":input").prop("disabled", false);
            $(".no_identitas").show().find(":input").prop("disabled", false);
            $(".nama_bin").show().find(":input").prop("disabled", false);
            $(".tempat_lahir").show().find(":input").prop("disabled", false);
            $(".goldar").show().find(":input").prop("disabled", false);
            $(".kawin").show().find(":input").prop("disabled", false);
            $(".ibu").show().find(":input").prop("disabled", false);
            $(".jeniskelamin").show().find(":input").prop("disabled", false);
            $(".tanggal_lahir").show().find(":input").prop("disabled", false);
            $(".umur").show().find(":input").prop("disabled", false);
            $(".namadepan").show().find(":input").prop("disabled", false);
            $(".agama").show().find(":input").prop("disabled", false);
            $(".no_mobile_pasien").show().find(":input").prop("disabled", false);
            $(".alamat").show().find(":input").prop("disabled", false);
            $(".warganegara").show().find(":input").prop("disabled", false);
            

            $(".is_bukanmanusia").val(0);
            $(".form_bm").hide();
            $(".form_m").show();
            // $(".required_m").addClass('required'); //required kondisi manusia bkn manusia agar bisa masuk verifikasi
            // $(".form_bm").addClass('hide');;
            // $(".form_m").removeClass('hide');
        } else if (otoval == 0){
            $(".labelrm").hide();
            $(".rm_baru").show();
            $(".rm_lama").hide();
            ...
            //bukan manusia
            // $(".form_bm").removeClass('hide');
            // $(".form_m").addClass('hide');
            ...
            // bukan manusia disable
            $(".nama_pas").hide().find(":input").prop("disabled", true);
            $(".no_identitas").hide().find(":input").prop("disabled", true);
            $(".nama_bin").hide().find(":input").prop("disabled", true);
            $(".tempat_lahir").hide().find(":input").prop("disabled", true);
            $(".goldar").hide().find(":input").prop("disabled", true);
            $(".kawin").hide().find(":input").prop("disabled", true);
            $(".ibu").hide().find(":input").prop("disabled", true);
            $(".namadepan").hide().find(":input").prop("disabled", true);
            $(".agama").hide().find(":input").prop("disabled", true);
            $(".no_mobile_pasien").hide().find(":input").prop("disabled", true);
            $(".alamat").hide().find(":input").prop("disabled", true);
            $(".warganegara").hide().find(":input").prop("disabled", true);


            ////bukan manusia harus ada inputan ke db
            $(".jeniskelamin").hide().find(":input").prop("disabled", true);
            $(".tanggal_lahir").hide().find(":input").prop("disabled", true);
            $(".umur").hide().find(":input").prop("disabled", true);
            ...
            $(".is_bukanmanusia").val(1);
            $(".form_bm").show();
            $(".form_m").hide();
            // $(".required_m").removeClass('required'); //required kondisi manusia bkn manusia agar bisa masuk verifikasi
        }
    }
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.statusrekammedis.trim() == "<?php echo Params::STATUSREKAMMEDIS_AKTIF ?>") {
                    ...
                    $(".form_m #<?php echo CHtml::activeId($modPasien, "nama_pasien"); ?>").val(data.nama_pasien);
    ...
    function pilihPemeriksaanIni(obj) {
        ...
        if ($(obj).is(':checked')) {
            ...
            $("#form-tindakanpemeriksaan-" + form_index).find('span[name$="[ii][pemeriksaanlab_nama]"]').html(pemeriksaanlab_nama);
            ...
            $("#form-tindakanpemeriksaan-" + form_index).find('input[name$="[ii][tarif_tindakan]"]').val(formatInteger(harga_tariftindakan));
            $(".daftartindakan_id").find('input[name$="[ii][daftartindakan_id]"]').val(daftartindakan_id);
        } else {
    ...
    function printStatusLabel(pendaftaran_id) {
        window.open('<?php echo $this->createUrl('printLabel'); ?>&pendaftaran_id=' + pendaftaran_id, 'printwin', 'left=100,top=100,width=480,height=640');
    }
