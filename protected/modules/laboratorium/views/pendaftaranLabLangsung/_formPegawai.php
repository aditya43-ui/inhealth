<div class="control-group">
        ...
        <div class="controls">
			<?php echo $form->hiddenField($modPasien,'pegawai_penanggungjawab_id',array('readonly'=>true,'class'=>'span3', 'onkeyup'=>"return $(this).focusNextInputField(event);", 'maxlength'=>10)); ?>
            <?php
