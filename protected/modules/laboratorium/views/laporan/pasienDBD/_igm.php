...
// "DATE(pendaftaran_t.tgl_pendaftaran) BETWEEN '". $format->formatDateTimeForDb($tgl_awal) ."' AND '". $format->formatDateTimeForDb($tgl_akhir) ."'",
   ...
   // }
    ...
    {   
        ...
        {
            echo ($datas['daftartindakan_id'] == Params::DAFTARTINDAKAN_ID_IGM) ?  "<p style=\"margin: 0; text-align: center;\"><i class=icon-ok icon-black></i></p>":  "<p style=\"margin: 0; text-align: center;\"><i class=icon-minus icon-black></i></p>";
        }
    }
    else
    {
