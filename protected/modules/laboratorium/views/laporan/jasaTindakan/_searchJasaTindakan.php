...
use function PHPSTORM_META\type;
    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            <?php 
                echo CHtml::hiddenField('filter', 'daftartindakan_id', array('disabled' => 'disabled')) . '<div class="control-group">
                            ' . CHtml::label('Uraian Tindakan', 'daftartindakan_id', array('class' => 'control-label')) . ' 
                            <div class="controls">												 
                                ' . $form->dropDownList(
                        $model,
                        'daftartindakan_id',CHtml::listData(PemeriksaanradM::model()->findAll('pemeriksaanrad_aktif=TRUE ORDER BY pemeriksaanrad_nama ASC'), 'daftartindakan_id', 'pemeriksaanrad_nama'),
                        array(
                            'class' => 'form-control', 
                            'multiple' => 'multiple',
                        )
            ...
            <?php
                echo CHtml::hiddenField('filter', 'instalasi_id', array('disabled' => 'disabled')) .
                    '<div class="control-group">
                            ' . CHtml::label('Jenis Kunjugan', 'instalasi_id', array('class' => 'control-label')) . ' 
                            <div class="controls">
        ...
        <div class="col-sm-6">
            ...
            <?php
                echo CHtml::hiddenField('filter', 'carabayar_id', array('disabled' => 'disabled')) .
                    '<div class="control-group">
