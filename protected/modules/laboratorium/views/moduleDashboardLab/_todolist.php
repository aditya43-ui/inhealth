<div class="tile-block" id="todo_tasks">
	...
	<div class="tile-content">
		...
		<?php echo $form_todolist->textField($modTodolist,'todolist_nama',array('style'=>'margin-bottom:10px','class'=>'form-control', 'placeholder'=>'To Do List', 'onkeyup'=>"return $(this).focusNextInputField(event);")); ?>
...
<div style="text-align: center;">
        <?php echo CHtml::htmlButton(Yii::t('mds','{icon} Simpan',array('{icon}'=>'<i class="entypo-check"></i>')),array('class'=>'btn  btn-danger','onclick'=>'updateTodolist();')); ?>
        <?php echo CHtml::htmlButton(Yii::t('mds','{icon} Reset',array('{icon}'=>'<i class="entypo-cancel"></i>')),array('class' => 'btn btn-default','onclick'=>'$(\'#dialog-ubah-todolist\').dialog(\'close\')')); ?>
</div>
<?php $this->endWidget(); ?>
