...
<tr id="tr_<?php echo $modDiagnosa->diagnosa_id; ?>">
    ...
    <td>
        <?php
            echo CHtml::link("<span class='icon-form-silang'>&nbsp;</span>",'',array("rel"=>"tooltip","title"=>"Klik untuk Batal Diagnosa",'href'=>'','onclick'=>'cekHapus(this,'.$modDiagnosa->diagnosa_id.');return false;','style'=>'text-decoration:none;'));
        ?>
    </td>
</tr>