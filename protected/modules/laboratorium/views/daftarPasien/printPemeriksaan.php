            ...
            <td>
                <div class="content">
                    ...
                    <table class="table border">
                        ...
                        <?php if (count((array)$modPeriksa) > 0) {
                            foreach ($modPeriksa as $tin) {
                    ...
                    <table class="table border">
                        <tr>
                            <th width="33%">Jenis Sampel</th>
                            <th width="33%">No. Sampel</th>
                            <th width="33%">Jumlah</th>
                        </tr>
                        <?php if (count($modSample) > 0) {
                            foreach ($modSample as $sam) {
                                
                                
                                //if (!empty($sam->kirimsamplelab_id)) { ?>
                                    <tr>
                    ...
                    <table style="color:#333;padding:10px;text-align: left;" width="100%">
                        <tr>
                            ...
                            <td>
                                <ol>
                                    <?php if (count((array)$modSample) > 0) {
                                        foreach ($modSample as $sam) {
                                            if (!empty($sam->kirimsamplelab->keterangan_kirim)) { ?>
                                                <li><?php echo $sam->kirimsamplelab->keterangan_kirim ?></li>
                                    <?php }
                                        }
                                    } ?>
                                    <ol>
