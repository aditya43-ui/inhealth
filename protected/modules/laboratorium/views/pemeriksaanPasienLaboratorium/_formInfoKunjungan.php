<div class="col-sm-6">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            ...
            $this->widget('MyJuiAutoComplete', array(
                ...
                'htmlOptions' => array(
                    'placeholder' => 'No. Masuk Penunjang', 'class' => 'all-caps span4', 'rel' => 'tooltip', 'title' => 'No. masuk penunjang / klik icon untuk mencari data kunjungan',
                    'onkeyup' => "return $(this).focusNextInputField(event)",
                ),
            ));
            ?>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <?php echo CHtml::textField(
                'tglmasukpenunjang',
                $modKunjungan->tglmasukpenunjang,
                array('readonly' => true, 'class' => 'span4', 'onkeyup' => "return $(this).focusNextInputField(event);")
            ); ?>
        </div>
    </div>
    <div class="control-group">
        ...
        <div class="controls">
            ...
            <?php echo CHtml::textField(
                'instalasiasal_nama',
                $modKunjungan->instalasiasal_nama,
                array('readonly' => true, 'class' => 'span4', 'onkeyup' => "return $(this).focusNextInputField(event);")
            ); ?>
        </div>
    </div>
    ...
    <div class="control-group" hidden>
        ...
        <div class="controls">
            ...
            <?php echo CHtml::textField(
                'kelaspelayanan_nama',
                $modKunjungan->kelaspelayanan_nama,
                array('readonly' => true, 'class' => 'span4', 'onkeyup' => "return $(this).focusNextInputField(event);")
            ); ?>
        </div>
    </div>
    <div class="control-group">
        ...
        <div class="controls">
            ...
            <?php echo CHtml::textField(
                ...
                $modKunjungan->jeniskasuspenyakit_nama,
                array('readonly' => true, 'class' => 'span4', 'onkeyup' => "return $(this).focusNextInputField(event);")
            );
            ?>
        </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            ...
            $this->widget('MyJuiAutoComplete', array(
                ...
                'htmlOptions' => array(
                    'class' => 'span4', 'placeholder' => 'Nama Pasien', 'rel' => 'tooltip', 'title' => 'Ketik nama pasien untuk mencari data kunjungan',
                    'onkeyup' => "return $(this).focusNextInputField(event)",
                ),
            ));
            ?>
