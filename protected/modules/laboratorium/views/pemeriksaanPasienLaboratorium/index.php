        ...
        <div class="panel panel-gradient">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="glyphicon glyphicon-file"></i> Pemeriksaan <b>Pasien Laboratorium</b>
                </div>
            </div>
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
						...
						<div class="panel panel-success">
							<div class="panel-heading">
								<div class="panel-title">Rujukan Keluar <?php echo CHtml::htmlButton("<i class='icon icon-white icon-plus'></i>", array('id'=>'btn_add_rujukan_keluar','onclick' => 'addRowRujukan(this);return false;', 'rel' => 'tooltip', 'title' => 'Klik untuk rujukan keluar', 'class' => 'btn btn-primary')); ?></div>
							</div>
							<div class="panel-body">
                            ...
                            <table class="table table-bordered table-condensed table-striped">
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo CHtml::textField('totaltarif', 0, array('class'=>'span2 integer', 'readonly'=>true)) ?>
                                        </td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                ...
                <div class="form-actions">
                    <?php
                    //						if (isset($_GET['sukses'])){	
                    //							echo CHtml::htmlButton(Yii::t('mds', '{icon} Save', array('{icon}' => '<i class="'.MyIcon::getIcons('simpan').'"></i>')), array('class' => 'btn btn-danger', 'type' => 'button', 'onkeypress' => 'formSubmit(this,event);','disabled'=>true));
                    //						}else{
                    ...
                    if (isset($_GET['sukses'])) {
                        echo CHtml::link(Yii::t('mds', '{icon} Print Status', array('{icon}' => '<i class="' . MyIcon::getIcons('cetak') . '"></i>')), 'javascript:void(0);', array('class' => 'btn btn-info', 'onclick' => "printStatus();return false"));
                    } else {
                        echo CHtml::link(Yii::t('mds', '{icon} Print Status', array('{icon}' => '<i class="' . MyIcon::getIcons('cetak') . '"></i>')), 'javascript:void(0);', array('class' => 'btn btn-info', 'disabled' => true));
                    }
