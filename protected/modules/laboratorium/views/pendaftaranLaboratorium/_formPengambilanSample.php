<div>
    ...
    <?php echo $form->textFieldRow($modPengambilanSample, '[' . $i . ']jmlpengambilansample', array('placeholder' => 'Jumlah Sampel', 'class' => 'integer', 'onkeyup' => "return $(this).focusNextInputField(event)")); ?>
    <div class='control-group'>
        <?php echo $form->labelEx($modPengambilanSample, '[' . $i . ']tempatsimpansample', array('placeholder' => 'Tempat Simpan Sampel', 'class' => 'control-label')); ?>
        <div class='controls'>
            <?php echo $form->textField($modPengambilanSample, '[' . $i . ']tempatsimpansample', array('placeholder' => 'Tempat Simpan Sampel', 'onkeyup' => "return $(this).focusNextInputField(event)")); ?>
        </div>
    </div>
    <?php echo $form->textAreaRow($modPengambilanSample, '[' . $i . ']keterangansample', array('placeholder' => 'Keterangan', 'onkeyup' => "return $(this).focusNextInputField(event)")); ?>
