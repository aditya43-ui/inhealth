...
<?php echo $form->textFieldRow($modPenanggungJawab,'nama_pj', array('placeholder'=>'Nama Lengkap Penanggung Jawab','class'=>'span3 '. $nama_kapital,'onkeyup'=>"return $(this).focusNextInputField(event)")); ?>
...
//                                            'dateFormat'=>Params::DATE_FORMAT,
                                ...
                                'htmlOptions'=>array('placeholder'=>'00/00/0000','class'=>'span3 dtPicker2 datemask', 'onblur'=>'setUmurPjp(this.value);','onkeyup'=>"return $(this).focusNextInputField(event)"
                                ),
        )); ?>
...
<?php echo $form->textFieldRow($modPenanggungJawab,'no_mobilepj', array('placeholder'=>'No. Handphone Penanggung Jawab','onkeyup'=>"return $(this).focusNextInputField(event)", 'class'=>'numbers-only span3')); ?>
<?php echo $form->textFieldRow($modPenanggungJawab,'no_teleponpj', array('placeholder'=>'No. Telepon Penanggung Jawab','onkeyup'=>"return $(this).focusNextInputField(event)", 'class'=>'numbers-only span3')); ?>