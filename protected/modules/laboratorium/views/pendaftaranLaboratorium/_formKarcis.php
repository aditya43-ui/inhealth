...
if(!empty($modKarcisAll) && count((array)$modKarcisAll) > 0){
        ...
        $karcis->harga_tariftindakan = $karcis->harga_tariftindakan;
				...
				echo '<td>'.CHtml::label($karcis->karcis_nama,$karcis->karcis_nama).'</td>
						<td style="text-align:right;">'.CHtml::activeTextField($karcis, '['.$i.']['.$ii.']harga_tariftindakan',array('readonly'=>true, 'class'=>'span1 integer-decimal', 'style'=>'width:96px;text-align:right;')).'</td>
