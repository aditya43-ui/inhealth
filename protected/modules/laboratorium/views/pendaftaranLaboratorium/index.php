...
<div class="panel panel-gradient">
    ...
    <div class="panel-body">
        ...
        <div class="panel panel-success" id="form-pasien" style="margin-top: 17px;">
            ...
            <div class="panel-body">
                <div class="row">
                    <?php $this->renderPartial($this->path_view_lab . '_formPasien', array('form' => $form, 'model' => $model, 'modPasien' => $modPasien, 'modPegawai' => $modPegawai, 'modPegawaiPJ' => $modPegawaiPJ)); ?>
...
<script>
    function printRincianPenunjangBelumBayar()
    {
        ...
        //if(instalasi_id && pendaftaran_id){
            window.open("<?php echo $this->createUrl('PrintRincianBelumBayar') ?>&pendaftaran_id="+pendaftaran_id,"",'location=_new, width=1024px');
        //}else{
