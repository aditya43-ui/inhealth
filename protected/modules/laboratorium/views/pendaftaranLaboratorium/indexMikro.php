...
$this->breadcrumbs = array(
    'Pendaftaran Laboratorium Mikrobiologi Klinik',
); ?>
...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            ...
            Pendaftaran Laboratorium <b>Mikrobiologi Klinik</b>
        </div>
    </div>
    <div class="panel-body">
        ...
        <div class="panel panel-success" id="form-pasien" style="margin-top: 17px;">
            <div class="panel-heading">
                <div class="panel-title">
                    ...
                    ?>
                    <span class='tombol'
                        style='display:none;'><?php echo CHtml::htmlButton('<i class="entypo-arrows-ccw"></i>', array('class' => 'btn btn-default btn-mini', 'onclick' => 'setPasienBaru();', 'onkeyup' => "return $(this).focusNextInputField(event)", 'rel' => 'tooltip', 'title' => 'Klik untuk kembali ke Pasien Baru')); ?></span>
                </div>
            </div>
            <div class="panel-body">
                <div class="row">
                    <?php $this->renderPartial($this->path_view_pendaftaran . '_formPasienMikro', array('form' => $form, 'model' => $model, 'modPasien' => $modPasien, 'modPegawai' => $modPegawai, 'modPegawaiPJ' => $modPegawaiPJ)); ?>
        ...
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-sm-6">
                        <?php echo $this->renderPartial($this->path_view . '_formPendaftaranMikro', array('form' => $form, 'model' => $model, 'modPasien' => $modPasien, 'modRujukan' => $modRujukan, 'modAsuransiPasien' => $modAsuransiPasien, 'modAsuransiPasienBadak' => $modAsuransiPasienBadak, 'modAsuransiPasienDepartemen' => $modAsuransiPasienDepartemen, 'modAsuransiPasienPekerja' => $modAsuransiPasienPekerja, 'modPegawai' => $modPegawai)); ?>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="row">
                    ...
                    $this->Widget('ext.bootstrap.widgets.BootAccordion', array(
                        ...
                        'content' => array(
                            'content-lab-' . $i => array(
                                'header' => '<b>Pemeriksaan Mikrobiologi Klinik</b>',
                                'isi' => $this->renderPartial($this->path_view . '_formPenunjangMikro', array(
                                    'form' => $form,
                                    'model' => $model,
                                    'i' => $i,
                                    'modPasienMasukPenunjang' => $modPasienMasukPenunjangs[$i],
        ...
        <div class="form-actions">
            ...
            if ($model->isNewRecord) {
                if(Yii::app()->user->getState('modul_id') == Params::MODUL_ID_PENDAFTARAN){
                    echo CHtml::htmlButton(Yii::t('mds', '{icon} Save', array('{icon}' => '<i class="entypo-check"></i>')), array('title' => 'Simpan', 'class' => 'btn btn-danger', 'type' => 'button', 'onclick' => 'setVerifikasiMikro();', 'onkeypress' => 'setVerifikasiMikro();')); //jika tanpa verifikasi >> formSubmit(this,event)
                }else{
        ...
        <?php $this->renderPartial($this->path_view . '_dialog', array('modKirimKeUnitLain'=>$modKirimUnitLain)); ?>
...
<?php $this->renderPartial($this->path_view . '_jsFunctionsMikro', array('model' => $model, 'modPasien' => $modPasien, 'modPenanggungJawab' => $modPenanggungJawab, 'modRujukan' => $modRujukan, 'modPasienMasukPenunjangs' => $modPasienMasukPenunjangs, 'modTindakan' => $modTindakan, 'modAsuransiPasien' => $modAsuransiPasien, 'modAsuransiPasienBadak' => $modAsuransiPasienBadak, 'modAsuransiPasienDepartemen' => $modAsuransiPasienDepartemen, 'modAsuransiPasienPekerja' => $modAsuransiPasienPekerja, 'modPegawai' => $modPegawai, 'modKirimUnitLain' => $modKirimUnitLain,)); ?>
        ...
        array(
            ...
            'value' => function($data) {
                ...
                return CHtml::Link('<i class="icon-form-check"></i>', "#", array("class" => "btn-small",
                            "onclick" => "inputBahan(this, " . $data->pemeriksaanlab_id. ", " . "'', " . "'ya'" . "); $('#dialogLab2').dialog('close'); return false;"));
            },
        ),
        array(
