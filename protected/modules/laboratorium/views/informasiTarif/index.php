<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="entypo-info-circled"></i> Informasi <b>Tarif Laboratorium</b>
        </div>
    </div>
    <div class="panel-body">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <?php echo $form->textFieldRow($modTarifLab, 'daftartindakan_nama', array('style' => 'width:204px', 'onkeypress' => "return $(this).focusNextInputField(event);", 'placeholder' => 'Nama Daftar Tindakan', 'maxlength' => 30)); ?>
                    </div>
                </div>
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="entypo-credit-card"></i> Tabel <b>Tarif Laboratorium</b>
                </div>
            </div>
                ...
                <!--<div class="block-tabel">
							...
							<table class="table table-striped table-condensed">
								...
								<tbody id="tabelDaftarPemeriksaanTotal">
									<tr>
										<td colspan="8"><p style="margin: 0; text-align: center;"><b>Total Pemeriksaan</b></p></td>
