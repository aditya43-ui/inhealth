...
<tr <?php if(!empty($modTindakan->tindakansudahbayar_id)){?> style="background-color: #00FF00 !important;" <?php } ?>>
    ...
    <?php if(Yii::app()->user->getState('instalasi_id') !== 25):?>
    <td>
     <span name="[ii][jenispemeriksaanlab_nama]"><?php echo $modTindakan->daftartindakan_nama ?? (!empty($modTindakan->daftartindakan_id) ? $modTindakan->daftartindakan->daftartindakan_nama : "-") ?></span>
    </td>
    <?php endif;?>
    <td <?php if(!empty($modTindakan->tindakansudahbayar_id)){?> style="background-color: #00FF00 !important;" <?php } ?>>
        <span name="[ii][pemeriksaanlab_nama]"><?php echo $modTindakan->daftartindakan_nama ?? (!empty($modTindakan->daftartindakan_id) ? $modTindakan->daftartindakan->daftartindakan_nama : "-") ?></span>
