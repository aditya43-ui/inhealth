...
class ModuleDashboardGJController extends ModuleDashboardNeonController
{
  ...
  {
    $this->pageTitle = Yii::app()->name . " - Dashboard Penggajian";
    $this->render('index');
  }
  ...
  public function actionSetIFrameDashboard()
  {
    ...
    $sql = "SELECT kabupaten_m.kabupaten_id, kabupaten_m.kabupaten_nama,kabupaten_m.longitude as longitude_kab,kabupaten_m.latitude as latitude_kab,kecamatan_m.kecamatan_id, kecamatan_m.kecamatan_nama, kecamatan_m.longitude, kecamatan_m.latitude, COUNT(pasien_m.pasien_id) AS jumlah
