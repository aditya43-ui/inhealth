...
<div class="panel panel-success">
    ...
    <div class="panel-body">
        ...
        $this->renderPartial('rekapPajakDokter/_search', array(
...
<div class="panel panel-success">
    ...
    <div class="panel-body table-responsive" id="div_rekap">
        <?php $this->renderPartial("rekapPajakDokter/_tableRekap", array('model' => $model)) ?>
    </div>
</div>
<div class="form-actions">
    ...
    $urlPrint = Yii::app()->createAbsoluteUrl($module . '/' . $controller . '/PrintLaporanRekapPajakDokter');
    $this->renderPartial('_footerWithoutgrafik', array('urlPrint' => $urlPrint, 'url' => $url, 'tips' => '10besarpenyakit', 'grafik' => 'none'));
    ?>
</div>
<?php
