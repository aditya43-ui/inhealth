...
$this->breadcrumbs = array(
    'Laporan Rekap Trend Penghasilan Setahun',
);
        ...
        <div class="panel panel-gradient">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="entypo-newspaper"></i> Laporan <b>Rekap Trend Penghasilan Setahun</b>
                </div>
            </div>
            <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="control-group">
                                    <?php echo CHtml::label("Tahun", 'tgl_rekam', array('class' => 'control-label')) ?>
                                    <div class="controls">
                                        <input type="number" min="1000" max="3000" name="GJRekaptrenpengahasilansetahunV[periodegaji]" value="<?php echo $model->periodegaji; ?>" class="span3">
                                    </div>
                                </div>
                ...
                <div class="panel panel-success">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <i class="entypo-credit-card"></i> Tabel <b>Rekap Trend Penghasilan Setahun</b>
                        </div>
                    </div>
                    <div class="panel-body table-responsive">
                        <?php $this->renderPartial($this->path_view_lap . 'rekapTrendPenghasilanTahun/_table', array('model' => $model)); ?>
                        <?php
                        $controller = Yii::app()->controller->id; //mengambil Controller yang sedang dipakai
                        $module = Yii::app()->controller->module->id; //mengambil Module yang sedang dipakai
                        $urlPrint =  Yii::app()->createAbsoluteUrl($module . '/' . $controller . '/PrintRekapTrendPenghasilanTahun');
                        $url = ""; //?
                        ?>
                    </div>
                </div>
