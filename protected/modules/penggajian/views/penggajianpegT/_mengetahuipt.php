...
<div class="row">
	...
	<div class="col-sm-4" style="text-align:center;">
			...
			if(isset($_GET['sukses'])){
				...
				if($model->mengetahuipt_id == Yii::app()->user->getState('pegawai_id')){
                                    echo CHtml::link(Yii::t('mds',' Mengetahui (PT)'), 
                                    $this->createUrl($this->id.'/index'), 
                                    array('class' => 'btn btn-danger',
                                            'onclick'=>'myConfirm("Apakah Anda yakin?","Perhatian!",
                                            function(r) {if(r) window.location = "'.$this->createUrl('ApproveMengetahuiPT',array('penggajianpeg_id'=>$model->penggajianpeg_id,'approve'=>true)).'";} ); return false;'));  
                                }
                                else{
                                    echo CHtml::link(Yii::t('mds',' Mengetahui (PT)'), 
                                    $this->createUrl($this->id.'/index'), 
...
<?php 
    ...
    $urlPrint= $this->createUrl('printApproveMengetahuiPT',array('penggajianpeg_id'=>$model->penggajianpeg_id));
