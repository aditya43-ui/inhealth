...
echo $this->renderPartial('application.views.headerReport.headerDefaultNewExcel',array('judulLaporan'=>$judulLaporan, 'colspan'=>45));  
$nama = "";
$tgl = "";
$namapt = "";
$tglpt = "";
...
//                $tbn1 = (($tbn*1)/100);
            ...
            ?>
                ...
                <tr>
                    ...
                    <td><?php echo empty($data->harikerja) ? "-" : $data->harikerja; ?></td>
                    <td><?php echo empty($data->harihadir) ? "-" : $data->harihadir; ?></td>
                    ...
                    <td class="num"><?php echo ($ps > 0)?0:1; ?></td>
