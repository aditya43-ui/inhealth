...
<div class="row">
	...
	<div class="col-sm-4" style="text-align:center;">
		<?php if (!empty($model->mengetahuipt)) { ?>
		<div class="control-group" style="margin-bottom: 57.5px;margin-top: 10px;">
			Mengetahui (PT),
		</div>
		<div class="control-group">
	...
	<div class="col-sm-4" style="text-align:center;">
		<div class="control-group" style="margin-bottom: 57.5px;margin-top: 10px;">
			...
			if(isset($_GET['sukses'])){
				...
				if($model->menyetujui_id == Yii::app()->user->getState('pegawai_id')){
                                    echo CHtml::link(Yii::t('mds',' Menyetujui'), 
                                    $this->createUrl($this->id.'/index'), 
                                    array('class' => 'btn btn-danger',
                                            'onclick'=>'myConfirm("Apakah Anda yakin?","Perhatian!",
                                            function(r) {if(r) window.location = "'.$this->createUrl('ApproveMenyetujui',array('penggajianpeg_id'=>$model->penggajianpeg_id,'approve'=>true)).'";} ); return false;'));  
                                }
                                else{
                                    echo CHtml::link(Yii::t('mds',' Menyetujui'), 
                                    $this->createUrl($this->id.'/index'), 
                                    array('class' => 'btn btn-danger',
                                            'onclick'=>'myAlert("Maaf, Anda tidak berhak Menyetujui Pengajuan Gaji ini?"); return false;'));  
                                }   
				echo "&nbsp";
...
<?php 
    ...
    $urlPrint= $this->createUrl('printApproveMenyetujui',array('penggajianpeg_id'=>$model->penggajianpeg_id));
