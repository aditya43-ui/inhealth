    ...
    <tr>
        <td>
            <table style="width: 100%; border: none;">
                <tr>
                    <td width="11%" style="text-align:right;">NIP</td>
                    <td width="2%">:</td>
                    <td width="37%">
                        <?php echo CHtml::encode($modelpegawai->nomorindukpegawai); ?>
                    </td>
                    <td width="11%" style="text-align:right;">No. Rekening</td>
                    <td width="2%">:</td>
                    <td width="37%">
                ...
                <tr>
                    <td width="11%" style="text-align:right;">Pegawai</td>
                    <td width="2%">:</td>
                    <td width="37%">
                        <?php
                    ...
                    <td width="11%" style="text-align:right;">Bank</td>
                    <td width="2%">:</td>
                    <td width="37%">
                        <?php
                ...
                <tr>
                    <td width="11%" style="text-align:right;">Tempat Lahir</td>
                    <td width="2%">:</td>
                    <td width="37%">
                        <?php echo CHtml::encode($modelpegawai->tempatlahir_pegawai); ?>
                    </td>
                    <td width="11%" style="text-align:right;">No. Telepon</td>
                    <td width="2%">:</td>
                    <td width="37%">
                ...
                <tr>
                    <td width="11%" style="text-align:right;">Tanggal Lahir</td>
                    <td width="2%">:</td>
                    <td width="37%">
                        <?php
                    ...
                    <td width="11%" style="text-align:right;">No. Handphone</td>
                    <td width="2%">:</td>
                    <td width="37%">
                        <?php
                ...
                <tr>
                    <td width="11%" style="text-align:right;">Jenis Kelamin </td>
                    <td width="2%">:</td>
                    <td width="37%">
                        <?php echo CHtml::encode($modelpegawai->jeniskelamin); ?>
                    </td>
                    <td width="11%" style="text-align:right;">Agama</td>
                    <td width="2%">:</td>
                    <td width="37%">
                ...
                <tr>
                    <td width="11%" style="text-align:right;">Tanggal Penggajian </td>
                    <td width="2%">:</td>
                    <td width="37%">
                        <?php echo CHtml::encode($model->tglpenggajian); ?>
                    </td>
                    <td width="11%" style="text-align:right;">Alamat </td>
                    <td width="2%">:</td>
                    <td width="37%">
                ...
                <tr>
                    <td width="11%" style="text-align:right;">No. Penggajian </td>
                    <td width="2%">:</td>
                    <td width="37%">
                ...
                <tr>
                    <td width="11%" style="text-align:right;">Keterangan </td>
                    <td width="2%">:</td>
                    <td width="37%">
