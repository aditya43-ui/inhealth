<?php
    ...
    foreach($model as $key=>$detail)
    {
		...
		if($detail->debitkredit == 'D'){
			$status = 'debit';
		}else if($detail->debitkredit == 'K'){
			$status = 'kredit';
		}
        ...
        echo('<tr>');
            ...
            echo '<td>';
                ...
                echo CHtml::textField("RekeningakuntansiV[$key][saldodebit]", 
                    0,
                    array(
                        'class'=>'inputFormTabel integer2 span2'.($status == 'debit' ? " saldodebitpph21" : ""),
            ...
            echo '<td>';
                echo CHtml::textField("RekeningakuntansiV[$key][saldokredit]",
                    0,
                    array(
                        'class'=>'inputFormTabel integer2 span2'.($status == 'kredit' ? " saldokreditpph21" : ""),
