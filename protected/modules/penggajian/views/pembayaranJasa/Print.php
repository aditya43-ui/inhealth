        ...
        <td width="50%" valign="top">
            <table style="width: 100%; border: none;">
                ...
                <tr>
                    ...
                    <td style="width: 100%">: <?php echo $model->kode_objekpajak; ?></td>
                </tr>
            </table>
        </td>
        <td width="50%">
            <table width="50%">
                ...
                <tr>		
                    ...
                    <td>: Rp <?php echo (!empty($model->totaladjsument)? MyFormatter::formatNumberForPrint($model->totaladjsument,2) : 0) ?></td>
                </tr>
                <tr>		
                    <td>Total Pajak Progresif</td>
                    <td>: Rp <?php echo MyFormatter::formatNumberForPrint($model->total_pajak,2) ?></td>
                </tr>
                <tr>		
                    <td>Total Pengajuan Jasa</td>
                    <td>: Rp <?php echo MyFormatter::formatNumberForPrint($model->totalbayarjasa) ?></td>
                </tr>
            </table>
        </td>
    </tr>
...
<!--<table width="100%" style="font-weight: bold">
        ...
        <tr>
            <td></td>
            <td>Total Tarif</td>
            <td>: <?php // echo MyFormatter::formatNumberForPrint($model->totaltarif)?></td>
        </tr>
        <tr>
            <td></td>
            <td>Total Jasa</td>
            <td>: <?php // echo MyFormatter::formatNumberForPrint($model->totaljasa)?></td>
        </tr>
        <tr>
            <td></td>
            <td>Total Pajak Progresif</td>
            <td>: <?php // echo MyFormatter::formatNumberForPrint($model->total_pajak)?></td>
        </tr>
        <tr>
            <td></td>
            <td>Total Pengajuan Jasa</td>
...
//            ));
        ...
        <tr>
            ...
            <td>: <?php // echo MyFormatter::formatNumberForPrint($model->totalsisajasa)?></td>
        </tr>
        <?php // endif; ?>
    </table>-->
    <?php }?>
