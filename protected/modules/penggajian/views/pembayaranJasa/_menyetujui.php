...
<div class="row">
    ...
    <div class="col-sm-4" style="text-align:center;">
			...
			if(isset($_GET['sukses'])){
				...
				echo "Direktur PT,<br> Menyetujui";
			}else{
				...
				array('class' => 'btn btn-danger',
					...
					function(r) {if(r) window.location = "'.$this->createUrl('Menyetujui',array('pembayaranjasa_id'=>$model->pembayaranjasa_id,'approve'=>true)).'";} ); return false;'));  
			}
			?>
		</div>	
		<div class="control-group">
...
<?php 
    ...
    $urlPrint= $this->createUrl('printMenyetujui',array('pembayaranjasa_id'=>$model->pembayaranjasa_id));
