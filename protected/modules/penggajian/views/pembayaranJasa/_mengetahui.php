		...
		array(
                ...
                array(
                    ...
                    'value'=>function($data) {
                        ...
                        $tgl = $bayar ? $bayar->tglpembayaran : date('Y-m-d');
                        return MyFormatter::formatDateTimeForUser(date("Y-m-d",strtotime($tgl)));
...
<div class="row">
    <div class="col-sm-4" style="text-align:center;">
			...
			if(isset($_GET['sukses'])){
				...
				echo "Direktur RS,<br> Mengetahui";
			}else{
				...
				array('class' => 'btn btn-danger',
					...
					function(r) {if(r) window.location = "'.$this->createUrl('Mengetahui',array('pembayaranjasa_id'=>$model->pembayaranjasa_id,'approve'=>true)).'";} ); return false;'));  
			}
			?>
		</div>	
    ...
    <div class="col-sm-4" style="text-align:center;">
		...
		<div class="control-group">
			<!--( <?php // echo isset($model->tgl_mengetahuipt)?$model->mengetahuipt->NamaLengkap:"";?> )-->
		</div>
	</div>
...
<?php 
    ...
    $urlPrint= $this->createUrl('printMengetahui',array('pembayaranjasa_id'=>$model->pembayaranjasa_id));
