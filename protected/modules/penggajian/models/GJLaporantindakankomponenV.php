<?php
class GJLaporantindakankomponenV extends LaporantindakankomponenV
{
	...
	public function getSumKomponen($groups = array(), $nama_kolom = null){
		if(isset($_GET['GJLaporantindakankomponenV']['komponentarif_id'])){
			$komponentarif_id = $_GET['GJLaporantindakankomponenV']['komponentarif_id'];
		}
...
//            }
		...
		if(isset($_GET['GJLaporantindakankomponenV'])){
			$tgl_awal = $format->formatDateTimeForDb($_GET['GJLaporantindakankomponenV']['tgl_awal']);
			$tgl_akhir = $format->formatDateTimeForDb($_GET['GJLaporantindakankomponenV']['tgl_akhir']);
