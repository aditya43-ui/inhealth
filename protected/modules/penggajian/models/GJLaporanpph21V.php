...
class GJLaporanpph21V extends Laporanpph21V
{
	...
	public function criteriaSearch()
	{
		...
		$criteria=new CDbCriteria;
                ...
                $criteria->addCondition("DATE(tglpenggajian) = '".$this->tglpenggajian."'");
//		$criteria->addBetweenCondition('DATE(tglpenggajian)', $this->tglpenggajian, $this->tglpenggajian);
		...
		$criteria->compare('LOWER(kelompokpegawai_nama)',strtolower($this->kelompokpegawai_nama),true);
                if(!empty($this->kategoripegawai)){
                    $criteria->addInCondition('kategoripegawai', $this->kategoripegawai);
                }
