...
class GJRegistrasifingerprint extends PegawaiM
{
        ...
        public function search()
	{
		...
		$criteria->compare('LOWER(photopegawai)',strtolower($this->photopegawai),true);
                ...
                if($this->pegawai_aktif == 'aktif'){
                    $this->pegawai_aktif = 1;
                }else if($this->pegawai_aktif == 'tidak aktif'){
                    $this->pegawai_aktif = 0;
                }
        ...
        public function searchPegawaiResign()
	{
		// Warning: Please modify the following code to remove attributes that
		// should not be searched.
		...
		$criteria->join = "LEFT JOIN jabatan_m ON jabatan_m.jabatan_id = t.jabatan_id 
                                                   JOIN resign_t ON resign_t.pegawai_id = t.pegawai_id";
