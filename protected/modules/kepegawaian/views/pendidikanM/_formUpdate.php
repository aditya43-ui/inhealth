...
<div class="row">
    ...
    <div class="col-sm-6">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $form->checkBox($model, 'pendidikan_aktif'); ?>
                <label for="KPPendidikanM_pendidikan_aktif">Aktif</label>
            </div>
        </div>
    </div>
</div>
<div class="form-actions">
    ...
    ?>
    <?php
    echo CHtml::link(Yii::t('mds', '{icon} Reset', array('{icon}' => '<i class="entypo-arrows-ccw"></i>')), Yii::app()->createUrl($this->module->id . '/pendidikanM/admin'), array(
