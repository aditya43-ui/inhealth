...
<div class="row">
    ...
    <div class="col-sm-6">
        <?php echo $form->textFieldRow($model, 'nilai_angkamin', array('placeholder' => 'Nilai Min', 'class' => 'span3 integer', 'onkeypress' => "return $(this).focusNextInputField(event);")); ?>
        <?php echo $form->textFieldRow($model, 'nilai_angkamaks', array('placeholder' => 'Nilai Maks', 'class' => 'span3 integer', 'onkeypress' => "return $(this).focusNextInputField(event);")); ?>
    </div>
    <div class="col-sm-6">
