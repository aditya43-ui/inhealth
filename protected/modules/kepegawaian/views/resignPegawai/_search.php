...
<div class="row">
    ...
    <div class="col-sm-6">
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $form->dropDownList($model, 'jabatan_baru', Chtml::listData(JabatanM::model()->findAll("jabatan_aktif = TRUE ORDER BY jabatan_nama ASC"), 'jabatan_nama', 'jabatan_nama'), array('class' => 'span4', 'empty' => '-- Pilih --')) ?>
            </div>
        </div>
        <div class="control-group">
            <?php echo Chtml::label("Unit Asal", 'unitkerja', array('class' => 'control-label')) ?>
            <div class="controls">
                <?php echo $form->dropDownList($model, 'unitkerja', Chtml::listData($model->getRuanganItems(), 'ruangan_nama', 'ruangan_nama'), array('class' => 'span4', 'empty' => '-- Pilih --')) ?>
            </div>
        </div>
        <div class="control-group">
            <?php echo Chtml::label("Unit baru", 'unitkerja_baru', array('class' => 'control-label')) ?>
            <div class="controls">
                <?php echo $form->dropDownList($model, 'unitkerja_baru', Chtml::listData($model->getRuanganItems(), 'ruangan_nama', 'ruangan_nama'), array('class' => 'span4', 'empty' => '-- Pilih --')) ?>
            </div>
        </div>
    </div>
</div>
