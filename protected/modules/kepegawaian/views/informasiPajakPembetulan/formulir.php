    ...
    <tr>
        <td colspan="3" style="border: 1px solid #000;">
            ...
            <table width="100%" class="anak">
                <tr>
                    <td width="20%"><b>NPWP PEMOTONG</b></td>
                    <td style="vertical-align: bottom;">: <?php echo $profil->npwp_pt; ?></td>
                </tr>
                <tr>
                    <td width="20%"><b>NAMA PEMOTONG</b></td>
                    <td style="vertical-align: bottom;">: <?php echo $profil->nama_pt; ?></td>
                </tr>
            </table>
    ...
    <tr>
        <td colspan="3" style="border: 1px solid #000;">
            ...
            <table style="width: 100%; border: none;">
                <tr>
                    <td width="15%"><b>1.NPWP</b></td>
                    <td width="35%">: <?php echo $modelpeg->pegawai->npwp; ?></td>
                    
                    <td colspan="2"><b>6.STATUS / JUMLAH TANGGUNGAN KELUARGA UNTUK PTKP</b> :</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td><b>4.ALAMAT</b></td>
                    <td>: <?php echo $modelpeg->pegawai->alamatnpwp; ?></td>
...
$urlPrint= $this->createUrl('formulirPrint',array('tahun'=>$tahunPajak, 'pegawai_id'=>$modelpeg->pegawai_id,'penggajianpeg_id'=>$penggajianpeg_id));
$js = <<< JSCRIPT
...
<script type="text/javascript">
    function loadPenghasilan(){
        ...
        $.ajax({
	        ...
	        data: { pegawai_id:pegawai_id, tahun:tahun, masa_1:masa_1, masa_2:masa_2},
	        dataType: "json",
