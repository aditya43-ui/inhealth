<?php $linkHalaman = CustomFunction::getUrlByMenuID(1176); ?>
    ...
    <div class="panel panel-gradient">
        <div class="panel-heading">
            <div class="panel-title">
                <i class="glyphicon glyphicon-briefcase"></i> Mutasi <b>Pegawai</b>
        ...
        <div class="panel-body">
            ...
            <div class="panel panel-success">
                <div class="panel-heading">
                    <div class="panel-title">
                        <i class="entypo-user"></i> Mutasi Pegawai
                    </div>
                </div>
                <div class="panel-body">
                    ...
                    <fieldset class="box" id="tablePegawaimutasi">
                        <div class="row">
                            <div class="col-sm-6">
                                <?php echo $form->textFieldRow($modPegmutasi, 'nomorsurat', array('placeholder' => 'Nomor Surat', 'class' => 'span3', 'onkeypress' => 'return $(this).focusNextInputField(event)')) ?>
                            ...
                            <div class="col-sm-6">
                                ...
                                <?php echo $form->textFieldRow($modPegmutasi, 'lokasikerja_baru', array('placeholder' => 'Lokasi Kerja Baru', 'class' => 'span3', 'onkeypress' => 'return $(this).focusNextInputField(event)')) ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <?php echo $form->fileField($modPegmutasi,'dokumen', array('class'=>'span3')); ?>
                                    </div>
                                </div>     
                            </div>
                        </div>
