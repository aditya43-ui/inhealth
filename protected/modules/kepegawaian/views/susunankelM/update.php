...
$this->breadcrumbs=array(
	...
	$model->susunankel_id=>array('view','id'=>$model->susunankel_id),
	'Update',
);

$arrMenu = array();
                array_push($arrMenu,array('label'=>Yii::t('mds','Update').' Susunan Keluarga ', 'header'=>true, 'itemOptions'=>array('class'=>'heading-master'))) ;
...
//                array_push($arrMenu,array('label'=>Yii::t('mds','View').' Susunan Keluarga ', 'icon'=>'eye-open', 'url'=>array('view','id'=>$model->susunankel_id))) ;
