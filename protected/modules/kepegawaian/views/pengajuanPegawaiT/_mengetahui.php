	...
	<div class="col-sm-6" style="text-align:center;">
			...
			if(isset($_GET['sukses'])){
				...
				array('class' => 'btn btn-danger',
					...
					function(r) {if(r) window.location = "'.$this->createUrl('ApproveMengetahui',array('pengajuanpegawai_id'=>$model->pengajuanpegawai_t_id,'approve'=>true)).'";} ); return false;'));  
			}
			?>
		</div>	
...
<?php 
    ...
    $urlPrint= $this->createUrl('printApproveMengetahui',array('pengajuanpegawai_id'=>$model->pengajuanpegawai_t_id));
