<?php $linkHalaman = CustomFunction::getUrlByMenuID(952); ?>
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="entypo-info-circled"></i> Informasi <b>Rencana Penerimaan Pegawai</b>
    ...
    <div class="panel-body">
        ...
        $this->breadcrumbs = array(
            'Informasi Rencana Penerimaan Pegawai',
        );
    ...
    ");
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="entypo-credit-card"></i> Tabel <b>Rencana Penerimaan Pegawai</b>
                </div>
            </div>
