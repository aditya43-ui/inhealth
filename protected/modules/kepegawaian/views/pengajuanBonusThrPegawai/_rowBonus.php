<tr>
    ...
    <td>
        <?php echo CHtml::textField("detailpengajuan[".$detail->pegawai_id."][nilaibonus]",0,array('class'=>'span2 integer-decimal','onblur'=>'generateFormatNumber()')) ?>
    </td>
    <td>
        <?php echo CHtml::textField("detailpengajuan[".$detail->pegawai_id."][tunjangan_pph_21_bonus]",0,array('class'=>'span2 integer-decimal','onblur'=>'generateFormatNumber()')) ?>
    </td>
    <td>
        <?php echo CHtml::textField("detailpengajuan[".$detail->pegawai_id."][pajakbonus]",0,array('class'=>'span2 integer-decimal','onblur'=>'generateFormatNumber()')) ?>
    </td>
    <td>
        <?php echo CHtml::textField("detailpengajuan[".$detail->pegawai_id."][keteranganbonus]","",array('class'=>'span3')) ?>
    </td>
</tr>
