...
<table width="100%" border="1" style="font-size: 12px;">
    <tr><td colspan="7" align="center" style="font-size: 24px;">Data Pelamar</td></tr>
				...
				echo "<div class='<div class='control-group' style='margin-bottom: 50px;'>";
                                if($model->menyetujui_id == Yii::app()->user->getState('pegawai_id')){
                                    ...
                                    array('class' => 'btn btn-danger',
                                            'onclick'=>'myConfirm("Apakah Anda yakin akan Menyetujui Pelamar ini?","Perhatian!",
                                            function(r) {if(r) window.location = "'.$this->createUrl('ApproveMenyetujui',array('pelamar_id'=>$model->pelamar_id,'approve'=>true)).'";} ); return false;'));  
                                }
                                else{
                                    echo CHtml::link(Yii::t('mds',' Menyetujui'), 
                                    $this->createUrl($this->id.'/index'), 
                                    array('class' => 'btn btn-danger',
                                            'onclick'=>'myAlert("Maaf, Anda tidak berhak Menyetujui Pelamar ini?"); return false;'));  
                                }
