...
<div class="row">
    ...
    <div class="col-sm-6">
        <?php echo $form->textAreaRow($modKesimpulan, 'kesimpulan', array('placeholder' => 'Kesimpulan', 'rows' => 3, 'cols' => 50, 'class' => 'span4', 'onkeyup' => "return $(this).focusNextInputField(event);")); ?>
        <?php echo $form->textAreaRow($modKesimpulan, 'saran', array('placeholder' => 'Saran', 'rows' => 3, 'cols' => 50, 'class' => 'span4', 'onkeyup' => "return $(this).focusNextInputField(event);")); ?>
    </div>
</div>
