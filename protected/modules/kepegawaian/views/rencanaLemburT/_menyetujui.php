	...
	<div class="col-sm-6" style="text-align:center;">
			...
			if(isset($_GET['sukses'])){
				...
				array('class' => 'btn btn-danger',
					...
					function(r) {if(r) window.location = "'.$this->createUrl('ApproveMenyetujui',array('rencanalembur_id'=>$model->rencanalembur_id,'approve'=>true)).'";} ); return false;'));  
			}
			?>
		</div>	
...
<?php 
    ...
    $urlPrint= $this->createUrl('PrintApproveMenyetujui',array('rencanalembur_id'=>$model->rencanalembur_id));
