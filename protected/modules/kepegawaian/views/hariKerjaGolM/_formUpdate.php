...
<div class="row">
    ...
    <div class="col-sm-6">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $form->checkBox($model, 'harikerjagol_aktif', array('onkeypress' => "return $(this).focusNextInputField(event);")); ?>
                <label for="KPHariKerjaGolM_harikerjagol_aktif">Aktif</label>
            </div>
        </div>
    </div>
</div>
