...
echo $this->renderPartial('application.views.headerReport.headerLaporan',array('judulLaporan'=>'<h3>Rencana Pelatihan '.$tipe->jenisdiklat_nama.'</h3>', 'colspan'=>10));
?>
...
<table width="100%" class="tab_header">
	<tr>
		<td>No. Rencana</td>
		<td>:</td>
		<td width="100%"><?php echo $model->norencanadiklat; ?></td>
		<td nowrap>Tgl. Rencana</td>
		<td>:</td>
		<td nowrap><?php echo date('d M Y', strtotime($model->tglrencanadiklat)); ?></td>
	</tr>
	<tr>
		<td>Nama Pelatihan</td>
		<td>:</td>
		<td><?php echo $model->namadiklat; ?></td>
	...
	<tr>
		...
		<td>:</td>
		<td><?php echo $model->tempat_diklat; ?></td>
		<td>Tanggal</td>
		<td>:</td>
		<td nowrap><?php echo date('d M Y', strtotime($model->rencanadiklat_periode)).' - '.
				date('d M Y', strtotime($model->rencanadiklat_sampaidgn)); ?></td>
	</tr>
	...
	<tr>
		...
		<td>:</td>
		<td><?php echo $model->alamat_diklat; ?></td>
		<td>Jam</td>
		<td>:</td>
