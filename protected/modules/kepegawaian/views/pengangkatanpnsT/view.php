...
$arrMenu = array();
                array_push($arrMenu,array('label'=>Yii::t('mds','View').' Pengangkatan PNS', 'header'=>true, 'itemOptions'=>array('class'=>'heading-master'))) ;
...
//                array_push($arrMenu,array('label'=>Yii::t('mds','Delete').' KPPengangkatanpnsT','icon'=>'trash','url'=>'#','linkOptions'=>array('submit'=>array('delete','id'=>$model->pengangkatanpns_id),'confirm'=>Yii::t('mds','Are you sure you want to delete this item?')))) ;
                (Yii::app()->user->checkAccess(Params::DEFAULT_ADMIN)) ?array_push($arrMenu,array('label'=>Yii::t('mds','Manage').' Pengangkatan PNS', 'icon'=>'folder-open', 'url'=>array('admin'))) :  '' ;
