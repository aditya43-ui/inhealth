...
<script type="text/javascript">
	...
	$(document).ready(function() {
        ...
        var asal = jQuery('#<?php echo CHtml::activeId($model, 'asal') ?>');	
        var kelaspelayanan_id = jQuery('#<?php echo CHtml::activeId($model, 'kelaspelayanan_id') ?>');	
        var shift_id = jQuery('#<?php echo CHtml::activeId($model, 'shift_id') ?>');	
        var jenisrekonsiliasibank_id = jQuery('#<?php echo CHtml::activeId($model, 'jenisrekonsiliasibank_id') ?>');	
        var bank_id = jQuery('#<?php echo CHtml::activeId($model, 'bank_id') ?>');	
        var jenisjurnal_id = jQuery('#<?php echo CHtml::activeId($model, 'jenisjurnal_id') ?>');	
...
//        }).hide();
        ...
        jQuery(kelaspelayanan_id).multiselect({
                includeSelectAllOption: true,
                buttonClass: "form-control",
                maxHeight: 300,
                buttonWidth: '182px',
        ...
        jQuery(jenisrekonsiliasibank_id).multiselect({
                includeSelectAllOption: true,
                buttonClass: "form-control",
                maxHeight: 300,
                buttonWidth: '182px',
        ...
        jQuery(jenisjurnal_id).multiselect({
                includeSelectAllOption: true,
                buttonClass: "form-control",
                maxHeight: 300,
                buttonWidth: '182px',
