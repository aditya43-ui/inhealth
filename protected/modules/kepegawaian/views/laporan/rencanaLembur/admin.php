...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="entypo-newspaper"></i> Laporan <b>Rencana Lembur</b>
        </div>
    </div>
    <div class="panel-body">
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                ...
                <?php $this->renderPartial($this->path_view . 'rencanaLembur._search', array(
                    'model' => $model,
                )); ?>
                <!--</fieldset>-->
                <!--search-form-->
        ...
        <div class="panel panel-success">
            ...
            <div class="panel-body table-responsive">
                <div class="block-tabel">
                    <?php $this->renderPartial($this->path_view . 'rencanaLembur._table', array('model' => $model)); ?>
                </div>
            </div>
        </div>
        <?php /*
        ...
        $urlPrint =  Yii::app()->createAbsoluteUrl($module . '/' . $controller . '/printRencanaLembur');
        $url = Yii::app()->createUrl($module . '/' . $controller . '/FrameGrafikRencanaLembur&id=1');
