...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="entypo-newspaper"></i> Laporan <b>Realisasi Diklat</b>
        </div>
    </div>
    <div class="panel-body">
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                ...
                <?php $this->renderPartial($this->path_view . 'realisasiDiklat._search', array(
                    'model' => $model,
                )); ?>
                <!--</fieldset>-->
                <!--search-form-->
        ...
        <div class="panel panel-success" id='diklateksternal'>
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="entypo-credit-card"></i> Tabel <b>Realisasi Diklat Eksternal</b>
                </div>
            </div>
            <div class="panel-body table-responsive">
                <?php $this->renderPartial($this->path_view . 'realisasiDiklat._tableEksternal', array('model' => $model)); ?>
            </div>
        </div>
        <div class="panel panel-success" id='diklatinternal'>
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="entypo-credit-card"></i> Tabel <b>Realisasi Diklat Internal</b>
                </div>
            </div>
            <div class="panel-body table-responsive">
                <?php $this->renderPartial($this->path_view . 'realisasiDiklat._tableInternal', array('modInternal' => $modInternal)); ?>
            </div>
        </div>
        <?php /*
					<div class="panel panel-success">
        ...
        $urlPrint =  Yii::app()->createAbsoluteUrl($module . '/' . $controller . '/printRealisasiDiklat');
        $url = Yii::app()->createUrl($module . '/' . $controller . '/FrameGrafikRealisasiDiklat&id=1');
