...
<table>
    ...
    <tr>
		...
		<div class="control-group">		
			<?php echo CHtml::label("",'golonganpegawai_aktif', array('class' => 'control-label')) ?>
			<div class="controls">
                <?php echo $form->checkBox($model,'golonganpegawai_aktif', array('onkeypress'=>"return $(this).focusNextInputField(event);")); ?> <label>Aktif</label>
            </div>
		</div>
        </td>
    </tr>
