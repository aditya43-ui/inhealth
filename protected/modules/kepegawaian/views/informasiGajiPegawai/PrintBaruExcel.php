...
if($caraPrint=='EXCEL')
	...
	if ($caraPrint != 'PDF'){
		echo "<div id='headers'>";
		echo $this->renderPartial('application.views.headerReport.headerLaporanTransaksiExcel',array('judulLaporan'=>"<b>SLIP GAJI - ".strtoupper($date).'</b>',  'periode'=> '', 'colspan'=>10));  
		echo '</div>';
	}else{
...
<table width="100%" style='margin-left:auto; margin-right:auto;' class='tabel-akun tab_detail'>
    ...
    ?>
        <tr>
            ...
            <td colspan="4" align="right" style="text-align:right;"><?php 
            echo $detail->jumlah == 0 ? "-" : $detail->jumlah; 
            ?></td>
			<td></td>
		</tr>
    <?php
    ...
    ?>
        <tr>
			...
			<td colspan="4" align="right" style="text-align: right">
				(<?php echo $model->totalpajak; ?>)
			</td>
		</tr>
		<tr>
			<td>Potongan Lain-Lain</td>
			<td colspan="4" align="right" style="text-align: right">
				(<?php echo $model->potongan_lainlain; ?>)
			</td>
		</tr>
		...
		<tr class="row_total">
            ...
            <td colspan="3" align="right" style="text-align: right">
                (<?php echo ($model->totalpotongan + $model->totalpajak + $model->potongan_lainlain); ?>)
            </td>
        </tr>
		<tr class="row_total">
            <td align="right" colspan="3" style="text-align: right">Jumlah Terima</td>
            <td colspan="3" align="right" style="text-align: right; text-decoration: underline;">
                <?php echo $model->penerimaanbersih; ?>
            </td>
        </tr>
