...
if($sukses > 0){
	Yii::app()->user->setFlash('success',"Status Penilai berhasil disimpan!");
}
...
<div class="row">
	...
	<div class="col-sm-6" style="text-align:center;">
			...
			if(isset($_GET['sukses'])){
				...
				echo CHtml::link(Yii::t('mds',' Penilai'), 
				$this->createUrl($this->id.'/index'), 
				array('class' => 'btn btn-danger',
					'onclick'=>'myConfirm("Apakah Anda yakin?","Perhatian!",
					function(r) {if(r) window.location = "'.$this->createUrl('ApprovePenilai',array('penilaianpegawai_id'=>$modPenilaianPegawai->penilaianpegawai_id,'approve'=>true)).'";} ); return false;'));  
			}
			?>
		</div>	
...
<?php 
    ...
    $urlPrint= $this->createUrl('PrintApprovePenilai',array('penilaianpegawai_id'=>$modPenilaianPegawai->penilaianpegawai_id));
