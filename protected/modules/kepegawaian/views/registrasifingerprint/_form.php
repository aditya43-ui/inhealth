...
<?php
$konfigFinger = AlatfingerM::model()->findAll('alat_aktif = true and is_fingerprint = true');
if (is_array($konfigFinger)) {
    ...
    echo CHtml::button("connect", array("id" => "connect", "class" => 'btn btn-primary', 'onclick' => 'aktifkanFinger(this, false);'));
    echo CHtml::button("info", array("class" => 'btn btn-info', 'onclick' => '$("#infokoneksi").slideToggle();'));
    echo '</div>';
    echo '</div>';
}
?>
...
<div class="panel panel-success">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="entypo-credit-card"></i> Tabel <b>Registrasi Finger Print</b>
        </div>
    </div>
