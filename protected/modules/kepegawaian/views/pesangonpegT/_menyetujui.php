			...
			if(isset($_GET['sukses'])){
				...
				if($model->menyetujui_id == Yii::app()->user->getState('pegawai_id')){
                                    ...
                                    array('class' => 'btn btn-danger',
                                            ...
                                            function(r) {if(r) window.location = "'.$this->createUrl('ApproveMenyetujui',array('pesangonpeg_id'=>$model->pesangonpeg_id,'approve'=>true)).'";} ); return false;'));  
                                }
                                else{
                                    echo CHtml::link(Yii::t('mds',' Menyetujui'), 
                                    $this->createUrl($this->id.'/index'), 
                                    array('class' => 'btn btn-danger',
                                            'onclick'=>'myAlert("Maaf, Anda tidak berhak Menyetujui Pesangon Pegawai ini?"); return false;'));  
                                }   
				echo "&nbsp";
...
<?php 
    ...
    $urlPrint= $this->createUrl('printApproveMenyetujui',array('pesangonpeg_id'=>$model->pesangonpeg_id));
