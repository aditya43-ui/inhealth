<div class="row">
    <div class="col-sm-6">
        ...
        <div class="control-group">
            <?php echo CHtml::label('Nama Pegawai', 'namapegawai', array('placeholder' => 'Nama Pegawai', 'class' => 'control-label hurufs-only')) ?>
            <div class="controls">
                ...
                $this->widget('MyJuiAutoComplete', array(
                    ...
                    'sourceUrl' => Yii::app()->createUrl('kepegawaian/PesangonpegT/PegawaiResign'),
                    'options' => array(
                        'showAnim' => 'fold',
                        'minLength' => 4,
                        ...
                        'select' => 'js:function( event, ui ) {
                            $("#KPPesangonpegT_pegawai_id").val(ui.item.value);
							$("#pegawai_id").val( ui.item.value );
                    ...
                    'htmlOptions' => array('onkeypress' => "return $(this).focusNextInputField(event)", 'class' => 'span4', 'placeholder' => 'Nama Pegawai',),
    ...
    <div class="col-sm-6">
        ...
        <?php echo $form->textFieldRow($model, 'npwp', array('readonly' => true, 'id' => 'npwp', 'class' => 'span4',)); ?>
        <div class="control-group">
        ...
        <?php echo $form->textFieldRow($model, 'agama', array('readonly' => true, 'id' => 'agama', 'class' => 'span4',)); ?>
        <?php echo $form->textAreaRow($model, 'alamat_pegawai', array('readonly' => true, 'id' => 'alamat_pegawai', 'class' => 'span4',)); ?>
        <?php echo $form->textFieldRow($model, 'jml_tanggungan', array('readonly' => true, 'value' => 0, 'class' => 'span4 integer', 'id' => 'jml_tanggungan')); ?>
        <?php
...
$this->widget('ext.bootstrap.widgets.BootGridView', array(
    'id' => 'pegawai-m-grid',
    'dataProvider' => $modPegawai->searchPegawaiResign(),
    'filter' => $modPegawai,
    'template' => "{summary}\n{items}\n{pager}",
        ...
        array(
            ...
            'value' => 'CHtml::Link("<i class=\"icon-form-check\"></i>","",array("class"=>"btn-small", 
                    ...
                    "onClick" => "
                      ...
                      $(\"#KPPesangonpegT_pegawai_id\").val(\"$data->pegawai_id\");    
                      ...
                      $(\"#jabatan\").val(\"". (isset($data->jabatan_nama) ? $data->jabatan_nama : "") ."\");
