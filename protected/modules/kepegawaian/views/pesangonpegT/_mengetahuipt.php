			...
			if(isset($_GET['sukses'])){
				...
				if($model->mengetahuipt_id == Yii::app()->user->getState('pegawai_id')){
                                    ...
                                    array('class' => 'btn btn-danger',
                                            ...
                                            function(r) {if(r) window.location = "'.$this->createUrl('ApproveMengetahuiPT',array('pesangonpeg_id'=>$model->pesangonpeg_id,'approve'=>true)).'";} ); return false;'));  
                                }
                                else{
                                    echo CHtml::link(Yii::t('mds',' Mengetahui (PT)'), 
                                    $this->createUrl($this->id.'/index'), 
...
<?php 
    ...
    $urlPrint= $this->createUrl('printApproveMengetahuiPT',array('pesangonpeg_id'=>$model->pesangonpeg_id));
