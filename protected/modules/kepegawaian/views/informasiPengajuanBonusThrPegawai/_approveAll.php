             ...
             <tbody>
                 <?php
                    ...
                    if(count((array)$model)>0){
                        ...
                        $namaMengetahui = $model[0]->pegawai_mengetahuirs;
                        $tgl_mengatahui = $model[0]->tgl_mengetahui;
                        $id_mengatahui = $model[0]->mengetahuirs_id;

                        $namaMengetahuipt = $model[0]->pegawai_mengetahuipt;
                        $tgl_mengatahuipt = $model[0]->tgl_mengetahuipt;
                        $id_mengatahuipt = $model[0]->mengetahui_pt;

                        $namaMenyetujui = $model[0]->pegawai_menyetujui;
                    ...
                    ?>
                        ...
                        <tr bgcolor='white'>
                            ...
                            <td bgcolor='white'><?php echo MyFormatter::formatMonthForUser(date('Y-m', strtotime($data->periodebonusthr))); ?></td>
                            <td bgcolor='white'><?php echo MyFormatter::formatDateTimeForUser($data->tglpengajuan); ?></td>
                            <td bgcolor='white'><?php echo $data->nopengajuan; ?></td>
                            <td bgcolor='white'><?php echo $data->jenisgaji; ?></td>
                        </tr>
                     <?php
                     }
                    }else{
...
$.ajax({
    ...
    success:function(data){
        ...
        if(data.sukses==1){
            $('#frameApproveAll').html("");
            $('#frameApproveAll').html(data.form);
        }else{
...
<?php }else{
     echo 'myAlert("Maaf, Anda tidak berhak Mengapprove Pengajuan Bonus / THR ini");';
} ?>
}
</script>
