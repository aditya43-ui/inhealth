			...
			if(isset($_GET['sukses'])){
				...
				if($model->menyetujui_id == Yii::app()->user->getState('pegawai_id')){
                                    ...
                                    array('class' => 'btn btn-danger',
                                            ...
                                            function(r) {if(r) window.location = "'.$this->createUrl('ApproveMenyetujui',array('pengbonusthr_id'=>$model->pengbonusthr_id,'approve'=>true)).'";} ); return false;'));
                                }
                                else{
                                    echo CHtml::link(Yii::t('mds',' Menyetujui'),
                                    $this->createUrl($this->id.'/index'),
                                    array('class' => 'btn btn-danger',
                                            'onclick'=>'myAlert("Maaf, Anda tidak berhak Menyetujui Pengajuan ini?"); return false;'));
                                }
				echo "&nbsp";
...
<?php
    ...
    $urlPrint= $this->createUrl('printApproveMenyetujui',array('pengbonusthr_id'=>$model->pengbonusthr_id));
