...
<div>
    <?php echo $form->radioButtonRow($model, 'penerimaan', array('onkeypress' => "return $(this).focusNextInputField(event);", 'uncheckValue' => null)); ?>
    <?php echo $form->radioButtonRow($model, 'ispotongan', array('onkeypress' => "return $(this).focusNextInputField(event);", 'uncheckValue' => null)); ?>
