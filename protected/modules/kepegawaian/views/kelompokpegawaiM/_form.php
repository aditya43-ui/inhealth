...
<div class="row">
    <div class="col-sm-6">
        <?php echo $form->textFieldRow($model, 'kelompokpegawai_nama', array('placeholder' => 'Kelompok Pegawai', 'class' => 'span3 hurufs-onyl', 'onkeyup' => "namaLain(this)", 'onkeypress' => "return $(this).focusNextInputField(event);", 'maxlength' => 30)); ?>
        <?php echo $form->textFieldRow($model, 'kelompokpegawai_namalainnya', array('placeholder' => 'Nama Lain', 'class' => 'span3  hurufs-onyl', 'onkeypress' => "return $(this).focusNextInputField(event);", 'maxlength' => 30)); ?>
    </div>
    <div class="col-sm-6">
