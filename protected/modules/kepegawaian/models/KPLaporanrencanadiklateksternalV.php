<?php
/**
*       - digunakan untuk menyimpaan fungsi model dan memanggil table Laporanrencanadiklateksternal_v, yang digunakan hanya untuk modul kepegawaian saja
*       @author		M Iqbal Laksana <iqbal.laksana@piindonesia.co.id>
*       @website	<piindonesia.co.id>
*/


class KPLaporanrencanadiklateksternalV extends LaporanrencanadiklateksternalV {
