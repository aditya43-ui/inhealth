<?php
class LaporanRevenueCenterController extends MyAuthController
{
  public $path_view = 'akuntansi.views.laporanRevenueCenter.';

  public function actionIndex()
  {
    $this->pageTitle = Yii::app()->name . " - Revenue Center";
    $model = new AKLaporanrevenuecenterV();
    $model->unsetAttributes();
    $model->tgl_awal = date('Y-m-d', strtotime('first day of this month'));
    $model->tgl_akhir = date('Y-m-d');

    if (isset($_GET['AKLaporanrevenuecenterV'])) {
      $model->attributes = $_GET['AKLaporanrevenuecenterV'];
      $model->tgl_awal = MyFormatter::formatDateTimeForDb($_GET['AKLaporanrevenuecenterV']['tgl_awal']);
      $model->tgl_akhir = MyFormatter::formatDateTimeForDb($_GET['AKLaporanrevenuecenterV']['tgl_akhir']);
    }
  ...
  public function actionPrint()
  {
    ...
    $judulLaporan = 'LAPORAN REVENUE CENTER';
