<div class="panel panel-gradient">
	...
	");
        ...
        // var_dump($detail);
        ?>
        <?php $this->renderPartial('_search', array('model' => $model, 'saldoawal' => $saldoawal)); ?>
        <div class="panel panel-success" style="margin-top: 17px;">
            ...
            <div class="panel-body">
                <div id="tableLaporan" class="grid-view overflow-x">
				...
				<td style = "text-align:right;"><?php //echo MyFormatter::formatNumberForPrint($rek1['kredit']); ?></td>
					...
					<td style = "text-align:right;"><?php //echo MyFormatter::formatNumberForPrint($rek2['kredit']); ?></td>
						...
						<td style = "text-align:right;"><?php //echo MyFormatter::formatNumberForPrint($rek3['debit']); 
                                                        ?></td>
						<td style = "text-align:right;"><?php //echo MyFormatter::formatNumberForPrint($rek3['kredit']); 
                                                        ?></td>
					</tr>-->
							...
							<td style = "text-align:right;"><?php //echo MyFormatter::formatNumberForPrint($rek4['debit']); 
                                                            ?></td>
							<td style = "text-align:right;"><?php //echo MyFormatter::formatNumberForPrint($rek4['kredit']); 
                                                            ?></td>
						</tr>-->
                                                ...
                                                ?>
                                                    <tr>
                                                        <td><?php echo $kd5; ?> <i class="entypo-info" data-html="true" data-toggle="popover" data-trigger="hover" data-placement="top" data-content="<?php echo $kodeakun_5; ?>" data-original-title="Informasi Kode Akun"></i></td>
