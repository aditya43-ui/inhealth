...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('kelbahanmakananrek-m-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="glyphicon glyphicon-file"></i> Pengaturan <b>Jurnal Kelompok Bahan Makanan</b>
        </div>
    </div>
    <div class="panel-body">
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="entypo-credit-card"></i> Tabel <b>Jurnal Kelompok Bahan Makanan</b>
                </div>
            </div>
            <div class="panel-body table-responsive">
                <?php $this->widget('ext.bootstrap.widgets.BootGridView', array(
                    'id' => 'kelbahanmakananrek-m-grid',
                    ...
                    'columns' => array(
                        ...
                        array(
                            ...
                            'filter' => CHtml::activeTextField($model, 'kelbahanmakanan'),
                        ...
                        array(
                            'name' => 'istokopname',
                            'type' => "raw",
                            'value' => '$data->istokopname ? "<i class=\"entypo-check\"></i>" : ""',
                            'filter' => CHtml::activeDropDownList($model, 'istokopname', [1 => 'Ya', 2 => 'Tidak'], array(
                                'empty' => '-- Pilih --',
                            )),
                            'htmlOptions' => array(
                                'style' => 'text-align: center;',
                        ...
                        array(
                            'name' => 'istokopnamebertambah',
                            'type' => "raw",
                            'value' => '$data->istokopnamebertambah ? "<i class=\"entypo-check\"></i>" : ""',
                            'filter' => CHtml::activeDropDownList($model, 'istokopnamebertambah', [1 => 'Ya', 2 => 'Tidak'], array(
                                'empty' => '-- Pilih --',
                            )),
                            'htmlOptions' => array(
                                'style' => 'text-align: center;',
                        ...
                        array(
                            'name' => 'istokopnameberkurang',
                            'type' => "raw",
                            'value' => '$data->istokopnameberkurang ? "<i class=\"entypo-check\"></i>" : ""',
                            'filter' => CHtml::activeDropDownList($model, 'istokopnameberkurang', [1 => 'Ya', 2 => 'Tidak'], array(
                                'empty' => '-- Pilih --',
                            )),
                            'htmlOptions' => array(
                                'style' => 'text-align: center;',
                        ...
                        array(
                            ...
                            'buttons' => array(
                                'remove' => array(
                                    ...
                                    'url' => 'Yii::app()->createUrl("' . Yii::app()->controller->module->id . '/' . Yii::app()->controller->id . '/nonActive",array("id"=>$data->kelbahanmakananrek_id))',
        ...
        <div class="form-actions">
            <?php
            echo CHtml::link(
                Yii::t('mds', '{icon} Tambah Jurnal Kelompok Bahan Makanan', array('{icon}' => '<i class="icon-plus icon-white"></i>')),
                $this->createUrl('create', array('modul_id' => Yii::app()->session['modul_id'])),
                array('title' => 'Tambah jurnal kelompok bahan makanan', 'class' => 'btn btn-danger',)
            );
...
<script type="text/javascript">
    ...
    $('.filters #KelbahanmakananrekM_kelbahanmakanan').focus();
</script>