<?php $form = $this->beginWidget('ext.bootstrap.widgets.BootActiveForm', array(
    'id' => 'kelompokbahanmakananrek-m-form',
...
<div class="row">
    <div class="col-sm-6">
        <div class="control-group">
            <?php echo CHtml::label('Kelompok Bahan Makanan <span class="required">*</span>', '', array('class' => 'control-label required')); ?>
            <div class="controls">
                <?php echo $form->dropDownList($model, 'kelbahanmakanan', LookupM::getItems('kelompokbahanmakanan'), array('empty' => '-- Pilih --', 'class' => 'required span3')); ?>
            </div>
        </div>
        ...
        <?php echo $form->dropDownListRow($model, 'debitkredit', ['D' => 'Debit', 'K' => 'Kredit'], array('empty' => '-- Pilih --', 'class' => 'span2', 'onkeyup' => "return $(this).focusNextInputField(event);", 'maxlength' => 1)); ?>
    </div>
    <div class="col-sm-6">
        <div class="control-group">
            <?php echo CHtml::label("", '', array('class' => 'control-label')) ?>
            <div class="controls">
                <?php echo $form->checkBox($model, 'ispenerimaan') ?>
                <label for="KelbahanmakananrekM_ispenerimaan">Penerimaan</label>
            </div>
        </div>
        <div class="control-group">
            <?php echo CHtml::label("", '', array('class' => 'control-label')) ?>
            <div class="controls">
                <?php echo $form->checkBox($model, 'ispemakaian') ?>
                <label for="KelbahanmakananrekM_ispemakaian">Pemakaian</label>
            </div>
        </div>
        <div class="control-group">
            <?php echo CHtml::label("", '', array('class' => 'control-label')) ?>
            <div class="controls">
                <?php echo $form->checkBox($model, 'isreturpenerimaan') ?>
                <label for="KelbahanmakananrekM_isreturpenerimaan">Retur Penerimaan</label>
            </div>
        </div>
        ...
        <div class="control-group">
            <?php echo CHtml::label("", '', array('class' => 'control-label')) ?>
            <div class="controls">
                <?php echo $form->checkBox($model, 'istokopname') ?>
                <label for="KelbahanmakananrekM_istokopname">Stok Opname Awal</label>
            </div>
        </div>
        ...
        <div class="control-group">
            <?php echo CHtml::label("", '', array('class' => 'control-label')) ?>
            <div class="controls">
                <?php echo $form->checkBox($model, 'istokopnamebertambah') ?>
                <label for="KelbahanmakananrekM_istokopnamebertambah">Stok Opname Penyesuaian Bertambah</label>
            </div>
        </div>
        ...
        <div class="control-group">
            <?php echo CHtml::label("", '', array('class' => 'control-label')) ?>
            <div class="controls">
                <?php echo $form->checkBox($model, 'istokopnameberkurang') ?>
                <label for="KelbahanmakananrekM_istokopnameberkurang">Stok Opname Penyesuaian Berkurang</label>
            </div>
        </div>
    </div>
</div>
...
<div class="form-actions">
    ...
    <?php echo CHtml::link(
        Yii::t('mds', '{icon} Pengaturan Jurnal Kelompok Bahan Makanan', array('{icon}' => '<i class="icon-folder-open icon-white"></i>')),
