...
<div class="row">
    ...
    <div class="col-sm-6">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $form->dropDownList($modlookup, 'lookup_name', LookupM::getItems('carapembayaran'), array('empty' => '-- Pilih --', 'class' => 'required')); ?>
            </div>
        </div>
    </div>
    <div class="col-sm-6">
...
<div class="form-actions">
    <?php echo CHtml::htmlButton(
        $modlookup->isNewRecord ? Yii::t('mds', '{icon} Create', array('{icon}' => '<i class="' . MyIcon::getIcons('simpan') . '"></i>')) :
    ...
    'columns' => array(
        array(
            ...
            'value' => 'CHtml::Link("<i class=\"icon-form-check\"></i>","#",array("class"=>"btn-small",
                ...
                $(\"#AKLookupM_rekDebit\").val(\"$data->namarekeninglast\");                                                
        ...
        array(
            ...
            'value' => 'CHtml::Link("<i class=\"icon-form-check\"></i>","#",array("class"=>"btn-small",
				...
				"onClick" =>"
                    ...
                    $(\"#AKLookupM_rekKredit\").val(\"$data->namarekeninglast\");
