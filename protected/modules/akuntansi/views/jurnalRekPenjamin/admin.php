<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="glyphicon glyphicon-file"></i> Pengaturan <b>Jurnal Rekening Penjamin</b>
        </div>
    </div>
    ...
    ");
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="entypo-credit-card"></i> Tabel <b>Jurnal Rekening Penjamin</b>
                </div>
            </div>
            <div class="panel-body table-responsive">
                ...
                <?php $this->widget('ext.bootstrap.widgets.BootGridView', array(
                    ...
                    'dataProvider' => $model->searchRekeningPenjamin(),
                    //    'filter'=>$model,
                    'template' => "{summary}\n{items}\n{pager}",
                        ...
                        array(
                            ...
                            'buttons' => array(
                                'view' => array(
                                    ...
                                    'url' => 'Yii::app()->createUrl("' . Yii::app()->controller->module->id . '/' . Yii::app()->controller->id . '/view",array("id"=>"$data->penjamin_id","tab"=>"' . (isset($_GET['tab']) ? $_GET['tab'] : '') . '"))',
                                ),
                            ),
                        ),
                        array(
                            ...
                            'buttons' => array(
                                'update' => array(
                                    ...
                                    'url' => 'Yii::app()->createUrl("' . Yii::app()->controller->module->id . '/' . Yii::app()->controller->id . '/update",array("id"=>"$data->penjamin_id","tab"=>"' . (isset($_GET['tab']) ? $_GET['tab'] : '') . '"))',
                                ),
                            ),
                        ),
                        array(
                            ...
                            'buttons' => array(
                                'delete' => array(
                                    ...
                                    'url' => 'Yii::app()->createUrl("' . Yii::app()->controller->module->id . '/' . Yii::app()->controller->id . '/delete",array("id"=>"$data->penjamin_id","tab"=>"' . (isset($_GET['tab']) ? $_GET['tab'] : '') . '"))',
                                ),
                            )
                        ),
                    ),
        ...
        <div class="form-actions">
            <?php
            echo CHtml::link(
                Yii::t('mds', '{icon} Tambah Jurnal Rekening Penjamin', array('{icon}' => '<i class="' . MyIcon::getIcons('tambah-baris') . '"></i>')),
                $this->createUrl(Yii::app()->controller->id . '/create', array('modul_id' => Yii::app()->session['modul_id'], 'tab' => isset($_GET['tab']) ? $_GET['tab'] : '')),
                array('title' => 'Tambah jurnal rekening penjamin', 'class' => 'btn btn-danger',)
            );
