...
?>
 ...
 <table style="width: 100%; border: none;">
    ...
    <tbody>
        ...
        $this->renderPartial('akuntansi.views.laporanKartu.piutang/_tableExcel', array('model'=>$model, 'caraPrint'=>$caraPrint,)); 
    }else{
        $this->renderPartial('akuntansi.views.laporanKartu.piutang/_table', array('model'=>$model, 'caraPrint'=>$caraPrint,)); 
    }      ?>
		</div>		
            </td>
        </tr>
...
<div class="content">
    ...
    <div class="judulcontent"> <?php echo $judulLaporan   ?> <br> <?php echo $periode   ?></div>
     <br>
<?php  $this->renderPartial('akuntansi.views.laporanKartu.piutang/_table', array('model'=>$model, 'caraPrint'=>$caraPrint,)); ?>
</div>
