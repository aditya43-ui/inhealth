			...
			<table class="<?php echo $tableClass ?>" width="100%">					
				<thead>
					...
					<tr  class="<?php echo $colorheader; ?>">
						...
						<th bgcolor='#edeff2' align='center' width='20px' style='<?php echo $bghead ?>'>Tp</th>
				...
				<?php 
					...
					<tr class="lap-bottom-akun-2">
						<td bgcolor='#c2c4c6'  style="text-align:left;" colspan="4"><b>Saldo <?php echo $item['nama'] ?>:</b></td>											
					...
					?>
							...
							<tr class="lap-bottom-akun-2">
								<td bgcolor='#c2c4c6'  style="text-align:left;" colspan="4"><b>Grand Total :</b></td>	
								<td bgcolor='#c2c4c6' >&nbsp;</td>
								<td bgcolor='#c2c4c6'  style='text-align:center;'><b>IDR</b></td>
								<td bgcolor='#c2c4c6' >&nbsp;</td>
								<td bgcolor='#c2c4c6' >&nbsp;</td>
