			...
			<table class="<?php echo $tableclass; ?>" width="100%">
				<thead>
					...
					<tr class='<?php echo $colorheader; ?>' >
						...
						<th align='center' width='20px' style='<?php echo $bghead ?>'>Jenis Transaksi</th>
				...
				<?php
					...
					<tr class="lap-bottom-akun-2">
						<td style="text-align:left;" colspan="4"><b>Saldo Supplier <?php echo $item['nama'] ?>:</td>
						<td>&nbsp;</td>
						<td><b>IDR</td>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
					...
					?>
							...
							<tr class="lap-bottom-akun-2">
								<td style="text-align:left;" colspan="4"><b>Total Seluruh Supplier :</b></td>
								<td>&nbsp;</td>
								<td><b>IDR</b></td>
								<td>&nbsp;</td>
								<td>&nbsp;</td>
