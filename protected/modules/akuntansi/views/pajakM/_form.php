...
<div class="row">
    <div class="col-sm-6">
        <?php echo $form->textFieldRow($model, 'pajak_nama', array('placeholder' => 'Nama Pajak', 'class' => 'span3', 'onkeyup' => "return $(this).focusNextInputField(event);", 'maxlength' => 50)); ?>
        <?php echo $form->textFieldRow($model, 'pajak_namalain', array('placeholder' => 'Nama Lain Pajak', 'class' => 'span3', 'onkeyup' => "return $(this).focusNextInputField(event);", 'maxlength' => 50)); ?>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $form->dropDownList($model, 'debitkredit', array("D" => "Debit", "K" => "Kredit"), array('empty' => '-- Pilih --', 'class' => 'span3')); ?>
            </div>
        </div>
    </div>
    <div class="col-sm-6">
        <?php echo $form->textFieldRow($model, 'keterangan', array('placeholder' => 'Keterangan', 'class' => 'span3', 'onkeyup' => "return $(this).focusNextInputField(event);", 'maxlength' => 200)); ?>
        <div class="control-group">
            <?php echo CHtml::label("", 'ispajakpegawai', array('class' => 'control-label')); ?>
            <div class="controls">
                <?php echo $form->checkBox($model, 'ispajakpegawai', array()); ?>
                <label for="AKPajakM_ispajakpegawai">Pajak Pegawai</label>
            </div>
        </div>
        <div class="control-group">
            <?php echo CHtml::label("", 'pajak_aktif', array('class' => 'control-label')); ?>
            <div class="controls">
...
<div class="form-actions">
    ...
    <?php echo CHtml::link(Yii::t('mds', '{icon} Pengaturan Master Pajak', array('{icon}' => '<i class="icon-folder-open icon-white"></i>')), $this->createUrl('admin', array('modul_id' => Yii::app()->session['modul_id'], 'tab' => isset($_GET['tab']) ? $_GET['tab'] : '')), array('class' => 'btn btn-success')); ?>
    ...
    'columns' => array(
        array(
            ...
            'value' => 'CHtml::Link("<i class=\"icon-form-check\"></i>","#",array("class"=>"btn-small",
                ...
                $(\"#' . CHtml::activeId($model, 'rekening5_nama') . '\").val(\"$data->namarekeninglast\");                                                
