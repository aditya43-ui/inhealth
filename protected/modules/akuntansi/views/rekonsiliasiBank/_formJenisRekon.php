<div class="row">
    <div class="col-sm-6">
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo CHtml::dropDownList('jenisrekonsiliasibank_id', '', CHtml::listData(AKJenisrekonsiliasibankM::model()->findAll(), 'jenisrekonsiliasibank_id', 'jenisrekonsiliasibank_nama'), array('empty' => '-- Pilih --', 'class' => 'span3', 'onkeypress' => "return $(this).focusNextInputField(event)", 'onchange' => 'setRekonsiliasiBank(this);')) ?>
            </div>
        </div>
    </div>
</div>
        ...
        array(
            ...
            'value' => 'CHtml::Link("<i class=\"icon-form-check\"></i>","#",array("class"=>"btn-small",
				...
				"onClick" =>"
                    ...
                    $(\"#rekening5_id\").val($data->rekeninglast_id);
                    $(\"#rekening5_nb\").val(\"debit\");
                    setRekonsiliasiBankRekening();
