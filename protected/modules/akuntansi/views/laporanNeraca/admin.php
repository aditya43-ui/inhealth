    ...
    <div class="col-md-12">
        <div class="panel panel-primary panel-gradient">
            <div class="panel-heading">
                <div class="panel-title">Laporan <strong>Neraca</strong></div>
            </div>
            <div class="panel-body">
                ...
                <div class="panel panel-success panel-shadow">
                    <div class="panel-heading">
                        <div class="panel-title">Tabel <strong>Neraca</strong></div>
                    </div>
                    <div class="panel-body table-responsive">
                        <div class='block-tabel'> 
                            <?php $this->renderPartial($this->path_view.'_tableBaru', array('model'=>$model,'models'=>$models)); ?>                                
                        </div>
                    </div>
                </div>	
                <?php 
