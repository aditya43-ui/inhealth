...
<div class="row-fluid">
	<div class="col-sm-6">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?php echo $form->checkBox($model,'subtipeinsiden_aktif',array('checked'=>'subtipeinsiden_aktif')); ?> <label>Aktif</label>
                </div>
            </div>
	</div>
	<div class="col-sm-6">
            <div class="control-group">
                <?php echo CHtml::label("Nama Subtipe Insiden","",array('class' => 'control-label')); ?>
                <div class="controls">
                    <?php echo $form->textField($model,'subtipeinsiden_nama',array('class'=>'span3','placeholder'=>'Ketik Nama Kelompok Subtipe Insiden','maxlength'=>100)); ?>
                </div>
            </div> 
            <div class="control-group">
                <?php echo CHtml::label("Nama Lain Subtipe Insiden","",array('class' => 'control-label')); ?>
                <div class="controls">
                    <?php echo $form->textField($model,'subtipeinsiden_namalainnya',array('class'=>'span3','placeholder'=>'Ketik Nama Lain Kelompok Subtipe Insiden','maxlength'=>100)); ?>
                </div>
            </div> 
	</div>
</div>
