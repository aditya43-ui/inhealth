...
<div class="row">
    ...
    <div class="col-sm-6">
        <div class="control-group">
            <?php echo CHtml::label('Jenis Kejadian', '', array('class' => 'control-label')); ?>
            <div class="controls">
                <?php echo $form->dropDownList($model, 'jeniskejadian', CHtml::listData(LookupM::model()->findAllByPk(array(2383, 2384)), 'lookup_name', 'lookup_name'), array('empty' => '-- Pilih --', 'class' => 'span4', 'onkeyup' => "return $(this).focusNextInputField(event)")); ?>
            </div>
        </div>
        <div class="control-group">
            <?php echo CHtml::label('Nama Korban', '', array('class' => 'control-label')); ?>
            <div class="controls">
                <?php echo $form->textField($model, 'namakorban', array('placeholder' => 'Ketik Nama Pelapor', 'class' => 'span4', 'onkeyup' => "return $(this).focusNextInputField(event);", 'maxlength' => 100)); ?>
            </div>
        </div>
        <div class="control-group">
