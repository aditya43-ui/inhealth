                ...
                <?php $this->widget('ext.bootstrap.widgets.BootGridView',array(
                    ...
                    'columns'=>array(
                            ...
                            array(
                                ...
                                'filter' => Chtml::activeTextField($model, 'tingkatrisiko_batasbawah', array())
                            ),
                            array(
                                'header' => 'Batas Atas',
                                'name' => 'tingkatrisiko_batasatas',
                                'filter' => Chtml::activeTextField($model, 'tingkatrisiko_batasatas', array())
                            ),
                            array(
                                'header' => 'Warna Risiko',
                            ...
                            array(
                                ...
                                'buttons'=>array(
                                    'remove' => array (
                                        ...
                                        'url'=>'Yii::app()->createUrl("'.Yii::app()->controller->module->id.'/'.Yii::app()->controller->id.'/nonActive",array("id"=>$data->tingkatrisiko_riskregister_id))',
                                    ...
                                    'add' => array (
                                        ...
                                        'url'=>'Yii::app()->createUrl("'.Yii::app()->controller->module->id.'/'.Yii::app()->controller->id.'/active",array("id"=>$data->tingkatrisiko_riskregister_id))',
