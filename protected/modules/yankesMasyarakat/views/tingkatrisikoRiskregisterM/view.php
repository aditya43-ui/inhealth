<?php
    $this->breadcrumbs=array(
        ...
        $model->tingkatrisiko_riskregister_id,
    );
?>
<div class="panel panel-gradient">
        ...
        <div class="row-fluid">
            ...
            <?php $this->widget('ext.bootstrap.widgets.BootDetailView',array(
                    ...
                    'attributes'=>array(
                        ...
                        array(
                            'label' => 'Batas Bawah',
                            'value' => $model->tingkatrisiko_batasbawah,
                        ),
                        array(
                            'label' => 'Batas Atas',
                            'value' => $model->tingkatrisiko_batasatas,
                        ),
                        array(
                            'label' => 'Warna Risiko',
	...
	<div class="row-fluid">
            ...
            <?php echo CHtml::link(Yii::t('mds','{icon} Ubah',array('{icon}'=>'<i class="icon-pencil icon-white"></i>')),$this->createUrl('update',array('id'=>$model->tingkatrisiko_riskregister_id,'modul_id'=> Yii::app()->session['modul_id'])), array('class'=>'btn btn-success')); ?>
