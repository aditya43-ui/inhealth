	...
	<div class="row-fluid">
            <div class="span12">
                 <div class="control-group">
                    ...
                    <div class="controls">
                        <?php echo Chtml::dropDownList('tipeinsiden_id','', Chtml::listData(TipeinsidenM::model()->findAllByAttributes(array('tipeinsiden_aktif'=>true)),'tipeinsiden_id','tipeinsiden_nama'),array('class' => 'span3', 'empty'=>'-- Pilih --')); ?>		
                    </div>
                </div> 
                 <div class="control-group">
                ...
                <div class="row-fluid block-tabel overflow-x">
                    <table id="table-master" class="table table-striped table-bordered table-condensed">
                        <thead>
                            <th>No</th>
                            <th>Tipe Insiden</th>
                            <th>Nama Kelompok Subtipe Insiden</th>
                            <th>Nama Lain Kelompok Subtipe Insiden</th>
                            <th>Aktif</th>
                            <th>Hapus</th>
                        </thead>
                        <tbody>
