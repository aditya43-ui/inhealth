    ...
    <div class="col-md-12">
        <div class="panel panel-gradient">
            <div class="panel-heading">
                <div class="panel-title">Pengaturan <strong>Kelompok Subtipe Insiden</strong></div>
            </div>
            <div class="panel-body">
                ...
                $('.search-form form').submit(function(){
                        $.fn.yiiGridView.update('kelompoksubtipeinsiden-m-grid', {
                                data: $(this).serialize()
                        });
                        return false;
                });
                ...
                <div class="panel panel-success">
                    <div class="panel-heading">
                        <div class="panel-title">Tabel <strong>Kelompok Subtipe Insiden</strong></div>
                    </div>
                    <div class="panel-body" style="overflow-x: scroll">
                        <div class="block-tabel">
                            <?php
                            $this->widget('ext.bootstrap.widgets.BootGridView', array(
                                'id' => 'kelompoksubtipeinsiden-m-grid',
                                ...
                                'columns' => array(
                                    ...
                                    array(
                                        ...
                                        'filter' => Chtml::activeTextField($model, 'kelompoksubtipeinsiden_nama', array('class' => ''))
                                    ),
                                    array(
                                        'header' => 'Nama Lain Subtipe Insiden',
                                        'name' => 'kelompoksubtipeinsiden_namalainnya',
                                        'value' => '$data->kelompoksubtipeinsiden_namalainnya',
                                        'filter' => Chtml::activeTextField($model, 'kelompoksubtipeinsiden_namalainnya', array('class' => ''))
                                    ),
                                    array(
                                    ...
                                    array(
                                        ...
                                        'buttons' => array(
                                            'view' => array(
                                                ...
                                                'url' => 'Yii::app()->createUrl("' . Yii::app()->controller->module->id . '/' . Yii::app()->controller->id . '/view",array("id"=>"$data->kelompoksubtipeinsiden_id"))',
                                            ),
                                        ),
                                    ),
                                    array(
                                        ...
                                        'buttons' => array(
                                            'update' => array(
                                                ...
                                                'url' => 'Yii::app()->createUrl("' . Yii::app()->controller->module->id . '/' . Yii::app()->controller->id . '/update",array("id"=>"$data->kelompoksubtipeinsiden_id"))',
                                            ),
                                        ),
                                    ),
                                    array(
                                        ...
                                        'type' => 'raw',
                                        'value' => function($data) {
                                            if ($data->kelompoksubtipeinsiden_aktif == true) {
                                                return CHtml::link("<i class='glyphicon glyphicon-remove'></i> "
                                                        , "javascript:removeTemporary($data->kelompoksubtipeinsiden_id)", 
                                                        array(
                                                            "id" => "$data->kelompoksubtipeinsiden_id", 
                                                            "rel" => "tooltip", 
                                                            "data-placement"=>'left',
                                                            "title" => "Menonaktifkan Kelompok Subtipe Insiden")) . ' ' . 
                                                        CHtml::link("<i class='glyphicon glyphicon-trash'></i> ", 
                                                            "javascript:deleteRecord($data->kelompoksubtipeinsiden_id)", 
                                                                array(
                                                                    "id" => "$data->kelompoksubtipeinsiden_id", 
                                                                    "rel" => "tooltip", 
                                                                    "data-placement"=>'left',
                                                ...
                                                return CHtml::link("<i class='glyphicon glyphicon-check'></i> ", 
                                                        "javascript:aktifkan($data->kelompoksubtipeinsiden_id)", 
                                                        array(
                                                            "id" => "$data->kelompoksubtipeinsiden_id", 
                                                            "rel" => "tooltip", 
                                                            "data-placement"=>'left',
                ...
                <?php
                echo CHtml::link(Yii::t('mds', '{icon} Tambah Kelompok Subtipe Insiden', array('{icon}' => '<i class="entypo-plus"></i>')), $this->createUrl(Yii::app()->controller->id . '/create', array('modul_id' => Yii::app()->session['modul_id'])), array('class' => 'btn btn-success')) . "&nbsp&nbsp";
				...
				function cekForm(obj){
					$("#kelompoksubtipeinsiden-m-search :input[name='"+ obj.name +"']").val(obj.value);
				}
				function print(caraPrint){
					window.open("${urlPrint}/"+$('#kelompoksubtipeinsiden-m-search').serialize()+"&caraPrint="+caraPrint,"",'location=_new, width=900px');
				}
JSCRIPT;
