        ...
        'columns'=>array(
            array(
                ...
                'value'=>'CHtml::Link("<i class=\"icon-form-check\"></i>","javascript:void(0);",array("class"=>"btn-small", 
                    "id" => "selectPegawai",
                    "onClick" => "
                        $(\"#YKMInsidenkebakaranT_unitkeja_kejadian_nama\").val(\"$data->namaunitkerja\");
                        $(\"#YKMInsidenkebakaranT_unitkeja_kejadian_id\").val(\"$data->unitkerja_id\");
...
//                                     "id" => "selectObat",
//                                     "onClick" => "
//                                                   $(\"#YKMInsidenkebakaranT_pelapor_id\").val(\"$data->pegawai_id\");
//                                                   $(\"#YKMInsidenkebakaranT_pelapor_nama\").val(\"$data->NamaLengkap\");
//                                                   $(\"#YKMInsidenkebakaranT_nomorindukpegawai\").val(\"$data->nomorindukpegawai\");
...
//                                     "id" => "selectObat",
//                                     "onClick" => "
//                                                   $(\"#YKMInsidenkebakaranT_mengetahuipegawai_id\").val(\"$data->pegawai_id\");
//                                                   $(\"#YKMInsidenkebakaranT_mengetahuipegawai_nama\").val(\"$data->NamaLengkap\");
