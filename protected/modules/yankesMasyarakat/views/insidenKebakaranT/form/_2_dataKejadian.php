            ...
            <div class="controls">
                ...
                if (empty($_GET['is_edit'])) {
                    $this->widget('MyJuiAutoComplete', array(
                        'model' => $model,
                        'attribute' => 'unitkeja_kejadian_nama',
...
<div class="row-fluid">
    <div class="panel panel-success">
        ...
        <div class="panel-body">
            <?php echo $form->textAreaRow($model, 'kronologis_kebakaran', array('class' => 'span8', 'onkeypress' => "return $(this).focusNextInputField(event);", 'placeholder' => 'Kronologis Kebakaran')); ?>
            <?php echo $form->textAreaRow($model, 'penyebab_kebakaran', array('class' => 'span8', 'onkeypress' => "return $(this).focusNextInputField(event);", 'placeholder' => 'Penyebab Kebakaran')); ?>
            <?php echo $form->textAreaRow($model, 'kerugianakibatkebakaran', array('class' => 'span8', 'onkeypress' => "return $(this).focusNextInputField(event);", 'placeholder' => 'Kerugian/Akibat Kebakaran')); ?>
            <?php echo $form->textAreaRow($model, 'tindakanperbaikan', array('class' => 'span8', 'onkeypress' => "return $(this).focusNextInputField(event);", 'placeholder' => 'Tindakan Perbaikan')); ?>
        </div>
    </div>
</div>