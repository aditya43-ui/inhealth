...
if($caraPrint=='EXCEL')
{
    ...
    header('Content-Disposition: attachment;filename="'.'Data Risk Register'.'-'.date("Y/m/d").'.xls"');
...
if ($caraPrint != 'EXCEL') {
    if ($caraPrint == 'PRINT') {
        ...
        <?php
        echo $this->renderPartial('application.views.headerReport.headerLaporanTransaksiNew', array('judulLaporan' => 'Data Risk Register', 'colspan' => 20));
        ?>
        </span>
        <table>
            <thead>
    ...
    echo $this->renderPartial('application.views.headerReport.headerLaporanTransaksiExcelNew', array('judulLaporan' => 'Data Risk Register', 'colspan' => 20));
}
?>
