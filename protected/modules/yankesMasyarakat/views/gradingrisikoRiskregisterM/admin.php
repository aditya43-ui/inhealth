                            ...
                            $this->widget('ext.bootstrap.widgets.BootGridView', array(
                                ...
                                'columns' => array(
                                    ...
                                    array(
                                        ...
                                        'filter' => Chtml::activeDropDownList($model, 'detectability_id',Chtml::listData(DetectabilityM::model()->findAllByAttributes(array('detectability_aktif'=>true)),'detectability_id','detectability_deskripsi'), array('class' => '','empty'=>'-- Pilih --'))
                                    ),
                                    array(
                                        ...
                                        'filter' => Chtml::activeDropDownList($model, 'tingkatrisiko_riskregister_id',Chtml::listData(TingkatrisikoRiskregisterM::model()->findAllByAttributes(array('tingkatrisiko_aktif'=>true)),'tingkatrisiko_riskregister_id','tingkatrisiko_nama'), array('class' => '','empty'=>'-- Pilih --'))
                                    ),
                                    array(
                                    ...
                                    array(
                                        ...
                                        'buttons' => array(
                                            'view' => array(
                                                ...
                                                'url' => 'Yii::app()->createUrl("' . Yii::app()->controller->module->id . '/' . Yii::app()->controller->id . '/view",array("id"=>"$data->gradingrisiko_riskregister_id"))',
                                            ),
                                        ),
                                        'htmlOptions' => array('style' => 'text-align: center;'),
                                    ),
                                    array(
                                        ...
                                        'buttons' => array(
                                            'update' => array(
                                                ...
                                                'url' => 'Yii::app()->createUrl("' . Yii::app()->controller->module->id . '/' . Yii::app()->controller->id . '/update",array("id"=>"$data->gradingrisiko_riskregister_id"))',
                                            ),
                                        ),
                                        'htmlOptions' => array('style' => 'text-align: center;'),
                                    ),
                                        ...
                                        'value' => function($data) {
                                            if ($data->gradingrisiko_aktif == true) {
                                                return CHtml::link("<i class='glyphicon glyphicon-remove'></i> "
                                                        , "javascript:removeTemporary($data->gradingrisiko_riskregister_id)", 
                                                        array(
                                                            "id" => "$data->gradingrisiko_riskregister_id", 
                                                            "rel" => "tooltip", 
                                                            "data-placement"=>'left',
                                                            "title" => "Menonaktifkan Grading Risiko")) . ' ' . 
                                                        CHtml::link("<i class='glyphicon glyphicon-trash'></i> ", 
                                                            "javascript:deleteRecord($data->gradingrisiko_riskregister_id)", 
                                                                array(
                                                                    "id" => "$data->gradingrisiko_riskregister_id", 
                                                                    "rel" => "tooltip", 
                                                                    "data-placement"=>'left',
                                                ...
                                                return CHtml::link("<i class='glyphicon glyphicon-check'></i> ", 
                                                        "javascript:aktifkan($data->gradingrisiko_riskregister_id)", 
                                                        array(
                                                            "id" => "$data->gradingrisiko_riskregister_id", 
                                                            "rel" => "tooltip", 
                                                            "data-placement"=>'left',
