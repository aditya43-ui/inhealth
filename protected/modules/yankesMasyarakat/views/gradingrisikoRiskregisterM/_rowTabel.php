<tr>
	...
	<td style="text-align: center;">
            <?php echo CHtml::activeHiddenField($model, '[ii]detectability_id',array('class'=>'span3 detectability_id','readonly'=>true));?>		
            <?php echo CHtml::activeTextField($model, '[ii]detectability_deskripsi',array('class'=>'span3','readonly'=>true));?>		
	</td>
        <td style="text-align: center;">
            <?php echo CHtml::activeHiddenField($model, '[ii]tingkatrisiko_riskregister_id',array('class'=>'span3 tingkatrisiko_riskregister_id','readonly'=>true));?>		
