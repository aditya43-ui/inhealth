            ...
            <div class="span12">
                <div class="span6">
                    ...
                    <div class="control-group">
                       ...
                       <div class="controls">
                           <?php echo Chtml::dropDownList('detectability_id','', Chtml::listData(DetectabilityM::model()->findAllByAttributes(array('detectability_aktif'=>true)),'detectability_id','detectability_deskripsi'),array('class' => 'span3', 'empty'=>'-- Pilih --')); ?>		
                       </div>
                    </div>
                </div>
                <div class="span6">
                    <div class="control-group">
                       ...
                       <div class="controls">
                           <?php echo Chtml::dropDownList('tingkatrisiko_riskregister_id','', Chtml::listData(TingkatrisikoRiskregisterM::model()->findAllByAttributes(array('tingkatrisiko_aktif'=>true)),'tingkatrisiko_riskregister_id','tingkatrisiko_nama'),array('class' => 'span3', 'empty'=>'-- Pilih --','onchange'=>'setWarnaRisiko();')); ?>		
                       </div>
                    </div> 
                    <div class="control-group">
