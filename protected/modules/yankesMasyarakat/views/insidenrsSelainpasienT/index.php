...
<div class="panel panel-gradient">
    <div class="panel panel-heading">
        <div class="panel-title"> <b> Formulir Laporan Insiden Selain Pasien </b> </div>
    </div>
    <div class="panel-body">
        <div class="row-fluid">
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    <?php $this->renderPartial($this->path_view.'/form/_dataPelaporan', array('model' => $model, 'form' => $form))?>
                </div>
            </div>
        </div>
        <div class="row-fluid">
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    <?php $this->renderPartial($this->path_view.'/form/_dataKejadian', array('model' => $model, 'form' => $form))?>
        ...
        <div class="row-fluid">
            <div class="panel panel-success">
                <div class="panel panel-heading">
                    <div class="panel-title"> <b> Mengetahui </b> </div>
                </div>
                <div class="panel-body">
                    <?php $this->renderPartial($this->path_view.'/form/_dataMengetahui', array('model' => $model, 'form' => $form))?>
                </div>
            </div>
        </div>
        <div class="row-fluid">
