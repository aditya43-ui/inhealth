...
<div class="col-sm-6">
    <div class="control-group">	
        ...
        <?php echo CHtml::label("Tanggal Pelaporan &nbsp;&nbsp;", 'tgl_pelaporan', array('class' => 'listtanggal1 ')) ?>
        <div class="controls">
    ...
    <div class="control-group">	
        ...
        <?php echo CHtml::label("Tanggal Kejadian &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;", 'tgl_kejadian', array('class' => 'listtanggal1')); ?>
        <div class="controls">
...
<div class="form-actions">
    ...
    <?php echo CHtml::link(Yii::t('mds', '{icon} Reset', array('{icon}' => '<i class="entypo-arrows-ccw"></i>')), $this->createUrl('InformasiLaporanInsidenTumpahanB3T/index'), array('class' => 'btn btn-danger')) . "&nbsp"; ?>
