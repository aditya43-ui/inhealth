...
<div class="row-fluid">
    <div class = "col-sm-6">
        ...
        <div class="control-group">
            <?php echo CHtml::label('Skor Risiko','',array('class'=>'control-label'));?>
            <div class="controls">
                <?php echo $form->textField($model,'tingkatrisiko_nilai',array('placeholder'=>'Range Skor Risiko','class'=>'span4', 'onkeyup'=>"return $(this).focusNextInputField(event);", 'maxlength'=>100)); ?>
            </div>
        </div>
    </div>
    <div class = "col-sm-6">
