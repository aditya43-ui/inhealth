<div class="col-md-6">
    <?php echo $form->textFieldRow($model, 'no_dokumen', array('readonly' => true, 'class' => 'span4', 'onkeypress' => "return $(this).focusNextInputField(event);", 'placeholder' => 'Lokasi Kejadian')); ?>
    <?php echo $form->textFieldRow($model, 'no_revisi', array('readonly' => true, 'class' => 'span4', 'onkeypress' => "return $(this).focusNextInputField(event);", 'placeholder' => 'Lokasi Kejadian')); ?>
...
<div class="col-md-6">
    ...
    <?php echo $form->textFieldRow($model, 'nomorindukpegawai', array('readonly' => true, 'class' => 'span4 required', 'onkeypress' => "return $(this).focusNextInputField(event);", 'placeholder' => 'NIP Pelapor')); ?>
