<?php $form=$this->beginWidget('ext.bootstrap.widgets.BootActiveForm',array(
	...
	<div class="row-fluid">
            <div class="col-sm-6">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <?php echo $form->textArea($model, 'detectability_deskripsi', array('class' => 'span3', 'placeholder' => 'Ketik Deskripsi', 'maxlength' => 100)); ?>		
                    </div>
                </div>
                <div class="control-group">
                        ...
                        <div class="controls">
                             <?php
                                if($model->detectability_aktif == true){
                            ?>
                            <?php  echo $form->checkBox($model,'detectability_aktif',array('value'=>1,'uncheckValue'=>0,'checked'=>'detectability_aktif')); ?> <label>Aktif</label>
                            <?php
                                }else{
                            ?>
                            <?php  echo $form->checkBox($model,'detectability_aktif',array('value'=>1,'uncheckValue'=>0)); ?> <label>Aktif</label>
                            <?php
                                }
                            ?>
                        </div>				
	...
	<div class="form-actions">
		...
		<?php echo CHtml::link(Yii::t('mds','{icon} Pengaturan Tipe Resiko',array('{icon}'=>'<i class="icon-folder-open icon-white"></i>')),$this->createUrl('admin',array('modul_id'=> Yii::app()->session['modul_id'])), array('class'=>'btn btn-success')); ?>
