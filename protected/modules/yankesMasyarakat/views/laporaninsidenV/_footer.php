...
<?php
	...
	//echo CHtml::htmlButton(Yii::t('mds','{icon} GRAFIK',array('{icon}'=>'<i class="icon-print icon-white"></i>')),array('class'=>'btn btn-primary', 'type'=>'button','onclick'=>'print(\'GRAFIK\')'))."&nbsp&nbsp";     
        echo CHtml::htmlButton(Yii::t('mds','{icon} GRAFIK',array('{icon}'=>'<i class="icon-print icon-white"></i>')),array('class'=>'btn btn-primary', 'type'=>'button','onclick'=>'downloadPDF();'))."&nbsp&nbsp";     
