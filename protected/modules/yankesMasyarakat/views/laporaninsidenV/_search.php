<div class="search-form" style="">
                        ...
                        'content3' => array(
                            ...
                            'isi' => CHtml::hiddenField('filter', 'pilih', array('disabled' => 'disabled')) .
                                    '<table>
                                        <tr>
                                            <td>' .
                                             $form->radioButtonList($model, 'pilihan', array('a' => 'Grading Risiko Insiden', 'b' => 'Tingkat Risiko Insiden', 'c' => 'Waktu Pelaporan Insiden'), array('value' => 'pengunjung', 'inline' => true, 'empty' => '-- Pilih --', 'onkeypress' => "return $(this).focusNextInputField(event)")) 
                                            .'</td>'
                                        . '</tr>'
                                    . '</table>',
                            'active' => true,
    ...
    <div class="form-actions">
        <?php echo CHtml::htmlButton(Yii::t('mds', '{icon} Search', array('{icon}' => '<i class="entypo-search"></i>')), array('class' => 'btn btn-primary', 'type' => 'button', 'id' => 'btn_simpan', 'onclick' => 'caridata();')) . "&nbsp;"; ?>
