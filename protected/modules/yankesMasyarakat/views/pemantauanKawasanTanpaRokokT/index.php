...
<div class="panel panel-gradient">
    <div class="panel panel-heading">
        <div class="panel-title"> <b> Formulir Pemantauan Kawasan Tanpa Rokok </b> </div>
    </div>
    <div class="panel-body">
        ...
        <div class="row-fluid">
            <div class="panel panel-success">
                <div class="panel panel-heading">
                    <div class="panel-title"> <b>Rincian Pelanggaran </b> </div>
                </div>
                <div class="panel-body">
                    <?php $this->renderPartial($this->path_view.'/form/_dataRincianPelanggaran', array('model' => $model, 'form' => $form))?>
