<div class="row-fluid lookdisable">
    <div class="col-md-6">
        ...
        <div class="control-group">
            <?php echo CHtml::label('Evaluasi Resiko', '', array('class' => 'control-label ')) ?>
            <div class="controls">
                <?php echo $form->dropDownList($modEvaluasi,'evaluasi_risiko', LookupM::getItems("evaluasi_risiko"), array('class'=>'span3 ','empty'=>'-- Pilih --')); ?>
