	...
	<div class="row-fluid">
            <div class="col-sm-6">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <?php echo $form->dropDownList($model,'tingkatrisiko_id',Chtml::listData(TingkatrisikoM::model()->findAllByAttributes(array('tingkatrisiko_aktif'=>true)),'tingkatrisiko_id','tingkatrisiko_nama'),array('class' => 'span3', 'empty'=>'-- Pilih --','onchange'=>'setWarnaRisikoUpdate();')); ?>		
                    </div>
                 </div> 
                 <div class="control-group">
