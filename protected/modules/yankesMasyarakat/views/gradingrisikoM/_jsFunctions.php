<script>
    function tambah()
    {
        ...
        var tingkatrisiko_id = $('#tingkatrisiko_id').val();
        ...
        function(data){
            if(data.message == 'sukses'){
                ...
                $('#table-master').find("tbody > tr").each(function(){
                   ...
                   var tingkatrisiko_id = $(this).find('.tingkatrisiko_id').val();
                   if((peluang_id == data.peluang_id) && (konsekuensi_id == data.konsekuensi_id) && (tingkatrisiko_id == data.tingkatrisiko_id)){
                       cekAda = 1;
                   }
                });
                if(cekAda == 0){
    ...
    function setWarnaRisikoUpdate(){
        var tingkatrisiko_id = $('#GradingrisikoM_tingkatrisiko_id').val();
        $.post('<?php echo $this->createUrl('getWarnaRisiko'); ?>', { 
            tingkatrisiko_id:tingkatrisiko_id},
        function(data){
            $('#GradingrisikoM_warnarisiko').val(data.return);
        }, "json");
    }
