...
class KUPengeluaranumumT extends PengeluaranumumT
{
	...
	public $is_posting,$jmlgaji, $jenispengeluaran_nama;
        public $persenpph_21, $persenpph_22, $persenpph_23, $persenppn;
	...
	public function searchInformasi()
	{
		...
		$criteria=new CDbCriteria;
                $criteria->with = array('jenispengeluaran');
		...
		if(!empty($this->jenispengeluaran_id)){
			$criteria->addCondition("jenispengeluaran_id = ".$this->jenispengeluaran_id);			
                ...
                $criteria->compare('LOWER(jenispengeluaran.jenispengeluaran_nama)',strtolower($this->jenispengeluaran_nama),true);
