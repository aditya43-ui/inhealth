<?php
class KULaporantindakankomponenV extends LaporantindakankomponenV
{
	...
	public function getSumKomponen($groups = array(), $nama_kolom = null){
		if(isset($_GET['KULaporantindakankomponenV']['komponentarif_id'])){
			$komponentarif_id = $_GET['KULaporantindakankomponenV']['komponentarif_id'];
		}
...
//            }
		...
		if(isset($_GET['KULaporantindakankomponenV'])){
			$tgl_awal = $format->formatDateTimeForDb($_GET['KULaporantindakankomponenV']['tgl_awal']);
			$tgl_akhir = $format->formatDateTimeForDb($_GET['KULaporantindakankomponenV']['tgl_akhir']);
