<?php
/**
* - digunakan untuk mengambil data dari view laporanclosingkasir_v
* @category		model
...
*/
class KULaporanclosingkasirV extends LaporanclosingkasirV
{
	...
	public function searchInformasi()
	{
        ...
        public function searchGrafik() {
            ...
            $criteria->select = 'sum(nilaiclosingtrans) as jumlah, shift_nama as data';
