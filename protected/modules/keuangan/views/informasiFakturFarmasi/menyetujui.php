	...
	<div class="span4" style="text-align:center;">
			...
			if(isset($_GET['sukses'])){
				...
				array('class'=>'btn btn-primary',
					...
					function(r) {if(r) window.location = "'.$this->createUrl('Menyetujui',array('fakturpembelian_id'=>$modFakturPembelian->fakturpembelian_id,'approve'=>true)).'";} ); return false;'));  
			}
			?>
		</div>	
...
//    echo CHtml::htmlButton(Yii::t('mds','{icon} PDF',array('{icon}'=>'<i class="icon-book icon-white"></i>')),array('class'=>'btn btn-primary', 'type'=>'button','onclick'=>'print(\'PDF\')'))."&nbsp&nbsp"; 
    $urlPrint= $this->createUrl('printMenyetujui',array('fakturpembelian_id'=>$modFakturPembelian->fakturpembelian_id));
