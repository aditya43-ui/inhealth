<?php $linkHalaman = CustomFunction::getUrlByMenuID(3499); ?>
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="entypo-info-circled"></i> Informasi <b>Setoran Utang Pajak Pembelian</b>
    ...
    <div class="panel-body">
        ...
        $this->breadcrumbs = array(
            'Informasi Setoran Utang Pajak Pembelian',
        );
        Yii::app()->clientScript->registerScript('search', "
            $('#setoranpajakpembelian-info-search').submit(function(){
                    $.fn.yiiGridView.update('setoranpajakpembelian-info-grid', {
                            data: $(this).serialize()
                    });
                    return false;
            });
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="entypo-credit-card"></i> Tabel <b>Setoran Utang Pajak Pembelian</b>
                </div>
            </div>
            <div class="panel-body table-responsive">
                <?php
                $this->widget('ext.bootstrap.widgets.HeaderGroupGridViewNonRp', array(
                    'id' => 'setoranpajakpembelian-info-grid',
                    ...
                    'columns' => array(
                        ...
                        array(
                            ...
                            'value' => 'number_format($data->sisahutang,2,",",".")',
                            'htmlOptions' => array('style' => 'text-align: right;'),
                        ),
                        array(
                        ...
                        array(
                            ...
                            'value' => 'CHtml::link("<i class=\'icon-form-detail\'></i> ",Yii::app()->createUrl("keuangan/InformasiSetoranPajakPembelian/rincian",array("tandabuktikeluar_id"=>$data->tandabuktikeluar_id)) ,array("title"=>"Klik untuk Melihat Rincian Setoran Utang Pajak Pembelian","target"=>"iframe", "onclick"=>"$(\"#dialogRincianPajak\").dialog(\"open\");", "rel"=>"tooltip"))',
                        ),
                        //                                        array(
                        //                                               'header'=>'Buti Potong Pajak',
                        //                                               'type'=>'raw',
                        //                                               'htmlOptions'=>array('style'=>'text-align:center;'),
                        //                                               'value'=>'CHtml::link("<i class=\'icon-form-detail\'></i> ",Yii::app()->createUrl("keuangan/InformasiFakturUmum/detailsFaktur",array("terimapersediaan_id"=>$data->faktur_id)) ,array("title"=>"Klik untuk Melihat Rincian Bukti Potong Pajak","target"=>"iframe", "onclick"=>"alert(\"Belum Berfungsi\")", "rel"=>"tooltip"))',
                        //                                            ),
                        array(
                            'header' => 'Batal',
                            'type' => 'raw',
                            'value' => function ($data) {
                                return (!empty($data->batalpegawai_id) ? "SUDAH DIBATALKAN" : CHtml::link("<i class='icon-form-silang'></i>", 'javascript:dialogBatalPajak(' . $data->tandabuktikeluar_id . ')', array("id" => $data->tandabuktikeluar_id, "rel" => "tooltip", "title" => "Klik untuk membatalkan Setoran Utang Pajak Pembelian", "data-placement" => "left")));
                            },
                            'htmlOptions' => array('style' => 'text-align: center; width: 60px;'),
                        ),
                    ),
...
$this->beginWidget('zii.widgets.jui.CJuiDialog', array(
    ...
    'options' => array(
        'title' => 'Rincian Setoran Utang Pajak Pembelian',
        'autoOpen' => false,
        'minWidth' => 1100,
        'height' => 500,
        'resizable' => false,
...
$this->beginWidget('zii.widgets.jui.CJuiDialog', array(
    ...
    'options' => array(
        'title' => 'Form Pembatalan Setoran Utang Pajak Pembelian',
        'autoOpen' => false,
        'show' => 'blind',
        'hide' => 'explode',
        'zIndex' => 1002,
...
<script type="text/javascript">
    function dialogBatalPajak(tandabuktikeluar_id) {
        $('#DialogBatalFaktur #tandabuktikeluar_id').val(tandabuktikeluar_id);
        $('#DialogBatalFaktur #keterangan_batal').val('');
        $('#DialogBatalFaktur').dialog('open');
    }

    function ubahFakturKarenaBatal() {
        var tandabuktikeluar_id = $('#DialogBatalFaktur #tandabuktikeluar_id').val();
        var tglbatal = $('#DialogBatalFaktur #tglbatal').val();
        var pegawaibatal_id = $('#DialogBatalFaktur #pegawaibatal_id').val();
