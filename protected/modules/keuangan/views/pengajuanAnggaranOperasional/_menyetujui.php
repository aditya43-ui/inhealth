    ...
    <div class="col-sm-4" style="text-align:center;">
                ...
                if(isset($_GET['sukses'])){
                    ...
                    array('class' => 'btn btn-danger',
                            ...
                            function(r) {if(r) window.location = "'.$this->createUrl('Menyetujui',array('pengajuanpetty_id'=>$model->pengajuanpetty_id,'approve'=>true)).'";} ); return false;'));
                            echo "&nbsp";
                            echo CHtml::link(Yii::t('mds',' Menolak'),
                            $this->createUrl($this->id.'/index'),
                            array('class'=>'btn btn-default',
                                    'onclick'=>'myConfirm("Apakah Anda yakin?","Perhatian!",
                                    function(r) {if(r) window.location = "'.$this->createUrl('Menyetujui',array('pengajuanpetty_id'=>$model->pengajuanpetty_id,'tolak'=>true)).'";} ); return false;'));
                }
                ?>
        </div>
        <div class="control-group">
