...
$modPembelian = PermintaanpembeliantouangmukaV::model()->findByAttributes(array('permintaanpembelian_id' => $model->pembelianbarang_id, 'typepermintaan' => $typepermintaan));
            ...
            <td>
                <div class="content">
                    <div class="judulcontent">
                        <p style="margin: 0; text-align: center;"><b>RINCIAN PEMBAYARAN UANG MUKA PEMBELIAN</b></p>
                    </div>
                    <br>
                    <table style="width: 100%; border: none;">
                        <tr>
...
<?php if (!isset($_GET['caraPrint'])) { ?>
    <script type="text/javascript">
        function print(caraPrint) {
            var id = '<?php echo isset($model->uangmukabeli_id) ? $model->uangmukabeli_id : null ?>';
            window.open('<?php echo $this->createUrl('detailInformasi'); ?>&uangmukabeli_id=' + id + '&caraPrint=' + caraPrint, 'printwin', 'left=100,top=100,width=1000,height=640');
        }
    </script>
<?php } ?>