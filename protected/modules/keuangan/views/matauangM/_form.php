...
<div class="row">
    ...
    <div class="col-sm-6">
        <?php echo $form->textFieldRow($model, 'matauang', array('placeholder' => 'Mata Uang', 'class' => 'span3', 'onkeypress' => "return $(this).focusNextInputField(event);", 'maxlength' => 50)); ?>
        <?php //echo $form->checkBoxRow($model,'matauang_aktif', array('onkeypress'=>"return $(this).focusNextInputField(event);",'checked'=>'checked')); 
        ?>
    </div>
    <div class="col-sm-6">
        <?php echo $form->textFieldRow($model, 'singkatan', array('placeholder' => 'Singkatan', 'class' => 'span3', 'onkeypress' => "return $(this).focusNextInputField(event);", 'maxlength' => 50)); ?>
    </div>
</div>
