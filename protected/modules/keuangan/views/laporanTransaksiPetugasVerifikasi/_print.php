...
if ($caraPrint == 'PDF') {
    ?>
    <div class="header">
        <?php   echo $this->renderPartial('keuangan.views.laporanTransaksiPetugasVerifikasi.headerDefaultNew', array('judulLaporan' => $judulLaporan, 'periode' => $periode)); ?><br>
    </div>
    <div class="content">

        <?php
       $this->renderPartial('keuangan.views.laporanTransaksiPetugasVerifikasi._table', array('model'=>$model, 'caraPrint'=>$caraPrint)); 
        ?>
    </div>
