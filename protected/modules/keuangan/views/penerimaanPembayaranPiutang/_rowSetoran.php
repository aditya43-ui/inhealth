<tr>
    <td>
        ...
        <?php echo CHtml::activeHiddenField($modDetail,'[ii]jnspembayar_id',array('readonly'=>true)); ?>
        <?php echo CHtml::activeHiddenField($modDetail,'[ii]pendaftaran_id',array('readonly'=>true)); ?>
        <?php echo CHtml::activeHiddenField($modDetail,'[ii]pasien_id',array('readonly'=>true)); ?>
        <?php echo CHtml::activeHiddenField($modDetail,'[ii]pembayaranpelayanan_id',array('readonly'=>true)); ?>
        <?php echo CHtml::activeHiddenField($modDetail,'[ii]tandabuktibayar_id',array('readonly'=>true)); ?>
        <?php echo CHtml::activeHiddenField($modDetail,'[ii]bankpenerima_id',array('readonly'=>true)); ?>
    ...
    <td><span><?php echo $modDetail->jnspembayar_nama; ?></span></td>
    <td><span><?php echo (!empty($modDetail->namabank)?$modDetail->namabank:"-"); ?></span></td>
    <td><span style="text-align: right">Rp <?php echo MyFormatter::formatNumberForPrint($modDetail->jumlahpembayaran,2); ?></span></td>
    <td style="text-align: right">
        <?php echo CHtml::activeHiddenField($modDetail,'[ii]jumlahpembayaran',array('onkeypress'=>"return $(this).focusNextInputField(event);",'class'=>'')); ?>
    ...
    <td style="text-align: right">
        <?php echo CHtml::activeTextField($modDetail,'[ii]biayaadministrasi',array('class'=>'span2 integer-decimal','onblur'=>'hitungsisa(this)','onkeypress'=>"return $(this).focusNextInputField(event);",'disabled'=>true)); ?>
    </td>
    <td style="text-align: right">
        <?php echo CHtml::activeTextField($modDetail,'[ii]biaya_materai',array('class'=>'span2 integer-decimal','onblur'=>'hitungsisa(this)','onkeypress'=>"return $(this).focusNextInputField(event);",'disabled'=>true)); ?>
    </td>
    <td style="text-align: right">
        <?php echo CHtml::activeTextField($modDetail,'[ii]jmlpenerimaan',array('class'=>'span2 integer-decimal','onblur'=>'hitungsisa(this)','onkeypress'=>"return $(this).focusNextInputField(event);",'readonly'=>true)); ?>
    </td>
    <td style="text-align: right">
