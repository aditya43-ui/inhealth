        ...
        <div class="control-group">
            ...
            <div class="controls">
                ...
                if(!empty($modPendaftaran->pendaftaran_id)){
                    ...
                    $listInstalasi = array(Params::INSTALASI_ID_RI => 'INSTALASi RAWAT INAP');
...
$this->widget('ext.bootstrap.widgets.BootGridView', array(
    ...
    'dataProvider' => $modDialogPasien->searchDialogOrderBatal(),
...
<script type="text/javascript">
    ...
    function loadPembayaran(pendaftaran_id, ruangan_id, penjualanresep, nonota) {
        ...
        $.post('<?php echo Yii::app()->createUrl('billingKasir/ActionAjax/loadPembayaranVerifikasiTindakanAkomodasi'); ?>', {
