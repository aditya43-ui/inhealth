...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="glyphicon glyphicon-briefcase"></i> Transaksi <b>Order Batal Tindakan Akomodasi</b>
...
function renameInputRowTindakan(obj_table){
    ...
    function simpanCeklisVerifikasi(obj) {
        ...
        $.post('<?php echo $this->createUrl('simpanCeklisBatalTindakan')?>', $(obj).parents("tr").find(":input").serialize(), function(data) {
            ...
            if (data.ok == 1) {
                ...
                myAlert('Akomodasi Behasil di order Batal Akomodasi');
    ...
    function setCeklisNota(obj) {
        var ceklis = $(obj).is(":checked");
        var nota = $(obj).data('nota');

        $('#tblBayarTind .pilihan[data-nota="' + nota + '"]').prop("checked", ceklis);
    }
