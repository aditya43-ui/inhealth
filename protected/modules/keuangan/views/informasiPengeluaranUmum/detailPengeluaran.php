...
<table>
    <thead>
        <tr>
            ...
            <td style="padding-left:420px;" valign="MIDDLE" align="right" colspan=" 9">
                <br>
        ...
        <td>
            <table>
                ...
                <tr>
                    ...
                    <td>:<i>&nbsp;<?php 
                    $modTandaBuktiBayar = TandabuktikeluarT::model()->findByPk($modPengeluaran->tandabuktikeluar_id);
...
// $modPegawaiKetahui = PegawaiM::model()->findByPk($modPengeluaran->pegawaimengetahui_id);
?>
</div>
