<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="fas fa-layer-group"></i> Pengaturan <b>Grup Layanan Kasir</b>
        </div>
    </div>
    <div class="panel-body">
                ...
                <?php $this->widget('ext.bootstrap.widgets.BootGridView', array(
                    ...
                    'columns' => array(
                        ...
                        array(
                            'header' => 'Hapus',
                            'type' => 'raw',
                            'value' => 'CHtml::link("<i class=\'' . MyIcon::getIcons('hapus') . '\'></i> ", "javascript:deleteRecord($data->grouplayanankasir_id)",array("id"=>"$data->grouplayanankasir_id","rel"=>"tooltip","title"=>"Hapus Grup Layanan"))',
                            'htmlOptions' => array('style' => 'text-align: center; width: 60px;'),
                        ),
                    ),
        ...
        <div class="form-actions">
            ...
            echo CHtml::link(
                Yii::t('mds', '{icon} Tambah Grup Layanan Kasir', array('{icon}' => '<i class="icon-plus icon-white"></i>')),
                $this->createUrl('create', array('modul_id' => Yii::app()->session['modul_id'])),
                array('title' => 'Tambah grup layanan kasir', 'class' => 'btn btn-danger',)
            );
