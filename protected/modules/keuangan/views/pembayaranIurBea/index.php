    ...
    <div class="panel panel-gradient">
        <div class="panel-heading">
            <div class="panel-title">
                <i class="glyphicon glyphicon-briefcase"></i> Transaksi <b>Pembayaran Iur Bea</b>
            </div>
        </div>
        <div class="panel-body">
                ...
                <div class="panel-body">
                    ...
                    <div class="row-fluid">
                        <div class="col-sm-6">
                            ...
                            <?php echo $form->textFieldRow($modPenUmum, 'kelompoktransaksi', array('readonly' => true, 'class' => 'span3 reqForm', 'onkeypress' => "return $(this).focusNextInputField(event);", 'maxlength' => 50)); ?>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <?php
                                    echo $form->textField($modPenUmum, 'jenisKodeNama', array('class'=>'span3', 'readonly'=>true));
                                    /*
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <?php echo $form->textField($modPenUmum, 'volume', array('class' => 'span1 reqForm numbers-only', 'onkeypress' => "return $(this).focusNextInputField(event);", 'style' => 'text-align: right;', 'readonly'=>true)); ?>
                                    <?php echo $form->dropDownList($modPenUmum, 'satuanvol', LookupM::getItems('satuanumum'), array('class' => 'span2', 'onkeypress' => "return $(this).focusNextInputField(event);", 'maxlength' => 50, 'readonly'=>true)); ?>
                                </div>
                            </div>
                            <?php echo $form->textFieldRow($modPenUmum, 'hargasatuan', array('readonly'=>true,  'class' => 'inputFormTabel integer2 reqForm span3', 'onkeypress' => "return $(this).focusNextInputField(event);")); ?>
                        </div>
                        <div class="col-sm-6">
            ...
            <div class="panel panel-success">
                <div class="panel-heading">
                    <div class="panel-title"><span hidden><?php echo CHtml::checkBox('pakeAsuransi', true, array('onchange' => 'bukaUraian(this)', 'onkeypress' => "return $(this).focusNextInputField(event);")); ?></span>
                        Uraian Iur Bea</div>
                </div>
                <div class="panel-body">
                    <fieldset class="">
...
<!--/div-->
<?php $this->renderPartial($this->path_view . '_jsFunctionsKunjungan', array('modKunjungan' => $modKunjungan, 'form' => $form)); ?>
