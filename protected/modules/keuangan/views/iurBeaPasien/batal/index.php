    ...
    <div class="col-md-12">
        <div class="panel panel-gradient">
            <div class="panel-heading">
                <div class="panel-title">Transaksi <strong>Batal Iur Bea Pasien</strong></div>
            </div>
            <div class="panel-body">
                ...
                <div class="panel panel-success">
                    <div class="panel-heading">
                        <div class="panel-title">Daftar Pasien Iur Biaya</div>
                    </div>
                    <div class="panel-body">
                        <?php $this->renderPartial($this->path_view . 'batal/_formIurBiaya', ['form' => $form]) ?>
                    </div>
                </div>
                
                <?php $this->renderPartial($this->path_view.'batal/_jsFunctions', array('modKunjungan'=>$modKunjungan,'model'=>$model)); ?>
