<?php $linkHalaman = CustomFunction::getUrlByMenuID(3520); ?>
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="entypo-info-circled"></i> Informasi <b>Setoran Utang Pajak Pengeluaran Kas</b>
    ...
    <div class="panel-body">
        ...
        $this->breadcrumbs = array(
            'Informasi Setoran Utang Pajak Pengeluaran Kas',
        );
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="entypo-credit-card"></i> Tabel <b>Setoran Utang Pajak Pengeluaran Kas</b>
                </div>
            </div>
            <div class="panel-body table-responsive">
                ...
                $this->widget('ext.bootstrap.widgets.HeaderGroupGridViewNonRp', array(
                    ...
                    'dataProvider' => $model->searchInformasiPengeluaranKas(),
                    'template' => "{summary}\n{items}\n{pager}",
                    ...
                    'columns' => array(
                        ...
                        array(
                            ...
                            'value' => 'CHtml::link("<i class=\'icon-form-detail\'></i> ",Yii::app()->createUrl("keuangan/InformasiSetoranHutangPajak/rincian",array("tandabuktikeluar_id"=>$data->tandabuktikeluar_id)) ,array("title"=>"Klik untuk Melihat Rincian Setoran Utang Pajak Pengeluaran Kas","target"=>"iframe", "onclick"=>"$(\"#dialogRincianPajak\").dialog(\"open\");", "rel"=>"tooltip"))',
                        ),
                        array(
                            'header' => 'Batal',
                            'type' => 'raw',
                            'value' => function ($data) {
                                return (!empty($data->batalpegawai_id) ? "SUDAH DIBATALKAN" : CHtml::link("<i class='icon-form-silang'></i>", 'javascript:dialogBatalPajak(' . $data->tandabuktikeluar_id . ')', array("id" => $data->tandabuktikeluar_id, "rel" => "tooltip", "title" => "Klik untuk membatalkan Setoran Utang Pajak Pengeluaran Kas", "data-placement" => "left")));
                            },
...
$this->beginWidget('zii.widgets.jui.CJuiDialog', array(
    ...
    'options' => array(
        'title' => 'Rincian Setoran Utang Pajak Pengeluaran Kas',
        'autoOpen' => false,
        'minWidth' => 1100,
        'minHeight' => 100,
        'resizable' => false,
...
$this->beginWidget('zii.widgets.jui.CJuiDialog', array(
    ...
    'options' => array(
        'title' => 'Form Pembatalan Setoran Utang Pajak Pengeluaran Kas',
        'autoOpen' => false,
        'show' => 'blind',
        'hide' => 'explode',
        'zIndex' => 1002,
