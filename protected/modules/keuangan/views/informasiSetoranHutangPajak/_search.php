...
<div class="row">
    <div class="col-sm-6">
        ...
        <div class="control-group">
            <?php echo CHtml::label(CHtml::activeCheckBox($model, 'ceklis') . " <label for='KUInformasisetoranhutangpajakV_ceklis'>Tanggal Penyetoran</label>", '', array('class' => 'control-label')) ?>
            <div class="controls">
        ...
        <?php echo $form->textFieldRow($model, 'no_setorpajakpembelian', array('placeholder' => 'No. Penyetoran', 'class' => 'span3')); ?>
    </div>
    <div class="col-sm-6">
        <div class="control-group">
