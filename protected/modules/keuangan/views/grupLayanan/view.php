<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="far fa-eye"></i> Lihat <b>Grup Layanan</b>
        </div>
    </div>
    <div class="panel-body table-responsive">
        ...
        <?php $this->widget('ext.bootstrap.widgets.BootDetailView', array(
            ...
            'attributes' => array(
                ...
                'grouplayanan_kode',
                'grouplayanan_nama',
                'grouplayanan_namalain',
                'grouplayanan_definisi',
                'grouplayanan_order',
                array(               // related city displayed as a link
                    'name' => 'is_oa',
                    'type' => 'raw',
                    'value' => (($model->is_oa == True) ? 'Jenis Obat dan Alkes' : 'Tindakan'),
                ),
                array(               // related city displayed as a link
                    'name' => 'grouplayanan_aktif',
                    'type' => 'raw',
                    'value' => (($model->grouplayanan_aktif == True) ? Yii::t('mds', 'Yes') : Yii::t('mds', 'No')),
                ),
            ),
        )); ?>
