<?php $form = $this->beginWidget('ext.bootstrap.widgets.BootActiveForm', array(
    ...
    'method' => 'get',
    'id' => 'pembayaranbonusthr-info-search',
    'type' => 'horizontal',
)); ?>
<div class="row">
    <div class="col-sm-6">
        ...
        <div class="control-group">
            <?php echo CHtml::label(CHtml::activeCheckBox($model, 'ceklis') . " <label for='InformasipembayaranbonusthrV_ceklis'>Tanggal Pembayaran</label>", '', array('class' => 'control-label')) ?>
            <div class="controls">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $form->textField($model, 'nopembayaran', array('placeholder' => 'No. Pembayaran', 'class' => 'span3')); ?>
            </div>
        </div>
    </div>
    <div class="col-sm-6">
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $form->dropDownList($model, 'jenisgaji', LookupM::getItemsUrutan('jenisgaji'), array('empty' => '-- Pilih --', 'class' => 'span3')); ?>
            </div>
        </div>
        <div class="control-group">
