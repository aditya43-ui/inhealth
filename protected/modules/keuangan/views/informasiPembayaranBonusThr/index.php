<?php $linkHalaman = CustomFunction::getUrlByMenuID(3544); ?>
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="entypo-info-circled"></i> Informasi <b>Pembayaran THR / Bonus Pegawai</b>
    ...
    <div class="panel-body">
        ...
        $this->breadcrumbs = array(
            'Informasi Pembayaran THR / Bonus Pegawai',
        );
        Yii::app()->clientScript->registerScript('search', "
            $('#pembayaranbonusthr-info-search').submit(function(){
                    $.fn.yiiGridView.update('pembayaranbonusthr-info-grid', {
                            data: $(this).serialize()
                    });
                    return false;
            });
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="entypo-credit-card"></i> Tabel <b>Pembayaran THR / Bonus Pegawai</b>
                </div>
            </div>
            <div class="panel-body table-responsive">
                <div class="block-tabel">
                    ...
                    $this->widget('ext.bootstrap.widgets.HeaderGroupGridViewNonRp', array(
                        'id' => 'pembayaranbonusthr-info-grid',
                        ...
                        'columns' => array(
                            ...
                            array(
                                ...
                                'type' => 'raw',
                                'value' => '$data->jenisgaji',
                            ),
                            array(
                                'header' => 'Total Utang',
                                'value' => '"Rp ". number_format($data->totalhutang,2,",",".")',
                                'htmlOptions' => array('style' => 'text-align:right;')
                            ),
                            array(
                                'header' => 'Total Yang DIbayarkan',
                                'value' => '"Rp ". number_format($data->totaldibayarkan,2,",",".")',
                                'htmlOptions' => array('style' => 'text-align:right;')
                            ),
                            array(
                            ...
                            array(
                                ...
                                'value' => '"Rp ". number_format($data->totalsisahutang,2,",",".")',
                                'htmlOptions' => array('style' => 'text-align:right;')
                            ),
                            array(
                                'header' => 'Petugas',
                            ...
                            array(
                                ...
                                'value' => 'CHtml::link("<i class=\'icon-form-detail\'></i> ",Yii::app()->createUrl("keuangan/InformasiPembayaranBonusThr/rincian",array("tandabuktikeluar_id"=>$data->tandabuktikeluar_id)) ,array("title"=>"Klik untuk Melihat Rincian Pembayaran THR / Bonus Pegawai","target"=>"iframe", "onclick"=>"$(\"#dialogRincianPajak\").dialog(\"open\");", "rel"=>"tooltip"))',
                            ),
                            array(
                                'header' => 'Batal',
                                'type' => 'raw',
                                'value' => function ($data) {
                                    return (!empty($data->pegawaibatal_id) ? "SUDAH DIBATALKAN" : CHtml::link("<i class='icon-form-silang'></i>", 'javascript:dialogBatalPajak(' . $data->tandabuktikeluar_id . ')', array("id" => $data->tandabuktikeluar_id, "rel" => "tooltip", "title" => "Klik untuk membatalkan Pembayaran THR / Bonus Pegawai", "data-placement" => "left")));
                                },
...
$this->beginWidget('zii.widgets.jui.CJuiDialog', array(
    ...
    'options' => array(
        'title' => 'Rincian Pembayaran THR / Bonus Pegawai',
        'autoOpen' => false,
        'minWidth' => 1100,
        'minHeight' => 100,
        'resizable' => false,
...
$this->beginWidget('zii.widgets.jui.CJuiDialog', array(
    ...
    'options' => array(
        'title' => 'Form Pembatalan Pembayaran THR / Bonus Pegawai',
        'autoOpen' => false,
        'show' => 'blind',
        'hide' => 'explode',
        'zIndex' => 1002,
...
<script type="text/javascript">
    ...
    function ubahFakturKarenaBatal() {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo $this->createUrl('PembatalanPembayaran'); ?>',
            data: {
