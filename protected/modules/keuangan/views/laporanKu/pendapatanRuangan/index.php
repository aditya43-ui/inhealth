...
$url = Yii::app()->createUrl('/' . $module . '/' . $controller . '/frameGrafikPendapatanRuangan&id=1');
        ...
        <div class="panel panel-gradient">
            ...
            <div class="panel-body">
                <div class="panel panel-success">
                    ...
                    <div class="panel-body">
                        <div class="search-form">
                            <?php $this->renderPartial($this->path_view_ku . 'pendapatanRuangan/_search', array(
                                'model' => $model,
                            )); ?>
                        </div><!--search-form-->
                    </div>
                ...
                <div class="panel panel-success">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <i class="entypo-credit-card"></i> Tabel <b>Pendapatan Ruangan</b>
                        </div>
                    </div>
                    <div class="panel-body table-responsive">
                        <?php $this->renderPartial($this->path_view_ku . 'pendapatanRuangan/_tableBaru', array('model' => $model)); ?>
                    </div>
                </div>
                <div class="panel panel-success">
                    <div class="panel-heading">
                ...
                $urlPrint =  Yii::app()->createAbsoluteUrl($module . '/' . $controller . '/printPendapatanRuangan');
