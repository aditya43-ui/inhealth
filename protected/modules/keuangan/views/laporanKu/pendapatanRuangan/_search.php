    ...
    <div class="row">
		...
		<div id='searching'>
			<div class="control-group">
				...
				<div class="controls">
					<?php echo $form->dropDownList($model,'dokterpemeriksa1_id',  CHtml::listData(DokterV::model()->findAll("pegawai_aktif = TRUE "), 'pegawai_id', 'namaLengkap'),array(
					'class'=>'form-control', 'multiple'=>'multiple')); ?>
				</div>
			</div>								
		</div>	
        ...
        <div class="col-sm-6">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    $criIns->addCondition(" revenuecenter IS TRUE ");
...
<script>
    function CekCaraBayar() {
        ...
        if (!jQuery.isNumeric(carabayar)) {
            //myAlert('Isi terlebih dahulu Jenis Penjamin');
            // return false;
        } else {
            //  $('#searchLaporan');
        }
