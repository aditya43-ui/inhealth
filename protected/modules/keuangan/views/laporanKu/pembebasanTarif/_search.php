    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <div id='searching'>
                ...
                <div class="control-group">
                    <?php echo CHtml::label('Dokter', 'nama_pegawai', array('class' => 'control-label')) ?>
                    <div class="controls">
                        <?php echo $form->dropDownList($model, 'pegawai_id',  CHtml::listData(DokterV::model()->findAll("pegawai_aktif = TRUE "), 'pegawai_id', 'namaLengkap'), array(
                            'class' => 'form-control', 'multiple' => 'multiple'
                        )); ?>
                    </div>
                </div>
				...
				'content'=>array(
					'content3'=>array(
						...
						'isi'=>'<table >
									...
									'class'=>'span3','onkeypress' => "return $(this).focusNextInputField(event)",'sourceUrl'=> $this->createUrl('/ActionAutoComplete/DaftarAllDokter'),'placeholder'=>'Nama Dokter')).'<a href="javascript:void(0);" id="tombolDokterDialog" onclick="$(&quot;#dialogDokter&quot;).dialog(&quot;open&quot;);return false;">
								<i class="icon-list"></i>
			...
			echo CHtml::hiddenField('idSupplier'); */ ?>
                ...
                //
                //                                        ),
                //                                        'htmlOptions'=>array('onkeypress'=>"return $(this).focusNextInputField(event)",'class'=>'span3','placeholder'=>'Nama Dokter'),
