        ...
        <div class="panel panel-gradient">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="entypo-newspaper"></i> Laporan <b>Frekuensi Layanan</b>
                </div>
            </div>
            <div class="panel-body">
                <div class="panel panel-success">
                    ...
                    <div class="panel-body">
                        ...
                        <?php $this->renderPartial($this->path_view_ku . 'frekuensiLayanan._search', array(
                            'model' => $model,
                        )); ?>
                        <!--</fieldset>-->
                        <!--search-form-->
                ...
                <div class="panel panel-success">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <i class="entypo-credit-card"></i> Tabel <b>Frekuensi Layanan</b>
                        </div>
                    </div>
                    <div class="panel-body table-responsive">
                        <?php $this->renderPartial($this->path_view_ku . 'frekuensiLayanan._table', array('model' => $model)); ?>
                    </div>
                </div>
                ...
                $urlPrint =  Yii::app()->createAbsoluteUrl($module . '/' . $controller . '/printFrekuensiLayanan');
                $url = Yii::app()->createUrl($module . '/' . $controller . '/FrameGrafikFrekuensiLayanan&id=1');
