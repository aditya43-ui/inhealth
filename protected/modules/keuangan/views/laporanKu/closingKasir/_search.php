<div class="search-form">
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            //						'isi'=>'<table >
            //									<tr>
            //									<td >'.CHtml::hiddenField('pegawai_id')
            ...
            //									'class'=>'span3','onkeypress' => "return $(this).focusNextInputField(event)",'sourceUrl'=> $this->createUrl('ActionAutoComplete/ListKaryawan'),'placeholder'=>'Nama Pegawai')).'<a href="javascript:void(0);" id="tombolDokterDialog" onclick="$(&quot;#dialogDokter&quot;).dialog(&quot;open&quot;);return false;">
            //								<i class="icon-list"></i>
        ...
        <div class="col-sm-6">
            <div class="control-group">
                ...
                ?>
                <?php echo CHtml::label('Kasir', 'nama_pegawai', array('class' => 'control-label')) ?>
                <div class="controls">
     ...
     */ ?>
        ...
        <div class="col-sm-6">
            <div class="control-group">
                ...
                <div class="controls">
                    <?php echo $form->dropDownList($model, 'shift_id', Chtml::listData($model->ShiftItems, 'shift_id', 'shift_nama'), array(
                        'class' => 'form-control', 'multiple' => 'multiple'
                    )); ?>
                </div>
                <?php
