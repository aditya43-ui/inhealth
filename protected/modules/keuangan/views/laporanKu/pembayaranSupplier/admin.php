...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="entypo-newspaper"></i> Laporan <b>Pembayaran Supplier</b>
        </div>
    </div>
    <div class="panel-body">
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                ...
                <?php $this->renderPartial($this->path_view_ku . 'pembayaranSupplier._search', array(
                    'model' => $model,
                )); ?>
                <!--</fieldset>-->
                <!--search-form-->
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="entypo-credit-card"></i> Tabel <b>Pembayaran Supplier</b>
                </div>
            </div>
            <div class="panel-body table-responsive">
                <?php $this->renderPartial($this->path_view_ku . 'pembayaranSupplier._table', array('model' => $model)); ?>
            </div>
        </div>
        ...
        $urlPrint =  Yii::app()->createAbsoluteUrl($module . '/' . $controller . '/printPembayaranSupplier');
        $url = Yii::app()->createUrl($module . '/' . $controller . '/FrameGrafikPembayaranSupplier&id=1');
