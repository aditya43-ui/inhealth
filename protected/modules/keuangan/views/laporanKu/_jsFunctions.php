...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		var dokterperiksa1 = jQuery('#<?php echo CHtml::activeId($model, 'dokterpemeriksa1_id') ?>');	
		var shift = jQuery('#<?php echo CHtml::activeId($model, 'shift_id') ?>');	
		var pegawai_id = jQuery('#<?php echo CHtml::activeId($model, 'pegawai_id') ?>');
		var supplier_id = jQuery('#<?php echo CHtml::activeId($model, 'supplier_id') ?>');
		var supplier_jenis = jQuery('#<?php echo CHtml::activeId($model, 'supplier_jenis') ?>');
		...
		* multi select propinsi dan kabupaten
		...
		jQuery(dokterperiksa1).multiselect({
			includeSelectAllOption: true,
			buttonClass: "form-control",
			maxHeight: 300,
			buttonWidth: '182px',
		...
		jQuery(supplier_jenis).multiselect({
			includeSelectAllOption: true,
			buttonClass: "form-control",
			maxHeight: 300,
			buttonWidth: '182px',
			enableCaseInsensitiveFiltering: true,
			onChange: function(element, checked) {				
					var ins  = jQuery('#<?php echo CHtml::activeId($model, 'supplier_jenis') ?>');
					var ins_all = jQuery('#<?php echo CHtml::activeId($model, 'supplier_jenis') ?>   option:selected');
					var ru  = jQuery('#<?php echo CHtml::activeId($model, 'supplier_id') ?>');
					...
					jQuery.ajax({
						type:'POST',
						url: '<?php echo $this->createUrl('/ActionDynamic/GetSupplierMultiSelectByJenis') ?>',					
						dataType: "json",
						data: {supplier_jenis:selected},
						success: function(data){	
