<div class="search-form">
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            ...
            <div class="control-group">
                <?php echo CHtml::label('Data Grafik', '', array('class' => 'control-label')); ?>
                <div class="controls">
                    <?php echo CHtml::radioButton('dataGrafik', false, array('id' => 'carabayar', 'value' => 'carabayar')); ?><label for="carabayar">Jenis Penjamin</label><br>
                    <?php echo CHtml::radioButton('dataGrafik', false, array('id' => 'dokter', 'value' => 'dokter')); ?> <label for="dokter">Dokter</label><br>
                    <?php echo CHtml::radioButton('dataGrafik', false, array('id' => 'instalasi', 'value' => 'instalasi')); ?> <label for="instalasi">Instalasi</label>
                </div>
            </div>
        </div>
    </div>
