...
$url = Yii::app()->createUrl('/' . $module . '/' . $controller . '/frameGrafikJasaInstalasi&id=1');
        ...
        <div class="panel panel-gradient">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="entypo-newspaper"></i> Laporan <b>Jasa Instalasi</b>
                </div>
            </div>
            <div class="panel-body">
                <div class="panel panel-success">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="box search-form">
                            <?php $this->renderPartial($this->path_view_ku . 'jasaInstalasi/_search', array(
                                'model' => $model,
                            )); ?>
                        </div>
                        <!--search-form-->
                ...
                <div class="panel panel-success">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <i class="entypo-credit-card"></i> Tabel <b>Jasa Instalasi</b>
                        </div>
                    </div>
                    <div class="panel-body table-responsive">
                        <div class="block-tabel">
                            <?php $this->renderPartial($this->path_view_ku . 'jasaInstalasi/_table', array('model' => $model)); ?>
                        </div>
                    </div>
                </div>
                <div class="panel panel-success">
                ...
                $urlPrint =  Yii::app()->createAbsoluteUrl($module . '/' . $controller . '/printJasaInstalasi');
