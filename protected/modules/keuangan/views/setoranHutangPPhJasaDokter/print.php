        ...
        <tr>
            <td>
                ...
                <div class="judulcontent">
                    <b>RINCIAN SETORAN HUTANG PPh 21 JASA DOKTER</b>
                </div>
                ...
                <table width="85%" style='margin-left:auto; margin-right:auto;' class ="border">
                    ...
                    ?>
                         <tr class="border">
                            <td><?php echo ($i+1)."."; ?></td>
                            <td><?php echo (isset($modPeg)? MyFormatter::getMonthId(date('m', strtotime($modPeg->periodejasa)))." ".date('Y', strtotime($modPeg->periodegaji)) : ""); ?></td>
