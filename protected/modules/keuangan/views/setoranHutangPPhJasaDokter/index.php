<?php $linkHalaman = CustomFunction::getUrlByMenuID(3523); ?>
<?php Yii::app()->clientScript->registerScriptFile(Yii::app()->baseUrl . '/js/accounting2.js', CClientScript::POS_END); ?>
<?php Yii::app()->clientScript->registerScriptFile(Yii::app()->baseUrl . '/js/form2.js', CClientScript::POS_END); ?>
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="glyphicon glyphicon-briefcase"></i> Transaksi <b>Setoran Pajak Hutang Pph 21 Jasa Dokter</b>
    ...
    <div class="panel-body">
        ...
        $this->breadcrumbs = array(
            'Setoran Pajak Hutang Pph 21 Jasa Dokter',
        );
        ?>
        <?php $form = $this->beginWidget('ext.bootstrap.widgets.BootActiveForm', array(
            'id' => 'setoranhutangpphjasadokter-t-form',
        ...
        <div class="form-actions">
            ...
            echo CHtml::htmlButton(
                ...
                array(
                    'title' => 'Simpan',
                    'class' => 'btn btn-danger', 'type' => 'button', 'onKeypress' => 'validasiFaktur();', 'onclick' => 'validasiFaktur();',
                    'disabled' => $disabled
                )
            );
            echo CHtml::link(
