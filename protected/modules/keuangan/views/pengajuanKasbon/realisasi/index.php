<?php $linkHalaman = $this->createUrl('informasi') ?>
<div id="input-penerimaan-kas">
    <div class="panel panel-gradient">
        <div class="panel-heading">
            <div class="panel-title">
                <i class="glyphicon glyphicon-briefcase"></i> Transaksi <b>Realisasi Kas (Kasbon)</b>
        ...
        <div class="panel-body">
            ...
            <div class="panel  panel-success form-dis">
                ...
                <div class="panel-body">     
                    <?php echo $form->hiddenField($model, 'pengajuankasbon_id'); ?>                   
                    <?php echo $this->renderPartial($this->path_view . 'realisasi/_info', array('model' => $model, 'form' => $form)); ?>
                </div>
            </div>
            <div class="panel  panel-success form-dis">
                <div class="panel-heading">
                    <div class="panel-title">Realisasi</div>
                </div>
                <div class="panel-body"> 
                    <div class="row-fluid">
                        <div class="col-sm-6">
                    ...
                    <fieldset class="">
                        <div id="div_tblInputUraian">
                            <table id="tblInputUraian" class="table table-bordered table-striped table-condensed">
                                ...
                                <tbody>
                                    <?php $this->renderPartial($this->path_view . 'realisasi/_rowUraian', array('form' => $form, 'modUraian' => $modUraian)); ?>
                                </tbody>
                            </table>
                        </div>
                    </fieldset>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div style="overflow-x: auto;max-width: 100%">
                                    <?php
                                    $this->renderPartial(
                                        $this->path_view . 'realisasi/_rowListRekening',
                                        array(
                                            'form' => $form,
                                            'modUraian' => $modUraian,
                                        )
...
<!--/div-->
<?php $this->renderPartial($this->path_view . 'realisasi/_jsFunctions', array('modPenUmum' => $modPenUmum, 'form' => $form, 'modUraian' => $modUraian, 'modTandaBukti' => $modTandaBukti)); ?>
<?php $this->endWidget(); ?>
<?php
