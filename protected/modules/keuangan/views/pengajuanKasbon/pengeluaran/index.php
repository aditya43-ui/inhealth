    ...
    <div class="panel panel-gradient">
        <div class="panel-heading">
            <div class="panel-title">
                <i class="fas fa-money-bill"></i> Transaksi <b>Pengeluaran Kas (Kasbon)</b>
        ...
        <div class="panel-body">
            ...
            <div class="panel  panel-success form-dis">
                ...
                <div class="panel-body">     
                    ...
                    <?php echo $this->renderPartial($this->path_view . 'pengeluaran/_info', array('model' => $model, 'form' => $form)); ?>
                </div>
            </div>

            <div class="panel  panel-success form-dis">
                <div class="panel-heading">
                    <div class="panel-title">Pengeluaran Kas</div>
                </div>
                <div class="panel-body">
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="col-sm-6">
                            ...
                            <?php echo $form->hiddenField($modPengUmum, 'pegawaimengetahui_id', array('class'=>'pegawaimengetahui_id')); ?>
...
<?php $this->renderPartial($this->path_view . 'pengeluaran/_jsFunctions', array('modPengUmum' => $modPengUmum, 'form' => $form, 'modUraian' => $modUraian, 'modBuktiKeluar' => $modBuktiKeluar)); ?>
<?php $this->endWidget(); ?>
