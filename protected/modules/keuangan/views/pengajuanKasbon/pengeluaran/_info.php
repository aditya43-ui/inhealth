...
$this->widget('ext.bootstrap.widgets.BootGridView',array(
	...
	'dataProvider'=>$model->searchInformasiUntukPengeluaranKas(),
	'filter'=>$model,
	'template'=>"{summary}\n{items}\n{pager}",
	...
	'columns'=>array(
		array(
			...
			'value'=>'CHtml::Link("<i class=\"icon-form-check\"></i>","#",array("class"=>"btn-small",
                    ...
                    window.location.replace(\"".Yii::app()->controller->createUrl("pengeluaranKas", array("id"=>$data->pengajuankasbon_id))."\");
					return false;
			"))',
		),
        [
