...
<div class="panel  panel-success form-dis">
    ...
    <div class="panel-body">                        
        <?php echo $this->renderPartial($this->path_view . 'form/_1_pengajuanKasbon', array('model' => $model, 'form' => $form)); ?>
    </div>
</div>
...
<div class="panel  panel-success form-dis">
    ...
    <div class="panel-body">                        
        <?php
        echo $this->renderPartial($this->path_view . 'form/_2_formApproval', array(
            'model' => $model,
            'form' => $form,
        ));
        ?>
