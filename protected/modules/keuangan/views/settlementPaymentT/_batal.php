...
<div class="row">
	<div class="col-sm-12">
        ...
        <?php echo $form->textFieldRow($modInvoice,'tglpembatalan',array('class'=>'span3','readonly'=>true))?>
		...
		<div class="control-group">
			<label for="alasanpembatalan" class="control-label required">Alasan Pembatalan <span class="required">*</span></label>
			<div class="controls">
					<?php echo $form->textArea($modInvoice,'alasanpembatalan',array('class'=>'span3'))?>
			</div>
		</div>
