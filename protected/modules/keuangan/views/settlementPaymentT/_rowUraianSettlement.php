...
if(count((array)$modSettlementPaymentDetails) > 0) {
    //$this->renderPartial('_cekSettlementDetails',array('modSettlementPaymentDetails'=>$modSettlementPaymentDetails,'removeButton'=>true));
} else {
...
<tr>
    ...
    <td>
        ...
        <?php 
            $modSettlementPaymentDetail->tgltransaksi = MyFormatter::formatDateTimeForUser($modSettlementPaymentDetail->tgltransaksi);
  ...
  <td>
    <?php echo CHtml::activeTextField($modSettlementPaymentDetail, '[0]volume', array('class'=>'inputFormTabel integer span2','onblur'=>'hitungTotalUraian(this);calculateTotalRow();')) ?>
  </td>
  <td>
  ...
  <td>
    <?php echo CHtml::activeTextField($modSettlementPaymentDetail, '[0]hargasatuan', array('class'=>'inputFormTabel integer-decimal span2','onblur'=>'hitungTotalUraian(this);calculateTotalRow()')) ?>
  </td>
  <td>
    <?php echo CHtml::activeTextField($modSettlementPaymentDetail, '[0]totalharga', array('readonly'=>true,'class'=>'inputFormTabel integer-decimal span2 totalharga')) ?>
  </td>
  <td><?php echo CHtml::activeHiddenField($modSettlementPaymentDetail, '[0]rekening5_id', array('readonly'=>true,'class'=>'inputFormTabel span3')) ?>
  <?php
  $this->widget('MyJuiAutoComplete', array(
                        'model' => $modSettlementPaymentDetail,
