<?php $form = $this->beginWidget('ext.bootstrap.widgets.BootActiveForm', array(
    ...
    'method' => 'get',
    'id' => 'setoranhutangpajak-info-search',
    'type' => 'horizontal',
)); ?>
<div class="row">
    <div class="col-sm-6">
        ...
        <div class="control-group">
            <?php echo CHtml::label(CHtml::activeCheckBox($model, 'ceklis') . " <label for='KUInformasisetoranppnkeluaranV_ceklis'>Tanggal Pembayaran</label>", '', array('class' => 'control-label')) ?>
            <div class="controls">
    ...
    <div class="col-sm-6">
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $form->dropDownList($model, 'pajak_id', CHtml::listData(PajakM::model()->findAll('pajak_aktif = true and isppnkeluaran = true'), 'pajak_id', 'pajak_nama'), array('empty' => '-- Pilih --', 'class' => 'span3')); ?>
            </div>
        </div>
        <div class="control-group">
