<?php $linkHalaman = CustomFunction::getUrlByMenuID(3535); ?>
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="entypo-info-circled"></i> Informasi <b>Setoran Utang PPN Keluaran</b>
    ...
    <div class="panel-body">
        ...
        $this->breadcrumbs = array(
            'Informasi Setoran Utang PPN Keluaran',
        );
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="entypo-credit-card"></i> Tabel <b>Setoran Setoran Utang PPN Keluaran</b>
                </div>
            </div>
                ...
                $this->widget('ext.bootstrap.widgets.HeaderGroupGridViewNonRp', array(
                    ...
                    'columns' => array(
                        ...
                        array(
                            ...
                            'value' => 'CHtml::link("<i class=\'icon-form-detail\'></i> ",Yii::app()->createUrl("keuangan/InformasiSetoranHutangPPN/rincian",array("tandabuktikeluar_id"=>$data->tandabuktikeluar_id)) ,array("title"=>"Klik untuk Melihat Rincian Setoran Utang PPN Keluaran","target"=>"iframe", "onclick"=>"$(\"#dialogRincianPajak\").dialog(\"open\");", "rel"=>"tooltip"))',
                        ),
                        array(
                            'header' => 'Batal',
                            'type' => 'raw',
                            'value' => function ($data) {
                                return (!empty($data->batalpegawai_id) ? "SUDAH DIBATALKAN" : CHtml::link("<i class='icon-form-silang'></i>", 'javascript:dialogBatalPajak(' . $data->tandabuktikeluar_id . ')', array("id" => $data->tandabuktikeluar_id, "rel" => "tooltip", "title" => "Klik untuk membatalkan Setoran Utang PPN Keluaran", "data-placement" => "left")));
                            },
...
$this->beginWidget('zii.widgets.jui.CJuiDialog', array(
    ...
    'options' => array(
        'title' => 'Rincian Setoran Utang PPN Keluaran',
        'autoOpen' => false,
        'minWidth' => 1100,
        'minHeight' => 100,
        'resizable' => false,
...
$this->beginWidget('zii.widgets.jui.CJuiDialog', array(
    ...
    'options' => array(
        'title' => 'Form Pembatalan Setoran Utang PPN Keluaran',
        'autoOpen' => false,
        'show' => 'blind',
        'hide' => 'explode',
        'zIndex' => 1002,
