    ...
    <div class="panel-body">
        <table width="100%" class="table table-condensed">
            ...
            <tr>
                ...
                <td><?php echo CHtml::textField('KUTandabuktibayarT[jmlpembayaran]', $modBuktiBayar->jmlpembayaran, array('class' => 'integer2', 'readonly' => true)); ?></td>
            </tr>
            <tr>
                ...
                <td><?php echo CHtml::textField('KUTandabuktibayarT[biayaadministrasi]', $modBuktiBayar->biayaadministrasi, array('class' => 'integer2', 'readonly' => true)); ?></td>
            </tr>
        </table>
    </div>
</div>
