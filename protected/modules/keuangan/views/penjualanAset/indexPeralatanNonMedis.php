        ...
        <div class="panel panel-gradient">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="glyphicon glyphicon-briefcase"></i> Transaksi <b>Penjualan Aset Peralatan Non Medis</b>
                </div>
            </div>
            <div class="panel-body">
                <fieldset id="input-penjualanaset">
                    ...
                    <div class="panel panel-success">
                        <div class="panel-heading">
                            <div class="panel-title">
                                <i class="entypo-search"></i> Pencarian Aset Peralatan Non Medis
                            </div>
                        </div>
                        <div class="panel-body">
                            <div class="col-sm-6">
                                <fieldset class="box">
                                    ...
                                    <div class="form-actions">
                                        <?php echo CHtml::htmlButton(Yii::t('mds', '{icon} Search', array('{icon}' => '<i class="entypo-search"></i>')), array('class' => 'btn btn-danger', 'type' => 'button', 'onclick' => 'ambilDataPenghapusanPeralatanNonMedis(); return false;')); ?>
                                    </div>
                                </fieldset>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-success">
                        <div class="panel-heading">
                            <div class="panel-title">
                                <i class="entypo-credit-card"></i> Tabel <b>Peralatan Non-Medis</b>
                            </div>
                        </div>
                    ...
                    <div class="form-actions">
                        ...
                        <?php echo CHtml::htmlButton(Yii::t('mds', '{icon} Save', array('{icon}' => '<i class="entypo-check"></i>')), array('class' => 'btn btn-danger', 'type' => 'button', 'onclick' => 'cekSimpanPeralatanNonMedis()', 'onkeypress' => 'cekSimpanPeralatanNonMedis()', 'disabled' => $disableSave)); ?>
                        <?php
