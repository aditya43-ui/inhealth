        ...
        <div class="panel panel-gradient">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="glyphicon glyphicon-briefcase"></i> Transaksi <b>Penjualan Kendaraan</b>
                </div>
            </div>
            <div class="panel-body">
                <fieldset id="input-penjualanaset">
                    ...
                    <div class="panel panel-success">
                        <div class="panel-heading">
                            <div class="panel-title">
                                <i class="entypo-search"></i> Pencarian Kendaraan
                            </div>
                        </div>
                        <div class="panel-body">
                            <fieldset class="box">
                                ...
                                <div class="form-actions">
                                    <?php echo CHtml::htmlButton(Yii::t('mds', '{icon} Search', array('{icon}' => '<i class="entypo-search"></i>')), array('class' => 'btn btn-danger', 'type' => 'button', 'onclick' => 'ambilDataPenghapusanKendaraan(); return false;')); ?>
                                </div>
                            </fieldset>
                        </div>
                    </div>
                    <div class="panel panel-success">
                        <div class="panel-heading">
                            <div class="panel-title">
                                <i class="entypo-credit-card"></i> Tabel <b>Kendaraan</b>
                            </div>
                        </div>
                    ...
                    <div class="form-actions">
                        ...
                        <?php echo CHtml::htmlButton(Yii::t('mds', '{icon} Save', array('{icon}' => '<i class="entypo-check"></i>')), array('class' => 'btn btn-danger', 'type' => 'button', 'onclick' => 'cekSimpanKendaraan()', 'onkeypress' => 'cekSimpanKendaraan()', 'disabled' => $disableSave)); ?>
                        <?php
