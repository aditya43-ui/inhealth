<?php $linkHalaman = CustomFunction::getUrlByMenuID(3545); ?>
...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="glyphicon glyphicon-briefcase"></i> Transaksi <b>Pembayaran <span class="jenistransaksi">THR / Bonus</span> Pegawai</b>
    ...
    <div class="panel-body">
        ...
        $this->breadcrumbs = array(
            'Pembayaran Bonus / THR Pegawai',
        );
        ?>

        <?php $form = $this->beginWidget('ext.bootstrap.widgets.BootActiveForm', array(
            'id' => 'pembayaranbonusthr-t-form',
        ...
        <div class="form-actions">
            ...
            echo CHtml::htmlButton(
                ...
                array(
                    'title' => 'Simpan',
                    'class' => 'btn btn-danger', 'type' => 'button', 'onKeypress' => 'simpanPembayaran();', 'onclick' => 'simpanPembayaran();',
                    'disabled' => $disabled
                )
            ) . "&nbsp";
            echo CHtml::link(
