                ...
                <div class="col-sm-6">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            echo $form->dropDownList($model, 'instalasi_id', CHtml::listData(InstalasiM::model()->findAll('instalasi_aktif = true AND revenuecenter = TRUE ORDER BY instalasi_nama ASC'), 'instalasi_id', 'instalasi_nama'), array(
