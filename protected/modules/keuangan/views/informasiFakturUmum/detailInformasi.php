        ...
        <td width="50%">
            <table class='tab_header' style = "border: 0;">
                <tr>
                    ...
                    <td>
                        : <?php echo $modPengajuan->nopembelian; ?>
                    </td>
                </tr>
                <tr>
                    <td>No Penerimaan</td>
...
<script type='text/javascript'>
    ...
    {        
        ...
        window.open('<?php echo $this->createUrl('detailsFaktur'); ?>&terimapersediaan_id='+terimapersediaan_id+'&caraPrint='+caraprint,'printwin','left=100,top=100,width=1000,height=640');
    };                                                             
  </script>
<?php }else{ ?>
   <?php 
