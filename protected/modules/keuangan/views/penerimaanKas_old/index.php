    ...
    <div class="form-actions">
        <div style="float:left;margin-right:6px;">
           ...
           <?php echo CHtml::link(Yii::t('mds','{icon} Ulang',array('{icon}'=>'<i class="entypo-arrows-ccw"></i>')), 
            ...
            <?php
				echo CHtml::htmlButton(Yii::t('mds','{icon} Print',array('{icon}'=>'<i class="entypo-print"></i>')),array('class'=>'btn btn-info', 'type'=>'button','id'=>'printhasil','disabled'=>true,'onclick'=>'print()')); 
