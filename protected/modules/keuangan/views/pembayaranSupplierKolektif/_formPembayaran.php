    ...
    <div class="panel-body">
        <div class="row">
            <div class='col-md-6'>
                ...
                <div class="control-group">
                    <?php $model->tglbayarkesupplier = Yii::app()->dateFormatter->formatDateTime(CDateTimeParser::parse($model->tglbayarkesupplier, 'yyyy-MM-dd hh:mm:ss', 'medium', null)); ?>
                    <?php echo $form->labelEx($model, 'tglbayarkesupplier', array('class' => 'control-label inline')) ?>
                    <div class="controls">
                        <?php
            ...
            <div class='col-md-6'>
                <?php echo $form->textFieldRow($model, 'totaltagihan', array(
                    'readonly' => true,
                    'class' => 'integer-decimal span3', 'onkeypress' => "return $(this).focusNextInputField(event);"
                )); ?>
                <div class="control-group">
                    <?php echo $form->labelEx($model, 'jmldibayarkan', array('class' => 'control-label', 'label' => 'Total Yang Dibayarkan')) ?>
                    <div class="controls">
                        <?php echo $form->textField($model, 'jmldibayarkan', array(
                            'readonly' => false,
                ...
                <?php echo $form->textFieldRow($modBuktiKeluar, 'biayaadministrasi', array(
                    'onblur' => 'hitungKasKeluar();',
                    'class' => 'integer-decimal span3', 'onkeypress' => "return $(this).focusNextInputField(event);"
                )); ?>
                <?php echo $form->textFieldRow($modBuktiKeluar, 'biayaongkos_kirim', array(
                    'onblur' => 'hitungKasKeluar();',
                    'class' => 'integer-decimal span3', 'onkeypress' => "return $(this).focusNextInputField(event);"
                )); ?>
                ...
                <div class="control-group">
                    <?php echo $form->labelEx($model, 'totalsisatagihan', array('class' => 'control-label', 'label' => 'Total Sisa Tagihan')) ?>
                    <div class="controls">
