...
<div class="row">
    ...
    <div class="col-sm-6">
        <div class="control-group">
            <label class="control-label">Jenis Obat dan Alkes</label>
            <div class="controls">
                <?php
                $this->widget('MyJuiAutoComplete', array(
                    'name' => 'jenisobatalkes_nama',
                    'model' => $model,
                    'value' => $model->jenisobatalkes_nama,
                    'source' => 'js: function(request, response) {
												   $.ajax({
													   url: "' . $this->createUrl('AutocompleteDaftarTindakan') . '",
													   dataType: "json",
...
$modDaftarTindakan = new JenisobatalkesM('search');
...
$this->widget('ext.bootstrap.widgets.BootGridView', array(
    ...
    'dataProvider' => $modDaftarTindakan->searchGrupLayananJenisOa(),
                ...
                return CHtml::Link(
                    ...
                    array(
                        ...
                        "onclick" => '
										...
										$("#' . CHtml::activeId($model, 'jenisobatalkes_id') . '").val(' . $data->jenisobatalkes_id . ');
