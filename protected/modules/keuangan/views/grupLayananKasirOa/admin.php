<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="fas fa-layer-group"></i> Pengaturan <b>Grup Layanan Kasir Obat dan Alkes</b>
        </div>
    </div>
    <div class="panel-body">
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="entypo-credit-card"></i> Tabel <b>Grup Layanan Kasir Obat dan Alkes</b>
                </div>
            </div>
            <div class="panel-body table-responsive">
                <?php $this->widget('ext.bootstrap.widgets.BootGridView', array(
                    ...
                    'columns' => array(
                        ...
                        array(
                            'header' => 'Grup Layanan',
                            'value' => '$data->grouplayanan->grouplayanan_nama',
                        ),
                        array(
                        ...
                        array(
                            'header' => 'Hapus',
                            'type' => 'raw',
                            'value' => 'CHtml::link("<i class=\'' . MyIcon::getIcons('hapus') . '\'></i> ", "javascript:deleteRecord($data->grouplayanankasiroa_id)",array("id"=>"$data->grouplayanankasiroa_id","rel"=>"tooltip","title"=>"Hapus Grup Layanan"))',
                            'htmlOptions' => array('style' => 'text-align: center; width: 60px;'),
                        ),
                    ),
        ...
        <div class="form-actions">
            ...
            echo CHtml::link(
                Yii::t('mds', '{icon} Tambah Grup Layanan Kasir Obat dan Alkes', array('{icon}' => '<i class="icon-plus icon-white"></i>')),
                $this->createUrl('create', array('modul_id' => Yii::app()->session['modul_id'])),
                array('title' => 'Tambah grup layanan kasir obat & alkes', 'class' => 'btn btn-danger',)
            );
