...
<div class="form-actions">
    ...
    <?php
    echo CHtml::link(Yii::t('mds', '{icon} Reset', array('{icon}' => '<i class="entypo-arrows-ccw"></i>')), Yii::app()->createUrl($this->module->id . '/InformasiPembayaranKlaimMerchant/index'), array(
