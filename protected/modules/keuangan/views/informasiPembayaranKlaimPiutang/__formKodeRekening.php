...
//    $tr = "";
    ...
    echo CHtml::hiddenField("RekeningakuntansiV[$key][rekening5_id]", $value->rekeninglast_id, array('class'=>'rekening5_id'));
    echo '</td>';
    echo('<td>');
