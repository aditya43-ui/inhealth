        ...
        <div class="row">
            ...
            <div class='col-md-6'>
                <?php echo $form->textFieldRow($model, 'totalhutang', array(
                    'readonly' => true,
                    'class' => 'inputFormTabel integer-decimal span3', 'onkeypress' => "return $(this).focusNextInputField(event);"
                )); ?>
                <?php echo $form->textFieldRow($model, 'jmlpembayaran', array(
                    'readonly' => false,
                    'class' => 'inputFormTabel integer-decimal span3', 'onkeypress' => "return $(this).focusNextInputField(event);", 'onblur' => 'hitungPlorate(this);'
                )); ?>
