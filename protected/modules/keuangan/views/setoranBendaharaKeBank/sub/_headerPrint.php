...
<table style="width: 100%; border: none;">
    <tr>
        ...
        <td align="center">
            ...
            <div>
                Telp. <?php echo $modProfilRs->no_telp_profilrs; ?> Fax.  / <?php echo $modProfilRs->no_faksimili." - ".$modProfilRs->kabupaten->kabupaten_nama; ?> - <?php echo "Website. ".$modProfilRs->website; ?>
            </div>
        </td>
    </tr>
    <tr>
