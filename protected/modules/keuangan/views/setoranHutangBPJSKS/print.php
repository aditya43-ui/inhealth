        ...
        <tr>
            <td>
                ...
                <div class="judulcontent">  
                    <b>RINCIAN SETORAN HUTANG BPJS KESEHATAN</b>
                </div>
                    ...
                    <tr>
                        ...
                        <td width="50%">
                            <table class='table' style = "border: 0;">
                                ...
                                <?php } ?>
                                <tr>
                                    <td <?php echo $widthjenis; ?>> Total Utang </td>
                                   <td>
                ...
                <table width="85%" style='margin-left:auto; margin-right:auto;' class ="border">
                    ...
                    ?>
                         <tr class="border">
                            <td><?php echo ($i+1)."."; ?></td>
                            <td><?php echo (isset($modPeg)? MyFormatter::getMonthId(date('m', strtotime($modPeg->periodegaji)))." ".date('Y', strtotime($modPeg->periodegaji)) : ""); ?></td>
