...
class BatalVerifikasiTindakanAkomodasiController extends MyAuthController
{
  public $layout = '//layouts/column1';
  public $path_view = 'keuangan.views.batalVerifikasiTindakanAkomodasi.';
      ...
      try {
        ...
        if ($ok) {
          ...
          echo CJSON::encode(array(
            'ok'=>1,
            'msg'=>'Akomodasi gagal di order Batal Akomodasi.',
          ));
          ...
          echo CJSON::encode(array(
            'ok'=>0,
            'msg'=>'Akomodasi gagal di order Batal Akomodasi[1].',
          ));
        }
        ...
        echo CJSON::encode(array(
          'ok'=>0,
          'msg'=>'Akomodasi gagal di order Batal Akomodasi. '.$ex->getMessage(),
        ));
      }
