<div class='white-container'>
    ...
    <?php 
    echo CHtml::link(Yii::t('mds', '{icon} Tambah Bidang', array('{icon}'=>'<i class="icon-plus icon-white"></i>')), $this->createUrl('/gudangUmum/bidangM/create',array('modul_id'=> Yii::app()->session['modul_id'])), array('class' => 'btn btn-danger',));
