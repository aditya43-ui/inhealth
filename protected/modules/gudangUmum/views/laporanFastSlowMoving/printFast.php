    ...
    <table style="width: 100%; border: none;">
        ...
        <tbody>
            <tr>
                <td>
                    <div class="content">
  <?php  $this->renderPartial('_table', array('model'=>$model, 'caraPrint'=>$caraPrint, 'fast'=>true)); ?>
...
if ($caraPrint == 'GRAFIK') {
    ...
    <table style="width: 100%; border: none;">
        ...
        <tbody>
            ...
            <?php     echo $this->renderPartial('gudangUmum.views.laporan._grafik', array('model'=>$model, 'data'=>$data, 'caraPrint'=>$caraPrint, 'searchdata'=>$model->searchGrafikFastMoving()), true); ?>
