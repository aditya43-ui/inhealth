...
<table style="width:100%; padding: none; border: none;">
  <tr>
    ...
    <td>Icon <i class="entypo-calendar"></i> untuk menentukan tanggal Transaksi.</td>
  </tr>
  <tr>
    <td>2</td>
    <td>Icon <i class="icon-list-alt"></i><i class="entypo-search"></i> berfungsi untuk menampilkan list data secara detail.</td>
  </tr>
  <tr>
    <td>3</td>
