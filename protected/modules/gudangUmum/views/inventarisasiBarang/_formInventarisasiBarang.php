...
<div class="row-fluid">
    ...
    <?php echo $form->textFieldRow($model,'totalnilaipersediaan',array('class'=>'span3 integer-decimal', 'readonly'=>true)); ?>
		<?php echo $form->textFieldRow($model,'invbarang_totalnetto',array('class'=>'span3 integer-decimal', 'readonly'=>true)); ?>
