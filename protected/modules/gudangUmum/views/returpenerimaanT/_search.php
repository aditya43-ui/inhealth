...
<div class="row">
    <div class="col-sm-6">
        ...
        <?php echo $form->textFieldRow($model, 'noreturterima', array('placeholder' => 'No. Retur', 'class' => 'span3', 'maxlength' => 20)); ?>
    </div>
    <div class="col-sm-6">
        <?php echo $form->textFieldRow($model, 'nopenerimaan', array('placeholder' => 'No Penerimaan', 'class' => 'span3', 'maxlength' => 20)); ?>
