...
$this->widget('bootstrap.widgets.BootMenu', array(
    ...
    'items'=>array(
        ...
        array('label'=>'Sub Kelompok', 'url'=>$this->createUrl('/gudangUmum/subkelompokM/admin'), 'active'=>true),
        array('label'=>'Bidang', 'url'=>$this->createUrl('/gudangUmum/bidangM/admin'),),
         array('label'=>'Satuan Barang', 'url'=>$this->createUrl('/gudangUmum/lookupM/admin'),),
