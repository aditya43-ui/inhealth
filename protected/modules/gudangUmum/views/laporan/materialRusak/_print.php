    ...
    <table style="width: 100%; border: none;">
        ...
        <tbody>
            <tr>
                <td>
                    <div class="content">
 <?php  $this->renderPartial('materialRusak/_table', array('model'=>$model, 'caraPrint'=>$caraPrint)); ?>
    ...
    <table style="width: 100%; border: none;">
        ...
        <tbody>
            <tr>
             ...
             <?php     echo $this->renderPartial('_grafik', array('model'=>$model, 'data'=>$data, 'caraPrint'=>$caraPrint, 'searchdata'=>$searchdata), true); ?>
