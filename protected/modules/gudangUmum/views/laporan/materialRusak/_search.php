<div class="search-form">
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <?php
            echo CHtml::hiddenField('filter', 'kondisi_barang', array('disabled' => 'disabled')) .
                '<div class="control-group">
                ' . CHtml::label('Kondisi Barang', 'kondisi_barang', array('class' => 'control-label')) . ' 
                <div class="controls">
                    ' . $form->dropDownList($model, 'kondisi_barang', CHtml::listData(LookupM::model()->findAll("lookup_type = 'inventariskeadaan' AND lookup_aktif = TRUE AND lookup_name <> 'Baik' ORDER BY lookup_urutan ASC "), 'lookup_name', 'lookup_value'), array(
                ...
                $this->Widget('ext.bootstrap.widgets.BootAccordion', array(
                    ...
                    'content' => array(
                        'content2' => array(
                            ...
                            'isi' => CHtml::hiddenField('filter', 'kondisi_barang', array('disabled' => 'disabled')) .
                                '<div class="control-group">
                                    ' . CHtml::label('Kondisi Barang', 'kondisi_barang', array('class' => 'control-label')) . ' 
                                    <div class="controls">
                                        ' . $form->dropDownList($model, 'kondisi_barang', CHtml::listData(LookupM::model()->findAll("lookup_type = 'inventariskeadaan' AND lookup_aktif = TRUE AND lookup_name <> 'Baik' ORDER BY lookup_urutan ASC "), 'lookup_name', 'lookup_value'), array(
...
<?php //$this->render('_jsFunctions', array('model'=>$model));
?>