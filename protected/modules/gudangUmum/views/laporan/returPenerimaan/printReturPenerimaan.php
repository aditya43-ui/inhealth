    ...
    <table style="width: 100%; border: none;">
        ...
        <tbody>
            <tr>
                <td>
                    <div class="content">
  <?php  $this->renderPartial('returPenerimaan/_returPenerimaan', array('model'=>$model, 'caraPrint'=>$caraPrint)); 
     ?>
        ...
        <tbody>
            <tr>
                <td>
                   ...
                   <?php echo $this->renderPartial('_grafik', array('model'=>$model, 'data'=>$data, 'caraPrint'=>$caraPrint, 'searchdata'=>$model->searchReturpenerimaangrafik()), true); ?>
