...
if ($caraPrint == 'EXCEL') {
    ...
    echo $this->renderPartial('application.views.headerReport.headerDefaultNewExcel', array('judulLaporan' => $judulLaporan, 'periode' => $periode, 'colspan' => 13));
}
    ...
    <table style="width: 100%; border: none;">
        ...
        <tbody>
            <tr>
                <td>
                    <div class="content">
                        <?php $this->renderPartial('penerimaanPersediaan/_penerimaanPersediaan', array('model' => $model, 'caraPrint' => $caraPrint)); ?>
            ...
            <tr>
                <td>
                    <div class="content">
                        ...
                        <?php echo $this->renderPartial('_grafik', array('model' => $model, 'data' => $data, 'caraPrint' => $caraPrint, 'searchdata' => $model->searchPenerimaanPersediaangrafik()), true); ?>
