...
if ($caraPrint == 'EXCEL') {
    ...
    echo $this->renderPartial('application.views.headerReport.headerDefaultNewExcel', array('judulLaporan' => $judulLaporan, 'periode' => $periode, 'colspan' => 18));
}
    ...
    <table style="width: 100%; border: none;">
            ...
            <tr>
                <td>
                    <div class="header"><?php
                        if ($caraPrint != 'EXCEL') {
                            echo $this->renderPartial('application.views.headerReport.headerDefaultNew', array('judulLaporan' => '', 'periode' => $periode));
                        }
                        ?></div>  
                </td>
            </tr>
        ...
        <tbody>
            <tr>
                <td>
                    <div class="content">
 <?php  $this->renderPartial('pengajuanLogistik/_table', array('model'=>$model, 'caraPrint'=>$caraPrint, 'grid'=>$grid,'multipleheader'=>$multipleheader));  
     ?>
