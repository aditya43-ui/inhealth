            ...
            <tr>
                ...
                <td>
                    ...
                    <?php } else { ?>
                        ...
                        <?php echo CHtml::link("<br>Lihat Dokumen<br>", Yii::app()->controller->createUrl('pencarianPasien/detailScanRM', array('dokfilerm_id' => $dok->dokfilerm_id)), 
                            array(
                                  "class" => "",
                                  "target" => "frameGambar",
                                  "rel" => "tooltip",
...
<iframe name="frameGambar"></iframe>
<?php $this->endWidget(); ?>
