            ...
            <div class="panel-body">
                ...
                <div class="control-group">
                    ...
                    <div class="controls inline">
                        ...
                        ?>
                        <?php echo $form->textField($model, 'nama_pasien', array('onkeypress' => "return $(this).focusNextInputField(event)", 'class' => 'span3 hurufs-only')); ?>

                        <?php //echo $form->error($model, 'namadepan');  
                        ?><?php echo $form->error($model, 'nama_pasien'); ?>
                    </div>
                </div>
                <?php echo $form->textFieldRow($model, 'nama_bin', array('placeholder' => 'Nama Panggilan', 'class' => 'span4', 'onkeypress' => "return $(this).focusNextInputField(event)")); ?>
                <?php echo $form->textFieldRow($model, 'tempat_lahir', array('placeholder' => 'Tempat Lahir', 'class' => 'span4', 'onkeypress' => "return $(this).focusNextInputField(event)")); ?>
                <div class="control-group">
                ...
                <?php echo $form->textFieldRow($model, 'nama_ibu', array('class' => 'hurufs-only', 'onkeypress' => "return $(this).focusNextInputField(event)", 'placeholder' => 'Nama Ibu')); ?>
                <?php echo $form->textFieldRow($model, 'nama_ayah', array('class' => 'hurufs-only', 'onkeypress' => "return $(this).focusNextInputField(event)", 'placeholder' => 'Nama Ayah')); ?>
            </div>
        </div>
    </div>
    <div class="col-sm-6">
        ...
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                <?php echo $form->textFieldRow($model, 'alamat_pasien', array('placeholder' => 'Alamat Pasien', 'class' => 'span4', 'onkeypress' => "return $(this).focusNextInputField(event)")); ?>
                <div class="control-group">
                ...
                <?php echo $form->textFieldRow($model, 'agama', array('placeholder' => 'Agama', 'class' => 'span4', 'onkeypress' => "return $(this).focusNextInputField(event)")); ?>
                <?php echo $form->textFieldRow($model, 'warga_negara', array('placeholder' => 'Warga Negara', 'class' => 'span4', 'onkeypress' => "return $(this).focusNextInputField(event)")); ?>
            </div>
        </div>
    </div>
</div>
