<?php
class INRawatInap  extends InfopasienmasukkamarinfoV
{
        ...
        public function searchRI()
    {
        ...
        $criteria->addBetweenCondition('date(tglmasukkamar)',$this->tgl_awal,$this->tgl_akhir,true);
		if($this->ceklis)
			{
        ...
        if (!empty($this->pasienpulang)) {
            if ($this->pasienpulang == 1) {
