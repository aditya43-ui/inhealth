...
class INTariftindakanM extends TariftindakanM {
    ...
    public function search()
	{
		...
		$criteria->compare('daftartindakaN_id',$this->daftartindakan_id, true);
		$criteria->compare('komponentarif.komponentarif_id',$this->komponentarif_id);
