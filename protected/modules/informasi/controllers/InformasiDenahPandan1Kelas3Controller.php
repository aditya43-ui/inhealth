 ...
 * 
 */
class InformasiDenahPandan1Kelas3Controller extends MyAuthController
{
  /**
  ...
  public function actionIndex($instalasi_id = '', $ruangan_id = '')
  {
    ...
    if ((isset($_POST['ajax'])) && (isset($_POST['ruangan']))) {
      ...
      $criteria->addCondition(((!empty($ruangan)) ? "t.ruangan_id =" . $ruangan . " and t.kelaspelayanan_id=4 and " : "") . 't.kamarruangan_aktif = true order by t.ruangan_id, t.kelaspelayanan_id, t.kamarruangan_nokamar, t.kamarruangan_nobed');
