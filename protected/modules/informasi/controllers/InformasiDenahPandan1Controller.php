...
/**
 * pembuatan fungsi denah pandan 1
 * RSST-4635
 ...
 * 
 */
class InformasiDenahPandan1Controller extends MyAuthController
{
  /**
  ...
  public function actionIndex($instalasi_id = '', $ruangan_id = '')
  {
    ...
    if ((isset($_POST['ajax'])) && (isset($_POST['ruangan']))) {
      ...
      $criteria->addCondition(((!empty($ruangan)) ? "t.ruangan_id =" . $ruangan . " and t.kelaspelayanan_id IN (3,5) and " : "") . 't.kamarruangan_aktif = true order by t.ruangan_id, t.kelaspelayanan_id, t.kamarruangan_nokamar, t.kamarruangan_nobed');
                        ...
                        draw();
                          ...
                          //digunakan untuk validasi ruangan berdasarkan no kamar dan jenis kelamin
                            ...
                            for(j=0;j<pasien_kamar.length;j++){
                             ...
                             var hotspots=[ 
                                {id:"1",kamarruangan_nokamar:"musola",kelaspelayanan_nama:"",ruangan_id:"763",uri:"",x:960,y:200,radius:30,tip:"Bed:"},     
                            ];
                             hotspots[0].uri=iconmusola;
                             hotspots[0].tip="Mushola";
