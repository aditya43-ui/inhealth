<?php
/**
 * pembuatan fungsi denah Kemuning 1 Anak
 * RSST-4643
 ...
 * 
 */
class InformasiDenahKemuningAnakController extends MyAuthController
{
  /**
  ...
  protected function renderKamarRuangan($model)
  {
    ...
    foreach ($list1 as $i => $v) {
      ...
      $result .= "<style>.contentKamar{
                        ...
                        #myCanvas{
                            ...
                            background-image: url('" . Yii::app()->request->baseUrl . "/images/denah/" . $tempRuangan . "_1.png');
    ...
    $result .= 'INFORMASI KAMAR KEMUNING 1 ANAK'; /* judul disesuaikan dengan nama ruangan */
    $result .= '</div>';
    $result .= '</div>';
    ...
    $result .= '<script>
                       $( document ).ready(function() {
                        ...
                        var hotspots=[
                          ...
                          {id:1,kamarruangan_nokamar:"KELAS 1",kelaspelayanan_nama:"",ruangan_id:"764",uri:"",x:200,y:200,radius:30,tip:"Bed:"},
                          {id:2,kamarruangan_nokamar:"KELAS 1",kelaspelayanan_nama:"",ruangan_id:"764",uri:"",x:350,y:200,radius:30,tip:"Bed:"},
                          {id:3,kamarruangan_nokamar:"KELAS 1",kelaspelayanan_nama:"",ruangan_id:"764",uri:"",x:400,y:550,radius:30,tip:"Bed:"},
                          {id:4,kamarruangan_nokamar:"KELAS 1",kelaspelayanan_nama:"",ruangan_id:"764",uri:"",x:250,y:550,radius:30,tip:"Bed:"},
                          
                          {id:1,kamarruangan_nokamar:"KELAS 2",kelaspelayanan_nama:"",ruangan_id:"764",uri:"",x:480,y:200,radius:30,tip:"Bed:"},
                          {id:2,kamarruangan_nokamar:"KELAS 2",kelaspelayanan_nama:"",ruangan_id:"764",uri:"",x:560,y:200,radius:30,tip:"Bed:"},
                          {id:3,kamarruangan_nokamar:"KELAS 2",kelaspelayanan_nama:"",ruangan_id:"764",uri:"",x:640,y:200,radius:30,tip:"Bed:"},
                          {id:4,kamarruangan_nokamar:"KELAS 2",kelaspelayanan_nama:"",ruangan_id:"764",uri:"",x:710,y:200,radius:30,tip:"Bed:"},
                          {id:6,kamarruangan_nokamar:"KELAS 2",kelaspelayanan_nama:"",ruangan_id:"764",uri:"",x:500,y:550,radius:30,tip:"Bed:"},
                          {id:7,kamarruangan_nokamar:"KELAS 2",kelaspelayanan_nama:"",ruangan_id:"764",uri:"",x:560,y:550,radius:30,tip:"Bed:"},
                          {id:"1",kamarruangan_nokamar:"farmasi",kelaspelayanan_nama:"",ruangan_id:"764",uri:"",x:730,y:550,radius:30,tip:"Bed:"},
                        ];
