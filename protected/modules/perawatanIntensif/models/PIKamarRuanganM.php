 ...
 */
class PIKamarRuanganM extends KamarruanganM
{
	/**
	...
	public function getKelasPelayananRuanganItems()
        {
            return PIKamarRuanganM::model()->with('kelaspelayanan')->findAll('t.ruangan_id='.Yii::app()->user->getState('ruangan_id').'');
        }
        
        public function getKamarNoKamarItems()
        {
            return PIKamarRuanganM::model()->with('ruangan')->findAll('t.ruangan_id='.Yii::app()->user->getState('ruangan_id').'');
