...
class PILaporanpemakaiobatalkesV extends LaporanpemakaiobatalkesV  {
        ...
        public function searchTable()
	{
            ...
            $criteria->compare('qty_oa',$this->qty_oa);
            $criteria->compare('hargasatuan_oa',$this->hargasatuan_oa);
			 $criteria->select='sum(qty_oa) as jumlah ,jenisobatalkes_nama,obatalkes_golongan,obatalkes_kategori,obatalkes_nama,satuankecil_nama,carabayar_nama';
			$criteria->group = 'jenisobatalkes_nama,obatalkes_golongan,obatalkes_kategori,obatalkes_nama,satuankecil_nama,carabayar_nama';
