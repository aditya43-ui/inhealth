...
class PemakaianbarangTPIController extends PemakaianbarangTController
{
  /**
  ...
  public function actionIndex($a = null)
  {
    ...
    if (isset($_POST['GUPemakaianbarangT'])) {
      ...
      if (isset($_POST['GUPemakaianbrgdetailT']) && count((array)$_POST['GUPemakaianbrgdetailT']) > 0) {
        if ($model->validate()) {
          ...
          try {
            ...
            if ($model->save()) {
              ...
              foreach ($modDetails as $i => $data) {
                if ($data->jmlpakai > 0) {
                  if ($data->save()) {
                    $success = $success && InventarisasiruanganT::simpanStokPemakaian($model, $data); //disamakan dengan controller PemakaianbarangTController di gudang umum
                    ...
                    //										InventarisasiruanganT::kurangiStok($data->jmlpakai, $data->barang_id, $data->inventarisasi_kode);
    ...
    $linkHalaman = CustomFunction::getUrlByMenuID(2635);
