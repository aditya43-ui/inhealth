...
class InformasipemakaiobatalkesruanganPIController extends InformasipemakaiobatalkesruanganVController
{
  ...
  {
    return $this->createUrl('PemakaianObatPI/rincianDetail');
  }
  ...
  {
    return $this->createUrl('PemakaianObatPI/Index');
  }
}
