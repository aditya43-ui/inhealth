...
class PemesananAmbulansTPIController extends PemesananAmbulansPasienRSController
{
  public $path_view = 'ambulans.views.pemesananAmbulansPasienRS.';

  public function actionIndex($a = null)
  {
    $this->pageTitle = Yii::app()->name . " - Pesan Ambulans";
    $format = new MyFormatter();
    $modPasien = new PasienM;
    $modKunjungan = new AMInfokunjunganrjV;
    $modKunjungan->instalasi_id = Params::INSTALASI_ID_ICU;
    ...
    if (isset($_GET['id'])) {
      ...
      if (!empty($modPemesanan->pendaftaran_id)) {
        ...
        $modKunjungan->instalasi_id = $modPemesanan->ruanganpemesan->instalasi_id;
      }
    }

    $linkHalaman = CustomFunction::getUrlByMenuID(2639);
