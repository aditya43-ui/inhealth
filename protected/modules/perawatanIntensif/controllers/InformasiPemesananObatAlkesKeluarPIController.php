...
class InformasiPemesananObatAlkesKeluarPIController extends InformasiPemesananObatAlkesKeluarController
{
  ...
  {
    return $this->createUrl('pemesananObatAlkesPI/print');
  }
  ...
  {
    return InformasiPemesananObatAlkesKeluaController::actionBatalPemesananObat();
  }
}
