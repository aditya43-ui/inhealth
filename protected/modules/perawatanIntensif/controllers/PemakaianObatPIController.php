...
class PemakaianObatPIController extends PemakaianObatController
{
  /**
  ...
  public function actionInformasi($a = null) {
    $linkHalaman = CustomFunction::getUrlByMenuID(2608);
  ...
  public function actionIndex($pemakaianobat_id = null, $a = null)
  {
        ...
        if (count((array)$_POST['FAPemakaianobatdetailT']) > 0) {
          ...
          foreach ($_POST['FAPemakaianobatdetailT'] as $i => $postDetail) {
            ...
            if (isset($detailGroups[$obatalkes_id])) {
              ...
              $detailGroups[$obatalkes_id]['qty_satuanpakai'] = $postDetail['qty_satuanpakai'];
              $detailGroups[$obatalkes_id]['ket_obatpakai'] = isset($postDetail['ket_obatpakai']) ? $postDetail['ket_obatpakai'] : "";
            }
          }
          //END GROUP
        }
    ...
    $linkHalaman = CustomFunction::getUrlByMenuID(2638);
