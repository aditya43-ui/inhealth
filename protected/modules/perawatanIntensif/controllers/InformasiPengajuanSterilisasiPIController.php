...
class InformasiPengajuanSterilisasiPIController extends InformasiPengajuanSterilisasiRuanganController
{
  public $path_view = 'sterilisasi.views.informasiPengajuanSterilisasiRuangan.';

  public function actionIndex()
  {
    $this->pageTitle = Yii::app()->name . " - Informasi Pengajuan Strerilisasi";
