        ...
        <div class="controls">
            ...
            <?php 
                $this->widget('MyJuiAutoComplete', array(
                                ...
                                'htmlOptions'=>array('placeholder'=>'No. Pendaftaran','class'=>'all-caps span3','rel'=>'tooltip','title'=>'No. Pendaftaran',
        ...
        <div class="controls">
            ...
            <?php 
                $this->widget('MyJuiAutoComplete', array(
                                ...
                                'htmlOptions'=>array('placeholder'=>'No. Rekam Medik','class'=>'all-caps span3','rel'=>'tooltip','title'=>'No. rekam medik untuk mencari data kunjungan',
                                    'onkeyup'=>"return $(this).focusNextInputField(event)",
                                    ),
                            )); 
            ?>
...
$this->beginWidget('zii.widgets.jui.CJuiDialog', array( // the dialog
    ...
    $modDialogKunjungan = new PIInfopasienmasukkamarV('searchDialogKunjungan');
    $modDialogKunjungan->unsetAttributes();
    $modDialogKunjungan->ruangan_id = Yii::app()->user->getState('ruangan_id');
//    $modDialogKunjungan->ruangan_id = $ruangan_id;
    $modDialogKunjungan->tglmasukkamar = date('d/m/Y') . ' - ' . date('d/m/Y');
    if(isset($_GET['PIInfopasienmasukkamarV'])) {
        $modDialogKunjungan->attributes = $_GET['PIInfopasienmasukkamarV'];
    }
    ...
    $this->widget('ext.bootstrap.widgets.BootGridView',array(
            ...
            'columns'=>array(
                    ...
                    array(
						...
						'filter'=> false,
                        // CHtml::activeTextField($modDialogKunjungan, 'tglmasukkamar', array('class'=>'span3','readonly'=>true)),
...
//				jQuery("#'.CHtml::activeId($modDialogKunjungan, 'tglmasukkamar').'").datepicker(jQuery.extend({showMonthAfterYear:false}, jQuery.datepicker.regional["id"], {"dateFormat":"dd M yy","maxDate":"d","timeText":"Waktu","hourText":"Jam","minuteText":"Menit","secondText":"Detik","showSecond":true,"timeOnlyTitle":"Pilih Waktu","timeFormat":"hh:mm:ss","changeYear":true,"changeMonth":true,"showAnim":"fold","yearRange":"-80y:+20y"}));
//				jQuery("#'.CHtml::activeId($modDialogKunjungan, 'tglmasukkamar').'_date").on("click", function(){jQuery("#'.CHtml::activeId($modDialogKunjungan, 'tglmasukkamar').'").datepicker("show");});
                                jQuery("#'.CHtml::activeId($modDialogKunjungan, 'tglmasukkamar').'").daterangepicker({
                                    "maxDate": "' . date('m/d/Y') . '",
                                    "showDropdowns": true,
                                });
			}',
