...
<div class="panel panel-gradient">
    ...
    <div class="panel-heading">
        <div class="panel-title">
            <i class="glyphicon glyphicon-briefcase"></i> Transaksi <b>Pemakaian Bahan</b>
        </div>
    </div>
    <div class="panel-body">
        ...
        <div id="form-tambahobatalkes" class="panel panel-success">
            ...
            <div class="panel-body">
                ...
                if (!empty($modKunjungan->pasienadmisi_id)) {
                    $ruangan_id = PasienadmisiT::model()->findByPk($modKunjungan->pasienadmisi_id)->ruangan_id;
                } else {
                    $ruangan_id = $modKunjungan->ruangan_id;
                }
                $this->renderPartial($this->path_view . '_formObatAlkesPasien', array('modKunjungan' => $modKunjungan, 'ruangan_id' => $ruangan_id));
                ?>
            </div>
        </div>
        ...
        <div class="form-actions">
            ...
            if ($modKunjungan->isNewRecord) {
                ...
                echo CHtml::link(Yii::t('mds', '{icon} Print', array('{icon}' => '<i class="entypo-print"></i>')), 'javascript:void(0);', array('class' => 'btn btn-info', 'onclick' => "print(" . $modKunjungan->pasienadmisi_id . ");return false"));
            }
