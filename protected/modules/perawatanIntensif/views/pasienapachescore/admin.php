...
$arrMenu = array();
                (Yii::app()->user->checkAccess(Params::DEFAULT_ADMIN)) ?array_push($arrMenu,array('label'=>Yii::t('mds','Manage').' PIPasienapachescoreT ', 'header'=>true, 'itemOptions'=>array('class'=>'heading-master'))) :  '' ;
