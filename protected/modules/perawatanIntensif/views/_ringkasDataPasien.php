...
<fieldset>
    ...
    <div id="divRiwayatPasien" class="control-group">
        <iframe src="<?php echo Yii::app()->createUrl('perawatanIntensif/riwayatPasien/getRiwayatPasien&id='.$modPasien->pasien_id); ?>" id="riwayatPasien" width="100%" height="100%" onload="javascript:resizeIframe(this);">
        </iframe>        
    </div>
</fieldset>
