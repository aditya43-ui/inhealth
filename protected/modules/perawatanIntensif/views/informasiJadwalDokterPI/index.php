...
<legend class="rim2">Penjadwalan Dokter Rawat Intensif</legend>
            ...
            <td>
                ...
                <div class="controls">
                    <div class="input-append">
                        <input type="text" name="PIJadwaldokterM[jadwaldokter_mulai]" id="PIJadwaldokterM" onkeypress="return $(this).focusNextInputField(event);" readonly="readonly" class="hasDatepicker">
                ...
                <?php echo $form->dropDownListRow($model,'pegawai_id', CHtml::listData(PIPendaftaranT::model()->getDokterItemsInstalasi(Params::INSTALASI_ID_PI), 'pegawai_id', 'nama_pegawai') ,array('empty'=>'-- Pilih --','onkeypress'=>"return $(this).focusNextInputField(event)")); ?>
                
            </td>
            <td>
                <?php echo $form->dropDownListRow($model,'ruangan_id', CHtml::listData(PIPendaftaranT::model()->getRuanganItems(Params::INSTALASI_ID_PI), 'ruangan_id', 'ruangan_nama') ,
                                                      array('empty'=>'-- Pilih --',
    ...
    <div class="form-actions">
        ...
        <?php echo CHtml::link(Yii::t('mds','{icon} Reset',array('{icon}'=>'<i class="entypo-arrows-ccw"></i>')), 
                                ...
                                array('class' => 'btn btn-default',
                                    'onclick'=>'window.parent.myConfirm("Apakah Anda ingin mengulang ini?","Perhatian!",function(r) {if(r) window.location = "'.$this->createUrl('index').'";} ); return false;')); ?>
        <?php 
