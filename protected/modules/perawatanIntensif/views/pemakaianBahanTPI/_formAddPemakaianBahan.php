<tr>
    ...
    <td style="text-align:right;">
        <?php echo number_format($modObatAlkesPasien->hargajual_oa, 0, ",", "."); ?>
    </td>
    <td>
        <?php echo CHtml::hiddenField("pemakaianBahan[ii][hargajual_oa]", $modObatAlkesPasien->hargajual_oa,array('readonly'=>true,'class'=>'inputFormTabel lebar3')); ?>
        <?php echo CHtml::hiddenField("pemakaianBahan[ii][hargasatuan_oa]", $modObatAlkesPasien->hargasatuan_oa,array('readonly'=>true,'class'=>'inputFormTabel lebar3')); ?>
        <?php echo CHtml::hiddenField("pemakaianBahan[ii][harganetto_oa]", $modObatAlkesPasien->harganetto_oa,array('readonly'=>true,'class'=>'inputFormTabel lebar3')); ?>
        ...
        <?php echo CHtml::textField("pemakaianBahan[ii][qty_oa]", isset($modObatAlkesPasien->qty_oa) ? $modObatAlkesPasien->qty_oa : '1',array('onkeyup'=>'hitungSubTotal(this)','readonly'=>true,'class'=>'inputFormTabel span2 float2 qty')); ?>
		<?php echo CHtml::hiddenField("pemakaianBahan[ii][qty_stok]",isset($modObatAlkesPasien->qty_stok) ? $modObatAlkesPasien->qty_stok : '1',array('readonly'=>true,'class'=>'span1 float2', 'onkeyup'=>"return $(this).focusNextInputField(event)",)); ?>
        ...
        ?>
        <?php echo CHtml::hiddenField("pemakaianBahan[ii][iurbiaya]",$totalsub,array('readonly'=>true,'class'=>'inputFormTabel lebar3 float subtotal')); ?>
    </td>
    <td>
