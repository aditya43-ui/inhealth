    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <div class="control-group">
                ...
                <div class="controls">
                    <?php echo $form->checkBoxList($model, 'caramasuk_id', CHtml::listData(CaramasukM::model()->findAll('caramasuk_aktif = true'), 'caramasuk_id', 'caramasuk_nama'), array('onkeypress' => "return $(this).focusNextInputField(event)")); ?>
                </div>
            </div>
