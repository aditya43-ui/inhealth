            ...
            <div class="panel panel-success">
                <div class="panel-heading">
                    <div class="panel-title">
                        <i class="glyphicon glyphicon-file"></i> Berdasarkan Kelas Pelayanan
                    </div>
                </div>
                <div class="panel-body">
                    ...
                    <label for="checkSemuaid">Pilih Semua</label>
                    <div class="penjamin">
                        <?php echo $form->checkBoxList($model, 'kelaspelayanan_id', CHtml::listData(KelaspelayananM::model()->findAll(), 'kelaspelayanan_id', 'kelaspelayanan_nama')); ?>
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    function checkSemua() {
        if ($("#checkSemuaid").is(":checked")) {
            $('.penjamin input[name*="PILaporanbiayapelayanan"]').each(function() {
