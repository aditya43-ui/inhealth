<div class="search-form">
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <div id='searching'>
                <?php
                echo '<div class="control-group">' . CHtml::hiddenField('filter', 'wilayah') . '<label class="control-label">Propinsi</label><div class="controls">' . $form->dropDownList($model, 'propinsi_id', CHtml::listData($model->getPropinsiItems(), 'propinsi_id', 'propinsi_nama'), array(
                    'empty' => '-- Pilih --',
                    'ajax' => array(
                        'type' => 'POST',
