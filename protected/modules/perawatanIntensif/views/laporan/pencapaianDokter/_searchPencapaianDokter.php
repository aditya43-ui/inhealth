    ...
    <div class="row">
        <div class="col-sm-4">
			...
			<div class='control-group'>
                <?php echo CHtml::label('Periode Tindakan', 'dari_tanggal', array('class' => 'control-label')) ?>
                <div class="controls">  
			...
			<div class='control-group'>
                ...
                <div class="controls">
					<?php echo CHtml::checkBox('PILaporanvisitedokterV[nursestation_id]', $model->nursestation_id, array('onkeypress'=>"return $(this).focusNextInputField(event)")) ?>
...
<!--		<div class='control-group'>
                ...
                <div class="controls">
			<?php
//			echo $form->dropDownList($model, 'ruangan_id', CHtml::listData($model->getNursestationItems(), 'ruangan_id', 'ruangan_nama'), array('empty' => '-- Pilih --', 'onkeypress' => "return $(this).focusNextInputField(event)"));
			?>
		</div>
		</div>-->
            </div>
