...
<div class="">
    <div class="row">
        ...
        <div class="col-sm-6">
            ...
            <div class="control-group">
                <?php echo CHtml::label('Nama Pegawai <span class="required">*</span>', 'namapegawai', array('class' => 'control-label')) ?>
                <div class="controls">
                    <?php echo $form->hiddenField($modPengkajian, 'pegawai_id', array('class' => 'required', 'readonly' => true, 'id' => 'pegawai_id')) ?>
                    <?php
                    ...
                    $this->widget('MyJuiAutoComplete', array(
                        ...
                        'htmlOptions' => array(
                            ...
                            'onblur' => "if(this.value==''){ $('#pegawai_id').val('');}",
                            'class' => 'required span3', 'onkeypress' => "return $(this).focusNextInputField(event)",
                        ),
                    ));
                    ?>
...
$modPegawai = new PIPegawaiM;
if (isset($_GET['PIPegawaiM']))
    $modPegawai->attributes = $_GET['PIPegawaiM'];
