...
foreach ($modRiwayatKirimKeUnitLain as $i => $riwayat) {
    $modPermintaan = PIPermintaanPenunjangT::model()->with('daftartindakan')->findAllByAttributes(array('pasienkirimkeunitlain_id'=>$riwayat->pasienkirimkeunitlain_id));
    ?>
    <tr>
        <td>
            <?php
...
<table style="width: 100%; border: none;">
    ...
    <tr>
        ...
        <td width="50%" align="center">Dokter Penanggungjawab</td>
    <tr>
    <tr>
        <td colspan="2">&nbsp;</td>
    <tr>
    ...
    <tr>
        <?php 
            if(!empty($modPendaftaran->pasienadmisi_id)){
				$ruangan_id = PasienadmisiT::model()->findByPk($modPendaftaran->pasienadmisi_id)->ruangan_id;
			}else{
