    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-sm-6">
                ...
                <?php echo $form->textFieldRow($model, 'nama_bin', array('placeholder' => 'Nama Alias', 'class' => 'span3', 'onkeypress' => "return $(this).focusNextInputField(event)", 'maxlength' => 50)); ?>
            </div>
            ...
            <div class="col-sm-6">
                ...
                <?php echo $form->dropDownListRow(
                    $model,
                    'ruangan_id',
                    CHtml::listData(PIPasienAdmisiT::model()->getRuanganItems(Params::INSTALASI_ID_PI), 'ruangan_id', 'ruangan_nama'),
                    array(
                        'empty' => '-- Pilih --',
...
<script>
    // document.getElementById('PIPasienriyangpindahV_tgl_awal_date').setAttribute("style", "display:none;");
    // document.getElementById('PIPasienriyangpindahV_tgl_akhir_date').setAttribute("style", "display:none;");

    function cekTanggal() {

        var checklist = $('#PIPasienriyangpindahV_ceklis');
        var pilih = checklist.attr('checked');
        if (pilih) {
            document.getElementById('PIPasienriyangpindahV_tgl_awal_date').setAttribute("style", "display:block;");
            document.getElementById('PIPasienriyangpindahV_tgl_akhir_date').setAttribute("style", "display:block;");
        } else {
            document.getElementById('PIPasienriyangpindahV_tgl_awal_date').setAttribute("style", "display:none;");
            document.getElementById('PIPasienriyangpindahV_tgl_akhir_date').setAttribute("style", "display:none;");
        }
