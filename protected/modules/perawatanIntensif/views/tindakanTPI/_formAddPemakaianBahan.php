...
<!--<td>
    ...
    <td>
        ...
        <?php echo CHtml::textField("pemakaianBahan[0][qty]", $modObatAlkesPasien->qty_oa,array('onkeyup'=>'hitungSubTotal(this)','readonly'=>true,'class'=>'inputFormTabel lebar1 float qty', 'style'=>'text-align: right;')); ?>
    ...
    <td>
        ...
        ?>
        <?php echo CHtml::textField("pemakaianBahan[0][subtotal]",$totalsub,array('readonly'=>true,'class'=>'inputFormTabel lebar3 float subtotal', 'style'=>'text-align: right;')); ?>
    </td>
    <td>
