                ...
                <?php foreach ($modTindakans as $i => $modTindakan) { ?>
                    <tr>
                        <td>
							...
							<?php echo (isset($modTindakan->perawat->nama_pegawai) ? "Perawat 1:".$modTindakan->perawat->NamaLengkap : ""); echo (!empty($modTindakan->perawat_id)) ? ',<br>' : ''; ?>
                            <?php echo (isset($modTindakan->suster->nama_pegawai) ? "Perawat 2 :".$modTindakan->suster->NamaLengkap : ""); echo (!empty($modTindakan->suster_id)) ? ',<br>' : ''; ?>                            
                        </td>
                        <td>
                            <?php 
