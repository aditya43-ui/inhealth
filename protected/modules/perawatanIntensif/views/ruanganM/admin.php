...
$('.filters #PINRuanganM_ruangan_nama').focus();
");
...
<?php
//Filter Grid
$model = new PINRuanganM('searchInformasi');
$model->unsetAttributes();
$format = new MyFormatter();
if (isset($_GET['PINRuanganM'])) {
        $model->attributes = $_GET['PINRuanganM'];
        $model->ruangan_nama = $_GET['PINRuanganM']['ruangan_nama'];
        $model->kategoritindakan_nama = $_GET['PINRuanganM']['kategoritindakan_nama'];
        $model->daftartindakan_kode = $_GET['PINRuanganM']['daftartindakan_kode'];
        $model->daftartindakan_nama = $_GET['PINRuanganM']['daftartindakan_nama'];
}
...
echo CHtml::link(Yii::t('mds', '{icon} Tambah Tindakan Ruangan', array('{icon}' => '<i class="icon-plus icon-white"></i>')), $this->createUrl('/perawatanIntensif/ruanganM/createDaftarTindakan', array('modul_id' => Yii::app()->session['modul_id'])), array('class' => 'btn btn-danger',));
