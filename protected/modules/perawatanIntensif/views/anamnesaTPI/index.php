...
$form = $this->beginWidget('ext.bootstrap.widgets.BootActiveForm', array(
    ...
    'focus' => '#PIAnamnesaT_keluhanutama_annoninput .maininput',
));
?>
...
<div class="panel panel-success">
    <div class="panel-heading">
        <div class="panel-title">
            <i class='fas fa-laptop-medical'></i> Pemeriksaan <b>Anamnesa</b>
        </div>
    </div>
    <div class="panel-body">
        ...
        <div class="form-actions">
            ...
            $anamnesaB = null;
            if (isset($_GET['id'])) {
                $anamnesaB = PIAnamnesaT::model()->findByPk($_GET['id']);
            }

            if (empty($anamnesaB)) {
                $anamnesaB = new PIAnamnesaT();
            }
...
echo $this->renderPartial("_jsFunction", array(), true);
...
$modDataDiagnosaPenyakitTerdahulu = new PIDiagnosaM('searchDiagnosaAnamnesa');
$modDataDiagnosaPenyakitTerdahulu->unsetAttributes();
if (isset($_GET['PIDiagnosaM'])) {
    $modDataDiagnosaPenyakitTerdahulu->attributes = $_GET['PIDiagnosaM'];
    $modDataDiagnosaPenyakitTerdahulu->diagnosa_nama = (isset($_GET['PIDiagnosaM']['diagnosa_nama']) ? $_GET['PIDiagnosaM']['diagnosa_nama'] : "");
    $modDataDiagnosaPenyakitTerdahulu->diagnosa_namalainnya = (isset($_GET['PIDiagnosaM']['diagnosa_namalainnya']) ? $_GET['PIDiagnosaM']['diagnosa_namalainnya'] : "");
    $modDataDiagnosaPenyakitTerdahulu->diagnosa_kode = (isset($_GET['PIDiagnosaM']['diagnosa_kode']) ? $_GET['PIDiagnosaM']['diagnosa_kode'] : "");
}
...
$modDataDiagnosaKeluarga = new PIDiagnosaM('searchDiagnosaAnamnesa');
$modDataDiagnosaKeluarga->unsetAttributes();
if (isset($_GET['PIDiagnosaM'])) {
    $modDataDiagnosaKeluarga->attributes = $_GET['PIDiagnosaM'];
    $modDataDiagnosaKeluarga->diagnosa_nama = (isset($_GET['PIDiagnosaM']['diagnosa_nama']) ? $_GET['PIDiagnosaM']['diagnosa_nama'] : "");
    $modDataDiagnosaKeluarga->diagnosa_namalainnya = (isset($_GET['PIDiagnosaM']['diagnosa_namalainnya']) ? $_GET['PIDiagnosaM']['diagnosa_namalainnya'] : "");
    $modDataDiagnosaKeluarga->diagnosa_kode = (isset($_GET['PIDiagnosaM']['diagnosa_kode']) ? $_GET['PIDiagnosaM']['diagnosa_kode'] : "");
}
$this->widget('ext.bootstrap.widgets.BootGridView', array(
