<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="entypo-credit-card"></i> Tabel <b>Diagnosa (ICD 9) CM
        </div>
    </div>
    <div class="panel-body table-responsive">
        <?php
        echo CHtml::htmlButton(
            '<i class="icon-plus icon-white"></i> Tambah Diagnosa 9 CM',
            array(
                'onclick' => 'tambahDiagnosaix();return false;',
                'class' => 'btn btn-primary',
                'rel' => "tooltip",
                'title' => "Klik untuk menambahkan Diagnosa 9 CM Pasien",
            )
        );
        ?>
                ...
                ?>
                        <tr>
                            ...
                            <td style="text-align: center; width: 60px;">
                                <?php
                                if (!$status) {
                                    echo CHtml::link("<i class='icon-form-silang'></i>", "javascript:void(0);", array("onclick" => "hapusDiagnosaix(this);return false;", "rel" => "tooltip", "rel" => "tooltip", "title" => "Klik untuk Menghapus Diagnosis"));
                                }
                                ?>
                            </td>
                        </tr>
