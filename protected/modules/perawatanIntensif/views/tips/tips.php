...
<table style="width:100%; padding: none; border: none;">
  <tr>
	...
	<td>6.</td>
	<td>Gunakan tombol ini  <button class="btn btn-primary" name="yt0" type="submit"><i class="entypo-search"></i>
  ...
  <tr>
	...
	<td>7</td>
	<td>Gunakan tombol ini  <button class="btn btn-primary" name="yt0" type="submit"><i class="entypo-check"></i>
Simpan</button> berfungsi untuk menyimpan.
  ...
  <tr>
	...
	<td>8</td>
	<td>Gunakan tombol ini <a class="btn btn-danger" href="/simrs/index.php?r=perawatanIntensif/pasienRawatIntensif/formTindakLanjutDariPasienRI">
		<i class="entypo-arrows-ccw"></i> Ulang</a> untuk mengulang kembali inputan.
	</td>
  </tr>
