...
<?php 
    $pegawai = new PIDokterpegawaiV('searchByDokterDialog');
    if (isset($_GET['PIDokterpegawaiV'])){
        $pegawai->attributes = $_GET['PIDokterpegawaiV'];
    }
    $this->widget('ext.bootstrap.widgets.BootGridView',array(
		'id'=>'giladiagnosa-m-grid',
		'dataProvider'=>$pegawai->searchByDokterDialog(),
		'filter'=>$pegawai,
		'template'=>"{summary}\n{items}\n{pager}",
