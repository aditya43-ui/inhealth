<?php     
    $modTindakan = new PIPaketpelayananV('searchTindakan');
    $modTindakan->unsetAttributes();    
    if(isset($_GET['PIPaketpelayananV'])) {
        $modTindakan->attributes = $_GET['PIPaketpelayananV'];
        $modTindakan->daftartindakan_kode = isset($_GET['PIPaketpelayananV']['daftartindakan_kode']) ? $_GET['PIPaketpelayananV']['daftartindakan_kode'] : null;
    }
