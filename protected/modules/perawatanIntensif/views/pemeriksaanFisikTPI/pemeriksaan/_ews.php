<?php if (Yii::app()->user->getState('ruangan_id') == Params::RUANGAN_ID_ICU): ?>
<div class="panel panel-success panel_cgsews" id="panel_ews">
...
<div class="panel panel-success panel_cgsews" id="panel_pews">
    <div class="panel-heading">
        <div class="panel-title">
            <?php 
            $model->is_pews = true;
            echo $form->hiddenField($model, 'is_pews'); ?> 
