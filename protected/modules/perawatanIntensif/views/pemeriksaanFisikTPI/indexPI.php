...
<div class="panel panel-success">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="glyphicon glyphicon-file"></i> Pemeriksaan <b>Fisik</b>
        </div>
    </div>
                ...
                <div class="panel panel-success panel_cgsews">
                    <div class="panel-heading">
                        <div class="panel-title"><?php echo $form->checkBox($modPemeriksaanFisik, 'gcs_eye', array('class' => 'cek_ews', 'uncheckValue' => null)); ?>
                            Glasgow Coma Scale
                            <?php echo CHtml::link('<i class="icon-chevron-right" style="cursor:pointer;"></i>', '', array('onclick' => "$('#dialogGCS').dialog('open')", 'onkeypress' => "return $(this).focusNextInputField(event);", 'style' => 'color:#333;')); ?></div>
                        <?php echo $form->radioButtonList($modPemeriksaanFisik, 'gcs_jenis', array(0 => "Dewasa/Anak", 1 => "Bayi"), array(
                    ...
                    <div class="panel-body">
                        ...
                        <div class="controls">
                                ...
                                echo $form->dropDownList(
                                    $modPemeriksaanFisik,
                                    'gcs_eye',
                                    CHtml::listData(PIMetodeGCSM::model()->findAll($crit), 'metodegcs_nilai', 'textMetodeGCSM'),
                ...
                <div class="control-group">
                        ...
                        <div class="controls">
                                ...
                                echo $form->dropDownList(
                                    $modPemeriksaanFisik,
                                    'gcs_verbal',
                                    CHtml::listData(PIMetodeGCSM::model()->findAll($crit3), 'metodegcs_nilai', 'textMetodeGCSM'),
                                    array('empty' => '-- Pilih --', 'class' => 'span3', 'onkeypress' => "return $(this).focusNextInputField(event);", 'onchange' => 'hitungCGS()')
                                ); ?>
                        </div>
                </div>
                <div class="control-group">
                        ...
                        <div class="controls">
                                ...
                                echo $form->dropDownList(
                                    $modPemeriksaanFisik,
                                    'gcs_motorik',
                                    CHtml::listData(PIMetodeGCSM::model()->findAll($crit2), 'metodegcs_nilai', 'textMetodeGCSM'),
                                    array('empty' => '-- Pilih --', 'class' => 'span3', 'onkeypress' => "return $(this).focusNextInputField(event);", 'onchange' => 'hitungCGS()')
                                ); ?>
                        </div>
                </div>-->
                        ...
                        <div class="controls">
                            ...
                            <?php echo $form->textFieldRow($modPemeriksaanFisik, 'namaGCS', array('class' => 'span1 namaGCS', 'onkeyup' => "return $(this).focusNextInputField(event);", 'readonly' => true)); ?>
        ...
        <div class="row">
            ...
            <div class="col-sm-6" style="margin-top: 17px;">
                <fieldset class=''>
                    <div class="panel panel-success panel_cgsews">
                        <div class="panel-heading">
                            <div class="panel-title"><?php echo $form->checkBox($modPemeriksaanFisik, 'thorax', array('class' => 'cek_ews', 'uncheckValue' => null)); ?>Thorax</div>
                    ...
                    <div class="panel-body" style="width:412px !important;">
                        ...
                        ?>
                            ...
                            <img img-no="<?php //echo $tbh->gambartubuh_id 
                                            ?>" alt="<?php echo $tbh->gambartubuh_id ?>" id="myImgId<?php echo $i ?>" src="<?php echo Yii::app()->request->baseUrl; ?>/images/anatomi.jpg" class="taggd<?php echo $tbh->gambartubuh_id ?>" style="width:480px;" />
...
JS;
    ...
    ?>
    <?php echo $this->renderPartial('_jsFunctionsPI', array(
