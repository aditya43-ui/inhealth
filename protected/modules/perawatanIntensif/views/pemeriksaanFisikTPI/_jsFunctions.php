...
function batalTambahBagianTubuh(obj){
    window.parent.myConfirm("Apakah Anda akan membatalkan pemilihan pemeriksaan ini?","Perhatian!",
    function(r){
        if(r){
...
function hapusBagianTubuh(obj){
    window.parent.myConfirm("Apakah Anda akan menghapus pemeriksaan ini?","Perhatian!",
    function(r){
        if(r){
			var bagiantubuh_id = $(obj).parents('tr').find('input[name="bagiantubuh_id"]').val();
...
function setKeluhanGastroin(){
	var adakelgastrointestinal = $('#<?php echo CHtml::activeId($modPemeriksaanFisik,'adakelgastrointestinal');?>');
	if(adakelgastrointestinal.is(':checked')){
		$('#<?php echo CHtml::activeId($modPemeriksaanFisik,'gastrointestinal_sebutkan');?>').removeAttr('readonly',true);
	}else{
		$('#<?php echo CHtml::activeId($modPemeriksaanFisik,'gastrointestinal_sebutkan');?>').attr('readonly',true);
	}
}

function setPembatasanMakanan(){
	var pembatasanmakanan = $('#<?php echo CHtml::activeId($modPemeriksaanFisik,'pembatasanmakanan');?>');
	if(pembatasanmakanan.is(':checked')){
		$('#<?php echo CHtml::activeId($modPemeriksaanFisik,'pembatasanmakanan_sebutkan');?>').removeAttr('readonly',true);
	}else{
		$('#<?php echo CHtml::activeId($modPemeriksaanFisik,'pembatasanmakanan_sebutkan');?>').attr('readonly',true);
	}
}

function setGigiPalsu(){
	var gigipalsu = $('#<?php echo CHtml::activeId($modPemeriksaanFisik,'gigipalsu');?>');
	if(gigipalsu.is(':checked')){
		$('#<?php echo CHtml::activeId($modPemeriksaanFisik,'gigipalsu_sebutkan');?>').removeAttr('readonly',true);
	}else{
		$('#<?php echo CHtml::activeId($modPemeriksaanFisik,'gigipalsu_sebutkan');?>').attr('readonly',true);
	}
}

function setPendengaran(){
	var pendengaran = $('#<?php echo CHtml::activeId($modPemeriksaanFisik,'pendengaran');?>');
	if(pendengaran.is(':checked')){
		$('#<?php echo CHtml::activeId($modPemeriksaanFisik,'pendengaran_sebutkan');?>').removeAttr('readonly',true);
	}else{
		$('#<?php echo CHtml::activeId($modPemeriksaanFisik,'pendengaran_sebutkan');?>').attr('readonly',true);
	}
}

function setPenglihatan(){
	var penglihatan = $('#<?php echo CHtml::activeId($modPemeriksaanFisik,'penglihatan');?>');
	if(penglihatan.is(':checked')){
		$('#<?php echo CHtml::activeId($modPemeriksaanFisik,'penglihatan_sebutkan');?>').removeAttr('readonly',true);
	}else{
		$('#<?php echo CHtml::activeId($modPemeriksaanFisik,'penglihatan_sebutkan');?>').attr('readonly',true);
	}
}

function setDefekasi(){
	var defekasi = $('#<?php echo CHtml::activeId($modPemeriksaanFisik,'defekasi');?>');
	if(defekasi.is(':checked')){
		$('#<?php echo CHtml::activeId($modPemeriksaanFisik,'defekasi_sebutkan');?>').removeAttr('readonly',true);
	}else{
		$('#<?php echo CHtml::activeId($modPemeriksaanFisik,'defekasi_sebutkan');?>').attr('readonly',true);
	}
}

function setMiksi(){
	var miksi = $('#<?php echo CHtml::activeId($modPemeriksaanFisik,'miksi');?>');
	if(miksi.is(':checked')){
		$('#<?php echo CHtml::activeId($modPemeriksaanFisik,'miksi_sebutkan');?>').removeAttr('readonly',true);
	}else{
		$('#<?php echo CHtml::activeId($modPemeriksaanFisik,'miksi_sebutkan');?>').attr('readonly',true);
	}
}

function setHambatan(){
	var hambatanpembelajaran = $('#<?php echo CHtml::activeId($modPemeriksaanFisik,'hambatanpembelajaran');?>');
	if(hambatanpembelajaran.is(':checked')){
		$('#<?php echo CHtml::activeId($modPemeriksaanFisik,'hambatanpembelajaran_ya');?>').removeAttr('readonly',true);
	}else{
		$('#<?php echo CHtml::activeId($modPemeriksaanFisik,'hambatanpembelajaran_ya');?>').attr('readonly',true);
	}
}
setKeluhanGastroin();
setPembatasanMakanan();
setGigiPalsu();
setPendengaran();
setPenglihatan();
setDefekasi();
