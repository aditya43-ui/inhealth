...
<div class="col-sm-6">
	<div class="control-group">
		...
		<div class="controls">
			<?php echo CHtml::activeTextField($modInfoPasien, 'tgl_pendaftaran', array(
				'readonly' => true)); ?>
			<?php echo CHtml::activeHiddenField($modInfoPasien, 'pendaftaran_id', array(
				'readonly' => true)); ?>
			<?php echo CHtml::activeHiddenField($modInfoPasien, 'pasien_id', array('readonly' => true)); ?>
			<?php echo CHtml::activeHiddenField($modInfoPasien, 'pasienadmisi_id', array(
				'readonly' => true)); ?>
			<?php echo CHtml::activeHiddenField($modInfoPasien, 'kelaspelayanan_id', array(
				'readonly' => true)); ?>
...
<?php echo CHtml::activeHiddenField($modInfoPasien, 'penjamin_id', array('readonly' => true)); ?>
		<?php echo CHtml::activeHiddenField($modInfoPasien, 'jeniskasuspenyakit_id', array(
			'readonly' => true)); ?>
		</div>
	</div>

	<div class="control-group">
			<?php echo CHtml::label("No. Pendaftaran <span style=color:red;> * </span>", 'no_pendaftaran', array(
		...
		<div class="controls">
			...
			$this->widget('MyJuiAutoComplete', array(
				...
				'htmlOptions'	 => array('placeholder'	 => 'No. Pendaftaran', 'class'			 => 'all-caps',
					'rel'			 => 'tooltip', 'title'			 => 'No. pendaftaran / klik icon untuk mencari data kunjungan',
	...
	<div class="control-group">
		<?php echo CHtml::activeLabel($modInfoPasien, 'jeniskasuspenyakit_id', array(
			'class' => 'control-label')); ?>
		<div class="controls">
<?php echo CHtml::activeTextField($modInfoPasien, 'jeniskasuspenyakit_nama', array(
	'readonly' => true)); ?>
		</div>
	</div>
...
<?php echo CHtml::activeTextField($modInfoPasien, 'nama_pegawai', array('readonly' => true)); ?>
	...
	<div class="control-group">
		...
		<div class="controls">
<?php echo CHtml::activeTextField($modInfoPasien, 'kelaspelayanan_nama', array(
	'readonly' => true)); ?>
		</div>
	</div>
...
<div class="col-sm-6">
	<div class="control-group">
			<?php echo CHtml::label("No. Rekam Medik <span style=color:red;> * </span>", 'no_pendaftaran', array(
				'class' => 'control-label required')); ?>
		<div class="controls">
			<?php
			$this->widget('MyJuiAutoComplete', array(
	...
	<div class="control-group">
			<?php echo CHtml::label("Nama Pasien <span style=color:red;> * </span>", 'nama_pasien', array(
				'class' => 'control-label required')); ?>
		<div class="controls">
			<?php echo CHtml::hiddenField('namadepan', $modInfoPasien->namadepan, array(
			...
			$this->widget('MyJuiAutoComplete', array(
				...
				'htmlOptions'	 => array('placeholder'	 => 'Ketik Nama Pasien', 'rel'			 => 'tooltip',
					'title'			 => 'Ketik nama pasien untuk mencari data kunjungan',
					'onkeyup'		 => "return $(this).focusNextInputField(event)",
				),
			));
			?>
...
<?php if (isset($modInfoPasien->kamarruangan_id)) { ?>
	<?php echo CHtml::activeTextField($modInfoPasien, 'kamarruangan_nokamar', array(
		'readonly' => true, 'class' => 'span1')); ?> /
	<?php echo CHtml::activeTextField($modInfoPasien, 'kamarruangan_nobed', array(
		'readonly' => true, 'class' => 'span1')); ?>
<?php } else { ?>
	<?php echo CHtml::TextField('kamarruangan_nokamar', '', array('readonly' => true,
		'class' => 'span1')); ?> /
	<?php echo CHtml::TextField('kamarruangan_nobed', '', array('readonly' => true,
		'class' => 'span1')); ?>
<?php } ?>
		</div>
	</div>
