...
if (isset($_GET['pendaftaran_id'])) {
    $breads['Informasi Rawat Intensif'] = $this->getReferrer();
}
    ...
    <div class="panel-body">
        ...
        <div class="panel panel-success" id="form-infopasien">
                ...
                <div class="panel-title">
                    ...
                    <span class='tombol' style='display:none;'>
                        ...
                        echo CHtml::htmlButton('<i class="entypo-arrows-ccw"></i>', array(
                            'class'         => 'btn btn-danger btn-mini', 'onclick'     => 'setInfoPasienReset();',
                            'onkeyup'     => "return $(this).focusNextInputField(event)",
                            'rel'         => 'tooltip', 'title'         => 'Klik untuk mengulang data pasien'
                        ));
                        ?></span>
                </div>
            </div>
            <div class="panel-body">
                <?php $this->renderPartial('_dataPasien', array(
                    ...
                    'modPasien'         => $modPasien, 'modAdmisi'         => $modAdmisi, 'modInfoPasien'     => $modInfoPasien
                ));
                ?>
            </div>
        </div>
        <?php
        $this->renderPartial('_tableRencanaTindakan', array(
            'format'                 => $format,
            ...
            <div class="panel-body">
                ...
                <div style="overflow: auto;max-width: 1300px;">
                    <table class="items table table-striped table-bordered table-condensed" id="table_rencanatindakan">
                        ...
                        <?php
                        $trTindakan = $this->renderPartial('_rowTindakanPasien', array(
            ...
            <div class="panel-body">
                <div class="col-sm-6">
                    <div class="control-group">
                        <?php echo $form->labelEx($modVerifikasiTindakan, 'tglverifikasirenc', array(
                            'class' => 'control-label'
                        ))
                        ?>
                        <div class="controls">
                    ...
                    <?php echo $form->textFieldRow($modVerifikasiTindakan, 'noverifikasi_renc', array(
                ...
                <div class='col-sm-6'>
                    <div class="control-group">
                        <?php echo $form->labelEx($modVerifikasiTindakan, 'petugas_verif_id', array(
                            'class' => 'control-label'
                        ))
                        ?>
                        <div class="controls">
                            ...
                            $this->widget('MyJuiAutoComplete', array(
                                ...
                                'htmlOptions'     => array(
                                    "rel"         => "tooltip", "title"         => "Pencarian Data Petugas Verifikasi",
                                    'onkeypress' => "return $(this).focusNextInputField(event)",
                    ...
                    <div class="control-group">
                        <?php echo $form->labelEx($modVerifikasiTindakan, 'mengetahui_id', array(
                            'class' => 'control-label'
                        ))
                        ?>
                        <div class="controls">
                            ...
                            $this->widget('MyJuiAutoComplete', array(
                                ...
                                'htmlOptions'     => array(
                                    "rel"         => "tooltip", "title"         => "Pencarian Data Pegawai Mengetahui",
                                    'onkeypress' => "return $(this).focusNextInputField(event)",
        ...
        <div class="form-actions">
            ...
            echo CHtml::htmlButton(Yii::t('mds', '{icon} Save', array('{icon}' => '<i class="entypo-check"></i>')), array(
                'class'         => 'btn btn-danger', 'id'         => 'btn_submit', 'type'         => 'submit',
                'disabled'     => $disableSave
            ));
            ?>
            <?php
            if (!$this->getReferrer()) {
                echo CHtml::link(Yii::t('mds', '{icon} Reset', array('{icon}' => '<i class="entypo-arrows-ccw"></i>')), $this->createUrl($this->id . '/' . $this->action->id . '&pendaftaran_id=' . $_GET['pendaftaran_id'] . '&pasienadmisi_id=' . $_GET['pasienadmisi_id']), array(
            ...
            ?>
            <?php
            echo CHtml::htmlButton(Yii::t('mds', '{icon} Print', array('{icon}' => '<i class="entypo-print"></i>')), array(
                'class'         => 'btn btn-info', 'disabled'     => $disablePrint, 'type'         => 'button',
                'onclick'     => 'print(\'PRINT\')'
            ));
            ?>
            <?php
...
$this->renderPartial('_jsFunctions', array(
    'modPendaftaran' => $modPendaftaran,
    'modPasien'         => $modPasien, 'modAdmisi'         => $modAdmisi, 'modInfoPasien'     => $modInfoPasien,
    'modTindakan'     => $modTindakan, 'modTindakans'     => $modTindakans
));
?>
<?php
...
$modPegawaiVerifikasi = new PIPegawaiM('search');
$modPegawaiVerifikasi->unsetAttributes();
if (isset($_GET['PIPegawaiM'])) {
    $modPegawaiVerifikasi->attributes = $_GET['PIPegawaiM'];
}
...
$modPegawaiMengetahui = new PIPegawaiM('search');
$modPegawaiMengetahui->unsetAttributes();
if (isset($_GET['PIPegawaiM'])) {
    $modPegawaiMengetahui->attributes = $_GET['PIPegawaiM'];
}
$this->widget('ext.bootstrap.widgets.BootGridView', array(
