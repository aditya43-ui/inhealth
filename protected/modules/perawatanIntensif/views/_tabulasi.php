...
$urlAnamnesa = $this->createUrl($module.'anamnesaTPI/index',array('pendaftaran_id'=>$modPendaftaran->pendaftaran_id,'pasienadmisi_id'=>$modAdmisi->pasienadmisi_id));
$urlFisik = $this->createUrl($module.'PemeriksaanFisikTPI/index',array('pendaftaran_id'=>$modPendaftaran->pendaftaran_id,'pasienadmisi_id'=>$modAdmisi->pasienadmisi_id));
$urlLab =$this->createUrl($module.'laboratoriumTPI/index', array('pendaftaran_id'=>$modPendaftaran->pendaftaran_id,'pasienadmisi_id'=>$modAdmisi->pasienadmisi_id));
$urlRad = $this->createUrl($module.'radiologiTPI/index', array('pendaftaran_id'=>$modPendaftaran->pendaftaran_id,'pasienadmisi_id'=>$modAdmisi->pasienadmisi_id));
$urlRehab =  $this->createUrl($module.'rehabMedisTPI/index', array('pendaftaran_id'=>$modPendaftaran->pendaftaran_id,'pasienadmisi_id'=>$modAdmisi->pasienadmisi_id));
$urlGizi = $this->createUrl($module.'konsulGiziTPI/index', array('pendaftaran_id'=>$modPendaftaran->pendaftaran_id,'pasienadmisi_id'=>$modAdmisi->pasienadmisi_id));
$urlPoli = $this->createUrl($module.'konsulPoliTPI/index', array('pendaftaran_id'=>$modPendaftaran->pendaftaran_id,'pasienadmisi_id'=>$modAdmisi->pasienadmisi_id));
$urlTindakan = $this->createUrl($module.'tindakanTPI/index', array('pendaftaran_id'=>$modPendaftaran->pendaftaran_id,'pasienadmisi_id'=>$modAdmisi->pasienadmisi_id));
$urlDiagnosa =$this->createUrl($module.'diagnosaTPI/index', array('pendaftaran_id'=>$modPendaftaran->pendaftaran_id,'pasienadmisi_id'=>$modAdmisi->pasienadmisi_id));
$urlBedah = $this->createUrl($module.'bedahSentralTPI/index', array('pendaftaran_id'=>$modPendaftaran->pendaftaran_id,'pasienadmisi_id'=>$modAdmisi->pasienadmisi_id));
$urlRujukan =  $this->createUrl($module.'rujukanKeluarTPI/index', array('pendaftaran_id'=>$modPendaftaran->pendaftaran_id,'pasienadmisi_id'=>$modAdmisi->pasienadmisi_id));
//Reseptur Di Hide Sementara karena tidak dibutuhkan
$urlResep = $this->createUrl($module.'resepturTPI/index', array('pendaftaran_id' => $modPendaftaran->pendaftaran_id,'pasienadmisi_id'=>$modAdmisi->pasienadmisi_id));
$urlBahan = $this->createUrl($module.'pemakaianBahanTPI/index', array('pendaftaran_id'=>$modPendaftaran->pendaftaran_id,'pasienadmisi_id'=>$modAdmisi->pasienadmisi_id));
//$urlUnitDosis = $this->createUrl($module.'unitDosisTPI/index', array('pendaftaran_id'=>$modPendaftaran->pendaftaran_id,'pasienadmisi_id'=>$modAdmisi->pasienadmisi_id));
