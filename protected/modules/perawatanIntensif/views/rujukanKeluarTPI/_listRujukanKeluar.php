<table class="items table table-bordered table-striped table-condensed" id="tblInputTindakan">
    ...
    <tr>
        ...
        <td style="text-align: center;"><?php echo CHtml::link("<i class='icon-form-sampah'></i>", '#', array('onclick'=>'hapusRujukan(this, '.$rujukan->pasiendirujukkeluar_id.');return false;','rel'=>'tooltip','title'=>'Klik untuk melihat detail rujukan')); ?></td>
    </tr>
    <?php } ?>
