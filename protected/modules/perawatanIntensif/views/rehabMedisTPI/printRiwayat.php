...
foreach ($modRiwayatKirimKeUnitLain as $i => $riwayat) {
    $modPermintaan = PIPermintaanPenunjangT::model()->with('daftartindakan','tindakanrm')->findAllByAttributes(array('pasienkirimkeunitlain_id'=>$riwayat->pasienkirimkeunitlain_id));
    ?>
    <tr>
