...
{
	window.parent.myConfirm("Anda yakin akan membatalkan rujukan rehab medis pasien ini?","Perhatian!",function(r) {
		if(r){
			$('#tblListPermintaanRehab').addClass('animation-loading');
			$.ajax({
				type:'POST',
				...
				success:function(data){
					if(data.status == true){
						...
						$('#tblListPermintaanRehab').removeClass('animation-loading');									
