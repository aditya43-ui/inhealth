...
<div class="formInputTab">
    ...
    <table style="width: 100%; border: none;">
        <tr>
            ...
            <td width="50%">
                <legend class="rim">Tabel Tindakan Rehab Medis <?php echo isset($modJenisTarif) ? "- " . $modJenisTarif->jenistarif->jenistarif_nama : ""; ?></legend>
...
<script>
    function inputperiksa(obj) {
        if ($(obj).is(':checked')) {
            ...
            jQuery.ajax({
                'url': '<?php echo Yii::app()->createUrl('perawatanIntensif/rehabMedisTPI/loadFormPermintaanRehabMedis') ?>',
                'data': {
    ...
    //{
    //    window.parent.myConfirm("Apakah Anda akan membatalkan kirim pasien ke Rehab Medis?","Perhatian!",function(r) {
    //        if(r){
