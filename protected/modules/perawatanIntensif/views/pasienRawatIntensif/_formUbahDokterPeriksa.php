...
<script type="text/javascript">
    function loadDataPendaftaran()
    {
        ...
        $.post("<?php echo $this->createUrl('getDataPendaftaranPI'); ?>", { pendaftaran_id: pendaftaran_id,pasienadmisi_id:pasienadmisi_id },
            function(data){
                ...
                $('#dp').val(dokter);
				$('#PIUbahdokterR_dokterlama_id').val(data.pegawai_id);
