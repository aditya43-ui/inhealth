...
<tr id="tr_<?php echo $morbiditas->diagnosa_id; ?>">
    ...
    <td><?php echo CHtml::dropDownList("Morbiditas[$i][kelompokDiagnosa]",$morbiditas->kelompokdiagnosa_id,CHtml::listData(PIKelompokDiagnosaM::model()->findAll(), "kelompokdiagnosa_id", "kelompokdiagnosa_nama"),
    ...
    <td>
        ...
        <?php //echo CHtml::dropDownList("Morbiditas[$i][diagnosaTindakan]", $morbiditas->diagnosaicdix_id, CHtml::listData(PIDiagnosaicdixM::model()->findAll(), 'diagnosaicdix_id', 'diagnosaicdix_nama'),
                //                        array('empty'=>'-- Pilih --','id'=>'diagnosaTindakan_'.$morbiditas->diagnosa_id,'class'=>'span2')) ?>
    </td>
    <td>
        <?php echo CHtml::dropDownList("Morbiditas[$i][sebabDiagnosa]", $morbiditas->sebabdiagnosa_id, CHtml::listData(PISebabDiagnosaM::model()->findAll(), 'sebabdiagnosa_id', 'sebabdiagnosa_nama'),
