...
<table style="width: 100%; border: none;">
    ...
    <tr>
        ...
        <td colspan="3"></td>
        <td colspan="3" align="center" valign="middle">
            <?php // echo (isset($modPendaftaran->pegawai->gelardepan)?$modPendaftaran->pegawai->gelardepan:'').' '.$modPendaftaran->pegawai->nama_pegawai.' '.(isset($modPendaftaran->pegawai->gelarbelakang_nama)?$modPendaftaran->pegawai->gelarbelakang_nama:''); ?>
