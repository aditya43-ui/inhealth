...
<tr id="periksarad_<?php echo $modTarif->pemeriksaanrad_id; ?>">
    <td>
        ...
        <?php echo CHtml::hiddenField("permintaanPenunjang[pasienkirimkeunitlain_id][]", isset($pasienkirimkeunitlain_id) ? $pasienkirimkeunitlain_id : null,array('class'=>'inputFormTabel','readonly'=>true)); ?>
    ...
    <td><?php echo CHtml::textField("permintaanPenunjang[inputqty][]", '1',array('class'=>'inputFormTabel integer lebar1 qty', 'onkeyup'=>'cekInputQty(this);hitungTotal();')); ?></td>
</tr>
<?php } ?>
