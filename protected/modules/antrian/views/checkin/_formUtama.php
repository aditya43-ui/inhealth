    ...
    <div class="form_main">
        <div class="control-group">
            ...
            <div class="controls">
                ...
                <p style="font-size: 20pt;">Kode Booking <span style="font-weight: bold;">(Kode Reservasi)</span> atau Nomor <span style="font-weight: bold;">Kartu BPJS</span> atau <span style="font-weight: bold;">Kartu Tanda Penduduk (KTP)</span></p>
                <?php
                echo CHtml::textField('input_no_kartu', null, array('class' => 'input_no_kartu', 'style' => 'width:700px;height:50px;font-size:30px; border-radius:5px;background-color:#B7FBB7;', 'onkeyup' => "namaLain(this);"));
                echo "<br>";
                echo CHtml::htmlButton("Proses", array(
                    "onclick" => "setPemeriksaanPertama(1);",
                    "class" => "btn btn-success",
                    "style" => "font-size:30px; padding:20px 30px; border-radius:5px; margin-top:10px;background-color:#3E6F3E;",
                ));
                ?>
            </div>
            <br>
...
<script>
    function kembaliKeHalamanAwal() {
        window.location.replace("<?php echo Yii::app()->createUrl('antrian/AmbilTiket/IndexAntrianPasien')  ?>")
    }
