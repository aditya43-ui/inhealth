<?php
    ...
    $default = isset($default)?$default:'tidak';
?>
...
//        var katakunci1 = $('#PPSepT_jnspelayanan').val();
        ...
        var setting = {
            ...
            success: function (data) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?php echo $this->createUrl('setFormDokterMelayani'); ?>',
