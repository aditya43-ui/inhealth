                        ...
                        if (count($modLokets) > 0) {
                            ...
                            foreach ($modLokets as $key => $loket) {
                                ...
                                <div class="item-a col-sm-12">
                                    <div class="radius tombol loket_<?php echo $loket->modelantrian_id; ?>" onclick="toPoli(<?php echo $loket->modelantrian_id ?>,'<?php echo $loket->modelantrian_kode ?>' )" id="btn-<?php echo strtolower(str_replace(" ", "-", $loket->modelantrian_nama)) ?>" style="background-color:#448074;">
                    ...
                    <div class="col-sm-12" width="100%">
                        <div class="col-sm-12" width="100%">
                            <ul class="tab-pilih2 col-sm-2">
                                <li class="">
                                    <div class="back-button">                                
                                        <i class="fas fa-long-arrow-alt-left" onclick="toPoli2(<?php echo $poli->ruangan_id; ?>)"></i>
                                    </div>
                                </li>
                            </ul>
                        </div>
