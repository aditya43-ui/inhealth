<?php $this->pageTitle = ' - Print Ambil Tiket '.$modAntrian->modelantrian->modelantrian_nama.'' ?>
<style>
    body {
...
<table style='width:100%;' class="details">
    <!-- <tr>
        <td colspan="2" style="font-size: 20px;">
            <?php //echo $this->renderPartial('application.views.headerReport.headerDefaultKarcisRJ2',array('judulLaporan'=>'ANTRIAN BILLING KASIR')); ?>
        </td>
        </tr> -->
    <tr>
    ...
    <tr>
       <td width="100%" colspan="3" style="text-align: center;">
           <b>NOMOR ANTRIAN <?php echo strtoupper($modAntrian->modelantrian->modelantrian_nama); ?></b>  
           <br>
           <br><br>
        </td>
    </tr>
    <tr>
       <td width="100%" colspan="3">
           ...
           <b><span style="font-size: 35px;"><?php echo strtoupper($modAntrian->modelantrian->modelantrian_singkatan."-".$modAntrian->noantrian) ?></span></b>  
           <br>
           </p>
           </div>
        </td>
