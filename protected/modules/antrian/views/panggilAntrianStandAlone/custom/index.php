...
<div class="panel panel-primary panel-gradient panggil_antrian">
    <div class="panel-heading">
        <div class="panel-title"><b>Pemanggilan Antrian</b></div>
    </div>
    <div class="panel-body">
        ...
        <table class="table-condensed" width="100%">
            ...
            <tr>
                ...
                <td style="text-align: center;">                    
                    <?php echo CHtml::dropDownList('modelantrian_id', '', array(), array('class' => 'span3', 'empty' => '-- Pilih --', 'onchange' =>'setFormAntrian("reset");setDropdownLoket();')) ?>
                </td>
                <td style="text-align: center;">
...
<div id="time"></div>
<?php echo $this->renderPartial('_jsFunctionsAntrian',array('modAntrian'=>$modAntrian, 'konfig'=>$konfig)); ?>
