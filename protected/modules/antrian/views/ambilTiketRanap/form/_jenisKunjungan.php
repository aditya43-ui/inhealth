<?php
    ...
    ?>
        ...
        <div data-form-jenis-kunjungan='fast track' class="form-horizontal">
            ...
            <table width="100%">
                <tr>
                    <td style="font-size:2vw;">Penanggung Jawab</td>
                ...
                <tr>
                    ...
                    <td><?= CHtml::activeTextField($model,'nama_pasien',['class'=>'required input-form-control']) ?></td>
                </tr>
                <tr>
                    <td style="font-size:2vw;">Alasan Fasttrack</td>
