                        ...
                        if (count($modLokets) > 0) {
                            ...
                            foreach ($modLokets as $key => $loket) {
                                ...
                                <div class="item-a col-sm-12">
                                    <div class="radius-penjamin tombol loket_<?php echo $loket->modelantrian_id; ?>" onclick="toNomorLangsung(<?php echo $loket->modelantrian_id ?>,'<?php echo $loket->modelantrian_kode ?>' )" id="btn-<?php echo strtolower(str_replace(" ", "-", $loket->modelantrian_nama)) ?>" style="background-color:#448074;">
...
// console.log(modelantrian_kode)
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.ada){
                        ...
                        alert("Nomor rekam medik tidak terdaftar");
                    }
                },
    ...
    function toNomorLangsung(id, kode) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo $this->createUrl('SimpanTiketLangsungRawatInap'); ?>',
            data: {
                modelantrian_id: id,
...
//                }, 2000); // akan diprint kembali 2 detik setelah print pertama
    ...
    function print(antrian_id) {
        $("#print_win").attr('src', "<?php echo $this->createUrl('PrintRanap') ?>&antrian_id=" + antrian_id);
    }
