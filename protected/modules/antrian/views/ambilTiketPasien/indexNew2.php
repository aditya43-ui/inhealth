            ...
            <div class="row">
                ...
                <div id="penjamin">
                    ...
                    <div class="item-select col-sm-12">
                        ...
                        ?>
                            <a href='<?php echo Yii::app()->createUrl('antrian/checkin/index/') ?>'>
                                    <div class="item-a col-sm-12">
                                    <div class="radius-penjamin tombol loket_" style="background-color:#448074;width: 263pt;">
                                        <div class="tombolheader">
                                            <div class="labeltiket">
                                                <?php //echo strtoupper($loket->modelantrian_nama); ?>
                                                KEDATANGAN
                                        ...
                                        <div class="tombolbody2">
                                            <hr>                                            
                                            <div class="labeltiket3" >
                                                <div class="setakhir" style="font-size:1.5vw;">CHECK IN</div>
                                                <div class="setnomor" style="font-size:1.5vw;"><?php //$loket->modelantrian_kode . "-" . $antrian['nomaksimal'];  echo $antrian['nomaksimal']; ?></div>
                                        <!-- <div class="clearfix"></div> -->
                                            </div>
                                        </div>
                ...
                <div id="jeniskunjungan">
                    <div class="col-sm-12" width="100%">
                        ...
                        <div class="item-select col-sm-12">
                        <?= $this->renderPartial($this->pathView_antrian_pasien.'form/_jenisKunjungan',['model'=>$model], true) ?>
                        </div>
                    </div>
                </div>
                <!-- end jeniskunjungan -->
...
$this->renderPartial($this->pathView_antrian_pasien.'_dialog',[]);
?>
...
//                }, 2000); // akan diprint kembali 2 detik setelah print pertama
    ...
    $(document).ready(function() {
        ...
        <?php  if(isset($_GET['sukses'])&& isset($_GET['pendaftaran_id'])) { ?>
                myAlert('Pasien Berhasil Check-in','Success')
            <?php }?>
    });
</script>