            ...
            <div class="row">
                <div class="col-sm-12" width="100%">
                    <ul class="tab-pilih">
                        ...
                        <li class="poli-tab"><a onclick="return false">2. Poliklinik</a></li>
                        <li class="dokter-tab"><a onclick="return false">3. Dokter</a></li>
                ...
                <div id="penjamin" class="item-select">
                        ...
                        ?>
                        <div class="item-a">
                            <div class="tombol" onclick="toBooking()" style="background-color:<?php echo $card_color ?>;">
                                <div class="tombolheader">
                                    <div class="tombolicon">
                                        <i class="far fa-address-card"></i>
                                    </div>
                                ...
                                <div class="tombolbody">
                                    ...
                                    <div class="labeltiket">
                                    <div class="setakhir"></div>
                                        <div class="setnomor"></div>
                                    </div>
                                </div>
                            </div>
                            <?php
                        ...
                        <?php 
                            $sql = "SELECT MAX(cast(noantrian as integer)) as nomaksimal FROM antrian_t
                            WHERE DATE(tglantrian)='" . date('Y-m-d') . "'
                            AND modelantrian_id = " . $modKasir->modelantrian_id;
                            $antrianK = Yii::app()->db->createCommand($sql)->queryRow();

                            if (!isset($antrianK['nomaksimal'])) {
                                $antrianK['nomaksimal'] = 0;
                            }
                            ?>
                        <div class="item-a">
                            <div class="tombol loket_<?php echo $modKasir->modelantrian_id; ?>" onclick="toPoli(<?php echo $modKasir->modelantrian_id ?>,'<?php echo $modKasir->modelantrian_kode ?>' )" id="btn-<?php echo strtolower(str_replace(" ", "-", $modKasir->modelantrian_nama)) ?>" style="background-color:<?php echo $input_even ?>;">
                                <div class="tombolheader">
                                    <div class="tombolicon">
                                        <i class="far fa-address-card"></i>
                                    </div>
                                ...
                                <div class="tombolbody">
                                    ...
                                    <div class="labeltiket">
                                        ANTRIAN <br>
                                        <?php echo strtoupper($modKasir->modelantrian_nama); ?>
                                    </div>
                                    <div class="labeltiket">
                                    <div class="setakhir">ANTRIAN AKHIR</div>
                                                <div class="setnomor"><?php echo $modKasir->modelantrian_kode . "-" . $antrianK['nomaksimal']; ?></div>
                                    </div>
                                </div>
                            </div>
                            <?php
                        ...
                        <!-- Daftar Boking -->
                    <div class="main_booking" id="item-checkin" style="display: none;">
                        <?php echo $this->renderPartial($this->pathView_umum_asuransi . 'indexBooking', array(), true); ?>
                    </div>
                </div>
                ...
                <div id="poliklinik" class="item-select">
                    ...
                    ?>
                            ...
                            ?>
                            <div class="item-b">
                                <div class="tombol" onclick="toDokter(<?php echo $poli->ruangan_id; ?>)" style="background-color:<?php echo $card_color ?>; height: initial;">
                                    <div class="tombolheader">
                                        <div class="tombolicon">
...
<script type="text/javascript">
    ...
    function toPenjamin(modelantrian_id) {
        ...
        $('#tab-text').html('Silakan Pilih Antrian')
