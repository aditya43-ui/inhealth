...
<body>
    ...
    <div class="bases">
        ...
        <div>
            ...
            <?php
            echo CHtml::link(
                Yii::t('mds', '{icon}', array('{icon}' => '<img width="400px" src="images/KIOSK/Icon-07-07.png"/>')),
                Yii::app()->createUrl($this->module->id . '/ambilTiket/indexUmumAsuransiNew2&modulId=76'),
                array()
            );
            echo CHtml::link(
                Yii::t('mds', '{icon}', array('{icon}' => '<img width="400px" src="images/KIOSK/Icon-07_Payment-07.png"/>')),
                Yii::app()->createUrl($this->module->id . '/ambilTiket/indexUmumAsuransiNew2&modulId=76'),
                array()
            );
            echo CHtml::link(
                Yii::t('mds', '{icon}', array('{icon}' => '<img width="400px" src="images/KIOSK/Icon-07_Jadwal Dokter-07.png"/>')),
                Yii::app()->createUrl($this->module->id . '/ambilTiket/indexUmumAsuransiNew2&modulId=76'),
                array()
            );
            ?>
