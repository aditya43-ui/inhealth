...
function printKarcisFarmasiResep(reseptur_id, caraprint)
{
    window.open("<?php echo Yii::app()->createUrl('farmasiApotek/informasiPasienResep/printResepDokter') ?>&id="+reseptur_id+"&caraPrint="+caraprint,"",'location=_new, width=900px');
}
