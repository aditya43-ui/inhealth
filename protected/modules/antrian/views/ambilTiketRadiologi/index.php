...
<style>
    ...
    .k1btn-tiket1 {
        ...
        line-height: 1;
        <?php if($jenis_pasien=="RAD" || empty($jenis_pasien)){
           echo "background: url('images/antrian/btn1rad.png');";
        }?>
        background-repeat: no-repeat;
    }
     .k2btn-tiket2 {
        ...
        height:431px;
        <?php if($jenis_pasien=="RAD" || empty($jenis_pasien)){
            echo "background: url('images/antrian/btn2Lab.png');";
        } ?>
        border:none;
        vertical-align: top;
        font-family: Arial, Helvetica, sans-serif;
    ...
    button.k1btn-tiket1:hover {
        <?php if($jenis_pasien=="RAD" || empty($jenis_pasien)){
           echo "background: url('images/antrian/btn1radover.png');";
        } ?>
        box-shadow: 2px 4px 3px 2px #222;
        background-repeat: no-repeat;    
    }
    button.k2btn-tiket2:hover {
        <?php if($jenis_pasien=="RAD" || empty($jenis_pasien)){
           echo "background: url('images/antrian/btn2LabOver.png');";
        } ?>
        box-shadow: 2px 4px 3px 2px #222;
        background-repeat: no-repeat;    
    }
...
<?php $form=$this->beginWidget('ext.bootstrap.widgets.BootActiveForm',array(
    ...
    <div id="headerAntrian2">
        ...
        ?>
        <h1 style="text-align: center; margin-top: 50px; height: 60px; font-size: 50px;font-family:oswald; font-weight: bold; color: grey; "><?php echo $tampung1; ?></h1>
        <?php if (!empty($tampung2)): ?>
    ...
    <div class="content">
        ...
        <div class="bases" style="padding-left: calc(100% - (100% - 50px));">
        <?php
