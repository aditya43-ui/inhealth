...
<style>
    ...
    #pantrian2 {
        ...
        justify-content: center;
        float: left;
        width: calc(25% * <?php echo (4 - count((array)$modModels)); ?>);
        height: 175px;
        padding: 10px;
...
<div class="row" style="margin: 15px 15px 0">
    <div class="statistik" id="pantrian2">
    ...
    if (count((array)$modModels) > 0) {
        foreach ($modModels as $i => $loket) {
    ?>
            <div id="loket2_<?php echo $loket->modelantrian_id; ?>" class="antrian" data-antrian="<?php echo $loket->modelantrian_id; ?>">
                <div class="col-xs-2 statistik" id="pantrian" style="font-size:16px; color:white; font-family:oswald; font-weight: bold;background-color:<?php echo $col[$cnt]; ?>;">
                    <?php echo "<h3 style='color:white'>" . strtoupper($loket->modelantrian_nama) . "</h3>"; ?>
                    <?php echo $this->renderPartial('_statistik_model', array('loket' => $loket)); ?>
                </div>
            </div>
    <?php
            $cnt++;
...
<div class="row frame-antrian">
    ...
    <div class="col-sm-6" style="padding: 0 2px;">
        ...
        for ($i = 0; $i < $loket_total; $i++) {
            ?>
            <div class="col-sm-6 col-nopadding">
                <div class="no-loket">
                    <div class="col-xs-4 ruangan1">
                    </div>
                    <div class="col-xs-4 no-antrian" id="pantriantengah">
                    ...
                    <div class="col-xs-4 ruangan" id="pasien-deskripsi_<?php echo $i; ?>">
                        <div class="col-sm-12">MERAWAT DENGAN KASIH SAYANG</div>
                    </div>
                </div>
            </div>
        <?php } ?>
