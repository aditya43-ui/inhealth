        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (var key in data) {
                    if (data.hasOwnProperty(key)) {
                        ...
                        if (obj.antrian_id !== null) {
                            ...
                            if (obj.loket_id == 1 || obj.loket_id == 9 || obj.loket_id == 17) {
                                $('.loketAntrian_1').hide();
                            ...
                            } else if (obj.loket_id == 2 || obj.loket_id == 10 || obj.loket_id == 18) {
                                $('.loketAntrian_2').hide();
                                $("#loket_" + obj.loket_id).show();
                                noantrians[i] = obj.noantrian;
                                loket_ids[i] = obj.loket_id;
                                modelantrian_singkatan[i] = obj.modelantrian_singkatan;
                            } else if (obj.loket_id == 3 || obj.loket_id == 11 || obj.loket_id == 19) {
                                $('.loketAntrian_3').hide();
                                $("#loket_" + obj.loket_id).show();
                                noantrians[i] = obj.noantrian;
                                loket_ids[i] = obj.loket_id;
                                modelantrian_singkatan[i] = obj.modelantrian_singkatan;
                            } else if (obj.loket_id == 4 || obj.loket_id == 12 || obj.loket_id == 20) {
                                $('.loketAntrian_4').hide();
                                $("#loket_" + obj.loket_id).show();
                                noantrians[i] = obj.noantrian;
                                loket_ids[i] = obj.loket_id;
                ...
                if (i > 0 && (antrian_id != '' && antrian_id != undefined)) { //agar tidak memanggil ketika refresh interval fungsi ini kecuali jika noantrian berubah
                    ...
                    setAntrianAllTerakhir('AntrianJaminanLama1');
                }
            },
