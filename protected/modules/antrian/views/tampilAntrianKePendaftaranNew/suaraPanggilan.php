...
?>
        ...
        <script type="text/javascript">
            ...
            setPlaylist("<?php echo $i;?>","kodeantri","<?php echo strtolower(trim($modLokets[$i]->modelantrian->modelantrian_singkatan)); ?>");
...
$(document).ready(function() {
    ...
    var soundDat = [
        ...
        {name: "noantrian"},
        {name: "<?php echo strtolower(trim($modLokets[$i]->modelantrian->modelantrian_singkatan)); ?>"},
        <?php   
        $noantrian_split = explode(" ", strtolower(MyFormatter::formatNumberTerbilang((int)$noantrian)));
        foreach($noantrian_split as $ii => $nomor){ ?>
        {name: "<?php echo $nomor; ?>"},
