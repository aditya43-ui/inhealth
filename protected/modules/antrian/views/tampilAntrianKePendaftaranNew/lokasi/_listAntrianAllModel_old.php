...
/*
<div class="lis-antrian " nolist = '1' style='padding: 0 0.7% 0 0.3%;'>
    <div class=' col-md-2' style='padding: 0;margin-right: 5px;'>  
        <?= $this->renderPartial($pathview.'lokasi/all/_view_kel_no_antrian',['i'=>0], true) ?>
        <?= $this->renderPartial($pathview.'lokasi/all/_view_kel_no_antrian',['i'=>1], true) ?>
        <?= $this->renderPartial($pathview.'lokasi/all/_view_kel_no_antrian',['i'=>2], true) ?>
        <?= $this->renderPartial($pathview.'lokasi/all/_view_kel_no_antrian',['i'=>3], true) ?>
    </div>
    <div class=' col-md-2' style='height:30vw;background: red;padding: 0;background:red;vertical-align: middle;margin: 0;position:relative'>  
        <?= $this->renderPartial($pathview.'lokasi/all/_view_kel_no_antrian',['i'=>0], true) ?>        
    </div>    
</div>
 * */
...
if (count($load_model) > 0) {    
    $w_mod = (100/(count($load_model)));
    foreach($nomor_loket as $tab){
        echo '<div class="lis-antrian " nolist = "1" style="padding:0 4px 0 4px;display: table;width:100%;">';
            $i = 0; 
            $no_mod = 0;
            foreach($load_model as $mod){
                ...
                echo '<div style="padding: 0;width:'.$w_mod.'%;padding:0 4px 0 0;display: table-cell;" class="'.$hide.'">';
                    echo $this->renderPartial($pathview.'lokasi/all/_view_kel_no_antrian',[
                        'mod'=>$mod,
                        'i'=>$i,
                        'no_mod'=>$no_mod,
                        'tab'=>$tab,
