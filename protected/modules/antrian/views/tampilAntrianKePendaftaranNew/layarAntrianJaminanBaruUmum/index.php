...
<div class="row">
    ...
    <div class="col-md-8 " id="layar" >
        ...
        <div style="margin-top:35px; text-align:center; font-size:40px; color:white; font-family:oswald; font-weight:bolder;"><?php echo strtoupper($layar->layarantrian_nama); ?></div>
    </div>
</div>
<div class="row">
    <?php
...
<script>
    ...
    function customFungsi(){
        for (var key in arr) {
            if (arr.hasOwnProperty(key)) {
                ...
                if (obj.antrian_id !== null) {
                    ...
                    if (obj.loket_id == 25 || obj.loket_id == 28 || obj.loket_id == 31) {
                        $('.loketAntrian_5').hide();
                        $("#loket_" + obj.loket_id).show();                        
                    } else if (obj.loket_id == 26 || obj.loket_id == 29 || obj.loket_id == 32) {
                        $('.loketAntrian_6').hide();
                        $("#loket_" + obj.loket_id).show();                        
                    } else if (obj.loket_id == 27 || obj.loket_id == 30 || obj.loket_id == 33) {
                        $('.loketAntrian_7').hide();
                        $("#loket_" + obj.loket_id).show();                        
                    }
                }                
        ...
        setAntrianAllTerakhir('AntrianJaminanBaruUmum');
    }
    ...
    function setAntrians(antrian_id) {
        var jenis = 'AntrianJaminanBaruUmum';
        $.ajax({
            type: 'POST',
