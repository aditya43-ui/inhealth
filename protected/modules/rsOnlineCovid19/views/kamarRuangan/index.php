...
$this->breadcrumbs = array(
    'Informasi Kamar Ruangan'
);
$controller = Yii::app()->controller->id; //mengambil Controller yang sedang dipakai
$module = Yii::app()->controller->module->id; //mengambil Module yang sedang dipakai
Yii::app()->clientScript->registerScript('cari wew', "
    $('#daftarPasien-form').submit(function(){
        $('#daftarkamarruangan-grid').addClass('animation-loading');
        $.fn.yiiGridView.update('daftarkamarruangan-grid', {
            data: $(this).serialize()
        });
        return false;
    });
...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="entypo-info-circled"></i> Informasi <b>Kamar Ruangan</b>
        </div>
    </div>
                ...
                $this->widget('ext.bootstrap.widgets.BootGridView', array(
                    ...
                    'columns' => array(
                        ...
                        array(
                            ...
                            'type' => 'raw',
                            'value' => function ($data) {
                                return $data->kamarruangan_jmlbed;
                            },
                        ),
                        array(
                            ...
                            'value' => function ($data) {
                                if (!empty($data->tglpengiriminkemenkes)) {
                                    ...
                                    return CHtml::htmlButton(Yii::t('mds', '{icon} Belum Terkirim', array('{icon}' => '<i class="' . MyIcon::getIcons('tambah-baris') . '"></i>')), array('class' => 'btn btn-primary', 'type' => 'button', 'onclick' => 'tambahPasien("' . $data->kamarruangan_id . '")'));
                                }
                            },
                        ...
                        array(
                            ...
                            'value' => function ($data) {
                                ...
                                return CHtml::htmlButton(Yii::t('mds', '{icon} ' . $label, array('{icon}' => '<i class="' . MyIcon::getIcons('ubah') . '"></i>')), array('class' => 'btn btn-info', 'type' => 'button', 'onclick' => 'ubahPasien("' . $data->kamarruangan_id . '")'));
                            },
                            'htmlOptions' => array('style' => 'text-align: center;'),
                        ),
                        array(
                            ...
                            'value' => function ($data) {
                                ...
                                return CHtml::htmlButton(Yii::t('mds', '{icon} ' . $label, array('{icon}' => '<i class="' . MyIcon::getIcons('hapus') . '"></i>')), array('class' => 'btn btn-danger', 'type' => 'button', 'onclick' => 'hapusPasien("' . $data->kamarruangan_id . '")'));
                            },
                            'htmlOptions' => array('style' => 'text-align: center;'),
                        ),
                    ),
...
<script type="text/javascript">
    function tambahPasien(kamarruangan_id) {
    ...
    function ubahPasien(kamarruangan_id) {
        $('#alertpesanPasien').html("");
        $.ajax({
            type: 'POST',
            url: '<?php echo $this->createUrl('PasienKemenkes'); ?>',
    ...
    function hapusPasien(kamarruangan_id) {
        $('#alertpesanPasien').html("");
