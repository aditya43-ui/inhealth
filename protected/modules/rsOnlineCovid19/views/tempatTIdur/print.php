...
function searchData() {
    $.ajax({
        ...
        dataType: "json",
         beforeSend: function(){
            $("#table-tempattidur").addClass("animation-loading");
        },
        success: function (data) {
            $("#table-tempattidur").removeClass("animation-loading");
            if(data.status!= '200'){
              $("#table-tempattidur > tbody > tr").remove();
                $('#table-tempattidur > tbody').html(data.form);
