<?php
class TempatTidurController extends MyAuthController{
	
    public $path_view = 'rsOnlineCovid19.views.tempatTIdur.';
    ...
    public function actionGetDataKemenkes()
    {
        if(Yii::app()->request->isAjaxRequest) { 
            ...
            $start = 1;
            $limit = 10;
            $dataBridging = $bpjs->tempattindur("",$start, $limit);
            ...
            if(count($decodeJson->tempat_tidur) > 0){
                $no = 1;
                foreach ($decodeJson->tempat_tidur as $data){
