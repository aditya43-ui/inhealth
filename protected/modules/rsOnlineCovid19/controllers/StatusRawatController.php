<?php
class StatusRawatController extends MyAuthController{
	
    public $path_view = 'rsOnlineCovid19.views.statusRawat.';
    ...
    public function actionGetDataStatusRawat()
    {
        if(Yii::app()->request->isAjaxRequest) { 
            ...
            if(count($decodeJson->status_rawat) > 0){
                $no = 1;
