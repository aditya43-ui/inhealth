    ...
    <tr>
        ...
        <td width="50%">
            <table width="100%" style="margin:0px;" cellpadding="0" cellspacing="0">
                <tr>
                    <td width="180px">No Referensi</td>
                    <td>
...
<div class="row-fluid">
	<div class="cols-sm-4" style="text-align:center;">
	...
	<div class="cols-sm-4" style="text-align:center;">
            <div class='control-group' style='margin-bottom: 57.5px;margin-top: 10px;'>
                <?php // echo ucwords(strtolower($modProfilRs->kabupaten->kabupaten_nama)); ?> Direktur, <br />Menyetujui<?php // echo MyFormatter::getMonthId(date('m')) . " " . date('Y'); ?>
            </div>
            <div class="control-group">
...
//    echo CHtml::htmlButton(Yii::t('mds','{icon} PDF',array('{icon}'=>'<i class="icon-book icon-white"></i>')),array('class'=>'btn btn-primary', 'type'=>'button','onclick'=>'print(\'PDF\')'))."&nbsp&nbsp";
    $urlPrint= $this->createUrl('print',array('permintaanpembelian_id'=>$model->permintaanpembelian_id));
