    ...
    <table width="100%" style='margin-left:auto; margin-right:auto;' class = "border">
        ...
        ?>
            <tr class="border">
                ...
                <td style = "text-align:right;"><?php echo ($this->cekPegawaiJabatan() || Params::cekHiddenHargaGudangFarmasi()==true)?"Rp".MyFormatter::formatNumberForPrint($modObat->harganettoper, 2):"Hidden"; ?></td>
                <td style = "text-align:right;"><?php echo ($this->cekPegawaiJabatan() || Params::cekHiddenHargaGudangFarmasi()==true)?($modObat->persenppn):"Hidden"; ?></td>
                <td style = "text-align:right;"><?php echo ($this->cekPegawaiJabatan() || Params::cekHiddenHargaGudangFarmasi()==true)?"Rp".MyFormatter::formatNumberForPrint($modObat->ppn, 2):"Hidden"; ?></td>
                <td style = "text-align:right;"><?php echo ($this->cekPegawaiJabatan() || Params::cekHiddenHargaGudangFarmasi()==true)?"Rp".MyFormatter::formatNumberForPrint($modObat->hpp, 2):"Hidden"; ?></td>
                <td style = "text-align:right;"><?php echo ($this->cekPegawaiJabatan() || Params::cekHiddenHargaGudangFarmasi()==true)?"Rp".MyFormatter::formatNumberForPrint($modObat->hpp*$modObat->jmlpermintaan, 2):"Hidden"; ?></td>
                </td>
            </tr>
        <?php } ?>
        <tr>
