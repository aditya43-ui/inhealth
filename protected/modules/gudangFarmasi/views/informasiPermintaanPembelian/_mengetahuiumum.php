...
<table style="margin:0 auto; ">
        ...
        ?>
             <TR>
                <TD style="text-align: center; color: black !important;" colspan=" <?php echo (!empty($colspan)) ? ($colspan) : "6"; ?>" ALIGN=CENTER VALIGN=MIDDLE ><h3><?php echo $judulLaporan ?></h3></TD>
            </TR>
        <?php
            }
        ?>
...
<div class="row-fluid">
	<div class="col-sm-4" style="text-align:center;">
			...
			if(isset($_GET['sukses'])){
				...
				echo "Manager Umum, <br> Mengetahui";
			}else{
				...
				array('class'=>'btn btn-primary',
					...
					function(r) {if(r) window.location = "'.$this->createUrl('MengetahuiUmum',array('permintaanpembelian_id'=>$model->permintaanpembelian_id,'approve'=>true)).'";} ); return false;'));  
			}
			?>
		</div>	
	...
	<div class="col-sm-4" style="text-align:center;">
		...
		<div class="control-group">
			( <?php echo isset($model->tglmenyetujui)?$model->pegawaimenyetujui->NamaLengkap:"";?> )
		</div>
	</div>
</div>
...
<?php 
    ...
    $urlPrint= $this->createUrl('printMengetahuiUmum',array('permintaanpembelian_id'=>$model->permintaanpembelian_id));
