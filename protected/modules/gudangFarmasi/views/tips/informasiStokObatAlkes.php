...
<table style="width:100%; padding: none; border: none;">
  <tr>
    ...
    <td>Icon <i class="icon-form-ubah"></i> untuk mmengubah data.</td>
  </tr>
  <tr>
    <td>3</td>
    <td>
        Gunakan tombol ini  <button class="btn btn-primary" name="yt0" type="submit"><i class="entypo-check"></i> Simpan        
