<div class="col-sm-6">
		...
		<div class="controls">
			...
			<?php 
				$this->widget('MyJuiAutoComplete', array(
					...
					'tombolDialog'=>array('idDialog'=>'dialogObatAlkesSupplier','idTombol'=>'tombolDialogObatAlkes'),
				)); 
			?>
		</div>
	</div>
	<div class="control-group">
		...
		<div class="controls">
			...
			<label>Berdasarkan Master Obat & Alkes</label>
		</div>
	</div>
</div>
<div class="col-sm-6">
    <div class="control-group ">
		...
		<div class="controls">
			<?php echo CHtml::textField('qty_input', 1, array('onblur'=>'$("#qty").val(this.value);','onkeyup'=>"return $(this).focusNextInputField(event)",'class'=>'span1 integer-decimal', 'style' => 'text-align:right;width:50px;')) ?>
		</div>
		<div class="controls">
		...
		<div class="controls">
            <?php echo CHtml::hiddenField('tipesatuan',Params::SATUANOBAT_KECIL) ?>
			<?php echo CHtml::dropDownList('tipesatuan_nama', Params::SATUANOBAT_KECIL ,LookupM::getItems('satuanobat'), array('style'=>'width:120px;', 'onchange'=>'cekTipeSatuan(this);', 'disabled'=>true)) ?>
		</div>
		<div class="controls">
...
$modObatAlkes->supplier_id = $modPenerimaanBarang->supplier_id;
...
if(isset($_GET['GFObatSupplierM'])){
	...
	$modObatAlkes->satuankecil_id = isset($_GET['GFObatSupplierM']['satuankecil_id'])?$_GET['GFObatSupplierM']['satuankecil_id']:null;
        $modObatAlkes->tglkadaluarsa = isset($_GET['GFObatSupplierM']['tglkadaluarsa'])?$_GET['GFObatSupplierM']['tglkadaluarsa']:null;
}
...
$this->widget('ext.bootstrap.widgets.BootGridView',array(
	...
	'columns'=>array(
				...
				array(
                    ...
                    'type'=>'raw',
                    'value'=>function($data){						
                            return date("d/m/Y",strtotime($data->obatalkes->tglkadaluarsa));						
                    },
//                    'value'=>'date("d/m/Y",strtotime($data->tglkadaluarsa))',
				...
				array(
                    'name'=>'hargabelibesar',
                    'type'=>'raw',
                    'value'=>'MyFormatter::formatNumberForPrint($data->hargabelibesar, 2)',
                    'filter'=>false,
                ...
                array(
                    'name'=>'hargabelikecil',
                    'type'=>'raw',
                    'value'=>'MyFormatter::formatNumberForPrint($data->hargabelikecil, 2)',
                    'filter'=>false,
                    'htmlOptions'=>array('style'=>'text-align: right;'),
                ),
                array(
        ...
        'afterAjaxUpdate'=>'function(id, data){$("#obatalkessupplier-m-grid .datemask").mask("99/99/9999");jQuery(\''.Params::TOOLTIP_SELECTOR.'\').tooltip({"placement":"'.Params::TOOLTIP_PLACEMENT.'"});}',
));
...
if(isset($_GET['GFObatalkesM'])){
    ...
    $modObatAlkes->tglkadaluarsa = isset($_GET['GFObatalkesM']['tglkadaluarsa'])?$_GET['GFObatalkesM']['tglkadaluarsa']:null;
}
$this->widget('ext.bootstrap.widgets.BootGridView',array(
	'id'=>'obatalkes-m-grid',
	'dataProvider'=>$modObatAlkes->searchDialog(),
	...
	'columns'=>array(
            ...
            array(
                    ...
                    'type'=>'raw',
                    'value'=>function($data){						
                            return date("d/m/Y",strtotime($data->tglkadaluarsa));						
                    },
//                    'value'=>'date("d/m/Y",strtotime($data->tglkadaluarsa))',
                    'filter'=>CHtml::activeTextField($modObatAlkes,'tglkadaluarsa',array('class'=>'datemask','placeholder'=>'cth:15/01/2020','onkeyup'=>'return $(this).focusNextInputField(event)')),
                ),
