<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class='fas fa-shopping-cart'></i> Transaksi <b>Pemesanan Obat dan Alkes</b>
        </div>
    </div>
    <div class="panel-body">
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class='far fa-file-alt'></i> Data <b>Pemesanan Obat dan Alkes</b>
                </div>
            </div>
            <div class="panel-body">
                <?php
                $this->breadcrumbs = array(
                    'Transaksi Permintaan Unit',
                );
                ?>
                <?php
            ...
            <div class="panel-body">
                ...
                <div class="panel panel-success">
                    ...
                    <div class="panel-body table-responsive">
                        <table class="items table table-bordered table-striped table-condensed" id="table-detailpemesanan">
                            <thead>
                                <tr>
                                    <th>No.</th>
                                    <th>Jenis</th>
        ...
        <div class="form-actions">
            ...
            if (isset($_GET['pesanobatalkes_id'])) {
                echo CHtml::htmlButton(
                    ...
                    array('title' => 'Simpan', 'class' => 'btn btn-danger', 'title' => 'Simpan', 'type' => 'button', 'disabled' => true, 'style' => 'cursor:not-allowed;')
                );
                echo CHtml::link(
                ...
                echo CHtml::htmlButton(
                    Yii::t('mds', '{icon} Save', array('{icon}' => '<i class="entypo-check"></i>')),
                    array('title' => 'Simpan', 'class' => 'btn btn-danger', 'title' => 'Simpan', 'type' => 'submit', 'onKeypress' => 'return formSubmit(this,event)')
                );
                echo CHtml::link(
                    Yii::t('mds', '{icon} Reset', array('{icon}' => '<i class="entypo-arrows-ccw"></i>')),
                    $this->createUrl($this->id . '/index'),
                ...
                echo CHtml::link(
                    Yii::t('mds', '{icon} Print', array('{icon}' => '<i class="entypo-print"></i>')),
                    'javascript:void(0);',
                    array('class' => 'btn btn-info', 'disabled' => TRUE, 'style' => 'cursor:not-allowed;')
                );
            }
            ?>
            <?php
