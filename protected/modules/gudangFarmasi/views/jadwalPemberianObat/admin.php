...
<div class="panel panel-primary panel-gradient">
    <div class="panel-heading">
        <div class="panel-title"><i class="fas fa-layer-group"></i> Pengaturan <strong>Jadwal Pemberian Obat</strong></div>
    </div>
...
<?php echo CHtml::link(Yii::t('mds', '{icon} Advanced Search', array('{icon}' => '<i class="icon-accordion icon-white"></i>')), '#', array('class' => 'search-button btn')); ?>
        ...
        <div class="panel panel-success panel-shadow">
            <div class="panel-heading">
                <div class="panel-title"><i class="entypo-credit-card"></i> Tabel <strong>Jadwal Pemberian Obat</strong></div>
            </div>
        ...
        <?php
        echo CHtml::link(Yii::t('mds', '{icon} Tambah Jadwal Pemberian Obat', array('{icon}'=>'<i class="icon-plus icon-white"></i>')),
