    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="control-group">
                <?php echo CHtml::label("Tgl. Formulir Opname", 'tgl_rekam', array('class' => 'control-label')) ?>
                <div class="controls">
        ...
        <div class="col-sm-6">
            <?php echo $form->textFieldRow($model, 'noformulir', array('placeholder' => 'No. Formulir Opname', 'class' => 'numberOnly')); ?>
        </div>
    </div>
