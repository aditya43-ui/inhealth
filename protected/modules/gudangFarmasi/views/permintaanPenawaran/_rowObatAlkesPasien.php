<tr>
    ...
    <td>
        <?php echo CHtml::activeDropDownList($modPenawaranDetail, '[ii]satuanobat', LookupM::getItems('satuanobat'),array('onChange'=>'pilihSatuan(this);','style'=>'width:100px;', 'class'=>'satuanobat')); ?><br>
