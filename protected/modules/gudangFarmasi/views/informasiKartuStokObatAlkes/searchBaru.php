<div id="divSearch-form">
    <div class="row">
        ...
        <div class="col-sm-6">
            <?php echo $form->dropDownListRow($model, 'instalasi_id', $instalasiAsals, array('disabled' => $disabled, 'class' => 'span4', 'empty' => '-- Pilih --', 'onkeyup' => "return $(this).focusNextInputField(event)", 'ajax' => array('type' => 'POST', 'url' => $this->createUrl('SetDropdownRuangan', array('encode' => false, 'model_nama' => get_class($model))), 'update' => "#" . CHtml::activeId($model, 'ruangan_id'),))); ?>
