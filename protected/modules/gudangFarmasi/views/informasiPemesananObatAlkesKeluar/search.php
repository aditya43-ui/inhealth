<div class="panel panel-success">
    ...
    <div class="panel-body">
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <?php echo $form->textFieldRow($model, 'nopemesanan', array('placeholder' => 'No. Pemesanan', 'class' => 'angkahuruf-only span4')); ?>
                ...
                <?php echo $form->dropDownListRow($model, 'ruangantujuan_id', $ruanganPemesanans, array('class' => 'span4', 'empty' => '-- Pilih --', 'onkeyup' => "return $(this).focusNextInputField(event);")); ?>
            </div>
            <div class="col-sm-6">
                ...
                <?php echo $form->dropDownListRow($model, 'pegawaipemesan_id', CHtml::listData(PegawairuanganV::model()->findAllByAttributes(array('ruangan_id' => Yii::app()->user->getState('ruangan_id'), 'pegawai_aktif' => TRUE,), array('order' => 'nama_pegawai')), 'pegawai_id', 'namaLengkap'), array('class' => 'span4', 'empty' => '-- Pilih --')); ?>
            </div>
        </div>
