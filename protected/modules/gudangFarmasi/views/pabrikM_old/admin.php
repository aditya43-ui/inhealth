<div class="white-container">
    ...
    <!--</div>-->
    <?php
    echo CHtml::link(Yii::t('mds', '{icon} Tambah Pabrik', array('{icon}' => '<i class="icon-plus icon-white"></i>')), $this->createUrl('create', array('modul_id' => Yii::app()->session['modul_id'])), array('class' => 'btn btn-danger',));
