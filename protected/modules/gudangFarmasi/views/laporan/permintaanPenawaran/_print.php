    ...
    <table style="width: 100%; border: none;">
        ...
        <tbody>
            <tr>
                <td>
                    <div class="content">
<?php  $this->renderPartial('permintaanPenawaran/_table', array('model'=>$model, 'caraPrint'=>$caraPrint)); ?>
    ...
    <table style="width: 100%; border: none;">
        ...
        <tbody>
            <tr>
                <td>
                    <div class="content">
    <?php     echo $this->renderPartial('_grafik', array('model'=>$model, 'data'=>$data, 'caraPrint'=>$caraPrint, 'grafik'=>$grafik), true); ?>
