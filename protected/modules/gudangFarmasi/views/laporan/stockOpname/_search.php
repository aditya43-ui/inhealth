<div class="search-form">
        ...
        <div class="col-sm-6">
            ...
            echo CHtml::hiddenField('filter', 'jenisobatalkes_id', array('disabled' => 'disabled')) .
                '<div class="control-group">
                        ...
                        <div class="controls">
                            ' . $form->dropDownList($model, 'jenisobatalkes_id', CHtml::listData(JenisobatalkesM::model()->findAll("jenisobatalkes_aktif = TRUE ORDER BY jenisobatalkes_nama ASC"), 'jenisobatalkes_id', 'jenisobatalkes_nama'), array(
    ...
    <div class="form-actions">
        ...
        <?php echo CHtml::link(
            ...
            $this->createUrl('laporanStockOpname'),
            array(
                'title' => 'Ulang',
