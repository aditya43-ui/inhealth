<?php
/**
 *  kumpulan fungsi js untuk laporan stok opname 
 * 
...
<script type="text/javascript">
	...
	$(document).ready(function() {
        ...
        var jnskelompok = jQuery('#<?php echo CHtml::activeId($model, 'jnskelompok') ?>');	
		...
		var pemakaianobat = jQuery('#<?php echo CHtml::activeId($model, 'status') ?>');			       
        ...
        * multi select propinsi dan kabupaten
        ...
        jQuery(jnskelompok).multiselect({
                includeSelectAllOption: true,
                buttonClass: "form-control",
                maxHeight: 300,
                buttonWidth: '182px',
		...
		jQuery(pemakaianobat).multiselect({
                includeSelectAllOption: true,
                buttonClass: "form-control",
                maxHeight: 300,
                buttonWidth: '182px',
