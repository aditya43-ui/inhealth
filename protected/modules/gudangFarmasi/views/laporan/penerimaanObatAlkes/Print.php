...
if ($caraPrint == 'EXCEL') {
    ...
    echo $this->renderPartial('application.views.headerReport.headerDefaultNewExcel', array('judulLaporan' => $judulLaporan, 'periode' => $periode, 'colspan' => 8));
}
...
if ($caraPrint != 'GRAFIK' && $caraPrint != 'PDF') {
 ...
 <?php $this->renderPartial('penerimaanObatAlkes/_table', array('model'=>$model, 'caraPrint'=>$caraPrint)); ?>
    ...
    <table style="width: 100%; border: none;">
        ...
        <tbody>
            <tr>
                <td>
                    <div class="content">
<?php    echo $this->renderPartial('penerimaanObatAlkes/_grafik', array('model'=>$model, 'data'=>$data, 'caraPrint'=>$caraPrint), true); ?>
