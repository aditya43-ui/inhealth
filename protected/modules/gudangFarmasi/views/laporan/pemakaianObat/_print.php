...
if ($caraPrint == 'EXCEL') {
    ...
    echo $this->renderPartial('application.views.headerReport.headerDefaultNewExcel', array('judulLaporan' => $judulLaporan, 'periode' => $periode, 'colspan' => 7));
}
            ...
            <tr>
                <td>
                    <div class="content">
                        ...
                        <?php
                        if ($model->tabmenu == 'pakai-obat') {
                            $this->renderPartial($this->path_view_gudang . 'pemakaianObat._table', array('model' => $model, 'caraPrint' => $caraPrint));
                        } elseif ($model->tabmenu == 'rekap-pakai-obat') {
                            $this->renderPartial($this->path_view_gudang . 'pemakaianObat._tableRekap', array('model' => $model, 'caraPrint' => $caraPrint));
                        }
                        ?>
    ...
    <table style="width: 100%; border: none;">
        ...
        <tbody>
            <tr>
                <td>
                    <div class="content">
                        <?php echo $this->renderPartial($this->path_view_gudang . 'pemakaianObat._grafik', array('model' => $model, 'data' => $data, 'caraPrint' => $caraPrint), true); ?>
