    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="control-group">
                <?php echo CHtml::label("Tgl. Stock Opname", 'tglstokopname', array('class' => 'control-label')) ?>
                <div class="controls">
            ...
            <?php echo $form->textFieldRow($model, 'nostokopname', array('placeholder' => 'Ketik No. Stock Opname', 'class' => 'angkahuruf-only span4',)); ?>
            <?php echo $form->dropDownListRow($model, 'jenisstokopname', LookupM::getItems('jenisstokopname'), array('empty' => '-- Pilih --', 'class' => 'span4',)) ?>
        </div>
        <div class="col-sm-6">
            <div class="control-group">
