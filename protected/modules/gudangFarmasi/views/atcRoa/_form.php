...
<div class="row">
    <div class="col-sm-6">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $form->textField($model, 'lookup_name', array('placeholder' => 'Route of Adm ATC', 'class' => 'span3', 'onkeyup' => "return $(this).focusNextInputField(event);", 'maxlength' => 100)); ?>
            </div>
        </div>
        <div class="control-group">
            <?php echo CHtml::label('Route of Adm ATC Lainnya <span class="required">*</span>', 'lookup_value', array('class' => 'control-label required')) ?>
            <div class="controls">
                <?php echo $form->textField($model, 'lookup_value', array('placeholder' => 'Route of Adm ATC Lainnya', 'class' => 'span3', 'onkeyup' => "return $(this).focusNextInputField(event);", 'maxlength' => 100)); ?>
            </div>
        </div>
    </div>
    <div class="col-sm-6">
...
<div class="form-actions">
    ...
    <?php echo CHtml::link(
        Yii::t('mds', '{icon} Pengaturan Route of Adm Atc', array('{icon}' => '<i class="icon-folder-open icon-white"></i>')),
