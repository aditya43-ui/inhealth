...
if (isset($_GET['sukses'])) {
    $hiddenData = "hidden";
    Yii::app()->user->setFlash('success', "Berhasil di Approve Oleh Direktur!");
}
    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-sm-6">
                ...
                <?php echo $form->hiddenField($model, 'statuspengajuan', array()); ?>
    ...
    <div class="panel-body table-responsive">
        <table width="100%" style='margin-left:auto; margin-right:auto;' class="items table table-bordered table-striped table-condensed">
            ...
            foreach ($modDetails as $i => $modObat) {
                $modObat->checklist = $modObat->isperubahanharga;
                $satuanobat = "";
            ...
            ?>
                <tr class="border">
                    ...
                    <td><?php echo MyFormatter::formatNumberForPrint($modObat->harganettolama); ?></td>
                    <td><?php echo MyFormatter::formatNumberForPrint($modObat->diskonlama); ?></td>
                    <td><?php echo MyFormatter::formatNumberForPrint($modObat->ppnlama); ?></td>
                    <td><?php echo MyFormatter::formatNumberForPrint($modObat->hpplama); ?></td>
                    <td><?php echo MyFormatter::formatNumberForPrint($modObat->marginlama) . "%"; ?></td>
                    <td><?php echo MyFormatter::formatNumberForPrint($modObat->hargajuallama); ?></td>
                    <td><?php echo MyFormatter::formatNumberForPrint($modObat->harganettobaru); ?></td>
                    <td><?php echo MyFormatter::formatNumberForPrint($modObat->diskonbaru); ?></td>
                    <td><?php echo MyFormatter::formatNumberForPrint($modObat->ppnbaru); ?></td>
                    <td><?php echo MyFormatter::formatNumberForPrint($modObat->hppbaru); ?></td>
                    <td><?php echo MyFormatter::formatNumberForPrint($modObat->marginbaru) . "%"; ?></td>
                    <td><?php echo MyFormatter::formatNumberForPrint($modObat->hargajualbaru); ?></td>
...
<div class="row">
    <div class="col-sm-6" style="text-align:center;">
        ...
        <div class="control-group">
            ( <?php echo isset($model->tglmengetahui) ? $model->pegawaimengetahui->NamaLengkap : ""; ?> )
        </div>
    </div>
    <div class="col-sm-6" style="text-align:center;">
        <?php
            ...
            echo CHtml::link(
                ...
                array(
                    ...
                    'onclick' => 'myConfirm("Apakah Anda yakin?","Perhatian!",
                        function(r) {if(r) simpanApproval("SUDAH DISETUJUI");} ); return false;'
                )
            );
            echo "&nbsp";
            echo CHtml::link(
                ...
                array(
                    ...
                    'onclick' => 'myConfirm("Apakah Anda yakin?","Perhatian!",
                                function(r) {if(r) simpanApproval("DITOLAK");} ); return false;'
                )
            );
        }
        ?>
...
<script type="text/javascript">
    function simpanApproval(typeapprove) {
        $('#<?php echo CHtml::activeId($model, 'statuspengajuan'); ?>').val(typeapprove);
