                        ...
                        <table class="items table table-bordered table-striped table-condensed" id="table-obat">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo !empty($detail->obatalkes_id) ? $detail->obatalkes->obatalkes_nama : null;?><br><?php echo $detail->etiket?></td>
                                    <td><?php echo $detail->signa_oa;?></td>
                                    <td><?php echo !empty($detail->permintaan_dosis) ? $detail->permintaan_dosis : '0';?> <?php echo !empty($detail->satuan_permintaandosis) ? $detail->satuan_permintaandosis : '';?></td>
                                    <td><?php echo !empty($detail->jml_permintaan) ? $detail->jml_permintaan : '0';?> <?php echo !empty($detail->satuan_jmlpermintaan) ? $detail->satuan_jmlpermintaan : '';?></td>
                                    <td><?php echo $detail->jumlah;?></td>
                                    <td><?php echo $detail->resepturketerangan?></td>
                                    <td hidden>
                                        <?php echo !empty($detail->satuankecil_id)?$detail->satuankecil->satuankecil_nama:null;?>
                                    </td>
