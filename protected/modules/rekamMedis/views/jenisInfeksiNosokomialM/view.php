<div class='white-container'>
    <legend class='rim2'>Lihat Jenis <b>Infeksi Nosokomial</b></legend>
    <?php
    ...
    //                (Yii::app()->user->checkAccess(Params::DEFAULT_UPDATE)) ?array_push($arrMenu,array('label'=>Yii::t('mds','Update').' RKJenisInfeksiNosokomialM', 'icon'=>'pencil','url'=>array('update','id'=>$model->jenisin_id))) :  '' ;
    //                array_push($arrMenu,array('label'=>Yii::t('mds','Delete').' RKJenisInfeksiNosokomialM','icon'=>'trash','url'=>'#','linkOptions'=>array('submit'=>array('delete','id'=>$model->jenisin_id),'confirm'=>Yii::t('mds','Are you sure you want to delete this item?')))) ;
