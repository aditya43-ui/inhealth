...
<div class="panel panel-success">
    ...
    <div class="panel-body">
		...
		<div class="panel panel-success">
			...
			<div class="panel-body">
				<?php echo $this->renderPartial($this->path_view_tidakresusitasi.'_riwayat', array('model'=>$model)); ?>


			</div>
		</div>

		<?php echo $this->renderPartial($this->path_view_tidakresusitasi.'_form', array('model'=>$model,'modPasien'=>$modPasien,'modPendaftaran'=>$modPendaftaran,'ubah'=>$ubah)); ?>
	</div>
</div>
