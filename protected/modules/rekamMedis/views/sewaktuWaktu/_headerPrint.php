...
<table width="100%" border="1px">
    ...
    <td style="width: 25%" class="borderclass" valign="top">
      <div><img src="<?php echo Params::urlProfilRSDirectory().$modProfilRs->logo_rumahsakit ?> " style="height: 100px;"/></div>
    ...
    <td style="width: 35%;" class="borderclass"  valign="top">
        <table class="" style="float:right; width: 100%">
          <tr>
            ...
            <tr>
                <td style="padding: 3px; font-size: 11pt">Tangal Lahir</td>
                <td style="padding: 3px; font-size: 11pt">:</td>
                <td style="padding: 3px; font-size: 11pt">
            ...
            <tr>
                <td style="padding: 3px; font-size: 11pt">Tanggal Pendaftaran</td>
                <td style="padding: 3px; font-size: 11pt">:</td>
                <td style="padding: 3px; font-size: 11pt">
