        ...
        <div class="controls">
            ...
            if (!isset($_GET['pendaftaran_id']) || empty($_GET['pendaftaran_id'])) {
                $this->widget('MyJuiAutoComplete', array(
                    ...
                    'htmlOptions' => array(
                        'placeholder' => 'Ketik No. Pendaftaran', 'class' => 'all-caps', 'rel' => 'tooltip', 'title' => 'Ketik no. pendaftaran / klik icon untuk mencari data kunjungan',
...
<div class="col-sm-6">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            ...
            if (!isset($_GET['pendaftaran_id']) || empty($_GET['pendaftaran_id'])) {
                ...
                echo CHtml::textField('no_rekam_medik', $modKunjungan->no_rekam_medik, array('readonly' => true, 'class' => 'span3', 'onkeyup' => "return $(this).focusNextInputField(event);"));
            }
            ?>
        </div>
    </div>
    <div class="control-group">
        ...
        <div class="controls">
            ...
            if (!isset($_GET['pendaftaran_id']) || empty($_GET['pendaftaran_id'])) {
                ...
                echo CHtml::textField('nama_pasien', $modKunjungan->nama_pasien, array('readonly' => true, 'class' => 'span3', 'onkeyup' => "return $(this).focusNextInputField(event);"));
            }
            ?>
        </div>
    </div>
    ...
    <div class="control-group">
        <?php echo CHtml::label('Cara Pulang', 'carakeluar_nama', array('class' => 'control-label')); ?>
        <div class="controls">
            <?php echo CHtml::textField('carakeluar_nama', $modKunjungan->carakeluar_nama, array('readonly' => true, 'class' => 'span3', 'onkeyup' => "return $(this).focusNextInputField(event);")); ?>
        </div>
    </div>
...
<!-- <div class = "col-sm-6">
    <div align="center">
        ...
        ?>
        <img id="photo-preview" src="<?php //echo $url_photopasien
                                        ?>"width="128px"/>
    </div><br>
    <div class="control-group">
