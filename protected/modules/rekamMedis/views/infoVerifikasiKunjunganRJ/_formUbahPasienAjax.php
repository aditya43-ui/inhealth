...
<div class="panel panel-success">
    ...
    <div class="panel-body">
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="panel panel-success">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <?php echo $form->dropDownList($modPasien, 'jenisidentitas', LookupM::getItems('jenisidentitas'), array('empty' => '-- Pilih --', 'onkeyup' => "return $(this).focusNextInputField(event)", 'class' => 'span1', 'style' => 'float:left; width:80px'));
                                ?>
                                <?php
                                echo $form->textField($modPasien, 'no_identitas_pasien', array(
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <?php echo $form->dropDownList($modPasien, 'namadepan', LookupM::getItems('namadepan'), array('empty' => '-- Pilih --', 'onkeyup' => "return $(this).focusNextInputField(event)", 'class' => 'span1', 'style' => 'float:left; width:80px'));
                                ?>
                                <?php
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <?php echo $form->dropDownList($modPasien, 'golongandarah', LookupM::getItems('golongandarah'), array('empty' => '-- Pilih --', 'onkeyup' => "return $(this).focusNextInputField(event)", 'class' => 'span1'));
                                ?>
                ...
                <div class="panel panel-success">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <i class="glyphicon glyphicon-user"></i> Penanggung <b>Jawab Pasien</b>
                        </div>
                    </div>
                    <div class="panel-body">
                        <div class="control-group pj_sb" style="display: none;">
                            <?php
                            echo CHtml::checkBox('pp_sb', false, array(
                                'value' => $modPenanggungJawab->penanggungjawab_id,
                                'name' => 'PPSebelumnya',
                                'uncheckValue' => null,
                                'onchange' => "setPenanggungjawabPS(this)",
                                'class' => 'pp_sb',
                                'id' => 'ppSebelumnya'
                            )) . "<label id='ppSebelumnyaLabel' for='ppSebelumnya'>(Klik jika Penanggung Jawab Pasien Sebelumnya)</label> ";
                            ?>
                            <p></p>
                        </div>
                        <?php echo $form->dropDownListRow($modPenanggungJawab, 'pengantar', LookupM::getItems('pengantar'), array('class' => 'span4 form-control delapan', 'empty' => '-- Pilih --', 'onkeyup' => "return $(this).focusNextInputField(event)", 'onchange' => 'cekPengantar();')); ?>
                        <?php echo $form->hiddenField($modPenanggungJawab, 'penanggungjawab_id', array('readonly' => true, 'class' => 'span3', 'onkeyup' => "return $(this).focusNextInputField(event);", 'maxlength' => 10)); ?>
                        <?php echo $form->textFieldRow($modPenanggungJawab, 'nama_pj', array('placeholder' => 'Nama Lengkap Penanggung Jawab', 'class' => 'span4 form-control', 'onkeyup' => "return $(this).focusNextInputField(event)")); ?>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <?php echo $form->dropDownList($modPenanggungJawab, 'hubungankeluarga', LookupM::getItems('hubungankeluarga'), array('class' => 'span4 form-control delapan', 'empty' => '-- Pilih --', 'onkeyup' => "return $(this).focusNextInputField(event)")); ?>
                            </div>
                        </div>

                        <?php echo $form->textFieldRow($modPenanggungJawab, 'tempatlahir_pj', array('placeholder' => 'Kota/Kabupaten Kelahiran', 'class' => 'span4 all-caps form-control', 'onkeyup' => "return $(this).focusNextInputField(event)")); ?>
                        <div class="control-group">
                            <?php echo $form->labelEx($modPenanggungJawab, 'tgllahir_pj', array('class' => 'control-label')) ?>
                            <div class="controls">
                                <?php
                                $modPenanggungJawab->tgllahir_pj = (!empty($modPenanggungJawab->tgllahir_pj) ? date("d/m/Y", strtotime($modPenanggungJawab->tgllahir_pj)) : null);
                                $this->widget('MyDateTimePicker', array(
                        ...
                        <?php echo $form->textAreaRow($modPenanggungJawab, 'alamat_pj', array('placeholder' => 'Alamat Lengkap Penanggung Jawab', 'class' => 'span4 form-control autogrow', 'onchange' => 'convertToUpper(this)', 'onkeyup' => 'convertToUpper(this)', 'onkeyup' => "return $(this).focusNextInputField(event)")); ?>
                        <div class="control-group">
                            <?php echo CHtml::label('No. Telepon', 'no_teleponpj', array('class' => 'control-label refreshable')) ?>
                            <div class="controls">
                                <?php echo $form->textField($modPenanggungJawab, 'no_teleponpj', array('placeholder' => 'No. Telepon Penanggung Jawab', 'onkeyup' => "return $(this).focusNextInputField(event)", 'class' => 'numbers-only span4 form-control')); ?>
                            </div>
                        </div>
                        <div class="control-group">
                            <?php echo CHtml::label('No. Handphone <span class="required">*</span>', 'no_teleponpj', array('class' => 'control-label refreshable')) ?>
                            <div class="controls">
                                <?php echo $form->textField($modPenanggungJawab, 'no_mobilepj', array('placeholder' => 'No. Handphone Penanggung Jawab', 'onkeyup' => "return $(this).focusNextInputField(event)", 'class' => 'numbers-only span4 form-control required', 'maxlength' => 15)); ?>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panel-heading">
                        <div class="panel-title">
                            ...
                            echo CHtml::htmlButton(Yii::t('mds', '{icon} Ambil Foto', array('{icon}' => '<i class="entypo-camera"></i>')), array(
                                'class' => 'btn btn-default', 'onclick' => "$('#dialog-addphoto').dialog('open');",
        ...
        <div class="form-actions">
            <?php echo CHtml::htmlButton(Yii::t('mds', '{icon} Save', array('{icon}' => '<i class="entypo-check"></i>')), array('class' => 'btn btn-danger', 'type' => 'submit')); //formSubmit(this,event)  , 'onkeypress' => 'setVerifikasi();'
            ?>
        </div>
    </div>
</div>
...
function setPengantar() {
    ...
    var umur = $("#<?php echo CHtml::activeId($modPendaftaran, 'umur') ?>").val();
