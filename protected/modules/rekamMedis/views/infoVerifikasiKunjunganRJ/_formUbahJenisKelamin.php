...
<div class="control-group">
    ...
    <div class="controls">
        <?php echo CHtml::textField('jk', 'jk', array('readonly' => true, 'class' => 'jenisKelaminLama')); ?>
    </div>
</div>
<?php
echo $form->radioButtonListInlineRow(
    ...
    array('onkeypress' => "return $(this).focusNextInputField(event)", 'required' =>true, 'class' => 'jenisKelaminBaru')
);
?>
