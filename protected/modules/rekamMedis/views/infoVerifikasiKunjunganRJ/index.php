...
JS;
    ...
    <script>
        ...
        $(document).ready(function() {
            var penj = jQuery('#<?php echo CHtml::activeId($modInfoVerifikasiKunjuganRJ, 'penjamin_id') ?>');
