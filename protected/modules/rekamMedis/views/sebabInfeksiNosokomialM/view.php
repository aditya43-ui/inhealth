<div class='white-container'>
    <legend class='rim2'>Lihat Sebab <b>Infeksi Nosokomial</b></legend>
    <?php
    ...
    //                (Yii::app()->user->checkAccess(Params::DEFAULT_UPDATE)) ?array_push($arrMenu,array('label'=>Yii::t('mds','Update').' RKSebabInfeksiNosokomialM', 'icon'=>'pencil','url'=>array('update','id'=>$model->sebabin_id))) :  '' ;
    //                array_push($arrMenu,array('label'=>Yii::t('mds','Delete').' RKSebabInfeksiNosokomialM','icon'=>'trash','url'=>'#','linkOptions'=>array('submit'=>array('delete','id'=>$model->sebabin_id),'confirm'=>Yii::t('mds','Are you sure you want to delete this item?')))) ;
