	...
	<div class="panel-heading">
		<div class="panel-title">
                         <i class="fas fa-layer-group"></i> Pengaturan <b>Sebab Infeksi Nosokomial</b></div>
	</div>
    ...
    <?php 
    echo CHtml::link(Yii::t('mds', '{icon} Tambah Sebab Infeksi Nosokomial', array('{icon}'=>'<i class="icon-plus icon-white"></i>')), $this->createUrl('sebabInfeksiNosokomialM/create',array('modul_id'=> Yii::app()->session['modul_id'])), array('class' => 'btn btn-danger',));
