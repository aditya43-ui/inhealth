...
<?php $linkHalaman = CustomFunction::getUrlByMenuID(1169); ?>
<?php
...
<div class="panel panel-gradient">
    ...
    <div class="panel-body">
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                <?php $this->renderPartial('_search', ['modInfoKunjunganRDV' => $modInfoKunjunganRDV, 'model' => $model]) ?>
            </div>
        </div>
        <div class="panel panel-success">
            <div class="panel-heading">
        ...
        <?php $this->endWidget(); ?>
        <?php
        //========= start ubah batal rawat inap dialdialogBatalRawatInapog =============================
        $this->beginWidget('zii.widgets.jui.CJuiDialog', array(
        ...
        <?php
        $this->endWidget();
        //========= end ubah batal rawat inap dialog =============================
        ?>
        ...
        $urlLabelGelang = Yii::app()->createUrl('pendaftaranPenjadwalan/pendaftaranRawatJalan/printLabelGelang', array('pendaftaran_id' => ''));
        $urlLabelGelangAnak = Yii::app()->createUrl('pendaftaranPenjadwalan/pendaftaranRawatJalan/printLabelGelang', array('pendaftaran_id' => ''));
        $urlPrintKepalaLes = Yii::app()->createUrl('pendaftaranPenjadwalan/InfoKunjunganRD/printKepalaLes', array('pendaftaran_id' => ''));
...
{
   window.open('${urlLabelGelang}'+pendaftaran_id,'printwin','left=100,top=100,width=700,height=600');    
}  
function printLabelGelangAnak(pendaftaran_id)
{
   window.open('${urlLabelGelangAnak}'+pendaftaran_id,'printwin','left=100,top=100,width=700,height=600');    
}  
...
JS;
        ...
        <script type="text/javascript">
            ...
            function ubahKelompokPenyakit(pendaftaran_id) {
                ...
                jQuery.ajax({
                    'url': '<?php echo Yii::app()->createUrl('pendaftaranPenjadwalan/infoKunjunganRD/ubahKelompokPenyakit', array('menu' => 'RD')) ?>',
                    'data': $(this).serialize(),
                    'type': 'post',
                    'dataType': 'json',
                    'success': function(data) {
            ...
            function ubahDokterPeriksa(pendaftaran_id) {
                ...
                jQuery.ajax({
                    'url': '<?php echo $this->createUrl('ubahDokterPeriksa', array('menu' => 'RD')) ?>',
                    'data': $(this).serialize(),
                    'type': 'post',
                    'dataType': 'json',
                    'success': function(data) {
            ...
            function ubahKelasPelayanan(pendaftaran_id) {
                ...
                jQuery.ajax({
                    'url': '<?php echo $this->createUrl('ubahKelasPelayanan', array('menu' => 'RD')) ?>',
                    'data': $(this).serialize(),
                    'type': 'post',
                    'dataType': 'json',
                    'success': function(data) {
            ...
            function cekVerifikasiTindakLanjut(obj, id) {
                $.post('<?php echo $this->createUrl('verifikasiTindakLanjut') ?>', {
                    ...
                    if (data.ok == 1) {
                        $("#iframePasienPulang").prop('src', '<?php echo Yii::app()->createUrl("/rawatDarurat/daftarPasien/PasienPulang"); ?>&pendaftaran_id=' + id +
                            "&dialog=1");
        ...
        $this->endWidget('zii.widgets.jui.CJuiDialog');
        ?>
        <!-- Penambahan untuk dialog riwayat pemeriksaan -->
        <?php
        ...
        ?>
        <!-- End Penambahan dialog untuk riwayat pasien -->
        <!--SESSION UBAH STATUS-->
        <?php
