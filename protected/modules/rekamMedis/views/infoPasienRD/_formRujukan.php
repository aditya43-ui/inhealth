...
<div class="control-group">
    ...
    <div class="controls">
        ...
        <?php echo CHtml::htmlButton(Yii::t('mds', '{icon}', array('{icon}' => '<i class="entypo-search"></i>')), array('class' => 'btn btn-primary pull-right', 'style' => 'margin: -37px 2px 0 0;', 'rel' => 'tooltip', 'title' => 'klik untuk mencari diagnosa rujukan', 'onclick' => 'openDialog()')); ?>
    </div>
</div>
