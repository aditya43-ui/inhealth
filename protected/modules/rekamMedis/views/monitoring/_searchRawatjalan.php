...
<div class="row">
    <div class="col-sm-6">
        ...
        <?php echo $form->dropDownListRow($model, 'ruangan_id', CHtml::listData(RuanganM::getRuanganByInstalasi(Params::INSTALASI_ID_RJ), 'ruangan_id', 'ruangan_nama'), array('empty' => '-- Pilih --', 'class' => 'span4', 'onkeypress' => '$(this).focusNextInputField(event)')); ?>
    ...
    <div class="col-sm-6">
        <?php echo $form->textFieldRow($model, 'nama_pasien', array('placeholder' => 'Nama Pasien')); ?>
