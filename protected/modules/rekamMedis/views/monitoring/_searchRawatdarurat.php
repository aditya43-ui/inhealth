...
<div class="row">
    ...
    <div class="col-sm-6">
        <?php echo $form->textFieldRow($model, 'no_rekam_medik', array('class' => 'span4', 'onkeypress' => '$(this).focusNextInputField(event)', 'autofocus' => true, 'placeholder' => 'No. Rekam Medik')); ?>
        ...
        <?php echo $form->textFieldRow($model, 'nama_pasien', array('class' => 'span4', 'placeholder' => 'Nama Pasien')); ?>
    </div>
    <div class="col-sm-6">
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $form->dropDownList(
                    $model,
                    'carakeluar_id',
                    CHtml::listData($model->getCarakeluarItems(), 'carakeluar_id', 'carakeluar_nama'),
                    array(
        ...
        <div class="control-group">
            <?php echo CHtml::label('Kondisi Pulang <span class="required">*</span>', 'RIPasienPulangT_kondisikeluar_id', array('class' => 'control-label')) ?>
            ...
            <div class="controls">
                <?php echo $form->dropDownList(
                    $model,
                    'kondisikeluar_id',
                    CHtml::listData($model->getKondisikeluarItems($model->carakeluar_id), 'kondisikeluar_id', 'kondisikeluar_nama'),
