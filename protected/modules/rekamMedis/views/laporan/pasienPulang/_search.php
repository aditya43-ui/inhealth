    ...
    <div class="row">
        <div class="col-sm-6">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                        <?php echo $form->dropDownList($model, 'carakeluar', CarakeluarM::model()->getCaraKeluar(), array(									
									'multiple' => 'multiple',
                    ...
                    <fieldset> 
                        <div class="control-group">
                            <?php echo CHtml::label("Kondisi Pulang","",array('class' => 'control-label')); ?>
                            <div class="controls">
                            <?php echo $form->dropDownList($model, 'kondisipulang', KondisiKeluarM::model()->getKondisiKeluar(), array(									
                                                                            'multiple' => 'multiple',
                                                                            'onkeypress' => "return $(this).focusNextInputField(event)")
                                                                    ); ?>
                            </div>
		...
		<div class="control-group">
			...
			<div class="controls">												 
				<?php echo $form->dropDownList($model,'ruangan_id',
						array(),
