...
<script type="text/javascript">
    ...
    $(document).ready(function() {
		...
		var kab = jQuery('#<?php echo CHtml::activeId($model, 'kabupaten_id') ?>');	
                ...
                var carakeluar = jQuery('#<?php echo CHtml::activeId($model, 'carakeluar') ?>');	
		
		var dokterpemeriksa = jQuery('#<?php echo CHtml::activeId($model, 'pegawai_id') ?>');	
                
                var kondisipulang = jQuery('#<?php echo CHtml::activeId($model, 'kondisipulang') ?>');	
		...
		* multi select propinsi dan kabupaten
		...
		jQuery(dokterpemeriksa).multiselect({
			includeSelectAllOption: true,
			buttonClass: "form-control",
			maxHeight: 300,
			buttonWidth: '182px',
