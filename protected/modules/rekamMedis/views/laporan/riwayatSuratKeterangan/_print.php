...
if ($caraPrint != 'GRAFIK')
$this->renderPartial($this->path_view.'riwayatSuratKeterangan._table', array('model'=>$model, 'caraPrint'=>$caraPrint)); 

if ($caraPrint == 'GRAFIK')
echo $this->renderPartial($this->path_view.'riwayatSuratKeterangan._grafik', array('model'=>$model, 'data'=>$data, 'caraPrint'=>$caraPrint, 'searchdata'=>$model->searchGrafik()), true); 
