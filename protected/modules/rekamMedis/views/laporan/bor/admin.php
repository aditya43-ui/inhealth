...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="entypo-newspaper"></i> Laporan <b>BOR</b>
        </div>
    </div>
    <div class="panel-body">
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                ...
                <?php $this->renderPartial($this->path_view . 'bor._search', array(
                    'model' => $model,
                )); ?>
                <!--</fieldset>-->
                <!--search-form-->
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="entypo-credit-card"></i> Tabel <b>BOR</b>
                </div>
            </div>
            <div class="panel-body table-responsive">
                <div class="block-tabel">
                    <?php $this->renderPartial($this->path_view . 'bor._table', array('model' => $model)); ?>
                </div>
            </div>
        </div>
        <div class="panel panel-success">
        ...
        $url = Yii::app()->createUrl($module . '/' . $controller . '/frameGrafikBOR') . '/';
        $urlPrint =  Yii::app()->createAbsoluteUrl($module . '/' . $controller . '/printBOR');
