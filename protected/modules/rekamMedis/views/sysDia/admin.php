<div class="panel panel-gradient">
    ...
    <div class="panel-body">
        ...
        <div class="form-actions">
            <?php
            echo CHtml::link(
                Yii::t('mds', '{icon} Tambah Sysdia', array('{icon}' => '<i class="icon-plus icon-white"></i>')),
                $this->createUrl('sysDia/create', array('modul_id' => Yii::app()->session['modul_id'])),
                array('title' => 'Tambah sysdia', 'class' => 'btn btn-danger',)
            );
