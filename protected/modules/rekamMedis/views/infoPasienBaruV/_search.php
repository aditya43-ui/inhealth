...
<div class="row">
    <div class="col-sm-6">
        ...
        <?php echo $form->textFieldRow($model, 'penanggungJawab', array('class' => 'span4', 'maxlength' => 50, 'placeholder' => 'Nama Penanggung Jawab')); ?>
    </div>
    <div class="col-sm-6">
        <?php echo $form->textFieldRow($model, 'alamat_pasien', array('maxlength' => 50, 'placeholder' => 'Alamat Pasien')); ?>
        <?php
