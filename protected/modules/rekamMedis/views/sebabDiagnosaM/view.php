<div class='white-container'>
    <legend class='rim2'>Lihat <b>Sebeb Diagnosa</b></legend>
    <?php
    ...
    //                (Yii::app()->user->checkAccess(Params::DEFAULT_UPDATE)) ?array_push($arrMenu,array('label'=>Yii::t('mds','Update').' RKSebabDiagnosaM', 'icon'=>'pencil','url'=>array('update','id'=>$model->sebabdiagnosa_id))) :  '' ;
    //                array_push($arrMenu,array('label'=>Yii::t('mds','Delete').' RKSebabDiagnosaM','icon'=>'trash','url'=>'#','linkOptions'=>array('submit'=>array('delete','id'=>$model->sebabdiagnosa_id),'confirm'=>Yii::t('mds','Are you sure you want to delete this item?')))) ;
