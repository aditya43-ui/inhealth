...
$this->breadcrumbs = array(
    'Laporan Dinas' => array('/rekamMedis/laporanDinas'),
...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="entypo-newspaper"></i> Laporan <b>Angka Kematian</b>
        </div>
    </div>
    <div class="panel-body">
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="entypo-credit-card"></i> Tabel <b>Angka Kematian</b>
                </div>
            </div>
            <div class="panel-body table-responsive">
                <?php echo $this->renderPartial('_tabelAngkaKematian', array('model' => $model), true); ?>
            </div>
        </div>

        <div class="form-actions">
            <?php
            $urlPrint = $this->createUrl('printLaporanAngkaKematian');
