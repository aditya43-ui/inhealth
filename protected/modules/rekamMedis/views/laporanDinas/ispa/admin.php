...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="entypo-newspaper"></i> Laporan <b>ISPA</b>
        </div>
    </div>
    <div class="panel-body">
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                ...
                <?php $this->renderPartial($this->path_view . 'ispa._searchV2', array(
                    'model' => $model,
                )); ?>
                <!--</fieldset>-->
                <!--search-form-->
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="entypo-credit-card"></i> Tabel <b>ISPA</b>
                </div>
            </div>
            <div class="panel-body table-responsive">
                <?php $this->renderPartial($this->path_view . 'ispa._table', array('model' => $model)); ?>
            </div>
        </div>
        <!--
                <div class="panel panel-success">
	...
	-->
        ...
        $urlPrint =  Yii::app()->createAbsoluteUrl($module . '/' . $controller . '/printLaporanIspa');
        $url = Yii::app()->createUrl($module . '/' . $controller . '/FrameGrafikLaporanIspa&id=1');
