...
-->
        ...
        <fieldset class='box'>
            <div class="panel panel-success">
                <div class="panel-heading">
                    <div class="panel-title">
                        <i class="glyphicon glyphicon-file"></i> Pemeriksaan Thorax
                    </div>
                </div>
                <div class="panel-body">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                echo $form->dropDownList(
                                    $modPemeriksaanFisik,
                                    'gcs_eye',
                                    CHtml::listData(RKMetodeGCSM::model()->findAll($crit), 'metodegcs_nilai', 'textMetodeGCSM'),
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                echo $form->dropDownList(
                                    $modPemeriksaanFisik,
                                    'gcs_verbal',
                                    CHtml::listData(RKMetodeGCSM::model()->findAll($crit3), 'metodegcs_nilai', 'textMetodeGCSM'),
                                    array('empty' => '-- Pilih --', 'class' => 'span3', 'onkeypress' => "return $(this).focusNextInputField(event);", 'onchange' => 'hitungCGS()')
                                ); ?>
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                echo $form->dropDownList(
                                    $modPemeriksaanFisik,
                                    'gcs_motorik',
                                    CHtml::listData(RKMetodeGCSM::model()->findAll($crit2), 'metodegcs_nilai', 'textMetodeGCSM'),
                                    array('empty' => '-- Pilih --', 'class' => 'span3', 'onkeypress' => "return $(this).focusNextInputField(event);", 'onchange' => 'hitungCGS()')
                                ); ?>
                            </div>
                        </div>
        ...
        <div class="col-sm-6">
            <div class="panel panel-success">
                ...
                <div class="panel-body table-responsive'>
                        <table class=" items table-bordered table table-striped table-condensed" id="table-bagtubuh">
                    <thead>
                        <tr>
                            <th width='30'>No.</th>
                            <th>Bagian Tubuh</th>
...
<div class="form-actions">
    <?php echo CHtml::htmlButton(
        $modPemeriksaanFisik->isNewRecord ? Yii::t('mds', '{icon} Create', array('{icon}' => '<i class="entypo-check"></i>')) :
