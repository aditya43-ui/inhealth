...
echo CHtml::dropDownList('Dokumen[ii][warnadokrm_id]',$warnadokrm_id,CHtml::listData(WarnadokrmM::model()->findAll("warnadokrm_aktif = TRUE"),'warnadokrm_id','warnadokrm_namawarna'), array());
?>
