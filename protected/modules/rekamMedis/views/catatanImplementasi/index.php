...
<div class="panel panel-success">
    <div class="panel-heading">
        <div class="panel-title">Catatan Implementasi</div>
    </div>
    <div class="panel-body">
        <div class="row-fluid">
            <div class = "col-sm-12">
                ...
                <div class="control-group ">
                    <?php echo CHtml::activeLabelEx($model, 'pelaksanaan', array('class' => 'control-label')); ?>
                    <div class="controls">
                        <?php
                        echo $form->textArea($model, 'pelaksanaan', array('rows' => 5, 'class'=>'span8'));
                        ?>
                    </div>
                </div>
                <div class="control-group ">
                    <?php echo CHtml::activeLabelEx($model, 'monitoring', array('class' => 'control-label')); ?>
                    <div class="controls">
                        <?php
                        echo $form->textArea($model, 'monitoring', array('rows' => 5, 'class'=>'span8'));
                        ?>
                    </div>
                </div>
                <div class="control-group ">
                    <?php echo CHtml::activeLabelEx($model, 'fasilitas', array('class' => 'control-label')); ?>
                    <div class="controls" style="width:600px;">
                        <div class="checkbox inline">
                            <?php
                            echo $form->checkBox($model, 'fasilitas', array(
                                'value'=>'DPJP', 'uncheckValue'=>null, 'checked'=>(is_array($model->fasilitas) && in_array('DPJP', $model->fasilitas))
                            ));
                            ?>
                            <label>DPJP</label>
                        </div>
                        <?php
                        echo $form->checkBoxList($model, 'fasilitas', array(
                            'Anggota Tim Klinis'=>'Anggota Tim Klinis',
                            'Pelayanan Keuangan'=>'Pelayanan Keuangan',
                            'Pelayanan Asuransi'=>'Pelayanan Asuransi',
                            'Pelayanan Administrasi'=>'Pelayanan Administrasi',
                            'Pasien dan Keluarga'=>'Pasien dan Keluarga',
                        ), array(
                            'uncheckValue'=>null,
                            'template'=>'<div class="checkbox inline">{input}{label} </div>',
                        ));
                        ?>
                    </div>
                </div>
        ...
        <div class="row-fluid">
            <div class="col-sm-6">
                <div class="control-group ">
                    <?php echo CHtml::activeLabelEx($model, 'advokasi', array('class' => 'control-label')); ?>
                    <div class="controls">
                        <?php
                        echo $form->textArea($model, 'advokasi', array('rows' => 5, 'class'=>'span4'));
                        ?>
                    </div>
                </div>
            ...
            <div class="col-sm-6">
                <div class="control-group ">
                    <?php echo CHtml::activeLabelEx($model, 'hasilpelayanan', array('class' => 'control-label')); ?>
                    <div class="controls">
                        <?php
                        echo $form->textArea($model, 'hasilpelayanan', array('rows' => 5, 'class'=>'span4'));
                        ?>
                    </div>
                </div>
        ...
        <div class="row-fluid">
            <div class="col-sm-12">
                <div class="control-group ">
                    <?php echo CHtml::activeLabelEx($model, 'terminasi', array('class' => 'control-label')); ?>
                    <div class="controls">
                        <?php
                        echo $form->textArea($model, 'terminasi', array('rows' => 5, 'class'=>'span8'));
                        ?>
                    </div>
                </div>
            </div>
    ...
    <div class="form-actions">
        ...
        echo CHtml::link(Yii::t('mds', '{icon} Ulang', array('{icon}' => '<i class="entypo-arrows-ccw"></i>')),
            $this->createUrl('index', array(
                'pendaftaran_id'=>isset($_GET['pasien_id']) ? $_GET['pasien_id'] : null, 
