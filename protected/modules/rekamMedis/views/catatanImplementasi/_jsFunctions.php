...
function print(pendaftaran_id,catatanimplementasi_id,typeinstalasi,caraPrint)
{
    window.open('<?php echo $this->createUrl('print'); ?>&pendaftaran_id='+pendaftaran_id+'&catatanimplementasi_id='+catatanimplementasi_id+'&typeinstalasi='+typeinstalasi+'&caraPrint='+caraPrint,'printwin','left=100,top=100,width=793,height=1122,scrollbars=yes');
}
</script>
