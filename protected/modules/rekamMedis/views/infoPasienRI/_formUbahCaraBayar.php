<!--<div class="panel panel-success">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="fa fa-umbrella"></i> Jenis Penjamin dan Penjamin
        </div>
    </div>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <?php echo CHtml::textField('namaPasien', $modPendaftaran->pasien->namadepan . $modPendaftaran->pasien->nama_pasien, array('readonly' => true)); ?>
        </div>
    </div>
    <?php
    echo $form->dropDownListRow(
        $modAdmisi,
        'carabayar_id',
        CHtml::listData(CarabayarM::model()->findAllByAttributes(array('carabayar_aktif' => true), array('order' => 'carabayar_nama ASC')), 'carabayar_id', 'carabayar_nama'),
        array(
    ...
    <?php echo $form->textAreaRow($model, 'alasanperubahan', array('placeholder' => 'Alasan Perubahan',)); ?>

    <div id="divNonBridging" hidden>
        <div class="control-group">
            <label class="control-label"> Non-bridging </label>
            <div class="controls">
                <?php
                echo CHtml::checkBox('is_bridging', true, ['rel' => 'tooltip', 'title' => 'Klik jika non bridging', 'onkeyup' => "return $(this).focusNextInputField(event);", 'onclick' => 'set_nonbridging(this)']);
                ?>
            </div>
        </div>
    </div>

    <div id="divInputNonBridging" hidden>
        <div class="control-group">
            ...
            <div class="controls">
                ...
                $this->widget('MyJuiAutoComplete', array(
                    ...
                    'htmlOptions' => array(
                        ...
                        'onblur' => "",
                        'class' => 'numbers-only nopeserta'
                    ),
                ));
                ?>
                <?php echo $form->error($modAsuransiPasien, 'nopeserta'); ?>
                <?php echo $form->hiddenField($modAsuransiPasien, 'asuransipasien_id', array('readonly' => true, 'class' => '', 'onkeyup' => "return $(this).focusNextInputField(event);", 'maxlength' => 10)); ?>
            </div>
        </div>
        <?php echo $form->textFieldRow($modAsuransiPasien, 'nokartuasuransi', array('disabled' => true, 'onkeypress' => "return $(this).focusNextInputField(event)", 'placeholder' => 'No. Asuransi', 'class' => 'nokartuasuransi')); ?>
        <?php echo $form->textFieldRow($modAsuransiPasien, 'namapemilikasuransi', array('disabled' => true, 'onkeypress' => "return $(this).focusNextInputField(event)", 'placeholder' => 'Nama Pemilik Asuransi', 'class' => 'namapemilikasuransi')); ?>
        <?php echo $form->textFieldRow($modAsuransiPasien, 'nomorpokokperusahaan', array('disabled' => true, 'onkeypress' => "return $(this).focusNextInputField(event)", 'class' => 'nomorpokokperusahaan', 'placeholder' => 'No. Pokok Perusahaan')); ?>
        <?php echo $form->textFieldRow($modAsuransiPasien, 'namaperusahaan', array('disabled' => true, 'onkeypress' => "return $(this).focusNextInputField(event)", 'class' => 'namaperusahaan', 'placeholder' => 'Nama Perusahaan')); ?>
        <div class="control-group">
            <?php echo CHtml::label($modAsuransiPasien->getAttributeLabel('kelastanggunganasuransi_id') . " <span class='required'>*</span>", 'kelastanggunganasuransi_id', array('class' => 'control-label')) ?>
            <div class="controls">
                <?php echo $form->dropDownList($modAsuransiPasien, 'kelastanggunganasuransi_id', CHtml::listData($modPendaftaran->getKelasPelayananItems(), 'kelaspelayanan_id', 'kelaspelayanan_nama'), array('disabled' => true, 'empty' => '-- Pilih --', 'class' => 'required kelastanggunganasuransi_id', 'onkeypress' => "return $(this).focusNextInputField(event)")); ?>
            </div>
        </div>
        <div class="control-group">
    ...
    <div id="divAsuransi">
        ...
        <div class="control-group">
            <?php echo CHtml::label($modAsuransiPasien->getAttributeLabel('kelastanggunganasuransi_id') . " <span class='required'>*</span>", 'kelastanggunganasuransi_id', array('class' => 'control-label')) ?>
            <div class="controls">
                <?php echo $form->dropDownList($modAsuransiPasien, 'kelastanggunganasuransi_id', CHtml::listData($modPendaftaran->getKelasPelayananItems(), 'kelaspelayanan_id', 'kelaspelayanan_nama'), array('disabled' => true, 'empty' => '-- Pilih --', 'onkeypress' => "return $(this).focusNextInputField(event)", 'class' => 'required')); ?>
            </div>
        </div>
        <div class="control-group">
            <label class="control-label">Status Konfirmasi</label>
    ...
    <div id="divAsuransiBpjs" hidden>
        <div class="control-group">
            ...
            <div class="controls">
                ...
                <?php echo $form->hiddenField($modAsuransiPasienBpjs, 'asuransipasien_id', array('readonly' => true, 'class' => '', 'onkeyup' => "return $(this).focusNextInputField(event);", 'maxlength' => 10)); ?>
            </div>
        </div>
        <?php echo $form->textFieldRow($modAsuransiPasienBpjs, 'nokartuasuransi', array('placeholder' => 'Nomor Kartu Asuransi', 'class' => ' nokartuasuransi', 'onkeyup' => "return $(this).focusNextInputField(event);", 'maxlength' => 13)); ?>
        <?php echo $form->textFieldRow($modAsuransiPasienBpjs, 'namapemilikasuransi', array('placeholder' => 'Nama Lengkap Pemilik Asuransi', 'class' => ' namapemilikasuransi', 'onkeyup' => "return $(this).focusNextInputField(event);", 'maxlength' => 50)); ?>
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $form->dropDownList(
                    ...
                    'jenispeserta_id',
                    CHtml::listData($modAsuransiPasien->getJenisPesertaItems(), 'jenispeserta_id', 'jenispeserta_nama'),
                    array(
                        'class' => ' jenispeserta_id', 'empty' => '-- Pilih --', 'onkeyup' => "return $(this).focusNextInputField(event)",
                    )
                ); ?>
        ...
        <?php //echo $form->textFieldRow($modAsuransiPasien,'nomorpokokperusahaan',array('placeholder'=>'Nomor Pokok Perusahaan','class'=>'', 'onkeyup'=>"return $(this).focusNextInputField(event);", 'maxlength'=>50)); 
        ?>
        <div class="control-group">
            <?php echo CHtml::label($modAsuransiPasien->getAttributeLabel('kelastanggunganasuransi_id') . " <span class='required'>*</span>", 'kelastanggunganasuransi_id', array('class' => 'control-label')) ?>
            <div class="controls">
                <?php echo $form->dropDownList($modAsuransiPasienBpjs, 'kelastanggunganasuransi_id', CHtml::listData(PPPendaftaranT::model()->getKelasTanggunganItems(), 'kelasbpjs_id', 'kelaspelayanan_nama'), array('disabled' => true, 'empty' => '-- Pilih --', 'class' => 'required kelastanggunganasuransi_id', 'onkeyup' => "return $(this).focusNextInputField(event)")); ?>
            </div>
        </div>
        <?php //echo $form->textFieldRow($modAsuransiPasien,'namaperusahaan',array('placeholder'=>'Nama Perusahaan Asuransi','class'=>'', 'onkeyup'=>"return $(this).focusNextInputField(event);", 'maxlength'=>50)); 
        ?>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $form->dropDownList(
                    ...
                    array(
                        'class' => '', 'empty' => '-- Pilih --', 'onkeyup' => "return $(this).focusNextInputField(event)",
                        'ajax' => array(
                            'type' => 'POST',
        ...
        <?php //echo $form->textFieldRow($modRujukanBpjs,'no_rujukan', array('placeholder'=>'Nomor Rujukan','class'=>'','onkeyup'=>"return $(this).focusNextInputField(event)")); 
        ?>
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $form->dropDownList(
                    ...
                    array('class' => '', 'empty' => '-- Pilih --', 'onkeyup' => "return $(this).focusNextInputField(event)", 'onchange' => 'setNamaPerujuk();')
                ); ?>
                <?php /*RND-666 >> echo CHtml::htmlButton('<i class="icon-plus-sign icon-white"></i>', 
        ...
        <?php echo $form->textFieldRow($modRujukanBpjs, 'nama_perujuk', array('placeholder' => 'Nama Lengkap Perujuk', 'class' => '', 'onkeyup' => "return $(this).focusNextInputField(event)")); ?>
        ...
        ?>
            <?php echo $form->hiddenField($modSep, 'sep_id', array('placeholder' => '', 'class' => '', 'onkeyup' => "return $(this).focusNextInputField(event)")); ?>
            <?php echo $form->textFieldRow($modSep, 'ppkrujukan', array('placeholder' => '', 'class' => '', 'onkeyup' => "return $(this).focusNextInputField(event)")); ?>
            <?php echo $form->textAreaRow($modSep, 'catatansep', array('placeholder' => '', 'class' => '', 'onkeyup' => "return $(this).focusNextInputField(event)")); ?>
        <?php } ?>
    </div>
    <div class="form-actions">
        ...
        if (!isset($_GET['sukses'])) {
            echo CHtml::htmlButton(
                $model->isNewRecord ? Yii::t('mds', '{icon} Create', array('{icon}' => '<i class="entypo-check"></i>')) : Yii::t('mds', '{icon} Save', array('{icon}' => '<i class="entypo-check"></i>')),
                array('title' => 'Simpan', 'class' => 'btn btn-danger', 'type' => 'button', 'onKeypress' => 'return formSubmit(this,event)', 'onclick' => 'cekNoBPJS(this);', 'id' => 'btn_submit')
            );
        } else {
            echo CHtml::htmlButton(
                $model->isNewRecord ? Yii::t('mds', '{icon} Create', array('{icon}' => '<i class="entypo-check"></i>')) : Yii::t('mds', '{icon} Save', array('{icon}' => '<i class="entypo-check"></i>')),
                array('title' => 'Simpan', 'class' => 'btn btn-danger', 'type' => 'button', 'onKeypress' => 'return formSubmit(this,event)', 'disabled' => true, 'id' => 'btn_submit')
            );
        }
...
<script type="text/javascript">
    ...
    function onClickAsuransi() {
        ...
        if (cara_bayar == cara_bayar_bpjs) {
            ...
            ?>
                ...
                $('#divInputNonBridging').hide();
                $('#divInputNonBridging input').attr('disabled', 'true');
                $('#divInputNonBridging select').attr('disabled', 'true');
                $('#divInputNonBridging input:not(.rb_kon)').attr('value', '');
                $('#divInputNonBridging select').attr('value', '');
    ...
    function listPenjamin(idCaraBayar) {
        $.post("<?php echo Yii::app()->createUrl('pendaftaranPenjadwalan/infoKunjunganRI/getListPenjamin') ?>", {
    ...
    function getAsuransiNoKartu(isi) {
        ...
        var divBpjs = 'divAsuransiBpjs';
        if ($('#is_bridging').is(':checked')) {
            divBpjs = 'divInputNonBridging';
        }
        ...
        var setting = {
            ...
            beforeSend: function() {
                $("#" + divBpjs).addClass("animation-loading");
            },
            success: function(data) {
                $("#" + divBpjs).removeClass("animation-loading");

                var obj = JSON.parse(data);
                if (obj.response != null) {
                    var peserta = obj.response.peserta;

                    $("#" + divBpjs).find('.nopeserta').val(peserta.noKartu);
                    $("#" + divBpjs).find('.nokartuasuransi').val(peserta.noKartu);
                    $("#" + divBpjs).find('.namapemilikasuransi').val(peserta.nama);
                    $("#" + divBpjs).find('.jenispeserta_id').val(peserta.jenisPeserta.kdJenisPeserta);
                    $("#" + divBpjs).find('.kelastanggunganasuransi_id').val(peserta.hakKelas.kode);
                } else {
    ...
    function cekNoBPJS(obj) {
        <?php if (Yii::app()->user->getState('isbridging') == true) { ?>
            var nobpjs = $("#PPAsuransipasienM_nopeserta").val();
        <?php } else { ?>
            var nobpjs = $("#PPAsuransipasienM_nopeserta").val();
        <?php } ?>
    ...
    const set_nonbridging = (obj) => {
        if ($(obj).is(':checked')) {
            ...
            $('#divInputNonBridging input').removeAttr('disabled');
            $('#divInputNonBridging select').removeAttr('disabled');
            $('#divInputNonBridging').show();
        } else {
            $('#divAsuransiBpjs input').removeAttr('disabled');
            $('#divAsuransiBpjs select').removeAttr('disabled');
            $('#divAsuransiBpjs textarea').removeAttr('disabled');
    ...
    $(document).ready(function(){
        <?php if(!empty($_GET['sukses'])) { ?>
            window.parent.$('#carabayardialog').dialog('close');
