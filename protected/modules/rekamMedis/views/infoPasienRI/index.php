    ...
    <div class="panel panel-pr_imary panel-gradient">
        ...
        <div class="panel-body">
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    <?php $this->renderPartial('_search', ['modPPInfoKunjunganRIV' => $modPPInfoKunjunganRIV]) ?>
                </div>
            </div>
            <div class="panel panel-success">
                <div class="panel-heading">
...
JS;
            ...
            <script type="text/javascript">
                function cekValidasiVerifikasi(pendaftaran_id, menu) { 
                    $.post('<?= $this->createUrl('/rekamMedis/infoVerifikasiKunjunganRJ/cekValidasiVerifikasi') ?>', {
                ...
                function cekValidasiCeklis(pendaftaran_id, pasienadmisi_id, menu) { 
                    $.post('<?= $this->createUrl('/rekamMedis/infoVerifikasiKunjunganRJ/cekValidasiVerifikasi') ?>', {
                        pendaftaran_id:pendaftaran_id,
                        menu:menu
                    }, function(data){
                        if(data.sukses == 1) {
                            var url = '<?= Yii::app()->createUrl(Yii::app()->controller->module->id . "/resumeMedis/checklistBerkasRI") ?>' + '&pendaftaran_id=' + pendaftaran_id + '&pasienadmisi_id='+ pasienadmisi_id +'&frame=true';

                            $("#dialogChecklistBerkas").dialog("open");
                            $('#iframeChecklistBerkas').attr('src', url);
                        } else {
                            window.parent.myAlert('Pasien belum ditindak lanjut oleh pelayanan');
                        }
                    }, 'json');
