<tr>
    <td width="100px">
        <?php echo CHtml::activeTextField($modLampiran,'['.$i.']lampiransuratsehat_nama',array('class'=>'span3', 'onkeypress'=>"return $(this).focusNextInputField(event);", 'maxlength'=>200,'placeholder'=>'lampiran/catatan ')); ?>
    </td>
    <td width="20px">
