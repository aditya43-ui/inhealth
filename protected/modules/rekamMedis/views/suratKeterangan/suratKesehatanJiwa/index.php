...
.groupUkurans{
 ...
 table > tbody > tr > td > input{
    ...
    <?php
        $this->renderPartial($this->path_view.'suratKesehatanJiwa/suratKesehatanJiwa',array('model'=>$model,'modPasien'=>$modPasien,
...
<?php
if(!empty($_GET['suratketerangan_id'])){
    $urlPrint=  Yii::app()->createAbsoluteUrl($this->module->id.'/'.$this->id.'/printSuratKesehatanJiwa&pendaftaran_id='.$_GET['pendaftaran_id'].'&suratketerangan_id='.$_GET['suratketerangan_id'].'');
