...
.groupUkurans{
  ...
  table > tbody > tr > td > input{
    ...
    <?php
        $this->renderPartial($this->path_view.'opnameRI/suratOpnameRIV2',array('model'=>$model,'modPasien'=>$modPasien,
    ...
    <div class="form-actions">
        <?php
            if(!empty($_GET['suratketerangan_id'])){
                ...
                echo CHtml::htmlButton(Yii::t('mds','{icon} Print',array('{icon}'=>'<i class="entypo-print"></i>')),array('class'=>'btn btn-infos', 'disabled'=>false,'type'=>'button','onclick'=>'print(\'PRINT\')'));                 
            }else{
                echo CHtml::htmlButton(Yii::t('mds','{icon} Create',
                array('{icon}'=>'<i class="entypo-check"></i>')),array('class' => 'btn btn-danger', 'type'=>'submit', 
