...
if(!empty($_GET['pendaftaran_id'])){
    ...
    if(!empty($modPendaftaran->pasienadmisi_id)){
        ...
        $modAdmisi->tgladmisi = date('Y-m-d');
        $modAdmisi->tglpulang = date('Y-m-d');
    }
    if ($model->isNewRecord) {
        $model->tglistirahat = MyFormatter::formatDateTimeForUser($modAdmisi->tgladmisi);
        $model->ruanganinap_id = $modAdmisi->ruangan_id;
    }
}else{
...
<div>
        ...
        <TABLE ALIGN="CENTER" style="margin-left:100px; text-align: center;">
             <tr>
                <td ALIGN=CENTER VALIGN=MIDDLE>
                    <B><span FACE="Liberation Serif" SIZE=4><U><?php echo "SURAT KETERANGAN RAWAT INAP"; ?></U></span></B>
                </td>
            </tr>
             <tr>
                <td ALIGN=CENTER VALIGN=MIDDLE>
    ...
    <p align="justify">
        ...
        <br>
        <p align="justify">
            Sedang dirawat mulai tanggal  <?php 
            
            
            //var_dump($model->attributes); die;
            
            echo CHtml::activeTextField($model, 'tglistirahat', array('readonly'=>true, 'class'=>'span2'));
            //echo CHtml::activeTextField('tglDirawat', $modAdmisi->tgladmisi,array('readonly'=>true, 'class'=>'span2'));
            echo " sampai ";
        ...
        <p align="justify">
            ...
            echo "diruang ";
            // var_dump($model->attributes); die;
            echo CHtml::activeDropDownList($model, 'ruanganinap_id', CHtml::listData(
        ...
        <label class="font-13px"  style="width:100%">
            <table class="tabel-surat">
                <tr style="text-align: center;">
                    ...
                    <td width="19%">                        
                                <?php $date = date('Y-m-d'); ?>
                                <?php echo ucfirst($data->kabupaten->kabupaten_nama) ;?>, <?php echo ucfirst($format->formatDateTimeForUser($date)); ?><br>
