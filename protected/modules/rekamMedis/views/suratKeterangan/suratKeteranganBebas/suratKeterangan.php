        ...
        <TABLE ALIGN="CENTER" style="margin-left:100px; text-align: center;">
             <TR>
                <TD ALIGN=CENTER VALIGN=MIDDLE>
                    <B><FONT FACE="Liberation Serif" SIZE=4><U><?php echo "SURAT KETERANGAN RUJUKAN"; ?></U></FONT></B>
                </TD>
            </TR>
             <TR>
                <TD ALIGN=CENTER VALIGN=MIDDLE>
    ...
    <p align="justify">
        <table width="100%" style="width:500px;margin-left:80px;">
            ...
            <tr>
                <td>Diagnosa</td>
                <td>:</td>
                <td><?php echo CHtml::textField('nama_pasien',(isset($modPendaftaran->jeniskasuspenyakit->jeniskasuspenyakit_nama)?$modPendaftaran->jeniskasuspenyakit->jeniskasuspenyakit_nama : "-"), array('readonly'=>true,
                            'onkeypress'=>"return $(this).focusNextInputField(event)")); ?></td>
            </tr>
			<tr>
                <td>Dokter yang merawat</td>
                <td>:</td>
                <td><?php echo CHtml::textField('nama_pasien',$modPendaftaran->pegawai->namaLengkap, array('readonly'=>true,
                            'onkeypress'=>"return $(this).focusNextInputField(event)")); ?></td>
            </tr>
			<tr>
