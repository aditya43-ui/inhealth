<?php
// Yii::import('pendaftaranPenjadwalan.controllers.InfoKunjunganRIController');
// Yii::import('pendaftaranPenjadwalan.views.infoKunjunganRI');
Yii::import('pendaftaranPenjadwalan.models.*');
Yii::import('rawatInap.controllers.PasienRawatInapController');
Yii::import('rawatInap.models.*');
class InfoPasienRIController extends MyAuthController
{
  public $path_view = 'rekamMedis.views.infoPasienRI.';
  ...
  public function actionIndex()
  {
    ...
    $modPPInfoKunjunganRIV->statusperiksa =  Params::STATUSPERIKSA_SUDAH_PULANG;
  ...
  public function actionGetRujukanDari($encode = false, $namaModel = '')
  {
    if (Yii::app()->request->isAjaxRequest) {
      ...
      if ($encode) {
        echo CJSON::encode($asalrujukan_id);
      } else {
