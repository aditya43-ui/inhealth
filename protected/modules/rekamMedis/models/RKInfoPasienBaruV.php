...
class RKInfoPasienBaruV extends InfopasienpengunjungV {
    ...
    public function searchDataPasien()
	{
		...
		$criteria->with = array('penanggungjawab');
		...
		$criteria->compare('LOWER(statuspasien)',strtolower($this->statuspasien='PENGUNJUNG BARU'),true);
		...
		$criteria->compare('LOWER(penanggungjawab.nama_pj)',  strtolower($this->penanggungJawab), true);
