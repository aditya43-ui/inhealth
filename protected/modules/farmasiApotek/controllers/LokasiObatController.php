...
class LokasiObatController extends MyAuthController
{
  ...
  {
    $model = new LokasiobatM;

    if (isset($_POST['LokasiobatM'])) {
      $model->attributes = $_POST['LokasiobatM'];
      if ($model->save()) {
        Yii::app()->user->setFlash('success', 'Data ' . $model->lokasiobat_nama . ' berhasil disimpan.');
  ...
  public function actionIndex()
  {
    ...
    $dataProvider = new CActiveDataProvider('LokasiobatM');
