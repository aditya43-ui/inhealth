...
$this->breadcrumbs = array(
    'Pasien Sudah Pulang - Rawat Inap',
);
?>
...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="entypo-info-circled"></i> Pasien Sudah <b>Pulang - Rawat Inap</b>
        </div>
    </div>
    <div class="panel-body">
        ...
        ?>
        <?php echo $this->renderPartial('_formCariRI', array('model' => $modRI, 'form' => $form, 'format' => $format,), true); ?>
    </div>
</div>
