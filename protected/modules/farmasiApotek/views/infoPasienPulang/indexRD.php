...
$this->breadcrumbs = array(
    'Pasien Sudah Pulang - Rawat Darurat',
);
?>
...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="entypo-info-circled"></i> Pasien Sudah <b>Pulang - Rawat Darurat</b>
        </div>
    </div>
    <div class="panel-body">
        ...
        ?>
        <?php echo $this->renderPartial('_formCariRD', array('model' => $modRD, 'form' => $form, 'format' => $format,), true); ?>
    </div>
</div>
