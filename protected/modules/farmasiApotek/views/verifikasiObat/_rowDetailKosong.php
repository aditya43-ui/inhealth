<tr>
	...
	<td style="text-align: center;">
		...
		<?php echo CHtml::activeHiddenField($modResepturDetail, '[ii]is_verifkasiapoteker', array('value' => true, 'style' => 'width:110px;')); ?>
		<?php echo CHtml::activeHiddenField($modResepturDetail, '[ii]is_tambahanapoteker', array('value' => true, 'style' => 'width:110px;')); ?>
	</td>
	<td></td>
	<td></td>
	<td>
	...
	<?php } ?>
	<td>
        <span name="[ii][obatalkes_kode_kosong]"><?php echo (!empty($modResepturDetail->obatalkes_id) ? $modResepturDetail->obatalkes->obatalkes_kode : "") ?></span> /<br>
        <span name="[ii][obatalkes_nama_label_kosong]" class="namaobat"><?php echo (!empty($modResepturDetail->obatalkes_id) ? $modResepturDetail->obatalkes->obatalkes_nama : "") ?></span>
    </td>
	<td><span name="[ii][jenisobat]"></span></td>
	<td>
