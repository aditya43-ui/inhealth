...
<tr>
	...
	<td>
		<?php if (isset($modDetailReseptur[$iii])) { ?>
			...
			<span name="[ii][obatalkes_nama_label]"><?php echo (!empty($modDetailReseptur[$iii]->obatalkes_id) ? $modDetailReseptur[$iii]->obatalkes_nama." (".$modDetailReseptur[$iii]->obatlain_nama.") " : "") ?></span>
		<?php } else { ?>
	...
	<td nowrap>
		<?php echo CHtml::activeTelField($modObatAlkesPasien, '[ii]jumlahpermintaan_obatracikan', array('readonly' => false, 'style' => 'width:150px; text-align: right;'));?>
	</td>
	<td nowrap>
		<?php
