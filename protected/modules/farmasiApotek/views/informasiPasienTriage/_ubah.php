    ...
    <div class="panel-body">
        <div class="col-sm-12">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?php echo $form->textField($modPengambilanObat, 'create_time', ['readonly' => true]) ?>
                </div>
            </div>
            <div class="control-group">
                <label for="" class="control-label">Nama Obat</label>
                <div class="controls">
                    <?php echo $form->textField($modPengambilanObat, 'obatalkes_nama', ['readonly' => true]) ?>
                </div>
            </div>
            <div class="control-group">
                <label for="" class="control-label">No Resep</label>
                <div class="controls">
                    <?php echo $form->textField($modPengambilanObat, 'noresep_triage', ['readonly' => true]) ?>
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?php echo $form->textField($modPengambilanObat, 'jumlah') ?>
                </div>
            </div>
        </div>
