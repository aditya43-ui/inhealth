...
<table width="100%" style="margin-left:auto; margin-right:auto;">
    <tr>
        ...
        <td>No. Triage</td><td>:</td><td><?php echo CHtml::encode($modTriage->no_triage_pasien); ?></td>
    </tr>
    <tr>
...
<table id="tblDaftarResep" class="table table-bordered table-condensed" border="2">
    ...
    <tr>
        ...
        <td><?php echo $detail->obatTriage->petugasfarmasi->namaLengkap ?? '' ?></td>
        <td><?php echo $detail->obatTriage->petugas_pengambil_obat ?? '' ?></td>
...
<?php }else{ ?>
	<div class="form-actions">
		<?php
            ...
            // lembat telaah
            echo CHtml::Link('<i class="icon-print icon-white"></i> Lembar Telaah', 'javascript:;', array('class' => 'btn btn-info telaah', 'type' => 'button', 'onclick' => 'printTelaah("PRINT","'.$idReseptur.'")'));
...
<script>
    function printPenjualan(caraPrint, penjualanresep_id) {
        window.open('<?php echo $this->createUrl('/farmasiApotek/informasiPasienTriage/DetailPenjualan'); ?>&penjualanresep_id=' + penjualanresep_id + '&caraPrint=' + caraPrint, 'printwin', 'left=100,top=100,width=1000,height=640');
    }
