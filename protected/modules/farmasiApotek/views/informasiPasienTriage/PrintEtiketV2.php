...
<div class="content">
    <table style="width: 100%;">
        <tr>
            ...
            <td style="width: 3%;"> : </td>
            <td><?php echo $modPengambilanObat->noresep_triage;?></td>
        <tr>
        <tr>
            <td>Tanggal </td>
            <td> : </td>
            <td><?= $format->formatDateTimeForUser($modPengambilanObat->create_time) ?></td>
        <tr>
        <tr>
            <td>Nama Px </td>
            <td> : </td>
            <td><?php echo "<b>" . $modPasienTriage->keterangan . "</b>";?></td>
        <tr>
        
        <tr>
            <td>Nama Obat </td>
            <td> : </td>
            <td><?php echo $modObatAlkes->obatalkes_nama . " - " . $modPengambilanObat->jumlah . " $modObatAlkes->satuankekuatan";?></td>
        <tr>
