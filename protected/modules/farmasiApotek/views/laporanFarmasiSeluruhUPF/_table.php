<?php 
    ...
    if (isset($caraPrint)){
        $row = '$row+1';
        $data = $model->searchLaporanPrintFarmasiSeluruhUPF();
        $template = "{items}";
        $sort = false;
        if ($caraPrint == "EXCEL"){
        ...
        $data = $model->searchLaporanFarmasiSeluruhUPF();
        $dataTotal = $model->searchLaporanPrintFarmasiSeluruhUPF();
        $template = "{summary}\n{items}\n{pager}";
