...
// var_dump($model->is_aktif);die;
?>
<div class="row">
    <div class="col-sm-6">
     <?php  echo $form->textFieldRow($model,'jumlahobat',array('class'=>'span3 numbers-only','size'=>50,'maxlength'=>50)); ?>
     <?php echo $form->checkBoxRow($model, 'is_aktif', array('onkeypress' => "return $(this).focusNextInputField(event);")); ?>
     </div>
    <div class="col-sm-6">
    ...
    <?php
        echo CHtml::htmlButton(
            $model->isNewRecord ? Yii::t('mds', '{icon} Create', array('{icon}' => '<i class="entypo-check"></i>')) :
                Yii::t('mds', '{icon} Update', array('{icon}' => '<i class="entypo-check"></i>')),
