<?php $linkHalaman = CustomFunction::getUrlByMenuID(971); ?>
<style>
.qty_jual,
.qty_stok {
    text-align: right;
...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="glyphicon glyphicon-briefcase"></i> Penjualan <strong>Resep Rumah Sakit</strong>
    ...
    <div class="panel-body">
        ...
        <fieldset id="form-antrian">
            <div class="row row-fluid">
                ...
                <div class="col-sm-3">
                    <div class="control-group">
					<?php echo CHtml::label('Status Antrian', 'statusobat', array('class' => 'control-label')); ?>
                        <div class="controls">
                            <?php echo $form->dropDownList($modPenjualan, 'statusobat', ['SEDANG DILAYANI' => 'SEDANG DILAYANI', 'SEDANG DIKONSULTASIKAN' => 'SEDANG DIKONSULTASIKAN'],array('class'=>'span3','empty'=>'-- Pilih --') )?>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row-fluid" id="form-infopasien">
                    ...
                    <table class="items table table-bordered table-striped table-condensed" id="table-obatalkespasien">
                        <thead>
                            <tr>
								...
								<th class="waktu-ri hide" width="150">Waktu Pemberian</th>
								<th>Sediaan</th>
						...
						<tbody>
							...
							if (!empty($modObatAlkesPasien)) {
								...
								foreach ($modObatAlkesPasien as $i => $modDetail) {
									...
									echo $this->renderPartial($this->path_view . '_rowDetail', array('modObatAlkesPasien' => $modDetail, 'modReseptur' =>$modReseptur));
								}
							}
							?>
                        </tbody>
                        <tfoot>
                            ...
                            <tr>
                                <td style="text-align: right;" colspan="11"><strong>Jumlah Biaya R</strong></td>
                                <td>
                            ...
                            <tr>
                                <td style="text-align: right;" colspan="11"><strong>Jasa Pelayanan Farmasi</strong></td>
                                <td>
                            ...
                            <tr>
                                <td style="text-align: right;" colspan="11"><strong>Total Keseluruhan</strong></td>
                                <td>
