...
<table>
    ...
    <tr>
        ...
        <td><?= $det2->obatalkes->obatalkes_nama . (($det2->racikan_id == 2 ? (" NO. " . MyFormatter::formatNumberForUser(floatval($det2->jumlahpermintaan_obatnonracikan))) : "")) ?></td>
    </tr>
    <tr>
...
<br><br>
<div style="font-size: 8pt; page-break-before: always;">Beri Tanda Cek ()</div>
<br>
<?php
