        ...
        array(
            ...
            'value' => function($data) {
                $btnCheck = CHtml::link('<i class="icon-form-check"></i>', '', [
                    ...
                    $("#form-racikan #hargasatuan_reseptur").val("' . $data['HJual'] . '");
                    setObatRacikanDariApi("'. $data['Kode'].'", "'. $data['jenis']. '", "' . $data['StFornas']. '", "' . $data['HJual'] . '", "' . $data['satuan'] . '", "' . str_replace('"', '', $data['Nama']) . '", "' . $data['HPP'] . '");
                    '
                ]);
