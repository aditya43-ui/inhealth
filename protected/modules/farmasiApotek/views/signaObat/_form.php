...
<div class="row">
    ...
    <div class="col-sm-6">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $form->textField($model, 'lookup_name', array('placeholder' => 'Signa Obat', 'class' => 'span3', 'maxlength' => 200)); ?>
            </div>
        </div>
    ...
    <div class="col-sm-6">
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $form->textField($model, 'lookup_value', array('placeholder' => 'Signa Obat Lainnya', 'class' => 'span3', 'maxlength' => 200)); ?>
            </div>
        </div>
    </div>
</div>
