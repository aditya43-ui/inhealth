...
<tr>
    ...
    <td>
        <?php echo CHtml::activeTextField($modObatAlkesPasien, '[ii]jmlstok',array('class'=>'qty_stok integer', 'readonly'=>true,'style'=>'width:50px;')); ?>
    </td>
    <td>
        <?php
    ...
    <td>
        <?php echo CHtml::activeTextField($modObatAlkesPasien, '[ii]qty_oa',array('class'=>'qty_jual integer-decimal', 'readonly'=>false,'style'=>'width:50px;')); //,'onblur'=>'hitungSubTotal(this)'?>
    ...
    <td hidden>
    	<?php echo CHtml::activeTextField($modObatAlkesPasien, '[ii]persen_discount',array('style'=>'width:50px;', 'class'=>'integer-decimal','onblur'=>'hitungTotal()')); ?>
    </td>
    <td hidden>
    	<?php echo CHtml::activeTextField($modObatAlkesPasien, '[ii]discount',array('style'=>'width:110px;', 'class'=>'integer-decimal','onblur'=>'hitungPersenDiskon()')); ?>
    </td>
    <td hidden>
    	<?php echo CHtml::activeTextField($modObatAlkesPasien, '[ii]ppnpersen',array('style'=>'width:50px;', 'class'=>'integer-decimal','onblur'=>'hitungTotal()')); ?>
    </td>
    <td hidden>
    ...
    <td>
      ...
      <?php echo CHtml::activeHiddenField($modObatAlkesPasien, '[ii]subtotal',array('readonly'=>true,'style'=>'width:50px;')); ?>
    </td>
