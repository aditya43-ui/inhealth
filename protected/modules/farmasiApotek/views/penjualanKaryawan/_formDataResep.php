<div class="panel panel-success">
	...
	<div class="panel-body">
			...
			<div class="controls">
				...
				<div style="float:left;">
					...
					$this->widget('MyJuiAutoComplete', array(
						...
						'htmlOptions' => array('value' => $modReseptur->getDokter(), 'onkeypress' => "return $(this).focusNextInputField(event)", 'class' => 'span2', 'style' => 'float:left;')
					));
					?>
				</div>
			</div>
		...
		<?php
		echo $form->dropDownListRow($modPenjualan, 'carabayar_id', CHtml::listData($modPenjualan->getCaraBayarItems(), 'carabayar_id', 'carabayar_nama'), array(
		...
		?>
		<div class="control-group ">
			<?php echo CHtml::label('Jenis Penjamin <span class="required">*</span>','carabayarpegawai', array('class' => 'control-label')) ?>
			<div class="controls">
			<?php echo $form->dropDownList($modPenjualan,'carabayarpegawai', LookupM::getItems('carabayarpegawai'),array('empty'=>'-- Pilih --', 'onkeypress'=>"return $(this).focusNextInputField(event)", 'class'=>'span3 required')); ?>  
			</div>
		</div>
