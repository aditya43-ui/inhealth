...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="entypo-newspaper"></i> Laporan <b>Jumlah Resep</b>
        </div>
    </div>
    <div class="panel-body">
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="entypo-credit-card"></i> Tabel <b>Jumlah Resep</b>
                </div>
            </div>
            ...
            <div class="panel-body table-responsive">
                <div class="panel-body table-responsive">
                    <ul class="nav nav-tabs">
                        <li onclick="ShowHideDiv(this)" id="Grafik_Batang" class="buttonLi">
                            <a>Batang</a>
                        </li>
                        <li onclick="ShowHideDiv(this)" id="Grafik_Pie" class="buttonLi">
                            <a>Pie</a>
                        </li>
                        <li onclick="ShowHideDiv(this)" id="Grafik_Garis" class="buttonLi">
                            <a>Garis</a>
                        </li>
                    </ul>
                    <div class="div_grafik Grafik_Batang">
                        <?php
                    ...
                    <div class="div_grafik Grafik_Pie">
                        <?php
                        $this->renderPartial('grafik/_grafik_pie', array(
                            'tgl_awal' => $tgl_awal, 'tgl_akhir' => $tgl_akhir,
                            'model' => $model, 'lookup_m' => $lookup_m,
                            'resultLaporanJumlahResep' => $resultLaporanJumlahResep,
                            'judul_laporan' => $judul_laporan, 'tahun' => $tahun
                    ...
                    <div class="div_grafik Grafik_Garis">
                        <?php
                        $this->renderPartial('grafik/_grafik_garis', array(
                            'tgl_awal' => $tgl_awal, 'tgl_akhir' => $tgl_akhir,
                            'model' => $model, 'lookup_m' => $lookup_m,
                            'resultLaporanJumlahResep' => $resultLaporanJumlahResep,
                            'judul_laporan' => $judul_laporan, 'tahun' => $tahun
...
<script type="text/javascript">
    ...
    function ShowHideDiv(id) {
        ...
        $(".div_grafik").css("display", "none"); //Hide all DIV's within container
