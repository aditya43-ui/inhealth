<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="entypo-newspaper"></i> Laporan <b>Penjualan Obat</b>
        </div>
    </div>
    <div class="panel-body">
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="entypo-credit-card"></i> Tabel <b>Penjualan</b>
                </div>
            </div>
            <div class="panel-body table-responsive">
                <?php if (empty($model)) $model = new FALaporanpenjualanobatV; ?>
