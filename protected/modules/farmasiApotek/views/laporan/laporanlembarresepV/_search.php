    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    echo $form->dropDownList($model, 'instalasiasal_nama', CHtml::listData(InstalasiM::model()->findAll($insDrop), 'instalasi_nama', 'instalasi_nama'), array(
        ...
        <div class="col-sm-6">
            <div class="control-group">
                ...
                <div class="controls">
                    <?php
                    $ruDrop = new CDbCriteria();
                    $ruDrop->join = " JOIN instalasi_m i ON i.instalasi_id = t.instalasi_id ";
                    $ruDrop->addCondition(" ruangan_aktif = TRUE ");
                    // $ruDrop->addInCondition(" i.instalasi_nama ", array($model->instalasiasal_nama));
                    $ruDrop->order = " ruangan_nama ASC ";

                    echo $form->dropDownList(
                        $model,
                        'ruanganasal_nama',
                        CHtml::listData(RuanganM::model()->findAll($ruDrop), 'ruangan_id', 'ruangan_nama'),
