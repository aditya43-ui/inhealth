...
<script>
    function printNota(pendaftaran_id) {
        var nopel = $('#nopel').val();
        window.open('<?php echo $this->createUrl('/rawatJalan/tindakan/printTindakan'); ?>&id=' + pendaftaran_id + '&nopelayanan=' + nopel, 'printwin', 'left=100,top=100,width=1080,height=640');
    }
</script>
