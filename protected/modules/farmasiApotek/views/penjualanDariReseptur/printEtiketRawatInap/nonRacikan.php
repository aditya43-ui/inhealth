...
<div class="content" style="margin-left: 10px; width: 90%; margin-top: 0px;">
            ...
            <td style="font-size: 6pt;">
                <?php 
                    ...
                    if(!empty($modPendaftaran->admisi)) {
                        $ruangan_nama = $modPendaftaran->admisi->ruangan->ruangan_nama;
                    } 
                    echo substr($ruangan_nama, 0, 24);?>
            </td>
        <tr>
        <tr>
    </table>
    <table style="width: 100%; margin-top: -5pt; margin-bottom: 0pt;" class="">
        <tr>
            ...
            <td style="width: 3%;"> : </td>
            <td style="padding: 2px;"><?php echo $obat['obatalkes_nama']
            // . " - " . $obat['jumlahpermintaan_obatnonracikan']?></td>
        </tr>
    </table>
    <table style="width: 100%;  margin-top: -3pt; margin-bottom: -3pt;" class="tbl-obat">
    <tr class="tr-long">
            <td style="width: 35%;">Aturan </td>
            <td style="width: 3%;"> : </td>
