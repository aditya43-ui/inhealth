...
<div class="content" style="margin-left: 10px; width: 90%; margin-top: 0px;">
    <table style="width: 100%;" class="tbl-resep tbl-obat tbl-atas">
        <tr class="">
    ...
    <?php endif;?>
            <tr class="tr-long">
                ...
                <td style="width: 3%;"> : </td>
                <td style="line-height: 6pt;padding-top:-2px;"><?php echo "Racik " . $obat['rke'];?>
                    <p class="long-text"> 
                        <?php echo $obat['obatalkes_nama'] ?>
                    </p>
                </td>
            <tr>
        </table>
        <table style="width: 100%;  margin-top: -1pt; margin-bottom: -6pt;" class="tbl-obat">
            <tr class="tr-long">
                <td style="width: 37%;">Aturan </td>
                <td style="width: 3%;"> : </td>
                <td style="line-height: 7px;"><?php echo $obat['etiket']; ?></td>
            <tr>
        </table>
        <table style="width: 100%; margin-top:-0.5px" class="tbl-resep tbl-obat tbl-resep-obat">
            <tr>
