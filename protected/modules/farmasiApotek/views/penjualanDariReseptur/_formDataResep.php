<div class="col-sm-6">
    ...
    <div class="control-group">  
        <label for="pegawai_id" class="control-label">Pembuat Resep</label>
        <div class="controls">
...
<div class="col-sm-6">
    ...
    <div class="control-group ">
        <label class="control-label" for="iter">Petugas <span class="required">*</span></label>
    <?php 
    ...
    ?>
        <div class="controls">
            <?php echo CHtml::activedropDownList($modPenjualan, 'kodepetugas_inv', $arrayPetugas, array('readonly'=>true,'onkeypress'=>"return $(this).focusNextInputField(event)",'class'=>'span3 required', 'id' => 'kodepetugas', 'empty' => '-- Pilih --')) ?>
        </div>
    </div>
    <?php 
