...
<tr row-data="0">
	...
	<td style="text-align: center;">
		...
		<?php // echo CHtml::activeHiddenField($modResepturDetail, '[ii]waktupemberian_ranap',array('class' =>'waktupemberian_ranap','readonly'=>true,'style'=>'width:110px;')); 
		?>
	...
	<td>
		...
		// 	'htmlOptions' => array('placeholder' => 'Ketik nama obat alkes', 'onkeyup' => "return $(this).focusNextInputField(event)", 'class' => 'span3 username', 'value' => $modResepturDetail->ObatAlkesNama),
		// )); ?>
	...
	<td>
		<?= $modResepturDetail->sumberdana_nama ?? '' ?>
	</td>
	<td nowrap>
		<?php 
	...
	<?php if (!isset($takaranresep)) { ?>
		<td nowrap>
			<?php echo CHtml::activeTextField($modResepturDetail, '[ii]qty_dilayani', array('class' => 'qty number-char span1' . $rclass, 'readonly' => false, 'style' => 'width:50px; text-align: right;', 'value' => $modResepturDetail->qty_reseptur, 'onblur' => 'hitungSubTotal(this); ceklist(this);setRiwayat(this);')); ?>
			<?php echo $satuan; ?>
		</td>
	<?php } else { ?>
		<td nowrap>
			<?php echo CHtml::activeTextField($modResepturDetail, '[ii]qty_dilayani', array('class' => 'qty number-char span1' . $rclass, 'readonly' => false, 'style' => 'width:50px; text-align: right;', 'onblur' => 'hitungSubTotal(this); ceklist(this);setRiwayat(this);')); ?>
			<?php echo $satuan; ?>
		</td>
	<?php } ?>
	...
	<!--td>
		...
		<?php } ?>
	<td>
		<?php echo CHtml::activeTextField($modResepturDetail, '[ii]hargasatuan_reseptur', array('readonly' => true, 'style' => 'width:120px;', 'class' => 'hargasatuan_reseptur')); ?>
	</td>
	<td hidden>
