...
<div class="row">
    ...
    <div class="col-sm-6">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $form->textField($model, 'lookup_name', array('placeholder' => 'Sediaan Obat Racikan', 'class' => 'span4', 'maxlength' => 200)); ?>
            </div>
        </div>
    ...
    <div class="col-sm-6">
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $form->textField($model, 'lookup_value', array('placeholder' => 'Sediaan Obat Racikan Lainnya', 'class' => 'span4', 'maxlength' => 200)); ?>
            </div>
        </div>
