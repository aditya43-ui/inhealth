<div class = "col-sm-6">
    <div class="control-group ">
        ...
        <div class="controls">
            <?php
            echo CHtml::activeTextField($modPenjualan,'jenispenjualan',array('readonly'=>true,'class'=>'span3', 'onkeyup'=>"return $(this).focusNextInputField(event);"));
        ...
        <div class="controls">
            <?php
                $this->widget('MyJuiAutoComplete', array(
                    ...
                    'htmlOptions'=>array('placeholder'=>'Ketik Nama Pegawai','class'=>'span3 all-caps','rel'=>'tooltip','title'=>'Ketik no. pendaftaran / klik icon untuk mencari data pegawai',
                        'onkeyup'=>"return $(this).focusNextInputField(event)",
                    ),
                ))
            ?>
