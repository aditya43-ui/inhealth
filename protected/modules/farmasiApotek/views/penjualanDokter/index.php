<?php $linkHalaman = CustomFunction::getUrlByMenuID(965); ?>
<style>
    .yellow td {
...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="glyphicon glyphicon-briefcase"></i> Transaksi <strong>Penjualan Obat untuk Dokter</strong>
    ...
    <div class="panel-body">
        ...
        if (isset($_GET['sukses'])) {
            if ($_GET['sukses'] == 1) {
                Yii::app()->user->setFlash("success", "Transaksi Penjualan Obat untuk Dokter berhasil disimpan!");
            }
        }
        ?>
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="glyphicon glyphicon-file"></i> Data Dokter
                    <span class='tombol' style='display:none;'><?php echo CHtml::htmlButton('<i class="icon-refresh icon-white"></i>', array('class' => 'btn btn-danger btn-mini', 'onclick' => 'setInfoPegawaiReset();', 'onkeyup' => "return $(this).focusNextInputField(event)", 'rel' => 'tooltip', 'title' => 'Klik untuk mengulang data kunjungan')); ?></span>
                </div>
            </div>
            <div class="panel-body">
                <div class="row-fluid">
        ...
        <div class="panel panel-success">
            ...
            <div class="panel-body" style="overflow-x: auto;">
                <div class="block-tabel">
                    <table class="items table table-bordered table-striped table-condensed" id="table-obatalkespasien">
                        ...
                        <tfoot>
                            ...
                            <tr>
								<td style="text-align: right;" colspan="12"><strong>Jumlah Biaya R</strong></td>
								<td>
                            ...
                            <tr>
                                <td style="text-align: right;" colspan="12"><strong>Jasa Pelayanan Farmasi</strong></td>
                                <td>
                            ...
                            <tr>
                                <td colspan="12" style="text-align: right;"><strong>Total Keseluruhan</strong></td>
                                <td>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <?php //echo $form->textFieldRow($modPenjualan, 'totalhargajual',array('class'=>'span2 integer2', 'readonly'=>'true')); 
                        ?>
                    </div>
                </div>
            </div>
