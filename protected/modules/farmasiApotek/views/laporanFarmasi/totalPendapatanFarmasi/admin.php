<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="entypo-newspaper"></i> Laporan <b>Total Pendapatan Farmasi</b>
        </div>
    </div>
    <div class="panel-body">
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                ...
                $this->breadcrumbs = array(
                    'Laporan Total Pendapatan Farmasi',
                );
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="entypo-credit-card"></i> Tabel <b>Total Pendapatan Farmasi</b>
                </div>
            </div>
        ...
        <div class="panel panel-success">
            ...
            <div class="panel-body table-responsive">
                ...
                <iframe class="biru" src="" id="Grafik" width="100%" height='0' onload="javascript:resizeIframe(this);" style="border: none;"></iframe>
