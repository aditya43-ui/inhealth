<div class="search-form">
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <?php
            echo CHtml::hiddenField('filter', 'jenisobatalkes', array('disabled' => 'disabled')) .
                '<div class="control-group">
                    ' . CHtml::label('Jenis Obat Alkes', 'jenisobatalkes_id', array('class' => 'control-label')) . ' 
                    <div class="controls">
                        ' . $form->dropDownList($model, 'jenisobatalkes_id', CHtml::listData(JenisobatalkesM::model()->findAll(), 'jenisobatalkes_id', 'jenisobatalkes_nama'), array(
            ...
            //             'isi' => CHtml::hiddenField('filter', 'jenisobatalkes', array('disabled' => 'disabled')) .
            //                 '<div class="control-group">
            //                         ' . CHtml::label('Jenis Obat Alkes', 'jenisobatalkes_id', array('class' => 'control-label')) . ' 
            //                         <div class="controls">
            //                             ' . $form->dropDownList($model, 'jenisobatalkes_id', CHtml::listData(JenisobatalkesM::model()->findAll(), 'jenisobatalkes_id', 'jenisobatalkes_nama'), array(
