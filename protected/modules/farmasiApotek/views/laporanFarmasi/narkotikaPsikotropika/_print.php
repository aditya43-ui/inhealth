...
//    } else {
        $this->renderPartial('narkotikaPsikotropika/_table', array('model'=>$model, 'caraPrint'=>$caraPrint));
//    }
}
if ($caraPrint == 'GRAFIK')
echo $this->renderPartial('narkotikaPsikotropika/_grafik', array('model'=>$model, 'data'=>$data, 'caraPrint'=>$caraPrint), true); 
