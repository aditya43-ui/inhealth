<tr>
    ...
    <td>
        ...
        <span name="[ii][obatalkes_kode]"><?php echo (!empty($modObatAlkesPasien->sumberdana_id) ? $modObatAlkesPasien->obatalkes->obatalkes_kode."(".$modObatAlkesPasien->obatalkes_nama.")"  : "") ?></span>/<br>
    ...
    '<td>'.'<a onclick="hapusObatAlkesPasienDetail('.$modObatAlkesPasien->obatalkespasien_id.');return false;" rel="tooltip" href="javascript:void(0);" title="Klik untuk menghapus penjualan obat alkes ini"><i class="icon-form-sampah"></i></a></td>'.''; 
       ...
       echo
    '<td>'.'<a onclick="batalObatAlkesPasienDetail(this);return false;" rel="tooltip" href="javascript:void(0);" title="Klik untuk membatalkan penjualan obat alkes ini"><i class="icon-form-silang"></i></a></td>'.'';  
    }
    ?>
