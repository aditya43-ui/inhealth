...
<div class="panel panel-gradient">
    ...
    <div class="panel-body">
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                <?php $this->renderPartial($this->path_view_informasiPasienOperasi . '_formSearch', array('model' => $model)); ?>
            </div>
        </div>
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="entypo-credit-card"></i> Tabel <b>Pasien Operasi</b>
                </div>
                <?= CHtml::link('Kembali Ke Reseptur Pasien OK', $this->createUrl('index'),['class' => 'btn btn-default', 'style' => 'float:right;']) ?>
            </div>
