...
<body>
    ...
    <!--<div id="headerAntrian">gi
                <div id="refresh" style="float:right;">-->
    <div class="bases">
        <div id="header" class="row">
            <div class="col-sm-3" style="padding-left: 30px;">
                <div class="logo_profil">
                <img src="<?php echo Params::urlProfilRSDirectory().$data->logo_rumahsakit ?> " style="float:left; margin-top: -37px; max-width: 98px; width:98px;" class='image_report'/>
                </div>
            </div>
            <div class="col-sm-6">
