...
class FAInformasipenjualanresepV extends InformasipenjualanaresepV
{
        ...
        public $jumlah_dipanggil;
        public $statusperiksa;
        public $racikan_singkatan;
		public $noresep;
        public $is_tgl;
        public $modelantrian_kode;
	 ...
	 */
		...
		$criteria=new CDbCriteria;
                $criteria->select = array('t.racikan_nama,t.create_loginpemakai_id, t.pasienadmisi_id, t.gelardepan, t.gelarbelakang_nama, t.racikan_singkatan, t.carabayar_nama, t.penjamin_nama, t.noantrian, t.panggilantrian, t.antrianlewat, t.pendaftaran_id, penjualanresep_t.jenispenjualan','penjualanresep_t.returresep_id',' t.jenispenjualan','t.penjualanresep_id','t.pasien_id','t.pegawai_id', 't.nama_pegawai','t.alamat_pasien','t.no_rekam_medik','t.namadepan','t.nama_pasien','t.nama_bin','t.tanggal_lahir',
...
//                $criteria->addCondition('penjualanresep_t.returresep_id IS NULL'); // DI NONAKTIFKAN KARENA ADA KASUS RETUR SEBAGIAN OBAT 
        ...
        $criteria->group = 't.antrianfarmasi_id, t.create_loginpemakai_id, t.pasienadmisi_id, t.carabayar_id, t.carabayar_nama, t.penjamin_id, t.penjamin_nama, t.gelardepan, t.gelarbelakang_nama, t.racikanantrian_singkatan, t.noantrian, t.panggilantrian, t.antrianlewat, t.pendaftaran_id, penjualanresep_t.jenispenjualan, penjualanresep_t.returresep_id, t.jenispenjualan, t.no_rekam_medik, t.namadepan, t.nama_pasien, t.nama_bin, t.tanggal_lahir, t.noresep, t.totharganetto,
                            t.totalhargajual, t.instalasiasal_nama, t.ruanganasal_nama, t.penjualanresep_id, t.reseptur_id, t.pegawai_id, t.nama_pegawai, t.tglpenjualan, t.pasien_id,pendaftaran_t.umur, t.jeniskelamin, t.alamat_pasien, t.tglresep, t.create_ruangan, t.statusobat, t.tglpenyerahan,t.kamarruangan_nokamar, t.kamarruangan_nobed, t.kelaspelayanan_id';
...
//                    $this->$columnName = $format->format('#,##0', $this->$columnName);
        ...
        */
        ...
        {		
            ...
            if(!empty($this->instalasiterakhir_id)){
                $criteria->addCondition("instalasiterakhir_id = '".$this->instalasiterakhir_id."' ");
            }
            ...
            // $criteria->addCondition("instalasiterakhir2_id =".Params::INSTALASI_ID_RI);
            $criteria->limit = -1;
            return $criteria;
        }
    ...
    public function searchDashboardPengambilanResep() {
        $criteria = new CDbCriteria;
        if (!empty($this->pasien_id)){
            $criteria->addCondition("pasien_id = '".$this->pasien_id."' ");                
        }
        // date('d F Y', strtotime($model->tgl_awal)
        $criteria->addInCondition('carabayar_id', array(1,3,22));           
        // $criteria->addCondition('tglpenyerahan is null');
        // $criteria->addCondition('ketpenyerahan is not null');
		// if(!empty($this->tglpenyerahan)&&($this->tglpenyerahan!=date("d/m/Y"))){
		// 	$criteria->addCondition('tglpenyerahan = \''.$this->tglpenyerahan. '\'');
		// }
        // if (!empty($this->ketpenyerahan)&&($this->ketpenyerahan!=null)){
        //     $criteria->addCondition("ketpenyerahan = '".$this->ketpenyerahan."' ");
        // }
        $criteria->order = "tglpenjualan asc";
