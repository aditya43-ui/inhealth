<?php
    ...
    // $this->renderPartial('konsultasiInternal/_dataPasien', 
...
?>
<?php
    echo $this->renderPartial('jawabankonsul/_permohonan', 
        array('modPendaftaran' => $modPendaftaran, 'modPasien' => $modPasien, 'model' => $model, 'pasienMorbiditas' => $pasienMorbiditas)
    ); 
?>
<?php
    echo $this->renderPartial('jawabankonsul/_jawaban', 
        array('modPendaftaran' => $modPendaftaran, 'modPasien' => $modPasien, 'model' => $model, 'modMorbiditas' => $modMorbiditas)
    ); 
?>
...
?>
<?php
$modDiagnosa = new GZDiagnosaM('search');
$modDiagnosa->unsetAttributes();
if (isset($_GET['GZDiagnosaM'])) {
    $modDiagnosa->attributes = $_GET['GZDiagnosaM'];
}
$this->widget(
