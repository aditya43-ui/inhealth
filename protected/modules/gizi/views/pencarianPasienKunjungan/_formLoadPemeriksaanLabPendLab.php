...
<tr id="periksalab_<?php echo $idPemeriksaanLab; ?>">
    <td><?php echo CHtml::checkBox('GZTindakanPelayananT[cek][]',true, array('onclick'=>'myAlert("Silakan klik tombol \'Pilih Pemeriksaan Laboratorium\' untuk membatalkan pemeriksaan"); $(this).attr("checked",true);'));?></td>    
    <td>
