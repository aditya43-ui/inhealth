...
$pendaftaran = PendaftaranT::model()->findByPk($kunjungan->pendaftaran_id);

$ceklis = '<span class="fa fa-check-square-o"></span>';
$unceklis = '<span class="fa fa-square-o"></span>';
?>

<table class="tab_page" width="100%">
    <tbody>
        <tr>
            <td>
                ...
                <table class="tab_detail">
                    <tbody>
                        <tr>
                            <td width="100" class="header_logo">
                                <img src="<?php echo Params::urlProfilRSDirectory() . $modProfilRs->logo_rumahsakit ?> " style="width:100px;"/>
                            </td>
                            <td class="print_header">
                                <div class="print_judul">Formulir Sisa Makanan Rumah Sakit<br/>(Comstok/Recal)</div>
                            </td>
                            <td width="250">
                                <table class="tab_info tab_header">
                                    ...
                                    <tr>
                                        <td>Dokter DPJP</td>
                                        <td>:</td>
                                        <td><?php echo empty($pendaftaran->pasienadmisi) ? $pendaftaran->pegawai->namaLengkap : $pendaftaran->pasienadmisi->pegawai->namaLengkap; ?></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                ...
                <div class="panel_main" style="margin-bottom: 0px !important;">
                    ...
                    <div class="panel_body">
                        ...
                        <table class="tab_detail">
                            ...
                            <tbody>
                                ...
                                foreach ($jenis as $item):
                                    ...
                                    foreach ($makanan as $idx => $item2):
                                        ...
                                        <tr>
                                            ...
                                            <?php
                                            foreach ($persen as $item3):
                                                if ($det->persensisamakanan_id == $item3->persensisamakanan_id && $item3->urutan == 5) {
                                                    $total4++;
                                                }
                                                if ($det->persensisamakanan_id == $item3->persensisamakanan_id && $item3->urutan == 6) {
                                                    $total5++;
                                                }
                                                ?>
                                ...
                                <?php endforeach; ?>
                                <tr>
                                    <td>No Kolom<br/>Sisa Makanan</td>
                                    <td></td>
                                    <td></td>
                                    <?php foreach ($persen as $idx => $item3): ?>
                                        <td style="text-align: center;">
                                            <?php echo $idx; ?>
                                        </td>
                                    <?php endforeach; ?>
                                ...
                                <tr>
                                    ...
                                    <td colspan="<?php echo count($persen) + 2 ?>"></td>
                                    <td><?php echo $cnt - 1; ?></td>
                                </tr>
                                <tr>
                                    <td>Total 4 dan 5</td>
                                    <td colspan="<?php echo count($persen) ?>"></td>
                                    <td><?php echo $total4; ?></td>
                                    <td><?php echo $total5; ?></td>
                                    <td><?php echo $total4 + $total5; ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="panel_main">
                    <div class="panel_judul">AUDIT  SCORE</div>
                    <div class="panel_body">
                        <div class="row-fluid">
                            <div class="col-sm-6">
                                <table class="tab_info">
