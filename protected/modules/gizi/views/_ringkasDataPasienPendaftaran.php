...
?>
 <iframe src="" name="detailDialogAnamnesa" id="detailDialogAnamnesa" width="100%" height="100%" onload="javascript:resizeIframe(this);"></iframe>
<?php
$this->endWidget();
//=======================================================================
?>
...
?>
<iframe src="" name="detailDialog" id="detailDialog" width="100%" height="100%" onload="javascript:resizeIframe(this);"></iframe>
<?php
$this->endWidget();
