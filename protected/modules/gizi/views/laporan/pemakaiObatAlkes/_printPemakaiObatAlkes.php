    ...
    if ($caraPrint == 'PRINT') {
        ...
        <table>
            ...
            <tbody>
                <tr>
                    <td>
                        <div class="content"><?php $this->renderPartial('pemakaiObatAlkes/_tablePemakaiObatAlkesPrint', array('model' => $model, 'caraPrint' => $caraPrint)); ?></div>
                    </td></tr></tbody>
            <tfoot>
                <tr>
                    <td>
...
if ($caraPrint == 'PDF') {
    ...
    $this->renderPartial('pemakaiObatAlkes/_tablePemakaiObatAlkesPrint', array('model' => $model, 'caraPrint' => $caraPrint));
