...
$this->breadcrumbs = array(
    'Laporan Jumlah Porsi per Kelas',
);
?>
...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="entypo-newspaper"></i> Laporan <b>Jumlah Porsi per Kelas</b>
        </div>
    </div>
    <div class="panel-body">
        ...
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                <?php
                $this->renderPartial('jmlPorsiKelas/_search', array(
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="entypo-credit-card"></i> Tabel <b>Jumlah Porsi per Kelas</b>
                </div>
            </div>
