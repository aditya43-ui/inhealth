...
<div class="row">
    ...
    <div class="col-sm-6">
        <div class="control-group">
            ...
            <?php echo CHtml::label('Jenis Diet', '', array('class' => 'control-label')) ?>

            <div class="controls">
                <?php echo $form->dropDownList($model, 'jenisdiet_nama', CHtml::listData(JenisdietM::model()->findAll("jenisdiet_aktif = TRUE ORDER BY jenisdiet_nama ASC"), 'jenisdiet_nama', 'jenisdiet_nama'), array('empty' => '-- Pilih --', 'class' => 'span4')); ?>
            </div>
        </div>
    </div>
</div>
