...
$this->breadcrumbs = array(
    'Laporan Jasa Konsultasi Gizi',
);
?>
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="entypo-newspaper"></i> Laporan <b>Jasa Konsultasi Gizi</b>
        </div>
    </div>
    <div class="panel-body">
        ...
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                <?php
                $this->renderPartial('jasaKonsulGizi/_search', array(
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="entypo-credit-card"></i> Tabel <b>Jasa Konsultasi Gizi</b>
                </div>
            </div>
