...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="entypo-newspaper"></i> Laporan <b>PMT Radiologi</b>
        </div>
    </div>
    <div class="panel-body">
        ...
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                <?php
                $this->renderPartial('extraFooding/_search', array(
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="entypo-credit-card"></i> Tabel <b>PMT Radiologi</b>
                </div>
            </div>
            <div class="panel-body table-responsive">
                <?php $this->renderPartial('extraFooding/_table', array('model' => $model, 'format' => $format, 'models' => $models)); ?>
