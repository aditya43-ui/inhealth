...
<?php echo $this->renderPartial('application.views.headerReport.headerDefaultNew',array('judulLaporan'=>'',  'periode'=> '', 'colspan'=>10)); ?>
<table class="" style = "box-shadow:none;" width="100%">
