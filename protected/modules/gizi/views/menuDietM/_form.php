...
<div class="row">
    <div class="col-sm-6">
        ...
        ?>
        <?php
        // echo $form->dropDownListRow($model,'jenisdiet_id',
        ...
        <div class='control-group'>
            <?php echo CHtml::label('Tindakan Menu Diet', 'daftartindakan_id', array('class' => 'control-label', 'onkeypress' => "return $(this).focusNextInputField(event)")); ?>
            <div class="controls">
        ...
        <?php echo $form->textFieldRow($model, 'jml_porsi', array('placeholder' => 'Jumlah Porsi', 'class' => 'span2 numbers-only', 'onkeypress' => "return $(this).focusNextInputField(event)", "style" => "text-align: right;")); ?>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                ...
                echo $form->dropDownList($model, 'ukuranrumahtangga', CHtml::listData($model->URTItems, 'lookup_name', 'lookup_value'), array(
                    'class' => 'inputRequire span2', 'style' => "margin-right:80px;", 'onkeypress' => "return $(this).focusNextInputField(event)",
                    'empty' => '-- Pilih --',
                ));
                ?>
            </div>
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="entypo-credit-card"></i> Tabel <b>Zat Gizi</b>
                </div>
            </div>
...
<div class="form-actions">
    ...
    echo CHtml::htmlButton($model->isNewRecord ? Yii::t('mds', '{icon} Create', array('{icon}' => '<i class="entypo-check"></i>')) :
        Yii::t('mds', '{icon} Save', array('{icon}' => '<i class="entypo-check"></i>')), array('class' => 'btn btn-danger', 'type' => 'submit', 'id' => 'btn_simpan', 'onKeypress' => 'return formSubmit(this,event)', 'onclick' => 'formSubmit(this,event)'));
    ?>
    <?php
    echo CHtml::link(
