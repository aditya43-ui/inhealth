...
<div class="row">
    ...
    <div class="col-sm-4" style="text-align:center;">
        ...
        if (isset($_GET['sukses'])) {
            echo "<div class='control-group' style='height: 80px; margin-top: 0;'>";
            //            echo "Direktur,<br>Menyetujui";
        } else {
            echo "<div class='control-group' style='height: 80px'>";
            if ($modPengajuan->idpegawai_menyetujui == Yii::app()->user->getState('pegawai_id')) {
                echo CHtml::link(Yii::t('mds', ' Menyetujui'), $this->createUrl($this->id . '/index'), array(
                    'class' => 'btn btn-danger',
                    'onclick' => 'myConfirm("Apakah Anda yakin?","Perhatian!",
					function(r) {if(r) window.location = "' . $this->createUrl('ApproveMenyetujui', array('pengajuanbahanmkn_id' => $modPengajuan->pengajuanbahanmkn_id, 'approve' => true)) . '";} ); return false;'
                ));
            } else {
        ...
        ?>
        <div class="control-group">
            ( <?php echo (!empty($modPengajuan->tgl_menyetujui) ? "" : (isset($modPengajuan->idpegawai_menyetujui) ? $modPengajuan->menyetujui->namaLengkap : "&nbsp;")); ?> )
        </div>
    </div>
    <div class="col-sm-4" style="text-align:center;">
        <?php
...
$urlPrint = $this->createUrl('printApproveMenyetujui', array('pengajuanbahanmkn_id' => $modPengajuan->pengajuanbahanmkn_id));
