...
<div class="row">
    <div class="col-sm-4" style="text-align:center;">
        ...
        if (isset($_GET['sukses'])) {
            ...
            echo "<div class='control-group' style='margin-bottom: 50px;'>";
            if ($modPengajuan->idpegawai_mengetahui == Yii::app()->user->getState('pegawai_id')) {
                echo CHtml::link(Yii::t('mds', ' Mengetahui'), $this->createUrl($this->id . '/index'), array(
                    'class' => 'btn btn-danger',
                    'onclick' => 'myConfirm("Apakah Anda yakin?","Perhatian!",
					function(r) {if(r) window.location = "' . $this->createUrl('ApproveMengetahui', array('pengajuanbahanmkn_id' => $modPengajuan->pengajuanbahanmkn_id, 'approve' => true)) . '";} ); return false;'
                ));
            } else {
        ...
        <div class="control-group">
            ( <?php echo (!empty($modPengajuan->tgl_mengetahui) ? "" : (isset($modPengajuan->idpegawai_mengetahui) ? $modPengajuan->mengetahui->namaLengkap : "&nbsp;")); ?> )
        </div>
    </div>
</div>
...
$urlPrint = $this->createUrl('printApproveMengetahui', array('pengajuanbahanmkn_id' => $modPengajuan->pengajuanbahanmkn_id));
