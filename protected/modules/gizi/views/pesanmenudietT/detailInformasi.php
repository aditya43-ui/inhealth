...
<?php } else if ($modPesan->jenispesanmenu == Params::JENISPESANMENU_PENDAMPING) { ?>
    <table id="tableObatAlkes" class="table table-striped table-bordered table-condensed">
        <thead>
            <tr>
                ...
                <th rowspan="2">Instalasi</th>
                <th rowspan="2">Ruangan</th>
                <th rowspan="2">Nama <?php echo $kolomNama; ?></th>
                <th rowspan="2">Jenis Kelamin</th>
                <th colspan="<?php echo count(JeniswaktuM::getJenisWaktu()); ?>"><p style='margin: 0; text-align: center;'>Menu Diet</p></th>
                <th rowspan="2">Jumlah</th>
            </tr>
        ...
        <tbody>
            ...
            $pasien = empty($modPesan->pendaftaran) ? null : $modPesan->pendaftaran->pasien;
            ...
            foreach ($modDetailPesan AS $tampilData):
                ...
                <td>" . $modPesan->ruangan->ruangan_nama . "</td>";
                if (!empty($pasien)) {
                    echo "<td>" . (empty($pasien) ? "-" : $pasien->nama_pasien) . "</td>   
                <td>" . (empty($pasien) ? "-" : $pasien->jeniskelamin) . "</td>";
                } else {
                    echo "<td>Tamu " . $no . "</td>   
