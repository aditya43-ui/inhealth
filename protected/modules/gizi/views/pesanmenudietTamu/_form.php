...
$this->breadcrumbs = array(
    'Pemesanan Menu Diet Pendamping'
);
$form = $this->beginWidget('ext.bootstrap.widgets.BootActiveForm', array(
    'id' => 'gzpesanmenudietpendamping-t-form',
...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="fas fa-utensils"></i> Transaksi <b>Pemesanan Menu Diet Pendamping</b>
    ...
    <div class="panel-body">
        ...
        if (!empty($_GET['sukses'])) {
            Yii::app()->user->setFlash('success', "Data No. Pemesanan " . $model->nopesanmenu . " berhasil disimpan!");
        ?>
        <?php } ?>
        <?php $this->widget('bootstrap.widgets.BootAlert'); ?>
        <?php echo $this->renderPartial($this->path_view_tamu . '_dataForm', array('form' => $form, 'model' => $model)); ?>
        <br>
                        ...
                        <div class="control-group">
                            ...
                            <div>
                                ...
                                <?php echo '<table>
                                                            <tr>
                                                                <td>
                                                                    ' . Chtml::checkBoxList('jeniswaktu', '', CHtml::listData($modJenisWaktu, 'jeniswaktu_id', 'jeniswaktu_nama'), array('template' => '<label class="checkbox inline">{input}{label}</label>', 'separator' => '', 'style' => 'margin-left:2px;max-width:10px;', 'class' => 'span2 jeniswaktu', 'onkeypress' => "return $(this).focusNextInputField(event)")) . '
                                                                </td>
                                                            </tr>
                                                        </table>'; ?>
                                <!--</fieldset>-->
        ...
        <div class="form-actions">
            ...
            if (isset($_GET['sukses'])) {
                echo CHtml::htmlButton($model->isNewRecord ? Yii::t('mds', '{icon} Create', array('{icon}' => '<i class="entypo-check"></i>')) :
                    Yii::t('mds', '{icon} Save', array('{icon}' => '<i class="entypo-check"></i>')), array('title' => 'Simpan', 'class' => 'btn btn-primary disabled', 'type' => 'button', 'onKeypress' => 'return formSubmit(this,event)'));
            } else {
                echo CHtml::htmlButton($model->isNewRecord ? Yii::t('mds', '{icon} Create', array('{icon}' => '<i class="entypo-check"></i>')) :
...
<?php $this->endWidget(); ?>
<?php $this->renderPartial($this->path_view_tamu . '_dialog', array('model' => $model)); ?>
<?php
