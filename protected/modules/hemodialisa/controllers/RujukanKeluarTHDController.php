...
class RujukanKeluarTHDController extends RujukanKeluarController
{
...
//            
//            $modRujukanKeluar = new HDPasienDirujukKeluarT;
...
//            if(isset($_POST['HDPasienDirujukKeluarT'])) {
//                $modRujukanKeluar->attributes = $_POST['HDPasienDirujukKeluarT'];
...
//            }
//		
//            $modRiwayatRujukanKeluar = HDPasienDirujukKeluarT::model()->with('rujukankeluar','pendaftaran')->findAllByAttributes(array('pendaftaran_id'=>$pendaftaran_id),array('order'=>'t.create_time DESC'));
//            
...
//            $modRujukanKeluar = HDPasienDirujukKeluarT::model()->findByPk($idPasienDirujuk);
