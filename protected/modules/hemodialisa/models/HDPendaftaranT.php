...
class HDPendaftaranT extends PendaftaranT
{    
	...
	public $kelaspelayanan, $status_lama;
    /**
    ...
    public function searchRiwayat($data)
    {
        ...
        /**
        * searchPasienHD menampilkan pasien rawat darurat untuk dialog box di:
         * - transaksi - pasien pulang
        * @return \CActiveDataProvider
        */
        public function searchPasienHD(){
        ...
        {
            return HDPendaftaranT::model()->findAll('statusperiksa_aktif=true ORDER BY statusperiksa');
        }
        ...
        */
        ...
        public function getPPJPItems($ruangan_id = null) {
            $criteria = new CDbCriteria();
            ...
            $modDokter = PegawaiV::model()->findAll($criteria);
            return $modDokter;
        }
