 ...
 */
class HDPendaftaran extends PendaftaranT
{    
    ...
    public function searchPasienPendaftaran()
    {
            ...
            $criteria->addCondition('ruangan.instalasi_id = '.Params::INSTALASI_ID_HD);
    ...
    public function getRuanganItems($instalasi_id=null)
    {
        if(!empty($instalasi_id)){
            ...
            return RuanganM::model()->findAll(array('order'=>'ruangan_nama','condition'=>"instalasi_id IN (".Params::INSTALASI_ID_RJ.",".Params::INSTALASI_ID_HD.") AND ruangan_aktif = TRUE"));
        }
    }
