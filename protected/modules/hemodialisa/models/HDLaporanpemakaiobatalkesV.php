...
class HDLaporanpemakaiobatalkesV extends LaporanpemakaiobatalkesV  {
        ...
        public function searchTable()
	{
		...
		$criteria=new CDbCriteria;
        $criteria->select='jenisobatalkes_nama,obatalkes_golongan,obatalkes_kategori,obatalkes_nama,satuankecil_nama,carabayar_nama,qty_oa';
		if (is_array($this->jenisobatalkes_id)){
			$criteria->addInCondition('jenisobatalkes_id',$this->jenisobatalkes_id);
		}
		else{
		...
		$criteria->compare('qty_oa',$this->qty_oa);
		$criteria->compare('hargasatuan_oa',$this->hargasatuan_oa);
		$criteria->group = 'jenisobatalkes_nama,obatalkes_golongan,obatalkes_kategori,obatalkes_nama,satuankecil_nama,carabayar_nama,qty_oa';
