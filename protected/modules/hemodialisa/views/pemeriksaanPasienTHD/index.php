<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            ...
            <span style="float:right; padding: 0px">
                <?php echo CHtml::link(Yii::t('mds', '{icon} Kembali', array('{icon}' => '<i class="entypo-back"></i>')), $this->createUrl('DaftarPasien/Index', array('modul_id' => Yii::app()->session['modul_id'])), array('class' => 'btn btn-sm btn-danger')); ?>
            </span>
        <?php } ?>
        </div>
    ...
    <div class="panel-body">
        ...
        ?>
        <div>
            <iframe id="frame" class="tes" src="" width='100%' frameborder="0" style="overflow-y:scroll; overflow-x: scroll;" ></iframe>
        </div>
