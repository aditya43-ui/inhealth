...
foreach($get as $det){
    ...
    echo $this->renderPartial('application.views.headerReport.headerLaporanTransaksiHemo',array('judulLaporan'=>$judulLaporan, 'colspan'=>10,'periode'=>'','form_no'=>$data['no_dok']));      

    echo '<h4 align="right" style="color:red">(AXEON SN. 100238)</h4>';
