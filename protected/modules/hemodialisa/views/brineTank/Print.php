...
foreach($get as $det){
    ...
    echo $this->renderPartial('application.views.headerReport.headerLaporanTransaksiHemo',array('judulLaporan'=>$judulLaporan, 'colspan'=>10,'periode'=>'<i>BRINE TANK MAINTANCE</i>','form_no'=>'Form. WTP-IHD 05'));      
