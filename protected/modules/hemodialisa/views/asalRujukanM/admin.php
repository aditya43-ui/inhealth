<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="fas fa-layer-group"></i> Master <b>Data - Asal Rujukan</b>
        </div>
    </div>
    <div class="panel-body">
        ...
        $this->widget('bootstrap.widgets.BootMenu', array(
            ...
            'items' => array(
                ...
                array('label' => 'Asal Rujukan', 'url' => $this->createUrl('/hemodialisa/asalRujukanM'), 'active' => true),
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        $('input[name="HDAsalRujukanM[asalrujukan_nama]"]').focus();
    })
</script>