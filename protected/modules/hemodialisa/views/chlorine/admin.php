...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">Pengaturan <strong>Chlorine</strong></div>
    </div>
...
<?php echo CHtml::link(Yii::t('mds', '{icon} Advanced Search', array('{icon}' => '<i class="icon-accordion icon-white"></i>')), '#', array('class' => 'search-button btn')); ?>
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">Tabel <strong>Chlorine</strong></div>
            </div>
        ...
        <?php
        echo CHtml::link(Yii::t('mds', '{icon} Tambah Chlorine', array('{icon}'=>'<i class="icon-plus icon-white"></i>')),
