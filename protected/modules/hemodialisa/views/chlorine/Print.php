...
foreach($get as $det){
    ...
    echo $this->renderPartial('application.views.headerReport.headerLaporanTransaksiHemo',array('judulLaporan'=>$judulLaporan, 'colspan'=>10,'periode'=>$data['alias'],'form_no'=>$data['no_dok']));      

    echo '<h5 align="right">Limit value &le; 0,1 mg/L</h5>';
