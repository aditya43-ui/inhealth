...
$modPendaftaran = new HDPendaftaranT('searchPasienHD');
$modPendaftaran->unsetAttributes();
if(isset($_GET['HDPendaftaranT'])) {
    $modPendaftaran->attributes = $_GET['HDPendaftaranT'];
    $modPendaftaran->noRm = $_GET['HDPendaftaranT']['noRm'];
    $modPendaftaran->namaPasien = $_GET['HDPendaftaranT']['namaPasien'];
    $modPendaftaran->tgl_pendaftaran_cari = $_GET['HDPendaftaranT']['tgl_pendaftaran_cari'];
    $modPendaftaran->namaInstalasi = $_GET['HDPendaftaranT']['namaInstalasi'];
    $modPendaftaran->namaRuangan = $_GET['HDPendaftaranT']['namaRuangan'];
    $modPendaftaran->namaCarabayar = $_GET['HDPendaftaranT']['namaCarabayar'];
}
$this->widget('ext.bootstrap.widgets.BootGridView',array(
	'id'=>'pendaftaran-t-grid',
	'dataProvider'=>$modPendaftaran->searchPasienHD(),
	...
	'columns'=>array(
                array(
                    ...
                    'value'=>'CHtml::Link("<i class=\"icon-form-check\"></i>","javascript:void(0);",array("class"=>"btn-small", 
                                    ...
                                    "onClick" => "
                                        ...
                                        $(\"#HDPendaftaranT_tgl_pendaftaran\").val(\"$data->tgl_pendaftaran\");
                                        $(\"#HDPendaftaranT_no_pendaftaran\").val(\"$data->no_pendaftaran\");
                                        $(\"#HDPendaftaranT_umur\").val(\"$data->umur\");
                                        $(\"#HDPendaftaranT_pendaftaran_id\").val(\"$data->pendaftaran_id\");
                                        $(\"#PasienpulangT_pendaftaran_id\").val(\"$data->pendaftaran_id\");
                                        $(\"#HDPendaftaranT_carabayar_id\").val(\"$data->carabayar_id\");
                                        $(\"#HDPendaftaranT_penjamin_id\").val(\"$data->penjamin_id\");
                                        $(\"#HDPendaftaranT_kelaspelayanan_id\").val(\"$data->kelaspelayanan_id\");
                                        $(\"#HDPasienM_pasien_id\").val(\"$data->pasien_id\");
                                        $(\"#PasienpulangT_pasien_id\").val(\"$data->pasien_id\");
                                        $(\"#HDPasienM_jeniskelamin\").val(\"$data->PasienJenisKelamin\");
                                        $(\"#HDPasienM_no_rekam_medik\").val(\"$data->PasienNoRm\");
                                        $(\"#HDPasienM_nama_pasien\").val(\"$data->PasienNama\");
                                        $(\"#HDPasienM_nama_bin\").val(\"$data->PasienAlias\");
           ...
           'name'=>'statusperiksa',
            'type'=>'raw',
           // 'filter'=>  CHtml::listData(HDPendaftaranT ::model()->findAll(),'statusperiksa','statusperiksa'),
//             'value'=>'statusperiksa',
                    ),
...
function isiDataPasien(data)
{
    ...
    $("#PasienpulangT_pasien_id").val(data.pasien_id);
    $("#HDPasienM_pasien_id").val(data.pasien_id);
    $("#HDPasienM_jeniskelamin").val(data.jeniskelamin);
    $("#HDPasienM_nama_pasien").val(data.namapasien);
    $("#HDPasienM_nama_bin").val(data.namabin);
