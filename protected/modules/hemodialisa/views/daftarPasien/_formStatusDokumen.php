				...
				<?php echo $form->labelEx($modUbahStatus, 'Instalasi Tujuan', array('class'=>'control-label')); ?>
				 <div class="controls">
					 <?php
				         ...
				         $criteria->addInCondition('instalasi_id', array(2,18,126,116,117,190,4,201,195,3,20,83,1));
				         $criteria->addCondition("instalasi_aktif = TRUE");
                                         $criteria->order = 'instalasi_nama ASC';
                        echo $form->dropDownList($modUbahStatus, 'instalasi_id', CHtml::listData(InstalasiM::model()->findAll($criteria), 'instalasi_id', 'instalasi_nama'), array('empty' => '-- Pilih --', 'class' => 'span2', 'onkeypress' => "return $(this).focusNextInputField(event);", 'maxlength' => 50, 'style'=>'width:200px;',
...
<?php
    ...
    $modPegawai = new HDPegawaiM('search');
