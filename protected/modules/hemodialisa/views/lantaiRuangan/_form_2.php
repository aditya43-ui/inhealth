<?php $form=$this->beginWidget('ext.bootstrap.widgets.BootActiveForm',array(
	...
	'focus'=>'#'.CHtml::activeId($model,'lookup_nama')
)); ?>
	...
	<div class="row-fluid">
            <div class = "span4">
                <?php echo $form->textFieldRow($model,'lookup_nama',array('class'=>'span3', 'onkeyup'=>"return $(this).focusNextInputField(event);", 'maxlength'=>50)); ?>
	...
	<div class="form-actions">
		...
		<?php echo CHtml::link(Yii::t('mds','{icon} Pengaturan Resep HD',array('{icon}'=>'<i class="icon-folder-open icon-white"></i>')),$this->createUrl('admin',array('modul_id'=> Yii::app()->session['modul_id'])), array('class'=>'btn btn-success')); ?>
