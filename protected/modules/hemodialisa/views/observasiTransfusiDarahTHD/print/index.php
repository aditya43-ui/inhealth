<style>     
    ...
    table.prinout td.head-padd{
        vertical-align: middle !important;
        margin:1px !important;
        padding:1px !important;        
    }
    
    table.prinout td table.prinout td.head-padd{
        font-size:7pt;
    }
</style>
<?php
...
?>
<?= $this->renderPartial('print/page/_hal_1',['model'=>$model, 'modKantong'=>$modKantong,'data'=>$data], true) ?>