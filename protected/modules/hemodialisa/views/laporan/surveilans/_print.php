...
if ($caraPrint != 'GRAFIK')
  $this->renderPartial('surveilans/_table', array('model'=>$model, 'caraPrint'=>$caraPrint));  
  $this->renderPartial('surveilans/_tableRekap', array('model'=>$model, 'caraPrint'=>$caraPrint)); 
