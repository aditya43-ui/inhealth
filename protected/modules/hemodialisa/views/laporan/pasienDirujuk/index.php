<div class="panel panel-gradient">  
    <div class="panel-heading">
	   <div class="panel-title">Laporan<b> Pasien Dirujuk</b></div>				
    </div>  
    <div class="panel-body">
    <?php
    $url = Yii::app()->createUrl('hemodialisa/laporan/FrameGrafikLaporanPasienDirujuk&id=1');
    ...
    <div class="panel panel-success"> 
         <div class="panel-heading">  
        <div class="panel-title"><h6>Tabel <b>Pasien Dirujuk</b></h6></div>
        </div> 
        <div class="panel-body">       
