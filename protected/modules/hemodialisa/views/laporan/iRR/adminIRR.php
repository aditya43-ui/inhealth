...
<div class="white-container">
    <legend class="rim2">Laporan <b>IRR</b></legend>
    <?php
    ...
    $url = Yii::app()->createUrl('hemodialisa/laporan/frameGrafikSensusHarian&id=1');
    ...
    ");
            ...
            <div class="box search-form">
                <?php $this->renderPartial('iRR/_search', array(
                    'model' => $model
                )); ?>
            </div><!--search-form-->
            <div style="overflow-y: auto;">
                <div class="block-tabel">
                    <h6>Tabel <b>IRR</b></h6>
                    <?php $this->renderPartial('iRR/_table', array('model' => $model)); ?>
                </div>
            </div>
            <?php
            ...
            $urlPrint =  Yii::app()->createAbsoluteUrl($module . '/' . $controller . '/printLaporanIRR');
