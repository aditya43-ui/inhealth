 ...
 <style>
	...
	<div class="row-fluid">
            <div class="control-group">
                ...
                <?php echo CHtml::label("Tanggal Kunjungan",'', array('class' => 'control-label')) ?>
                <div class="controls">
        ...
        <div class="row-fluid">
                            ...
                            'content' => array(
                                'content1' => array(
                                        ...
                                        'isi' => CHtml::hiddenField('filter', 'wilayah').
                                                ...
                                                <div class="control-group">
                                                        '.CHtml::label('Kecamatan','kecamatan_id', array('class' => 'control-label')).' 
                                                        <div class="controls">												 
                                                ...
                                                <div class="control-group">
                                                        '.CHtml::label('Kelurahan','kelurahan_id', array('class' => 'control-label')).' 
                                                        <div class="controls">												 
            ...
            <div class="col-sm-6">
                ...
                <br>
                <div class="control-group">
                    <?php echo CHtml::label('Status Pasien', 'Status Pasien', array('class' => 'control-label')) ?>
                    <div class="controls">  
                        <?php echo $form->dropDownList($model, 'statuspasien', array(Params::STATUSPASIEN_BARU => Params::STATUSPASIEN_BARU, Params::STATUSPASIEN_LAMA => Params::STATUSPASIEN_LAMA), array('empty' => '-- Pilih --', 'onkeypress' => "return $(this).focusNextInputField(event)",'class'=>'span3')) ?>
                    </div> 
                </div> 
                
                <?php echo $form->dropDownListRow($model,'jeniskasuspenyakit_id', CHtml::listData(HDBukuregisterpasien::model()->getJenisKasusPenyakitItems($model->ruangan_id), 'jeniskasuspenyakit_id', 'jeniskasuspenyakit_nama') ,array('empty'=>'-- Pilih --','onkeyup'=>"return $(this).focusNextInputField(event)",'class'=>'span3')); ?>
            </div>
        </div>     
