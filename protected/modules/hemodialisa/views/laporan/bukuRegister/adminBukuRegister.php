<div class="panel panel-gradient">  
    <div class="panel-heading">
	   <div class="panel-title">Laporan<b> Buku Register</b></div>				
    </div>  
    ...
    $url = Yii::app()->createUrl('hemodialisa/laporan/frameGrafikBukuRegister&id=1');
    ...
    <div class="panel panel-success"> 
        <?php $this->renderPartial('hemodialisa.views.laporan.bukuRegister/_search2',array(
    ...
    <div class="panel panel-success">  
        ...
        <div class="panel-body">
        <?php $this->renderPartial('hemodialisa.views.laporan.bukuRegister/_tableBukuRegister', array('model'=>$model)); ?>
        </div>
        <div class="panel panel-success">
        ...
        $this->renderPartial('hemodialisa.views.laporan._footer_pisah2', array('urlPrint' => $urlPrint, 'url' => $url));
        ?>
    </div>
    <div class="panel panel-success">
        <?php $this->renderPartial('hemodialisa.views.laporan._tab'); ?>
