<div class="panel panel-gradient">  
    <div class="panel-heading">
        <div class="panel-title">
            <i class="entypo-newspaper"></i> Laporan <b>Pemakai Jasa Instalasi</b>
        </div>
    </div>
    <div class="panel-body">
    <?php

    $url = Yii::app()->createUrl('hemodialisa/laporan/frameGrafikLaporanJasaInstalasi&id=1');
    ...
    ");
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="entypo-credit-card"></i> Tabel <b>Pemakai Jasa Instalasi</b>
                </div>
            </div>
