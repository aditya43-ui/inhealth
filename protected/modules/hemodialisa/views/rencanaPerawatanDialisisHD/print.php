...
<!--        <tr>
        ...
        <tr>
            <td align="center" valig="middle" colspan="3">
                 <h4>Rencana Perawatan Dialisis</h4>
            </td>
        </tr>
        <tr>
            <td align="center" valig="middle" colspan="3">
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <tr>
                            <td><?= $model->waktu_dialisis_pertama; ?></td>
                            <td><?= $model->profesi; ?></td>
                            <td><?= !empty($model->pegawai_id) ? $model->pegawai->nama_pegawai : ""; ?></td>
                            <td><?= $model->masalah_yang_ditemukan; ?></td>
                            <td><?= $model->perencanaan; ?></td>
                            <td><?= $model->instruksi; ?></td>
                        </tr>
                    </tbody>
                </table>
