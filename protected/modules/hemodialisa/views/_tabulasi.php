...
$urlAnamnesa = $this->createUrl($module.'anamnesaTHD/index',array('pendaftaran_id'=>$modPendaftaran->pendaftaran_id));
$urlFisik = $this->createUrl($module.'PemeriksaanFisikTHD/index',array('pendaftaran_id'=>$modPendaftaran->pendaftaran_id));
$urlLab =$this->createUrl($module.'laboratoriumTHD/index', array('pendaftaran_id' => $modPendaftaran->pendaftaran_id));
$urlRad = $this->createUrl($module.'radiologiTHD/index', array('pendaftaran_id' => $modPendaftaran->pendaftaran_id));
$urlRehab =  $this->createUrl($module.'rehabMedisTHD/index', array('pendaftaran_id' => $modPendaftaran->pendaftaran_id));
$urlGizi = $this->createUrl($module.'konsulGiziTHD/index', array('pendaftaran_id' => $modPendaftaran->pendaftaran_id));
$urlPoli = $this->createUrl($module.'konsulPoliTHD/index', array('pendaftaran_id' => $modPendaftaran->pendaftaran_id));
$urlTindakan = $this->createUrl($module.'tindakanTHD/index', array('pendaftaran_id' => $modPendaftaran->pendaftaran_id));
$urlDiagnosa =$this->createUrl($module.'diagnosaTHD/index', array('pendaftaran_id' => $modPendaftaran->pendaftaran_id));
$urlBedah = $this->createUrl($module.'bedahSentralTHD/index', array('pendaftaran_id' => $modPendaftaran->pendaftaran_id));
$urlRujukan =  $this->createUrl($module.'rujukanKeluarTHD/index', array('pendaftaran_id' => $modPendaftaran->pendaftaran_id));
$urlResep = $this->createUrl($module.'resepturTHD/index', array('pendaftaran_id' => $modPendaftaran->pendaftaran_id));
$urlBahan = $this->createUrl($module.'pemakaianBahanTHD/index', array('pendaftaran_id' => $modPendaftaran->pendaftaran_id));
