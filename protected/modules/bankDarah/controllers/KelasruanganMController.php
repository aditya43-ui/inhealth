...
class KelasruanganMController extends MyAuthController
{
  ...
  public $path_view = 'bankDarah.views.kelasruanganM.';
  ...
  {
    $model = new BDKelasruangan('search');
    $model->unsetAttributes();
    if (isset($_GET['BDKelasruangan']))
      $model->attributes = $_GET['BDKelasruangan'];
  ...
  protected function validasiTabular($data)
  {
    foreach ($data as $i => $row) {
      $modDetails[$i] = new BDKelasruangan;
  ...
  public function loadModel($id, $kelaspelayanan = null)
  {
    if (empty($kelaspelayanan)) {
      $model = BDKelasruangan::model()->findByAttributes(array('ruangan_id' => $id));
    } else {
      $model = BDKelasruangan::model()->findByAttributes(array('ruangan_id' => $id, 'kelaspelayanan_id' => $kelaspelayanan));
    }
    if ($model === null)
  ...
  {
    $model = new BDKelasruangan;
    if (isset($_REQUEST['BDKelasruangan'])) {
      $model->attributes = $_REQUEST['BDKelasruangan'];
    }
