<?php
class KwitansiBankDarahController extends MyAuthController
{
  /**
  ...
  public function actionPrintKwitansi($pendaftaran_id, $idPasienadmisi, $idPembayaranPelayanan)
  {
    ...
    if ($caraPrint == 'PRINT') {
      ...
      $this->render('bankDarah.views.kwitansiBankDarah.viewKwitansi', array(
      ...
      $mpdf->WriteHTML($this->renderPartial('bankDarah.views.kwitansiBankDarah.viewKwitansiPdf', array(
        'model' => $model, 'pembayarans' => $pembayarans, 'modPendaftaran' => $modPendaftaran, 'judulKwitansi' => $judulKwitansi, 'caraPrint' => $caraPrint, 'rincianpembayaran' => $rincianpembayaran,
        'modTandaBukti' => $modTandaBukti,
        'modBayar' => $modBayar
      ), true));
