...
class InformasipemakaiobatalkesruanganBDController extends InformasipemakaiobatalkesruanganVController
{
  ...
  {
    return $this->createUrl('PemakaianObatBD/rincianDetail');
  }
  ...
  {
    return $this->createUrl('PemakaianObatBD/Index');
  }
}
