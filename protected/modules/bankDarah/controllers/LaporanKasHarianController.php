...
class LaporanKasHarianController extends MyAuthController
{
  ...
  {
    $model = new BDClosingkasirT('search');
    $this->pageTitle = Yii::app()->name . ' - Laporan Laboratorium';
    $model->tgl_awal = date('Y-m-d 00:00:00');
    $model->tgl_akhir = date('Y-m-d H:i:s');
    if (isset($_GET['BDClosingkasirT'])) {
      $model->attributes = $_GET['BDClosingkasirT'];
      $format = new MyFormatter();
      $model->tgl_awal = $format->formatDateTimeForDb($_GET['BDClosingkasirT']['tgl_awal']);
      $model->tgl_akhir = $format->formatDateTimeForDb($_GET['BDClosingkasirT']['tgl_akhir']);
    }
  ...
  public function actionPrintLaporanKasHarian()
  {
    ...
    $criteria->addBetweenCondition('t.tglclosingkasir', $format->formatDateTimeForDb($_REQUEST['BDClosingkasirT']['tgl_awal']), $format->formatDateTimeForDb($_REQUEST['BDClosingkasirT']['tgl_akhir']));
    ...
    $criteria3->addBetweenCondition('t.tglclosingkasir', $format->formatDateTimeForDb($_REQUEST['BDClosingkasirT']['tgl_awal']), $format->formatDateTimeForDb($_REQUEST['BDClosingkasirT']['tgl_akhir']));
    ...
    $model      = BDClosingkasirT::model()->findAll($criteria);
    $modDetail  = BDClosingkasirT::model()->findAll($criteria3);
    ...
    //        $criteria2->addBetweenCondition('t.tglclosingkasir',$format->formatDateTimeForDb($_REQUEST['BDClosingkasirT']['tgl_awal']),$format->formatDateTimeForDb($_REQUEST['BDClosingkasirT']['tgl_akhir']));
    ...
    //        if (isset($_REQUEST['BDClosingkasirT'])) {
    //            $model->attributes = $_REQUEST['BDClosingkasirT'];
    //            $format = new MyFormatter();
    //            $model->tgl_awal = $format->formatDateTimeForDb($_REQUEST['BDClosingkasirT']['tgl_awal']);
    //            $model->tgl_akhir = $format->formatDateTimeForDb($_REQUEST['BDClosingkasirT']['tgl_akhir']);
    //        }
    //        echo " test";
    ...
    if (isset($_REQUEST['BDClosingkasirT'])) {
      ...
      $model->attributes = $_REQUEST['BDClosingkasirT'];
      $format = new MyFormatter();
      if (!empty($_REQUEST['BDClosingkasirT']['tgl_awal'])) {
        $model->tgl_awal = $format->formatDateTimeForDb($_REQUEST['BDClosingkasirT']['tgl_awal']);
      }
      if (!empty($_REQUEST['BDClosingkasirT']['tgl_awal'])) {
        $model->tgl_akhir = $format->formatDateTimeForDb($_REQUEST['BDClosingkasirT']['tgl_akhir']);
