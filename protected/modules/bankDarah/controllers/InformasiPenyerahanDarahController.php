 ...
 */
class InformasiPenyerahanDarahController extends MyAuthController
{
  public $layout = '//layouts/column1';
  public $defaultAction = 'admin';
  public $path_view = 'bankDarah.views.informasiPenyerahanDarah';
  ...
  {
    $model = new BDInfopenyerahandarah();
    $model->unsetAttributes();  // clear any default values
    $format = new MyFormatter();
    $model->tgl_awal = date("Y-m-d");
    $model->tgl_akhir = date("Y-m-d");
    if (isset($_GET['BDInfopenyerahandarah'])) {
      $model->attributes = $_GET['BDInfopenyerahandarah'];
      $model->tgl_awal = MyFormatter::formatDateTimeForDb($_GET['BDInfopenyerahandarah']['tgl_awal']);
      $model->tgl_akhir = MyFormatter::formatDateTimeForDb($_GET['BDInfopenyerahandarah']['tgl_akhir']);
      $model->no_permintaandarah = $_GET['BDInfopenyerahandarah']['no_permintaandarah'];
    }
