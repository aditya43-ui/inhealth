...
$form = $this->beginWidget('ext.bootstrap.widgets.BootActiveForm', array(
    ...
    'method' => 'get',
    'id' => 'informasibataldonor-r-search',
    'type' => 'horizontal',
        ));
...
<div class="row-fluid">
    <div class="col-sm-6">
        ...
        <div class = "control-group">
            ...
            <div class = "controls">
                <?php echo $form->textField($model, 'no_formulir', array('class' => 'custom-only span3', 'placeholder' => 'Ketik Nomor Pendaftaran')) ?>
            </div>
        </div>
        <div class = "control-group">
            <?php echo Chtml::label("No. Donor Darah", 'no_pendonor', array('class' => 'control-label')) ?>
            <div class = "controls">
                <?php echo $form->textField($model, 'no_pendonor', array('class' => 'custom-only span3', 'placeholder' => 'Ketik Nomor Pendaftaran')) ?>
            </div>
        </div>
        <div class = "control-group">
            <?php echo Chtml::label("Nama Lengkap", 'nama_lengkap', array('class' => 'control-label')) ?>
            <div class = "controls">

                <?php echo $form->textField($model,'nama_lengkap',array('class'=>'custom-only span3','placeholder'=>'Ketik Nama')) ?>
    ...
    <div class="col-sm-6">
        <div class = "control-group">
            ...
            <div class = "controls">
                <?php echo $form->dropDownList($model, 'jenis_kelamin', LookupM::getItems("jeniskelamin"), array('class' => 'span3', 'empty' => '-- Pilih --')) ?>
            </div>
        </div>
        <div class = "control-group">
