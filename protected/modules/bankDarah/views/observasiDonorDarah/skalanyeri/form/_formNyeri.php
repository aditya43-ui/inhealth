				...
				<tr>
					...
					<?php
						...
						for($i=0;$i<=10;$i++){
                                                    if ($i == 0){
                                        ?>
                                                <td onclick="" width='<?php echo ($i == 10)?'1%':'8%'; ?>'><a  class="hover"><span class="nyeri-nomor" id="nyerinomor_<?php echo $i; ?>" ><?php echo $i; ?></span></a></td>
                                        <?php
                                                    }else{
					?>
						<td onclick="pilihScala(<?php echo $i; ?>)" width='<?php echo ($i == 10)?'1%':'8%'; ?>'><a  class="hover"><span class="nyeri-nomor" id="nyerinomor_<?php echo $i; ?>" ><?php echo $i; ?></span></a></td>
					<?php
                                                    }
						}
					?>
