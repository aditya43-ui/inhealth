           ...
           <div class="col-sm-6">
			<div class="panel">
				...
				<div class="panel-body" style="width:412px !important;">
                    <?php
                    $i = 1;
                    $gbrTubuh = $modGambarTubuh->AllDataGambarObservasiNyeri;
                    $css = '';
				...
				<div class="panel-body table-responsive">
					<div class='block-tabel'>
						<table class="table border" id="table-bagtubuh">
							...
							<tbody>
                                                            <?php										
                                                                if(!empty($modPeriksaGambar)) {
                                                                        $i = 1;
                                                                        $a = 0;											
                                                                        foreach($modPeriksaGambar as $ii => $vv){
                                                                                ...
                                                                                echo $this->renderPartial($this->path_view_nyeri."form/_rowDetail",array('modPemeriksaanGbr'=>$vv, 'i' => $i, 'a'=>$a),true);
                                                                                $i++;
                                                                                $a++;
                                                                        }
                                                                }  
