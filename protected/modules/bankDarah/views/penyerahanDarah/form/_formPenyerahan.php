    ...
    <table class="table table-bordered table-condensed">
        <thead>
            <tr>
                ...
                <th>Petugas Transporter Darah</th>-->
            </tr>
        </thead>
        <tbody id="tab_penyerahan">
            ...
            foreach ($penyiapan as $row => $detail): 
                ...
                echo $this->renderPartial($this->path_view."form/_rowPenyerahanBaru", array(                    
                    'model'=>$model,
                    'item'=>$item,
                    'row'=>$row,
                    'detail'=>$detail,                    
...
<div class="col-sm-12">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <?php 
               echo CHtml::activeTextField($model, 'peg_transporter',array('class'=>'required'));
            ?>
        </div>
    </div>
</div>
