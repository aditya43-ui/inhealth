...
<div class="row">
    ...
    <div class="col-sm-6">
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $form->textField($model, 'no_masukpenunjang', array('placeholder' => 'Nomor Formulir', 'class' => 'span4', 'onkeypress' => "return $(this).focusNextInputField(event);", 'maxlength' => 50)); ?>
            </div>
        </div>
        <div class="control-group">
    ...
    <div class="col-sm-6">
        <div class="control-group">
            <?php echo $form->labelEx($model, 'Instalasi Asal', array('class' => 'control-label')) ?>
            <div class="controls">
                <?php echo $form->dropDownList($model, 'instalasiasal_id', CHtml::listData(InstalasibankdarahV::model()->findAll(), 'instalasi_id', 'instalasi_nama'), array('class' => 'span3', 'empty' => '-- Pilih --', 'onchange' => 'setRuangan(this)')) ?>
            </div>
        </div>
        <div class="control-group">
            <?php echo $form->labelEx($model, 'Ruangan Asal', array('class' => 'control-label')) ?>
            <div class="controls">
                <?php echo $form->dropDownList($model, 'ruanganasal_id', CHtml::listData(RuanganM::model()->findAll(['order' => 'ruangan_nama asc']), 'ruangan_id', 'ruangan_nama'), array('class' => 'span3 ruanganasal', 'empty' => '-- Pilih --')) ?>
            </div>
        </div>
        <div class="control-group">
