...
<div class="panel panel-gradient">
    ...
    <div class="panel-body">
        ...
        <div id="hasil_pengujian">
            ...
            <?php if (!empty($pengujianSlide)) {
                echo $this->renderPartial($this->path_view . 'form/_formSlideTest', array(
                    'permintaan' => $permintaan,
                    'pengujianSlide' => $pengujianSlide
                ), true);
                echo $this->renderPartial($this->path_view . 'form/_formKompat', array(
                    'permintaan' => $permintaan,
                    'pengujianTube' => $pengujianSlide,
                    'pengujianKompat' => $pengujianKompat,
                ), true);
            } else if (!empty($pengujianTube)) {
                //echo $this->renderPartial($this->path_view.'form/_formTubeTest', array(
                //    'permintaan'=>$permintaan,
...
<script>
    ...
    function printLabel() {
        ...
        var penyiapandarah_ke = <?php echo empty($_GET['penyiapandarah_ke']) ? "null" : $_GET['penyiapandarah_ke']; ?>;
        if (permintaan_id != null) {
            window.open('<?php echo $this->createUrl('print'); ?>&id=' + permintaan_id + "&penyiapandarah_ke=" + penyiapandarah_ke, 'printwin', 'left=100,top=100,width=800,height=500');
        }
    }
