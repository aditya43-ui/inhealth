...
$jenis_komponen = '';
$modPeket = TipepaketM::model()->findByPk($kirim->jeniskomponendarah_id);
if(!empty($modPeket)) {
    $jenis_komponen = $modPeket->tipepaket_nama;
}
...
<table style="width: 100%;" class="table table-bordered">
    <tr>
        ...
        <th style="width: 35%;">Jenis Komponen Darah</th>
