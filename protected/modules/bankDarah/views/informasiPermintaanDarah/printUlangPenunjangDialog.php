...
<?php
    echo CHtml::link(
        ...
        array(
            'class' => 'btn btn-info',
            'onclick' => "printNotaPenunjang();return false"
        )
    );
?>
...
<script>
    function printNotaPenunjang() {
        ...
        window.open('<?php echo $this->createUrl('/bankDarah/verifikasiPermintaanDarahPasien/PrintTindakan'); ?>&id=' + pendaftaran_id + '&nopelayanan=' + nopel, 'printwin', 'left=100,top=100,width=1080,height=640');
    }
</script>
...
$this->widget('ext.bootstrap.widgets.BootGridView', array(
    'id' => 'triase-m-grid',
    'dataProvider' => $modTin->searchNoPelayananPenunjang(),
    'filter' => $modTin,
    'template' => "{summary}\n{items}{pager}",
    ...
    'columns' => array(
        ...
        array(
            ...
            'value' => 'CHtml::Link("<i class=\"icon-form-check\"></i>","#",array("class"=>"btn-small", 
                                    "id" => "selectObat",
                                    "onClick" => "$(\"#nopelayanan\").val(\"$data->no_nota\"); $(\"#nopel\").val(\"$data->nopelayanan\"); $(\"#pasienmasukpenunjang_id\").val(\"$data->pasienmasukpenunjang_id\");  
