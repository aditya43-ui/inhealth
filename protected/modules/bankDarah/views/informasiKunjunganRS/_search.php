    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-sm-6">
                <div class="control-group">
                    ...
                    <div class="controls">
                        ...
                        $this->widget('MyDateTimePicker', array(
                            ...
                            'htmlOptions' => array(
                                'class' => 'span3 dtPicker3', 'onkeyup' => "return $(this).focusNextInputField(event)"
                            ),
                        )); ?>
                ...
                <?php echo $form->textFieldRow($model, 'no_rekam_medik', array('autofocus' => true, 'class' => 'span3', 'onkeyup' => "return $(this).focusNextInputField(event)", 'placeholder' => 'No. Rekam Medik')); ?>
                <?php echo $form->textFieldRow($model, 'no_pendaftaran', array('class' => 'span3', 'onkeyup' => "return $(this).focusNextInputField(event)", 'placeholder' => 'No. Pendaftaran')); ?>
            </div>
            <div class="col-sm-6">
                <?php echo $form->textFieldRow($model, 'nama_pasien', array('class' => 'span3', 'onkeyup' => "return $(this).focusNextInputField(event)", 'placeholder' => 'Nama Pasien')); ?>
