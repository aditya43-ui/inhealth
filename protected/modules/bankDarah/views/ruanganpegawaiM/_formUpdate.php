...
<table id="tabelKasuspenyakitdiagnosa" class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
        ...
        foreach ($modRuanganpegawai as $value) {
            $hapus = Yii::app()->createUrl('bankDarah/ruanganpegawaiM/Delete', array('id' => "$value->ruangan_id", 'pegawai' => "$value->pegawai_id"));
            $tr = '<tr>';
...
<div class="form-actions">
    ...
    <?php echo CHtml::link(
        Yii::t('mds', '{icon} Pengaturan Ruangan Pegawai', array('{icon}' => '<i class="icon-folder-open icon-white"></i>')),
        $this->createUrl('RuanganpegawaiM/admin', array('modul_id' => Yii::app()->session['modul_id'])),
