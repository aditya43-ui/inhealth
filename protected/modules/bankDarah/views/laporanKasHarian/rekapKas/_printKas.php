    ...
    <div>
        <table style="max-width:300px;align:center;font-size:14px;font-family:tahoma;margin-left:250px;">
            ...
            <tr>
                ...
                <td style='border-bottom:1px solid #000000; border-radius:2px;padding:2px;'><div style='border-bottom:0px solid #000000; border-radius:2px;padding: 0;text-align:right;'></div><span style="text-align:right;float:right"><?php echo number_format($piutang); ?></span></td>
            </tr>
            <tr>
            ...
            <tr>
               ...
               <td style='border-bottom:1px solid #000000; border-radius:2px;padding:2px;'><div style='border-bottom:0px solid #000000; border-radius:2px;padding: 0;float:right;text-align:right;'><span style="text-align:right;float:right"><?php echo number_format($totalpengeluaran); ?></span></td>
            </tr>
            <tr>
