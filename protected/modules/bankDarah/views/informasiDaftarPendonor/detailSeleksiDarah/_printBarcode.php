        ...
        <td>
            <div style="width:320px; height: 180px;">
                    <table style="margin-top: 20px;">
                        <tr>
                        <span style="margin-left: 27px;font-size: 18px;font-weight: bolder; position:absolute">ITD. RSUD. DR. SOETOMO</span>
                        </tr>
                        <tr>
                            <td>
        ...
        <td>
            <?php for ($i = 1; $i < 3; $i++) { ?>
                <div style="width:320px; height: 180px;">
                    <table>
                        <tr>
                        <span style="margin-left: 32px;font-size: 18px;font-weight: bolder; position:absolute">ITD. RSUD. DR. SOETOMO</span>
                        </tr>
                        <tr>
                            <td>
