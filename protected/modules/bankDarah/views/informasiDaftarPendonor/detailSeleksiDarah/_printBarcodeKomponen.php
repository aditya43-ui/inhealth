                    ...
                    foreach ($modKantongDarah as $data) {
                        ...
                        <div style="width:320px; height: 180px;">
                            <table style="margin-top: 20px;">
                                <tr>
                                <span style="margin-left: 26px;font-size: 18px;font-weight: bolder; position:absolute">ITD. RSUD. DR. SOETOMO</span>
                                </tr>
                                <tr>
                                    <td>
                    ...
                    foreach ($modKantongDarah as $data) {
                        ...
                        <div style="width:320px; height: 180px;">
                            <table style="margin-top: 5px;">
                                <tr>
                                <span style="margin-left: 26px;font-size: 18px;font-weight: bolder; position:relative">ITD. RSUD. DR. SOETOMO</span>
                                </tr>
                                <tr>
                                    <td>
                ...
                if (count($modKantongDarah) > 0) {
                    foreach ($modKantongDarah as $data) {
                        ...
                        <div class="atas" style="width:320px; height: 170px;" >
                            <table>
                                    <tr>
                                    <span style="margin-top:15px !important; margin-left: 26px;font-size: 18px;font-weight: bolder; position:relative">ITD. RSUD. DR. SOETOMO</span>
                                    </tr>
                                    <tr>
                                        <td>
