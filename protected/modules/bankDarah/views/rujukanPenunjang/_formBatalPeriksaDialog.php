...
<div class="form-actions">
    <?php 
        ...
        echo CHtml::hiddenField('pasienkirimkeunitlain_id', '');
        ...
        <?php echo CHtml::htmlButton(Yii::t('mds', '{icon} Reset', array('{icon}'=>'<i class="entypo-cancel"></i>')), array('type'=>'button','onclick'=>'$(\'#DialogBatalperiksa\').dialog(\'close\');','class'=>'btn btn-danger')); ?>
</div>
