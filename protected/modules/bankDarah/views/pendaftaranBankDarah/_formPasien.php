...
$this->beginWidget('zii.widgets.jui.CJuiDialog', array( // the dialog
    'id' => 'dialogPasien',
    'options' => array(
        'title' => 'Pencarian Data Pasien Bank Darah',
        'autoOpen' => false,
        'modal' => true,
        'width' => 960,
        'height' => 480,
...
$modDataPasien = new BDPasienM('searchDialog');
$modDataPasien->unsetAttributes();
if (isset($_GET['BDPasienM'])) {
    $modDataPasien->attributes = $_GET['BDPasienM'];
    $modDataPasien->cari_kelurahan_nama = $_GET['BDPasienM']['cari_kelurahan_nama'];
    $modDataPasien->cari_kecamatan_nama = $_GET['BDPasienM']['cari_kecamatan_nama'];
}
