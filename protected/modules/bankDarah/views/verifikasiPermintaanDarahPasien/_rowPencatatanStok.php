...
<tr>
    <td>
        <?= $ii+1 ?>
        <?php echo CHtml::hiddenField('PencatatanStok[' . $ii .'][jeniskomponendarah_id]', $modKirim->jeniskomponendarah_id) ?>
    </td>
    <td><?= $row->jeniskomponendarah->jeniskomponenedarah_nama ?? '' ?></td>
    <td>
        <?php 
            echo CHtml::numberField('PencatatanStok[' . $ii .'][jumlahkantong]', $row->jumlah_kantong, ['readonly' => 'true', 'class' => 'span1 jumlahkantong']);
    ...
    <td>
        <?php 
            echo CHtml::numberField('PencatatanStok[' . $ii .'][diambil]', $row->diambil, ['readonly' => 'true', 'class' => 'span1 diambil']);
    ...
    <td>
        <?php 
            echo CHtml::numberField('PencatatanStok[' . $ii .'][dititip]', $row->dititip, ['readonly' => 'true', 'class' => 'span1 dititip']);
    ...
    <td>
        <a onclick="ubahPencatatanStok(this, <?= $row->permintaankepenunjang_id ?>);return false;" rel="tooltip" href="javascript:void(0);" title="Klik untuk Simpan" class="simpanPencatatan hide"><i class="icon-form-check"></i></a>
