<tr>
    ...
    <td>
        ...
        <?php echo CHtml::activeHiddenField($modObatAlkesPasien,'[ii]hargajual_oa',array('readonly'=>true,'class'=>'span2 float','style'=>'width:90px;')); ?>
        <?php echo CHtml::activeTextField($modObatAlkesPasien,'[ii]hargasatuan_oa',array('readonly'=>true,'class'=>'span2 float','style'=>'width:90px;')); ?>
    </td>
    <td>
