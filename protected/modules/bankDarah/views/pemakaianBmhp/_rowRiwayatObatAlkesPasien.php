<tr>
    ...
    <td>
        <?php echo CHtml::textField('riwayatOaPasien[ii][harganetto_oa]',$modObatAlkesPasien->hargasatuan_oa,array('readonly'=>true,'class'=>'span2 integer','style'=>'width:90px;')); ?>
    </td>
    <td>
        <?php echo CHtml::textField('riwayatOaPasien[ii][qty_oa]',$modObatAlkesPasien->qty_oa,array('readonly'=>true,'class'=>'span1 float')); ?>
    </td>
    <td>
