                        ...
                        <tbody class="body-status">
                            ...
                            <tr class="tr-status">
                                ...
                                <td style="">
                                    ...
                                    $modPasienKirim = PasienkirimkeunitlainT::model()->findByAttributes(['pendaftaran_id' => $modPendaftaran->pendaftaran_id]);
                                    if(!empty($modPasienKirim)) {
                                        $rgn_login = $modPasienKirim->create_ruangan;
                                    }

                                    $ruangan = RuanganM::model()->findByPk($rgn_login);

                                    if(!empty($modPasienKirim)) {
                                        $ins_login = $ruangan->instalasi_id;
                                    }
...
<table style="width: 100%;">
    <tr>
        <td style="width: 70%;">
            <b>No. Nota :
                <?php echo $modPendaftaran->no_pendaftaran . $noPelayanan; ?></b>
        </td>
