...
<div>
    <table id="tableLaporan" width="100%" class="border" border="1px solid !important" style="text-align:center;">
        <thead>
            <tr>
                <td rowspan="2" style="text-align:center;">Tgl</td>
        ...
        <tbody>
            ...
            foreach ($modShow as $value){
                $cari = LapkunjungandonorV::model()->findAllByAttributes(array('waktu_pendaftaran' => $value->waktu_pendaftaran));
            ...
            ?>
            <tr>
                <td style="text-align: center"><?php echo date("d",strtotime($value->waktu_pendaftaran)); ?></td>
