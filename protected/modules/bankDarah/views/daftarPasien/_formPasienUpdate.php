                    ...
                    <?php $modPasien->propinsi_id = (!empty($modPasien->propinsi_id)) ? $modPasien->propinsi_id : Yii::app()->user->getState('propinsi_id'); ?>
                        ...
                        echo $form->dropDownList($modPasien, 'propinsi_id', CHtml::listData($modPasien->getPropinsiItems(), 'propinsi_id', 'propinsi_nama'), array('empty' => '-- Pilih --', 'onkeypress' => "return $(this).focusNextInputField(event)", 'class' => 'reqPasien',
                            'ajax' => array('type' => 'POST',
                                'url' => Yii::app()->createUrl('ActionDynamic/GetKabupaten', array('encode' => false, 'namaModel' => 'BDPasienM')),
                                'update' => '#LKPasienM_kabupaten_id',),
                            'onchange' => "clearKecamatan();clearKelurahan();",));
                        ?>
                            <?php
                            echo CHtml::htmlButton('<i class="icon-plus-sign icon-white"></i>', array('class' => 'btn btn-danger', 'onclick' => "{addPropinsi(); $('#dialogAddPropinsi').dialog('open');}",
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            echo $form->dropDownList($modPasien, 'kabupaten_id', CHtml::listData($modPasien->getKabupatenItems($modPasien->propinsi_id), 'kabupaten_id', 'kabupaten_nama'), array('empty' => '-- Pilih --', 'onkeypress' => "return $(this).focusNextInputField(event)", 'class' => 'reqPasien',
                                'ajax' => array('type' => 'POST',
                                    'url' => Yii::app()->createUrl('ActionDynamic/GetKecamatan', array('encode' => false, 'namaModel' => 'BDPasienM')),
                                    'update' => '#LKPasienM_kecamatan_id'),
                                'onchange' => "clearKelurahan();",));
                            ?>
                            <?php
                            echo CHtml::htmlButton('<i class="icon-plus-sign icon-white"></i>', array('class' => 'btn btn-danger', 'onclick' => "{addKabupaten(); $('#dialogAddKabupaten').dialog('open');}",
...
<?php echo $form->error($modPasien, 'kabupaten_id'); ?>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            echo $form->dropDownList($modPasien, 'kecamatan_id', CHtml::listData($modPasien->getKecamatanItems($modPasien->kabupaten_id), 'kecamatan_id', 'kecamatan_nama'), array('empty' => '-- Pilih --', 'onkeypress' => "return $(this).focusNextInputField(event)", 'class' => 'reqPasien',
                                'ajax' => array('type' => 'POST',
                                    'url' => Yii::app()->createUrl('ActionDynamic/GetKelurahan', array('encode' => false, 'namaModel' => 'BDPasienM')),
                                    'update' => '#LKPasienM_kelurahan_id')));
                            ?>
                            <?php
                            echo CHtml::htmlButton('<i class="icon-plus-sign icon-white"></i>', array('class' => 'btn btn-danger', 'onclick' => "{addKecamatan(); $('#dialogAddKecamatan').dialog('open');}",
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            ?>
                            <?php
                            echo CHtml::htmlButton('<i class="icon-plus-sign icon-white"></i>', array('class' => 'btn btn-danger', 'onclick' => "{addKelurahan(); $('#dialogAddKelurahan').dialog('open');}",
                    ...
                    <?php // echo $form->textField($modPasien,'no_mobile_pasien', array('onkeypress'=>"return $(this).focusNextInputField(event)",'placeholder'=>'No. Handphone','class'=>'span2')); ?>
<?php // echo $form->error($modPasien, 'rt'); ?>
<?php // echo $form->error($modPasien, 'rw'); ?>
                            </div>
                        </div>-->
<?php //echo $form->textFieldRow($modPasien,'tgl_meninggal'); ?>
                    ...
                    <!--<fieldset id="fieldsetDetailPasien" class="col-sm-6">
                    ...
                    <?php // echo $form->textFieldRow($modPasien,'no_telepon_pasien',array('onkeypress'=>"return $(this).focusNextInputField(event)",'placeholder'=>'No. Telepon Yang Dapat Dihubungi')); ?>
...
<?php // echo $form->dropDownListRow($modPasien,'suku_id', CHtml::listData($modPasien->getSukuItems(), 'suku_id', 'suku_nama'),array('empty'=>'-- Pilih --', 'onkeypress'=>"return $(this).focusNextInputField(event)")); ?>
                        <img id="imgFotoPasien" src="" alt="Foto pasien">
...
{
    $('input[name="BDPasienM[jeniskelamin]"]').each(function(){
...
{
    $('input[name="BDPasienM[rhesus]"]').each(function(){
