...
<table id="table-detailbarang" class="table table-striped table-bordered table-condensed">
    <thead>
        <tr>
            <th>Nomor Kantong</th>
            <th>Jenis Darah</th>
            <th colspan="8" style="text-align: center;">Pemeriksaan Goldar Metode Slide Test</th>
        ...
        <tr>
            <th></th>
            <th></th>
            <th colspan='4' style="text-align: center;">Sel Grouping <?php echo CHtml::checkBox("selGrouping",false,array('onchange'=>'setGrouping(this)')) ?></th>
            <th colspan='3' style="text-align: center;">Serum Typing <?php echo CHtml::checkBox("serumTyping",false,array('onchange'=>'setTyping(this)')) ?></th>
            <th>Kesimpulan</th>
            <th>Mayor</th>
            <th>Minor</th>
    ...
    <tbody>
         <?php 
                    if(!empty($modPermantaanDetail)) {     
                        ...
                        echo $this->renderPartial($this->path_view.'ajaxLoadAset', array( 
