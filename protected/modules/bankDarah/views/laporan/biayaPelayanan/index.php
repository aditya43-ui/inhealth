<div class="white-container">
    <legend class="rim2">Laporan Biaya <b>Pelayanan Bank Darah</b></legend>
    <?php
    ...
    $url = Yii::app()->createUrl('bankDarah/laporan/frameGrafikLaporanBiayaPelayanan&id=1');
    ...
    <div class="block-tabel"> 
        <h6>Tabel Biaya <b>Pelayanan Bank Darah</b></h6>
