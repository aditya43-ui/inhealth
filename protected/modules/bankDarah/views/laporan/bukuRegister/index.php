...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="glyphicon glyphicon-file"></i> Laporan <b>Buku Register</b>
        </div>
    </div>
    <?php
    $url = Yii::app()->createUrl('bankDarah/laporan/frameGrafikBukuRegister&id=1');
    ...
    <div class="panel-body">
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                <?php $this->renderPartial('bukuRegister/_search', array('model' => $model)); ?>
            </div>
        </div>
        <div class="panel panel-success">
            <div class="panel-heading">
        ...
        jQuery(instalasipemesan_nama).multiselect({
            ...
            onChange: function(element, checked) {
                ...
                jQuery.ajax({
                    ...
                    dataType: "json",
                    data: {
                        instalasipemesan_nama: selected
                    },
                    success: function(data) {
