    ...
    <div class="row-fluid">
        <div class="col-sm-12">
            ...
            <div class="control-group">
                ...
                <?php echo CHtml::label("Tanggal Pendaftaran Donor",'waktu_pendaftaran', array('class' => 'control-label')) ?>
                <div class="controls">
            ...
            <?php $this->Widget('ext.bootstrap.widgets.BootAccordion',array(
                        ...
                        'content'=>array(
                            'content5'=>array(
                                ...
                                'isi'=>  
                                        '<div class="control-group">
                                            '.CHtml::label('','status_pendonor', array('class' => 'control-label')).' 
                                            <div class="controls">
                                                '.$form->radioButtonListInlineRow($model,'status',array("Lolos"=>"Lolos Seleksi","Gagal"=>"Gagal Seleksi/Batal Donor"), array('onkeyup'=>"return $(this).focusNextInputField(event)")).'											
                                            </div>
                                        </div>',
                                'active'=>TRUE,
                            ),
