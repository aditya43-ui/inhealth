    ...
    <table width="100%" class="table table-bordered table-condensed" border="1px" >
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo isset($b["kelompok_44"]['det']["$o_negatif"]['25sampai44']) ? $b["kelompok_44"]['det']["$o_negatif"]['25sampai44'] :""; ?></td>
            ...
            <tr>
                ...
                <td><?php echo isset($b["kelompok_59"]['det']["$o_negatif"]['45sampai59']) ? $b["kelompok_59"]['det']["$o_negatif"]['45sampai59'] :""; ?></td>
