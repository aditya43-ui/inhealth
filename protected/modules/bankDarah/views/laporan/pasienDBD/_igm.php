...
$format = new MyFormatter();
    ...
    {   
        ...
        {
            echo ($datas['daftartindakan_id'] == 5594) ?  "<p style=\"margin: 0; text-align: center;\"><i class=icon-ok icon-black></i></p>":  "<p style=\"margin: 0; text-align: center;\"><i class=icon-minus icon-black></i></p>";
        }
    }
    else
    {
