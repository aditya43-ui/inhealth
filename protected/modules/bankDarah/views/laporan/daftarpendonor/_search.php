<div class="search-form" style="">
    ...
    <div class="row-fluid">
        <div class="col-sm-12">
            ...
            <div class="control-group">
                ...
                <?php echo CHtml::label("Periode Laporan", 'tglseleksidonor', array('class' => 'control-label')) ?>
                <div class="controls">
    ...
    <div class="form-actions">
        ...
        <?php
        echo CHtml::link(Yii::t('mds', '{icon} Ulang', array('{icon}' => '<i class="entypo-arrows-ccw"></i>')), $this->createUrl($this->id . '/laporanDaftarPendonor'), array('class' => 'btn btn-danger'));
        ?>
    </div>
</div>  
