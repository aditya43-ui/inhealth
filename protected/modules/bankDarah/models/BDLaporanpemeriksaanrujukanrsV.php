<?php
class BDLaporanpemeriksaanrujukanrsV extends LaporanpemeriksaanrujukanrsV
{
	...
	public static function model($className=__CLASS__)
	{
        ...
        protected function functionCriteria() {
            ...
            $criteria->select = 't.daftartindakan_kode, t.daftartindakan_nama,t.tarif_satuan,t.no_pendaftaran,t.tglmasukpenunjang,t.nama_pasien,t.no_rekam_medik,
            ...
            $criteria->group = 't.daftartindakan_kode, t.daftartindakan_nama, t.tarif_satuan, t.no_pendaftaran, t.tglmasukpenunjang, t.nama_pasien, t.no_rekam_medik';
			...
			$criteria->join ='RIGHT JOIN tindakansudahbayar_t ON tindakansudahbayar_t.tindakansudahbayar_id = t.tindakansudahbayar_id';
