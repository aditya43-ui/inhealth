 ...
 * @author sujana
 */
class BDLaporanpasienpenunjangV extends LaporanpasienpenunjangV {
...
//    }
    ...
    protected function functionCriteria() {
		 ...
		 */
		$criteria->join = ' 
					LEFT JOIN tindakanpelayanan_t b ON b.pendaftaran_id = t.pendaftaran_id';
		$criteria->group = 't.pendaftaran_id,t.pasien_id, t.nama_pasien, t.alamat_pasien, t.rt, t.rw, t.jeniskelamin, t.umur,
							t.tgl_pendaftaran, t.no_pendaftaran, t.no_rekam_medik,
                            t.nama_pasien,
                            t.jeniskelamin,
                            t.alamat_pasien,
                            t.kabupaten_nama,
		 ...
		 * RND-14088
		 */
		$criteria->addCondition("b.daftartindakan_id = 5594 OR b.daftartindakan_id = 5593");
		/**
		 * end RND-14088
		 */
        return $criteria;
    ...
    public function searchPasienDBD()
    {
            ...
            $this->tgl_akhir = MyFormatter::formatDateTimeForDb($this->tgl_akhir);
             $cond = array(
				...
				"b.daftartindakan_id = 5594 OR b.daftartindakan_id = 5593"
            );
            $query = "select 
                    ...
                    ". (count((array)$cond) > 0 ? " WHERE " . implode(" AND ", $cond) : "" ) ."	
                    GROUP BY 
                            pasien_m.no_rekam_medik,
                            pasien_m.nama_pasien,
                            pasien_m.jeniskelamin,
