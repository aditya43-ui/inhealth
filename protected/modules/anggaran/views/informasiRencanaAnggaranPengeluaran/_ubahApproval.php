<div class="white-container">
    ...
    <div class="form-actions">
        <?php echo CHtml::htmlButton(Yii::t('mds', '{icon} Save', array('{icon}' => '<i class="entypo-check"></i>')), array('class' => 'btn btn-danger', 'type' => 'button', 'onclick' => 'verifikasiUbahApprove();', 'onkeypress' => 'verifikasiUbahApprove();')); ?>
        <?php echo CHtml::link(
