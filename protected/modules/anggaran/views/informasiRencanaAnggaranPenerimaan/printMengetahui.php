...
<table class="table">
	...
	<tbody>
		...
		?>
		<tr>
				<td style="font-weight: normal; text-align: right;"><?php echo $i+1; echo ". "; ?></td>
				<td style="font-weight: normal;"><?php echo $modDetail->renanggaran_ke; ?></td>
				<td style="font-weight: normal; text-align: right;"><?php echo $modDetail->tglrenanggaranpen; ?></td>
				<td style="font-weight: normal;"><?php echo $format->formatNumberForPrint($modDetail->nilaipenerimaan); ?></td>
		</tr>
		<?php } ?>
			<tr style="border:1px solid;">
