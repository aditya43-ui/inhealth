...
<div class="panel panel-default" id="charts_env">
    <div class="panel-heading">
        <div class="panel-title with-tabs">
            <i class="fas fa-chart-pie"></i> Jumlah Rencana Anggaran Bulan ini
        </div>
    ...
    <div class="panel-body" style="height: 205px;">
        <div class="tab-content">
            <div class="tab-pane" id="area-chart">
                <div id="area-chart-1" class="morrischart" style="height: 200px;"></div>
            </div>
            <div class="tab-pane active" id="line-chart">
                <div id="line-chart-1" class="morrischart" style="height: 200px;"></div>
            </div>
            <div class="tab-pane" id="pie-chart">
                <div id="donut-chart-1" class="morrischart" style="height: 200px;"></div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    // Donut Chart
    var donut_chart_1 = $("#donut-chart-1"); donut_chart_1.parent().show();
