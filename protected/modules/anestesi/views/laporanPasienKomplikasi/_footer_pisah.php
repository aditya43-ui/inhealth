                    ...
                    array(
                            ...
                            'items'=>array(
                                    array(
                                            ...
                                            'url'=>"#",
                                            'itemOptions' => array(
                                                    'onclick'=>'print(\'PDF\');return false;'
                                            )
                                    ),
                                    array(
                                            'label'=>'Excel',
                                            ...
                                            'url'=>"#",
                                            'itemOptions' => array(
                                                    'onclick'=>'print(\'EXCEL\');return false;'
                                            )
                                    ),
                            )
                    ),
...
$content = $this->renderPartial('anestesi.views.tips/tips',array(),true);
...
{
	var tab = $("#ATLapanestesikomplikasiintraV_pilihan_tab").val();
	if(tab == "intra"){
	window.open("${urlPrint}Intra/"+$('#laporan-search').serialize()+"&caraPrint="+caraPrint,"",'location=_new, width=900px, scrollbars=yes');
	}else{
	window.open("${urlPrint}Pasca/"+$('#laporan-search').serialize()+"&caraPrint="+caraPrint,"",'location=_new, width=900px, scrollbars=yes');	
   }
