<div class="row-fluid">
    <div class="col-sm-6">
        <div class="control-group">
            <?php echo CHtml::label("No. Intra Anestesi <span class='required'>*</span>", 'noanestesi', array('class' => 'control-label required')); ?>
            <div class="controls">
                <?php // echo CHtml::activeHiddenField($modPascaAnestesi, 'pasienanastesi_id', array('readonly' => true, 'class' => 'span3', 'onkeyup' => "return $(this).focusNextInputField(event);")); ?>
                <?php // echo CHtml::activeHiddenField($modPascaAnestesi, 'intraanestesi_id', array('readonly' => true, 'class' => 'span3', 'onkeyup' => "return $(this).focusNextInputField(event);")); ?>
                ...
                <?php echo CHtml::activeHiddenField($modPraAnestesi, 'praanestesi_id', array('readonly' => true, 'class' => 'span3', 'onkeyup' => "return $(this).focusNextInputField(event);")); ?>
                <?php
                $this->widget('MyJuiAutoComplete', array(
                    'model' => $modKunjungan,
                    'attribute' => 'nointraanestesi',
                    'source' => 'js: function(request, response) {
						$.ajax({
							url: "' . $this->createUrl('AutocompleteKunjungan') . '",
							dataType: "json",
							data: {
								nointraanestesi: request.term,
							},
                    ...
                    'options' => array(
                        ...
                        'select' => 'js:function( event, ui ) {
							...
							setKunjungan(ui.item.intraanestesi_id,ui.item.praanestesi_id,ui.item.pasienanastesi_id);
							return false;
						}',
                    ),
                    'tombolDialog' => array('idDialog' => 'dialogKunjungan'),
                    'htmlOptions' => array('placeholder' => 'Ketik No. Intra Anestesi', 'class' => 'all-caps', 'rel' => 'tooltip', 'title' => 'Ketik No. Anestesi',
        ...
        <div class="control-group">
            <?php echo CHtml::label("Tgl. Intra Anestesi <span class='required'>*</span>", 'tglintraanestesi', array('class' => 'control-label required')); ?>
            <div class="controls">
                <?php echo CHtml::activeTextField($modKunjungan, 'tglintraanestesi', array('readonly' => true, 'class' => 'span3', 'onkeyup' => "return $(this).focusNextInputField(event);")); ?>
            </div>
        </div>
        <div class="control-group">
...
$modDialogKunjungan = new ATInformasiintraanestesiV('search');
$modDialogKunjungan->unsetAttributes();
//    $modDialogKunjungan->tgl_intra_cari = date('d M Y');
//$modDialogKunjungan->tgl_intra_cari = date('m/d/Y') . ' - ' . date('m/d/Y');
//if (isset($_GET['ATInformasiintraanestesiV'])) {
//    $modDialogKunjungan->attributes = $_GET['ATInformasiintraanestesiV'];
//    $modDialogKunjungan->tgl_intra_cari = (isset($_GET['ATInformasiintraanestesiV']['tgl_intra_cari']) ? $_GET['ATInformasiintraanestesiV']['tgl_intra_cari'] : null);
//}
        ...
        array(
            ...
            'value' => 'CHtml::Link("<i class=\"icon-form-check\"></i>","javascript:void(0);",array("class"=>"btn-small", 
					...
					"onClick" => "  
						...
						setKunjungan($data->intraanestesi_id,$data->praanestesi_id,$data->pasienanastesi_id); 
						$(\"#dialogKunjungan\").dialog(\"close\");
					"))',
        ),
        'nointraanestesi',
        array(
            'name' => 'tglintraanestesi',
            'type' => 'raw',
            'value' => 'MyFormatter::formatDateTimeForUser($data->tglintraanestesi)',
            'filter' =>false,
//            CHtml::activeTextField($modDialogKunjungan, 'tgl_intra_cari', array('class' => 'span3', 'readonly' => true)),
        /* $this->widget('MyDateTimePicker',array(
          'model'=>$modDialogKunjungan,
          'attribute'=>'tgl_intra_cari',
          'mode'=>'date',
          'options'=> array(
          'dateFormat'=>Params::DATE_FORMAT,
          'maxDate'=>'d',
          ),
          'htmlOptions'=>array('readonly'=>false, 'class'=>'dtPicker3','id'=>'tgl_intra_cari','placeholder'=>date('d M Y H:i:s')),
          ),true
          ), */
        ),
        'no_rekam_medik',
...
//			jQuery(\'#tgl_intra_cari\').datepicker(jQuery.extend({
//                        showMonthAfterYear:false}, 
//                        jQuery.datepicker.regional[\'id\'], 
//                       {\'dateFormat\':\'dd M yy\',\'maxDate\':\'d\',\'timeText\':\'Waktu\',\'hourText\':\'Jam\',\'minuteText\':\'Menit\',
//                       \'secondText\':\'Detik\',\'showSecond\':true,\'timeOnlyTitle\':\'Pilih Waktu\',\'timeFormat\':\'hh:mms\',
//                       \'changeYear\':true,\'changeMonth\':true,\'showAnim\':\'fold\',\'yearRange\':\'-80y:+20y\'})); 
//                jQuery(\'#tgl_intra_cari_date\').on(\'click\', function(){jQuery(\'#tgl_intra_cari\').datepicker(\'show\');});
                jQuery("#' . CHtml::activeId($modDialogKunjungan, 'tgl_intra_cari') . '").daterangepicker({
                    "maxDate": "' . date('m/d/Y') . '",
                    "showDropdowns": true,
                });
                }',
...
<script>
    $(document).ready(function () {
        $('input[name="ATInformasiintraanestesiV[tgl_intra_cari]"]').daterangepicker({
