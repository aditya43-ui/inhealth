<div class="panel panel-gradient">
    <div class="panel-heading">    
        <div class="panel-title">Informasi Daftar <b>Pasien Masuk Penunjang</b></div>
    </div>
    ...
    ?>
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title judul">Tabel Daftar <b>Pasien Masuk Penunjang</b></div>
            </div>
            <div class="panel-body">
...
?>
    <iframe name='frameAnestesi' width="100%" height="100%"></iframe>
<?php $this->endWidget(); ?>