...
<TABLE>
        ...
        <TABLE ALIGN="CENTER">
             <TR>
                <TD ALIGN=CENTER VALIGN=MIDDLE>
                    <B><FONT FACE="Liberation Serif" SIZE=4><U><?php echo "SURAT PERSETUJUAN TINDAKAN MEDIS"; ?></U></FONT></B>
                </TD>
            </TR>
             <TR>
                <TD ALIGN=CENTER VALIGN=MIDDLE>
    ...
    <p align="justify">
		...
		<h3><center>PERSETUJUAN</center></h3>
		<p align="justify">
			Untuk dilakukan tindakan medis berupa 
			<?php if(count($modTindakanAnestesi) > 0){ ?>
			<?php
				$style_tindakan = '';
		...
		<p align="justify">
			...
			<?php if(count($modObatAlkesAnestesi) > 0){ ?>
			<?php
				$style_obat = '';
