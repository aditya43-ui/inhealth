<div class="panel panel-gradient">
	...
	<div class="row-fluid">
		<fieldset class="box" id="form-persetujuan tindakan">
			<div class="row-fluid">
				<?php $this->renderPartial($this->path_view.'_formSuratPersetujuan',array('modKunjungan'=>$modKunjungan,'modSuratPersetujuan'=>$modSuratPersetujuan,'format'=>$format,'form'=>$form,'data'=>$data,'modPasienAnestesi'=>$modPasienAnestesi,
...
<?php $this->endWidget(); ?>
<?php
	$this->renderPartial($this->path_view.'_jsFunctions',array('modKunjungan'=>$modKunjungan,'modSuratPersetujuan'=>$modSuratPersetujuan,'format'=>$format,'form'=>$form,'data'=>$data,'modPasienAnestesi'=>$modPasienAnestesi,
						'modPraAnestesi'=>$modPraAnestesi,
						'modTindakanAnestesi'=>$modTindakanAnestesi,
						'modObatAlkesAnestesi'=>$modObatAlkesAnestesi,
						'modPendaftaran'=>$modPendaftaran,
