...
<?php $this->widget('ext.bootstrap.widgets.BootGridView',array(
    ...
    'columns'=>array(
		...
		array(
			'header'=>'Tanggal Intra Anestesi',
			'type'=>'raw',
			'value'=>'isset($data->tglintraanestesi) ? MyFormatter::formatDateTimeForUser($data->tglintraanestesi) : ""',
		),
		array(
		...
		array(
			...
			'type'=>'raw',
			'value'=>'CHtml::link("<icon class=\'icon-form-ubah\' ></icon> ", Yii::app()->createUrl("/anestesi/PascaAnestesi/index", array("pasienanastesi_id"=>$data->pasienanastesi_id)), array("rel"=>"tooltip", "title"=>"klik untuk pasca anestesi"))','htmlOptions'=>array('style'=>'text-align: center; width:40px ')                  
		),
		array(
