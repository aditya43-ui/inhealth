        ...
        array(
            ...
            'value' => 'CHtml::Link("<i class=\"icon-form-check\"></i>","javascript:void(0);",array("class"=>"btn-small", 
					...
					"onClick" => "
						...
						setTableMonitoring($data->pasienanastesi_id);
                                                setTombolTambah($data->pasienanastesi_id);
...
<?php if (!empty($_GET['pasienanastesi_id']) && !empty($_GET['pendaftaran_id'])) { ?>
            var pasienanastesi_id = <?php echo $_GET['pasienanastesi_id']; ?>;
            var pendaftaran_id = <?php echo $_GET['pendaftaran_id']; ?>;
            var pasienmasukpenunjang_id = <?php echo $modKunjungan->pasienmasukpenunjang_id; ?>;
            setKunjungan(pasienanastesi_id, pendaftaran_id, pasienmasukpenunjang_id);
            setTombolTambah(pasienanastesi_id);
            setTableMonitoring(pasienanastesi_id);
<?php } ?>
    });
</script>