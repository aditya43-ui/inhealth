    ...
    <td>
		...
		<?php echo CHtml::hiddenField('no_urut', '1', array('readonly'=>false,'class'=>'span1')) ?>
			...
			$this->widget('MyDateTimePicker', array(
				...
				'htmlOptions' => array('readonly' => true,'style'=>'width:80px;', 'onkeypress'=>"return $(this).focusNextInputField(event);",'class'=>'tglpemantauan required'),
			));?>
	</td>
	<td><?php 
...
//					'dateFormat' => Params::DATE_FORMAT,
	...
	<td><?php echo CHtml::activeTextField($modKondisiPasienAnestesi, '[0]menitke', array('readonly'=>false,'class'=>'span2 required', 'value'=>'')) ?></td>
