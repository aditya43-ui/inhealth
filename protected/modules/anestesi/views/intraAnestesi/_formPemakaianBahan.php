<div class="control-group ">
	<div class="control-group">
		<?php echo CHtml::label('Tindakan Anestesi','',array('class'=>'control-label')); ?>
		<div class="controls">
			<?php echo CHtml::dropDownList('daftartindakanPemakaianBahan', '',array(),array('empty'=>'Uraian Tindakan')) ?>
		</div>
	</div>
    <?php echo CHtml::label('Nama Obat dan Alat Kesehatan', 'obatalkes_nama', array('class'=>'control-label')); ?>
    <div class="controls">
            ...
            $this->widget('MyJuiAutoComplete', array(
				...
				'htmlOptions'=>array(
					'onkeyup'=>"return $(this).focusNextInputField(event)",
                                        'placeholder'=>'Obat dan Alat Kesehatan'
				),
