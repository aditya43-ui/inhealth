...
<div class="row-fluid">
	<div class="span4">
		<?php echo $form->dropDownListRow($model, 'statusanestesi', LookupM::getItems('statusanestesi'), array('empty' => '-- Pilih --', 'class' => 'span2', 'onkeyup' => "return $(this).focusNextInputField(event);", 'maxlength' => 50)); ?>
	</div>
</div>
