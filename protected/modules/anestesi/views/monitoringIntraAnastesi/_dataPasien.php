<div class="row-fluid">
    <div class="col-sm-6">
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo CHtml::activeHiddenField($model, 'pasienanastesi_id', array('readonly' => true, 'class' => 'span3', 'onkeyup' => "return $(this).focusNextInputField(event);")); ?>
                ...
                if (!isset($_GET['pasienanastesi_id'])){
            ...
            <div class="controls">
                ...
                if (!isset($_GET['pasienanastesi_id'])){
                    $this->widget('MyJuiAutoComplete', array(
                        ...
                        'htmlOptions' => array('placeholder' => 'Ketik No. Rekam Medik', 'class' => ' numbers-only span3 all-caps', 'rel' => 'tooltip', 'title' => 'Ketik no. rekam medik untuk mencari data kunjungan',
                            'onkeyup' => "return $(this).focusNextInputField(event)",
                        ),
                    ));
                }else{
