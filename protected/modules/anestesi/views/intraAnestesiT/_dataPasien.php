<div class="row-fluid">
    <div class="col-sm-6">
        <?php echo CHtml::activeHiddenField($modIntraAnastesi, 'intraanastesi_id', array('readonly' => true, 'class' => 'span3', 'onkeyup' => "return $(this).focusNextInputField(event);")); ?>
        <div class="control-group">
            ...
            <div class="controls">
                ...
                <?php
                if (!empty($modKunjungan->pasienanastesi_id)){
                    echo CHtml::activeTextField($modKunjungan, 'noanestesi',array('readonly'=>true, 'class'=>'span3'));
                }else{
                    $this->widget('MyJuiAutoComplete', array(
                        ...
                        'options' => array(
                            ...
                            'select' => 'js:function( event, ui ) {
                                                             ...
                                                             setKunjungan(ui.item.pasienanastesi_id,ui.item.pendaftaran_id,ui.item.pasienmasukpenunjang_id);
                                                             return false;
                                                    }',
                        ),
                        'tombolDialog' => array('idDialog' => 'dialogKunjungan'),
                        'htmlOptions' => array('placeholder' => 'Ketik No. Anestesi', 'class' => 'all-caps span3', 'rel' => 'tooltip', 'title' => 'Ketik No. Anestesi',
    ...
    <div class="col-sm-6">
        <div class="control-group">
            ...
            <div class="controls">
                <?php
                if (!empty($modKunjungan->pasienanastesi_id)){
                    echo CHtml::activeTextField($modKunjungan, 'no_rekam_medik',array('readonly'=>true, 'class'=>'span3'));
                }else{
                    $this->widget('MyJuiAutoComplete', array(
                        'model' => $modKunjungan,
                        ...
                        'htmlOptions' => array('placeholder' => 'Ketik No. Rekam Medik', 'class' => 'all-caps span3', 'rel' => 'tooltip', 'title' => 'Ketik no. rekam medik untuk mencari data kunjungan',
                            'onkeyup' => "return $(this).focusNextInputField(event)",
                        ),
                    ));
                }
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php
                if (!empty($modKunjungan->pasienanastesi_id)){
                    echo CHtml::activeTextField($modKunjungan, 'nama_pasien',array('readonly'=>true, 'class'=>'span3'));
                }else{
                    $this->widget('MyJuiAutoComplete', array(
                        'model' => $modKunjungan,
    ...
    'columns' => array(
        array(
            ...
            'value' => 'CHtml::Link("<i class=\"icon-form-check\"></i>","javascript:void(0);",array("class"=>"btn-small", 
					"id" => "selectKunjungan",
					"onClick" => "
						setKunjungan($data->pasienanastesi_id,$data->pendaftaran_id,$data->pasienmasukpenunjang_id);
