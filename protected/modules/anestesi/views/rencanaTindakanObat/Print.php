...
<fieldset>
    <table width="74%" style="margin:0px;" cellpadding="0" cellspacing="0">
        <tr>
            <td>Tgl. Anestesi</td>
            <td>:</td>
            <td><?php echo isset($modPasienAnestesi->tglanastesi) ? MyFormatter::formatDateTimeForUser($modPasienAnestesi->tglanastesi) : ""; ?></td>
        </tr>
        <tr>
            <td>No. Anestesi</td>
            <td>:</td>
            <td><?php echo isset($modPasienAnestesi->noanestesi) ? $modPasienAnestesi->noanestesi : ""; ?></td>
        </tr>
        <tr>
