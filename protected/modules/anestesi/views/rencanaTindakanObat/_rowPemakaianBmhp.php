<tr>
    <td>
        ...
        <?php echo CHtml::hiddenField("paketBmhp[0][anastesi_id]", $paketBmhp->anastesi_id,array('readonly'=>true,'class'=>'inputFormTabel lebar1')); ?>
        <?php // echo $paketBmhp->daftartindakan_nama; ?>
    </td>
	<td><?php echo isset($paketBmhp->daftartindakan_id) ? $paketBmhp->daftartindakan_nama : "-"; ?></td>
    <td>
    ...
    <td>
        ...
        <?php echo CHtml::hiddenField("paketBmhp[0][hargapemakaian]", $paketBmhp->hargapemakaian,array('readonly'=>true,'class'=>'inputFormTable span1 float')); ?>
        <?php echo CHtml::hiddenField("paketBmhp[0][hargajual]", $paketBmhp->hargajual_oa,array('readonly'=>true,'class'=>'inputFormTable span1 float')); ?>
        <?php echo CHtml::hiddenField("paketBmhp[0][harganetto]", $paketBmhp->harganetto_oa,array('readonly'=>true,'class'=>'inputFormTable span1 float')); ?>
        <?php echo CHtml::hiddenField("paketBmhp[0][hargasatuan]", $paketBmhp->hargasatuan_oa,array('readonly'=>true,'class'=>'inputFormTable span1 float')); ?>
        <?php echo CHtml::hiddenField("paketBmhp[0][qtypemakaian]", $paketBmhp->qtypemakaian,array('readonly'=>true,'class'=>'inputFormTable span1 float')); ?>
		<?php echo CHtml::hiddenField("paketBmhp[0][qty_stok]",$paketBmhp->qty_stok,array('readonly'=>true,'class'=>'span1 float', 'onkeyup'=>"return $(this).focusNextInputField(event)",)); ?>
        ...
        ?>
        <?php echo CHtml::hiddenField("paketBmhp[0][subtotal]",$totalsub,array('readonly'=>true,'class'=>'inputFormTabel lebar3 float subtotal')); ?>
    </td>
    <td>
