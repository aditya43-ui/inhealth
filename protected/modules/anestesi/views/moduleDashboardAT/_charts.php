...
<div class="panel panel-default" id="charts_env">
    <div class="panel-heading">
        <div class="panel-title with-tabs">
            <i class="entypo-users"></i> Jumlah Pasien Anestesi Bulan ini
        </div>
        ...
        <thead>
            <tr>
                <th width="50%" class="col-padding-1">
                    <div class="pull-left">
                        <div class="h4 no-margin">Jumlah Pasien Intra Anestesia</div>
                ...
                <th width="50%" class="col-padding-1">
                    <div class="pull-left">
                        <div class="h4 no-margin">Jumlah Pasien Intra Anestesia Dengan Keadaan Darurat</div>
    ...
    $(document).ready(function($) {
        ...
        Morris.Area({
            ...
            data: [
                ...
                ?> {
                            x: "<?php echo date("d", strtotime($chart['tglanastesi'])); ?>",
                            y: <?php echo isset($chart['jumlah_1']) ? $chart['jumlah'] : 0; ?>
                        },
                <?php
                    }
                }
        ...
        var donut_chart = Morris.Donut({
            ...
            data: [
                ...
                ?> {
                            label: "<?php echo $chart['penjamin_nama']; ?>",
