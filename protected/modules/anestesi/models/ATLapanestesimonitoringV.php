...
class ATLapanestesimonitoringV extends LapanestesimonitoringV
{
	...
	public function criteriaSearch()
	{
		...
		if(isset($_GET['ATLapanestesimonitoringV'])){
			$tgl_awal = $format->formatDateTimeForDb($_GET['ATLapanestesimonitoringV']['tgl_awal']);
			$tgl_akhir = $format->formatDateTimeForDb($_GET['ATLapanestesimonitoringV']['tgl_akhir']);
		...
		$criteria->compare('LOWER(monitoring)',strtolower($this->monitoring),true);
