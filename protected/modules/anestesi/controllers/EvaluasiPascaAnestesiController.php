...
/**
 * Digunakan untuk menampilkan halaman pasca anestesi 
 * @author  Yusuf Putra Anugrah <yusufputra@.com>
 * @package application.modules.anestesi
 * @subpackage controllers
 * @category controller
 */
class EvaluasiPascaAnestesiController extends MyAuthController {
    ...
    public $path_view = 'anestesi.views.evaluasiPascaAnestesi.';
    ...
    public function actionIndex($pendaftaran_id = null, $pasienkirimkeunitlain_id = null, $pasienanastesi_id = null, $frame = null) {
        ...
        if (!empty($pasienanastesi_id)) {
            ...
            $modPasca = PascaanestesiT::model()->findByAttributes(array('pasienanastesi_id' => $pasienanastesi_id));
        }

        $this->render($this->path_view . 'index', array(
            'modKunjungan' => $modKunjungan,
            'modEvaluasi' => $modPasca,
        ));
    }
