...
class InformasiPraAnestesiController extends MyAuthController
{
	/**
	...
	public $path_view='anestesi.views.informasiPraAnestesi.';
	public $path_tips='anestesi.views.tips.';


	public function actionIndex()
	{
		$model = new ATInformasipraanestesiV('searchInformasiPasien');
		$model->unsetAttributes();
		$model->tgl_awal = date('d M Y H:i:s');
		$model->tgl_akhir = date('d M Y H:i:s');
		
		if(isset($_GET['ATInformasipraanestesiV'])){
			$model->attributes = $_GET['ATInformasipraanestesiV'];
			$format = new MyFormatter();
			$model->tgl_awal  = $format->formatDateTimeForDb($_GET['ATInformasipraanestesiV']['tgl_awal']);
			$model->tgl_akhir = $format->formatDateTimeForDb($_GET['ATInformasipraanestesiV']['tgl_akhir']);
		}
