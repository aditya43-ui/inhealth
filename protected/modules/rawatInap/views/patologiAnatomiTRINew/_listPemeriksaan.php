<?php
/**
 * mengenerate daftar pemeriksaan patologi anatomi
 * 
                    ...
                    <div class="panel panel-success panel-shadow">
                            ...
                            <div class="panel-body">
                                    <?php   foreach ($jns['det'] as $j => $pr) {                                                                                                                            
                                                ...
                                                echo "<span>".$pr['pemeriksaanlab_nama']. " - " . $pr['pemeriksaanlab_kode'] ."</span></label><br/>";                                                                                                                            
                                    } ?>
                            </div>
                    </div>
...
?>
    <div class="col-sm-4">
            <div class="boxtindakan">
                    <div class="panel panel-success panel-shadow">
                            <div class="panel-heading">
                                    <div class="panel-title"><h6>Jenis Pemeriksaan Tidak Ditemukan</h6></div>
                            </div>
                            <div class="panel-body">
                                   <p>Nama Operasi tersebut tidak ada</p>
                            </div>
                    </div>
