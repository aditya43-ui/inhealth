...
<table width="40%" style="margin: 0;" cellpadding="1" cellspacing="0">
    <tr>
...
?>
    <script type='text/javascript'>
        ...
        function print(caraPrint) {
            var pasienpulang_id = '<?php echo isset($modelPulang->pasienpulang_id) ? $modelPulang->pasienpulang_id : $_GET['pasienpulang_id'] ?>';
