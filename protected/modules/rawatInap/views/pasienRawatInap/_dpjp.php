<div class="col-sm-6">
    <div class="control-group required">
        <?php echo $form->labelEx($modelPulang, 'dokterpenerima_id', array('class'=>'control-label required', 
            'label'=>'Dokter Pengirim <span class="required">*</span>')); ?>
        <div class="controls">
            <?php 
    ...
    <div class="control-group required">
        <?php echo $form->labelEx($modelPulang, 'dpjp1_id', array('class'=>'control-label required', 
            'label'=>'Dokter DPJP 1 <span class="required">*</span>')); ?>
        <div class="controls">
            <?php 
...
<?php
	...
	$this->widget('ext.bootstrap.widgets.BootGridView',array(
		...
		'dataProvider'=>$modDokUmum->searchDokterUmum(),
		'filter'=>$modDokUmum,
			'template'=>"{summary}\n{items}\n{pager}",
			'itemsCssClass'=>'table table-striped table-bordered table-condensed',
		'columns'=>array(
