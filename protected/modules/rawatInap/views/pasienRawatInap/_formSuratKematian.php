<div class="col-sm-6">
    ...
    <?php echo $form->textAreaRow($modKematian, 'penyebabkematian', array('placeholder' => 'Penyebab Kematian', 'class' => 'span3', 'onkeypress' => "return $(this).focusNextInputField(event);")); ?>
</div>
<div class="col-sm-6">
