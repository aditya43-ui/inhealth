...
<script type="text/javascript">
            ...
            success: function(data) {
                ...
                if(data.sukses == 1) {
                    if(data.obatalkes.sukses == 1) {
                        ...
                        $("#form-nonracikan #hargastuan_reseptur").val(harga_jual);
    ...
    function tambahObatRacik(obj) {
        ...
        var sumberdana_id = $('#form-racikan').find('#sumberdana_id').val();
    ...
    function addDataKeGridObat(obj, tipe, rke) {
        if (tipe == 'racik') {
            ...
            var etiket = setEtiket(val_frekuensi, satuansediaan, val_etiketwaktu, "");
    ...
    function setOaByRuangTujuan(obj) {
        var ruangan_id = $(obj).find("option:selected").val();

        $("#form-nonracikan").addClass("animation-loading");
        $("#form-racikan").addClass("animation-loading");
        $.fn.yiiGridView.update('obatnonracikan-api-grid', {
            data: {
                "ObatAPI[ruangan_id]": ruangan_id
            }
        });
        $.fn.yiiGridView.update('obatracikan-api-grid', {
            data: {
                "ObatAPI[ruangan_id]": ruangan_id
            }
        });
