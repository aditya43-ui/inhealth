...
<?php }else{ ?>
	<div class="form-actions">
        ...
        if(!empty($modPenjualan->pasienadmisi_id) && !empty($modPenjualan->reseptur_id)) {
            echo CHtml::htmlButton(Yii::t('mds','{icon} Etiket Rawat Inap',array('{icon}'=>'<i class="icon-print icon-white"></i>')),array(
                'class'=>'btn btn-info', 
                'type'=>'button',
                'onclick' => 'printetiketRanapNew(' . $modPenjualan->penjualanresep_id . ', false); return false;'
            ));
        }
        ?>
	</div>
