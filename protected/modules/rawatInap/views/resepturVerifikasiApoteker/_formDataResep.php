...
<div class="col-sm-12">
	...
	<div class="control-group">
		<?php echo CHtml::label('Apoteker <span class="required">*</span>','apoteker', array('class'=>'control-label')) ?>
		<div class="controls">
			<?php echo $form->dropDownList($modReseptur,'pegawai_id',CHtml::listData($modReseptur->getDokterItems(), 'pegawai_id', 'NamaLengkap'),array('class' => 'span3','onkeypress'=>"return $(this).focusNextInputField(event)", 'disabled' => true));?>
		</div>
	</div>
