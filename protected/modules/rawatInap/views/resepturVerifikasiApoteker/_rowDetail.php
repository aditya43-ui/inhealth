...
?>
	...
	<tr>
		...
		<td>
			<?php echo $modResepturDetail->sumberdana_nama ?? '' ?>
		</td>
		<td hidden>
...
<?php } else { ?>
	<tr>
		...
		<td>
			<?php
			echo CHtml::activeHiddenField($modResepturDetail, '[ii]qty_reseptur', array('class' => 'qty ' . ((empty($isRacikan) || $isRacikan == 0) ? "number-char" : ""), 'readonly' => false, 'style' => 'width:50px; text-align: right;', 'onblur' => 'hitungTotal()')); //,'onblur'=>'hitungSubTotal(this)'
