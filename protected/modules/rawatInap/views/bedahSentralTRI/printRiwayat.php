...
<table width="100%" <?php echo $style; ?> >
    ...
    <tr>
        ...
        <td width="60%"><?php echo CHtml::encode(isset($modAdmisi->kelaspelayanan_id)? $modAdmisi->kelaspelayanan->kelaspelayanan_nama :$modPendaftaran->kelaspelayanan->kelaspelayanan_nama); ?></td>
    </tr>
    <!-- <tr>
        ...
        <td>
            ...
            foreach($modPermintaan as $j => $permintaan){
                ...
                if($modKirim->is_cyto == 1){
                    ...
                    echo !empty($modTarif->harga_tariftindakan) ? MyFormatter::formatNumberForPrint($modTarif->harga_tariftindakan) : 0 .'<br>';
                }
