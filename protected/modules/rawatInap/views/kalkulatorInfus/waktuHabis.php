...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="fas fa-calculator"></i> Kalkulator Infus Berdasarkan Waktu Habis
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-sm-6">
                <table>
                    ...
                    <tr>
                        <td>Jumlah Tetes / Menit</td>
                        <td>
                            <input name="tetes" id="tetes" value="0" maxlength="5" type="text" class="span2 integer">
                            dpm
                        </td>
                    </tr>
                    <tr>
...
<script type="text/javascript">
    function hitungCairanInfus() {
        ...
        var tetes = parseInt($('#tetes').val());
        var faktor = $('#faktor').val();
        var jumlah = 0;
        if (faktor == 'Otsuka') {
            jumlah = Math.round((cairan / tetes) / 4);
        } else if (faktor == 'Terumo') {
            jumlah = Math.round((cairan / tetes) / 3);
        } else {
            jumlah = Math.round(cairan / tetes);
        }
        $('.hasilPerhitungan').html('Infus akan habis dalam <b>' + jumlah + '</b> jam');
        formatNumberSemua();
    }
