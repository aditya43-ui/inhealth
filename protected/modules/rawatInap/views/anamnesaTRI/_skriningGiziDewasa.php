...
<div class="panel panel-default panel_skrining" id="skrining_gizi_dewasa" hidden>
    ...
    <div class="panel-body table-responsive">
        <table width="100%" class="tab_skrining">
            ...
            <tfoot>
                ...
                <tr>
                    <td></td>
                    <td colspan="3">HASIL : <?php echo $form->textField($modAnamnesa, 'skrining_dewasa_hasil', array('readonly'=>true, 'class'=>'hasil-skrining span4',
                        'data-kurang'=>'Skrining diulang 1 bulan kemudian', 'data-lebih'=>'Rujuk/Konsul Ahli Gizi')); ?></td>
                </tr>
    ...
    <div class="panel-body table-responsive">
        <table width="100%" class="tab_skrining">
            ...
            <tfoot>
                ...
                <tr>
                    <td></td>
                    <td colspan="3">HASIL : <?php echo $form->textField($modAnamnesa, 'skrining_anak_hasil', array('readonly'=>true, 'class'=>'hasil-skrining span4',
                        'data-kurang'=>'Tidak beresiko malnutrisi', 'data-lebih'=>'Beresiko malnutrisi -> Rujuk/Konsul Ahli Gizi')); ?></td>
                </tr>
