...
<div class="panel panel-success">
    ...
    <div class="panel-body">
        ...
        <div class="row" <?= $formHide ?>>
            ...
            ?>
             <?php //echo $form->dropDownListRow($modAnamnesa, 'paramedis_nama', CHtml::listData(ParamedisV::model()->findAll("ruangan_id = ".Yii::app()->user->getState('ruangan_id')), 'nama_pegawai', 'NamaLengkap'), array('class' => 'span3', 'onkeypress' => "return $(this).focusNextInputField(event);", 'maxlength' => 100)); 
                ...
                ?>
                <?php $form->dropDownListRow($modAnamnesa, 'paramedis_nama', CHtml::listData($modAnamnesa->getParamedisItems(), 'pegawai.NamaLengkap', 'pegawai.NamaLengkap'), array('empty' => '-- Pilih --', 'class' => 'span3', 'onkeypress' => "return $(this).focusNextInputField(event);", 'maxlength' => 100)); ?>
        ...
        <div class="form-actions" <?= isset($_GET['lihat']) ? 'hidden' : ''?> <?= $formHide ?>>
            <?php
