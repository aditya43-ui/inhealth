...
<div class="row-fluid">
    <div class="col-sm-12">
        ...
        <div class="control-group">	
            <div style="width: 100%">
                <?php $this->widget('ext.redactorjs.Redactor',array('model'=>$model, 'attribute'=>'verifikasipdjp_hasilreview', 'toolbar'=>'mini','height'=>'100px')) ?>
            </div>
        </div>
    </div>
</div>
...
<div class="row-fluid">
   <div class="form-actions">
        <?php
            echo CHtml::htmlButton(Yii::t('mds','{icon} Verifikasi Edukasi',array('{icon}'=>'<i class="icon-ok icon-white"></i>')), array('class'=>'btn btn-primary', 'type'=>'button', 'onKeypress'=>'return formSubmit(this,event)','onclick'=>'simpanVerifikasi()'));
        ?>
    </div>
</div>
<?php $this->endWidget(); ?>
