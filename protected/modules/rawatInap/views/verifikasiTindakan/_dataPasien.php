...
<div class="col-sm-6">
	...
	<div class="control-group">
		...
		<div class="controls">
			...
			<?php echo CHtml::activeTextField($modInfoPasien, 'kamarruangan_nokamar', array('readonly'=>true,'class'=>'span2')); ?> /
			<?php echo CHtml::activeTextField($modInfoPasien, 'kamarruangan_nobed', array('readonly'=>true,'class'=>'span1')); ?>
			<?php }else{ ?>
			<?php echo CHtml::TextField('kamarruangan_nokamar', '', array('readonly'=>true,'class'=>'span2')); ?> /
