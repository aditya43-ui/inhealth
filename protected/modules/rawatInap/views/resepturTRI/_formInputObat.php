    ...
    <div class="panel panel-success">
        <div class="panel-heading">
            <div class="panel-title">
                <i class="far fa-file-alt"></i> Data <b>Resep</b>
            </div>
        </div>
        ...
        <div class="panel-heading">
            <div class="panel-title">
                <div id="judul_racikan" hidden>
                    <i class="far fa-file-alt"></i> Data <b>Obat (Racikan)</b>
                </div>
                <div id="judul_non_racikan">
                    <i class="far fa-file-alt"></i> Data <b>Obat (Non Racikan)</b> <?php echo CHtml::htmlButton('<i class="entypo-arrows-ccw"></i>', array('class' => 'btn btn-default btn-mini', 'onclick' => 'terapiobat_reset();', 'onkeyup' => "return $(this).focusNextInputField(event)", 'rel' => 'tooltip', 'title' => 'Klik untuk me-refresh form obat non racik')); ?>
                </div>
            </div>
        </div>
                ...
                <div class="controls">
                    <div class="input-append" style='display:inline'>
                        ...
                        $this->widget('MyJuiAutoComplete', array(
                            ...
                            'htmlOptions' => array('placeholder' => 'Kelas Therapi', 'class' => 'col-sm-8'),
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    $this->widget('MyJuiAutoComplete', array(
                        ...
                        'htmlOptions' => array('placeholder' => 'Nama Obat', "rel" => "tooltip", "title" => "Pencarian Data Obat/Alkes", 'onkeypress' => "return $(this).focusNextInputField(event)", 'class' => 'col-sm-8'),
                    ));
                    ?>
                </div>
            </div>
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    $this->widget('MyJuiAutoComplete', array(
                        ...
                        'htmlOptions' => array(
                            'placeholder' => 'Signa', 'class' => 'inputFormTabel span2', 'onkeypress' => "return $(this).focusNextInputField(event)", 'id' => 'signa'
                        ),
                    ));
                    ?>
