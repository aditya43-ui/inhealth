			...
			<table width='100%'>
				...
				<tr>
					...
					<?php
						...
						for($i=0;$i<=10;$i++){
					?>
						<td onclick="pilihScala(<?php echo $i; ?>)" width='<?php echo ($i == 10)?'1%':'8%'; ?>'><a style="position:relative; left:-5px;" onclick="pilihScala(<?php echo $i; ?>)" class="hover"><span style="padding: 4px;" class="nyeri-nomor" id="nyerinomor_<?php echo $i; ?>"><?php echo $i; ?></span></a></td>
					<?php
						}
					?>
				</tr>				
        ...
        <tr>
            <td colspan="12">
                <div class="control-group">
                        ...
                        <div class="controls">                                    
                            <?php echo $form->textField($model,'skalanyeri',array('class'=>'span1 skalanyeri','readonly'=>true,'style'=>'text-align:right;')) ?>
                        </div>
                        <div class="controls">                                    
                            <?php echo $form->textField($model,'skalanyeri_ket',array('class'=>'span3 skalanyeri_ket','readonly'=>true,'style'=>'text-align:left;')) ?>
                        </div>
                    </div>
            </td>
        </tr>
