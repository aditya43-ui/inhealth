...
<div class="clear">
    <?php echo CHtml::htmlButton(Yii::t('mds','{icon} Ok',array('{icon}'=>'<i class="entypo-check"></i>')),
                            array('class' => 'btn btn-danger', 'onKeypress'=>'return formSubmit(this,event)',
                                  'onclick'=>'$("#dokterpemeriksa1_id").val() !== "" ? $("#dialogPemeriksaLengkap").dialog("close") : myAlert("Dokter 1 belum diisi");'
								  )); ?>
</div>
<?php
...
function pilihDokter(id) {
    ...
    $.post(url, {
        ...
        switch(idPilihDokter) {
            ...
            case 6: setDokter6sampai10(res, 'dokter6',idPilihDokter ); $("#dokter6").val(res.label); break;
            case 7: setDokter6sampai10(res, 'dokter7',idPilihDokter ); $("#dokter7").val(res.label); break;
            case 8: setDokter6sampai10(res, 'dokter8',idPilihDokter ); $("#dokter8").val(res.label); break;
            case 9: setDokter6sampai10(res, 'dokter9',idPilihDokter ); $("#dokter9").val(res.label); break;
            case 10: setDokter6sampai10(res, 'dokter10',idPilihDokter ); $("#dokter10").val(res.label); break;
        }
