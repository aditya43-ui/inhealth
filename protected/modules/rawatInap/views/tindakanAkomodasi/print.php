                    ...
                    <table class="status" width="100%">
                        <tbody class="body-status">
                            ...
                            <tr class="tr-status">
                                ...
                                <td style="">:</td>
                                <td style="">
                                    <?php $tempatlayanan = RuanganM::model()->findByPk(Yii::app()->user->getState('ruangan_id')); // $modPendaftaran->pasienadmisi->ruangan_id)?>
                                ...
                                <td> <?php 
                                    ...
                                    if(Yii::app()->user->getState('modul_id') == Params::MODUL_ID_RJ || Yii::app()->user->getState('modul_id') == Params::MODUL_ID_RD || Yii::app()->user->getState('modul_id') == Params::MODUL_ID_GIZI) {
                                        echo '-';
                                    } else {
                                        echo $modPendaftaran->pasienadmisi->kelaspelayanan->kelaspelayanan_nama ?? $modPendaftaran->kelaspelayanan->kelaspelayanan_nama ?? "-";
                                    }
                                ?> </td>
                            </tr>
                            <tr class="tr-status">
