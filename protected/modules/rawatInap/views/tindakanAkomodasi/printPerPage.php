...
$crit2->addCondition(' pendaftaran_id = ' . $modPendaftaran->pendaftaran_id . ' and masukkamar_id is not null and verifbataltindakan_id is null ');
...
if(!empty($notatindakan_last)) {
  ...
  $condition = ' pendaftaran_id = ' . $modPendaftaran->pendaftaran_id . ' and masukkamar_id is not null and nopelayanan = \'' . $notatindakan_last->nopelayanan . '\'  and verifbataltindakan_id is null ';

  if(isset($_GET['is_all'])) {
    $condition = ' pendaftaran_id = ' . $modPendaftaran->pendaftaran_id . ' and masukkamar_id is not null and verifbataltindakan_id is null ';
  }
