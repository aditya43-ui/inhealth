...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title" style="width: 100%">
            <b>Lihat Riwayat Ringkasan Pasien Pulang</b>
        </div>
    </div>
    <div class="panel-body">
        <table class="prinout w100 no-grid">
            <tr>
                <td>
                    <h3 align="left" style="color: Black; font-weight: bold;">Ringkasan PASIEN PULANG (RESUME)</h3>
                </td>
                <td align="right">
        ...
        <table class="prinout w100 grid">
            ...
            <tr>
                ...
                <td>
                    <b>Ruang rawat terakhir:</b> <?= $modAdmisi->ruangan->ruangan_nama ?>
                </td>
            </tr>
            <tr>
                <td>
