    ...
    <div class="panel">
        ...
        <div class="panel-body" style="width:412px !important;">
            <div class="control-group">
                <label class="control-label">Status Lokalis</label>
                <div class="controls">
                    <?php echo CHtml::radioButton('status_lokalis', '', array('value' => 1, 'unCheckValue' => null, 'onclick' => 'cekLokalis()', 'checked' => true)); ?> <label>Normal</label> 
                    <?php echo CHtml::radioButton('status_lokalis', '', array('value' => 0, 'unCheckValue' => null, 'onclick' => 'cekLokalis()')); ?> <label>Tidak Normal</label>
                </div>
            </div>
            <div id="gambar-container">
            <?php
            $i = 1;
            $gbrTubuh = $modGambarTubuh->AllDataGambarAsesmenAwalMedis;
            $css = '';
            foreach ($gbrTubuh as $tbh) {
                ...
                if ($i == 1) {
                    ...
                    <div align="center"  id="imgtag<?php echo $tbh->gambartubuh_id ?>">
                        ...
                        <img img-no="<?php echo $tbh->gambartubuh_id ?>" alt="<?php echo $tbh->gambartubuh_id ?>" id="myImgId<?php echo $tbh->gambartubuh_id ?>" src="<?php echo Params::urlPhotoAnatomiTubuh() . $tbh->nama_file_gbr; ?>" class="taggd<?php echo $tbh->gambartubuh_id ?>" style="width:412px;"/> 
                    ...
                    <div align="center"  id="imgtag<?php echo $tbh->gambartubuh_id ?>">
                        ...
                        <img img-no="<?php echo $tbh->gambartubuh_id ?>" alt="<?php echo $tbh->gambartubuh_id ?>" id="myImgId<?php echo $i ?>" src="<?php echo Params::urlPhotoAnatomiTubuh() . $tbh->nama_file_gbr; ?>" class="taggd<?php echo $tbh->gambartubuh_id ?>"  style="width:412px;"/> 
                        <div id="tagbox<?php echo $tbh->gambartubuh_id ?>"></div>
                    </div>
                    <?php
                }
