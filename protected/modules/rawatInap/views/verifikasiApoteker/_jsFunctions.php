...
<script type='text/javascript'>
    ...
    const cekSimpanTabulasi = (frameObj, tabObj, dari = 'tab') => {   
        ...
        const tabw = ['Diagnosis Awal (A)', 'Anamnesis Keperawatan (S)', 'Anamnesis Medis', 'Periksa Fisik Awal (O)', 'Laboratorium (P)', 'Radiologi (P)', 'Patologi Anatomi (P)'];

        if(kunjungan = 'KUNJUNGAN LAMA') {
            const tabw = ['Diagnosis Awal (A)', 'Periksa Fisik Awal (O)', 'Laboratorium (P)', 'Radiologi (P)', 'Patologi Anatomi (P)'];
        }
        const tab_lengkap = ['Laboratorium (P)', 'Konsultasi Dokter Lain'];
