...
<!--div class="white-container"-->
        ...
        <div class="row-fluid">
            <div class="col-sm-12">
                <div class="form-wizard form-required-wizard no-margin" id="rootwizardResikoJatuhdewasa">
                ...
                <ul>
                    <li class="active">
                            <a href="#wizard_tabneonatus1" data-toggle="tab"><span>1</span>Pengkajin Skor Resiko Jatuh</a>
                    </li>
                    <li>
                            <a href="#wizard_tabneonatus2" data-toggle="tab"><span>2</span>Intervensi Pencegahan Jatuh</a>
                    </li>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="wizard_tabneonatus1">    
		                    <?php $this->renderPartial($this->path_view_dewasa.'_resiko_jatuh',array('form'=>$form,'model'=>$model,'modHasil'=>$modHasil)) ?>
                    </div>
                   <div class="tab-pane" id="wizard_tabneonatus2">
                   <div class="panel_cegah">
                      <div class="formCegah">
                      <?php $this->renderPartial($this->path_view_dewasa.'_pencegahanJatuhDewasa',array('form'=>$form,'model'=>$model,'modHasil'=>$modHasil, 'modIntervensi'=>$modIntervensi,'modDetail'=>$modDetail)) ?>
                      </div>
                      </div>
                    </div>
...
<?php $this->endWidget(); ?>
<?php $this->renderPartial($this->path_view_dewasa.'_jsFunctionsDewasa',array('model'=>$model,'modHasil'=>$modHasil,'modIntervensi'=>$modIntervensi)); ?>
