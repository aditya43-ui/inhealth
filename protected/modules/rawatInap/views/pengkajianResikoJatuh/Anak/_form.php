...
<!--div class="white-container"-->
        ...
        <div class="row-fluid">
            <div class="col-sm-12">
                <div class="form-wizard form-required-wizard no-margin" id="rootwizardResikoJatuhAnak">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="wizard_tabneonatus1">    
		                    <?php $this->renderPartial($this->path_view_anak.'_resiko_jatuh',array('form'=>$form,'model'=>$model,'modHasil'=>$modHasil)) ?>
                    </div>
                   <div class="tab-pane" id="wizard_tabneonatus2">
                      <div class="panel_cegah">
                        <div class="formanak formCegah">
                        <?php $this->renderPartial($this->path_view_anak.'_pencegahanJatuhAnak',array('form'=>$form,'model'=>$model,'modHasil'=>$modHasil, 'modIntervensi'=>$modIntervensi,'modDetail'=>$modDetail)) ?>
                        </div>
                        </div>    
                    </div>
...
<?php $this->endWidget(); ?>
<?php $this->renderPartial($this->path_view_anak.'_jsFunctionsAnak',array('model'=>$model,'modHasil'=>$modHasil)); ?>
