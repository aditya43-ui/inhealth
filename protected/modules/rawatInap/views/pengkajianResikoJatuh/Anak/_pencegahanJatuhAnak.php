<div class="panel panel-success">
    ...
    <div class="panel-body">
        ...
        <div class="col-sm-12">
            ...
            <?php echo CHtml::activeHiddenField($modIntervensi,'kelompok_pasien',array('class'=>'', 'value'=>'anak')) ?>
            ...
            <div class="col-md-4">
                <div class="control-group ">
                    ...
                    <div class="controls">
                        <?php
                            ...
                            'htmlOptions'=>array('readonly'=>true,'class'=>'span2 cekreq'),
                        )); ?>
                    </div>
                </div>
                <div class="control-group ">
                ...
                <div class="control-group ">
                    ...
                    <div class="controls">
                        <?php echo $form->dropDownList($modIntervensi, 'petugas_id', CHtml::listData(PegawairuanganV::model()->findAllByAttributes(array('ruangan_id'=>Yii::app()->user->getState("ruangan_id")),array('order'=>'nama_pegawai')), 'pegawai_id', 'namaLengkap'), array('empty' => '-- Pilih --', 'class' => 'span2 cekreq','style'=>'width:140px;')); ?>
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <div class="control-group ">
                    ...
                    <div class="controls">
                        <?php echo CHtml::activeRadioButtonList($modIntervensi,'resikojatuh_tingkat',array('Resiko Rendah'=>'Resiko Rendah','Resiko Tinggi'=>'Resiko Tinggi') , array('onkeyup'=>"return $(this).focusNextInputField(event)",'class'=>'cekreq risikojatuh','onclick'=>'setRisikoJatuh(this);','onload'=>'setRisikoJatuh(this);')); ?>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                ...
                <div class="control-group ">
                    <?php  echo CHtml::label('Apakah terjadi insiden jatuh ? <span style="color:red">*</span>', '', array('class' => 'control-label')) ?>
                    <div class="controls">
                        <div class="form-inline">
                            <!-- <div class="radio inline">
                                <?php //echo CHtml::activeRadioButton($modIntervensi,'evaluasi_pencegahanjatuh',array('Ya'=>'ya') , array('onkeyup'=>"return $(this).focusNextInputField(event)",'class'=>'cekreq','onclick'=>'')); ?><label>Ya</label>
                                <?php //echo CHtml::activeRadioButton($modIntervensi,'evaluasi_pencegahanjatuh',array('Ya'=>'ya') , array('onkeyup'=>"return $(this).focusNextInputField(event)",'class'=>'cekreq','onclick'=>'')); ?><label>Tidak</label>
                            </div> -->
                            <div class="radio inline">
        ...
        <?php
            $modMasterIntervensiSedang = IntervensipencegahanjatuhM::model()->findAll("intervensipencegahanjatuh_aktif = true and intervensipencegahanjatuh_tingkat = 'tinggi' and kelompok_pasien = 'anak' ORDER BY intervensipencegahanjatuh_urutan ASC");
        ...
        <?php
            // $modMasterIntervensiTinggi = IntervensipencegahanjatuhM::model()->findAll("intervensipencegahanjatuh_aktif = true and intervensipencegahanjatuh_tingkat = 'sangat_tinggi' and kelompok_pasien = 'anak' ORDER BY intervensipencegahanjatuh_urutan ASC");
    ...
    <div class="form-actions pull-right">
            <?php
                    if(isset($_GET['sukses'])){
                            ...
                            echo CHtml::htmlButton(Yii::t('mds','{icon} Save',array('{icon}'=>'<i class="icon-ok icon-white"></i>')), array('class'=>'btn btn-green', 'type'=>'button','onclick'=>'simpanData_anak();')); //RND-8620
