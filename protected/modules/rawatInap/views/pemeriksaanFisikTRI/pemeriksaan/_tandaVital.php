...
<div class="control-group">
    ...
    <div class="controls">
        ...
        echo $form->textField($modPemeriksaanFisik, 'hr', array('class' => 'span2 integer numbersOnly', 'onkeypress' => "return $(this).focusNextInputField(event);", 'maxlength' => 2, 'placeholder' => 'Denyut Jantung'));

        ?> bpm
    </div>
</div>
<div class="control-group">
    <label class="control-label">Variabilitas Denyut Jantung (HRV)</label>
    <div class="controls">
        <?php echo $form->textField($modPemeriksaanFisik, 'hrv', array('class' => 'span2 floatdot', 'onkeypress' => "return $(this).focusNextInputField(event);", 'maxlength' => 5, 'style' => 'text-align:right;')); ?>
        ms
    </div>
</div>
<div class="control-group">
...
<div class="control-group">
    ...
    <div class="controls">
        <?php echo $form->textField($modPemeriksaanFisik, 'suhutubuh', array('class' => 'span2   floatdot', 'onkeypress' => "return $(this).focusNextInputField(event);", 'maxlength' => 5, 'style' => 'text-align:right;')); ?>
        &#176 Celcius
    </div>
</div>
<div class="control-group">
