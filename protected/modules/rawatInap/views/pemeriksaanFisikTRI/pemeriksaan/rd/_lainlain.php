        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="far fa-file-alt"></i> Pemeriksaan Penunjang
                </div>
            </div>
...
<div class="row">
    <div class="col-sm-6">
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="far fa-comment-alt"></i> Tindakan
                </div>
            </div>
            <div class="panel-body">
    ...
    <div class="col-sm-6">
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="far fa-comment-alt"></i> Terapi
                </div>
            </div>
            <div class="panel-body">
...
<div class="row">
    <div class="col-sm-12">
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="far fa-comment-alt"></i> Masalah Keperawatan
                </div>
            </div>
            <div class="panel-body">
...
<div class="row">
    <div class="col-sm-6">
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="far fa-file-alt"></i> Rencana Tindak Lanjut
                </div>
            </div>
            <div class="panel-body">
    ...
    <div class="col-sm-6">
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="far fa-file-alt"></i> Edukasi Pasien
                </div>
            </div>
