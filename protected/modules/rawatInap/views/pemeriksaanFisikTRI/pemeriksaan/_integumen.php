    ...
    <div class="panel-body">
        <div class="control-group">
            ...
            <div class="controls">
                ...
                <?php
                echo '<label class="radio-inline">' . $form->radioButton($modIntegumen, 'warna[val]', array('value' => 'Lain2', 'uncheckValue' => null))
        ...
        <div class="control-group">
            ...
            <div class="controls">
                ...
                <?php
                echo '<label class="radio-inline">' . $form->radioButton($modIntegumen, 'integritas[val]', array('value' => 'Lain2', 'uncheckValue' => null))
