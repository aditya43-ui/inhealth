...
<table class="thorak_input">
    ...
    <tr>
        ...
        <td>
            ...
            <br>
            <p>
                <?php echo $form->dropDownList($modPemeriksaanFisik, 'au_paruwhkiri_1', array('+'=>'+', '-'=>'-'), array('empty'=>'-- Pilih --', 'style'=>'width:80px;', 'class'=>'au_paruwhkiri')); ?>
            </p>
            <p>
                <?php echo $form->dropDownList($modPemeriksaanFisik, 'au_paruwhkiri_2', array('+'=>'+', '-'=>'-'), array('empty'=>'-- Pilih --', 'style'=>'width:80px;', 'class'=>'au_paruwhkiri')); ?>
            </p>
            <p>
                <?php echo $form->dropDownList($modPemeriksaanFisik, 'au_paruwhkiri_3', array('+'=>'+', '-'=>'-'), array('empty'=>'-- Pilih --', 'style'=>'width:80px;', 'class'=>'au_paruwhkiri')); ?>
            </p>
        </td>
    </tr>
</table>
...
<table class="thorak_input">
    <tr>
        ...
        <td>
            <p>
                <?php echo $form->dropDownList($modPemeriksaanFisik, 'au_cardios1', array('Reguler'=>'Reguler', 'Inreguler'=>'Inreguler'), array('empty'=>'-- Pilih --', 'style'=>'width:100px;', 'class'=>'au_cardios')); ?>
            </p>
        </td>
    </tr>
    <tr>
        ...
        <td>
            <p>
                <?php echo $form->dropDownList($modPemeriksaanFisik, 'au_cardios2', array('Reguler'=>'Reguler', 'Inreguler'=>'Inreguler'), array('empty'=>'-- Pilih --', 'style'=>'width:100px;', 'class'=>'au_cardios')); ?>
            </p>
        </td>
    </tr>
    <tr>
        ...
        <td>
            <p>
                <?php echo $form->dropDownList($modPemeriksaanFisik, 'au_cardios3', array('+'=>'+', '-'=>'-'), array('empty'=>'-- Pilih --', 'style'=>'width:100px;', 'class'=>'au_cardios')); ?>
            </p>
        </td>
    </tr>
    <tr>
        ...
        <td>
            <p>
                <?php echo $form->dropDownList($modPemeriksaanFisik, 'au_cardios4', array('+'=>'+', '-'=>'-'), array('empty'=>'-- Pilih --', 'style'=>'width:100px;', 'class'=>'au_cardios')); ?>
            </p>
        </td>
    </tr>
</table>
