...
<table style="width: 100%; border: none;">
    ...
    <tr>
        ...
        <td>
            ...
            <?php
             $pasienAdmisi = PasienadmisiT::model()->findByPk($modPemeriksaanFisik->pasienadmisi_id);
    ...
    <tr>
        ...
        <td>
            ...
            <?php echo CHtml::encode((isset($modPemeriksaanFisik->pegawai)?$modPemeriksaanFisik->pegawai->namaLengkap:"")); ?>
        </td>
    </tr> 
    <tr>
        <td></td>
...
<table id="tblDaftarAnamnesa" class="table table-bordered table-condensed" border="2">
    ...
    <tr>
        ...
        <td colspan="2" width="70%"><?php echo (isset($modPemeriksaanFisik->denyutjantung)?$modPemeriksaanFisik->denyutjantung:" - "); ?> <?php echo (isset($modPemeriksaanFisik->hr)?$modPemeriksaanFisik->hr .' bpm':" - "); ?> </td>
    </tr>
    <tr>
        <td colspan="2" width="30%">Variabilitas Denyut Jantung (HRV)</td>
        <td colspan="2" width="70%"><?php echo (isset($modPemeriksaanFisik->hrv)?$modPemeriksaanFisik->hrv .' ms':" - "); ?> </td>
    </tr>
    <tr>
...
<?php echo $this->renderPartial('rawatInap.views.pemeriksaanFisikTRI.detail._kepalaLeher', array(
...
<?php echo $this->renderPartial('rawatInap.views.pemeriksaanFisikTRI.detail._cardio', array(
    'modPemeriksaanFisik'=>$modPemeriksaanFisik
), true); ?>
<?php echo $this->renderPartial('rawatInap.views.pemeriksaanFisikTRI.detail._pulmo', array(
    'modPemeriksaanFisik'=>$modPemeriksaanFisik
), true); ?>
<?php echo $this->renderPartial('rawatInap.views.pemeriksaanFisikTRI.detail._abdomen', array(
    'modPemeriksaanFisik'=>$modPemeriksaanFisik
), true); ?>
<?php echo $this->renderPartial('rawatInap.views.pemeriksaanFisikTRI.detail._obstetri', array(
    'modPemeriksaanFisik'=>$modPemeriksaanFisik
), true); ?>
...
<?php echo $this->renderPartial('rawatInap.views.pemeriksaanFisikTRI.detail._genitalia', array(
    'modPemeriksaanFisik'=>$modPemeriksaanFisik
), true); ?>
<?php echo $this->renderPartial('rawatInap.views.pemeriksaanFisikTRI.detail._ews', array(
    'model'=>$modPemeriksaanFisik
), true); ?>
<?php echo $this->renderPartial('rawatInap.views.pemeriksaanFisikTRI.detail._lainlain', array(
    'modPemeriksaanFisik'=>$modPemeriksaanFisik
), true); ?>
<table>
<tr>
...
function titikSesudahSimpanDetail(titikX,titikY,urutan){
	var titikX=$("#imgtag_detail").position().left + titikX - 12;
	var titikY=$("#imgtag_detail").position().top + titikY - 10;
	var nomor = urutan+1;
	var color = '#000000';
	var size = '5px';
