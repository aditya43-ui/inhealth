...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var triase = jQuery('#<?php echo CHtml::activeId($model, 'triase_id') ?>');	
        var rujukan = jQuery('#<?php echo CHtml::activeId($model, 'rujukankeluar_id') ?>');	
        var jenis_kecelakaan = jQuery('#<?php echo CHtml::activeId($model, 'jeniskecelakaan_id') ?>');	
        var cara_masuk = jQuery('#<?php echo CHtml::activeId($model, 'caramasuk_id') ?>');	
        var kondisi_keluar = jQuery('#<?php echo CHtml::activeId($model, 'kondisikeluar_id') ?>');	
        ...
        * multi select propinsi dan kabupaten
        ...
        jQuery(jenis_kecelakaan).multiselect({
            includeSelectAllOption: true,
            buttonClass: "form-control",
            maxHeight: 300,
            buttonWidth: '182px',
        ...
        jQuery(kondisi_keluar).multiselect({
            includeSelectAllOption: true,
            buttonClass: "form-control",
            maxHeight: 300,
            buttonWidth: '182px',
