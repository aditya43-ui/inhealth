<div class="search-form">
    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            <div class="control-group">
                <?php echo CHtml::label('Berdasarkan', '', array('class' => 'control-label')); ?>
                <div class="controls">
                    <?php echo $form->dropDownList($model, 'pilihanx', $model::berdasarkanStatus(), array('class' => 'form-control span4', 'empty' => '-- Pilih --', 'onkeypress' => "return $(this).focusNextInputField(event)")); ?>
                </div>
            </div>
        </div>
        <div class="col-sm-6">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?php echo $form->dropDownList($model,'pegawai_id',CHtml::listData(PegawaiM::model()->findAll('kelompokpegawai_id = 1'),'pegawai_id','nama_pegawai'),array('empty' => '-- Pilih --')) ?>
                </div>
            </div>
