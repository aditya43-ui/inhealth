...
<tr>
    ...
    <td>
		<?php echo CHtml::activeHiddenField($modPemeriksaanGbr, '['.(isset($a)?$a:'i').']pemeriksaangambarnyeri_id',array('style'=>'width:50px;', 'class'=>'integer pemeriksaangambarnyeri_id')); ?>
    ...
    <td>
		<?php 
			if (!empty($modPemeriksaanGbr->pemeriksaangambarnyeri_id)){
		?>
