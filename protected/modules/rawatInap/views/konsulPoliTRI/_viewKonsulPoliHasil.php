    ...
    <tr width="50%">
        <td width="50%">
            <div class="control-group">
                ...
                <div class="controls">
                    <?= CHtml::textArea('', preg_replace('#</?p.*?>#is', '', $modKonsul->uraian_konsuljjawaban),
                    array('class'
                    => '', 'style' => 'text-align:left', 'readonly' => true)) ?>
                </div>
            </div>
...
<div class="form-actions">
    <?php echo CHtml::link(Yii::t('mds', '{icon} Ok', array('{icon}' => '<i class="entypo-check"></i>')), '#', array('class' => 'btn btn-danger', 'onclick' => '$("#dialogDetailKonsulHasil").dialog("close");return false;'));
    ?>
</div>
