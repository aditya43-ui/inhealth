        ...
        <div class="row-fluid">
            <div class="col-sm-12">
                ...
                <ul>
                    ...
                    <li>
                            <a href="#wizard_tabanak3" data-toggle="tab"><span>3</span><?php echo "Kontrol Risiko Infeksi"; ?></a>
                    </li>
                    <li>
                      <a href="#wizard_tabanak4" data-toggle="tab"><span>4</span><?php echo "Psiko-Sosial-Spritual"; ?></a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="#wizard_tabanak13" data-toggle="tab"><span>9</span>Pemeriksaan Fisik (Body System)</a>
                    </li>
                    <li>
                        <a href="#wizard_tabanak14" data-toggle="tab"><span><?php echo "10"; ?></span><?php echo "Potensial kebutuhan pembelajaran"; ?></a>
                    </li>
                </ul>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="wizard_tabanak1">
                      <?php
                          $this->renderPartial($this->path_view.'anak/_formAnamnesaRI',array(
                   ...
                   <div class="tab-pane" id="wizard_tabanak2">
                     <?php
                        $this->renderPartial($this->path_view.'anak/_formKeadaanUmumRI',array('form'=>$form,'modAsesmenawalkeperawatanT'=>$model));
                      ?>
                    </div>
                    <div class="tab-pane" id="wizard_tabanak3">
                      <?php
                        $this->renderPartial($this->path_view.'anak/_formKontrolRisikoInfeksi',array('form'=>$form,'modAsesmenawalkeperawatanT'=>$model));
                       ?>
                    </div>
                    <div class="tab-pane" id="wizard_tabanak4">
                      <?php
                          $this->renderPartial($this->path_view.'anak/_formKebutuhanPsikologiRI',array('form'=>$form,'modPendaftaran'=>$modPendaftaran,'modAsesmenawalkeperawatanT'=>$model,'modAsesmenkebutuhanEdukasiT' => $modAsesmenkebutuhanEdukasiT));
                       ?>
                    </div>
                    <div class="tab-pane" id="wizard_tabanak5">
                      <?php
                          $this->renderPartial($this->path_view.'anak/_formSknFungsionalRD',array('form'=>$form,'modPendaftaran'=>$modPendaftaran,'modPasien'=>$modPasien,'modAsesmenawalkeperawatanT'=>$model, 'modBarthelindex'=>$modBarthelindex));
                       ?>
                    </div>
                    <div class="tab-pane" id="wizard_tabanak6">
                      <?php
                        $this->renderPartial($this->path_view.'anak/_formSkrinningGiziRI',array('form'=>$form,'modAsesmenawalkeperawatanT'=>$model));
                       ?>
                    </div>
                    <div class="tab-pane" id="wizard_tabanak7">
                      <?php
                        $this->renderPartial($this->path_view.'anak/_formPengkajianResikoJatuhRI',array('form'=>$form,'modAsesmenawalkeperawatanT'=>$model));
                       ?>
                    </div>
                    <div class="tab-pane" id="wizard_tabanak8">
                      <?php
                        $this->renderPartial($this->path_view.'anak/_formSkrinningNyeriRI',array('form'=>$form,'modPendaftaran'=>$modPendaftaran,'modPasien'=>$modPasien,'modAsesmenawalkeperawatanT'=>$model,'modSkrinningnyerianakdetT'=>$modSkrinningnyerianakdetT,'dataFlaCcs' => $dataFlaCcs,'getFlaCcs' => $getFlaCcs));
                       ?>
                    </div>
                    <div class="tab-pane" id="wizard_tabanak13">
                        <?php $this->renderPartial($this->path_view.'anak/_formPemeriksaanFisik',array('form'=>$form,'modAsesmenawalkeperawatanT'=>$model)) ?>
                    </div>
                    <div class="tab-pane" id="wizard_tabanak14">
...
<?php $this->endWidget(); ?>
<?php $this->renderPartial($this->path_view.'anak/_jsFunctionsAskepAnak',array('model'=>$model,'modPasien'=>$modPasien,'modAsesmenkebutuhanEdukasiT'=>$modAsesmenkebutuhanEdukasiT, 'modBarthelindex'=>$modBarthelindex)); ?>
