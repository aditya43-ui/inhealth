    ...
    <td style="width: 35%;" class="borderclass"  valign="top">
        <table class="" style="float:right; width: 100%">
            ...
            <tr>
                ...
                <td style="padding: 3px; font-size: 11pt">
                    <?php
                      $namaDokter = (isset($modPendaftaran->dokter)?$modPendaftaran->dokter->namaLengkap:"");
                      $pasienadmisi = PasienadmisiT::model()->findByPk($modPendaftaran->pasienadmisi_id);
                      if(isset($pasienadmisi)){
                        $namaDokter = (isset($pasienadmisi->pegawai)?$pasienadmisi->pegawai->namaLengkap:"");
                      }
