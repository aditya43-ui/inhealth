        ...
        <div class="panel-heading">
         ...
         <div class="panel-body">
             ...
             <div class="panel panel-primary panel-success" id="panelresikojatuh_dewasa">
                <div class="panel-heading">
                    <div class="panel-title"><?php echo $form->radioButton($modAsesmenawalkeperawatanT, 'isresikojatuh', array('onclick' => 'choiseResikoJatuh_dws(this)', 'value' => 0, 'class'=>'pilih_resikoJatuh', 'uncheckValue'=>null)); ?> <strong>Skrinning Resiko Jatuh Dewasa (Morse Falls Scale)</strong></div>
                </div>
                 <div class="panel-body">
             ...
             <div class="panel panel-primary panel-success" id="panelresikojatuh_lansia">
                <div class="panel-heading">
                    <div class="panel-title"><?php echo $form->radioButton($modAsesmenawalkeperawatanT, 'isresikojatuh', array('onclick' => 'choiseResikoJatuh_dws(this)', 'value' => 2, 'class'=>'pilih_resikoJatuh', 'uncheckValue'=>null)); ?> <strong>Skrinning Resiko Lansia (Sidney Scoring)</strong></div>
                </div>
                 <div class="panel-body">
                               ...
                               <table class="items table table-bordered table-striped table-condensed" id="tblResikojatuhLansia">
                                   ...
                                   <tr>
                                       ...
                                       <th>
                                           ...
                                           <div class="form-inline">
                                               <?php echo CHtml::radioButtonList('riwayatJatuhRSLansia','',array("1"=>"<h5>YA</h5>","0"=>"<h5>TIDAK</h5>"), array('class'=>'riwayatJatuh','onkeyup'=>"return $(this).focusNextInputField(event)",'separator'=>'&nbsp;&nbsp;&nbsp;','onchange'=>'setRiwayatJatuh_dws(this)'));?>
                                           </div>
                                       </th>
                                   ...
                                   <tr>
                                       ...
                                       <th>
                                           <div class="form-inline">
                                               <?php echo CHtml::radioButtonList('riwayatJatuhBulanLansia','',array("1"=>"<h5>YA</h5>","0"=>"<h5>TIDAK</h5>"), array('class'=>'riwayatJatuh','onkeyup'=>"return $(this).focusNextInputField(event)",'separator'=>'&nbsp;&nbsp;&nbsp;','onchange'=>'setRiwayatJatuh_dws(this)'));?>
                                           </div>
                                       </th>
                                   </tr>
                                   <tr>
                                       ...
                                       <th>
                                           ...
                                           <div class="form-inline">
                                               <?php echo CHtml::radioButtonList('statusMentalDeliriumLansia','',array("1"=>"<h5>YA</h5>","0"=>"<h5>TIDAK</h5>"), array('class'=>'statusMentalLansia','onkeyup'=>"return $(this).focusNextInputField(event)",'separator'=>'&nbsp;&nbsp;&nbsp;','onchange'=>'setStatusMental_dws(this)'));?>
                                           </div>
                                       </th>
                                   ...
                                   <tr>
                                       ...
                                       <th>
                                           <div class="form-inline">
                                               <?php echo CHtml::radioButtonList('statusMentalDisorientasiLansia','',array("1"=>"<h5>YA</h5>","0"=>"<h5>TIDAK</h5>"), array('class'=>'statusMentalLansia','onkeyup'=>"return $(this).focusNextInputField(event)",'separator'=>'&nbsp;&nbsp;&nbsp;','onchange'=>'setStatusMental_dws(this)'));?>
                                           </div>
                                       </th>
                                   </tr>
                                   <tr>
                                       ...
                                       <th>
                                           <div class="form-inline">
                                               <?php echo CHtml::radioButtonList('statusMentalAgitasiLansia','',array("1"=>"<h5>YA</h5>","0"=>"<h5>TIDAK</h5>"), array('class'=>'statusMentalLansia','onkeyup'=>"return $(this).focusNextInputField(event)",'separator'=>'&nbsp;&nbsp;&nbsp;','onchange'=>'setStatusMental_dws(this)'));?>
                                           </div>
                                       </th>
                                   </tr>
                                   <tr>
                                       ...
                                       <th>
                                           ...
                                           <div class="form-inline">
                                               <?php echo CHtml::radioButtonList('penglihatanKacamataLansia','',array("1"=>"<h5>YA</h5>","0"=>"<h5>TIDAK</h5>"), array('class'=>'penglihatanLansia','onkeyup'=>"return $(this).focusNextInputField(event)",'separator'=>'&nbsp;&nbsp;&nbsp;','onchange'=>'setPengelihatan_dws(this)'));?>
                                           </div>
                                       </th>
                                   ...
                                   <tr>
                                       ...
                                       <th>
                                           <div class="form-inline">
                                               <?php echo CHtml::radioButtonList('penglihatanBuramLansia','',array("1"=>"<h5>YA</h5>","0"=>"<h5>TIDAK</h5>"), array('class'=>'penglihatanLansia','onkeyup'=>"return $(this).focusNextInputField(event)",'separator'=>'&nbsp;&nbsp;&nbsp;','onchange'=>'setPengelihatan_dws(this)'));?>
                                           </div>
                                       </th>
                                   </tr>
                                   <tr>
                                       ...
                                       <th>
                                           <div class="form-inline">
                                               <?php echo CHtml::radioButtonList('penglihatanKatarakLansia','',array("1"=>"<h5>YA</h5>","0"=>"<h5>TIDAK</h5>"), array('class'=>'penglihatanLansia','onkeyup'=>"return $(this).focusNextInputField(event)",'separator'=>'&nbsp;&nbsp;&nbsp;','onchange'=>'setPengelihatan_dws(this)'));?>
                                           </div>
                                       </th>
                                   </tr>
                                   <tr>
                                       ...
                                       <th>
                                           <div class="form-inline">
                                               <?php echo CHtml::activeRadioButtonList($modAsesmenawalkeperawatanT,'kebiasaan_berkemih_lansia',array("1"=>"<h5>YA</h5>","0"=>"<h5>TIDAK</h5>"), array('class'=>'kebiasaanBerkemihLansia','onkeyup'=>"return $(this).focusNextInputField(event)",'separator'=>'&nbsp;&nbsp;&nbsp;','onchange'=>'setKebiasaanBerkemih_dws(this)'));?>
                                           </div>
                                       </th>
                                   ...
                                   <tr>
                                       ...
                                       <th colspan="2">
                                           ...
                                           <?php echo CHtml::dropDownList('transferLansia', '',LookupM::getItems('resikojatuh_transfer_lansia'), array('empty' => '-- Pilih --', 'class' => 'span3', 'onkeypress' => "return $(this).focusNextInputField(event);",'onchange'=>'getTransferLansia_dws()'));?>
                                       </th>
                                   ...
                                   <tr>
                                       ...
                                       <th colspan="2">
                                           ...
                                           <?php echo CHtml::dropDownList('mobilitasLansia', '',LookupM::getItems('resikojatuh_mobilitas_lansia'), array('empty' => '-- Pilih --', 'class' => 'span3', 'onkeypress' => "return $(this).focusNextInputField(event);",'onchange'=>'getMobilitasLansia_dws()'));?>
                                       </th>
                                   </tr>
                                   <tr>
                     ...
                     <td width="70%">
                         <table width="100%">
                            <tr>
                                ...
                                <td colspan="3">
                                    <div class="controls">
                                        <div class="form-inline">
                                           <div class="radio inline">
                                               <?php echo CHtml::activeRadioButtonList($modAsesmenawalkeperawatanT,'riwayatjatuh_3bln_terakhir',array(1=>'Ya',0=>'Tidak') , array('class'=>'riwayatjatuh_3bln_terakhir','onkeyup'=>"return $(this).focusNextInputField(event)",'onclick'=>'changeInformasiResikoJatuh_dws(this);','separator'=>'&nbsp;&nbsp;&nbsp;')); ?>
                                           </div>
                                       </div>
                                   </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <div class="controls">
                                        <?php echo $form->radioButtonList($modAsesmenawalkeperawatanT,'riwayatjatuh_alatbantu',array(0=>'Tidak',1=>'Ya') , array('class'=>'riwayatjatuh_alatbantu','onkeyup'=>"return $(this).focusNextInputField(event)",'onclick'=>'changeInformasiResikoJatuh_dws(this);')); ?>
                                   </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="controls">
                                        <?php echo $form->radioButton($modAsesmenawalkeperawatanT,'riwayatjatuh_jenisalatbantu', array('value'=>'Tongkat', 'uncheckValue'=>null,'class'=>'jenisalatbantu','onkeyup'=>"return $(this).focusNextInputField(event)",'onclick'=>'changeInformasiResikoJatuh_dws(this);', 'disabled'=>true)); ?> <label>Tongkat</lable>
                                   </div>
                                </td>
                                <td></td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="controls">
                                      <?php echo $form->radioButton($modAsesmenawalkeperawatanT,'riwayatjatuh_jenisalatbantu', array('value'=>'Kursi Roda', 'uncheckValue'=>null,'class'=>'jenisalatbantu','onkeyup'=>"return $(this).focusNextInputField(event)",'onclick'=>'changeInformasiResikoJatuh_dws(this);', 'disabled'=>true)); ?> <label>Kursi Roda</lable>
                                   </div>
                                </td>
                                <td></td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="controls">
                                        <?php echo $form->radioButton($modAsesmenawalkeperawatanT,'riwayatjatuh_jenisalatbantu', array('value'=>'Walker', 'uncheckValue'=>null,'class'=>'jenisalatbantu','onkeyup'=>"return $(this).focusNextInputField(event)",'onclick'=>'changeInformasiResikoJatuh_dws(this);', 'disabled'=>true)); ?> <label>Walker</lable>
                                   </div>
                                </td>
                                <td></td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="controls">
                                        <div class="form-inline">
                                            <?php echo $form->radioButton($modAsesmenawalkeperawatanT,'riwayatjatuh_jenisalatbantu', array('value'=>'Lainnya', 'uncheckValue'=>null,'class'=>'jenisalatbantu','onkeyup'=>"return $(this).focusNextInputField(event)",'onclick'=>'changeInformasiResikoJatuh_dws(this);', 'disabled'=>true)); ?> <label>Lainnya</lable>
