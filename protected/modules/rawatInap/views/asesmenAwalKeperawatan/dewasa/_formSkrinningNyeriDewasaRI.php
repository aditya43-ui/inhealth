         ...
         <div class="panel-body">
           <div class="row">
             ...
             <div class="panel panel-success panel_nyeri panelsadar" id="nyeri_dewasa" >
                <div class="panel-heading">
                    <div class="panel-title"><?php echo $form->radioButton($modAsesmenawalkeperawatanT, 'is_keluhannyeri_dewasa', array('onclick' => 'pilihNyeri_dws(this)', 'value' => 1, 'class'=>'pilih_nyeri', 'uncheckValue'=>null)); ?> Asesmen Nyeri Dewasa</div>
                </div>
                <div class="panel-body" >
                    ...
                    <br/>
                    <?php
                    echo $this->renderPartial($this->path_view . 'dewasa/_formAsesmenDewasa', array(
                        'form' => $form,
                ...
                <div class="row">
                    <div class="col-sm-6">
                      <div class="control-group">
                          ...
                          <div class="controls">
                              <?php echo $form->radioButtonList($modAsesmenawalkeperawatanT,'isadakeluhannyeri', array('Tidak'=>'Tidak','Ya'=>'Ya'), array('class'=>'isadakeluhannyeri','onkeyup'=>"return $(this).focusNextInputField(event)", 'onchange'=>'setAdaNyeri_dws();')); ?>
                          </div>
                      </div>
                      <div class="control-group">
                                     ...
                                     foreach($lookupKualitas as $i => $look_risiko){
                                      ...
                                      $htmlKualitas .= CHtml::hiddenField('KualitasNyeri['.$i.'][nama]',$look_risiko->lookup_value);
                                       if($look_risiko->lookup_value == 'Lainnya'){
                                         $htmlKualitas .= CHtml::checkBox('KualitasNyeri['.$i.'][isKualitas]',false , array('datavalue'=>$look_risiko->lookup_value,'class'=>'kualitasnyeri disabledinputan','onchange'=>'setKualitasNyeri()')).' <label>'.$look_risiko->lookup_name.'</label>';
                        ...
                        <div class="col-md-6">
                            <table width="100%">
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <div class="controls">
                                            <?php echo $form->radioButtonList($modAsesmenawalkeperawatanT,'deskripsinyeri_ismenjalar',array(0=>'Tidak',1=>'Ya') , array('onkeyup'=>"return $(this).focusNextInputField(event)",'onclick'=>'changeDeskripsinyeri_ismenjalar_dws(this);')); ?>
                                       </div>
                                    </td>
                                </tr>
                                <tr>
                                      ...
                                      if(count((array)$lookupFrekuensi) >0 ){
                                        ...
                                        foreach($lookupFrekuensi as $i => $look_risiko){
                                         ...
                                         $htmlFrekuensi .= CHtml::hiddenField('FrekuensiNyeri['.$i.'][nama]',$look_risiko->lookup_value);
                                          if($look_risiko->lookup_value == 'Lainnya'){
                                            $htmlFrekuensi .= CHtml::checkBox('FrekuensiNyeri['.$i.'][isFrekuensi]',false , array('datavalue'=>$look_risiko->lookup_value,'class'=>'frekuensinyeri','onchange'=>'setFrekuensiNyeri()')).' <label>'.$look_risiko->lookup_name.'</label>';
                            ...
                            <div class="control-group ">
                               ...
                               <div class="controls">
                                   <label class="checkbox inline">
                                       ...
                                       <div class="form-inline">
                                           <?php echo $form->checkboxRow($modAsesmenawalkeperawatanT,'isnyerihilangdgn_lainlain',array('onChange'=>'changeNyeriHilangLain_dws(this);')); ?>
                              ...
                              <tbody>
                                 <tr>
                                     ...
                                     <th>
                                         ...
                                         <?php echo $form->dropDownList($modAsesmenawalkeperawatanT, 'skriningnyeribps_ekspresiwajahpenilaian_text', CHtml::listData(LookupM::model()->findAll("lookup_type = 'bps_ekspresiwajah'"), 'lookup_value', 'lookup_name'), array('empty' => '-- Pilih --', 'class' => 'span3','onchange' => 'venekpresi_dws(this)')); ?>
                                     </th>
                                 ...
                                 <tr>
                                     ...
                                     <th>
                                         ...
                                         <?php echo $form->dropDownList($modAsesmenawalkeperawatanT, 'skriningnyeribps_ekstremitasataspenilaian_text', CHtml::listData(LookupM::model()->findAll("lookup_type = 'bps_ekstremitasatas'"), 'lookup_value', 'lookup_name'), array('empty' => '-- Pilih --', 'class' => 'span3','onchange' => 'venekstremitas_dws(this)')); ?>
                                     </th>
                                 ...
                                 <tr>
                                     ...
                                     <th>
                                         ...
                                         <?php echo $form->dropDownList($modAsesmenawalkeperawatanT, 'skriningnyeribps_kepatuhanventilatorpenilaian_text', CHtml::listData(LookupM::model()->findAll("lookup_type = 'bps_kepatuhanventilator'"), 'lookup_value', 'lookup_name'), array('empty' => '-- Pilih --', 'class' => 'span3','onchange' => 'venpatuh_dws(this)')); ?>
                                     </th>
