    ...
    <div class="col-sm-12">
      <div class="panel panel-success panelpilih_fungsional" id="pilih_fungsional" >
          <div class="panel-heading">
              <div class="panel-title"><?php echo CHtml::activeRadioButton($modAsesmenawalkeperawatanT,'isfungsional', array('onclick' => 'pilihFungsional_neonatus(this)', 'value' => 1, 'class'=>'pilih_fungsional', 'uncheckValue'=>null)); ?> Skrinning Status Fungsional</div>
          </div>
                    ...
                    <div class='block-tabel'>
                      <table class="items table table-bordered table-striped table-condensed" id="tblInputFungsional">
                          ...
                          <tr>
                              <th>1</th>
                              <th>Makan</th>
                              <th><?php echo CHtml::htmlButton('5',array('class'=>'btn btn-default', 'type'=>'button','onclick'=>"klikBtnMakan_neonatus(5)",'style'=>'width:100%; height:100%; background-color: #d1d1d1')); ?></th>
                              <th><?php echo CHtml::htmlButton('10',array('class'=>'btn btn-default', 'type'=>'button','onclick'=>"klikBtnMakan_neonatus(10)",'style'=>'width:100%; height:100%; background-color: #d1d1d1')); ?></th>
                           ...
                           <tr>
                              ...
                              <th><?php echo CHtml::htmlButton('5',array('class'=>'btn btn-default', 'type'=>'button','onclick'=>"klikBtnToilet_neonatus(5)",'style'=>'width:100%; height:100%; background-color: #d1d1d1')); ?></th>
                              <th><?php echo CHtml::htmlButton('10',array('class'=>'btn btn-default', 'type'=>'button','onclick'=>"klikBtnToilet_neonatus(10)",'style'=>'width:100%; height:100%; background-color: #d1d1d1')); ?></th>
                           ...
                           <tr>
                              ...
                              <th><?php echo CHtml::htmlButton('15',array('class'=>'btn btn-default', 'type'=>'button','onclick'=>"klikBtnRodaTidur_neonatus(15)",'style'=>'width:100%; height:100%; background-color: #d1d1d1')); ?></th>
                           ...
                           <tr>
                              ...
                              <th><?php echo CHtml::htmlButton('0',array('class'=>'btn btn-default', 'type'=>'button','onclick'=>"klikBtnGosokGigi_neonatus(0)",'style'=>'width:100%; height:100%; background-color: #d1d1d1')); ?></th>
                              <th><?php echo CHtml::htmlButton('5',array('class'=>'btn btn-default', 'type'=>'button','onclick'=>"klikBtnGosokGigi_neonatus(5)",'style'=>'width:100%; height:100%; background-color: #d1d1d1')); ?></th>
                           ...
                           <tr>
                              <th>5</th>
                              <th>Mandi</th>
                              <th><?php echo CHtml::htmlButton('0',array('class'=>'btn btn-default', 'type'=>'button','onclick'=>"klikBtnMandi_neonatus(0)",'style'=>'width:100%; height:100%; background-color: #d1d1d1')); ?></th>
                              <th><?php echo CHtml::htmlButton('5',array('class'=>'btn btn-default', 'type'=>'button','onclick'=>"klikBtnMandi_neonatus(5)",'style'=>'width:100%; height:100%; background-color: #d1d1d1')); ?></th>
                           ...
                           <tr>
                              ...
                              <th>Berjalan di permukaan dasar</th>
                                <th><?php echo CHtml::htmlButton('10',array('class'=>'btn btn-default', 'type'=>'button','onclick'=>"klikBtnBerjalanDasar_neonatus(10)",'style'=>'width:100%; height:100%; background-color: #d1d1d1')); ?></th>
                              <th><?php echo CHtml::htmlButton('15',array('class'=>'btn btn-default', 'type'=>'button','onclick'=>"klikBtnBerjalanDasar_neonatus(15)",'style'=>'width:100%; height:100%; background-color: #d1d1d1')); ?></th>
                           ...
                           <tr>
                              ...
                              <th><?php echo CHtml::htmlButton('5',array('class'=>'btn btn-default', 'type'=>'button','onclick'=>"klikBtnNaikTangga_neonatus(5)",'style'=>'width:100%; height:100%; background-color: #d1d1d1')); ?></th>
                              <th><?php echo CHtml::htmlButton('10',array('class'=>'btn btn-default', 'type'=>'button','onclick'=>"klikBtnNaikTangga_neonatus(10)",'style'=>'width:100%; height:100%; background-color: #d1d1d1')); ?></th>
                           ...
                           <tr>
                              <th>8</th>
                              <th>Berpakaian</th>
                              <th><?php echo CHtml::htmlButton('5',array('class'=>'btn btn-default', 'type'=>'button','onclick'=>"klikBtnBerpakaian_neonatus(5)",'style'=>'width:100%; height:100%; background-color: #d1d1d1')); ?></th>
                              <th><?php echo CHtml::htmlButton('10',array('class'=>'btn btn-default', 'type'=>'button','onclick'=>"klikBtnBerpakaian_neonatus(10)",'style'=>'width:100%; height:100%; background-color: #d1d1d1')); ?></th>
                           ...
                           <tr>
                              ...
                              <th><?php echo CHtml::htmlButton('5',array('class'=>'btn btn-default', 'type'=>'button','onclick'=>"klikBtnDefekasi_neonatus(5)",'style'=>'width:100%; height:100%; background-color: #d1d1d1')); ?></th>
                              <th><?php echo CHtml::htmlButton('10',array('class'=>'btn btn-default', 'type'=>'button','onclick'=>"klikBtnDefekasi_neonatus(10)",'style'=>'width:100%; height:100%; background-color: #d1d1d1')); ?></th>
                          ...
                          <tr>
                              ...
                              <th>Mengontrol Berkemih</th>
                                <th><?php echo CHtml::htmlButton('5',array('class'=>'btn btn-default', 'type'=>'button','onclick'=>"klikBtnBerkemih_neonatus(5)",'style'=>'width:100%; height:100%; background-color: #d1d1d1')); ?></th>
                              <th><?php echo CHtml::htmlButton('10',array('class'=>'btn btn-default', 'type'=>'button','onclick'=>"klikBtnBerkemih_neonatus(10)",'style'=>'width:100%; height:100%; background-color: #d1d1d1')); ?></th>
      ...
      <div class="panel panel-success panelpilih_fungsional" id="pilih_fungsionaladl" >
          <div class="panel-heading">
              <div class="panel-title"><?php echo CHtml::activeRadioButton($modAsesmenawalkeperawatanT,'isfungsional', array('onclick' => 'pilihFungsional_neonatus(this)', 'value' => 2, 'class'=>'pilih_fungsional', 'uncheckValue'=>null)); ?> Skrinning Status Fungsional ADL</div>
          </div>
          <div class="panel-body" >
                    ...
                    <div class='block-tabel'>
                       <table class="items table table-bordered table-condensed" id="tblInputFungsionalAdl">
                           ...
                           <tr>
                             ...
                             <th><?php echo CHtml::htmlButton('0',array('class'=>'btn btn-default', 'type'=>'button','onclick'=>"klikBtnAdl_neonatus(0,'bab')",'style'=>'width:100%; height:100%; background-color: #d1d1d1')); ?></th>
                           </tr>
                           <tr>
                             <th>Kadang - kadang tak terkendali</th>
                             <th><?php echo CHtml::htmlButton('1',array('class'=>'btn btn-default', 'type'=>'button','onclick'=>"klikBtnAdl_neonatus(1,'bab')",'style'=>'width:100%; height:100%; background-color: #d1d1d1')); ?></th>
                           </tr>
                           <tr>
                             <th>Mandiri</th>
                             <th><?php echo CHtml::htmlButton('2',array('class'=>'btn btn-default', 'type'=>'button','onclick'=>"klikBtnAdl_neonatus(2,'bab')",'style'=>'width:100%; height:100%; background-color: #d1d1d1')); ?></th>
                           </tr>
                           <tr>
                           ...
                           <tr>
                             <th>Tak Terkendali/ Tak Teratur (Perlu Pencahar)</th>
                             <th><?php echo CHtml::htmlButton('0',array('class'=>'btn btn-default', 'type'=>'button','onclick'=>"klikBtnAdl_neonatus(0,'bak')",'style'=>'width:100%; height:100%; background-color: #d1d1d1')); ?></th>
                           </tr>
                           <tr>
                             <th>Kadang - kadang tak terkendali (1 x 24 jam)</th>
                             <th><?php echo CHtml::htmlButton('1',array('class'=>'btn btn-default', 'type'=>'button','onclick'=>"klikBtnAdl_neonatus(1,'bak')",'style'=>'width:100%; height:100%; background-color: #d1d1d1')); ?></th>
                           </tr>
                           <tr>
                             <th>Mandiri</th>
                             <th><?php echo CHtml::htmlButton('2',array('class'=>'btn btn-default', 'type'=>'button','onclick'=>"klikBtnAdl_neonatus(2,'bak')",'style'=>'width:100%; height:100%; background-color: #d1d1d1')); ?></th>
                           </tr>
                           <tr>
                           ...
                           <tr>
                             ...
                             <th><?php echo CHtml::htmlButton('0',array('class'=>'btn btn-default', 'type'=>'button','onclick'=>"klikBtnAdl_neonatus(0,'kebersihan')",'style'=>'width:100%; height:100%; background-color: #d1d1d1')); ?></th>
                           </tr>
                           <tr>
                             <th>Mandiri</th>
                             <th><?php echo CHtml::htmlButton('1',array('class'=>'btn btn-default', 'type'=>'button','onclick'=>"klikBtnAdl_neonatus(1,'kebersihan')",'style'=>'width:100%; height:100%; background-color: #d1d1d1')); ?></th>
                           </tr>
                           <tr>
                           ...
                           <tr>
                             ...
                             <th><?php echo CHtml::htmlButton('0',array('class'=>'btn btn-default', 'type'=>'button','onclick'=>"klikBtnAdl_neonatus(0,'penggunaanjamban')",'style'=>'width:100%; height:100%; background-color: #d1d1d1')); ?></th>
                           </tr>
                           <tr>
                             <th>Perlu Pertolongan pada beberapa kegiatan, tetapi dapat mengerjakan sendiri kegiatan yang lain</th>
                             <th><?php echo CHtml::htmlButton('1',array('class'=>'btn btn-default', 'type'=>'button','onclick'=>"klikBtnAdl_neonatus(1,'penggunaanjamban')",'style'=>'width:100%; height:100%; background-color: #d1d1d1')); ?></th>
                           </tr>
                           <tr>
                             <th>Mandiri</th>
                             <th><?php echo CHtml::htmlButton('2',array('class'=>'btn btn-default', 'type'=>'button','onclick'=>"klikBtnAdl_neonatus(2,'penggunaanjamban')",'style'=>'width:100%; height:100%; background-color: #d1d1d1')); ?></th>
                           </tr>
                           <tr>
                           ...
                           <tr>
                             <th>Tidak Mampu</th>
                             <th><?php echo CHtml::htmlButton('0',array('class'=>'btn btn-default', 'type'=>'button','onclick'=>"klikBtnAdl_neonatus(0,'makan')",'style'=>'width:100%; height:100%; background-color: #d1d1d1')); ?></th>
                           </tr>
                           <tr>
                             <th>Perlu ditolong memotong makanan</th>
                             <th><?php echo CHtml::htmlButton('1',array('class'=>'btn btn-default', 'type'=>'button','onclick'=>"klikBtnAdl_neonatus(1,'makan')",'style'=>'width:100%; height:100%; background-color: #d1d1d1')); ?></th>
                           </tr>
                           <tr>
                             <th>Mandiri</th>
                             <th><?php echo CHtml::htmlButton('2',array('class'=>'btn btn-default', 'type'=>'button','onclick'=>"klikBtnAdl_neonatus(2,'makan')",'style'=>'width:100%; height:100%; background-color: #d1d1d1')); ?></th>
                           </tr>
                           <tr>
                           ...
                           <tr>
                             ...
                             <th><?php echo CHtml::htmlButton('0',array('class'=>'btn btn-default', 'type'=>'button','onclick'=>"klikBtnAdl_neonatus(0,'sikap')",'style'=>'width:100%; height:100%; background-color: #d1d1d1')); ?></th>
                           </tr>
                           <tr>
                             <th>Bantung (2 Orang)</th>
                             <th><?php echo CHtml::htmlButton('1',array('class'=>'btn btn-default', 'type'=>'button','onclick'=>"klikBtnAdl_neonatus(1,'sikap')",'style'=>'width:100%; height:100%; background-color: #d1d1d1')); ?></th>
                           </tr>
                           <tr>
                             <th>Mandiri</th>
                             <th><?php echo CHtml::htmlButton('2',array('class'=>'btn btn-default', 'type'=>'button','onclick'=>"klikBtnAdl_neonatus(2,'sikap')",'style'=>'width:100%; height:100%; background-color: #d1d1d1')); ?></th>
                           </tr>
                           <tr>
                           ...
                           <tr>
                             <th>Tidak Mampu</th>
                             <th><?php echo CHtml::htmlButton('0',array('class'=>'btn btn-default', 'type'=>'button','onclick'=>"klikBtnAdl_neonatus(0,'pindah')",'style'=>'width:100%; height:100%; background-color: #d1d1d1')); ?></th>
                           </tr>
                           <tr>
                             <th>Bisa (Pindah) dengan kursi roda</th>
                             <th><?php echo CHtml::htmlButton('1',array('class'=>'btn btn-default', 'type'=>'button','onclick'=>"klikBtnAdl_neonatus(1,'pindah')",'style'=>'width:100%; height:100%; background-color: #d1d1d1')); ?></th>
                           </tr>
                           <tr>
                             <th>Berjalan dengan bantuan 1 orang</th>
                             <th><?php echo CHtml::htmlButton('2',array('class'=>'btn btn-default', 'type'=>'button','onclick'=>"klikBtnAdl_neonatus(2,'pindah')",'style'=>'width:100%; height:100%; background-color: #d1d1d1')); ?></th>
                           </tr>
                           <tr>
                             <th>Mandiri</th>
                             <th><?php echo CHtml::htmlButton('3',array('class'=>'btn btn-default', 'type'=>'button','onclick'=>"klikBtnAdl_neonatus(3,'pindah')",'style'=>'width:100%; height:100%; background-color: #d1d1d1')); ?></th>
                           </tr>
                           <tr>
                           ...
                           <tr>
                             ...
                             <th><?php echo CHtml::htmlButton('0',array('class'=>'btn btn-default', 'type'=>'button','onclick'=>"klikBtnAdl_neonatus(0,'baju')",'style'=>'width:100%; height:100%; background-color: #d1d1d1')); ?></th>
                           </tr>
                           <tr>
                             <th>Sebagian dibantu (Misalnya: mengancing baju)</th>
                             <th><?php echo CHtml::htmlButton('1',array('class'=>'btn btn-default', 'type'=>'button','onclick'=>"klikBtnAdl_neonatus(1,'baju')",'style'=>'width:100%; height:100%; background-color: #d1d1d1')); ?></th>
                           </tr>
                           <tr>
                             <th>Mandiri</th>
                             <th><?php echo CHtml::htmlButton('2',array('class'=>'btn btn-default', 'type'=>'button','onclick'=>"klikBtnAdl_neonatus(2,'baju')",'style'=>'width:100%; height:100%; background-color: #d1d1d1')); ?></th>
                           </tr>
                           <tr>
                           ...
                           <tr>
                             <th>Tidak Mampu</th>
                             <th><?php echo CHtml::htmlButton('0',array('class'=>'btn btn-default', 'type'=>'button','onclick'=>"klikBtnAdl_neonatus(0,'tangga')",'style'=>'width:100%; height:100%; background-color: #d1d1d1')); ?></th>
                           </tr>
                           <tr>
                             <th>Butuh Pertolongan</th>
                             <th><?php echo CHtml::htmlButton('1',array('class'=>'btn btn-default', 'type'=>'button','onclick'=>"klikBtnAdl_neonatus(1,'tangga')",'style'=>'width:100%; height:100%; background-color: #d1d1d1')); ?></th>
                           </tr>
                           <tr>
                             <th>Mandiri</th>
                             <th><?php echo CHtml::htmlButton('2',array('class'=>'btn btn-default', 'type'=>'button','onclick'=>"klikBtnAdl_neonatus(2,'tangga')",'style'=>'width:100%; height:100%; background-color: #d1d1d1')); ?></th>
                           </tr>
                           <tr>
                           ...
                           <tr>
                             <th>Tergantung Orang Lain</th>
                             <th><?php echo CHtml::htmlButton('0',array('class'=>'btn btn-default', 'type'=>'button','onclick'=>"klikBtnAdl_neonatus(0,'mandi')",'style'=>'width:100%; height:100%; background-color: #d1d1d1')); ?></th>
                           </tr>
                           <tr>
                             <th>Mandiri</th>
                             <th><?php echo CHtml::htmlButton('1',array('class'=>'btn btn-default', 'type'=>'button','onclick'=>"klikBtnAdl_neonatus(1,'mandi')",'style'=>'width:100%; height:100%; background-color: #d1d1d1')); ?></th>
                           </tr>
                           <tr>
