                        ...
                        <div class="controls">
                                <?php
                                        $this->widget('MyDateTimePicker', array(
                                                ...
                                                'attribute' => 'jam_masukruangan_neonatus',
                                                'mode' => 'time',
                                                'options' => array(
                                                ),
                     ...
                     <div class="control-group ">
                        ...
                        <div class="controls">
                                <?php
                                        $this->widget('MyDateTimePicker', array(
                                                'model' => $modAsesmenawalkeperawatanT,
                                                'attribute' => 'tgl_assesmen_awal_neonatus',
                                                'mode' => 'datetime',
                                                'options' => array(
...
//                                                        'maxDate' => 'd',
                            ...
                            <div class="controls">
                                    <?php
                                            $this->widget('application.extensions.FCBKcomplete.FCBKcomplete',array(
                                                    'model'=>$modAsesmenawalkeperawatanT,
                                                    'attribute'=>'keluhanutama_neonatus',
                            ...
                            <div class="control-group ">
                                    ...
                                    <div class="controls">
                                            <?php
                                                    $this->widget('application.extensions.FCBKcomplete.FCBKcomplete',array(
                                                            'model'=>$modAsesmenawalkeperawatanT,
                                                            'attribute'=>'keluhantambahan_neonatus',
                     ...
                     <div class="control-group ">
                        ...
                        <div class="controls">
                            <?php echo $form->radioButtonList($modAsesmenawalkeperawatanT,'sumberdata',array('Pasien'=>'Pasien','Keluarga'=>'Keluarga','Lainnya'=>'Lainnya') , array('onkeyup'=>"return $(this).focusNextInputField(event)",'class'=>'sumberdata','onclick'=>'setSumberData_neonatus();')); ?>
                        </div>
                    </div>
                    <div class="control-group ">
                  ...
                  <div class="control-group ">
                    ...
                    <div class="controls">
                      ...
                      <?php
                      echo CHtml::htmlButton('<i class="icon-plus-sign icon-white"></i> <i class="icon-white icon-chevron-right"></i>', array('class' => 'btn btn-primary', 'onclick' => "$('#dialogDiagnosa').dialog('open');$('#formDiagnosa').val('formNeonatus');refreshGridDiagnosa();",
                 ...
                 <div class="col-sm-6">
                   <div class="control-group ">
                      ...
                      <div class="controls">
                          <div class="controls">
                                  <?php echo $form->radioButtonList($modAsesmenawalkeperawatanT,'statusalergipasien',array(1=>'Tidak Ada',2=>'Tidak Tahu',3=>'Ada') , array('onkeyup'=>"return $(this).focusNextInputField(event)",'class'=>'statusalergipasien','onclick'=>'setStatusAlergi_neonatus(this);')); ?>
                          </div>
                      </div>
                  </div>
                   ...
                   <?php echo $form->textAreaRow($modAsesmenawalkeperawatanT, 'riwayatalergimakanan', array('class' => 'span3', 'onkeypress' => "return $(this).focusNextInputField(event);",'readonly'=>true)); ?>
                     ...
                     <div class="control-group ">
                         ...
                         <div class="controls">
                             <?php echo $form->radioButtonList($modAsesmenawalkeperawatanT,'riwayatpembedahan_status',array('Tidak Pernah'=>'Tidak Pernah','Pernah'=>'Pernah') , array('class'=>'riwayatpembedahan_status','onkeyup'=>"return $(this).focusNextInputField(event)",'onclick'=>'setStatusPembedahanAnastesi_neonatus(this);')); ?>
                         </div>
                     </div>
                     <div class="control-group">
                     ...
                     <div class="control-group ">
                         ...
                         <div class="controls">
                             <?php echo $form->radioButtonList($modAsesmenawalkeperawatanT,'riwayattransfusi_status',array('Tidak'=>'Tidak','Ya'=>'Ya') , array('class'=>'riwayattransfusi_status','onkeyup'=>"return $(this).focusNextInputField(event)",'onclick'=>'setStatusRiwayattransfusi_neonatus();')); ?>
                         </div>
                     </div>
                     <div class="control-group">
                         <label class="control-label"></label>
                         <div class="controls">
                           <div class="control-group ">
                               ...
                               <div class="controls">
                                   <?php echo $form->radioButtonList($modAsesmenawalkeperawatanT,'riwayattransfusi_isreaksi',array('Tidak'=>'Tidak','Ya'=>'Ya') , array('class'=>'riwayattransfusi_isreaksi disabledinputan','onkeyup'=>"return $(this).focusNextInputField(event)",'onclick'=>'setReaksiRiwayattransfusi_neonatus();')); ?>
                               </div>
                           </div>
                           <div class="control-group">
                               <label class="control-label"></label>
