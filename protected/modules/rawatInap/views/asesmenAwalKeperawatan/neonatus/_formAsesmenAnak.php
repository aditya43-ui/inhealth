	...
	?>
		<tr>
			<td><b><?php echo $det['kategori']; ?></b></td>
                        <td style="<?php echo !empty($det[0]['id'])?'border:4px solid #333 !important;':'' ?>" class="hover params-nilai0 borderflaccs" onclick="getSkorFla_neonatus('<?php echo $det['kategori_id']; ?>',0,this)">
				<?php
			...
			<td style="<?php echo !empty($det[1]['id'])?'border:4px solid #333 !important;':'' ?>" class="hover params-nilai1 borderflaccs" onclick="getSkorFla_neonatus('<?php echo $det['kategori_id'] ?>',1,this)">
				<?php
			...
			<td style="<?php echo !empty($det[2]['id'])?'border:4px solid #333 !important;':'' ?>" class="hover params-nilai2 borderflaccs" onclick="getSkorFla_neonatus('<?php echo $det['kategori_id'] ?>',2,this)">
				<?php
				...
				?>
                        ...
                        <td style="text-align:right;">
                            <?php
                                $modNyeriDet = new RISkrinningnyerianakdetT();
