                                    ...
                                    <tbody>
                                       <tr>
                                           ...
                                           <th>
                                               ...
                                               <?php echo $form->dropDownList($modAsesmenawalkeperawatanT, 'usia_anak_text', LookupM::getItems('resikojatuh_usia_anak'), array('empty' => '-- Pilih --', 'class' => 'span3', 'onkeypress' => "return $(this).focusNextInputField(event);",'onchange' => 'resikojatuhanak_usia_neonatus(this)')); ?>
                                           </th>
                                       ...
                                       <tr>
                                           ...
                                           <th>
                                               ...
                                               <?php echo $form->dropDownList($modAsesmenawalkeperawatanT,'jeniskelamin_anak_text',LookupM::getItems('jeniskelamin_skrining'), array('empty' => '-- Pilih --', 'class' => 'jeniskelaminAnak span3', 'onkeypress' => "return $(this).focusNextInputField(event);",'onchange'=>'resikojatuhanak_jeniskelamin_neonatus(this)'));?>
                                           </th>
                                       ...
                                       <tr>
                                           ...
                                           <th>
                                               ...
                                               <?php echo $form->dropDownList($modAsesmenawalkeperawatanT, 'diagnosa_asessment_anak_text', LookupM::getItems('resikojatuh_diagnose_anak'), array('empty' => '-- Pilih --', 'class' => 'span3', 'onkeypress' => "return $(this).focusNextInputField(event);",'onchange' => 'resikojatuhanak_diagnosa_neonatus(this)')); ?>
                                           </th>
                                       ...
                                       <tr>
                                           ...
                                           <th>
                                               ...
                                               <?php echo $form->dropDownList($modAsesmenawalkeperawatanT, 'gangguan_kognitif_anak_text', LookupM::getItems('resikojatuh_gangguan_kognitif_anak'), array('empty' => '-- Pilih --', 'class' => 'span3', 'onkeypress' => "return $(this).focusNextInputField(event);",'onchange' => 'resikojatuhanak_gangguan_neonatus(this)')); ?>
                                           </th>
                                       ...
                                       <tr>
                                           ...
                                           <th>
                                               ...
                                               <?php echo $form->dropDownList($modAsesmenawalkeperawatanT, 'faktor_lingkungan_anak_text', LookupM::getItems('resikojatuh_faktor_lingkungan_anak'), array('empty' => '-- Pilih --', 'class' => 'span3', 'onkeypress' => "return $(this).focusNextInputField(event);",'onchange' => 'resikojatuhanak_faktor_neonatus(this)')); ?>
                                           </th>
                                       ...
                                       <tr>
                                           ...
                                           <th>
                                               ...
                                               <?php echo $form->dropDownList($modAsesmenawalkeperawatanT, 'responterhadap_pembedahan_anak_text', LookupM::getItems('resikojatuh_responterhadap_pembedahan_anak'), array('empty' => '-- Pilih --', 'class' => 'span3', 'onkeypress' => "return $(this).focusNextInputField(event);",'onchange' => 'resikojatuhanak_respon_neonatus(this)')); ?>
                                           </th>
                                       ...
                                       <tr>
                                           ...
                                           <th>
                                               ...
                                               <?php echo $form->dropDownList($modAsesmenawalkeperawatanT, 'penggunaan_medikamentosa_text', LookupM::getItems('resikojatuh_pembedahan_medikamentosa_anak'), array('empty' => '-- Pilih --', 'class' => 'span3', 'onkeypress' => "return $(this).focusNextInputField(event);",'onchange' => 'resikojatuhanak_bedah_neonatus(this)')); ?>
                                           </th>
                     ...
                     <td width="70%">
                         <table width="100%">
                            <tr>
                                ...
                                <td colspan="3">
                                    <div class="controls">
                                        <div class="form-inline">
                                           <div class="radio inline">
                                               <?php echo CHtml::activeRadioButtonList($modAsesmenawalkeperawatanT,'riwayatjatuh_3bln_terakhir',array(1=>'Ya',0=>'Tidak') , array('class'=>'riwayatjatuh_3bln_terakhir','onkeyup'=>"return $(this).focusNextInputField(event)",'onclick'=>'changeInformasiResikoJatuh_neonatus(this);','separator'=>'&nbsp;&nbsp;&nbsp;')); ?>
                                           </div>
                                       </div>
                                   </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <div class="controls">
                                        <?php echo $form->radioButtonList($modAsesmenawalkeperawatanT,'riwayatjatuh_alatbantu',array(0=>'Tidak',1=>'Ya') , array('class'=>'riwayatjatuh_alatbantu','onkeyup'=>"return $(this).focusNextInputField(event)",'onclick'=>'changeInformasiResikoJatuh_neonatus(this);')); ?>
                                   </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="controls">
                                        <?php echo $form->radioButton($modAsesmenawalkeperawatanT,'riwayatjatuh_jenisalatbantu', array('value'=>'Tongkat', 'uncheckValue'=>null,'class'=>'jenisalatbantu','onkeyup'=>"return $(this).focusNextInputField(event)",'onclick'=>'changeInformasiResikoJatuh_neonatus(this);', 'disabled'=>true)); ?> <label>Tongkat</lable>
                                   </div>
                                </td>
                                <td></td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="controls">
                                      <?php echo $form->radioButton($modAsesmenawalkeperawatanT,'riwayatjatuh_jenisalatbantu', array('value'=>'Kursi Roda', 'uncheckValue'=>null,'class'=>'jenisalatbantu','onkeyup'=>"return $(this).focusNextInputField(event)",'onclick'=>'changeInformasiResikoJatuh_neonatus(this);', 'disabled'=>true)); ?> <label>Kursi Roda</lable>
                                   </div>
                                </td>
                                <td></td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="controls">
                                        <?php echo $form->radioButton($modAsesmenawalkeperawatanT,'riwayatjatuh_jenisalatbantu', array('value'=>'Walker', 'uncheckValue'=>null,'class'=>'jenisalatbantu','onkeyup'=>"return $(this).focusNextInputField(event)",'onclick'=>'changeInformasiResikoJatuh_neonatus(this);', 'disabled'=>true)); ?> <label>Walker</lable>
                                   </div>
                                </td>
                                <td></td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="controls">
                                        <div class="form-inline">
                                            <?php echo $form->radioButton($modAsesmenawalkeperawatanT,'riwayatjatuh_jenisalatbantu', array('value'=>'Lainnya', 'uncheckValue'=>null,'class'=>'jenisalatbantu','onkeyup'=>"return $(this).focusNextInputField(event)",'onclick'=>'changeInformasiResikoJatuh_neonatus(this);', 'disabled'=>true)); ?> <label>Lainnya</lable>
