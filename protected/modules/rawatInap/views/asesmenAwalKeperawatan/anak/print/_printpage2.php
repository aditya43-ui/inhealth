<?php if($model->jenis_statusfungsional == 'jenis_fungsionaladl'){ ?>
  <table width="100%">
    ...
    <tr>
        <td class="borderclass" style="padding: 20px 40px 20px 40px">
          <table class="tableBorder" style="width: 100%">
             ...
             <tr>
                 ...
                 <td rowspan="3" style="vertical-align: middle;">Mengendalikan Rangsang deteksi (BAB)</td>
                 <td>Tak Terkendali/ Tak Teratur (Perlu Pencahar)</td>
                 <td style="text-align: center;">0</td>
                 <td rowspan="3" style="vertical-align: middle; text-align: center;"><?php echo $modBarthelindexadlT->skor_bab; ?> </td>
             </tr>
             <tr>
             ...
             <tr>
                 ...
                 <td rowspan="3" style="vertical-align: middle;">Mengendalikan Rangsang Berkemih (BAK)</td>
                 <td>Tak Terkendali/ Tak Teratur (Perlu Pencahar)</td>
                 <td style="text-align: center;">0</td>
                 <td rowspan="3" style="vertical-align: middle; text-align: center;"><?php echo $modBarthelindexadlT->skor_bak; ?> </td>
             </tr>
             <tr>
             ...
             <tr>
                 ...
                 <td rowspan="2" style="vertical-align: middle;">Membersihkan diri (Cuci Muka, Sisir Rambut, Sikat Gigi)</td>
                 <td>Butuh Pertolongan Orang Lain</td>
                 <td style="text-align: center;">0</td>
                 <td rowspan="2" style="vertical-align: middle; text-align: center;"><?php echo $modBarthelindexadlT->skor_kebersihanmandiri;; ?> </td>
             </tr>
             <tr>
               <td>Mandiri</td>
               <td style="text-align: center;">1</td>
             ...
             <tr>
                 ...
                 <td rowspan="3" style="vertical-align: middle;">Penggunaan Jamban, Masuk dan Keluar (Melepaskan, memakai celana, membersihkan, menyiram)</td>
                 <td>Tergantung Pertolongan Orang Lain</td>
                 <td style="text-align: center;">0</td>
                 <td rowspan="3" style="vertical-align: middle; text-align: center;"><?php echo $modBarthelindexadlT->skor_pengunaanjamban; ?> </td>
             </tr>
             <tr>
             ...
             <tr>
                 ...
                 <td rowspan="3" style="vertical-align: middle;">Makan</td>
                 <td>Tidak Mampu</td>
                 <td style="text-align: center;">0</td>
                 <td rowspan="3" style="vertical-align: middle; text-align: center;"><?php echo $modBarthelindexadlT->skor_makan; ?> </td>
             </tr>
             <tr>
             ...
             <tr>
                 ...
                 <td rowspan="3" style="vertical-align: middle;">Berubah sikap dari berbaring ke duduk</td>
                 <td>Perlu banyak bantuan untuk bisa duduk (2 orang)</td>
                 <td style="text-align: center;">0</td>
                 <td rowspan="3" style="vertical-align: middle; text-align: center;"><?php echo $modBarthelindexadlT->skor_sikap; ?> </td>
             </tr>
             <tr>
             ...
             <tr>
                 <td rowspan="4" style="vertical-align: middle; text-align: center;">7</td>
                 <td rowspan="4" style="vertical-align: middle;">Berpindah / Berjalan</td>
                 <td>Tidak Mampu</td>
                 <td style="text-align: center;">0</td>
                 <td rowspan="4" style="vertical-align: middle; text-align: center;"><?php echo $modBarthelindexadlT->skor_berpindah; ?> </td>
             </tr>
             <tr>
             ...
             <tr>
                 ...
                 <td rowspan="3" style="vertical-align: middle;">Memakai Baju</td>
                 <td>Tergantung Orang Lain</td>
                 <td style="text-align: center;">0</td>
                 <td rowspan="3" style="vertical-align: middle; text-align: center;"><?php echo $modBarthelindexadlT->skor_baju; ?> </td>
             </tr>
             <tr>
             ...
             <tr>
                 <td rowspan="3" style="vertical-align: middle; text-align: center;">9</td>
                 <td rowspan="3" style="vertical-align: middle;">Naik Turun Tangga</td>
                 <td>Tidak Mampu</td>
                 <td style="text-align: center;">0</td>
                 <td rowspan="3" style="vertical-align: middle; text-align: center;"><?php echo $modBarthelindexadlT->skor_naikturuntangga; ?> </td>
             </tr>
             <tr>
             ...
             <tr>
                 <td rowspan="2" style="vertical-align: middle; text-align: center;">10</td>
                 <td rowspan="2" style="vertical-align: middle;">Mandi</td>
                 <td>Tergantung Orang Lain</td>
                 <td style="text-align: center;">0</td>
                 <td rowspan="2" style="vertical-align: middle; text-align: center;"><?php echo $modBarthelindexadlT->skor_mandi; ?> </td>
             </tr>
             <tr>
               <td>Mandiri</td>
               <td style="text-align: center;">1</td>
             ...
             <tr>
               <td colspan="5">
                 <b>Keterangan Score Penilaian Status Fungsional</b><br/>
                 Mandiri : 20 <br/>
                 Tergantungan Ringan : 12 - 15<br/>
                 Tergantungan Sedang : 9 - 11<br/>
                 Tergantung Berat : 5 - 8<br/>
                 Tergantungan Total :  0 - 4<br/>
               </td>
             </tr>
          </table>
        </td>
    ...
    <tr>
        <td class="borderclass">
            <table width="100%">
                <tr>
                    <td width="64%">
                        <table class="tableBorder" id="tblInputFungsional" style="width: 100%">
                            <thead>
                                <tr>
