...
<div class="row-fluid">
  <div class="panel panel-primary panel-success">
     <div class="panel-heading">
         <div class="panel-title"><?php echo $form->radioButton($modAsesmenawalkeperawatanT, 'isskrinninggizidewasa', array('onclick' => 'choiseSkrinningGizi(this)', 'value' => 1, 'class'=>'pilih_SkrinningGizi', 'uncheckValue'=>null)); ?> <strong>Skrinning Gizi (Metode Malnutrition Skrinning Tools/ MST)</strong></div>
     </div>
    ...
    <div class="panel panel-primary panel-success">
        <div class="panel-heading">
            <div class="panel-title"><?php echo $form->radioButton($modAsesmenawalkeperawatanT, 'isskrinninggizidewasa', array('onclick' => 'choiseSkrinningGizi(this)', 'value' => 0, 'class'=>'pilih_SkrinningGizi', 'uncheckValue'=>null)); ?> <strong>Skrinning Gizi (Metode Strong Kids)</strong></div>
        </div>
         <div class="panel-body">
