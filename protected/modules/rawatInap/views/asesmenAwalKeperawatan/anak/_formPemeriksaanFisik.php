          ...
          <div class="panel-body">
                           ...
                           foreach($lookupJenisPernapasan as $i => $look_jenis){
                            ...
                            $htmlJenisP .= CHtml::hiddenField('Jenispernapasan['.$i.'][jenis]',$look_jenis);
                             if($look_jenis == 'Lain-Lain'){
                               $htmlJenisP .= CHtml::checkBox('Jenispernapasan['.$i.'][isJenis]',$isJenis , array('class'=>'isJenis disabledinputan','onchange'=>'setJenisPernapasan(this)')).' <label>'.$look_jenis.'</label>';
            ...
            <div class="col-sm-6">
             ...
             <div class="control-group">
                ...
                <div class="controls">
                    <?php echo $form->radioButtonList($modAsesmenawalkeperawatanT,'b1_kesulitanbernafas',array('Tidak'=>'Tidak','Ya'=>'Ya') , array('class'=>'b1_kesulitanbernafas','onkeyup'=>"return $(this).focusNextInputField(event)",'onchange'=>'setKesulitanbernafas()')); ?>
                </div>
            </div>
            <div class="control-group">
          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              ...
              <div class="control-group">
                 ...
                 <div class="controls">
                     <?php echo $form->radioButtonList($modAsesmenawalkeperawatanT,'b2_isoedem',array(0=>"Tidak",1=>'Ya') , array('class'=>'b2_isoedem','onkeyup'=>"return $(this).focusNextInputField(event)",'onchange'=>'setB2isoedem()')); ?>
                 </div>
             </div>
          ...
          <div class="row">
            ...
            <div class="control-group ">
                ...
                <div class="controls">
                  <div class="radio inline">
                    <div class="form-inline">
                      <?php echo $form->radioButtonList($modAsesmenawalkeperawatanT,'b5_abdomen_isnyeritekan',array(0=>'Tidak',1=>'Ya') , array('onkeyup'=>"return $(this).focusNextInputField(event)",'class'=>'b5_abdomen_isnyeritekan','labelOptions'=>array('style'=> 'padding-left:5px;padding-right:10px;'),'onchange'=>'setB5Nyeritekan()')); ?>
                    </div>
                  </div>
                </div>
            </div>
    ...
    <div class="panel panel-darkk">
        ...
        <div class="panel-body">
          <div class="row">
            <div class="col-sm-6">
              ...
              <div class="control-group ">
                  ...
                  <div class="controls">
                      <?php echo $form->radioButtonList($modAsesmenawalkeperawatanT,'b6_isfraktur',array('Tidak'=>'Tidak','Ya'=>'Ya') , array('onkeyup'=>"return $(this).focusNextInputField(event)",'class'=>'b6_isfraktur','labelOptions'=>array('style'=> 'padding-left:5px;padding-right:10px;'),'onchange'=>'setB6Fraktur()')); ?>
                  </div>
              </div>
              <div class="control-group">
                <label class="control-label"></label>
          ...
          <div class="control-group ">
              ...
              <div class="controls">
                  <?php echo $form->radioButtonList($modAsesmenawalkeperawatanT,'b6_isresikodekubitus',array(0=>'Tidak',1=>'Ya') , array('onkeyup'=>"return $(this).focusNextInputField(event)",'class'=>'b6_isresikodekubitus','labelOptions'=>array('style'=> 'padding-left:5px;padding-right:10px;'),'onchange'=>'setB6ResikoDekubitus()')); ?>
              </div>
          </div>
          <div class="control-group">
            <label class="control-label"></label>
         ...
         <div class="control-group ">
             ...
             <div class="controls">
                 <?php echo $form->radioButtonList($modAsesmenawalkeperawatanT,'b6_isluka',array(0=>'Tidak',1=>'Ya') , array('onkeyup'=>"return $(this).focusNextInputField(event)",'class'=>'b6_isluka','labelOptions'=>array('style'=> 'padding-left:5px;padding-right:10px;'),'onchange'=>'setB6Luka()')); ?>
             </div>
         </div>
         <div class="control-group">
           <label class="control-label"></label>
