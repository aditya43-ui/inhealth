                        ...
                        <div class="controls">
                                <?php
                                        $this->widget('MyDateTimePicker', array(
                                                ...
                                                'attribute' => 'jam_masukruangan_anak',
                                                'mode' => 'time',
                                                'options' => array(
                                                ),
                     ...
                     <div class="control-group ">
                        ...
                        <div class="controls">
                                <?php
                                        $this->widget('MyDateTimePicker', array(
                                                'model' => $modAsesmenawalkeperawatanT,
                                                'attribute' => 'tgl_assesmen_awal_anak',
                                                'mode' => 'datetime',
                                                'options' => array(
...
//                                                        'maxDate' => 'd',
                  ...
                  <div class="control-group ">
                    ...
                    <div class="controls">
                      ...
                      <?php
                      echo CHtml::htmlButton('<i class="icon-plus-sign icon-white"></i> <i class="icon-white icon-chevron-right"></i>', array('class' => 'btn btn-primary', 'onclick' => "$('#dialogDiagnosa').dialog('open');$('#formDiagnosa').val('formAnak');refreshGridDiagnosa();",
                 ...
                 <div class="col-sm-6">
                   <div class="control-group ">
                      ...
                      <div class="controls">
                          <!--<div class="radio">-->
                                  <div class="controls">
                                          <?php echo $form->radioButtonList($modAsesmenawalkeperawatanT,'statusalergipasien',array(1=>'Tidak Ada',2=>'Tidak Tahu',3=>'Ada') , array('onkeyup'=>"return $(this).focusNextInputField(event)",'class'=>'statusalergipasien','onclick'=>'setStatusAlergi(this);')); ?>
                                  </div>
                          <!--</div>-->
                   ...
                   <?php echo $form->textAreaRow($modAsesmenawalkeperawatanT, 'riwayatalergimakanan', array('class' => 'span3', 'onkeypress' => "return $(this).focusNextInputField(event);",'readonly'=>true)); ?>
                     ...
                     <div class="control-group ">
                         ...
                         <div class="controls">
                             <?php echo $form->radioButtonList($modAsesmenawalkeperawatanT,'riwayatpembedahan_status',array('Tidak Pernah'=>'Tidak Pernah','Pernah'=>'Pernah') , array('class'=>'riwayatpembedahan_status','onkeyup'=>"return $(this).focusNextInputField(event)",'onclick'=>'setStatusPembedahanAnastesi(this);')); ?>
                         </div>
                     </div>
                     <div class="control-group">
                     ...
                     <div class="control-group ">
                         ...
                         <div class="controls">
                             <?php echo $form->radioButtonList($modAsesmenawalkeperawatanT,'riwayattransfusi_status',array('Tidak'=>'Tidak','Ya'=>'Ya') , array('class'=>'riwayattransfusi_status','onkeyup'=>"return $(this).focusNextInputField(event)",'onclick'=>'setStatusRiwayattransfusi();')); ?>
                         </div>
                     </div>
                     <div class="control-group">
                         <label class="control-label"></label>
                         <div class="controls">
                           <div class="control-group ">
                               ...
                               <div class="controls">
                                   <?php echo $form->radioButtonList($modAsesmenawalkeperawatanT,'riwayattransfusi_isreaksi',array('Tidak'=>'Tidak','Ya'=>'Ya') , array('class'=>'riwayattransfusi_isreaksi disabledinputan','onkeyup'=>"return $(this).focusNextInputField(event)",'onclick'=>'setReaksiRiwayattransfusi();')); ?>
                               </div>
                           </div>
                           <div class="control-group">
                               <label class="control-label"></label>
