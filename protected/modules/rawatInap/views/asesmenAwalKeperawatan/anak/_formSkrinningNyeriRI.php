                            ...
                            <div class="control-group ">
                               ...
                               <div class="controls">
                                   <label class="checkbox inline">
                                       ...
                                       <div class="form-inline">
                                           <?php echo $form->checkboxRow($modAsesmenawalkeperawatanT,'isnyerihilangdgn_lainlain',array('onChange'=>'changeNyeriHilangLain(this);')); ?>
                              ...
                              <tbody>
                                 <tr>
                                     ...
                                     <th>
                                         ...
                                         <?php echo $form->dropDownList($modAsesmenawalkeperawatanT, 'skriningnyeribps_ekspresiwajahpenilaian_text', CHtml::listData(LookupM::model()->findAll("lookup_type = 'bps_ekspresiwajah'"), 'lookup_value', 'lookup_name'), array('empty' => '-- Pilih --', 'class' => 'span3','onchange' => 'venekpresi(this)')); ?>
                                     </th>
                                 ...
                                 <tr>
                                     ...
                                     <th>
                                         ...
                                         <?php echo $form->dropDownList($modAsesmenawalkeperawatanT, 'skriningnyeribps_ekstremitasataspenilaian_text', CHtml::listData(LookupM::model()->findAll("lookup_type = 'bps_ekstremitasatas'"), 'lookup_value', 'lookup_name'), array('empty' => '-- Pilih --', 'class' => 'span3','onchange' => 'venekstremitas(this)')); ?>
                                     </th>
                                 ...
                                 <tr>
                                     ...
                                     <th>
                                         ...
                                         <?php echo $form->dropDownList($modAsesmenawalkeperawatanT, 'skriningnyeribps_kepatuhanventilatorpenilaian_text', CHtml::listData(LookupM::model()->findAll("lookup_type = 'bps_kepatuhanventilator'"), 'lookup_value', 'lookup_name'), array('empty' => '-- Pilih --', 'class' => 'span3','onchange' => 'venpatuh(this)')); ?>
                                     </th>
