<table class="table border" style="color: #333;" id="master_falsccs">
	...
	?>
		<tr>
			...
			<td style="<?php echo !empty($det[1]['id'])?'border:4px solid #333 !important;':'' ?>" class="hover params-nilai1 borderflaccs">
				<?php 
			...
			<td style="<?php echo !empty($det[2]['id'])?'border:4px solid #333 !important;':'' ?>" class="hover params-nilai2 borderflaccs">
				<?php 
