          ...
          <table width="100%">
              <tr>
                  <td width="50%" valign="top">
                      <table width="100%" class="tablefont">
                          ...
                          <tr>
                              ...
                              <td width="5px" valign="top">:</td>
                              <td>
                                <span class="<?php echo ((!empty($model->riwayattransfusi_status) && ($model->riwayattransfusi_status=='Tidak'))?'fa fa-check-square-o':'fa fa-square-o'); ?>"></span> Tidak
                                <br/>
                                <span class="<?php echo ((!empty($model->riwayattransfusi_status) && ($model->riwayattransfusi_status=='Ya'))?'fa fa-check-square-o':'fa fa-square-o'); ?>"></span> Ya
                                <br/>
                                Reaksi Transfusi :
                                <span style="padding-left: 5px" class="<?php echo ((!empty($model->riwayattransfusi_isreaksi) && ($model->riwayattransfusi_isreaksi=='Tidak'))?'fa fa-check-square-o':'fa fa-square-o'); ?>"></span> Tidak
                                <span style="padding-left: 5px" class="<?php echo ((!empty($model->riwayattransfusi_isreaksi) && ($model->riwayattransfusi_isreaksi=='Ya'))?'fa fa-check-square-o':'fa fa-square-o'); ?>"></span> Ya
                                , reaksi yang timbul : <?php echo $model->riwayattransfusi_reaksiygtimbul; ?>
                              </td>
                          </tr>
                      </table>
                  </td>
                  <td width="50%" valign="top">
                      <table width="100%" class="tablefont">
                        <tr>
                            <td width="200px" valign="top">Riwayat Penyakit dalam Keluarga</td>
                            <td width="5px" valign="top">:</td>
     ...
     <div class="panel-heading">
      ...
      <div class="panel-body">
        <table width="100%" class="tablefont">
          ...
          <table width="100%" class="tablefont">
              <tr>
                  <td width="250px">Addtional Precaution yang harus dilakukan</td>
                  <td width="5px">:</td>
                  <td>
                    <?php
     ...
     <div class="panel-heading">
      ...
      <div class="panel-body">
        ...
        <?php }else{ ?>
          <table width="100%">
              <tr>
                <td colspan="2">Jenis Skrinning Status Fungsional : Kriteria Barthel Index</td>
              </tr>
              <tr>
                  <td width="60%">
