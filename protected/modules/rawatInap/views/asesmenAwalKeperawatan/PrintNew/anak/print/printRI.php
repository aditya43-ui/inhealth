...
<div style="padding: 5px;">
  ...
  <?php echo $this->renderPartial($this->path_view."PrintNew/anak/print/_printpage1_RI", array(
  ...
  <div style="page-break-before:always; page-break-after:always;">
    ...
    <br/> -->
    <?php echo $this->renderPartial($this->path_view."PrintNew/anak/print/_printpage2_RI", array(
  ...
  <!-- <div class="textbold headertext floatright">FRM/74C Rev 01/RSBM</div> -->
  <!-- <br/> -->
  <?php echo $this->renderPartial($this->path_view."PrintNew/anak/print/_printpage3_RI", array(
  ...
  <div style="page-break-before:always; page-break-after:always;">
    <!-- <div class="textbold headertext floatright">FRM/73C Rev 01/RSBM</div> -->
    <!-- <br/> -->
    <?php echo $this->renderPartial($this->path_view."PrintNew/anak/print/_printpage4_RI", array(
