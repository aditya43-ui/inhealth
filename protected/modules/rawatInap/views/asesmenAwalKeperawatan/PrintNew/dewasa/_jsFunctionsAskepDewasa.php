...
function skorskrinninggizi_dws(){
    ...
    $('.formDewasa').find('#<?php echo CHtml::activeId($model,'skrininggizidewasa_resiko') ?>').val(risDewasa);
    $('.formDewasa').find('#<?php echo CHtml::activeId($model,'skrininggizidewasa_tindakanygdilakukan') ?>').val(ketdewasa);
}
...
function choiseResikoJatuh_dws(obj){
    if($('.formDewasa').find(obj).val() == 0 && $('.formDewasa').find(obj).prop('checked')==true){
        inputAllEnabled($('.formDewasa').find('#panelresikojatuh_dewasa').find('.panel-body'));
        $('.formDewasa').find('#panelresikojatuh_dewasa').find('#resikojatuhdewasa').show();

        inputAllDisabled($('.formDewasa').find('#panelresikojatuh_anak').find('.panel-body'));
        $('.formDewasa').find('#panelresikojatuh_anak').find('#resikojatuhanak').hide();
        inputAllDisabled($('.formDewasa').find('#panelresikojatuh_lansia').find('.panel-body'));
        ...
        inputAllEnabled($('.formDewasa').find('#panelresikojatuh_anak').find('.panel-body'));
        $('.formDewasa').find('#panelresikojatuh_anak').find('#resikojatuhanak').show();

        inputAllDisabled($('.formDewasa').find('#panelresikojatuh_dewasa').find('.panel-body'));
        ...
        inputAllEnabled($('.formDewasa').find('#panelresikojatuh_lansia').find('.panel-body'));
...
function setChangeDetEdukasiLain_dws(obj){
    ...
    if($('.formDewasa').find(obj).prop('checked')==true){
        $('.formDewasa').find('#RIAsesmenkebutuhanEdukasidetT_'+index+'_edukasipasien_lainnya').attr('readonly',false);
    }else{
        $('.formDewasa').find('#RIAsesmenkebutuhanEdukasidetT_'+index+'_edukasipasien_lainnya').attr('readonly',true);
        $('.formDewasa').find('#RIAsesmenkebutuhanEdukasidetT_'+index+'_edukasipasien_lainnya').val('');
    }
}
...
function selectSumberData_dws(){
  if($('.formDewasa').find('#<?php echo CHtml::activeId($model, 'sumberdata'); ?>').val() == 'Lainnya'){
    $('.formDewasa').find('#<?php echo CHtml::activeId($model, 'sumberdata_lainnya'); ?>').attr('readonly',false);
  }else{
    $('.formDewasa').find('#<?php echo CHtml::activeId($model, 'sumberdata_lainnya'); ?>').val('');
    $('.formDewasa').find('#<?php echo CHtml::activeId($model, 'sumberdata_lainnya'); ?>').attr('readonly',true);
...
function changeMasalahPerkawinan_dws(){
  var index = 0;
  var indexLainnya = 0;
  $('.formDewasa').find('.neonatus_masalahperkawinanortu').each(function(){
    if($(this).val()=='Ada' &&  $(this).prop('checked')==true){
      $('.formDewasa').find('#<?php echo CHtml::activeId($model, 'neonatus_masalahperkawinanortuket'); ?>').attr('readonly',false);
      indexLainnya = 1;
    }else{
      index++;
    }
  ...
  if(index <= 2 && indexLainnya == 0){
    $('.formDewasa').find('#<?php echo CHtml::activeId($model, 'neonatus_masalahperkawinanortuket'); ?>').val('');
    $('.formDewasa').find('#<?php echo CHtml::activeId($model, 'neonatus_masalahperkawinanortuket'); ?>').attr('readonly',true);
  }
}

function changeKekerasanFisik_dws(){
  var index = 0;
  var indexLainnya = 0;
  $('.formDewasa').find('.neonatus_kekerasanfisikortu').each(function(){
    if($(this).val()=='Ada' &&  $(this).prop('checked')==true){
      $('.formDewasa').find('#<?php echo CHtml::activeId($model, 'kekerasanfisiket'); ?>').attr('disabled',false);
      indexLainnya = 1;
    }else{
      index++;
    }
  ...
  if(index <= 2 && indexLainnya == 0){
    $('.formDewasa').find('#<?php echo CHtml::activeId($model, 'kekerasanfisiket'); ?>').val('');
    $('.formDewasa').find('#<?php echo CHtml::activeId($model, 'kekerasanfisiket'); ?>').attr('disabled',true);
  }
}

function changeTraumaKehidupan_dws(){
  var index = 0;
  var indexLainnya = 0;
  $('.formDewasa').find('.neonatus_traumadlmhiduportu').each(function(){
    if($(this).val()=='Ada' &&  $(this).prop('checked')==true){
      $('.formDewasa').find('#<?php echo CHtml::activeId($model, 'neonatus_traumadlmhiduportuket'); ?>').attr('readonly',false);
      indexLainnya = 1;
    }else{
      index++;
    }
  ...
  if(index <= 2 && indexLainnya == 0){
    $('.formDewasa').find('#<?php echo CHtml::activeId($model, 'neonatus_traumadlmhiduportuket'); ?>').val('');
    $('.formDewasa').find('#<?php echo CHtml::activeId($model, 'neonatus_traumadlmhiduportuket'); ?>').attr('readonly',true);
  }
}

function pilihFungsional_dws(obj){
    if($('.formDewasa').find(obj).val() == 1 && $('.formDewasa').find(obj).prop('checked')==true){
        inputAllEnabled($('.formDewasa').find('#pilih_fungsional').find('.panel-body'));
        $('.formDewasa').find('#pilih_fungsional').find('.panel-body').find('.formFungsional').show();

        inputAllDisabled($('.formDewasa').find('#pilih_fungsionaladl').find('.panel-body'));
       $('.formDewasa').find('#pilih_fungsionaladl').find('.panel-body').find('.formFungsionalAdl').hide();
    }else if($('.formDewasa').find(obj).val() == 2 && $('.formDewasa').find(obj).prop('checked')==true){
        inputAllEnabled($('.formDewasa').find('#pilih_fungsionaladl').find('.panel-body'));
        $('.formDewasa').find('#pilih_fungsionaladl').find('.panel-body').find('.formFungsionalAdl').show();

        inputAllDisabled($('.formDewasa').find('#pilih_fungsional').find('.panel-body'));
        $('.formDewasa').find('#pilih_fungsional').find('.panel-body').find('.formFungsional').hide();
    }
}

function unpilihFungsional_dws(){
  inputAllDisabled($('.formDewasa').find('#pilih_fungsional').find('.panel-body'));
  $('.formDewasa').find('#pilih_fungsional').find('.panel-body').find('.formFungsional').hide();
...
function klikBtnAdl_dws(skor, type){
  if(type == 'bab'){
    $('.formDewasa').find('#<?php echo CHtml::activeId($modBarthelindex, 'skor_bab'); ?>').val(skor);
  }else if(type == 'bak'){
    $('.formDewasa').find('#<?php echo CHtml::activeId($modBarthelindex, 'skor_bak'); ?>').val(skor);
  }else if(type == 'kebersihan'){
    $('.formDewasa').find('#<?php echo CHtml::activeId($modBarthelindex, 'skor_kebersihanmandiri'); ?>').val(skor);
  }else if(type == 'penggunaanjamban'){
    $('.formDewasa').find('#<?php echo CHtml::activeId($modBarthelindex, 'skor_pengunaanjamban'); ?>').val(skor);
  }else if(type == 'makan'){
    $('.formDewasa').find('#<?php echo CHtml::activeId($modBarthelindex, 'skor_makan'); ?>').val(skor);
  }else if(type == 'sikap'){
    $('.formDewasa').find('#<?php echo CHtml::activeId($modBarthelindex, 'skor_sikap'); ?>').val(skor);
  }else if(type == 'pindah'){
    $('.formDewasa').find('#<?php echo CHtml::activeId($modBarthelindex, 'skor_berpindah'); ?>').val(skor);
  }else if(type == 'baju'){
    $('.formDewasa').find('#<?php echo CHtml::activeId($modBarthelindex, 'skor_baju'); ?>').val(skor);
  }else if(type == 'tangga'){
    $('.formDewasa').find('#<?php echo CHtml::activeId($modBarthelindex, 'skor_naikturuntangga'); ?>').val(skor);
  }else if(type == 'mandi'){
    $('.formDewasa').find('#<?php echo CHtml::activeId($modBarthelindex, 'skor_mandi'); ?>').val(skor);
  }

  var skor = 0;
  var keterangan = "";

  $('.formDewasa').find('#tblInputFungsionalAdl').find('.skinningfungsionaladl_skor').each(function(){
    var skorAdl = $('.formDewasa').find(this).val();
  ...
  $('.formDewasa').find('#tblInputFungsionalAdl').find('#<?php echo CHtml::activeId($model, 'skrinningfungsional_jumlah_skor'); ?>').val(skor);
  $('.formDewasa').find('#tblInputFungsionalAdl').find('#<?php echo CHtml::activeId($model, 'skrinningfungsional_keterangan'); ?>').val(keterangan);
}

function setStatusRiwayattransfusi_dws(){
  var index = 0;
  var indexLainnya = 0;
  $('.formDewasa').find('.riwayattransfusi_status').each(function(){
    if($(this).val()=='Ya' &&  $(this).prop('checked')==true){
      $('.formDewasa').find('#<?php echo CHtml::activeId($model, 'riwayattransfusi_reaksiygtimbul'); ?>').attr('disabled',false);
      $('.formDewasa').find('.riwayattransfusi_isreaksi').each(function(){
        $(this).attr('disabled',false);
      });
      indexLainnya = 1;
    }else{
  ...
  if(index <= 2 && indexLainnya == 0){
    $('.formDewasa').find('#<?php echo CHtml::activeId($model, 'riwayattransfusi_reaksiygtimbul'); ?>').val('');
    $('.formDewasa').find('#<?php echo CHtml::activeId($model, 'riwayattransfusi_reaksiygtimbul'); ?>').attr('disabled',true);
    $('.formDewasa').find('.riwayattransfusi_isreaksi').each(function(){
      $(this).attr('disabled',true);
      $(this).attr('checked',false);
    });
  }
  setReaksiRiwayattransfusi_dws();
}

function setReaksiRiwayattransfusi_dws(){
  var index = 0;
  var indexLainnya = 0;
  $('.formDewasa').find('.riwayattransfusi_isreaksi').each(function(){
    if($(this).val()=='Ya' &&  $(this).prop('checked')==true){
...
function setKesadaranNyeri_dws(){
  var indexLainnya = 0;
  $('.formDewasa').find('.kesadaranpasien_pengkajiannyeri').each(function(){
    if($(this).val()=='Sadar' &&  $(this).prop('checked')==true){
      $('.formDewasa').find('.panelsadar').show();
      $('.formDewasa').find('.paneltidaksadar').hide();
      indexLainnya += 1;
    }else if($(this).val()=='Tidak Sadar' &&  $(this).prop('checked')==true){
      $('.formDewasa').find('.panelsadar').hide();
      $('.formDewasa').find('.paneltidaksadar').show();
      indexLainnya += 1;
    }
  });
...
function venekpresi_dws(obj){
  if($('.formDewasa').find(obj).val() != ''){
    $('.formDewasa').find('#<?php echo CHtml::activeId($model,'skriningnyeribps_ekspresiwajahskor') ?>').val($(obj).val());
    $('.formDewasa').find('#<?php echo CHtml::activeId($model,'skriningnyeribps_ekspresiwajahpenilaian') ?>').val(obj.options[obj.selectedIndex].text);
  }else{
    $('.formDewasa').find('#<?php echo CHtml::activeId($model,'skriningnyeribps_ekspresiwajahskor') ?>').val(0);
  }
    skorventilator_dws();
}

function venekstremitas_dws(obj){
  if($('.formDewasa').find(obj).val() != ''){
    $('.formDewasa').find('#<?php echo CHtml::activeId($model,'skriningnyeribps_ekstremitasatasskor') ?>').val($(obj).val());
    $('.formDewasa').find('#<?php echo CHtml::activeId($model,'skriningnyeribps_ekstremitasataspenilaian') ?>').val(obj.options[obj.selectedIndex].text);
  }else{
    $('.formDewasa').find('#<?php echo CHtml::activeId($model,'skriningnyeribps_ekstremitasatasskor') ?>').val(0);
  }
    skorventilator_dws();
}

function venpatuh_dws(obj){
  if($('.formDewasa').find(obj).val() != ''){
    $('.formDewasa').find('#<?php echo CHtml::activeId($model,'skriningnyeribps_kepatuhanventilatorskor') ?>').val($(obj).val());
    $('.formDewasa').find('#<?php echo CHtml::activeId($model,'skriningnyeribps_kepatuhanventilatorpenilaian') ?>').val(obj.options[obj.selectedIndex].text);
  }else{
    $('.formDewasa').find('#<?php echo CHtml::activeId($model,'skriningnyeribps_kepatuhanventilatorskor') ?>').val(0);
  }
    skorventilator_dws();
}


function skorventilator_dws(){
    var totalSkor = 0;

    $('.formDewasa').find('#tbl_ventilator').find('.skor_ventilator').each(function(){
        var skor = $(this).val();
    ...
    $('.formDewasa').find('#<?php echo CHtml::activeId($model,'score_skalanyeri_dws') ?>').val(totalSkor);
    $('.formDewasa').find('#<?php echo CHtml::activeId($model,'keteranganskala_nyeri_dws') ?>').val(risDewasa);
}

function setJenisPernapasan_dws(obj){
  if($('.formDewasa').find(obj).prop('checked')==true){
    $('.formDewasa').find('#<?php echo CHtml::activeId($model,'b1jenispernapasan_lainnya') ?>').attr('disabled',false);
  }else{
    $('.formDewasa').find('#<?php echo CHtml::activeId($model,'b1jenispernapasan_lainnya') ?>').val('');
    $('.formDewasa').find('#<?php echo CHtml::activeId($model,'b1jenispernapasan_lainnya') ?>').attr('disabled',true);
  }
}

function setKesulitanbernafas_dws(){
  var index = 0;
  var indexLainnya = 0;
  $('.formDewasa').find('.b1_kesulitanbernafas').each(function(){
    if($(this).val()=='Ya' &&  $(this).prop('checked')==true){
      $('.formDewasa').find('#<?php echo CHtml::activeId($model, 'b1_jmloksigenperliter'); ?>').attr('disabled',false);
      $('.formDewasa').find('.b1_jenisterapioksigen').each(function(){
        $(this).attr('disabled',false);
      });
      indexLainnya = 1;
    }else{
  ...
  if(index <= 2 && indexLainnya == 0){
    $('.formDewasa').find('#<?php echo CHtml::activeId($model, 'b1_jmloksigenperliter'); ?>').val('');
    $('.formDewasa').find('#<?php echo CHtml::activeId($model, 'b1_jmloksigenperliter'); ?>').attr('disabled',true);
    $('.formDewasa').find('.b1_jenisterapioksigen').each(function(){
      $(this).attr('disabled',true);
      $(this).attr('checked',false);
    });
...
function setB2isoedem_dws(){
  var index = 0;
  var indexLainnya = 0;
  $('.formDewasa').find('.b2_isoedem').each(function(){
    if($(this).val()==1 &&  $(this).prop('checked')==true){
      $('.formDewasa').find('#<?php echo CHtml::activeId($model, 'b2_lokasioedem'); ?>').attr('disabled',false);
      indexLainnya = 1;
    }else{
      index++;
    }
  ...
  if(index <= 2 && indexLainnya == 0){
    $('.formDewasa').find('#<?php echo CHtml::activeId($model, 'b2_lokasioedem'); ?>').val('');
    $('.formDewasa').find('#<?php echo CHtml::activeId($model, 'b2_lokasioedem'); ?>').attr('disabled',true);
  }
}

function setB5Nyeritekan_dws(){
  var index = 0;
  var indexLainnya = 0;
  $('.formDewasa').find('.b5_abdomen_isnyeritekan').each(function(){
    if($(this).val()==1 && $(this).prop('checked')==true){
      $('.formDewasa').find('#<?php echo CHtml::activeId($model, 'b5_abdomen_nyeritekanlokasi'); ?>').attr('disabled',false);
      indexLainnya = 1;
    }else{
      index++;
    }
  ...
  if(index <= 2 && indexLainnya == 0){
    $('.formDewasa').find('#<?php echo CHtml::activeId($model, 'b5_abdomen_nyeritekanlokasi'); ?>').val('');
    $('.formDewasa').find('#<?php echo CHtml::activeId($model, 'b5_abdomen_nyeritekanlokasi'); ?>').attr('disabled',true);
  }
}

function setB6Fraktur_dws(){
  var index = 0;
  var indexLainnya = 0;
  $('.formDewasa').find('.b6_isfraktur').each(function(){
    if($(this).val()=='Ya' &&  $(this).prop('checked')==true){
      $('.formDewasa').find('#<?php echo CHtml::activeId($model, 'b6_lokasifraktur'); ?>').attr('disabled',false);
      $('.formDewasa').find('.b6_jenisfraktur').each(function(){
        $(this).attr('disabled',false);
      });
      indexLainnya = 1;
    }else{
  ...
  if(index <= 2 && indexLainnya == 0){
    $('.formDewasa').find('#<?php echo CHtml::activeId($model, 'b6_lokasifraktur'); ?>').val('');
    $('.formDewasa').find('#<?php echo CHtml::activeId($model, 'b6_lokasifraktur'); ?>').attr('disabled',true);
    $('.formDewasa').find('.b6_jenisfraktur').each(function(){
      $(this).attr('disabled',true);
      $(this).attr('checked',false);
    });
...
function setB6ResikoDekubitus_dws(){
  var index = 0;
  var indexLainnya = 0;
  $('.formDewasa').find('.b6_isresikodekubitus').each(function(){
    if($(this).val()==1 &&  $(this).prop('checked')==true){
      $('.formDewasa').find('#<?php echo CHtml::activeId($model, 'b6_skorbraden'); ?>').attr('disabled',false);
      indexLainnya = 1;
    }else{
      index++;
    }
  ...
  if(index <= 2 && indexLainnya == 0){
    $('.formDewasa').find('#<?php echo CHtml::activeId($model, 'b6_skorbraden'); ?>').val('');
    $('.formDewasa').find('#<?php echo CHtml::activeId($model, 'b6_skorbraden'); ?>').attr('disabled',true);
  }
}

function setB6Luka_dws(){
  var index = 0;
  var indexLainnya = 0;
  $('.formDewasa').find('.b6_isluka').each(function(){
    if($(this).val()==1 &&  $(this).prop('checked')==true){
      $('.formDewasa').find('#<?php echo CHtml::activeId($model, 'b6_lokasiluka'); ?>').attr('disabled',false);
      indexLainnya = 1;
    }else{
      index++;
    }
  ...
  if(index <= 2 && indexLainnya == 0){
    $('.formDewasa').find('#<?php echo CHtml::activeId($model, 'b6_lokasiluka'); ?>').val('');
    $('.formDewasa').find('#<?php echo CHtml::activeId($model, 'b6_lokasiluka'); ?>').attr('disabled',true);
  }
}
...
$(document).ready(function(){
   $('.formDewasa').find('.groupUkurans').find('input').keyup(function(){
    ...
    selectSumberData_dws();
    changeMasalahPerkawinan_dws();
    changeKekerasanFisik_dws();
    changeTraumaKehidupan_dws();

    setStatusRiwayattransfusi_dws();
    setKesadaranNyeri_dws();
    setKesulitanbernafas_dws();
    setB2isoedem_dws();
    setB5Nyeritekan_dws();
    setB6Fraktur_dws();
    setB6ResikoDekubitus_dws();
    setB6Luka_dws();


    var indexSknFungsional = 0;
    $('.formDewasa').find('.pilih_fungsional').each(function(){
        pilihFungsional_dws($(this));

        if(($('.formDewasa').find(this).val() == 1 || $('.formDewasa').find(this).val() == 2) && $('.formDewasa').find(this).prop('checked')==false){
          indexSknFungsional++;
        }
    });

    if(indexSknFungsional==2){
        unpilihFungsional_dws();
    }
