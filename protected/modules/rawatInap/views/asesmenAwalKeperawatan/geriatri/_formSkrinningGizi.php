...
<div class="row-fluid">
     <div class="panel panel-primary panel-success">
        <div class="panel-heading">
            <div class="panel-title"><?php echo $form->radioButton($modAsesmenawalkeperawatanT, 'isskrinninggizidewasa', array('onclick' => 'choiseSkrinningGizi_geriatri(this)', 'value' => 1, 'class'=>'pilih_SkrinningGizi', 'uncheckValue'=>null)); ?> <strong>Skrinning Gizi Dewasa (Metode Malnutrition Skrinning Tools/ MST)</strong></div>
        </div>
                         ...
                         <tbody>
                            ...
                            <tr>
                                ...
                                <th>
                                    ...
                                    <?php echo $form->dropDownList($modAsesmenawalkeperawatanT,'skrinninggizi_jwb_asupanmakanan_dewasa_text',array('1'=>'Ya','0'=>'Tidak'), array('empty' => '-- Pilih --', 'class' => 'jeniskelaminAnak span3', 'onkeypress' => "return $(this).focusNextInputField(event);",'onchange'=>'skrinninggizidewasa_asupan_geriatri(this)'));?>
                                </th>
             ...
             <div class="control-group ">
                     ...
                     <div class="controls">
                             <div class="groupUkurans">
                                     ...
                                     <?php echo CHtml::dropDownList('meter', '100', array('100'=>'Cm', '0.01'=>'M'), array('style'=>'width:50px;','class'=>'span1', 'onchange'=>'gantiJumlah_geriatri(this)')); ?>
                             </div>
                     </div>
             </div>
             <div class="control-group ">
                     ...
                     <div class="controls">
                             <div class="groupUkurans">
                                     ...
                                     <?php echo CHtml::dropDownList('gram', '0.001', array('1000'=>'Gr', '0.001'=>'Kg'), array('class'=>'span1', 'onchange'=>'gantiJumlah_geriatri(this)')); ?>
                             </div>
                     </div>
             </div>
             <div class="control-group ">
