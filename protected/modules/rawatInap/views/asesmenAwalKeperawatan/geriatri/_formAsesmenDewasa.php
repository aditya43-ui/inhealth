			...
			<table width='100%'>
				...
				<tr>
					...
					<?php
						...
						for($i=0;$i<=10;$i++){
					?>
						<td onclick="pilihScala_geriatri(<?php echo $i; ?>)" width='<?php echo ($i == 10)?'1%':'8%'; ?>'><a style="position:relative; left:-5px;" onclick="pilihScala_geriatri(<?php echo $i; ?>)" class="hover"><span style="padding: 4px;" class="nyeri-nomor" id="nyerinomor_<?php echo $i; ?>" ><?php echo $i; ?></span></a></td>
					<?php
						}
					?>
				</tr>
