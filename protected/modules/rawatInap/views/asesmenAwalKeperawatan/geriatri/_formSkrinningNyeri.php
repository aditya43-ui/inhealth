         ...
         <div class="panel-body">
           <div class="row">
             ...
             <div class="panel panel-success panel_nyeri panelsadar" id="nyeri_dewasa" >
                <div class="panel-heading">
                    <div class="panel-title"><?php echo $form->radioButton($modAsesmenawalkeperawatanT, 'is_keluhannyeri_dewasa', array('onclick' => 'pilihNyeri_geriatri(this)', 'value' => 1, 'class'=>'pilih_nyeri', 'uncheckValue'=>null)); ?> Asesmen Nyeri Dewasa</div>
                </div>
                <div class="panel-body" >
                    ...
                    <br/>
                    <?php
                    echo $this->renderPartial($this->path_view . 'geriatri/_formAsesmenDewasa', array(
                        'form' => $form,
                ...
                <div class="row">
                    <div class="col-sm-6">
                      <div class="control-group">
                          ...
                          <div class="controls">
                              <?php echo $form->radioButtonList($modAsesmenawalkeperawatanT,'isadakeluhannyeri', array('Tidak'=>'Tidak','Ya'=>'Ya'), array('class'=>'isadakeluhannyeri','onkeyup'=>"return $(this).focusNextInputField(event)", 'onchange'=>'setAdaNyeri_geriatri();')); ?>
                          </div>
                      </div>
                      <div class="control-group">
                    ...
                    <div class="row-fluid">
                        <div class="col-md-6">
                          <div class="control-group ">
                  					...
                  					<?php echo $form->dropDownList($modAsesmenawalkeperawatanT, 'deskripsinyeri_onsetsatuan', array('Jam'=>'Jam','Hari'=>'Hari', 'Minggu'=>'Minggu', 'Bulan'=>'Bulan', 'Tahun'=>'Tahun'), array('class'=>'span2', 'empty'=>'-- Pilih --')); ?>
                  					</div>
                  				</div>
                          <div class="control-group ">
                                     ...
                                     foreach($lookupKualitas as $i => $look_risiko){
                                      ...
                                      $htmlKualitas .= CHtml::hiddenField('KualitasNyeri['.$i.'][nama]',$look_risiko->lookup_value);
                                       if($look_risiko->lookup_value == 'Lainnya'){
                                         $htmlKualitas .= CHtml::checkBox('KualitasNyeri['.$i.'][isKualitas]',false , array('datavalue'=>$look_risiko->lookup_value,'class'=>'kualitasnyeri disabledinputan','onchange'=>'setKualitasNyeri_geriatri()')).' <label>'.$look_risiko->lookup_name.'</label>';
                        ...
                        <div class="col-md-6">
                            <table width="100%">
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <div class="controls">
                                            <?php echo $form->radioButtonList($modAsesmenawalkeperawatanT,'deskripsinyeri_ismenjalar',array(0=>'Tidak',1=>'Ya') , array('class'=>'deskripsinyeri_ismenjalar','onkeyup'=>"return $(this).focusNextInputField(event)",'onclick'=>'changeDeskripsinyeri_ismenjalar_geriatri();')); ?>
                                       </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="controls">
                                            <?php echo  $form->textField($modAsesmenawalkeperawatanT,'deskripsinyeri_lokasipenjalaran', array('class'=>'span3 disabledinputan', 'onkeypress'=>"return $(this).focusNextInputField(event);")); ?>
                                        </div>
                                    </td>
                                    <td></td>
                                </tr>
                                      ...
                                      if(count((array)$lookupFrekuensi) >0 ){
                                        ...
                                        foreach($lookupFrekuensi as $i => $look_risiko){
                                         ...
                                         $htmlFrekuensi .= CHtml::hiddenField('FrekuensiNyeri['.$i.'][nama]',$look_risiko->lookup_value);
                                          if($look_risiko->lookup_value == 'Lainnya'){
                                            $htmlFrekuensi .= CHtml::checkBox('FrekuensiNyeri['.$i.'][isFrekuensi]',false , array('datavalue'=>$look_risiko->lookup_value,'class'=>'frekuensinyeri','onchange'=>'setFrekuensiNyeri_geriatri()')).' <label>'.$look_risiko->lookup_name.'</label>';
                            ...
                            <div class="control-group ">
                              <?php echo CHtml::label('Nyeri Hilang Dengan','', array('class'=>'control-label')) ?>
                               <div class="controls">
                                   <!-- <label class="checkbox inline"> -->
                                       <?php echo $form->checkbox($modAsesmenawalkeperawatanT,'isnyerihilangdgn_minumobat',array()); ?> <label>Minum Obat</label>
                                       <br/>
                                       <?php echo $form->checkbox($modAsesmenawalkeperawatanT,'isnyerihilangdgn_berubahposisi',array()); ?> <label>Berubah posisi/ tidur</label>
                                       <br/>
                                       <?php echo $form->checkbox($modAsesmenawalkeperawatanT,'isnyerihilangdgn_istirahat',array()); ?> <label>Istirahat</label>
                                       <br/>
                                       <?php echo $form->checkbox($modAsesmenawalkeperawatanT,'isnyerihilangdgn_dengarmusik',array()); ?> <label>Mendengarkan Musik</label>
                                       <!-- <div class="form-inline"> -->
                                       <br/>
                                           <?php echo $form->checkbox($modAsesmenawalkeperawatanT,'isnyerihilangdgn_lainlain',array('onChange'=>'changeNyeriHilangLain_geriatri(this);')); ?> <label>Lain-lain</label>
                                           <br/>
                              ...
                              <tbody>
                                 <tr>
                                     ...
                                     <th>
                                         ...
                                         <?php echo $form->dropDownList($modAsesmenawalkeperawatanT, 'skriningnyeribps_ekspresiwajahpenilaian_text', CHtml::listData(LookupM::model()->findAll("lookup_type = 'bps_ekspresiwajah'"), 'lookup_value', 'lookup_name'), array('empty' => '-- Pilih --', 'class' => 'span3','onchange' => 'venekpresi_geriatri(this)')); ?>
                                     </th>
                                 ...
                                 <tr>
                                     ...
                                     <th>
                                         ...
                                         <?php echo $form->dropDownList($modAsesmenawalkeperawatanT, 'skriningnyeribps_ekstremitasataspenilaian_text', CHtml::listData(LookupM::model()->findAll("lookup_type = 'bps_ekstremitasatas'"), 'lookup_value', 'lookup_name'), array('empty' => '-- Pilih --', 'class' => 'span3','onchange' => 'venekstremitas_geriatri(this)')); ?>
                                     </th>
                                 ...
                                 <tr>
                                     ...
                                     <th>
                                         ...
                                         <?php echo $form->dropDownList($modAsesmenawalkeperawatanT, 'skriningnyeribps_kepatuhanventilatorpenilaian_text', CHtml::listData(LookupM::model()->findAll("lookup_type = 'bps_kepatuhanventilator'"), 'lookup_value', 'lookup_name'), array('empty' => '-- Pilih --', 'class' => 'span3','onchange' => 'venpatuh_geriatri(this)')); ?>
                                     </th>
