         ...
         <div class="panel-body">
             <div class="row-fluid">
                 <div class="col-sm-6">
                    ...
                    <div class="control-group ">
                       <?php echo $form->labelEx($modAsesmenawalkeperawatanT, 'kondisiumum', array('class' => 'control-label', 'label'=>'Keadaan Umum')) ?>
                       <div class="controls">
                           <?php
                                   $this->widget('application.extensions.FCBKcomplete.FCBKcomplete',array(
                                           'model'=>$modAsesmenawalkeperawatanT,
                                           'attribute'=>'kondisiumum_geriatri',
                     ...
                     <div class="panel panel-success panel-shadow">
                        ...
                        <div class="panel-body">
                            <div class="control-group ">
                                ...
                                <div class="controls">
                                 <?php  echo $form->textField($modAsesmenawalkeperawatanT,'td_systolic',array('class'=>'span1 numbersOnly systolic', 'onkeypress'=>"return $(this).focusNextInputField(event);", 'maxlength'=>3, 'onkeyup'=>'returnValue_geriatri(this); getText_geriatri();', 'style'=>'text-align: right;'));?>Mm
                                 <?php echo $form->textField($modAsesmenawalkeperawatanT,'td_diastolic',array('onblur'=>'','readonly'=>false,'class'=>'span1 numbersOnly diastolic', 'onkeypress'=>"return $(this).focusNextInputField(event);", 'maxlength'=>3, 'onkeyup'=>'returnValue_geriatri(this); getText_geriatri();', 'style'=>'text-align: right;')); ?>Hg
                                </div>
                            </div>
                            <div class="control-group ">
                            ...
                            <div class="control-group ">
                                    ...
                                    <div class="controls">
                                            <?php
                                                    echo $form->dropDownList($modAsesmenawalkeperawatanT, 'denyutjantung', CHtml::listData(LookupM::model()->findAllByAttributes(array('lookup_type'=>Params::LOOKUPTYPE_DENYUTJANTUNG),array('order'=>'lookup_name ASC')), 'lookup_value', 'lookup_name'), array('empty'=>'-- Pilih --','class'=>'span3'));
                                            ?>
                                    </div>
                            </div>
                            <div class="control-group ">
