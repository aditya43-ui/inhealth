<div class="row-fluid">
   <div class="panel panel-primary panel-gradient">
      <div class="panel-heading">
          <div class="panel-title"><strong>Psiko-Sosial-Spritual-Ekonomi</strong></div>
      </div>
         ...
         <div class="row">
             <div class="col-sm-6">
               ...
               <div class="control-group">
                   ...
                   <div class="controls">
                       <?php echo $form->radioButtonList($modAsesmenawalkeperawatanT,'isada_anak', array('Tidak Ada'=>'Tidak Ada','Ada'=>'Ada'), array('class'=>'isada_anak','onkeyup'=>"return $(this).focusNextInputField(event)", 'onchange'=>'setAnak_obgyn();')); ?>
                   </div>
               </div>
               <div class="control-group">
               ...
               <div class="control-group">
                   ...
                   <div class="controls">
                       <?php echo $form->dropDownList($modAsesmenawalkeperawatanT,'neonatus_tinggalbersama', LookupM::getItems('asesmen_tinggalbersama'),array('class'=>'span3', 'empty'=>'-- Pilih --','onkeypress'=>"return $(this).focusNextInputField(event);",'onchange'=>'changeTinggalBersama_obgyn(this);')); ?>
                   </div>
               </div>
               <div class="control-group">
                  ...
                  <div class="controls">
                    <div class="radio inline">
                      <div class="form-inline">
                        <?php echo $form->radioButtonList($modAsesmenawalkeperawatanT,'statusmerokok',array('0'=>'Tidak','1'=>'Ya'), array('onkeyup'=>"return $(this).focusNextInputField(event)",'class'=>'statusrokok','onclick'=>'setJumlahRokok_obgyn(this);','labelOptions'=>array('style'=> 'padding-left:5px;padding-right:10px;'))); ?>
                      </div>
                    </div>
                  </div>
                </div>
             ...
             <div class="col-sm-6">
               <div class="control-group">
                   ...
                   <div class="controls">
                       <?php echo $form->radioButtonList($modAsesmenawalkeperawatanT,'masalahdlm_berbicara', array('Tidak'=>'Tidak','Ya'=>'Ya'), array('class'=>'masalahdlm_berbicara','onkeyup'=>"return $(this).focusNextInputField(event)", 'onchange'=>'setMasalahDlmBerbicara_obgyn();')); ?>
                   </div>
               </div>
               <div class="control-group">
                   <label class="control-label"></label>
               ...
               <div class="control-group ">
                   ...
                   <div class="controls">
                       <?php echo $form->radioButtonList($modAsesmenkebutuhanEdukasiT,'bahasaseharihari_jenis',array('Indonesia'=>'Bahasa Indonesia','Daerah'=>'Bahasa Daerah') , array('class'=>'bahasaseharihari_jenis','onkeyup'=>"return $(this).focusNextInputField(event)",'onclick'=>'setEduBahasaSehari_obgyn(this);')); ?>
                   </div>
               </div>
              <div class="control-group">
                 <label class="control-label"></label>
             ...
             <div class="control-group ">
                 ...
                 <div class="controls">
                     <?php echo $form->radioButton($modAsesmenkebutuhanEdukasiT,'kebutuhanpenerjemah_status',array('class'=>'kebutuhanpenerjemah_status','value'=>'Tidak','onkeypress'=>"return $(this).focusNextInputField(event);",'onclick'=>'setEdukasiPenerjemah_obgyn(this);','uncheckValue'=>null)); ?> <label>Tidak</label>
                 </div>
             </div>
              <div class="control-group ">
                 <label class="control-label"></label>
                 <div class="controls">
                     <?php echo $form->radioButton($modAsesmenkebutuhanEdukasiT,'kebutuhanpenerjemah_status',array('class'=>'kebutuhanpenerjemah_status','value'=>'Ya','onkeypress'=>"return $(this).focusNextInputField(event);",'onclick'=>'setEdukasiPenerjemah_obgyn(this);','uncheckValue'=>null)); ?> <label>Ya, Bahasa</label>
