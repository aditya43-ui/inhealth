         ...
         <div class="panel-body">
             <div class="col-md-6">
               <div class="control-group ">
                  ...
                  <div class="controls">
                      <?php echo $form->radioButtonList($modAsesmenawalkeperawatanT,'kontrolrisikoinfeksi_status',array('Tidak Diketahui'=>'Tidak Diketahui','Suspect'=>'Suspect','Diketahui'=>'Diketahui') , array('onkeyup'=>"return $(this).focusNextInputField(event)",'class'=>'kontrolrisikoinfeksi_status','onclick'=>'setStatusKontrolRisiko_obgyn();')); ?>
                  </div>
              </div>
              <div class="control-group ">
                               ...
                               foreach($lookupJenisRisiko as $i => $look_risiko){
                                ...
                                $htmlRisiko .= CHtml::hiddenField('RisikoInfeksi['.$i.'][jenisrisiko]',$look_risiko->lookup_value);
                                 if($look_risiko->lookup_value == 'Lainnya'){
                                   $htmlRisiko .= CHtml::checkBox('RisikoInfeksi['.$i.'][isRisiko]',false , array('datavalue'=>$look_risiko->lookup_value,'class'=>'jenisrisiko disabledinputan','onchange'=>'setJenisRisikoLainnya_obgyn(this)')).' <label>'.$look_risiko->lookup_name.'</label>';
