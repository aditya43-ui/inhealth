                 ...
                 <div class="control-group ">
                    ...
                    <div class="controls">
                      <div class="control-group ">
                         ...
                         <div class="controls">
                           <?php echo $form->radioButtonList($modAsesmenawalkeperawatanT,'obgyn_antenatalcare_tempat',array('Dokter Kandungan'=>'Dokter Kandungan','Dokter Umum'=>'Dokter Umum','Bidan'=>'Bidan','Lainnya'=>'Lainnya') , array('onkeyup'=>"return $(this).focusNextInputField(event)",'class'=>'obgyn_antenatalcare_tempat disabledinputan','onclick'=>'setTempatAnteCare_obgyn();')); ?>
                           <br/>
