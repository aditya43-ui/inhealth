                    ...
                    <table width="100%" class="tablefont">
                        <tr>
                            ...
                            <td>
                              ...
                              <br/><span style="padding-left: 15px"></span> Di :
                              ...
                              <br/><span style="padding-left: 42px" class="<?php echo ((!empty($model->obgyn_statuskawin) && ($model->obgyn_statuskawin =='Dokter Umum'))?'fa fa-check-square-o':'fa fa-square-o'); ?>"></span> Dokter Umum
                              <br/><span style="padding-left: 42px" class="<?php echo ((!empty($model->obgyn_statuskawin) && ($model->obgyn_statuskawin =='Bidan'))?'fa fa-check-square-o':'fa fa-square-o'); ?>"></span> Bidan
                              <br/><span style="padding-left: 42px" class="<?php echo ((!empty($model->obgyn_statuskawin) && ($model->obgyn_statuskawin =='Lainnya'))?'fa fa-check-square-o':'fa fa-square-o'); ?>"></span> Lainnya
