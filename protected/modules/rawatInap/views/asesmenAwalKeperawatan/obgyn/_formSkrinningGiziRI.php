                         ...
                         <tbody>
                            ...
                            <tr>
                                ...
                                <th>
                                    ...
                                    <?php echo $form->dropDownList($modAsesmenawalkeperawatanT,'skrinninggizi_jwb_asupanmakanan_dewasa_text',array('1'=>'Ya','0'=>'Tidak'), array('empty' => '-- Pilih --', 'class' => 'jeniskelaminAnak span3', 'onkeypress' => "return $(this).focusNextInputField(event);",'onchange'=>'skrinninggizidewasa_asupan_obgyn(this)'));?>
                                </th>
             ...
             <div class="control-group ">
                     ...
                     <div class="controls">
                             <div class="groupUkurans">
                                     ...
                                     <?php echo CHtml::dropDownList('meter', '100', array('100'=>'Cm', '0.01'=>'M'), array('style'=>'width:50px;','class'=>'span1', 'onchange'=>'gantiJumlah_obgyn(this)')); ?>
                             </div>
                     </div>
             </div>
             <div class="control-group ">
                     ...
                     <div class="controls">
                             <div class="groupUkurans">
                                     ...
                                     <?php echo CHtml::dropDownList('gram', '0.001', array('1000'=>'Gr', '0.001'=>'Kg'), array('class'=>'span1', 'onchange'=>'gantiJumlah_obgyn(this)')); ?>
                             </div>
                     </div>
             </div>
             <div class="control-group ">
