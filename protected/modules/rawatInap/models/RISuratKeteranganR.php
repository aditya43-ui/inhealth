...
class RISuratKeteranganR extends SuratketeranganR
{
	/**
...
//      RSSP-669
        public function getNoSuratKematian($ruangan_id)
        {
            ...
            $tahun = date('Y');
            $default="001";
            $sql = "SELECT cast(max(substr(nomorsurat,5,3)) AS integer) nomer FROM suratketerangan_r WHERE ruangan_id=".$ruangan_id." AND date_part('year', tglsurat)='".$tahun."'"." AND date_part('month', tglsurat)='".$bln."' AND jenissurat_id = 3";
