<?php
/**
 * model ini digunakan untuk meload tabel bukuregisterri_v, pada modul rawat inap
 * 
...
class RIBukuregisterriV extends BukuregisterriV {
    ...
    */
    public static function criteriaGrafik($model, $type='data', $addCols = array()){
        ...
        if (!empty($model->penjamin_id) || !empty($model->carabayar_id)) {
    ...
    /**
     * pencarian data, yang datanya ditampilkan dalam bentuk prinout
     * @return \CActiveDataProvider
     */
