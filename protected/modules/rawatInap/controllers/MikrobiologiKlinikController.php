...
class MikrobiologiKlinikController extends MyAuthController
{
    ...
    protected $path_view = 'rawatInap.views.mikrobiologiKlinik.';
    ...
    public function actionIndex($pendaftaran_id, $idPasienKirimKeUnitLain = null)
    {
        ...
        $modMorbiditas = RIPasienMorbiditasT::model()->findByAttributes(array('kelompokdiagnosa_id' => 2, 'pendaftaran_id' => $modPendaftaran->pendaftaran_id, 'pasien_id' => $modPasien->pasien_id), array('order' => 'create_time DESC'));
        ...
        $modPeriksaLab = RIPemeriksaanLabM::model()->findAllByAttributes(array('pemeriksaanlab_aktif' => true), array('order' => 'jenispemeriksaanlab_id, pemeriksaanlab_urutan'));
    ...
    /**
     * method untuk menyimpan data pasien ke unit lain RIPasienKirimkeUnitLainT
     * digunakan di :
     * 1. rawatJalan/laboratorium/index
    ...
    protected function savePasienKirimKeUnitLain($modPendaftaran, $ruangan_lab, $instalasi_lab)
    {
        ...
        // var_dump($modKirimKeUnitLain->attributes, $_POST['RIPasienKirimKeUnitLainT']); die;
