<?php
class KehilanganLinenController extends MyAuthController
{
  public $layout = '//layouts/column1';
  public $penerimaanLinen = false;
  public $penerimaanLinenDet = true;

  public $path_view = 'laundry.views.kehilanganLinen.';
  ...
  public function actionIndex($id = null, $linkHalaman = null)
  {
    ...
    $modDetail->jenisperawatanlinen = Params::JENISPERAWATAN_KEHILANGAN;
    $modDetail->jumlah = 1;
    ...
    if (isset($_POST['LAPenerimaanlinenT'])) {
      ...
      try {
        ...
        $this->notifKehilanganLinen($modPenerimaan);
  ...
  public function notifKehilanganLinen($model)
  {

    $ruangan = RuanganM::model()->findByPk(Yii::app()->user->getState('ruangan_id'));
    $tujuan = RuanganM::model()->findByPk(Params::RUANGAN_ID_LAUNDRY);

    $judul = "Kehilangan Linen";
    $isi = "Tanggal : " . MyFormatter::formatDateTimeForuser($model->tglpenerimaanlinen) . '<br/>';
    $isi .= "Nomor : " . $model->nopenerimaanlinen . '<br/>';
    $isi .= "Ruangan Kehilangan : " . $ruangan->ruangan_nama . '<br/>';
    $isi .= "Keterangan : " . $model->keterangan_penerimaanlinen . '<br/>';
  ...
  public function actionPrint($penerimaanlinen_id, $caraPrint = null)
  {
    ...
    if ($caraPrint == 'PRINT') {
      ...
      $this->render($this->path_view . 'Print', array('format' => $format, 'judul_print' => $judul_print, 'deskripsi' => $deskripsi, 'modPenerimaanLinen' => $modPenerimaanLinen, 'modPenerimaanLinenDetail' => $modPenerimaanLinenDetail, 'caraPrint' => $caraPrint));
      ...
      $mpdf->WriteHTML($this->renderPartial($this->path_view . 'Print', array('format' => $format, 'judul_print' => $judul_print, 'deskripsi' => $deskripsi, 'modPenerimaanLinen' => $modPenerimaanLinen, 'modPenerimaanLinenDetail' => $modPenerimaanLinenDetail, 'caraPrint' => $caraPrint), true));
      $mpdf->Output();
    }
  }
}
