<?php
class PenerimaanCuciLinenLangsungController extends MyAuthController
{
  public $layout = '//layouts/column1';
  public $penerimaanLinen = false;
  public $penerimaanLinenDet = true;

  public $path_view = 'laundry.views.penerimaanCuciLinenLangsung.';
  public $path_view_tips = 'laundry.views.penerimaanLinenT.';

  public function actionIndex($id = null)
  {
    $this->pageTitle = Yii::app()->name . " - Penerimaan Pencucian Linen Langsung";
    ...
    $modDetail->jenisperawatanlinen = Params::JENISPERAWATAN_PENCUCIAN;
    $modDetail->jumlah = 1;
    ...
    if (isset($_POST['LAPenerimaanlinenT'])) {
      ...
      try {
        ...
        if ($this->penerimaanLinen && $this->penerimaanLinenDet) {
          ...
          Yii::app()->user->setFlash('error', "Data Penerimaan Pencucian Linen Langsung gagal disimpan !");
        }
      } catch (Exception $e) {
        $transaction->rollback();
        Yii::app()->user->setFlash('error', "Data Penerimaan Pencucian Linen Langsung gagal disimpan ! " . MyExceptionMessage::getMessage($e, true));
      }
    }
  ...
  public function actionPrint($penerimaanlinen_id, $caraPrint = null)
  {
    ...
    $judul_print = 'Penerimaan Pencucian Linen Langsung';
