...
$form = $this->beginWidget('ext.bootstrap.widgets.BootActiveForm', array(
    ...
    'type' => 'horizontal',
    'focus' => '#' . CHtml::activeId($model, 'nopenyimpananlinen'),
));
?>
<div class="row">
    <div class="col-sm-6">
        ...
        <div class="control-group">
            <?php echo CHtml::activeLabel($model, 'nopenyimpananlinen', array('class' => 'control-label')); ?>
            <div class="controls">
                <?php echo $form->textField($model, 'nopenyimpananlinen', array('placeholder' => 'No. Penyimpanan', 'class' => 'span4', 'maxlength' => 20, 'onkeypress' => "return $(this).focusNextInputField(event)")); ?>
            </div>
        </div>
    </div>
    <div class="col-sm-6">
