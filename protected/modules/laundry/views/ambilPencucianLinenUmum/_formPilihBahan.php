<div class="row">
    <div class="col-sm-6">
        <div class="control-group">
            <?php echo CHtml::label('Nama Bahan Disinfeksi', 'namalinen', array('class' => 'control-label')); ?>
            <div class="controls">
    ...
    <div class="col-sm-6">
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo CHtml::dropDownList('satuan', 'satuan', CHtml::listData(LASatuankecilM::model()->findAll("satuankecil_aktif = TRUE ORDER BY satuankecil_nama ASC"), 'satuankecil_nama', 'satuankecil_nama'), array('empty' => '-- Pilih --', 'class' => 'span3', 'onkeyup' => "return $(this).focusNextInputField(event)")); ?>
                <?php
...
<?php
//========= Dialog buat cari data bahan perawatan =========================
