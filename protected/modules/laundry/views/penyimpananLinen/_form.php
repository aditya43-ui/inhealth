...
//                                'maxDate' => 'd',
        ...
        <?php
        echo $form->textFieldRow($modPenyimpananLinen, 'nopenyimpananlinen', array('class' => 'span3', 'onkeyup' => "return $(this).focusNextInputField(event);", 'maxlength' => 20, 'readonly' => true));
        ?>
    </div>
    <div class="col-sm-6">
        <div class="control-group">
