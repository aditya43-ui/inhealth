    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="control-group">
                ...
                <div class="controls">
                    <?php echo $form->textField($modInfoPencucian, 'tglpenerimaanlinen', array('onkeypress' => "return $(this).focusNextInputField(event)", 'class' => 'span3', 'readonly' => true)); ?>
                   <?php echo $form->hiddenField($modInfoPencucian, 'tgl_awal', array('class' => 'span3')); ?>
...
//                    ));
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?php echo $form->textField($modInfoPencucian, 'nopenerimaanlinen', array('onkeypress' => "return $(this).focusNextInputField(event)", 'class' => 'span3', 'readonly' => true)); ?>
                </div> 
            </div>
...
<?php echo $form->textField($modInfoPencucian, 'jenisperawatan', array('onkeypress' => "return $(this).focusNextInputField(event)", 'class' => 'span3', 'readonly' => 'readonly')); ?>
                </div> 
            </div>
            <div class="control-group">
                    <?php echo CHtml::label('Instalasi', 'instalasi_id', array('class' => 'control-label')) ?>
                <div class="controls">
                    <?php echo $form->hiddenField($modInfoPencucian, 'instalasi_id', array('class' => 'span3')); ?>
                    <?php echo $form->textField($modInfoPencucian, 'instalasi_nama', array('onkeypress' => "return $(this).focusNextInputField(event)", 'class' => 'span3', 'readonly' => true)); ?>
                    <?php
...
//                    )));
             ...
             <div class="control-group">
                ...
                <div class="controls">
                    <?php echo $form->hiddenField($modInfoPencucian, 'ruangan_id', array('class' => 'span3')); ?>
                    <?php echo $form->textField($modInfoPencucian, 'ruangan_nama', array('onkeypress' => "return $(this).focusNextInputField(event)", 'class' => 'span3', 'readonly' => true)); ?>
                </div>
            </div>
