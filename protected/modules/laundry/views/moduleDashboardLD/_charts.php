<div class="panel panel-default" id="charts_env">
    <div class="panel-heading">
        <div class="panel-title with-tabs">
            <i class="fas fa-chart-pie"></i> Jumlah Pencucian Bulan Ini
        </div>
        ...
        <thead>
            <tr>
                <th width="50%" class="col-padding-1">
                    <div class="pull-left">
                        <div class="h4 no-margin">Pencucian</div>
                ...
                <th width="50%" class="col-padding-1">
                    <div class="pull-left">
                        <div class="h4 no-margin">Perawatan</div>
            ...
            data: [
                ...
                if (count((array)$dataAreaChart) > 0) {
                    foreach ($dataAreaChart as $i => $chart) { ?> {
                            "x": "<?php echo date("d", strtotime($chart['tglditerima'])); ?>",
            ...
            data: [
                ...
                if (count((array)$dataLineChart) > 0) {
                    foreach ($dataLineChart as $i => $chart) { ?> {
                            x: "<?php echo date("d", strtotime($chart['tglpresensi'])); ?>",
            ...
            data: [
                ...
                if (count((array)$dataDonutChart) > 0) {
                    foreach ($dataDonutChart as $i => $chart) { ?> {
                            label: "<?php echo $chart['kelompokjabatan']; ?>",
