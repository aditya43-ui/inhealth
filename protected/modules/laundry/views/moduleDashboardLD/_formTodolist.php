    ...
    <div class="row box">
        ...
        <div class="col-sm-6">
            ...
            $this->widget('MyDateTimePicker', array(
                ...
                'htmlOptions' => array(
                    'placeholder' => '00/00/0000 00:00:00', 'class' => 'dtPicker2 form-control datetimemask', 'onkeyup' => "return $(this).focusNextInputField(event)"
                ),
            ));
            ?>
        </div>
        <?php // echo CHtml::htmlButton(Yii::t('mds','{icon}',array('{icon}'=>'<i class="icon-plus icon-white"></i>')),array('class' => 'btn btn-danger','onclick'=>'updateTodolist();')); 
        ?>
