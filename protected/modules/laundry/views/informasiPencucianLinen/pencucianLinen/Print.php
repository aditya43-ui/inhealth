...
<table style="width: 100%; border: none;">
  ...
  <fieldset>
    <table width="74%" style="margin: 0;" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td><?php echo Params::setLabelKepegawaianKonfig(); ?> Mengetahui</td>
            <td>:</td>
...
<table width="100%" style="margin-top:20px;">
    <tr>
        ...
        <?php echo Params::setLabelKepegawaianKonfig(); ?> Menyetujui,
        ...
        <td width="50%" align="center">
            ...
            <?php echo Params::setLabelKepegawaianKonfig(); ?> Mengetahui,
