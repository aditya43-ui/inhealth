...
<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="fas fa-soap"></i> Transaksi <b>Pencucian Linen Ulang</b>
    ...
    <div class="panel-body">
        ...
        <div class="panel panel-success" style="display: none;">
            ...
            <div class="panel-body">
                <?php $this->renderPartial($this->path_view . 'pencucianLinen/_pencarian', array('modInfoPencucian' => $modInfoPencucian, 'instalasiTujuans' => $instalasiTujuans, 'ruanganTujuans' => $ruanganTujuans)); ?>
            </div>
        </div>
        <?php
        ...
        <div class="panel panel-success">
            ...
            <div class="panel-body table-responsive">
                <?php echo $this->renderPartial($this->path_view . 'pencucianLinen/_rowLinen', array('modPencucianLinen' => $modPencucianLinen, 'modPencucianLinenDetail' => $modPencucianLinenDetail, 'modPencucianBahan' => $modPencucianBahan, 'modInfoPencucian' => $modInfoPencucian)); ?>
            </div>
        </div>
        <div class="panel panel-success">
            <div class="panel-heading">
            ...
            <div class="panel-body">
                <?php echo $this->renderPartial($this->path_view . 'pencucianLinen/_form', array('form' => $form, 'modPencucianLinen' => $modPencucianLinen, 'modPencucianLinenDetail' => $modPencucianLinenDetail, 'modPencucianBahan' => $modPencucianBahan, 'instalasiTujuans' => $instalasiTujuans, 'ruanganTujuans' => $ruanganTujuans)); ?>
            </div>
        </div>
        <div class="panel panel-success">
            <div class="panel-heading">
            ...
            <div class="panel-body">
                <?php echo $this->renderPartial($this->path_view . 'pencucianLinen/_formPilihBahan', array('form' => $form, 'modPencucianLinen' => $modPencucianLinen, 'instalasiTujuans' => $instalasiTujuans, 'ruanganTujuans' => $ruanganTujuans)); ?>
                <br>
                                ...
                                <tbody>
                                    ...
                                    if (count((array)$modPencucianBahan) > 0) {
                                        foreach ($modPencucianBahan as $i => $modDetail) {
                                            echo $this->renderPartial($this->path_view . 'pencucianLinen/_rowBahanLinen', array('modDetail' => $modDetail));
                                        }
                                    }
                                    ?>
                                </tbody>
        ...
        <div class="form-actions">
            ...
            ?>
            <?php
            $content = $this->renderPartial($this->path_view . 'pencucianLinen/tips/tipsPerawatanLinen', array(), true);
            $this->widget('UserTips', array('type' => 'transaksi', 'content' => $content));
            ?>
        </div>
        <?php $this->endWidget(); ?>
        <?php $this->renderPartial($this->path_view . 'pencucianLinen/_jsFunctions', array('modPencucianLinen' => $modPencucianLinen, 'modPencucianLinenDetail' => $modPencucianLinen, 'modPencucianBahan' => $modPencucianBahan, 'modInfoPencucian' => $modInfoPencucian)); ?>
    </div>
</div>