<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="fas fa-file-signature"></i> Transaksi <b>Pencatatan Kehilangan Linen</b>
    ...
    <div class="panel-body">
        ...
        ?>
            <?php echo Yii::app()->user->setFlash('success', "Data Pencatatan Kehilangan Linen " . $model->nopenerimaanlinen . " berhasil disimpan!");
            $this->widget('bootstrap.widgets.BootAlert'); ?>
        <?php } ?>
        <?php $form = $this->beginWidget('ext.bootstrap.widgets.BootActiveForm', array(
            'id' => 'kehilanganlinen-t-form',
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">
                    <i class="far fa-file-alt"></i> Data <b>Linen</b>
                </div>
            </div>
            <div class="panel-body" style="overflow-y: auto;">
                <?php $this->renderPartial($this->path_view . '_tabelLinen', array(
                    'model' => $model,
                    'form' => $form,
                    'modDetail' => $modDetail,
                    'form' => $form,
    ...
    'columns' => array(
        array(
            ...
            'value' => 'CHtml::Link("<i class=\"icon-form-check\"></i>","#",array("class"=>"btn-small", 
				"id" => "selectLinen",
				"onClick" => "
					submitLinen(\"$data->linen_id\", \"$data->noregisterlinen\", \"$data->namalinen\");
