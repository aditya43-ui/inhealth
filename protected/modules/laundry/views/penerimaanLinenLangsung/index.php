<div class="panel panel-gradient">
    <div class="panel-heading">
        <div class="panel-title">
            <i class="fas fa-hands-wash"></i> Transaksi <b>Penerimaan Perawatan Linen Langsung</b>
        </div>
    </div>
    <div class="panel-body">
        <?php
        $this->breadcrumbs = array(
            'Transaksi Penerimaan Perawatan Linen Langsung',
        );
        ...
        ?>
            <?php echo Yii::app()->user->setFlash('success', "Data Penerimaan Perawatan Linen Langsung berhasil disimpan!");
