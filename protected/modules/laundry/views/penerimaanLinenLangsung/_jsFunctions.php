...
var trBahan=new String(<?php echo CJSON::encode($this->renderPartial('_rowDetail',array('model'=>$model,'modDetail'=>$modDetail,'form'=>$form,'removeButton'=>true),true));?>);
var trBahanFirst=new String(<?php echo CJSON::encode($this->renderPartial('_rowDetail',array('model'=>$model,'modDetail'=>$modDetail,'form'=>$form,'removeButton'=>false),true));?>);
