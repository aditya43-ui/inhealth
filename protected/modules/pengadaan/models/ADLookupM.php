<?php
class ADLookupM extends LookupM
{
	...
	public function search()
	{
        ...
        /**
        * Untuk filter data lookup_type jenistermin di halaman admin Master Termin.
        ...
        public function searchTermin()
	{
		...
		$criteria->compare('LOWER(lookup_kode)',strtolower($this->lookup_kode),true);
		$criteria->compare('lookup_aktif',$this->lookup_aktif);
                $criteria->addCondition("lookup_aktif = True and lookup_type ilike 'jenistermin'");
