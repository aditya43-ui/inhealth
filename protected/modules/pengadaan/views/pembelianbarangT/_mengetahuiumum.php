...
if($sukses > 0){
	Yii::app()->user->setFlash('success',"Status Manajer Umum Mengetahui berhasil disimpan !");
}
...
//                    echo "Manajer Umum, <br> Mengetahui";
                    ...
                    array('class'=>'btn btn-primary',
                            ...
                            function(r) {if(r) window.location = "'.$this->createUrl('MengetahuiUmum',array('pembelianbarang_id'=>$model->pembelianbarang_id,'approve'=>true)).'";} ); return false;'));  
            }
        ?>
            </div>	
            <div class="control-group">
...
<?php 
    ...
    $urlPrint= $this->createUrl('printMengetahuiUmum',array('pembelianbarang_id'=>$model->pembelianbarang_id));
