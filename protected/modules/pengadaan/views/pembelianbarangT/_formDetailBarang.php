...
$this->widget('ext.bootstrap.widgets.BootGridView',array(
    ...
    'columns'=>array(
        ...
        array(
            'header' => 'Jenis Barang',
            'name' => 'jenisbarang_id',
            'filter' => CHtml::dropDownList('ADBarangM[jenisbarang_id]',$modBarang->jenisbarang_id, CHtml::listData(JenisbarangM::model()->findAll('jenisbarang_aktif = true order by jenisbarang_nama'), 'jenisbarang_id', 'jenisbarang_nama'),array('empty'=>'-- Pilih --')),    
            'value' => '(!empty($data->jenisbarang_id)?$data->jenisbarangs->jenisbarang_nama:"")',
        ),
//        array(
//            'header' => 'Tipe Barang',
//            'name' => 'barang_type',
...
$js = <<< JS
    function inputBarang(){
        ...
        else if (!jQuery.isNumeric(parseFloat(jumlah))){
    ...
    function batal(obj){
        myConfirm("${notif}",'Perhatian!',function(r){
            if(!r) {
                ...
                if (id != null && id != "") {
                    $("#data_dihapus").val($("#data_dihapus").val() + "." + id);
                }
