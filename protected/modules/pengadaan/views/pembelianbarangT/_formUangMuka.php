<div class="row-fluid">
    <div class = "col-sm-6">
        <div class="control-group ">
            ...
            <div class="controls">
                <?php
//                    $model->tglpermintaanuangmuka = (!empty($model->tglpermintaanuangmuka) ? date("d/m/Y", strtotime($model->tglpermintaanuangmuka)) : null);
                    $this->widget('MyDateTimePicker', array(
                            ...
                            'htmlOptions' => array('placeholder' => '00/00/0000', 'class' => 'dtPicker2 span3', 'onkeyup' => "return $(this).focusNextInputField(event)"
                            ),
                    ));
                ?>
            </div>
