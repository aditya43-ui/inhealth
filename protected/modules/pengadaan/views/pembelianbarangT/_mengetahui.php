...
if($sukses > 0){
	Yii::app()->user->setFlash('success',"Status Manajer Keuangan Mengetahui berhasil disimpan !");
}
...
//				echo "Manajer Keuangan, <br> Mengetahui";
				...
				array('class'=>'btn btn-primary',
					...
					function(r) {if(r) window.location = "'.$this->createUrl('Mengetahui',array('pembelianbarang_id'=>$model->pembelianbarang_id,'approve'=>true)).'";} ); return false;'));  
			}
			?>
		</div>	
		<div class="control-group">
...
<?php 
    ...
    $urlPrint= $this->createUrl('printMengetahui',array('pembelianbarang_id'=>$model->pembelianbarang_id));
