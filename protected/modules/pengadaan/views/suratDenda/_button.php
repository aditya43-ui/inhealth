<div class="row-fluid">
    ...
    <?php
        ...
        if (!empty($model->terminke) && empty($modPPK)) {
        ...
        echo '&nbsp;';
        echo CHtml::link(Yii::t('mds', '{icon} Reset', array('{icon}' => '<i class="entypo-arrows-ccw"></i>')), Yii::app()->createUrl('/'.$module.'/'.$controller.'/index',array('suratperjanjiankerja_id'=>$_GET['suratperjanjiankerja_id'])), array('class' => 'btn btn-danger',
...
<script>
    function print(){
        ...
        //window.open('<?php echo $this->createUrl('print',array('id'=>$model->suratdenda_id)); ?>','printwin','left=100,top=100,width=640,height=480');
    }
</script>