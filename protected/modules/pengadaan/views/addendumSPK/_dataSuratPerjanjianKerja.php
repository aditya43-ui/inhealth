    ...
    <div class="panel-body">
        <div class="col-sm-6">
            <div class="control-group ">
                ...
                <div class="controls">
                    <?php echo $form->hiddenField($model, 'mappingrekeninganggaran_id', array('readonly'=>true, 'class'=>'span3')); ?>
                    <?php echo $form->hiddenField($model, 'persiapanpengadaan_id', array('readonly'=>true, 'class'=>'span3')); ?>
                    <?php echo $form->hiddenField($model, 'penawaranpenyedia_id', array('readonly'=>true, 'class'=>'span3')); ?>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?php 
                        echo $form->textField($model, 'kontrakcarapembayaran', ['class' => 'span3', 'readonly' => true]);
                    ?>
                </div>
            </div>
            <div class="control-group ">
        ...
        <div class="col-sm-6">      
            <div class="control-group ">
                ...
                <div class="controls">
                    ...
                    <?php echo $form->hiddenField($modPengadaan, 'instalasi_id', array('readonly'=>true, 'class'=>'span3 instalasi_id')); ?>
                    <?php echo $form->hiddenField($modPengadaan, 'unitkerja_id', array('readonly'=>true, 'class'=>'span3 unitkerja_id')); ?>
                    <?php echo $form->textArea($modPengadaan, 'namaunitkerja', array('readonly'=>true, 'class'=>'span3')); ?>
                </div>
            </div>
            <div class="control-group ">
            ...
            <div class="control-group ">
                ...
                <div class="controls">
                    <?php echo $form->textField($model, 'suratundanganpl_nomor', array('class'=>'span3', 'readonly' => true)); ?>
                </div>
            </div>
            <div class="control-group ">
                <label class="control-label">Tanggal Surat Pengadaan Langsung</label>
                <div class="controls">
                    <?php echo $form->textField($model, 'suratundanganpl_tanggal', array('class'=>'span3', 'readonly' => true)); ?>
            ...
            <div class="control-group ">
                ...
                <div class="controls">
                    <?php echo $form->textField($model, 'bahasilpl_nomor', array('class'=>'span3', 'readonly' => true)); ?>
                </div>
            </div>
            <div class="control-group ">
                <label class="control-label">Tanggal BA Hasil Pengadaan Langsung</label>
                <div class="controls">
                    <?php echo $form->textField($model, 'bahasilpl_tanggal', array('class'=>'span3', 'readonly' => true)); ?>
