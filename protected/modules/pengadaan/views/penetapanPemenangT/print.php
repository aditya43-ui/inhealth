        ...
        <table width="100%">
            <tr>
                ...
                <td width="65%" style="vertical-align:top; text-align: center"> 
                    <?php echo 'Surabaya, ', date('d', strtotime($model->penetapanpemenang_tanggal))." ".MyFormatter::getMonthId(date('m', strtotime($model->penetapanpemenang_tanggal))).date(' Y', strtotime($model->penetapanpemenang_tanggal));  ?><br>
                </td>
            </tr>
            <tr>
                <td width="35%"> </td>
