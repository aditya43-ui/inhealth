<div class="row-fluid">
    <div class="col-md-6">
        ...
        <div class="control-group">
            <?php echo CHtml::label('Nomor BA ', 'nomor_beritaacara', array('class' => 'control-label')) ?>
            <div class="controls">
    ...
    <div class="col-md-6">
        <div class="control-group ">
            <?php echo CHtml::label("Tanggal Pembuatan BA ", 'baserahterima_tanggal', array('class' => 'control-label')) ?>
            <div class="controls">
                <?php
         ...
         <div class="control-group">
            <?php echo CHtml::label('Termin ', 'nomor_beritaacara', array('class' => 'control-label')) ?>
            <div class="controls">
...
<div class="row-fluid">
    <div class="col-md-6">
        ...
        <div class="control-group ">
            <?php echo CHtml::label("Jabatan ", 'nomor_beritaacara', array('class' => 'control-label')) ?>
            <div class="controls">
