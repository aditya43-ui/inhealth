<div class="panel panel-success">
    ...
    <div class="panel-body">
        ...
        <div class="col-sm-6">
            <div class="control-group">
                <?php echo $form->labelEx($model, 'kuasapenggunaanggaran_id', array(
                    'class'=>'control-label',
                )); ?>
                <div class="controls">
                    <?php
                        ...
                        // --- end
                        echo $form->textField($model, 'kuasapenggunaanggaran_nama', array(
                            'class'=>'span3 kuasapenggunaanggaran_nama','readonly'=>true
                        ));
                        /*
                        $this->widget('MyJuiAutoComplete', array(
                                'name'=>'kuasapenggunaanggaran_nama',
                                'value'=>$kuasapenggunaanggaran_nama,
                                'source'=>'js: function(request, response) {
                                               $.ajax({
                                ...
                                'htmlOptions'=>array(
                                    'disabled'=>false,
                                    'onkeyup'=>"return $(this).focusNextInputField(event)",
                                    'class'=>'span3 kuasapenggunaanggaran_nama',
                                ),
