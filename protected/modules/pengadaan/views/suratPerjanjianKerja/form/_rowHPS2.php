<tr data-row="0">
    ...
    <td>
        <?php
            echo CHtml::activeTextField($model, '[detail]['.$i.']merk', array('class' => 'span2','readonly'=>true));
        ?>
    </td>
    <td>
        <?php
    ...
    <td>
        <?php 
            echo CHtml::activeTextField($model, '[detail]['.$i.']barang_jumlah', array('readonly' => true,'class' => 'span1 required integer-decimal volume ubah', 'onblur' =>($readonlyHPS == true) ? '' : 'hitungJumlahBaris(this);', ));
