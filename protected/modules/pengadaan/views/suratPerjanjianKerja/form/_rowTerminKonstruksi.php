<tr style="height:40px;">
    ...
    <td style="text-align:center; min-width: 100px;"> 
        <?php echo CHtml::activeTextField($modTermin, '[0]jumlah_persen',array('onblur' => 'hitungTerminKonstruksi();','value' => 95, 'class'=>'span1 integer-decimal jumlah_persen', 'readonly' => false)) ?>
    </td>
    <td style="text-align:center; min-width: 200px;"> 
        <?php echo CHtml::activeTextField($modTermin, '[0]jumlah_harga',array('class'=>'span2 integer-decimal jumlah_harga_konstruksi_95 jumlah_harga_konstruksi', 'readonly' => true)) ?>
...
<tr>
    ...
    <td style="text-align:center; min-width: 100px;"> 
        <?php echo CHtml::activeTextField($modTermin, '[1]jumlah_persen',array('onblur' => 'hitungTerminKonstruksi();', 'value' => 5, 'class'=>'span1 integer-decimal jumlah_persen', 'readonly' => false)) ?>
    </td>
    <td style="text-align:center; min-width: 200px;"> 
        <?php echo CHtml::activeTextField($modTermin, '[1]jumlah_harga',array('class'=>'span2 integer-decimal jumlah_harga_konstruksi_5 jumlah_harga_konstruksi', 'readonly' => true)) ?>
