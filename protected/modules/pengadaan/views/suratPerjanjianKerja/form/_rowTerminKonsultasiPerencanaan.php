<tr style="height:40px;">
    ...
    <td style="text-align:center; min-width: 100px;"> 
        <?php echo CHtml::activeTextField($modTermin, '[0]jumlah_persen',array('onblur' => 'hitungTerminPerencanaan();', 'value' => 80, 'class'=>'span1 integer-decimal jumlah_persen', 'readonly' => false)) ?>
    </td>
