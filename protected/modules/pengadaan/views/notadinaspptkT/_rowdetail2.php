...
<tbody>
    ...
    <tr>
        ...
        <td style="text-align: right"><?php echo CHtml::activeHiddenField($modDet, '[' . $i . ']jumlah_harga',array('readonly'=>true,'class'=>'span2 jumlah_harga integer-decimal')); echo "Rp. " . number_format($modDet->jumlah_harga, 2, ",", "."); ?>
