...
//                                            'dateFormat'=>Params::DATE_FORMAT,
	...
	<div class="col-sm-6">
            <?php echo $form->dropDownListRow($modRencanaKebBarang,'sumberdana_id',
		...
		<div class="controls">
                    ...
                    <?php echo CHtml::activeTextField($modRencanaKebBarang, 'ro_barang_bulan', array('readonly'=>false,'onkeyup'=>"return $(this).focusNextInputField(event)",'class'=>'span2 numbers-only','required'=>true)) ?> bulan
		</div>
            </div>
	</div>
</div>
