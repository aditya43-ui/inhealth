...
<div class="panel panel-gradient">
    <div class="panel-body">
        ...
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                <?php $this->renderPartial('_formPenawaran', array('form' => $form, 'modPenawaran' => $modPenawaran, 'model' => $model))?>

            </div>
        </div>
        <div class="panel panel-success">
            <div class="panel panel-heading">
                <div class="panel-title"> <b> Riwayat </b> </div>
            </div>
            <div class="panel-body">
                <?php $this->renderPartial('_formRiwayat', array('form' => $form, 'modPenawaran' => $modPenawaran, 'model' => $model))?>
            </div>
        </div>  
        <div class="row-fluid">
        <?php
