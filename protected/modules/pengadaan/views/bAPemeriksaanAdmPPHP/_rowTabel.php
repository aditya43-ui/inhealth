    ...
    <td style="text-align: center;" class="rowbutton">
        ...
        <?php
            if(!empty($modDetail->pegpphp_id)){
                ...
                echo CHtml::link('<i class="icon-minus-sign icon-white"></i>', '#', array('class'=>'btn btn-primary','onclick'=>'hapusBaris(this)', "rel"=>"tooltip" ,"data-original-title"=>"Klik untuk menghapus baris",'data-placement'=>'left')); 
            }
        ?>
    </td>
</tr>
