<table class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?php echo CHtml::link($riwayat->riwayatpengadaan_lampiran, $this->createUrl('UnduhDokumenRiwayat', array('id' => $riwayat->riwayatpengadaan_id)), array('title' => 'Unduh Dokumen', 'rel' => 'tooltip'));?></td>
        </tr>
        <?php
                }
            }
