...
<div class="panel panel-success">
    ...
    <div class="panel-body">
        ...
        <div class="row-fluid">
            <div class="col-sm-6">
                <div class = "control-group">
                    ...
                    <div class = "controls">
                        <?php echo $form->textField($model, 'nomor_dokumen', array('readonly' => true, 'class' => 'span4 required', 'maxlength' => 100)); ?>
                    </div>
                </div>
                <div class = "control-group">
                    <?php echo CHtml::label("Tanggal Surat <i style='color: red'> * </i>", '', array('class' => 'control-label')) ?>
                    <div class = "controls">
                        <?php echo $form->textField($model, 'perintahpengiriman_tanggal', array('readonly' => true, 'class' => 'span4 required', 'maxlength' => 100)); ?>
                    </div>
                </div>
                <div class = "control-group">
                ...
                <div class = "control-group">
                    ...
                    <div class = "controls">
                        <?php echo $form->textArea($model, 'denda_keterangan', array('readonly' => true, 'class' => 'span4', 'maxlength' => 100)); ?>
                    </div>
                </div>
            </div>
            <div class="col-sm-6">
        ...
        <div class="row-fluid">
            <?php $this->renderPartial('_formRincian2', array('model' => $model, 'modRincianSPK' => $modRincianSPK, 'modelDetail' => $modelDetail, 'form' => $form));?>
        </div>
    </div>
</div>
