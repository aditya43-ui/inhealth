...
//                                    "onclick" => 'setBarangJasa('.$res.');$("#dialogBarangJasa").dialog("close")'));
//                        },
//                ),
                 array(
                ...
                array(
                    ...
                    'filter' => CHtml::activeHiddenField($modBrgJasa, 'paketpekerjaan_id', array('class' => 'barang_paketpekerjaan_id')) .                                 
                                ...
                                CHtml::activeHiddenField($modBrgJasa, 'mappingrekeninganggaran_id', array('class' => 'barang_mappingrekeninganggaran_id')).
...
$this->widget('ext.bootstrap.widgets.BootGridView',array(
    ...
    'columns'=>array(
                ...
                array(
                    ...
                    'filter'=> CHtml::activeHiddenField($modPA, 'periodeanggaran_id').CHtml::activeHiddenField($modPA, 'jabatan_pengadaan').CHtml::activeTextField($modPA, 'nomorindukpegawai')
                ),
                array(
                    'header'=>'Nama',
                    'name'=>'nama_pegawai',                    
...
$modKegiatan = new KegiatanprogramM('search');
$modKegiatan->default = 'ada';
if(isset($_GET['KegiatanprogramM'])){
    $modKegiatan->attributes = $_GET['KegiatanprogramM'];    
}
