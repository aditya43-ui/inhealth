...
$form=$this->beginWidget('ext.bootstrap.widgets.BootActiveForm',array(
    ...
    'method'=>'get',
    'id'=>'rencanaumumpengadaan-m-search',
    'type'=>'horizontal',
)); 
...
<div class="row-fluid">
    <div class="col-sm-6">
        ...
        <div class = "control-group">
            <?php echo Chtml::label("Tahun Anggaran",'periodeanggaran_id', array('class'=>'control-label')) ?>
            <div class = "controls">
    ...
    <div class="col-sm-6">
         <div class = "control-group">
            <?php echo Chtml::label("Kategori Pengadaan",'rencanaumumpengadaan_tahun', array('class'=>'control-label')) ?>
            <div class = "controls">
         ...
         <div class = "control-group">
            <?php echo Chtml::label("Metode Pengadaan",'metode_pengadaan', array('class'=>'control-label')) ?>
            <div class = "controls">
                <?php echo $form->dropDownList($model,'metode_pengadaan', Chtml::listData(MetodepengadaanM::model()->findAllByAttributes(array('metodepengadaan_aktif'=>true)),'metodepengadaan_nama','metodepengadaan_nama'),
                    array('onkeypress'=>"return $(this).focusNextInputField(event)",'empty'=>'-- Pilih --')); ?>
            </div>
        </div>
         <div class = "control-group">
         ...
         <div class = "control-group">
            ...
            <div class = "controls">
                <?php echo $form->dropDownList($model,'rencanaumumpengadaan_status', LookupM::getItems('statusrencanaumumpengadaan'),
                    array('onkeypress'=>"return $(this).focusNextInputField(event)",'empty'=>'-- Pilih --')); ?>
            </div>
        </div>
    </div>
