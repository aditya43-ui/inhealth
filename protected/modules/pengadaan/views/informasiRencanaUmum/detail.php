    ...
    <div class="col-md-12">
        <div class="panel panel-gradient">
            ...
            <div class="panel-body">
                ...
                <?php
                echo CHtml::link(Yii::t('mds', '{icon} Kembali', array('{icon}' => '<i class="entypo-left-bold"></i>')), Yii::app()->createUrl('pengadaan/InformasiRencanaUmum/index'), array('class' => 'btn btn-success'));
                ?>
            </div>
