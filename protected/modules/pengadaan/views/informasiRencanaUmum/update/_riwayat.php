...
$this->widget('ext.bootstrap.widgets.MergeHeaderGroupGridView', array(
    ...
    'columns' => array(
        ...
        array(
            ...
            'type' => 'raw',
            'value' => function($data) {
                echo CHtml::link('<u>' . $data->riwayatpengadaan_lampiran . '</u>', $this->createUrl('UnduhLampiran', array('riwayatpengadaan_id' => $data->riwayatpengadaan_id)), array('class' => '', 'title' => 'Klik untuk download lampiran', 'rel' => 'tooltip'));
            },
        ),
    ),
