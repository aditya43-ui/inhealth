<tr rowdata="0">
    ...
    <td>        
        <?php
            echo CHtml::activeTextField($model, '[detail][0]rencanaumumpengadaandet_satuan',array('readonly'=>true, 'class'=>'rencanaumumpengadaandet_satuan span2'));
        ?>
    </td>
    <td>                
        <?php
            ...
            echo CHtml::activeHiddenField($model, '[detail][0]volumeawal',array('readonly'=>true, 'class'=>'span2 required integer-decimal volumeawal ubah volumeawal',' onkeyup'=>'return $(this).focusNextInputField(event);'));
        ?>
    </td>
    <td>
        <?php
            ...
            echo CHtml::activeHiddenField($model, '[detail][0]hargaawal',array('readonly'=>true, 'class'=>'span2 required integer-decimal estimasiawal ubah hargaawal',' onkeyup'=>'return $(this).focusNextInputField(event);'));
        ?>                  
    </td>
    <td>                
        <?php            
            ...
            echo CHtml::activeTextField($model, '[detail][0]rencanaumumpengadaandet_pajak',array('onblur' => 'hitungHargaBaris(this)', 'class'=>'span2 required integer-decimal persenpajak ubah rencanaumumpengadaandet_pajak', 'onblur'=>'hitung();',' onkeyup'=>'return $(this).focusNextInputField(event);'));
            echo CHtml::activeHiddenField($model, '[detail][0]persenawal',array('readonly'=>true, 'class'=>'span2 required integer-decimal persenpajakawal ubah persenawal',' onkeyup'=>'return $(this).focusNextInputField(event);'));
            echo CHtml::activeHiddenField($model, '[detail][0]rencanaumumpengadaandet_jmlpajak',array('readonly'=>true, 'class'=>'span2 required integer-decimal pajak',' onkeyup'=>'return $(this).focusNextInputField(event);'));
        ?>
    </td>
    <td>                
        <?php            
            echo CHtml::activeTextField($model, '[detail][0]rencanaumumpengadaandet_jumlah',array('onblur' => 'hitungJumlahBaris(this)',  'readonly'=>false, 'class'=>' required integer-decimal harga rencanaumumpengadaandet_jumlah',' onkeyup'=>'return $(this).focusNextInputField(event);'));
            echo CHtml::activeHiddenField($model, '[detail][0]rencanaumumpengadaandet_jumlahawal',array('readonly'=>true, 'class'=>'span2 required integer-decimal hargaawal',' onkeyup'=>'return $(this).focusNextInputField(event);'));
        ?>
    </td>
    <td>
        <?php 
            echo CHtml::activeTextField($model, '[detail][0]sisapagu_pengadaan', array('readonly' => true, 'class' => 'integer-decimal sisapagu_pengadaan'));
        ?>
    </td>
    <td>
