...
<div class="post" style="border-top:1px solid rgba(255, 255, 255, 0.1); padding-bottom:5px;">
	...
	<div class="nav">
		...
		<?php
		 ...
		 echo CHtml::htmlButton(Yii::t('mds','{icon}',array('{icon}'=>'<i class="icon-pencil icon-white"></i>')),array('title'=>'Klik untuk mengubah todolist','rel'=>'tooltip','class'=>'btn btn-mini btn-primary', 'onclick'=>'$(\'#dialog-ubah-todolist\').dialog(\'open\');setFormTodolist('.$data->todolist_id.');return false;'));
		 echo CHtml::htmlButton(Yii::t('mds','{icon}',array('{icon}'=>'<i class="icon-remove icon-white"></i>')),array('title'=>'Klik untuk menghapus todolist','rel'=>'tooltip','class'=>'btn btn-mini btn-primary', 'onclick'=>'HapusTodolist('.$data->todolist_id.');')); 
