...
<!--<div class="white-container">-->
    <div class="panel panel-gradient">
        <div class="panel panel-heading">
            <div class="panel-title"> Pengaturan <b> Template Dokumen</b> </div>
        </div>
        <div class="panel-body">
            ...
            <div class="block-tabel" style="overflow-x: scroll">
                <?php
                $this->widget('ext.bootstrap.widgets.BootGridView', array(
                    'id' => 'metodepengadaan-m-grid',
                    'dataProvider' => $model->searchTemplatePengadaan(),
//                    'filter' => $model,
                    'template' => "{summary}\n{items}\n{pager}",
                    ...
                    'columns' => array(
                        ...
                        array(
                            ...
                            'type' => 'raw',
                            'value' => function($data) {
                                if ($data->konfigtemplatesurat_aktif == true) {
                                    return CHtml::link("<i class='icon-form-silang'></i> ", "javascript:removeTemporary($data->konfigtemplatesurat_id)", array("id" => "$data->konfigtemplatesurat_id", "rel" => "tooltip", "title" => "Menonaktifkan Template")) . ' ' . CHtml::link("<i class='icon-form-sampah'></i> ", "javascript:deleteRecord($data->konfigtemplatesurat_id)", array("id" => "$data->konfigtemplatesurat_id", "rel" => "tooltip", "title" => "Hapus Template"));
                                } else {
                                    return CHtml::link("<i class='icon-form-check'></i> ", "javascript:aktifkan($data->konfigtemplatesurat_id)", array("id" => "$data->konfigtemplatesurat_id", "rel" => "tooltip", "title" => "Mengaktifkan Template")) . ' ' . CHtml::link("<i class='icon-form-sampah'></i> ", "javascript:deleteRecord($data->konfigtemplatesurat_id)", array("id" => "$data->konfigtemplatesurat_id", "rel" => "tooltip", "title" => "Hapus Template"));
                                }
                            },
    ...
    <?php
    echo CHtml::link(Yii::t('mds', '{icon} Tambah Template Dokumen', array('{icon}' => '<i class="icon-plus icon-white"></i>')), $this->createUrl('create', array('modul_id' => Yii::app()->session['modul_id'])), array('class' => 'btn btn-danger')) . "&nbsp&nbsp";
...
{
    window.open("${urlPrint}/"+$('#konfigtemplatesurat-k-search').serialize()+"&caraPrint="+caraPrint,"",'location=_new, width=900px');
}
JSCRIPT;
