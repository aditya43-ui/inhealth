	...
	<div class="row-fluid">
		...
		<div class="col-sm-6">
			...
			<div class = "control-group">
				...
				<div class = "controls">
					<?php echo $form->dropDownList($model, 'sumberdana_id', Chtml::ListData(SumberdanaM::model()->findAll("sumberdana_aktif = TRUE"),'sumberdana_id','sumberdana_nama'),array('empty'=>'-- Pilih --'))?>
				</div>
			</div>	
		</div>
	</div>     
