    ...
    <div class="col-md-12">
        <div class="panel panel-gradient">
            <div class="panel-heading">
                <div class="panel-title">Laporan <strong>Rencana Kebutuhan (Obat Alkes)</strong></div>
            </div>
        ...
        <div class="panel panel-success">
            ...
            <div class="panel-body">
						...
						<div class="row-fluid">
							...
							<div class="col-sm-6">
								<div class="control-group">
									...
									<div class="controls">
										<?php  echo $form->textField($model,'noperencnaan',array('placeholder'=>'Ketik No. Perencanaan','class'=>'span3')); ?>
									</div>
								</div>								
							</div>
						</div>
                ...
                <div class="panel panel-success">
                    <div class="panel-heading">
                        <div class="panel-title">Tabel <strong>Rencana Kebutuhan (Obat Alkes)</strong></div>
                    </div>
