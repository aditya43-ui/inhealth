...
<div class="panel panel-gradient">
    <div class="panel panel-heading">
        <div class="panel-title"> Pengaturan <b>Dokumen SSUK </b> </div>
    </div>
    <div class="panel-body">
        ...
        <div class="panel panel-success">
            <div class="panel-heading">
                <div class="panel-title">Tabel <b>Dokumen SSUK </b></div>
            </div>
            <div class="panel-body">
                <?php
                        ...
                        array(
                            ...
                            'value' => function($data) {
                                if ($data->lookup_aktif == true) {
                                    return CHtml::link("<span style='font-size:17px;'><i class='icon-form-silang'></i></span>", "javascript:removeTemporary($data->lookup_id)", array("id" => "$data->lookup_id", "rel" => "tooltip", "title" => "Menonaktifkan Dokumen SSUK")) . ' ' . CHtml::link("<span style='font-size:17px;'><i class='icon-form-sampah'></i></span>", "javascript:deleteRecord($data->lookup_id)", array("id" => "$data->lookup_id", "rel" => "tooltip", "title" => "Hapus Dokumen SSUk"));
                                } else {
                                    return CHtml::link("<span style='font-size:17px;'><i class='icon-form-check'></i></span>", "javascript:aktifkan($data->lookup_id)", array("id" => "$data->lookup_id", "rel" => "tooltip", "title" => "Mengaktifkan Dokumen SSUK")) . ' ' . CHtml::link("<span style='font-size:17px;'><i class='icon-form-sampah'></i></span>", "javascript:deleteRecord($data->lookup_id)", array("id" => "$data->lookup_id", "rel" => "tooltip", "title" => "Hapus Dokumen SSUK"));
                                }
                            },
...
<?php
echo CHtml::link(Yii::t('mds', '{icon} Tambah Dokumen SSUK', array('{icon}' => '<i class="icon-plus icon-white"></i>')), $this->createUrl('create', array('modul_id' => Yii::app()->session['modul_id'])), array('class' => 'btn btn-danger')) . "&nbsp&nbsp";
