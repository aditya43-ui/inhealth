...
<div class="panel panel-success form_skoring form_vas">
    <div class="panel-heading">
        <div class="panel-title">Visual Analog Scale (VAS) <a href="#" onclick="return false;" rel="tooltip" title="Geser tanda panah sampai skala nyeri hasil pengkajian"><i class="entypo-info-circled"></i></a></div>
    </div>
    <div class="panel-body">
        <input type="range" id="skor_vas" min="0" max="10" onchange="setSkorVas();" value="<?php echo empty($model->skalanyeri) ? 0 : $model->skalanyeri; ?>">
        <div class="ruler">
