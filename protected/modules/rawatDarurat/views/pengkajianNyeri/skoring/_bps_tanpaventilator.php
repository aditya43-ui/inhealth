<div class="panel panel-success form_skoring form_bps_tanpaventilator">
    <div class="panel-heading">
        <div class="panel-title">Behavioural Pain Scale (Tanpa Ventilator) <a href="#" onclick="return false;" rel="tooltip" title="Pilih Penilaian untuk setiap Parameter Pengkajian Nyeri"><i class="entypo-info-circled"></i></a></div>
    </div>
        ...
        <table class="table table-bordered table-condensed">
            ...
            <tbody id="tab_bpstv">
                ...
                <tr> 
                    ...
                    <td><?php echo $form->dropDownList($det, '[bpstv]['.$val.']bps_penilaian', $list_penilaian, array('empty'=>'-- Pilih --', 'class'=>'nilai_bpstv input_nilai', 'options'=>$option_list)); ?></td>
                    <td><?php echo $form->textField($det, '[bpstv]['.$val.']bps_skor', array('class'=>'span1 skor_bpstv input_skor', 'readonly'=>true, 'style'=>'text-align: right')); ?></td>
                </tr>
            ...
            <tfoot>
                <tr>
                    ...
                    <td><?php echo CHtml::activeTextField($model, 'skalanyeri', array('class' => 'span1 total_skor_bpstv', 'readonly' => true, 'style' => 'text-align:right;')) ?></td>
                </tr>
                <tr>
                    <td colspan="2">Kriteria Skor Nyeri</td>
                    <td><?php echo CHtml::activeTextField($model, 'keterangan_skalanyeri', array('class' => 'keterangan_skor_bpstv span3', 'readonly' => true, 'style' => 'text-align:left;')) ?></td>
                </tr>
            </tfoot>
        </table>
    </div>
