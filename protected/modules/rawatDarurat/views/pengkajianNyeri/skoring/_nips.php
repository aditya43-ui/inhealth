<div class="panel panel-success form_skoring form_nips">
    <div class="panel-heading">
        <div class="panel-title">Neonatal Infant Pain Score <a href="#" onclick="return false;" rel="tooltip" title="Pilih Penilaian untuk setiap Parameter Pengkajian Nyeri"><i class="entypo-info-circled"></i></a></div>
    </div>
        ...
        <table class="table table-bordered table-condensed">
            ...
            <tbody id="tab_nips">
                ...
                <tr> 
                    ...
                    <td><?php echo $form->dropDownList($det, '[nips]['.$val.']nips_penilaian', $list_penilaian, array('class'=>'nilai_nips input_nilai', 'options'=>$option_list)); ?></td>
                    <td><?php echo $form->textField($det, '[nips]['.$val.']nips_skor', array('class'=>'span1 skor_nips input_skor', 'readonly'=>true, 'style'=>'text-align: right')); ?></td>
                </tr>
            ...
            <tfoot>
                <tr>
                    ...
                    <td><?php echo CHtml::activeTextField($model, 'skalanyeri', array('class' => 'span1 total_skor_nips', 'readonly' => true, 'style' => 'text-align:right;')) ?></td>
                </tr>
                <tr>
                    <td colspan="2">Kriteria Skor Nyeri</td>
                    <td><?php echo CHtml::activeTextField($model, 'keterangan_skalanyeri', array('class' => 'keterangan_skor_nips span3', 'readonly' => true, 'style' => 'text-align:left;')) ?></td>
                </tr>
            </tfoot>
        </table>
    </div>
