...
function print(caraPrint)
{
    ...
    window.open('<?php echo $this->createUrl('printPenolakan'); ?>&pasienanastesi_id='+pasienanastesi_id+'&suratpersetujuantm_id='+suratpersetujuantm_id+'&pendaftaran_id='+pendaftaran_id+'&caraprint='+caraPrint,'printwin','left=100,top=100,width=1000,height=640');
}
