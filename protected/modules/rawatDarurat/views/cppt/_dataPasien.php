    ...
    <div class="panel-body">
        <table width="100%" class="table-condensed">
            ...
            <tr>
                ...
                <?php if(isset($modPendaftaran->pasienadmisi->spesialis)) {?>
                <td><?php echo CHtml::activeTextField($modPendaftaran->pasienadmisi->spesialis, 'jeniskasuspenyakit_nama', array('readonly'=>true)); ?>
                </td>
                <?php } else { ?>
                <td><?php echo CHtml::activeTextField($modPendaftaran, 'jeniskasuspenyakit_nama', array('readonly'=>true)); ?>
                </td>
                <?php }?>
                <td>
                ...
                <td><?php echo CHtml::activeTextField($modPendaftaran, 'carabayar_nama', array('readonly'=>true)); ?>
                </td>
            </tr>
            <tr>
                ...
                <td><?php
                    ...
                    if(Yii::app()->user->getState("instalasi_id") == Params::INSTALASI_ID_REHAB || Yii::app()->user->getState("instalasi_id") == Params::INSTALASI_ID_IBS || Yii::app()->user->getState("instalasi_id") == Params::INSTALASI_ID_GIZI){
                      $pegPemeriksa = PegawaiM::model()->findByPk($modPendaftaran->pegawai_id);
                      $namaDokterPemeriksa = (isset($pegPemeriksa)?$pegPemeriksa->namaLengkap:"");
                    }else if(Yii::app()->user->getState("instalasi_id") == Params::INSTALASI_ID_RD && Yii::app()->user->getState("ruangan_id") == Params::RUANGAN_ID_VK){
                      $pegPemeriksa = PegawaiM::model()->findByPk($modPendaftaran->pegawai_id);
                      $namaDokterPemeriksa = (isset($pegPemeriksa)?$pegPemeriksa->namaLengkap:"");
                    }else{
                        $namaDokterPemeriksa = $modPendaftaran->dokter->namaLengkap;
                    }
                ...
                <td><?php echo CHtml::activeTextField($modPendaftaran, 'penjamin_nama', array('readonly'=>true)); ?>
                </td>
            </tr>
        </table>
    </div>
