...
// $modelRiwayat1 = new RDCpptpasienT();
// // $pendaftaran_id = $_GET['pendaftaran_id'];
// $modPendaftaran1 = RDPendaftaranT::model()->with('jeniskasuspenyakit')->findByPk($modPendaftaran->pendaftaran_id);
...
//   $modPendaftaran1 = PasienmasukpenunjangV::model()->findByAttributes(array('pendaftaran_id' => $modPendaftaran->pendaftaran_id, 'ruangan_id' => $ruangan_id));
...
//     $modPendaftaran1 = InfokunjunganpersalinanV::model()->findByAttributes(array('pendaftaran_id' => $modPendaftaran->pendaftaran_id, 'ruangan_id' => $ruangan_id));
//   }
// }

// echo $this->renderPartial('rawatJalan.views.daftarPasien._riwayatCPPT', array(
//   'modelRiwayat' => $modelRiwayat1,
//   'modPendaftaran' => $modPendaftaran1
// ));
