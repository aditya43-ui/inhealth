...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var golonganumur = jQuery('#<?php echo CHtml::activeId($model, 'golonganumur_id') ?>');	
        var kondisipulang = jQuery('#<?php echo CHtml::activeId($model, 'kondisikeluar_id') ?>');	
        var namapegawai = jQuery('#<?php echo CHtml::activeId($model, 'nama_pegawai') ?>');	
        ...
        * multi select propinsi dan kabupaten
        ...
        jQuery(golonganumur).multiselect({
            includeSelectAllOption: true,
            buttonClass: "form-control",
            maxHeight: 300,
            buttonWidth: '182px',
        ...
        jQuery(kondisipulang).multiselect({
            includeSelectAllOption: true,
            buttonClass: "form-control",
            maxHeight: 300,
            buttonWidth: '182px',
        ...
        jQuery(namapegawai).multiselect({
            includeSelectAllOption: true,
            buttonClass: "form-control",
            maxHeight: 300,
            buttonWidth: '182px',
