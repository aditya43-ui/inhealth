<div class="search-form">
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <div class="control-group">
                <?php
                echo CHtml::hiddenField('filter', 'carakeluar', array('disabled' => 'disabled')) .
                    '<div class="control-group">
                        ' . CHtml::label('Cara Keluar', 'carakeluar', array('class' => 'control-label')) . ' 
                        <div class="controls">
                            ' . $form->dropDownList($model, 'carakeluar', CarakeluarM::model()->getCaraKeluar(), array(
                ...
                //     'content' => array(
                //         'content2' => array(
                //             'header' => '<i class="entypo-doc-text"></i> Berdasarkan Tindak Lanjut',
