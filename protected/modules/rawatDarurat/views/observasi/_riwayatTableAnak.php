<div style="overflow: auto">
	...
	'id'=>'riwayatobservasianak-grid',
	'dataProvider'=>$model->searchRiwayatAnak($model->pendaftaran_id, $model->pasienadmisi_id),
                'template'=>"{summary}\n{items}\n{pager}",
                'replaceUrl'=>true,
	...
	'columns'=>array(
                    ...
                    array(
                        'header'=>'Minum/<br />Sonde',
                        'type'=>'raw',
                        'value'=>'(!empty($data->minum_sonde)?$data->minum_sonde:"-")'
                    ),
                    array(
                        'header'=>'Muntah',
                        'type'=>'raw',
                        'value'=>'(!empty($data->muntah)?$data->muntah:"-")'
                    ),
                    array(
                        'header'=>'BAK',
                        'type'=>'raw',
                        'value'=>'(!empty($data->bak)?$data->bak:"-")'
                    ),
                    array(
                        'header'=>'BAB',
                        'type'=>'raw',
                        'value'=>'(!empty($data->bab)?$data->bab:"-")'
                    ),
                    array(
                        'header'=>'Catatan',
                        'type'=>'raw',
