...
<table class="tab_informasi">
    <tr>
        ...
        <td align="center">
            ...
            <br />
            <br />
            <?php echo !$model->isNewRecord ? "(" . $model->nama_yangmenyetujui . ")" : $form->textField($model, 'nama_yangmenyetujui', array('class' => 'span3')); ?>
        </td>
        <td width="33%" align="center">
            Perawat/Bidan
            ...
            <?php
            $cr = new CDbCriteria();
            $cr->addInCondition('kelompokpegawai_id', array(Params::KELOMPOKPEGAWAI_ID_BIDAN, Params::KELOMPOKPEGAWAI_ID_TENAGA_KEPERAWATAN));
...
<div class="form-actions">
    ...
    if (!$model->isNewRecord) {
        ...
        echo CHtml::link(
            ...
            array('title' => 'Ulang', 'class' => 'btn btn-default', 'disabled' => false, 'type' => 'button')
        );
        echo CHtml::htmlButton(
            Yii::t('mds', '{icon} Print', array('{icon}' => '<i class="entypo-print"></i>')),
            array('class' => 'btn btn-info', 'disabled' => false, 'type' => 'button', 'onclick' => 'print(\'PRINT\')')
        ) . "&nbsp&nbsp";
    } else {
        echo CHtml::htmlButton(
            Yii::t(
            ...
            array(
                'class' => (!$model->isNewRecord) ? 'btn btn-danger' : 'btn btn-danger submit', 'title' => 'Simpan', 'disabled' => (!$model->isNewRecord) ? true : false, 'type' => 'submit',
