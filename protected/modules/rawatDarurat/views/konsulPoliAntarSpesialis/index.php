    ...
    <div class="panel panel-success">
        <div class="panel-heading">
            <div class="panel-title">
                <i class="entypo-credit-card"></i> Tabel <b>Pelayanan Konsultasi Antar Spesialis</b>
            </div>
        </div>
        <div class="panel-body table-responsive" id="bodytabelriwayat">
            <?php $this->renderPartial($this->path_view_rd . '_listKonsulPoli', array('modRiwayatKonsul' => $modRiwayatKonsul)); ?>
        </div>
    </div>
    <!--</div>-->
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <?php /* echo $form->dropDownListRow(
                    ...
                    array(
                        'empty' => '-- Pilih --', 'class' => 'form-control span3', 'onkeypress' => "return $(this).focusNextInputField(event);",
                        'multiple' => 'multiple',
                        'onchange' => 'setTarif()'
                    )
                ); */
            ...
            <div class="col-sm-6">
                ...
                ?>
                <div class="control-group">
                    <label class="control-label">Dokter Konsul <span class="required">*</span></label>
                    <div class="controls">
                        <?php
                        echo $form->dropDownList(
                            $modKonsul,
                            'pegawai_id',
                            CHtml::listData($listDokterKonsul, 'pegawai_id', 'NamaLengkap'),
...
JS;
    ...
    <script type="text/javascript">
        ...
        function batalKonsul(idKonsulAntarPoli, pendaftaran_id, is_bisa = true) {

            if(is_bisa) {
                myConfirm("Apakah Anda akan membatalkan konsul ini?", "Perhatian!", function(r) {
                    if (r) {
                        $.post('<?php echo $this->createUrl('ajaxBatal') ?>', {
                            idKonsulAntarPoli: idKonsulAntarPoli,
                            ...
                            $('#bodytabelriwayat').html(data.result);
                        }, 'json');
                    }
                });
            } else {
