        ...
        <td>
            <table class="table noborder paddingtext" style="text-align: center;">                    
                ...
                <tr>       
                    ...
                    <td class="scala-tengah" colspan="3">
            ...
            <table class="table noborder">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php 
                                echo $modFisik->skala_wongbaker_nrs;
                            //echo $form->textField($modFisik,'skala_wongbaker_nrs',array('readonly'=>true,'class'=>'col-sm-2','style'=>'text-align:right;')) ?>
                    </td>
                </tr>
                <tr>
                    <td colspan="3">
                    ...
                    <td>
                        <?php
                            if ($modFisik->rasanyeri_berpindah){
                                echo 'Ya';
                            }else{
                                echo 'Tidak';
                            }
                ...
                <tr>
                    ...
                    <td >
                        ...
                        <?php echo $modFisik->seringmengalami_nyeri; ?>
                    </td>
                </tr>
                <tr>
                    <td colspan="3">
                    ...
                    <td>
                        ...
                        <?php echo $modFisik->penyebabberkurang_nyeri; ?>
                    </td>
                </tr>
                <tr>
                    <td>
