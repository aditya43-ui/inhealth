...
<table class="table border paddingtext">       
							...
							<div class="controls">
								<?php
									...
									if ($modPendaftaran->carabayar_id == Params::CARABAYAR_ID_BPJS){
										...
										$asuransi = true;
									}elseif ($modPendaftaran->carabayar_id == Params::CARABAYAR_ID_BPJS){
										$umum = true;
									}
								?>
	...
	<?php echo $this->renderPartial($this->path_view.'print._printGCS',array('form'=>$form,'modAsesTriase'=>$modAsesTriase,'modAsesTriDet'=>$modAsesTriDet,'getTriase'=>$getTriase),true); ?>
</table>
<?php echo $this->renderPartial($this->path_view.'print._printformNyeriV2',array('modFlaCcs'=>$modFlaCcs,'modAsesTriase'=>$modAsesTriase,'getFlaCcs'=>$getFlaCcs,'dataFlaCcs'=>$dataFlaCcs,'modFisik'=>$modFisik,'form'=>$form),true); ?>                                                    
...
<table style="width: 100%; border: none;">
    ...
    <tr>
        <td colspan="3" align="center" valign="middle" width="30%">&nbsp;</td>
        <td colspan="3">&nbsp;</td>
        <td colspan="3" align="center" valign="middle" width="30%"><?php echo Yii::app()->user->getState('kabupaten_nama').", ".MyFormatter::formatDateTimeId(date('Y-m-d',strtotime($modAsesTriase->tglasesmentriase))); ?><br>Petugas Triase</td>
    </tr>
    <tr>
        <td colspan="9">&nbsp;</td>
    </tr>
    ...
    <tr>
        ...
        <td colspan="3"></td>
        <td colspan="3" align="center" valign="middle"><?php echo $modAsesTriase->pegawai->namaLengkap ?? ""; ?></td>
    </tr>
