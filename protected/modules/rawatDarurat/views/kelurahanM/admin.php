<div class="panel panel-gradient">
    ...
    <div class="panel-body">
        ...
        'items'=>array(
            array('label'=>'Provinsi',  'url'=>$this->createUrl('/rawatDarurat/propinsiM&modul_id='.Yii::app()->session['modul_id'])),
                ...
                <?php $this->widget('ext.bootstrap.widgets.BootGridView', array(
                    ...
                    'columns' => array(
                        ...
                        array(
                            'header' => 'Hapus',
                            'type' => 'raw',
                            'value' => '($data->kelurahan_aktif)?CHtml::link("<i class=\'entypo-cancel\'></i> ","javascript:removeTemporary($data->kelurahan_id)",array("id"=>"$data->kelurahan_id","rel"=>"tooltip","title"=>"Menonaktifkan Kelurahan"))." ".CHtml::link("<i class=\'entypo-trash\'></i> ", "javascript:deleteRecord($data->kelurahan_id)",array("id"=>"$data->kelurahan_id","rel"=>"tooltip","title"=>"Hapus Kelurahan")):CHtml::link("<i class=\'entypo-trash\'></i> ", "javascript:deleteRecord($data->kelurahan_id)",array("id"=>"$data->kelurahan_id","rel"=>"tooltip","title"=>"Hapus Kelurahan"));',
