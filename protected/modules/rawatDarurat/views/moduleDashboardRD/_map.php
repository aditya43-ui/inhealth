<div class="row tile-block">
		...
		<div class="scrollable" data-height="400" data-scroll-position="right" data-rail-color="#fff" data-rail-opacity=".9" data-rail-width="8" data-rail-radius="10" data-autohide="0">
				<?php 
					...
					foreach ($dataMap as $i => $map){ 
						...
						$kecamatan[$diagnosa_id]['diagnosa'][$i]['latitude'] = isset($map['latitude']) ? $map['latitude'] : "'tidakada'";
						$kecamatan[$diagnosa_id]['diagnosa'][$i]['longitude'] = isset($map['longitude']) ? $map['longitude'] : "'tidakada'";
	...
	<div class="col-sm-9set" style="padding:0">
