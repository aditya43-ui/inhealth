...
<table>
    <tr>
        ...
        <td>:</td>
        <td>
            <?php echo CHtml::textField('tglbatal_rd', date('Y-m-d H:i:s'), array('readonly' => true, 'class' => 'realtime')); ?>
        </td>
    </tr>
    <tr>
        ...
        <td>:</td>
        <td>
            <?php echo CHtml::textArea('keterangan_batal_rd', ''); ?>
        </td>
    </tr>
</table>
...
<div class="form-actions">
    <?php
    echo CHtml::hiddenField('pendaftaran_id_rd', '');
    ...
    <?php echo CHtml::htmlButton(Yii::t('mds', '{icon} Tidak', array('{icon}' => '<i class="entypo-cancel"></i>')), array('type' => 'button', 'onclick' => '$(\'#DialogBatalperiksa_rd\').dialog(\'close\');', 'class' => 'btn btn-danger')); ?>
