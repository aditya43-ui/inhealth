<div class="row">
    <div class="col-sm-6">
        ...
        <div class="control-group ">
            ...
            <div class="controls">
                <?php echo $form->textArea($model, 'riwayatpenyakitterdahulu', array('class' => 'span3')); ?>
            </div>
        </div>
        <div class="control-group ">
            <?php  echo CHtml::label('Riwayat Alergi', '', array('class' => 'control-label')) ?>
            <div class="controls">
                <?php echo $form->textArea($model, 'riwayatalergi', array('class' => 'span3', 'style'=>'width:300px; height:100px')); ?>
            </div>
        </div>
    </div>
    <div class="col-sm-6">
