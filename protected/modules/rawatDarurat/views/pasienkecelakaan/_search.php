<div class="search-form">
    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            <?php
            echo CHtml::hiddenField('filter', 'jeniskecelakaan_id', array('disabled' => 'disabled')) .
                '<div class="control-group">
                ' . CHtml::label('Jenis Kecelakaan', 'jeniskecelakaan_id', array('class' => 'control-label')) . ' 
                <div class="controls">
                    ' . $form->dropDownList($model, 'jeniskecelakaan_id', CHtml::listData(JeniskecelakaanM::model()->findAll('jeniskecelakaan_aktif = true ORDER BY jeniskecelakaan_nama ASC'), 'jeniskecelakaan_id', 'jeniskecelakaan_nama'), array(
            ...
            //     'content' => array(
            //         'content2' => array(
            //             'header' => '<i class="entypo-doc-text"></i> Berdasarkan Jenis Kecelakaan',
            //             'isi' => CHtml::hiddenField('filter', 'jeniskecelakaan_id', array('disabled' => 'disabled')) .
            //                 '<div class="control-group">
            //                     ' . CHtml::label('Jenis Kecelakaan', 'jeniskecelakaan_id', array('class' => 'control-label')) . ' 
            //                     <div class="controls">
            //                         ' . $form->dropDownList($model, 'jeniskecelakaan_id', CHtml::listData(JeniskecelakaanM::model()->findAll('jeniskecelakaan_aktif = true ORDER BY jeniskecelakaan_nama ASC'), 'jeniskecelakaan_id', 'jeniskecelakaan_nama'), array(
