...
class MikrobiologiKlinikController extends MyAuthController
{
    ...
    protected $path_view = 'rawatDarurat.views.mikrobiologiKlinik.';
    ...
    public function actionIndex($pendaftaran_id, $idPasienKirimKeUnitLain = null)
    {
        ...
        $modMorbiditas = RDPasienMorbiditasT::model()->findByAttributes(array('kelompokdiagnosa_id' => 2, 'pendaftaran_id' => $modPendaftaran->pendaftaran_id, 'pasien_id' => $modPasien->pasien_id), array('order' => 'create_time DESC'));
        ...
        $modJenisPeriksaLab = RDJenisPemeriksaanLabM::model()->findAllByAttributes(array('jenispemeriksaanlab_aktif' => true), array('order' => 'jenispemeriksaanlab_urutan'));
        $modPeriksaLab = RDPemeriksaanLabM::model()->findAllByAttributes(array('pemeriksaanlab_aktif' => true), array('order' => 'jenispemeriksaanlab_id, pemeriksaanlab_urutan'));
        ...
        if (isset($idPasienKirimKeUnitLain)) {
            $modKirimKeUnitLain = RDPasienKirimKeUnitLainT::model()->findByPk($idPasienKirimKeUnitLain);
            ...
            try {
                        ...
                        if($_POST['pemeriksaan']) {
                            ...
                            for ($i = 0; $i < $count; $i++) {
                               $modKirimKeUnitLainMikrobiologi = $this->savePemeriksaanMikriobiologi(
                                ...
                                //         // array('instalasi_id'=>Params::INSTALASI_ID_FARMASI, 'ruangan_id'=>Params::RUANGAN_ID_APOTEK_RI, 'modul_id'=>10),
                ...
                if ($this->statusSaveKirimkeUnitLain && $this->statusSavePermintaanPenunjang && $this->tindakanpelayanantersimpan && $this->kirimSpesimen) {
                    ...
                    if (!empty($modKirimKeUnitLain->pendaftaran_id)) {
                        ...
                        $this->redirect(array('index', 'pendaftaran_id' => $pendaftaran_id, 'idPasienKirimKeUnitLain' => $modKirimKeUnitLainMikrobiologi->pasienkirimkeunitlain_id, 'sukses' => 1, 'smspasien' => $smspasien));
                    }
                } else {
        ...
        $modRiwayatKirimKeUnitLain = RDPasienKirimKeUnitLainT::model()->findAll($criRiwayat);
    ...
    protected function savePemeriksaanMikriobiologi($modPendaftaran, $jenispemeriksaanmikro_id, $samplelab_id, $caraambilsampel_id, $pemeriksaanmikro_id, $catatan)
    {
        ...
        $modKirimKeUnitLain->isbayarkekasirpenunjang = isset($_POST['RDPasienKirimKeUnitLainT']['isbayarkekasirpenunjang']) ? $_POST['RDPasienKirimKeUnitLainT']['isbayarkekasirpenunjang'] : 0;
    ...
    /**
     * method untuk menyimpan data pasien ke unit lain RDPasienKirimkeUnitLainT
     * digunakan di :
     * 1. rawatJalan/laboratorium/index
     * @param object $modPendaftaran model PendaftaranT
     * @return \RDPasienKirimKeUnitLainT 
     */
    protected function savePasienKirimKeUnitLain($modPendaftaran, $ruangan_lab, $instalasi_lab)
    {
        ...
        // var_dump($modKirimKeUnitLain->attributes, $_POST['RDPasienKirimKeUnitLainT']); die;
    ...
    protected function savePermintaanPenunjang($permintaan, $modKirimKeUnitLain)
    {
        ...
        foreach ($permintaan['kode_unik'] as $i => $value) {
            ...
            // var_dump($modPermintaan->attributes, $permintaan); die;
    ...
    {
        $modTindakan = new RDTindakanPelayananT;
    ...
    public function actionAjaxBatalKirim()
    {
        if (Yii::app()->request->isAjaxRequest) {
            ...
            $modRiwayatKirimKeUnitLain = RDPasienKirimKeUnitLainT::model()->findAllByAttributes(
    ...
    public function actionPrintRiwayat()
    {
        $pendaftaran_id = $_GET['id'];
        $modPendaftaran = PendaftaranT::model()->findByPk($pendaftaran_id);
        $modKirimKeUnitLain = RDPasienKirimKeUnitLainT::model()->findAll('pendaftaran_id=' . $pendaftaran_id);
        $modRiwayatKirimKeUnitLain = RDPasienKirimKeUnitLainT::model()->findAllByAttributes(
