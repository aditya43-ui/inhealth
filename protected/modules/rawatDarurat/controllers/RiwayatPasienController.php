...
class RiwayatPasienController extends MyAuthController
{
  public function actionGetRiwayatPasien($id)
  {
    ...
    $modKunjungan = RDPendaftaranT::model()->with('hasilpemeriksaanlab', 'anamnesa', 'pemeriksaanfisik', 'pasienmasukpenunjang', 'diagnosa')->findAll($criteria);
