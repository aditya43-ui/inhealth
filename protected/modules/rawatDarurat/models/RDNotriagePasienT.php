...
class RDNotriagePasienT extends NotriagePasienT
{
	public $no_triage,$no_triage_pasien;
    /**
	...
	public static function getDropTrigaePasien2($pendaftaran_id) {

		$cri = new CDbCriteria();
		if ((!empty($pendaftaran_id))) {
		// /$cri->addCondition(" instalasi_id = '" . Params::INSTALASI_ID_RD . "' ");
		$tanggal = date('Y-m-d');
		$cri->addCondition("date(create_time) = '".$tanggal."'");
		...
		// $cri->select = 'pendaftaran_id,pasien_id,no_pendaftaran,nama_pasien';
		// $cri->group = 'pendaftaran_id,pasien_id,no_pendaftaran,nama_pasien';
