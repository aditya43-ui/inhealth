...
class Bootstrap extends CApplicationComponent
{
	 ...
	 */
	public $coreCss = true;
        public $coreCssTheme = true;
        public $coreCssFontIcon = true;
	/**
	...
	public function init()
	{
		...
		if ($this->coreCss)
			$this->registerCss();
                ...
                if ($this->coreCssTheme)
			$this->registerCssTheme();
                     
                if ($this->coreCssFontIcon)
                     $this->registerCssFontIcon();
...
//		Yii::app()->clientScript->registerCssFile(Yii::app()->baseUrl.'/themes/neon/assets/css/font-icons/entypo/css/entypo.css');
		//Yii::app()->clientScript->registerCssFile(Yii::app()->baseUrl.'/themes/neon18/assets/css/bootstrap.css');
		//Yii::app()->clientScript->registerCssFile(Yii::app()->baseUrl.'/themes/neon18/assets/css/neon-core.css');
		//Yii::app()->clientScript->registerCssFile(Yii::app()->baseUrl.'/themes/neon18/assets/css/neon-theme.css');
		//Yii::app()->clientScript->registerCssFile(Yii::app()->baseUrl.'/themes/neon18/assets/css/bootstrap.css');
	}
	 ...
	 * Registers the Bootstrap CSS.
	 */
	public function registerCssTheme()
	{
           Yii::app()->clientScript->registerCssFile($this->getAssetsUrl().'/theme/skinsidebar/icon-sidebar-green.css');
            //Yii::app()->clientScript->registerCssFile($this->getAssetsUrl().'/theme/skinsidebar/neon-forms-green.css');
	}
        
        /**
	 * Registers the Bootstrap CSS.
	 */
	public function registerCssFontIcon()
	{
			Yii::app()->clientScript->registerCssFile($this->getAssetsUrl().'/font-icons/entypo/css/entypo.css'); 
           	// Yii::app()->clientScript->registerCssFile($this->getAssetsUrl().'/font/fontsopensans.css');
           	Yii::app()->clientScript->registerCssFile($this->getAssetsUrl().'/font-icons/font-awesome5/css/all.css');
           	Yii::app()->clientScript->registerCssFile($this->getAssetsUrl().'/font-icons/font-awesome/css/font-awesome.css');
	}
