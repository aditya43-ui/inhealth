...
(function($) {
    ...
    // set $.browser compatibility for older stuffs
    var matched, browser;
    ...
    $.jqplot.config = {
        ...
        defaultColors: [ "#8788fd", "#55ce63", "#f7e05a", "#f62d51", "#bdc3c7", "#ebebfd", "#1abc9c", "#2ecc71", "#3498db", "#9b59b6", "#34495e", "#f1c40f", "#e67e22", "#e74c3c", "#26B4E3", "#bd70c7"],
