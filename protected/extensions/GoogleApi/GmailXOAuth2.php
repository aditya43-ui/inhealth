...
define ( 'APP_CREDENTIALS', Yii::getPathOfAlias('webroot').'/token-access/googleApi/gmail-xoauth2-credentials.json' );
define ( 'CREDENTIALS_PATH', Yii::getPathOfAlias('webroot').'/token-access/googleApi/gmail-xoauth2-token.json');
