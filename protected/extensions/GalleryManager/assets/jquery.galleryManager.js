...
//        if (opts.hasName)photoTemplate += '<h5></h5>';
        ...
        if (opts.hasName || opts.hasDesc)photoTemplate += '<span class="btn btn-primary btn-mini"><i class="entypo-pencil" onclick="setEdit(this);" style="cursor:pointer;" rel="tooltip" title="Klik untuk ubah gambar"></i></span> ';
