...
<tr id="periksalab_<?php echo $idPemeriksaanLab; ?>">
    ...
    <td>
        ...
        <?php echo CHtml::textField("PemeriksaanLab[$jenisPemeriksaanLabKelompok][$idPemeriksaanLab][tarif_tindakan]", MyFormatter::formatNumberForUser($tarif),array('class'=>'inputFormTabel lebar2 integer tarif','readonly'=>true)); ?>
    </td>
    ...
    <td>
        <?php
            echo CHtml::link("<span class='icon-remove'>&nbsp;</span>",'',array("rel"=>"tooltip","title"=>"Klik untuk membatalkan Tindakan",'href'=>'#','onclick'=>'removeListTindakan(this,'.$idDaftarTindakan.','.$idPemeriksaanLab.');return false;','style'=>'text-decoration:none;'));
        ?>
    </td>
</tr>
<?php
