...
<table class="w100   prinout-emr kop-header-pdf" >
    <tr >
        ...
        <td align="center" nowrap width="<?= ($page=='L')?'25%':'35%'; ?>" style="vertical-align: bottom">   
            <div class="prov">
...
<table class="w100 prinout-emr title-header">
    <tr>
        ...
        <td align="center">
            <?= !empty($judul_laporan)?'<div class="judul">'.$judul_laporan.'</div>':'' ?>            
            <?= !empty($alias)?'<div class="alias"><i>'.$alias.'</i></div>':'' ?>
        </td>
