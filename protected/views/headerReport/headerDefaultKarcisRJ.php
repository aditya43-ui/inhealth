...
<table width="<?php echo ((isset($width)) ? $width : "100%")?>" class="headers">       
	<TR>
            <TD style="text-align: center;" align="center" colspan="<?php echo isset($colspan)?$colspan:2 ?>">
			 <img src="<?php echo Params::urlProfilRSDirectory().$data->logo_rumahsakit; ?> " style="text-align: center; max-width: 70px; width:70px;" class='image_report'/>
		</TD>
...
<!--            <div align="center" class="nama_profil">
            ...
            <div align="center" class="jalan_profil">
                <FONT FACE="Liberation Serif" color="black" style="font-size: 9pt;">
                    <?php echo $konfig->alamatheadersurat ?>
                </FONT>                
            </div>
<?php /*
            <div align="center" class="kontak_profil" style="font-size: 9pt;">
