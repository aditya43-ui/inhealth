        ...
        <TR>
            <TD ROWSPAN="1" WIDTH="80" ALIGN="CENTER" VALIGN="MIDDLE">
                <?php 
                    ...
                    if ($caraPrint == 'PDF'){
                ?>
                <img src="<?php echo Params::urlProfilRSPDFPath().'tumbs/kecil_'.$data->logo_rumahsakit ?> " width ="30px" />
                    <?php }else{ ?>
                    <img src="<?php echo Params::urlProfilRSDirectory().'tumbs/kecil_'.$data->logo_rumahsakit ?> " width ="30px" />
