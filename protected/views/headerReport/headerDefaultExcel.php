...
<table width="<?php echo ((isset($width)) ? $width : "100%")?>" class="headers">
	<TR>
        ...
        <TD align="center" colspan="<?php echo isset($colspan)?$colspan:1 ?>">
    ...
    <TR>
        <TD colspan="<?php echo isset($colspan)?$colspan:1 ?>" HEIGHT=2 style="border-bottom: 1px solid #000000">&nbsp;</TD>
    </TR>
    <TR>
        <TD STYLE="text-align:center;" colspan="<?php echo isset($colspan)?$colspan:1 ?>" class="judul" align="center">
            <font color="black"><h3><?php echo ((isset($judulLaporan)) ? $judulLaporan : null); ?></h3></font>
        </TD>
    </TR>   
	<tr>
		<td colspan="<?php echo isset($colspan)?$colspan:1 ?>">&nbsp;</td>
	</tr>
</table>
