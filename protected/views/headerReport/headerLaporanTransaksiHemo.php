        ...
        <TR>
            <TD ROWSPAN="2" WIDTH="80" ALIGN="CENTER" VALIGN="MIDDLE">
                <?php 
                    ...
                    if ($caraPrint == 'PDF'){
                ?>
                <img src="<?php echo Params::urlProfilRSPDFPath().$data->logo_rumahsakit ?> " style="float:left; max-width: 150px; width:140px;" class='image_report'/>
                    <?php }else{ ?>
                    <img src="<?php echo Params::urlProfilRSDirectory().$data->logo_rumahsakit ?> " style="float:left; max-width: 150px; width:140px;" class='image_report'/>
                 
                 <?php } ?>
            </TD>
            <TD ALIGN=CENTER VALIGN=MIDDLE colspan=" <?php echo (!empty($colspan)) ? ($colspan-1) : "5"; ?>" nowrap>
                <B><FONT FACE="Liberation Serif" SIZE=<?php echo isset($judulFont)?$judulFont:5; ?> color="black"><?php //echo $data->nama_rumahsakit ?></FONT></B>
            </TD>
