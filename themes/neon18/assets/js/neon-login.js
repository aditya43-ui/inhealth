		...
		neonLogin.$container.validate({
			...
			//	$(".form-login-error").slideUp('fast');
				...
				//{
					...
					$.ajax({
						url: baseurl + '/index.php?r=site/login',
						type: "POST",
						dataType: 'json',
						...
						error: function()
						{
							//alert("An error occoured!");
                                                     ...
                                                     //   neonLogin.resetProgressBar(true);
                                                        ...
                                                        $("#LoginForm_instalasi").html("<option value=''>-- Pilih --</option>");
                                                        $("#LoginForm_ruangan").html("<option value=''>-- Pilih --</option>");
                                                        $("#LoginForm_modul").html("<option value=''>-- Pilih --</option>");
                                                        $(".log-hide").show();
						...
						success: function(response)
						{
							...
							//{
								...
								if(login_status == 'invalid')
								{
									$(".login-page").removeClass('logging-in');
									neonLogin.resetProgressBar(true);
                                                                      //  alert(response.login_pesan);
                                                                        $("#message-login").html(response.login_pesan);
                                                                        $("#login-button").attr("disabled",true);
                                                                        $("#form_login").trigger("reset");
                                                                        $("#LoginForm_instalasi").html("<option value=''>-- Pilih --</option>");
                                                                        $("#LoginForm_ruangan").html("<option value=''>-- Pilih --</option>");
								...
								if(login_status == 'success')
								{
									...
									//setTimeout(function()
									//{
										var redirect_url = response.redirect_uri;
