...
//	public $loadingCssClass='grid-view-loading';
	...
	/**
	 * @var boolean digunakan untuk mengatifkan overflow posisi horizontal
	 * nilai default FALSE.
	 */
	public $overflowx = false;
        
        /**
	 * @var boolean when grid view has ability to change url or not.
	 */
	...
	public function registerClientScript()
	{
		...
		if($this->selectionChanged!==null)
			$options['selectionChanged']=(strpos($this->selectionChanged,'js:')!==0 ? 'js:' : '').$this->selectionChanged;
                ...
                $options['replaceUrl'] = $this->replaceUrl ? true : false;
