$(document).ready(function() {
	...
	$(".mws-panel.mws-collapsible2 .mws-panel-header")
		.append("<div class=\"mws-collapse-button mws-inset\"><span class='mws-collapsed'></span></div>")
			.find(".mws-collapse-button span")
				.live("click", function(event) {
					$(this).toggleClass("mws-collapsed")
						.parents(".mws-panel")
							.find(".mws-panel-body2")
								.slideToggle("fast");
				});
